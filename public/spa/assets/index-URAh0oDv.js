...
var Z = 60,
  ...
  y = 'year',
  C = 'date',
  tt = 'YYYY-MM-DDTHH:mm:ssZ',
  b = 'Invalid Date',
  rt = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,
  et = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,
  W = function (t, e, n) {
    var r = String(t);
  ...
  st = function (t) {
    var e = { M: D, y, w: Y, d: m, D: C, h: A, m: E, s: w, ms: x, Q: P };
    return (
      e[t] ||
      String(t || '')
        .toLowerCase()
...
const ot = { s: W, z: nt, m: at, a: it, p: st, u: ut };
var N = 'en',
  g = {};
g[N] = K;
var G = '$isDayjsObject',
  ...
  k = (function () {
    ...
    return (
      ...
      (t.startOf = function (n, r) {
        var a = this,
          ...
          v = function (p, S) {
            var l = [0, 0, 0, 0],
              _ = [23, 59, 59, 999];
            return s.w(a.toDate()[p].apply(a.toDate('s'), (i ? l : _).slice(S)), a);
          },
          f = this.$W,
          d = this.$M,
          h = this.$D,
      ...
      (t.add = function (n, r) {
        ...
        if (o === D) return this.set(D, this.$M + n);
        if (o === y) return this.set(y, this.$y + n);
        if (o === m) return c(1);
        if (o === Y) return c(7);
        var v = ((i = {}), (i[E] = F), (i[A] = R), (i[w] = I), i)[o] || 1,
          f = this.$d.getTime() + n * v;
        return s.w(f, this);
      }),
      ...
      (t.diff = function (n, r, a) {
        var i = this,
          o = s.p(r),
          c = $(n),
          v = (c.utcOffset() - this.utcOffset()) * F,
          f = this - c,
          d = function () {
            return s.m(i, c);
          },
