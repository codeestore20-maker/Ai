import { aF as v } from './index-CCbaqAw2.js';
var m = (function () {
  ...
  l = typeof window < 'u' && typeof document < 'u' && window.document === document,
  f = (function () {
    return typeof v < 'u' && v.Math === Math
      ? v
...
function D(e) {
  ...
  if (
    (r.boxSizing === 'border-box' &&
      (Math.round(a + o) !== t && (a -= _(r, 'left', 'right') + o),
      Math.round(u + s) !== n && (u -= _(r, 'top', 'bottom') + s)),
    !L(e))
  ) {
    var p = Math.round(a + o) - t,
      b = Math.round(u + s) - n;
    (Math.abs(p) !== 1 && (a -= p), Math.abs(b) !== 1 && (u -= b));
  }
...
function F(e) {
  ...
  return (
    y(s, { x: t, y: n, width: r, height: i, top: n, right: t + r, bottom: i + n, left: t }),
    s
  );
}
function d(e, t, n, r) {
...
var W = (function () {
    ...
    return (
      (e.prototype.observe = function (t) {
        ...
        if (!(typeof Element > 'u' || !(Element instanceof Object))) {
          ...
          n.has(t) ||
            (n.set(t, new W(t)), this.controller_.addObserver(this), this.controller_.refresh());
        }
      }),
  ...
  g = typeof WeakMap < 'u' ? new WeakMap() : new m(),
  O = (function () {
    function e(t) {
