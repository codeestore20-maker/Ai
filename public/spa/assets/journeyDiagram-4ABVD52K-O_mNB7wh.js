import { g as gt } from './chunk-FMBD7UC4-DXdf8TpC.js';
import { a as mt, g as lt, h as xt, d as kt } from './chunk-JSJVCQXG-CfnTNoLr.js';
import {
  g as _t,
  s as vt,
  a as bt,
...
import { d as et } from './arc-CP6XhVRu.js';
...
var U = (function () {
  var t = n(function (h, i, a, l) {
    ...
    g = {
      ...
      performAction: n(function (i, a, l, d, f, o, b) {
        var k = o.length - 1;
        switch (f) {
          case 1:
            return o[k - 1];
      ...
      table: [
        ...
        { 1: [3] },
        t(e, [2, 2], { 5: 3 }),
        { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: s, 12: c, 14: r, 16: p, 17: u, 18: y },
        t(e, [2, 7], { 1: [2, 1] }),
        t(e, [2, 3]),
        { 9: 15, 11: s, 12: c, 14: r, 16: p, 17: u, 18: y },
        t(e, [2, 5]),
        t(e, [2, 6]),
        t(e, [2, 8]),
        { 13: [1, 16] },
      ...
      parse: n(function (i) {
        ...
        function ft(w) {
          ((l.length = l.length - 2 * w), (f.length = f.length - w), (o.length = o.length - w));
        }
        n(ft, 'popStack');
        function D() {
          var w;
          ...
          switch (T[0]) {
            ...
            case 2:
              if (
                ...
                pt && (F._$.range = [o[o.length - (M || 1)].range[0], o[o.length - 1].range[1]]),
                (q = this.performAction.apply(F, [k, K, C, I.yy, T[1], f, o].concat(yt))),
                typeof q < 'u')
              )
                return q;
              (M &&
                ((l = l.slice(0, -1 * M * 2)), (f = f.slice(0, -1 * M)), (o = o.slice(0, -1 * M))),
...
` +
        ...
        next: n(function () {
          ...
          for (var f = this._currentRules(), o = 0; o < f.length; o++)
            if (
              ((l = this._input.match(this.rules[f[o]])), l && (!a || l[0].length > a[0].length))
            ) {
              if (((a = l), (d = o), this.options.backtrack_lexer)) {
                if (((i = this.test_match(l, f[o])), i !== !1)) return i;
                if (this._backtrack) {
                  a = !1;
                  continue;
                } else return !1;
          ...
          return a
            ? ((i = this.test_match(a, f[d])), i !== !1 ? i : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: n(function (a, l, d, f) {
          switch (d) {
            case 0:
              break;
            case 1:
...
var Et = U,
  ...
  Vt = n(function (t, e) {
    ...
    const p = r.map((y) => y.trim()),
      u = { section: V, type: V, people: p, task: t, score: c };
    B.push(u);
  }, 'addTask'),
  Rt = n(function (t) {
...
`,
  ...
  Nt = n(function (t, e) {
    ...
    return (n(y, 'ambivalent'), e.score > 3 ? p(r) : e.score < 3 ? u(r) : y(r), c);
  }, 'drawFace'),
  ot = n(function (t, e) {
  ...
  ht = (function () {
    ...
    n(t, 'byText');
    function e(r, p, u, y, g, m, x, h, i) {
      const { taskFontSize: a, taskFontFamily: l } = h,
        d = r.split(/<br\s*\/?>/gi);
      for (let f = 0; f < d.length; f++) {
        const o = f * a - (a * (d.length - 1)) / 2,
          b = p
            .append('text')
            .attr('x', u + g / 2)
            .attr('y', y)
    ...
    n(e, 'byTspan');
    function s(r, p, u, y, g, m, x, h) {
      const i = p.append('switch'),
        l = i
    ...
    n(s, 'byFo');
    function c(r, p) {
      for (const u in p) u in p && r.attr(u, p[u]);
    }
    return (
      n(c, '_setTextAttrs'),
      function (r) {
...
function ut(t) {
  ...
  Object.keys(E).forEach((r) => {
    const p = E[r].color,
      u = { cx: 20, cy: c, r: 7, fill: p, stroke: '#000', pos: E[r].position };
    j.drawCircle(t, u);
...
var $ = R().journey,
  ...
  Xt = n(function (t, e, s, c) {
    ...
    a &&
      h
        ...
        .attr('fill', p)
        .attr('font-family', y);
    const o = f.stopy - f.starty + 2 * $.diagramMarginY,
      b = P + f.stopx + 2 * $.diagramMarginX;
    ($t(h, o, b, $.useMaxWidth),
      h
        .append('line')
        .attr('x1', P)
    ...
    const k = a ? 70 : 0;
    (h.attr('viewBox', `${f.startx} -25 ${b} ${o + k}`),
  ...
  S = {
    ...
    updateBounds: n(function (t, e, s, c) {
      ...
      function y(g) {
        return n(function (x) {
          u++;
          const h = p.sequenceItems.length - u + 1;
          (p.updateVal(x, 'starty', e - h * r.boxMargin, Math.min),
            p.updateVal(x, 'stopy', c + h * r.boxMargin, Math.max),
            p.updateVal(S.data, 'startx', t - h * r.boxMargin, Math.min),
            p.updateVal(S.data, 'stopx', s + h * r.boxMargin, Math.max),
            g !== 'activation' &&
              (p.updateVal(x, 'startx', t - h * r.boxMargin, Math.min),
              p.updateVal(x, 'stopx', s + h * r.boxMargin, Math.max),
              p.updateVal(S.data, 'starty', e - h * r.boxMargin, Math.min),
              p.updateVal(S.data, 'stopy', c + h * r.boxMargin, Math.max)));
        }, 'updateItemBounds');
      }
    ...
    insert: n(function (t, e, s, c) {
      ...
      (this.updateVal(S.data, 'startx', r, Math.min),
        ...
        this.updateVal(S.data, 'stopx', p, Math.max),
        this.updateVal(S.data, 'stopy', y, Math.max),
        this.updateBounds(r, u, p, y));
    }, 'insert'),
  ...
  Gt = n(function (t, e, s) {
    const c = R().journey;
    let r = '';
    const p = c.height * 2 + c.diagramMarginY,
      u = s + p;
    let y = 0,
      g = '#CCC',
      m = 'black',
    ...
    for (const [h, i] of e.entries()) {
      if (r !== i.section) {
        ...
        (j.drawSection(t, f, c), (r = i.section), y++);
      }
