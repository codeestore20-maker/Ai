...
import { N as t } from './providerConfig-B8LLUHQ4.js';
import { P as i } from './index-CfiK1ayV.js';
...
const Et = () => {
  const { t: r } = p('modelProvider');
  return o.jsx(i, {
    ...t,
    settings: {
      ...t.settings,
      proxyUrl: {
        desc: r('newapi.apiUrl.desc'),
        placeholder: 'https://any-newapi-provider.com/',
        title: r('newapi.apiUrl.title'),
      },
    },
  });
};
