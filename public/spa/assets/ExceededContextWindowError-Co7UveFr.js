...
import { g as l, aG as u, I as f } from './index-NXWXCubP.js';
import { r as p } from '../vendor/vendor-emotion-DdM-9MtU.js';
import { u as C } from './index-4ACezDLV.js';
import { u as e } from './index-DVjZQKt1.js';
import { B as g } from './BaseErrorForm-Fg0SMYBO.js';
import { ao as y } from '../vendor/vendor-icons-BHMUH78i.js';
...
const Wr = p.memo(({ id: n }) => {
  const { t: r } = l('error'),
    [c, a] = p.useState(!1),
    o = e((t) => t.context),
    s = e((t) => t.regenerateUserMessage),
    i = e((t) => t.displayMessages.find((x) => x.id === n)?.parentId),
    d = p.useCallback(async () => {
      if (!(!o.topicId || !i)) {
        a(!0);
        try {
          (await C.getState().executeCompression(o, ''), await s(i));
        } finally {
          a(!1);
        }
      }
  ...
  return m.jsx(g, {
    avatar: m.jsx(f, { icon: y, size: 24 }),
    desc: r('exceededContext.desc'),
    title: r('exceededContext.title'),
    action: m.jsx(u, {
      disabled: !o.topicId,
      loading: c,
      type: 'primary',
      onClick: d,
      children: r('exceededContext.compact'),
    }),
  });
});
