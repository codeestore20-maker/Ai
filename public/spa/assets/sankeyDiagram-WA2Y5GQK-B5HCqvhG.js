...
import { o as Mt } from './ordinal-DILIJJjt.js';
...
function Bt() {
  ...
  ((v.update = function (n) {
    ...
    (v.nodeAlign = function (n) {
      return arguments.length ? ((r = typeof n == 'function' ? n : X(n)), v) : r;
    }),
    ...
    (v.nodePadding = function (n) {
      return arguments.length ? ((b = g = +n), v) : b;
    }),
    (v.nodes = function (n) {
    ...
    (v.extent = function (n) {
      return arguments.length
        ? ((t = +n[0][0]), (i = +n[1][0]), (e = +n[0][1]), (a = +n[1][1]), v)
        : [
            [t, e],
            [i, a],
          ];
  ...
  function D({ nodes: n }) {
    const f = ct(n, (s) => s.depth) + 1,
      u = (i - t - h) / (f - 1),
      c = new Array(f);
    for (const s of n) {
      const m = Math.max(0, Math.min(f - 1, Math.floor(r.call(null, s, f))));
      ((s.layer = m), (s.x0 = t + m * u), (s.x1 = s.x0 + h), c[m] ? c[m].push(s) : (c[m] = [s]));
    }
    if (o) for (const s of c) s.sort(o);
    return c;
  }
  function R(n) {
    const f = gt(n, (u) => (a - e - (u.length - 1) * g) / nt(u, it));
    for (const u of n) {
      let c = e;
      for (const s of u) {
        ((s.y0 = c), (s.y1 = c + s.value * f), (c = s.y1 + g));
  ...
  function S(n) {
    const f = D(n);
    ((g = Math.min(b, (a - e) / (ct(f, (u) => u.length) - 1))), R(f));
    for (let u = 0; u < y; ++u) {
      const c = Math.pow(0.99, u),
        s = Math.max(1 - c, (u + 1) / y);
      (B(f, c, s), P(f, c, s));
    }
  }
  function P(n, f, u) {
  ...
  function O(n, f) {
    const u = n.length >> 1,
      c = n[u];
    (d(n, c.y0 - g, u - 1, f), z(n, c.y1 + g, u + 1, f), d(n, a, n.length - 1, f), z(n, e, 0, f));
  }
  function z(n, f, u, c) {
    for (; u < n.length; ++u) {
      const s = n[u],
        m = (f - s.y0) * c;
      (m > 1e-6 && ((s.y0 += m), (s.y1 += m)), (f = s.y1 + g));
    }
  }
  function d(n, f, u, c) {
    for (; u >= 0; --u) {
  ...
  function $(n, f) {
    let u = n.y0 - ((n.sourceLinks.length - 1) * g) / 2;
  ...
  function I(n, f) {
    let u = f.y0 - ((f.targetLinks.length - 1) * g) / 2;
    for (const { source: c, width: s } of f.targetLinks) {
      if (c === n) break;
      u += s + g;
    }
...
ot.prototype = kt.prototype = {
  ...
  bezierCurveTo: function (t, e, i, a, h, b) {
    this._ +=
      'C' + +t + ',' + +e + ',' + +i + ',' + +a + ',' + (this._x1 = +h) + ',' + (this._y1 = +b);
  },
    ...
    if (this._x1 === null) this._ += 'M' + (this._x1 = t) + ',' + (this._y1 = e);
      ...
      if (!(Math.abs(l * k - r * o) > F) || !h)
        ...
        var x = i - b,
          ...
          T = Math.sqrt(v),
          N = Math.sqrt(_),
          C = h * Math.tan((rt - Math.acos((v + _ - M) / (2 * T * N))) / 2),
          D = C / N,
          R = C / T;
        (Math.abs(D - 1) > F && (this._ += 'L' + (t + D * o) + ',' + (e + D * l)),
          (this._ +=
            'A' +
            h +
            ',' +
  ...
  arc: function (t, e, i, a, h, b) {
    ...
    (this._x1 === null
      ? (this._ += 'M' + r + ',' + o)
      : (Math.abs(this._x1 - r) > F || Math.abs(this._y1 - o) > F) && (this._ += 'L' + r + ',' + o),
      i &&
        (_ < 0 && (_ = (_ % st) + st),
        _ > Rt
          ? (this._ +=
...
function Yt(t) {
  ...
  function g() {
    ...
    if (
      ...
      t(
        b,
        +a.apply(this, ((r[0] = o), r)),
        +h.apply(this, r),
        +a.apply(this, ((r[0] = l), r)),
        +h.apply(this, r),
      ),
      k)
    )
  ...
  return (
    (g.source = function (k) {
      return arguments.length ? ((e = k), g) : e;
    }),
    (g.target = function (k) {
    ...
    (g.y = function (k) {
      return arguments.length ? ((h = typeof k == 'function' ? k : dt(+k)), g) : h;
    }),
    (g.context = function (k) {
      return arguments.length ? ((b = k ?? null), g) : b;
    }),
    g
  );
}
...
var at = (function () {
  var t = p(function (k, r, o, l) {
      for (o = o || {}, l = k.length; l--; o[k[l]] = r);
      return o;
    }, 'o'),
    e = [1, 9],
    i = [1, 10],
    ...
    h = {
      ...
      performAction: p(function (r, o, l, _, x, y, v) {
        var M = y.length - 1;
        switch (x) {
          case 7:
            const T = _.findOrCreateNode(y[M - 4].trim().replaceAll('""', '"')),
              N = _.findOrCreateNode(y[M - 2].trim().replaceAll('""', '"')),
      ...
      parse: p(function (r) {
        ...
        function E() {
          ...
          return (
            (L = _.pop() || S.lex() || D),
            typeof L != 'number' &&
              (L instanceof Array && ((_ = L), (L = _.pop())), (L = o.symbols_[L] || L)),
            L
          );
        }
        p(E, 'lex');
        for (var A, $, I, n, f = {}, u, c, s, m; ; ) {
          if (
            (($ = l[l.length - 1]),
            this.defaultActions[$]
              ? (I = this.defaultActions[$])
              : ((A === null || typeof A > 'u') && (A = E()), (I = v[$] && v[$][A])),
...
Expecting ` +
          ...
          if (I[0] instanceof Array && I.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + $ + ', token: ' + A,
            );
          switch (I[0]) {
            case 1:
              (l.push(A),
            ...
            case 2:
              if (
                ...
                return n;
              (c &&
                ((l = l.slice(0, -1 * c * 2)), (x = x.slice(0, -1 * c)), (y = y.slice(0, -1 * c))),
                l.push(this.productions_[I[1]][0]),
                x.push(f.$),
                y.push(f._$),
                (s = v[l[l.length - 2]][l[l.length - 1]]),
                l.push(s));
              break;
            case 3:
              return !0;
        ...
        unput: p(function (r) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: l
                ? (l.length === _.length ? this.yylloc.first_column : 0) +
                  _[_.length - l.length].length -
                  l[0].length
                : this.yylloc.first_column - o,
            }),
            this.options.ranges && (this.yylloc.range = [x[0], x[0] + this.yyleng - o]),
...
` +
        ...
        next: p(function () {
          ...
          for (var x = this._currentRules(), y = 0; y < x.length; y++)
            if (
              ((l = this._input.match(this.rules[x[y]])), l && (!o || l[0].length > o[0].length))
            ) {
              if (((o = l), (_ = y), this.options.backtrack_lexer)) {
                if (((r = this.test_match(l, x[y])), r !== !1)) return r;
                if (this._backtrack) {
                  o = !1;
                  continue;
                } else return !1;
          ...
          return o
            ? ((r = this.test_match(o, x[_])), r !== !1 ? r : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: p(function (o, l, _, x) {
          switch (_) {
            case 0:
  ...
  return (p(g, 'Parser'), (g.prototype = h), (h.Parser = g), new g());
})();
at.parser = at;
var K = at,
  J = [],
  ...
  le = p(function (t, e, i, a) {
    const { securityLevel: h, sankey: b } = lt(),
      g = Lt.sankey;
    let k;
    h === 'sandbox' && (k = H('#i' + e));
    const r = h === 'sandbox' ? H(k.nodes()[0].contentDocument.body) : H('body'),
      o = h === 'sandbox' ? r.select(`[id="${e}"]`) : H(`[id="${e}"]`),
      l = b?.width ?? g.width,
      _ = b?.height ?? g.width,
      x = b?.useMaxWidth ?? g.useMaxWidth,
      y = b?.nodeAlignment ?? g.nodeAlignment,
      v = b?.prefix ?? g.prefix,
      M = b?.suffix ?? g.suffix,
      T = b?.showValues ?? g.showValues,
      N = a.db.getGraph(),
      C = ae[y];
    Bt()
      .nodeId((d) => d.id)
    ...
    o.append('g')
      ...
      .join('g')
      .attr('class', 'node')
      .attr('id', (d) => (d.uid = pt.next('node-')).id)
...
${v}${Math.round(E * 100) / 100}${M}`
    ...
    o.append('g')
      ...
      .data(N.nodes)
      .join('text')
      .attr('x', (d) => (d.x0 < l / 2 ? d.x1 + 6 : d.x0 - 6))
      .attr('y', (d) => (d.y1 + d.y0) / 2)
      .attr('dy', `${T ? '0' : '0.35'}em`)
      .attr('text-anchor', (d) => (d.x0 < l / 2 ? 'start' : 'end'))
      .text(P);
    const B = o
        .append('g')
        .attr('class', 'links')
      ...
      O = b?.linkColor ?? 'gradient';
    if (O === 'gradient') {
      const d = B.append('linearGradient')
        .attr('id', (E) => (E.uid = pt.next('linearGradient-')).id)
    ...
    switch (O) {
      case 'gradient':
        z = p((d) => d.uid, 'coloring');
        break;
      case 'source':
        z = p((d) => S(d.source.id), 'coloring');
        break;
      case 'target':
        z = p((d) => S(d.target.id), 'coloring');
        break;
      default:
        z = O;
    }
...
`,
  ...
  ye = K.parse.bind(K);
K.parse = (t) => ye(ue(t));
var Te = { styles: fe, parser: K, db: oe, renderer: ce };
