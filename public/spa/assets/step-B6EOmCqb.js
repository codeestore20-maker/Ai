...
var $ = 0.7,
  ...
  p = '\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*',
  Mt = /^#([0-9a-f]{3,8})$/,
  kt = new RegExp(`^rgb\\(${w},${w},${w}\\)$`),
  Tt = new RegExp(`^rgb\\(${p},${p},${p}\\)$`),
  Et = new RegExp(`^rgba\\(${w},${w},${w},${v}\\)$`),
  St = new RegExp(`^rgba\\(${p},${p},${p},${v}\\)$`),
  Pt = new RegExp(`^hsl\\(${v},${p},${p}\\)$`),
  Rt = new RegExp(`^hsla\\(${v},${p},${p},${v}\\)$`),
  U = {
    aliceblue: 15792383,
  ...
  return (
    ...
    (i = Mt.exec(t))
      ? ((e = i[1].length),
        ...
        e === 6
          ...
          : e === 3
            ...
            : e === 8
              ? M((i >> 24) & 255, (i >> 16) & 255, (i >> 8) & 255, (i & 255) / 255)
              : e === 4
                ? M(
                    ((i >> 12) & 15) | ((i >> 8) & 240),
                    ((i >> 8) & 15) | ((i >> 4) & 240),
      ...
      : (i = kt.exec(t))
        ? new _(i[1], i[2], i[3], 1)
        : (i = Tt.exec(t))
          ? new _((i[1] * 255) / 100, (i[2] * 255) / 100, (i[3] * 255) / 100, 1)
          : (i = Et.exec(t))
            ? M(i[1], i[2], i[3], i[4])
            : (i = St.exec(t))
              ? M((i[1] * 255) / 100, (i[2] * 255) / 100, (i[3] * 255) / 100, i[4])
              : (i = Pt.exec(t))
                ? nt(i[1], i[2] / 100, i[3] / 100, 1)
                : (i = Rt.exec(t))
                  ? nt(i[1], i[2] / 100, i[3] / 100, i[4])
                  : U.hasOwnProperty(t)
                    ? tt(U[t])
                    : t === 'transparent'
                      ? new _(NaN, NaN, NaN, 0)
...
function qt(t) {
  return (
    t instanceof N || (t = Y(t)),
    t ? ((t = t.rgb()), new _(t.r, t.g, t.b, t.opacity)) : new _()
  );
}
function I(t, i, e, n) {
  return arguments.length === 1 ? qt(t) : new _(t, i, e, n ?? 1);
}
function _(t, i, e, n) {
...
X(
  ...
  ct(N, {
    ...
    clamp() {
      return new _(m(this.r), m(this.g), m(this.b), E(this.opacity));
    },
    displayable() {
      return (
        -0.5 <= this.r &&
...
function nt(t, i, e, n) {
  return (
    n <= 0 ? (t = i = e = NaN) : e <= 0 || e >= 1 ? (t = i = NaN) : i <= 0 && (t = NaN),
    new x(t, i, e, n)
  );
}
function lt(t) {
  if (t instanceof x) return new x(t.h, t.s, t.l, t.opacity);
  if ((t instanceof N || (t = Y(t)), !t)) return new x();
  ...
  return (
    h
      ? (i === r
        ...
        (o *= 60))
      : (h = a > 0 && a < 1 ? 0 : o),
    new x(o, h, a, t.opacity)
  );
}
function At(t, i, e, n) {
  return arguments.length === 1 ? lt(t) : new x(t, i, e, n ?? 1);
}
function x(t, i, e, n) {
  ...
  ct(N, {
    ...
    rgb() {
      var t = (this.h % 360) + (this.h < 0) * 360,
        ...
        s = 2 * e - n;
      return new _(
        z(t >= 240 ? t - 240 : t + 120, s, n),
        z(t, s, n),
        z(t < 120 ? t + 240 : t - 120, s, n),
        this.opacity,
      );
    },
    clamp() {
      return new x(st(this.h), k(this.s), k(this.l), E(this.opacity));
    },
    displayable() {
      return (
    ...
    formatHsl() {
      const t = E(this.opacity);
      return `${t === 1 ? 'hsl(' : 'hsla('}${st(this.h)}, ${k(this.s) * 100}%, ${k(this.l) * 100}%${t === 1 ? ')' : `, ${t})`}`;
    },
  }),
);
function st(t) {
...
function z(t, i, e) {
  return (
    (t < 60 ? i + ((e - i) * t) / 60 : t < 180 ? e : t < 240 ? i + ((e - i) * (240 - t)) / 60 : i) *
    255
  );
}
const G = (t) => () => t;
...
function Kt(t, i) {
  var e = i - t;
  return e ? ut(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e) : G(isNaN(t) ? i : t);
}
function It(t) {
  return (t = +t) == 1
    ? _t
    : function (i, e) {
        return e - i ? Bt(i, e, t) : G(isNaN(i) ? e : i);
      };
}
function _t(t, i) {
  var e = i - t;
  return e ? ut(t, e) : G(isNaN(t) ? i : t);
}
const Ut = (function t(i) {
  var e = It(i);
  function n(s, r) {
    var o = e((s = I(s)).r, (r = I(r)).r),
      h = e(s.g, r.g),
      a = e(s.b, r.b),
      f = _t(s.opacity, r.opacity);
    return function (c) {
...
function Vt(t, i) {
  var e = (L.lastIndex = A.lastIndex = 0),
    n,
    s,
    r,
    o = -1,
    h = [],
    a = [];
  for (t = t + '', i = i + ''; (n = L.exec(t)) && (s = A.exec(i)); )
    ((r = s.index) > e && ((r = i.slice(e, r)), h[o] ? (h[o] += r) : (h[++o] = r)),
      (n = n[0]) === (s = s[0])
        ? h[o]
          ? (h[o] += s)
          : (h[++o] = s)
        : ((h[++o] = null), a.push({ i: o, x: Lt(n, s) })),
      (e = A.lastIndex));
  return (
    e < i.length && ((r = i.slice(e)), h[o] ? (h[o] += r) : (h[++o] = r)),
    h.length < 2
      ? a[0]
        ? Ot(a[0].x)
        : jt(i)
...
function xt(t) {
  this._ += t[0];
  for (let i = 1, e = t.length; i < e; ++i) this._ += arguments[i] + t[i];
}
function Yt(t) {
  let i = Math.floor(t);
  ...
  return function (n) {
    this._ += n[0];
    for (let s = 1, r = n.length; s < r; ++s) this._ += Math.round(arguments[s] * e) / e + n[s];
  };
}
class Gt {
  constructor(i) {
  ...
  arcTo(i, e, n, s, r) {
    ...
    let o = this._x1,
      ...
      l = h - e,
      u = c * c + l * l;
    if (this._x1 === null) this._append`M${(this._x1 = i)},${(this._y1 = e)}`;
    else if (u > b)
      if (!(Math.abs(l * a - f * c) > b) || !r) this._append`L${(this._x1 = i)},${(this._y1 = e)}`;
      else {
        let d = n - o,
          H = s - h,
          Z = a * a + f * f,
          ...
          D = Math.sqrt(Z),
          F = Math.sqrt(u),
          J = r * Math.tan((j - Math.acos((Z + u - Nt) / (2 * D * F))) / 2),
          q = J / F,
          K = J / D;
        (Math.abs(q - 1) > b && this._append`L${i + q * c},${e + q * l}`,
          this
            ._append`A${r},${r},0,0,${+(l * d > c * H)},${(this._x1 = i + K * a)},${(this._y1 = e + K * f)}`);
      }
  }
  arc(i, e, n, s, r, o) {
    ...
    (this._x1 === null
      ? this._append`M${f},${c}`
      : (Math.abs(this._x1 - f) > b || Math.abs(this._y1 - c) > b) && this._append`L${f},${c}`,
      n &&
        (u < 0 && (u = (u % O) + O),
        u > Xt
          ? this
              ._append`A${n},${n},0,1,${l},${i - h},${e - a}A${n},${n},0,1,${l},${(this._x1 = f)},${(this._y1 = c)}`
          : u > b &&
            this
              ._append`A${n},${n},0,${+(u >= j)},${l},${(this._x1 = i + n * Math.cos(r))},${(this._y1 = e + n * Math.sin(r))}`));
  }
  rect(i, e, n, s) {
    this
      ._append`M${(this._x0 = this._x1 = +i)},${(this._y0 = this._y1 = +e)}h${(n = +n)}v${+s}h${-n}Z`;
  }
  toString() {
    return this._;
  }
...
function ci(t, i) {
  var e = y(!0),
    ...
    r = null,
    o = Qt(h);
  ((t = typeof t == 'function' ? t : t === void 0 ? Ft : y(t)),
    (i = typeof i == 'function' ? i : i === void 0 ? Jt : y(i)));
  function h(a) {
    var f,
      c = (a = Zt(a)).length,
      l,
    ...
    for (n == null && (r = s((d = o()))), f = 0; f <= c; ++f)
      (!(f < c && e((l = a[f]), f, a)) === u && ((u = !u) ? r.lineStart() : r.lineEnd()),
        u && r.point(+t(l, f, a), +i(l, f, a)));
...
yt.prototype = {
  ...
  point: function (t, i) {
    ((t = +t),
      (i = +i),
      this._point ? this._context.lineTo(t, i) : ((this._point = 1), this._context.moveTo(t, i)));
  },
};
function di(t) {
  return new yt(t);
...
function ht(t, i, e) {
  var n = t._x1 - t._x0,
    s = i - t._x1,
    r = (t._y1 - t._y0) / (n || (s < 0 && -0)),
    o = (e - t._y1) / (s || (n < 0 && -0)),
    h = (r * s + o * n) / (n + s);
  return (ot(r) + ot(o)) * Math.min(Math.abs(r), Math.abs(o), 0.5 * Math.abs(h)) || 0;
}
function at(t, i) {
  var e = t._x1 - t._x0;
  ...
  lineEnd: function () {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        B(this, this._t0, at(this, this._t0));
        break;
    }
    ((this._line || (this._line !== 0 && this._point === 1)) && this._context.closePath(),
      (this._line = 1 - this._line));
    ...
    if (((t = +t), (i = +i), !(t === this._x1 && i === this._y1))) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          ((this._point = 3), B(this, at(this, (e = ht(this, t, i))), e));
          break;
        default:
          B(this, this._t0, (e = ht(this, t, i)));
          break;
      }
      ((this._x0 = this._x1),
        (this._x1 = t),
...
function wt(t) {
  this._context = new $t(t);
}
(wt.prototype = Object.create(R.prototype)).point = function (t, i) {
...
vt.prototype = {
  ...
  lineEnd: function () {
    ...
    if (e)
      if (
        (this._line ? this._context.lineTo(t[0], i[0]) : this._context.moveTo(t[0], i[0]), e === 2)
      )
        this._context.lineTo(t[1], i[1]);
      else
        for (var n = ft(t), s = ft(i), r = 0, o = 1; o < e; ++r, ++o)
...
function ft(t) {
  var i,
    ...
    r = new Array(e),
    o = new Array(e);
  for (s[0] = 0, r[0] = 2, o[0] = t[0] + 2 * t[1], i = 1; i < e - 1; ++i)
    ((s[i] = 1), (r[i] = 4), (o[i] = 4 * t[i] + 2 * t[i + 1]));
  for (s[e - 1] = 2, r[e - 1] = 7, o[e - 1] = 8 * t[e - 1] + t[e], i = 1; i < e; ++i)
    ((n = s[i] / r[i - 1]), (r[i] -= n), (o[i] -= n * o[i - 1]));
