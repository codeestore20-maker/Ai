import {
  ...
  g,
  h as P,
} from './index-D75tDTkj.js';
import { d as N } from './index-DqaPMvSy.js';
import { S as A } from './base-80a1f760-IPNbIDMK.js';
import { g as $ } from '../vendor/vendor-emotion-DdM-9MtU.js';
...
var G = (function () {
    function r(o, e, n) {
      ...
      ((this.type = o),
        ...
        (this.protocol = n),
        (this._disposeMessageListener = this.protocol.channelListen(function (a) {
            ...
            return q(this, function (u) {
              switch (u.label) {
                ...
                case 2:
                  return (
                    (c = u.sent()),
                    (l = { type: this.getTypeId(), msgId: i.msgId, result: c }),
                ...
                case 3:
                  return (
                    (p = u.sent()),
                    (l = { type: this.getTypeId(), msgId: i.msgId, error: { message: p.message } }),
                    this.protocol.dispatch(l),
                    [3, 4]
                  );
                case 4:
  ...
  Y = (function () {
    function r(o, e) {
      ((this.globalListeners = {}),
        ...
        (this.frameWindow = o.contentWindow),
        (this.origin = e),
        (this.globalListeners = []),
        (this.channelListeners = []),
    ...
    return (
      ...
      (r.prototype.dispatch = function (o) {
        this.frameWindow &&
          this.frameWindow.postMessage(x({ $id: this.channelId, codesandbox: !0 }, o), this.origin);
      }),
      ...
      (r.prototype.eventListener = function (o) {
        if (o.source === this.frameWindow) {
          var e = o.data;
          e.codesandbox &&
            (Object.values(this.globalListeners).forEach(function (n) {
              return n(e);
            }),
            e.$id === this.channelId &&
              Object.values(this.channelListeners).forEach(function (n) {
                return n(e);
              }));
        }
      }),
...
function ea(r, o) {
  ...
  if (
    i.indexOf('@sveltech/routify') > -1 ||
    i.indexOf('@roxi/routify') > -1 ||
    i.indexOf('vite') > -1 ||
    i.indexOf('@frontity/core') > -1
  )
    return 'node';
...
var y,
  L = '-{{suffix}}',
  na = 'https://'
    .concat((y = '2.19.8') === null || y === void 0 ? void 0 : y.replace(/\./g, '-'))
    .concat(L, '-sandpack.codesandbox.io/'),
  zn = (function (r) {
    C(o, r);
    function o(e, n, s) {
      s === void 0 && (s = {});
      ...
      if (
        ((a.getTranspilerContext = function () {
          return new Promise(function (c) {
            var p = a.listen(function (l) {
              l.type === 'transpiler-context' && (c(l.data), p());
            });
            a.dispatch({ type: 'get-transpiler-context' });
          });
        }),
        (a.getTranspiledFiles = function () {
          return new Promise(function (c) {
            ...
            a.dispatch({ type: 'get-modules' });
          });
        }),
        (a.bundlerURL = a.createBundlerURL()),
        (a.bundlerState = void 0),
        (a.errors = []),
        ...
        (F(i, "The element '".concat(e, "' was not found")),
          (a.element = i),
      ...
      return (
        ...
        a.setLocationURLIntoIFrame(),
        (a.iframeProtocol = new Y(a.iframe, a.bundlerURL)),
        (a.unsubscribeGlobalListener = a.iframeProtocol.globalListen(function (c) {
          c.type !== 'initialized' ||
            !a.iframe.contentWindow ||
            (a.iframeProtocol.register(),
            a.options.fileResolver &&
              (a.fileResolverProtocol = new G(
                'fs',
                function (p) {
                  return z(a, void 0, void 0, function () {
                    return q(this, function (l) {
                      if (p.method === 'isFile')
                        return [2, this.options.fileResolver.isFile(p.params[0])];
                      if (p.method === 'readFile')
                        return [2, this.options.fileResolver.readFile(p.params[0])];
            ...
            a.updateSandbox(a.sandboxSetup, !0));
        })),
        (a.unsubscribeChannelListener = a.iframeProtocol.channelListen(function (c) {
          switch (c.type) {
            ...
            case 'action': {
              c.action === 'show-error' && (a.errors = g(g([], a.errors, !0), [P(c)], !1));
              break;
            }
            case 'done': {
              a.status = 'done';
        ...
        s.experimental_enableServiceWorker && a.serviceWorkerHandshake(),
        a
      );
    }
    return (
      (o.prototype.createBundlerURL = function () {
        var e,
          n = this.options.bundlerURL || na;
        if (this.options.bundlerURL) return n;
        if (
          (this.options.teamId &&
            (n =
              n.replace('https://', 'https://' + this.options.teamId + '-') +
              '?cache='.concat(Date.now())),
          this.options.experimental_enableServiceWorker)
        ) {
          var s = [];
          (s.push(Math.random().toString(36).slice(4)),
            (n = n.replace(
              L,
              '-'.concat(
                (e = this.options.experimental_stableServiceWorkerId) !== null && e !== void 0
                  ? e
                  : s.join('-'),
              ),
            )));
      ...
      (o.prototype.serviceWorkerHandshake = function () {
        ...
        a.onmessage = function (c) {
          if (typeof c.data == 'object' && c.data.$channel === f)
            switch (c.data.$type) {
              case 'preview/ready':
                break;
        ...
        var i = function () {
          var c = { $channel: f, $type: 'preview/init' };
          ...
          return q(this, function (b) {
            switch (b.label) {
              ...
              case 1:
                return (
                  b.trys.push([1, 4, , 5]),
                  (a = new URL(e.url, this.bundlerURL).pathname),
                  (i = {}),
                  (c = this.getFiles()),
                  (p = c[a]),
                  p ? [3, 3] : [4, this.getTranspiledFiles()]
                );
              case 2:
                if (
                  ((l = b.sent()),
              ...
              case 3:
                return (
                  (u = p.code),
                  i['Content-Type'] || ((v = ia(a)), (d = Z.get(v)), d && (i['Content-Type'] = d)),
                  (m = {
                    $channel: f,
                    $type: 'preview/response',
                    id: e.id,
      ...
      (o.prototype.setLocationURLIntoIFrame = function () {
        var e,
          n = this.options.startRoute
            ? new URL(this.options.startRoute, this.bundlerURL).toString()
            : this.bundlerURL;
        ((e = this.iframe.contentWindow) === null || e === void 0 || e.location.replace(n),
          (this.iframe.src = n));
      }),
      ...
      (o.prototype.updateOptions = function (e) {
        N(this.options, e) || ((this.options = e), this.updateSandbox());
      }),
      (o.prototype.updateSandbox = function (e, n) {
        var s, a, i, c;
        (e === void 0 && (e = this.sandboxSetup),
          (this.sandboxSetup = x(x({}, this.sandboxSetup), e)));
        var p = this.getFiles(),
          l = Object.keys(p).reduce(function (d, m) {
            var t;
            return x(x({}, d), ((t = {}), (t[m] = { code: p[m].code, path: m }), t));
          }, {}),
          u = JSON.parse(
            E(
        ...
        var v = Object.keys(p).reduce(function (d, m) {
          var t;
          return x(x({}, d), ((t = {}), (t[m] = { content: p[m].code, path: m }), t));
        }, {});
        this.dispatch(
          x(x({}, this.options), {
            type: 'compile',
            ...
            template: this.sandboxSetup.template || ea(u, v),
            showOpenInCodeSandbox:
              (s = this.options.showOpenInCodeSandbox) !== null && s !== void 0 ? s : !0,
            showErrorScreen: (a = this.options.showErrorScreen) !== null && a !== void 0 ? a : !0,
            showLoadingScreen:
              (i = this.options.showLoadingScreen) !== null && i !== void 0 ? i : !1,
      ...
      (o.prototype.dispatch = function (e) {
        (e.type === 'refresh' &&
          ...
          this.options.experimental_enableServiceWorker && this.serviceWorkerHandshake()),
      ...
      (o.prototype.getCodeSandboxURL = function () {
        var e = this.getFiles(),
          n = Object.keys(e).reduce(function (s, a) {
            ...
            return x(
              x({}, s),
              ((i = {}), (i[a.replace('/', '')] = { content: e[a].code, isBinary: !1 }), i),
            );
          }, {});
      ...
      (o.prototype.getFiles = function () {
        ...
        return e.files['/package.json'] === void 0
          ? D(e.files, e.dependencies, e.devDependencies, e.entry)
      ...
      (o.prototype.initializeElement = function () {
        ((this.iframe.style.border = '0'),
          ...
          F(this.element.parentNode, 'The given iframe does not have a parent.'),
          this.element.parentNode.replaceChild(this.iframe, this.element));
      }),
      o
    );
  })(A);
export { zn as SandpackRuntime };
