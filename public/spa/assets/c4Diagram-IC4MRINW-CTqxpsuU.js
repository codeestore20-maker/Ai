import { g as Se, d as De } from './chunk-JSJVCQXG-CfnTNoLr.js';
import {
  s as Pe,
  g as Be,
  a as Ie,
...
var Ue = Ft,
  ...
  Je = g(function (e, t, s, o, l, a, r, n, i, u, d) {
    let y = V.find((f) => f.alias === t);
    if (!(y === void 0 && ((y = X.find((f) => f.alias === t)), y === void 0))) {
      if (s != null)
        if (typeof s == 'object') {
  ...
  y0 = g((e, t, s) => {
    ...
    for (let a of t) {
      ...
      if (l === 0) {
        let f = o.append('line');
        (f.attr('x1', a.startPoint.x),
          f.attr('y1', a.startPoint.y),
          f.attr('x2', a.endPoint.x),
          f.attr('y2', a.endPoint.y),
          f.attr('stroke-width', '1'),
          f.attr('stroke', n),
          f.style('fill', 'none'),
          a.type !== 'rel_b' && f.attr('marker-end', 'url(' + d + '#arrowhead)'),
          (a.type === 'birel' || a.type === 'rel_b') &&
            f.attr('marker-start', 'url(' + d + '#arrowend)'),
          (l = -1));
      } else {
        let f = o.append('path');
        (f
  ...
  Q = (function () {
    ...
    function t(l, a, r, n, i, u, d, y) {
      const { fontSize: f, fontFamily: E, fontWeight: O } = y,
        S = l.split($t.lineBreakRegex);
      for (let P = 0; P < S.length; P++) {
        const M = P * f - (f * (S.length - 1)) / 2,
          U = a
            .append('text')
            .attr('x', r + i / 2)
            .attr('y', n)
...
var ke = g(function (e, t, s) {
  ...
  Ae = g(function (e, t, s, o) {
    ...
    for (const a of o) {
      ...
      ((f = f + _.c4ShapePadding),
        (r.width = Math.max(r.width || _.width, f, _.width)),
    ...
    return (
      o == a && s < l
        ...
        : o == a && s > l
          ? (f = new Y(s, n))
          : s == l && o < a
            ? (f = new Y(r, o + e.height))
            : s == l && o > a && (f = new Y(r, o)),
      s > l && o < a
        ? y >= d
          ? (f = new Y(s, n + (d * e.width) / 2))
          : (f = new Y(r - ((i / u) * e.height) / 2, o + e.height))
        : s < l && o < a
          ? y >= d
            ? (f = new Y(s + e.width, n + (d * e.width) / 2))
            : (f = new Y(r + ((i / u) * e.height) / 2, o + e.height))
          : s < l && o > a
            ? y >= d
              ? (f = new Y(s + e.width, n - (d * e.width) / 2))
              : (f = new Y(r + ((e.height / 2) * i) / u, o))
            : s > l &&
              o > a &&
              (y >= d
                ? (f = new Y(s, n - (e.width / 2) * d))
                : (f = new Y(r - ((e.height / 2) * i) / u, o))),
      f
    );
  }, 'getIntersectPoint'),
...
function se(e, t, s, o, l) {
  ...
  for (let [r, n] of o.entries()) {
    ...
    let y = l.db.getC4ShapeArray(n.alias),
      f = l.db.getC4ShapeKeys(n.alias);
    (f.length > 0 && Ae(a, e, y, f), (t = n.alias));
...
var S0 = g(function (e, t, s, o) {
    ...
    (se(i, '', u, y, o),
      ...
      (u.data.stopy = Wt));
    const f = u.data;
    let O = f.stopy - f.starty + 2 * _.diagramMarginY;
    const P = f.stopx - f.startx + 2 * _.diagramMarginX;
    (d &&
      i
        .append('text')
        .text(d)
        .attr('x', (f.stopx - f.startx) / 2 - 4 * _.diagramMarginX)
        .attr('y', f.starty + _.diagramMarginY),
      Le(i, O, P, _.useMaxWidth));
    const M = d ? 60 : 0;
    (i.attr(
      'viewBox',
      f.startx - _.diagramMarginX + ' -' + (_.diagramMarginY + M) + ' ' + P + ' ' + (O + M),
    ),
      de.debug('models:', f));
  }, 'draw'),
