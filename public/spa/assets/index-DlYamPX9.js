...
import { a as e } from './providerConfig-B8LLUHQ4.js';
import { F as a } from './FormInput-BLnf1VK8.js';
import { F as s } from './FormPassword-DyHi6YXP.js';
import { P as l, S as m } from './index-Bgx7tZQB.js';
import { u as n } from './store-D4ebFM1W.js';
import { K as p } from './index-3vxyno4e.js';
import { g as c } from './index-wqF_YeCD.js';
import { a as d } from './selectors-ByZlqqp9.js';
...
const o = 'cloudflare',
  u = () => {
    const { t: r } = c('modelProvider'),
      i = n(d.isAiProviderConfigLoading(o));
    return {
      ...e,
      apiKeyItems: [
        {
          children: i
            ? t.jsx(m, {})
            : t.jsx(s, { autoComplete: 'new-password', placeholder: r(`${o}.apiKey.placeholder`) }),
          desc: r(`${o}.apiKey.desc`),
          label: r(`${o}.apiKey.title`),
          name: [p, 'apiKey'],
        },
        {
          children: i
            ? t.jsx(m, {})
            : t.jsx(a, { placeholder: r(`${o}.baseURLOrAccountID.placeholder`) }),
          desc: r(`${o}.baseURLOrAccountID.desc`),
          label: r(`${o}.baseURLOrAccountID.title`),
          name: [p, 'baseURLOrAccountID'],
        },
      ],
    };
  },
