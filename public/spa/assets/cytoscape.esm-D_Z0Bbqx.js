import { aF as To } from './index-wqF_YeCD.js';
function Bs(r, e) {
...
function ac(r, e) {
  for (var t = 0; t < e.length; t++) {
    ...
    ((a.enumerable = a.enumerable || !1),
      ...
      Object.defineProperty(r, ev(a.key), a));
  }
}
function gt(r, e, t) {
...
var rr = typeof window > 'u' ? null : window,
  So = rr ? rr.navigator : null;
rr && rr.document;
var lc = ar(''),
  rv = ar({}),
  vc = ar(function () {}),
  fc = typeof HTMLElement > 'u' ? 'undefined' : ar(HTMLElement),
  La = function (e) {
  ...
  Ue = function (e) {
    return e != null && ar(e) === vc;
  },
  _e = function (e) {
    return !Dr(e) && (Array.isArray ? Array.isArray(e) : e != null && e instanceof Array);
  },
  Le = function (e) {
    return e != null && ar(e) === rv && !_e(e) && e.constructor === Object;
  },
  cc = function (e) {
    return e != null && ar(e) === rv;
  },
  ae = function (e) {
  ...
  sv = function (e) {
    return (_e(e) ? e : null) || Pc(e) || kc(e) || Bc(e) || Dc(e);
  },
  Ac = {
    transparent: [0, 0, 0, 0],
...
var Go = !0,
  Kc = console.warn != null,
  Xc = console.trace != null,
  ...
  qr = function (e) {
    return e == null ? e : _e(e) ? e.slice() : Le(e) ? Yc(e) : e;
  },
  Zc = function (e) {
    return e.slice();
  },
  ...
  ra = (typeof Set > 'u' ? 'undefined' : ar(Set)) !== ed ? Set : rd,
  In = function (e, t) {
  ...
  Sa = { breadthFirstSearch: Wo({ bfs: !0 }), depthFirstSearch: Wo({ dfs: !0 }) };
...
var $d = cr({ weight: null, directed: !1 }),
  Rs = {
...
var Ud = cr({
  ...
  th = function (e) {
    for (var t = 0; t < e.length; t++)
      for (var a = 0; a < e.length; a++) t != a && rh(e[t], e[a]) && e.splice(a, 1);
    return e;
  },
  Qo = function (e) {
    for (
      var t = this.nodes(), a = this.edges(), n = this.cy(), i = Kd(e), s = {}, o = 0;
      o < t.length;
      o++
    )
      s[t[o].id()] = o;
    ...
    (Yd(v, l, i.multFactor), Tv(v, l));
    for (var m = !0, b = 0; m && b < i.maxIterations; )
      ((m = !1),
        (f = Qd(v, l, i.expandFactor)),
        (v = Jd(f, l, i.inflateFactor)),
        jd(v, f, u, 4) || (m = !0),
        b++);
    var w = eh(v, l, t, n);
    return ((w = th(w)), w);
  },
  ah = { markovClustering: Qo, mcl: Qo },
  nh = function (e) {
    return e;
  },
  Sv = function (e, t) {
  ...
  va = function (e, t, a, n, i) {
    for (
      var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : nh,
        o = n,
        l,
        u,
        v = 0;
  ...
  Jt = {
    euclidean: function (e, t, a) {
      return e >= 2 ? va(e, t, a, 0, jo, ih) : va(e, t, a, 0, Jo);
    },
...
var oh = cr({
  ...
  fh = function (e) {
    ...
    for (var u = !0, v = 0; u && v < i.maxIterations; ) {
      for (var f = 0; f < a.length; f++)
        ((n = a[f]), (o[n.id()] = kv(n, l, i.distance, i.attributes, 'kMeans')));
      u = !1;
      for (var c = 0; c < i.k; c++) {
        var h = Dv(c, a, o);
        if (h.length !== 0) {
          for (
            ...
            ((g[m] = p[m] / h.length), uh(g[m], y[m], i.sensitivityThreshold) || (u = !0));
          }
  ...
  ch = function (e) {
    ...
    i.testMode
      ? typeof i.testCentroids == 'number' ||
        (ar(i.testCentroids) === 'object' ? (o = i.testCentroids) : (o = eu(a, i.k)))
      : (o = eu(a, i.k));
    for (var f = !0, c = 0; f && c < i.maxIterations; ) {
      for (var h = 0; h < a.length; h++)
        ((n = a[h]), (l[n.id()] = kv(n, o, i.distance, i.attributes, 'kMedoids')));
      f = !1;
      for (var d = 0; d < o.length; d++) {
        var y = Dv(d, a, l);
        if (y.length !== 0) {
          v[d] = ru(o[d], y, i.attributes);
          for (var g = 0; g < y.length; g++)
            ((u = ru(y[g], y, i.attributes)), u < v[d] && ((v[d] = u), (o[d] = y[g]), (f = !0)));
          s[d] = t.collection(y);
        }
      }
      c++;
  ...
  tu = function (e) {
    ...
    for (var m = !0, b = 0; m && b < n.maxIterations; )
      ((m = !1),
        dh(s, a, o, u, n),
        hh(o, l, s, a, n),
        lh(o, l, n.sensitivityThreshold) || (m = !0),
        b++);
    return ((i = gh(a, o, n, t)), { clusters: i, degreeOfMembership: o });
  },
  ph = { kMeans: fh, kMedoids: ch, fuzzyCMeans: tu, fcm: tu },
  yh = cr({
    distance: 'euclidean',
    linkage: 'min',
    mode: 'threshold',
  ...
  mh = { single: 'min', complete: 'max' },
  bh = function (e) {
    var t = yh(e),
      a = mh[t.linkage];
    return (a != null && (t.linkage = a), t);
  },
  au = function (e, t, a, n, i) {
    for (
      var s = 0,
        o = 1 / 0,
        l,
  ...
  nu = function (e) {
    ...
    for (var g = au(o, v, l, u, n); g; ) g = au(o, v, l, u, n);
    var p;
    return (
      n.mode === 'dendrogram'
  ...
  wh = { hierarchicalClustering: nu, hca: nu },
  xh = cr({
    distance: 'euclidean',
    preference: 'median',
    damping: 0.8,
  ...
  su = function (e) {
    ...
    for (var d = 0; d < o; d++)
      for (var y = 0; y < o; y++)
        d !== y && (u[d * o + y] = Ch(n.distance, a[d], a[y], n.attributes));
    v = Th(u, n.preference);
    ...
    for (var re = Sh(o, f, c), ne = kh(o, u, re), J = {}, z = 0; z < re.length; z++) J[re[z]] = [];
  ...
  Dh = { affinityPropagation: su, ap: su },
  Bh = cr({ root: void 0, directed: !1 }),
  Ph = {
  ...
  Rh = { tarjanStronglyConnected: Ja, tsc: Ja, tscc: Ja, tarjanStronglyConnectedComponents: Ja },
  Bv = {};
[Sa, od, ud, vd, cd, hd, yd, Wd, Xt, Yt, Rs, ah, ph, wh, Dh, Ph, Ah, Rh].forEach(function (r) {
  be(Bv, r);
});
var Pv = 0,
  Av = 1,
...
Nr.prototype = {
  ...
  then: function (e, t) {
    var a = this,
      n = new Nr();
    return (
      a.onFulfilled.push(lu(e, n, 'fulfill')),
      a.onRejected.push(lu(t, n, 'reject')),
      Mv(a),
      n.proxy
    );
  },
};
var ou = function (e, t, a, n) {
    return (e.state === Pv && ((e.state = t), (e[a] = n), Mv(e)), e);
  },
  Mv = function (e) {
    e.state === Av
      ? uu(e, 'onFulfilled', e.fulfillValue)
      : e.state === Rv && uu(e, 'onRejected', e.rejectReason);
  },
  uu = function (e, t, a) {
    if (e[t].length !== 0) {
      var n = e[t];
    ...
    if (typeof a == 'function') {
      ...
      try {
        a.call(
          ...
          function (i) {
            n ||
              ((n = !0), i === t ? e.reject(new TypeError('circular thenable chain')) : Lv(e, i));
          },
          function (i) {
            n || ((n = !0), e.reject(i));
          },
    ...
    if (a && a.isNode())
      if (l)
        for (var u = 0; u < this.length; u++) {
          var v = this[u];
          t !== void 0 ? v.position(e, (t - s[e]) / i) : o !== void 0 && v.position(mv(o, i, s));
        }
      else {
        var f = a.position();
...
var Ar = function (e) {
  ...
  Ug = function (e, t) {
    ...
    if (b) {
      ...
      (Ko(Y, s), ln(Y, p), un(Y, 1));
      var te = (o.labelBounds = o.labelBounds || {});
      (te.all != null ? Dd(te.all) : (te.all = wr()),
        n &&
          t.includeLabels &&
  ...
  ll = function (e, t) {
    ...
    if (
      (a.bbCache == null
        ? ((n = Ug(e, Pa)), (a.bbCache = n), (a.bbCachePosKey = Kv(e)))
        : (n = a.bbCache),
      !o)
    ) {
      var l = e.isNode();
...
pt.boundingBox = function (r) {
  ...
  if (t && this.length === 1 && !a(this[0]))
    (r === void 0 ? (r = Pa) : (r = fl(r)), (e = ll(this[0], r)));
  else {
    ((e = wr()), (r = r || Pa));
    var n = fl(r),
      i = this,
    ...
    for (var l = 0; l < i.length; l++) {
      var u = i[l];
      (a(u) && u.dirtyBoundingBoxCache(), tt(e, ll(u, n)));
    }
  }
  return (
    (e.x1 = Ar(e.x1)),
    ...
    (ma[e.name] = function () {
      ...
      if (a)
        if (s) {
          ...
          return o.strValue === 'label'
            ? (a.recalculateRenderedStyle(), n.rstyle[e.labelName] || 0)
            : o.pfValue;
        } else return 1;
    }),
...
var Xg = qa,
  ...
  np = Object.keys(cl).reduce(function (r, e) {
    var t = cl[e],
      a = ap(e);
    return (
      (r[e] = function () {
...
function Gn() {
  for (
    var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : op,
    ...
    for (var n = _e(a) ? a : a.split(/\s+/), i = 0; i < n.length; i++) {
      ...
      if (!ut(s)) {
        ...
        if (o) {
          var l = o[1],
            u = o[2] ? o[2] : null,
            v = hl(e, { type: l, namespace: u, target: e.context });
          t(e, v);
        }
      }
    }
      ...
      function (i, s) {
        ...
        for (
          var o = function () {
              ...
              if (
                v.type === s.type &&
                (!v.namespace || v.namespace === s.namespace || v.namespace === sp) &&
  ...
  jv = {
    createEmitter: function () {
      for (var e = 0; e < this.length; e++) {
        var t = this[e],
          a = t._private;
        a.emitter || (a.emitter = new Gn(lp, t));
      }
      return this;
    },
    emitter: function () {
...
fp();
var cp = cr({ nodeDimensionsIncludeLabels: !1 }),
  fn = {
...
be(gr, {
  ...
  outgoers: Rr(yl({ outgoing: !0 }), 'outgoers'),
  successors: ml({ outgoing: !0 }),
  incomers: Rr(yl({ incoming: !0 }), 'incomers'),
  predecessors: ml({}),
});
be(gr, {
...
be(gr, { edgesWith: Rr(wl(), 'edgesWith'), edgesTo: Rr(wl({ thisIsSrc: !0 }), 'edgesTo') });
function wl(r) {
  return function (t) {
    var a = [],
      n = this._private.cy,
...
be(gr, {
  ...
  parallelEdges: Rr(xl(), 'parallelEdges'),
  codirectedEdges: Rr(xl({ codirected: !0 }), 'codirectedEdges'),
});
function xl(r) {
  var e = { codirected: !1 };
  return (
...
He.collection = function () {
  return tv(this) ? this : new fr(this._private.cy, [this]);
};
He.unique = function () {
...
[Bv, Dg, vn, st, jt, Hg, _n, ip, jv, ef, vp, Sn, fn, vr, ot, gr].forEach(function (r) {
  be(He, r);
});
var yp = {
  add: function (e) {
...
function zt(r, e, t, a, n) {
  ...
  var s = Cl(r, n),
    o = Cl(e, n);
  if (ae(s) && ae(o)) return El(i, s, o, t, a);
  if (_e(s) && _e(o)) {
...
var Ep = {
  ...
  af = {
    createEmitter: function () {
      var e = this._private;
      return (e.emitter || (e.emitter = new Gn(Cp, this)), this);
    },
    emitter: function () {
      return this._private.emitter;
    },
...
Un.parseImpl = function (r, e, t, a) {
  ...
  if (u.number) {
    ...
    return (
      ...
      (P === 'deg' || P === 'rad') && (I.pfValue = P === 'rad' ? e : Cd(e)),
      P === '%' && (I.pfValue = e / 100),
      I
    );
  } else if (u.propList) {
...
var Dp = {
  ...
  At = {
    ...
    selectionType: function (e) {
      var t = this._private;
      if ((t.selectionType == null && (t.selectionType = Bp), e !== void 0))
...
[yp, Ep, af, zs, dn, Tp, Fs, hn, Dp, At, Aa].forEach(function (r) {
  be(kn, r);
});
var Pp = {
    fit: !0,
...
nf.prototype.run = function () {
  ...
  var p = [],
    ...
    b = function (ie, de) {
      p[de] == null && (p[de] = []);
      var he = p[de].length;
      (p[de].push(ie), Sl(ie, { index: he, depth: de }));
    },
    w = function (ie, de) {
      var he = Ft(ie),
        Ee = he.depth,
  ...
  var we = function (ie) {
    return Uc(Ae(ie), l, Ce[r.direction]);
  };
...
function Kn(r) {
  ((this.options = be({}, Lp, r)), (this.options.layout = this));
  ...
  var n = Yr(),
    ...
    s = function (c) {
      return !(
        t.stopped ||
        c >= r.numIter ||
        (Vp(a, r), (a.temperature = a.temperature * r.coolingFactor), a.temperature < r.minTemp)
      );
    },
    o = function () {
...
var Ip = function (e, t, a) {
    ...
    for (var v = 0; v < o.edgeSize; v++) {
      ...
      if (M != O) {
        for (
          var V = Op(P.sourceId, P.targetId, o), G = o.graphSet[V], N = 0, g = o.layoutNodes[L];
          G.indexOf(g.id) === -1;
        )
...
var Yp = { ready: function () {}, stop: function () {} };
function ho(r) {
...
var Jp = [
  { name: 'breadthfirst', impl: nf },
  { name: 'circle', impl: sf },
  { name: 'concentric', impl: of },
  { name: 'cose', impl: Kn },
  { name: 'grid', impl: ff },
  { name: 'null', impl: ho },
  { name: 'preset', impl: cf },
...
go.registerArrowShapes = function () {
  ...
  (o('none', { collide: xn, roughCollide: xn, draw: js, spacing: Ho, gap: Ho }),
  ...
  function m(x) {
    ...
    if (k.edgeType === 'segments' || k.edgeType === 'straight' || k.edgeType === 'haystack') {
      for (var I = k.allpts, M = 0; M + 3 < I.length; M += 2)
        if (
          Md(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], R) &&
          A > (L = zd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3]))
        )
          return (g(x, L), !0);
    } else if (
      k.edgeType === 'bezier' ||
      ...
      for (var I = k.allpts, M = 0; M + 5 < k.allpts.length; M += 4)
        if (
          Ld(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5], R) &&
          A > (L = Nd(r, e, I[M], I[M + 1], I[M + 2], I[M + 3], I[M + 4], I[M + 5]))
        )
          return (g(x, L), !0);
    }
    for (
...
var Vs,
  ...
  ey = function (e, t, a, n, i) {
    if (
      (e !== Ml ? Ll(t, e, Vr) : jp(Pr, Vr),
      Ll(t, a, Pr),
      (Al = Vr.nx * Pr.ny - Vr.ny * Pr.nx),
      (Rl = Vr.nx * Pr.nx - Vr.ny * -Pr.ny),
      (Ur = Math.asin(Math.max(-1, Math.min(1, Al)))),
      Math.abs(Ur) < 1e-6)
    ) {
...
Ga.getSourceEndpoint = function (r) {
  ...
  return (
    this.recalculateRenderedStyle(r),
    e.edgeType === 'haystack'
      ? { x: e.haystackPts[0], y: e.haystackPts[1] }
      : { x: e.arrowStartX, y: e.arrowStartY }
  );
};
Ga.getTargetEndpoint = function (r) {
  ...
  return (
    this.recalculateRenderedStyle(r),
    e.edgeType === 'haystack'
      ? { x: e.haystackPts[2], y: e.haystackPts[3] }
      : { x: e.arrowEndX, y: e.arrowEndY }
  );
};
var yo = {};
function ty(r, e, t) {
        ...
        if (i[f]) {
          ...
          switch (a.edgeType) {
            ...
            case 'multibezier': {
              ...
              ((P = ka(0, P, 1)), (e = Kt(T.p0, T.p1, T.p2, P)), (c = ay(T.p0, T.p1, T.p2, P)));
              break;
            }
            case 'straight':
            case 'segments':
            case 'haystack': {
              ...
              var G = d - L,
                N = G / R;
              ((N = ka(0, N, 1)), (e = Sd(I, M, N)), (c = wf(I, M)));
              break;
            }
          }
...
xf.getNodeShape = function (r) {
  ...
  if (t === 'cutrectangle' && (r.width() < Il || r.height() < Il))
    return (
      Ol ||
        (Ve(
...
var Ef = {};
[Mt, Bn, yr, Ga, yo, Gr, xf, Xn, Yn].forEach(function (r) {
  be(Ef, r);
});
var Cf = {};
...
ia.binder = function (r) {
  var e = this,
    t = e.cy.window(),
    a = r === t || r === t.document || r === t.document.body || gc(r);
  ...
  r.registerBinding(
    ...
    (we = function (S) {
      ...
      if (!(!_ && !D(S))) {
        ...
        var le = function (ec) {
            return { originalEvent: S, type: ec, position: { x: Z[0], y: Z[1] } };
          },
        ...
        if (_ && r.touchData.cxt) {
          ...
          if (te) {
            var Uf = Ye - F,
              ...
              xo = J[0] * ua + Ua.x,
              Eo = J[1] * ua + Ua.y,
              Jf = { x: (-Zn / ua) * (xo - Ua.x - Zf) + xo, y: (-Zn / ua) * (Eo - Ua.y - Qf) + Eo };
            if (Br && Br.active()) {
              var hr = r.dragData.touchDragEles;
              (p(hr),
                r.redrawHint('drag', !0),
            ...
            ($.viewport({ zoom: Zn, pan: Jf, cancelOnFailedZoom: !0 }),
              $.emit(le('pinchzoom')),
              (j = wo),
              (F = Ye),
              (U = ir),
  ...
  return (this.nodeShapes['bottom-round-rectangle'] = this.nodeShapes.bottomroundrectangle =
    {
      ...
      intersectLine: function (e, t, a, n, i, s, o, l) {
        ...
        return h.length > 0 ? h : xv(i, s, e, t, a, n, o, l);
      },
      checkPoint: function (e, t, a, n, i, s, o, l) {
        l = l === 'auto' ? vt(n, i) : l;
        var u = 2 * l;
...
[go, Ef, Cf, ia, Qr, Ha].forEach(function (r) {
  be(sa, r);
});
var ws = 1e3 / 60,
  Sf = {
...
nr.getElement = function (r, e, t, a, n) {
  ...
  if ((h && h.invalidated && ((h.invalidated = !1), (h.texture.invalidatedWidth -= h.width)), h))
    return h;
  var d;
  if ((v <= zl ? (d = zl) : v <= nn ? (d = nn) : (d = Math.ceil(v / nn) * nn), v > ly || f > uy))
    return null;
...
nr.checkTextureFullness = function (r) {
  ...
  r.usedWidth / r.width > fy && r.fullnessChecks >= cy ? lt(t, r) : r.fullnessChecks++;
};
...
nr.setupDequeueing = Sf.setupDequeueing({
...
var wy = 1,
  ...
  Df = function (e) {
    ...
    ((t.layersByLevel = {}),
      (t.firstGet = !0),
      (t.lastInvalidationTime = Yr() - 2 * Fl),
      (t.skipping = !1),
...
dr.getLayers = function (r, e, t) {
  ...
  var y = function () {
      if (!f) {
        f = wr();
        for (var D = 0; D < r.length; D++) Bd(f, r[D].boundingBox());
      }
      return f;
    },
    g = function (D) {
  ...
  for (var p = null, m = r.length / wy, b = !o, w = 0; w < r.length; w++) {
    ...
    if (
      (!p || p.eles.length >= m || !wv(p.bb, E.boundingBox())) &&
...
dr.drawEleInLayer = function (r, e, t, a) {
  ...
  o.w === 0 ||
    ...
    i.drawCachedElement(s, e, null, null, t, Ay),
...
dr.setupDequeueing = Sf.setupDequeueing({
...
Hr.drawCachedElement = function (r, e, t, a, n, i) {
  ...
  if (!(c.w === 0 || c.h === 0 || !e.visible()) && (!a || ao(c, a))) {
    ...
    (s.drawElementUnderlay(r, e),
      s.drawCachedElementPortion(r, e, l, t, n, h, Ny, qy),
      (!d || !y) && s.drawCachedElementPortion(r, e, u, t, n, h, zy, xs),
      d &&
        !y &&
        (s.drawCachedElementPortion(r, e, v, t, n, h, Fy, xs),
        s.drawCachedElementPortion(r, e, f, t, n, h, Vy, xs)),
  ...
  if (!(n && (o === 0 || e.pstyle('text-opacity').value === 0))) {
    ...
    if (c != null && c !== '' && !isNaN(l) && !isNaN(u)) {
      ...
      if (C > 0 || (T > 0 && x > 0)) {
        ...
        if (
          (B
            ? (r.beginPath(), Hl(r, F, U, Q, K, A))
            : P
              ? (r.beginPath(), _y(r, F, U, Q, K))
    ...
    var ne = function () {
      ...
      q = function (ue, X, S, _) {
        var W = (s.nodePathCache = s.nodePathCache || []),
          $ = dv(S === 'polygon' ? S + ',' + _.join(',') : S, '' + X, '' + ue, '' + re),
          Z = W[$],
          oe,
          ee = !1;
        return (
...
yt.drawNodeOverlay = Af('overlay');
yt.drawNodeUnderlay = Af('underlay');
...
function Hy(r, e, t) {
  var a = Wl(r, r.VERTEX_SHADER, e),
    n = Wl(r, r.FRAGMENT_SHADER, t),
    i = r.createProgram();
  if (
    (r.attachShader(i, a),
    r.attachShader(i, n),
...
function Fr(r, e, t, a) {
  ...
  (r.bindBuffer(r.ARRAY_BUFFER, f),
    ...
    r.bindBuffer(r.ARRAY_BUFFER, null));
  for (var c = new Array(e), h = 0; h < e; h++) c[h] = Qy(r, o, u, v, s, h);
  return (
    (f.dataArray = u),
    (f.stride = v),
    (f.size = s),
...
function Es() {
  var r = new $l(9);
  return (
    $l != Float32Array && ((r[1] = 0), (r[2] = 0), (r[3] = 0), (r[5] = 0), (r[6] = 0), (r[7] = 0)),
    (r[0] = 1),
    (r[4] = 1),
    (r[8] = 1),
    r
...
var am = (function () {
    ...
    return gt(r, [
      ...
      },
      {
        key: 'bufferIfNeeded',
        value: function (t) {
          (this.texture || (this.texture = Zy(t, this.debugID)),
            this.needsBuffer &&
  ...
  cm = (function () {
    function r(e, t, a) {
      (ht(this, r),
        ...
        (this.batchDebugInfo = []),
        (a.enableWrapping = !0),
        (a.createTextureCanvas = Wy),
        (this.atlasManager = new sm(e, a)),
        (this.batchManager = new om(a)),
          ...
          if (t.visible()) {
            ...
            if (n) {
              ...
              if (
                ...
                this.vertTypeBuffer.getView(v)[0] = Xl;
                ...
                for (var y = 0; y < n.length - 2; y += 2) {
                  ...
                  this.vertTypeBuffer.getView(g)[0] = Yl;
...
Lf.initWebgl = function (r, e) {
  ...
  ((r.bgColor = dm(t)),
    ...
    (t.pickingFrameBuffer = em(a)),
    (t.pickingFrameBuffer.needsDraw = !0),
    (t.drawing = new cm(t, a, r)));
  var n = function (f) {
      return function (c) {
...
function hm(r) {
  {
    ...
    r.render = function (i) {
      i = i || {};
      var s = r.cy;
      r.webgl && (s.zoom() > kf ? (gm(r), e.call(r, i)) : (pm(r), Nf(r, i, Ea.SCREEN)));
    };
  }
  {
...
function Nf(r, e, t) {
  ...
  var n = r.drawing,
    i = 0;
  if (
    (t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && mm(r, e),
    ...
    (n.endFrame(),
      t.screen && r.webglDebugShowAtlases && (bm(r), wm(r)),
...
var Zl = Math.sin(0),
  ...
  Us = {},
  zf = Math.PI / 40;
for (var Gt = 0 * Math.PI; Gt < 2 * Math.PI; Gt += zf)
...
mt.drawEllipsePath = function (r, e, t, a, n) {
  if ((r.beginPath && r.beginPath(), r.ellipse)) r.ellipse(e, t, a / 2, n / 2, 0, 0, 2 * Math.PI);
    ...
    for (var i, s, o = a / 2, l = n / 2, u = 0 * Math.PI; u < 2 * Math.PI; u += zf)
      ((i = e - o * $s[u] * Zl + o * Us[u] * Ql),
        (s = t + l * Us[u] * Zl + l * $s[u] * Ql),
...
[Bf, Hr, Jr, mo, Lt, yt, xr, Lf, mt, Wa, Vf].forEach(function (r) {
  be(ke, r);
});
var km = [
    { name: 'null', impl: hf },
  ...
  Dm = [
    { type: 'layout', extensions: Jp },
    { type: 'renderer', extensions: km },
  ],
  _f = {},
  Gf = {};
function Hf(r, e, t) {
