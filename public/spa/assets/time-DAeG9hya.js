import { b as un, t as Te, c as on, a as an } from './linear-BkEJkjA2.js';
import { i as cn } from './init-Dmth1JHB.js';
function Yt(e, n) {
  let t;
  if (n === void 0) for (const r of e) r != null && (t < r || (t === void 0 && r >= r)) && (t = r);
  else {
    let r = -1;
    for (let c of e) (c = n(c, ++r, e)) != null && (t < c || (t === void 0 && c >= c)) && (t = c);
  }
  return t;
}
function xt(e, n) {
...
function M(e, n, t, r) {
  ...
  return (
    (c.floor = (o) => (e((o = new Date(+o))), o)),
    (c.ceil = (o) => (e((o = new Date(o - 1))), n(o, 1), e(o), o)),
    (c.round = (o) => {
      const i = c(o),
        y = c.ceil(o);
      return o - i < y - o ? i : y;
    }),
    (c.offset = (o, i) => (n((o = new Date(+o)), i == null ? 1 : Math.floor(i)), o)),
    (c.range = (o, i, y) => {
      const C = [];
      if (((o = c.ceil(o)), (y = y == null ? 1 : Math.floor(y)), !(o < i) || !(y > 0))) return C;
      let h;
      do (C.push((h = new Date(+o))), n(o, y), e(o));
      while (h < o && o < i);
      return C;
    }),
    (c.filter = (o) =>
      M(
        ...
        (i, y) => {
          if (i >= i)
            if (y < 0) for (; ++y <= 0; ) for (; n(i, -1), !o(i); );
            else for (; --y >= 0; ) for (; n(i, 1), !o(i); );
        },
      )),
    t &&
      ((c.count = (o, i) => (re.setTime(+o), ue.setTime(+i), e(re), e(ue), Math.floor(t(re, ue)))),
      (c.every = (o) => (
        (o = Math.floor(o)),
        !isFinite(o) || !(o > 0)
          ? null
          : o > 1
            ? c.filter(r ? (i) => r(i) % o === 0 : (i) => c.count(0, i) % o === 0)
            : c
      ))),
    c
  );
...
const me = M(
  ...
  (e, n) => n.getMonth() - e.getMonth() + (n.getFullYear() - e.getFullYear()) * 12,
  (e) => e.getMonth(),
);
me.range;
const be = M(
  ...
  (e, n) => n.getUTCMonth() - e.getUTCMonth() + (n.getUTCFullYear() - e.getUTCFullYear()) * 12,
  (e) => e.getUTCMonth(),
);
be.range;
const O = M(
...
function Le(e, n, t, r, c, o) {
  ...
  function y(h, T, Y) {
    const D = T < h;
    D && ([h, T] = [T, h]);
    const w = Y && typeof Y.range == 'function' ? Y : C(h, T, Y),
      N = w ? w.range(h, +T + 1) : [];
    return D ? N.reverse() : N;
  }
  function C(h, T, Y) {
    const D = Math.abs(T - h) / Y,
      w = un(([, , _]) => _).right(i, D);
...
const [Ht, Wt] = Le(I, be, ge, We, He, xe),
  [Un, Cn] = Le(O, me, K, B, fe, se);
function ae(e) {
  if (0 <= e.y && e.y < 100) {
  ...
  function s(a, f) {
    return function (l) {
      var u = [],
        ...
        A,
        he;
      for (l instanceof Date || (l = new Date(+l)); ++S < p; )
        a.charCodeAt(S) === 37 &&
          (u.push(a.slice(m, S)),
          (A = Me[(F = a.charAt(++S))]) != null ? (F = a.charAt(++S)) : (A = F === 'e' ? ' ' : '0'),
          (he = f[F]) && (F = he(l, A)),
          u.push(F),
          (m = S + 1));
      ...
      if (
        ...
        ('w' in u || (u.w = 1),
          'Z' in u
            ? ((m = ce(z(u.y, 0, 1))),
              (p = m.getUTCDay()),
              (m = p > 4 || p === 0 ? E.ceil(m) : E(m)),
              (m = le.offset(m, (u.V - 1) * 7)),
              (u.y = m.getUTCFullYear()),
              (u.m = m.getUTCMonth()),
              (u.d = m.getUTCDate() + ((u.w + 6) % 7)))
            : ((m = ae(z(u.y, 0, 1))),
              (p = m.getDay()),
              (m = p > 4 || p === 0 ? $.ceil(m) : $(m)),
              (m = B.offset(m, (u.V - 1) * 7)),
              (u.y = m.getFullYear()),
              (u.m = m.getMonth()),
              (u.d = m.getDate() + ((u.w + 6) % 7))));
      } else
        ('W' in u || 'U' in u) &&
          ('w' in u || (u.w = 'u' in u ? u.u % 7 : 'W' in u ? 1 : 0),
          (p = 'Z' in u ? ce(z(u.y, 0, 1)).getUTCDay() : ae(z(u.y, 0, 1)).getDay()),
          (u.m = 0),
          (u.d =
            'W' in u ? ((u.w + 6) % 7) + u.W * 7 - ((p + 5) % 7) : u.w + u.U * 7 - ((p + 6) % 7)));
  ...
  function j(a, f, l, u) {
    for (var S = 0, m = f.length, p = l.length, F, A; S < m; ) {
      ...
      if (((F = f.charCodeAt(S++)), F === 37)) {
        if (
          ((F = f.charAt(S++)), (A = te[F in Me ? f.charAt(S++) : F]), !A || (u = A(a, l, u)) < 0)
        )
          return -1;
      } else if (F != l.charCodeAt(u++)) return -1;
    }
    return u;
  }
  function de(a, f, l) {
...
function Ze(e, n, t, r, c, o, i, y, C, h) {
  ...
  return (
    ...
    (T.nice = function (s) {
      var v = D();
      return (
        (!s || typeof s.range != 'function') && (s = n(v[0], v[v.length - 1], s ?? 10)),
        s ? D(sn(v, s)) : T
      );
    }),
    (T.copy = function () {
...
function bt() {
  return cn.apply(
    Ze(Un, Cn, O, me, K, B, fe, se, q, Ae).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
    arguments,
  );
}
export {
