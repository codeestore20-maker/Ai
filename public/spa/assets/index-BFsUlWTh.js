...
import { M as i } from './Markdown-CJ_9HjbS.js';
import { g as m, f as p } from './index-wqF_YeCD.js';
import { G as e } from './providerConfig-B8LLUHQ4.js';
import { F as s } from './FormPassword-DyHi6YXP.js';
import { P as a, S as n } from './index-Bgx7tZQB.js';
import { u as c } from './store-D4ebFM1W.js';
import { K as l, L as d } from './index-3vxyno4e.js';
import { a as f } from './selectors-ByZlqqp9.js';
...
const u = p(({ css: o, cssVar: r }) => ({
  ...
  g = 'github',
  h = () => {
    const { t: o } = m('modelProvider'),
      r = c(f.isAiProviderConfigLoading(g));
    return {
      ...e,
      apiKeyItems: [
        {
          children: r
            ...
            : t.jsx(s, {
                ...
                placeholder: o('github.personalAccessToken.placeholder'),
              }),
          desc: t.jsx(i, {
            className: u.markdown,
            fontSize: 12,
            variant: 'chat',
            children: o('github.personalAccessToken.desc'),
          }),
          label: o('github.personalAccessToken.title'),
          name: [l, d],
        },
      ],
    };
