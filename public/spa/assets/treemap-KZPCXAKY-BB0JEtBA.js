import { _ as En } from './index-NXWXCubP.js';
import {
  O as xh,
  P as Dh,
  e as _d,
  ...
  s as jh,
  p as zh,
} from './isEmpty-BVodj7VX.js';
import { k as qr, S as Bh, h as Wh, e as Vh, i as Kh } from './_baseIsEqual-C8ukSnff.js';
import {
  j as nl,
  g as Hr,
  u as Hh,
...
import {
  ...
  l as jn,
  e as Zh,
} from './_basePickBy-CUkQjNwQ.js';
import { c as Be } from './clone-Di7ceSMc.js';
import { p as ji, a as ep } from '../vendor/vendor-emotion-DdM-9MtU.js';
var tp = Object.prototype,
  ...
  ft = xh(function (t, e) {
    ...
    for (var n in e) np.call(e, n) && Fh(t, n, e[n]);
  });
function xd(t, e, n) {
  var r = -1,
    i = t.length;
...
function op(t, e, n, r) {
  var i = -1,
    ...
    l = e.length;
  if (!o) return c;
  e.length >= ap && ((s = Wh), (a = !1), (e = new Bh(e)));
  e: for (; ++i < o; ) {
    var u = t[i],
      f = u;
    if (((u = u !== 0 ? u : 0), a && f === f)) {
      for (var m = l; m--; ) if (e[m] === f) continue e;
      c.push(u);
    } else s(e, f, r) || c.push(u);
  }
  return c;
}
var Ia = Gh(function (t, e) {
  return _l(t) ? op(t, $d(e, 1, _l, !0)) : [];
});
function Ge(t, e, n) {
  var r = t == null ? 0 : t.length;
  return r ? ((e = e === void 0 ? 1 : rl(e)), xd(t, e < 0 ? 0 : e, r)) : [];
}
function Bi(t, e, n) {
  var r = t == null ? 0 : t.length;
  return r ? ((e = e === void 0 ? 1 : rl(e)), (e = r - e), xd(t, 0, e < 0 ? 0 : e)) : [];
}
function cp(t, e) {
...
var up = Object.prototype,
  ...
  fp = sp(function (t, e, n) {
    dp.call(t, n) ? t[n].push(e) : Uh(t, n, [e]);
  }),
  hp = '[object String]';
function nt(t) {
  return typeof t == 'string' || (!je(t) && Id(t) && Pd(t) == hp);
}
var pp = Math.max;
function et(t, e, n, r) {
  ((t = _d(t) ? t : $e(t)), (n = n ? rl(n) : 0));
  var i = t.length;
  return (
    n < 0 && (n = pp(i + n, 0)),
    nt(t) ? n <= i && t.indexOf(e, n) > -1 : !!i && Ld(t, e, n) > -1
  );
}
function Pl(t, e, n) {
  var r = t == null ? 0 : t.length;
...
function fi(t) {
  return (
    typeof t == 'object' && t !== null && typeof t.info == 'object' && typeof t.message == 'string'
  );
}
class Md {
  constructor() {
    ...
    (r) => {
      for (; r.keyIndex < r.keys.length; ) {
        ...
        if (!i.startsWith('$')) {
          const s = t[i];
          if (We(s)) {
            if ((r.keyIndex++, Ol(s, n))) return { done: !1, value: s };
          } else if (Array.isArray(s)) {
            for (; r.arrayIndex < s.length; ) {
              const a = r.arrayIndex++,
                o = s[a];
              if (We(o) && Ol(o, n)) return { done: !1, value: o };
            }
            r.arrayIndex = 0;
          }
        }
...
function is(t, e) {
  ...
  return new al(t, (n) => ol(n, e));
}
function Zt(t, e) {
  if (!t) throw new Error('Root node must be an AstNode.');
  return new al(t, (n) => ol(n, e), { includeRoot: !0 });
}
function Ol(t, e) {
  if (!e) return !0;
...
function Sp(t, e) {
  ...
  for (const i of Object.values(n.properties))
    i.defaultValue !== void 0 && r[i.name] === void 0 && (r[i.name] = qd(i.defaultValue));
}
function qd(t) {
  return Array.isArray(t) ? [...t.map(qd)] : t;
}
...
const xl = { $type: 'ArrayLiteral', elements: 'elements' },
  Dl = { $type: 'ArrayType', elementType: 'elementType' },
  xn = {
    $type: 'Assignment',
    cardinality: 'cardinality',
    feature: 'feature',
...
const An = {
  ...
  Ml = { $type: 'GrammarImport', path: 'path' },
  cr = {
    $type: 'Group',
    cardinality: 'cardinality',
    elements: 'elements',
...
const Ha = {
  ...
  Fl = { $type: 'InfixRuleOperators', precedences: 'precedences' },
  Li = { $type: 'Interface', attributes: 'attributes', name: 'name', superTypes: 'superTypes' };
function Ip(t) {
  return ee.isInstance(t, Li.$type);
}
const Oi = { $type: 'Keyword', cardinality: 'cardinality', predicate: 'predicate', value: 'value' };
function Bn(t) {
...
const ko = { $type: 'Negation', value: 'value' };
function $p(t) {
  return ee.isInstance(t, ko.$type);
}
const Gl = { $type: 'NumberLiteral', value: 'value' },
  Ls = { $type: 'Parameter', name: 'name' },
  Co = { $type: 'ParameterReference', parameter: 'parameter' };
function Lp(t) {
...
const No = { $type: 'ReturnType', name: 'name' };
function xp(t) {
  return ee.isInstance(t, No.$type);
}
const dr = {
  $type: 'RuleCall',
  arguments: 'arguments',
...
const Ul = { $type: 'StringLiteral', value: 'value' },
  fr = {
...
const hi = {
  ...
  pi = { $type: 'TypeDefinition' },
  ql = { $type: 'UnionType', types: 'types' },
  ...
  constructor() {
    (super(...arguments),
      (this.types = {
        AbstractElement: {
          name: ct.$type,
          properties: { cardinality: { name: ct.cardinality } },
          superTypes: [],
        },
        ...
        Action: {
          ...
          properties: {
            ...
            feature: { name: On.feature },
            inferredType: { name: On.inferredType },
            operator: { name: On.operator },
            type: { name: On.type, referenceType: Et.$type },
          },
          superTypes: [ct.$type],
        },
        Alternatives: {
          name: Hs.$type,
          properties: {
            cardinality: { name: Hs.cardinality },
            elements: { name: Hs.elements, defaultValue: [] },
          },
          superTypes: [ct.$type],
        },
        ArrayLiteral: {
          name: xl.$type,
          properties: { elements: { name: xl.elements, defaultValue: [] } },
          superTypes: [mi.$type],
        },
        ArrayType: {
          name: Dl.$type,
          properties: { elementType: { name: Dl.elementType } },
          superTypes: [pi.$type],
        },
        Assignment: {
          name: xn.$type,
          properties: {
            ...
            predicate: { name: xn.predicate },
            terminal: { name: xn.terminal },
          },
          superTypes: [ct.$type],
        },
        BooleanLiteral: {
        ...
        CharacterRange: {
          ...
          properties: {
            ...
            parenthesized: { name: Dn.parenthesized, defaultValue: !1 },
            right: { name: Dn.right },
          },
          superTypes: [gt.$type],
        },
        ...
        CrossReference: {
          ...
          properties: {
            ...
            deprecatedSyntax: { name: Mn.deprecatedSyntax, defaultValue: !1 },
            isMulti: { name: Mn.isMulti, defaultValue: !1 },
            terminal: { name: Mn.terminal },
            type: { name: Mn.type, referenceType: Et.$type },
          },
          superTypes: [ct.$type],
        },
        Disjunction: {
        ...
        EndOfFile: {
          name: Ao.$type,
          properties: { cardinality: { name: Ao.cardinality } },
          superTypes: [ct.$type],
        },
        Grammar: {
          name: An.$type,
          properties: {
            imports: { name: An.imports, defaultValue: [] },
            interfaces: { name: An.interfaces, defaultValue: [] },
            isDeclared: { name: An.isDeclared, defaultValue: !1 },
            name: { name: An.name },
            rules: { name: An.rules, defaultValue: [] },
            types: { name: An.types, defaultValue: [] },
          },
          superTypes: [],
        },
        GrammarImport: { name: Ml.$type, properties: { path: { name: Ml.path } }, superTypes: [] },
        Group: {
          name: cr.$type,
          properties: {
            cardinality: { name: cr.cardinality },
            elements: { name: cr.elements, defaultValue: [] },
            guardCondition: { name: cr.guardCondition },
            predicate: { name: cr.predicate },
          },
          superTypes: [ct.$type],
        },
        InferredType: {
          name: So.$type,
          properties: { name: { name: So.name } },
          superTypes: [Et.$type],
        },
        InfixRule: {
          name: Vt.$type,
        ...
        InfixRuleOperators: {
          name: Fl.$type,
          properties: { precedences: { name: Fl.precedences, defaultValue: [] } },
          superTypes: [],
        },
        Interface: {
          name: Li.$type,
          properties: {
            attributes: { name: Li.attributes, defaultValue: [] },
            name: { name: Li.name },
            superTypes: { name: Li.superTypes, defaultValue: [], referenceType: Et.$type },
          },
          superTypes: [Et.$type],
        },
        Keyword: {
        ...
        NegatedToken: {
          ...
          properties: {
            ...
            lookahead: { name: lr.lookahead },
            parenthesized: { name: lr.parenthesized, defaultValue: !1 },
            terminal: { name: lr.terminal },
          },
          superTypes: [gt.$type],
        },
        Negation: {
          name: ko.$type,
          properties: { value: { name: ko.value } },
          superTypes: [nr.$type],
        },
        NumberLiteral: {
          name: Gl.$type,
          properties: { value: { name: Gl.value } },
          superTypes: [mi.$type],
        },
        Parameter: { name: Ls.$type, properties: { name: { name: Ls.name } }, superTypes: [] },
        ParameterReference: {
          name: Co.$type,
          properties: { parameter: { name: Co.parameter, referenceType: Ls.$type } },
          superTypes: [nr.$type],
        },
        ParserRule: {
          name: Pt.$type,
        ...
        ReferenceType: {
          name: Ya.$type,
          properties: {
            isMulti: { name: Ya.isMulti, defaultValue: !1 },
            referenceType: { name: Ya.referenceType },
          },
          superTypes: [pi.$type],
        },
        RegexToken: {
        ...
        ReturnType: { name: No.$type, properties: { name: { name: No.name } }, superTypes: [] },
        RuleCall: {
          name: dr.$type,
          properties: {
            arguments: { name: dr.arguments, defaultValue: [] },
            cardinality: { name: dr.cardinality },
            predicate: { name: dr.predicate },
            rule: { name: dr.rule, referenceType: Ps.$type },
          },
          superTypes: [ct.$type],
        },
        SimpleType: {
          name: xi.$type,
          properties: {
            primitiveType: { name: xi.primitiveType },
            stringType: { name: xi.stringType },
            typeRef: { name: xi.typeRef, referenceType: Et.$type },
          },
          superTypes: [pi.$type],
        },
        StringLiteral: {
          name: Ul.$type,
          properties: { value: { name: Ul.value } },
          superTypes: [mi.$type],
        },
        TerminalAlternatives: {
          ...
          properties: {
            ...
            elements: { name: fr.elements, defaultValue: [] },
            lookahead: { name: fr.lookahead },
            parenthesized: { name: fr.parenthesized, defaultValue: !1 },
          },
          superTypes: [gt.$type],
        },
        TerminalElement: {
        ...
        TerminalRule: {
          name: ln.$type,
          properties: {
            definition: { name: ln.definition },
            fragment: { name: ln.fragment, defaultValue: !1 },
            hidden: { name: ln.hidden, defaultValue: !1 },
            name: { name: ln.name },
            type: { name: ln.type },
          },
          superTypes: [Ps.$type],
        ...
        TerminalRuleCall: {
          ...
          properties: {
            ...
            rule: { name: pr.rule, referenceType: ln.$type },
          },
          superTypes: [gt.$type],
        },
        Type: {
        ...
        TypeAttribute: {
          name: hi.$type,
          properties: {
            defaultValue: { name: hi.defaultValue },
            isOptional: { name: hi.isOptional, defaultValue: !1 },
            name: { name: hi.name },
            type: { name: hi.type },
          },
          superTypes: [],
        },
        TypeDefinition: { name: pi.$type, properties: {}, superTypes: [] },
        UnionType: {
          name: ql.$type,
          properties: { types: { name: ql.types, defaultValue: [] } },
          superTypes: [pi.$type],
        },
        UnorderedGroup: {
          name: Qs.$type,
          properties: {
            cardinality: { name: Qs.cardinality },
            elements: { name: Qs.elements, defaultValue: [] },
          },
          superTypes: [ct.$type],
        },
        UntilToken: {
          ...
          properties: {
            ...
            terminal: { name: mr.terminal },
          },
          superTypes: [gt.$type],
        },
        ValueLiteral: { name: mi.$type, properties: {}, superTypes: [] },
        Wildcard: {
          name: Di.$type,
          properties: {
            cardinality: { name: Di.cardinality },
            lookahead: { name: Di.lookahead },
            parenthesized: { name: Di.parenthesized, defaultValue: !1 },
          },
          superTypes: [gt.$type],
        },
      }));
...
const ee = new Wd();
function wo(t) {
  return new al(t, (e) => (Wi(e) ? e.content : []), { includeRoot: !0 });
}
function zp(t, e) {
...
function jl(t, e) {
  return Fd(t) && e.includes(t.tokenType.name);
}
function Hp(t, e = !0) {
  for (; t.container; ) {
    const n = t.container;
...
class Kd {
  ...
  atom() {
    ...
    if ((e === void 0 && this.isPatternCharacter() && (e = this.patternCharacter()), rr(e)))
...
`),
  ...
  characterClassEscape() {
    ...
    if (rr(e)) return { type: 'Set', value: e, complement: n };
  }
  controlEscapeAtom() {
    let e;
    switch (this.popChar()) {
...
`);
    ...
    if (rr(e)) return { type: 'Character', value: e };
  }
...
`:
  ...
  characterClass() {
    ...
    for (
      ...
      if ((r.type, zl(r) && this.isRangeDash())) {
        this.consumeChar('-');
...
function Xd(t, e, n) {
  (e.add(t.name),
    is(t).forEach((r) => {
      if (Wn(r) || n) {
        const i = r.rule.ref;
        i && !e.has(i.name) && Xd(i, e, n);
      }
    }));
}
function om(t) {
  if (t.terminal) return t.terminal;
  if (t.type.ref) return Qd(t.type.ref)?.terminal;
}
function cm(t) {
  return t.hidden && !Hd(ul(t));
}
function lm(t, e) {
  return !t || !e ? [] : ll(t, e, t.astNode, !0);
}
function Jd(t, e, n) {
  if (!t || !e) return;
  const r = ll(t, e, t.astNode, !0);
  if (r.length !== 0)
    return (n !== void 0 ? (n = Math.max(0, Math.min(n, r.length - 1))) : (n = 0), r[n]);
}
function ll(t, e, n, r) {
  if (!r) {
    const i = $a(t.grammarSource, zn);
    if (i && i.feature === e) return [t];
  }
  return Wi(t) && t.astNode === n ? t.content.flatMap((i) => ll(i, e, n, !1)) : [];
}
function um(t, e, n) {
  if (!t) return;
  const r = dm(t, e, t?.astNode);
  if (r.length !== 0)
    return (n !== void 0 ? (n = Math.max(0, Math.min(n, r.length - 1))) : (n = 0), r[n]);
}
function dm(t, e, n) {
  if (t.astNode !== n) return [];
  if (Bn(t.grammarSource) && t.grammarSource.value === e) return [t];
  const r = wo(t).iterator();
  let i;
  const s = [];
  do
    if (((i = r.next()), !i.done)) {
...
function Zd(t, e, n) {
  function r(i, s) {
    let a;
    return ($a(i, zn) || (a = Zd(s, s, n)), n.set(t, a), a);
  }
  if (n.has(t)) return n.get(t);
  n.set(t, void 0);
  for (const i of is(e)) {
    if (zn(i) && i.feature.toLowerCase() === 'name') return (n.set(t, i), i);
    if (Wn(i) && sn(i.rule.ref)) return r(i, i.rule.ref);
    if (Dp(i) && i.typeRef?.ref) return r(i, i.typeRef.ref);
  }
}
function ef(t) {
  return tf(t, new Set());
...
function tf(t, e) {
  ...
  for (const n of is(t))
    if (Wn(n)) {
      if (!n.rule.ref || (sn(n.rule.ref) && !tf(n.rule.ref, e)) || la(n.rule.ref)) return !1;
    } else {
      if (zn(n)) return !1;
      if (La(n)) return !1;
    }
...
function Vi(t) {
  if (ss(t)) return sn(t) && ef(t) ? t.name : (nf(t) ?? t.name);
  if (Ip(t) || Up(t) || xp(t)) return t.name;
  if (La(t)) {
    const e = hm(t);
    if (e) return e;
  } else if (zd(t)) return t.name;
  throw new Error('Cannot get name of Unknown Type');
}
function hm(t) {
  if (t.inferredType) return t.inferredType.name;
  if (t.type?.ref) return Vi(t.type.ref);
}
function pm(t) {
  return an(t) ? (t.type?.name ?? 'string') : (nf(t) ?? t.name);
}
function ul(t) {
  const e = { s: !1, i: !1, u: !1 },
    n = Yr(t.definition, e),
...
function mm(t) {
  return en(t.elements.map((e) => Yr(e)).join('|'), {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    parenthesized: t.parenthesized,
    wrap: !1,
...
function en(t, e) {
  return (
    (e.parenthesized || e.lookahead || e.wrap !== !1) &&
      (t = `(${e.lookahead ?? (e.parenthesized ? '' : '?:')}${t})`),
...
function vm(t) {
  const e = [],
    n = t.Grammar;
  for (const r of n.rules) an(r) && cm(r) && tm(ul(r)) && e.push(r.name);
  ...
  if (t instanceof Qe) {
    ...
    if (t instanceof mt)
      return {
        ...
        idx: t.idx,
        separator: Zs(new le({ terminalType: t.separator })),
...
function ha(t, e = []) {
  return t instanceof ze || t instanceof Ae || t instanceof it
    ? !0
    : t instanceof st
      ? Dd(t.definition, (r) => ha(r, e))
      : t instanceof Qe && et(e, t)
        ? !1
        : t instanceof xt
          ? (t instanceof Qe && e.push(t), kt(t.definition, (r) => ha(r, e)))
          : !1;
}
function Cm(t) {
...
function $t(t) {
  ...
  if (t instanceof le) return 'CONSUME';
  throw Error('non exhaustive match');
}
class Ma {
  walk(e, n = []) {
    q(e.definition, (r, i) => {
      ...
      else if (r instanceof le) this.walkTerminal(r, s, n);
...
function Wl(t, e, n) {
  return [
    new ze({ definition: [new le({ terminalType: t.separator })].concat(t.definition) }),
  ].concat(e, n);
}
function os(t) {
  if (t instanceof Qe) return os(t.referencedRule);
  if (t instanceof le) return bm(t);
  if (km(t)) return Nm(t);
  if (Cm(t)) return wm(t);
  throw Error('non exhaustive match');
}
function Nm(t) {
  ...
  let r = 0,
    ...
    a = !0;
  for (; i && a; )
    ((s = n[r]), (a = ha(s)), (e = e.concat(os(s))), (r = r + 1), (i = n.length > r));
  return sl(e);
}
function wm(t) {
...
const cf = 'Complement Sets are not supported for first char optimization',
  pa = `Unable to use "first char" lexer optimizations:
`;
function Om(t, e = !1) {
  try {
    const n = Fa(t);
    return Io(n.value, {}, n.flags.ignoreCase);
  } catch (n) {
    if (n.message === cf)
      e &&
        rf(`${pa}	Unable to optimize: < ${t.toString()} >
...
function Io(t, e, n) {
  switch (t.type) {
    case 'Disjunction':
      for (let i = 0; i < t.value.length; i++) Io(t.value[i], e, n);
      break;
    case 'Alternative':
      const r = t.value;
      for (let i = 0; i < r.length; i++) {
        ...
        switch (a.type) {
          case 'Character':
            ...
            break;
          case 'Set':
            if (a.complement === !0) throw Error(cf);
            q(a.value, (c) => {
              if (typeof c == 'number') xs(c, e, n);
                ...
                if (n === !0) for (let u = l.from; u <= l.to; u++) xs(u, e, n);
                  ...
                  for (let u = l.from; u <= l.to && u < Fi; u++) xs(u, e, n);
                  if (l.to >= Fi) {
                    const u = l.from >= Fi ? l.from : Fi,
                      f = l.to,
                      m = dn(u),
                      p = dn(f);
                    for (let A = m; A <= p; A++) e[A] = A;
                  }
                }
              }
            });
        ...
        if ((a.type === 'Group' && Po(a) === !1) || (a.type !== 'Group' && o === !1)) break;
      }
      break;
    default:
      throw Error('non exhaustive match!');
...
function Po(t) {
  ...
  return e && e.atLeast === 0 ? !0 : t.value ? (je(t.value) ? kt(t.value, Po) : Po(t.value)) : !1;
}
class Dm extends xa {
  constructor(e) {
  ...
  visitSet(e) {
    e.complement
      ? Vl(e, this.targetCharCodes) === void 0 && (this.found = !0)
      : Vl(e, this.targetCharCodes) !== void 0 && (this.found = !0);
  }
}
function fl(t, e) {
  ...
  } else return jr(e, (n) => et(t, n.charCodeAt(0))) !== void 0;
}
const Vn = 'PATTERN',
  Mi = 'defaultMode',
  Ds = 'modes';
...
`,
  ...
  n('misc mapping', () => {
    ((a = M(r, (N) => N.tokenTypeIdx)),
      ...
      (c = M(r, (N) => {
        ...
        if (k) return je(k) ? M(k, (H) => Pl(r, H)) : [Pl(r, k)];
      })),
      (l = M(r, (N) => N.PUSH_MODE)),
      (u = M(r, (N) => z(N, 'POP_MODE'))));
  });
  let f;
  n('Line Terminator Handling', () => {
    const N = df(e.lineTerminatorCharacters);
    ((f = M(r, (k) => !1)),
      e.positionTracking !== 'onlyOffset' &&
        (f = M(r, (k) =>
          z(k, 'LINE_BREAKS') ? !!k.LINE_BREAKS : uf(k, N) === !1 && fl(N, k.PATTERN),
        )));
  });
  let m, p, A, b;
  n('Misc Mapping #2', () => {
  ...
  return (
            ...
            if (typeof k.PATTERN == 'string') {
              ...
              q(k.START_CHARS_HINT, (K) => {
                const J = typeof K == 'string' ? K.charCodeAt(0) : K,
                  oe = dn(J);
                H !== oe && ((H = oe), Za(N, oe, b[P]));
              });
            } else if (nn(k.PATTERN))
              if (k.PATTERN.unicode)
                ((I = !1),
                  e.ensureOptimizations &&
                    _o(`${pa}	Unable to analyze < ${k.PATTERN.toString()} > pattern.
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`));
              ...
              (e.ensureOptimizations &&
                _o(`${pa}	TokenType: <${k.name}> is using a custom token pattern without providing <start_chars_hint> parameter.
	This will disable the lexer's first char optimizations.
...
function qm(t) {
  const e = ht(t, (i) => {
      const s = i[Vn];
      return !nn(s) && !Yn(s) && !z(s, 'exec') && !nt(s);
    }),
    n = M(e, (i) => ({
      message:
        'Token Type: ->' +
...
`,
    ...
    z(t, Ds) &&
      ...
      r.push({
        message: `A MultiMode Lexer cannot be initialized with a ${Mi}: <${t.defaultMode}>which does not exist
`,
    ...
    e &&
      q(a, (c) => {
        ...
        if (l !== !1) {
          ...
          z(c, 'LINE_BREAKS') ? c.LINE_BREAKS === !0 && (i = !0) : fl(o, c.PATTERN) && (i = !0);
      }),
    e &&
      !i &&
      r.push({
...
function uf(t, e) {
  ...
  if (nn(t.PATTERN)) {
    ...
    if (lf(t)) return { issue: Se.CUSTOM_LINE_BREAK };
    throw Error('non exhaustive match');
  }
}
function ag(t, e) {
...
function lg(t) {
  q(t, (e) => {
    (pf(e) || ((ff[Hl] = e), (e.tokenTypeIdx = Hl++)),
      Yl(e) && !je(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]),
      Yl(e) || (e.CATEGORIES = []),
  ...
  q(t, (e) => {
    ((e.categoryMatches = []),
      q(e.categoryMatchesMap, (n, r) => {
        e.categoryMatches.push(ff[r].tokenTypeIdx);
      }));
  });
}
function dg(t) {
...
a boolean 2nd argument is no longer supported`);
    ...
    (r === !0
      ...
      this.TRACE_INIT('Lexer Constructor', () => {
        ...
        (this.TRACE_INIT('Lexer Config handling', () => {
          if (this.config.lineTerminatorsPattern === Gi.lineTerminatorsPattern)
            this.config.lineTerminatorsPattern = sg;
          else if (this.config.lineTerminatorCharacters === Gi.lineTerminatorCharacters)
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
          ...
          ((this.trackStartLines = /full|onlyStart/i.test(this.config.positionTracking)),
            ...
            je(e)
              ? (i = { modes: { defaultMode: Be(e) }, defaultMode: Mi })
              : ((s = !1), (i = Be(e))));
        }),
        ...
        (q(this.lexerDefinitionWarning, (o) => {
          ...
          this.TRACE_INIT('Choosing sub-methods implementations', () => {
            if (
              ...
              this.trackStartLines === !1 && (this.computeNewColumn = jh),
...
` + i,
  ...
  tokenizeInternal(e, n) {
    ...
    const K = this.hasCustom ? 0 : Math.floor(e.length / 10),
      J = new Array(K),
      oe = [];
    let ue = this.trackStartLines ? 1 : void 0,
    ...
    let D = !1;
    const x = (B) => {
      if (E.length === 1 && B.tokenType.PUSH_MODE === void 0) {
        ...
        E.pop();
        const ne = jn(E);
        ((y = this.patternIdxToConfig[ne]),
          (R = this.charCodeToPatternIdxToConfig[ne]),
          (S = y.length));
    ...
    function j(B) {
      (E.push(B),
        (R = this.charCodeToPatternIdxToConfig[B]),
        ...
        if (
          (fe !== !1
            ...
            : G.isCustom === !0
              ? ((C = Re.exec(N, P, J, _)),
                C !== null
                  ? ((c = C[0]), (f = c.length), C.payload !== void 0 && (l = C.payload))
                  : (c = null))
              : ((Re.lastIndex = P), (f = this.matchLength(Re, e, P))),
          f !== -1)
        ) {
      ...
      if (f !== -1) {
        if (
          ...
          m !== void 0 &&
            ...
            (p = G.tokenTypeIdx),
            (A = this.createTokenInstance(c, P, p, G.tokenType, ue, de, f)),
            this.handlePayload(A, l),
            m === !1 ? (H = this.addToken(J, H, A)) : _[m].push(A)),
          T === !0 && G.canLineTerminator === !0)
        ) {
          let Re = 0,
            fe,
            Ie;
          ...
          do
            ((c = c !== null ? c : e.substring(P, P + f)),
              (fe = g.test(c)),
              fe === !0 && ((Ie = g.lastIndex - 1), Re++));
          while (fe === !0);
          Re !== 0
            ? ((ue = ue + Re),
              (de = f - Ie),
              this.updateTokenEndLineColumnLocation(A, m, Ie, Re, ue, de, f))
            : (de = this.computeNewColumn(de, f));
        } else de = this.computeNewColumn(de, f);
        ...
        for (; xe === !1 && P < k; )
          for (P++, i = 0; i < S; i++) {
            ...
            if (
              (at !== !1
                ? N.charCodeAt(P) === at && (xe = !0)
                : be.isCustom === !0
                  ? (xe = Z.exec(N, P, J, _) !== null)
        ...
        if (
          ((b = P - Re),
          (de = this.computeNewColumn(de, b)),
          (I = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(
            N,
            Re,
            b,
            fe,
          ...
          oe.push({ offset: Re, line: fe, column: Ie, length: b, message: I }),
          ie === !1)
        )
          break;
      }
  ...
  updateTokenEndLineColumnLocation(e, n, r, i, s, a, o) {
    ...
    n !== void 0 &&
      ((c = r === o - 1),
      (l = c ? -1 : 0),
      (i === 1 && c === !0) || ((e.endLine = s + l), (e.endColumn = a - 1 + -l)));
  }
...
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return (
    z(t, Xl) && (n.CATEGORIES = t[Xl]),
    ls([n]),
    z(t, Jl) && (n.LABEL = t[Jl]),
    z(t, Ql) && (n.GROUP = t[Ql]),
    z(t, eu) && (n.POP_MODE = t[eu]),
    z(t, Zl) && (n.PUSH_MODE = t[Zl]),
    z(t, tu) && (n.LONGER_ALT = t[tu]),
    z(t, nu) && (n.LINE_BREAKS = t[nu]),
    z(t, ru) && (n.START_CHARS_HINT = t[ru]),
    n
  );
}
const fn = gf({ name: 'EOF', pattern: tt.NA });
ls([fn]);
function hl(t, e, n, r, i, s, a, o) {
  return {
    image: e,
    startOffset: n,
    endOffset: r,
...
const Er = {
  buildMismatchTokenMessage({ expected: t, actual: e, previous: n, ruleName: r }) {
    return `Expecting ${mf(t) ? `--> ${Sr(t)} <--` : `token of type --> ${t.name} <--`} but found --> '${e.image}' <--`;
  },
...
but found: '` +
    ...
    if (r) return s + r + o;
    {
      const c = Je(t, (m, p) => m.concat(p), []),
        l = M(c, (m) => `[${M(m, (p) => Sr(p)).join(', ')}]`),
...
and Non-Terminal names start with a lower case letter.`;
    ...
    buildAlternationPrefixAmbiguityError(t) {
      const e = M(t.prefixPath, (i) => Sr(i)).join(', '),
...
`;
        ...
        const i = M(t.prefixPath, (s) => Sr(s)).join(', ');
...
see: https://en.wikipedia.org/wiki/LL_parser#Left_factoring.`;
    ...
    buildDuplicateRuleNameError(t) {
      let e;
      return (
        t.topLevelRule instanceof Xr ? (e = t.topLevelRule.name) : (e = t.topLevelRule),
  ...
  for (; n.length < e && i < t.length; ) {
    ...
    if (o instanceof ze) r = a(o.definition);
      ...
      const c = [
        ...
        new Ae({ definition: [new le({ terminalType: o.separator })].concat(o.definition) }),
      ];
      return a(c);
      ...
      if (o instanceof le) n.push(o.terminalType);
      else throw Error('non exhaustive match');
    }
    i++;
  }
...
function Tf(t, e, n, r) {
  ...
  for (f.push({ idx: -1, def: t, ruleStack: [], occurrenceStack: [] }); !ae(f); ) {
    ...
    const C = p[0];
    if (C === i) {
      const N = { idx: A, def: Ge(p), ruleStack: Bi(b), occurrenceStack: Bi(I) };
      f.push(N);
      ...
      if (A < c - 1) {
        ...
        if (n(k, C.terminalType)) {
          const P = { idx: N, def: Ge(p), ruleStack: b, occurrenceStack: I };
          f.push(P);
        }
      } else if (A === c - 1)
        (u.push({
      ...
      const k = Be(I);
      k.push(C.idx);
      const P = { idx: A, def: C.definition.concat(s, Ge(p)), ruleStack: N, occurrenceStack: k };
      f.push(P);
    } else if (C instanceof ze) {
      const N = { idx: A, def: Ge(p), ruleStack: b, occurrenceStack: I };
      (f.push(N), f.push(a));
      const k = { idx: A, def: C.definition.concat(Ge(p)), ruleStack: b, occurrenceStack: I };
      f.push(k);
    } else if (C instanceof pt) {
      const N = new Ae({ definition: C.definition, idx: C.idx }),
        k = C.definition.concat([N], Ge(p)),
        P = { idx: A, def: k, ruleStack: b, occurrenceStack: I };
      f.push(P);
    } else if (C instanceof mt) {
      const N = new le({ terminalType: C.separator }),
        k = new Ae({ definition: [N].concat(C.definition), idx: C.idx }),
        P = C.definition.concat([k], Ge(p)),
        H = { idx: A, def: P, ruleStack: b, occurrenceStack: I };
      f.push(H);
    } else if (C instanceof it) {
      const N = { idx: A, def: Ge(p), ruleStack: b, occurrenceStack: I };
      (f.push(N), f.push(a));
      const k = new le({ terminalType: C.separator }),
        P = new Ae({ definition: [k].concat(C.definition), idx: C.idx }),
        H = C.definition.concat([P], Ge(p)),
        K = { idx: A, def: H, ruleStack: b, occurrenceStack: I };
      f.push(K);
      ...
      for (let N = C.definition.length - 1; N >= 0; N--) {
        const k = C.definition[N],
          P = { idx: A, def: k.definition.concat(Ge(p)), ruleStack: b, occurrenceStack: I };
        (f.push(P), f.push(a));
      }
    else if (C instanceof rt)
      f.push({ idx: A, def: C.definition.concat(Ge(p)), ruleStack: b, occurrenceStack: I });
    else if (C instanceof Xr) f.push(kg(C, A, b, I));
    else throw Error('non exhaustive match');
  }
  return u;
}
...
function pl(t) {
  if (t instanceof ze || t === 'Option') return ge.OPTION;
  if (t instanceof Ae || t === 'Repetition') return ge.REPETITION;
  if (t instanceof pt || t === 'RepetitionMandatory') return ge.REPETITION_MANDATORY;
  if (t instanceof mt || t === 'RepetitionMandatoryWithSeparator')
    return ge.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (t instanceof it || t === 'RepetitionWithSeparator') return ge.REPETITION_WITH_SEPARATOR;
  if (t instanceof st || t === 'Alternation') return ge.ALTERNATION;
  throw Error('non exhaustive match');
}
function au(t) {
  const { occurrence: e, rule: n, prodType: r, maxLookahead: i } = t,
    s = pl(r);
  return s === ge.ALTERNATION ? Ua(e, n, i) : qa(e, n, s, i);
}
...
class _g extends Ma {
  ...
  walkAtLeastOneSep(e, n, r) {
    this.checkIsTarget(e, ge.REPETITION_MANDATORY_WITH_SEPARATOR, n, r) ||
      super.walkOption(e, n, r);
  }
  walkMany(e, n, r) {
...
function Ua(t, e, n, r) {
  const i = new Rf(t, ge.ALTERNATION, r);
  return (e.accept(i), vf(i.result, n));
}
function qa(t, e, n, r) {
  const i = new Rf(t, n);
  e.accept(i);
    ...
    q(t, (i) => {
      ...
      q(a, (o) => {
        const c = pl(o),
          ...
          m = qa(u, i, c, l)[0];
        if (ae(yt(m))) {
          const p = n.buildEmptyRepetitionError({ topLevelRule: i, repetition: o });
          r.push({ message: p, type: Ze.NO_NON_EMPTY_LOOKAHEAD, ruleName: i.name });
        }
      });
    }),
    r
      ...
      (o, c, l) => (
        e.definition[l].ignoreAmbiguities === !0 ||
          q(c, (u) => {
            const f = [l];
            (q(t, (m, p) => {
              l !== p && Oo(m, u) && e.definition[p].ignoreAmbiguities !== !0 && f.push(p);
            }),
              f.length > 1 && !Oo(i, u) && (i.push(u), o.push({ alts: f, path: u })));
          }),
        o
      ),
      [],
  ...
  return rs(
    dt(i, (a) => {
      ...
      const c = a.idx,
        ...
        u = ht(
          i,
          (m) => e.definition[m.idx].ignoreAmbiguities !== !0 && m.idx < c && Pg(m.path, l),
        );
      return M(u, (m) => {
        const p = [m.idx + 1, c + 1],
          A = e.idx === 0 ? '' : e.idx;
...
function Kg(t) {
  const e = il(t, { errMsgProvider: yg }),
    n = {};
  return (
    q(t.rules, (r) => {
      n[r.name] = r;
...
function Hg(t) {
  return (
    (t = il(t, { errMsgProvider: Un })),
    Lg(t.rules, t.tokenTypes, t.errMsgProvider, t.grammarName)
  );
}
const kf = 'MismatchedTokenException',
  Cf = 'NoViableAltException',
  Nf = 'EarlyExitException',
  wf = 'NotAllInputParsedException',
  bf = [kf, Cf, Nf, wf];
Object.freeze(bf);
function ga(t) {
  return et(bf, t.name);
...
const to = {},
  If = 'InRuleRecoveryException';
class Qg extends Error {
  constructor(e) {
    (super(e), (this.name = If));
  }
}
class Zg {
  initRecoverable(e) {
  ...
  getTokenToInsert(e) {
    const n = hl(e, '', NaN, NaN, NaN, NaN, NaN, NaN);
  ...
  tryInRepetitionRecovery(e, n, r, i) {
    ...
    const f = () => {
      const m = this.LA(0),
        ...
        A = new _f(p, l, this.LA(0));
      ((A.resyncedTokens = Bi(o)), this.SAVE_ERROR(A));
    };
    for (; !c; )
      if (this.tokenMatcher(u, i)) {
        ...
        this.tokenMatcher(u, s)
          ? (c = !0)
          : ((u = this.SKIP_TOKEN()), this.addToResyncTokens(u, o));
  ...
  getFollowSetFromFollowKey(e) {
    if (e === to) return [fn];
    const n = e.ruleName + e.idxInCallingRule + of + e.inRule;
...
function ey(t, e, n, r, i, s, a) {
  ...
  if (c === void 0) {
    const m = this.getCurrRuleFullName(),
      p = this.getGAstProductions()[m];
    ((c = new s(p, i).startWalking()), (this.firstAfterRepMap[o] = c));
  }
  let l = c.token,
    u = c.occurrence;
  const f = c.isEndOfRule;
  (this.RULE_STACK.length === 1 && f && l === void 0 && ((l = fn), (u = 1)),
    !(l === void 0 || u === void 0) &&
...
class gl {
  ...
  validateNoLeftRecursion(e) {
    return dt(e, (n) => Sf(n, n, Un));
  }
  validateEmptyOrAlternatives(e) {
    return dt(e, (n) => Gg(n, Un));
  }
  validateAmbiguousAlternationAlternatives(e, n) {
    return dt(e, (r) => Ug(r, n, Un));
  }
  ...
  buildLookaheadForOptional(e) {
    return Ng(e.prodOccurrence, e.rule, e.maxLookahead, e.dynamicTokensEnabled, pl(e.prodType), bg);
  }
}
class ny {
  initLooksAhead(e) {
    ((this.dynamicTokensEnabled = z(e, 'dynamicTokensEnabled')
      ? e.dynamicTokensEnabled
      : rn.dynamicTokensEnabled),
      (this.maxLookahead = z(e, 'maxLookahead') ? e.maxLookahead : rn.maxLookahead),
      (this.lookaheadStrategy = z(e, 'lookaheadStrategy')
        ? e.lookaheadStrategy
        : new gl({ maxLookahead: this.maxLookahead })),
        ...
        (q(r, (l) => {
          ...
          this.TRACE_INIT(`${$t(l)}${u}`, () => {
            const f = this.lookaheadStrategy.buildLookaheadForAlternation({
              ...
              m = no(this.fullRuleNameToShort[n.name], Pf, l.idx);
            this.setLaFuncCache(m, f);
          });
        }),
          q(i, (l) => {
            this.computeLookaheadFunc(n, l.idx, xo, 'Repetition', l.maxLookahead, $t(l));
          }),
          q(s, (l) => {
            this.computeLookaheadFunc(n, l.idx, $f, 'Option', l.maxLookahead, $t(l));
          }),
          q(a, (l) => {
            this.computeLookaheadFunc(n, l.idx, Do, 'RepetitionMandatory', l.maxLookahead, $t(l));
          }),
          q(o, (l) => {
...
function uy(t, e, n) {
  const r = function () {};
  Lf(r, t + 'BaseSemanticsWithDefaults');
...
class hy {
  initTreeBuilder(e) {
    if (
      ...
      (this.nodeLocationTracking = z(e, 'nodeLocationTracking')
        ? e.nodeLocationTracking
        : rn.nodeLocationTracking),
      !this.outputCst)
    )
      ...
      this.recoveryEnabled
        ? ((this.setNodeLocationFromToken = lu),
          (this.setNodeLocationFromNode = lu),
          (this.cstPostRule = Fe),
  ...
  getBaseCstVisitorConstructor() {
    if (tn(this.baseCstVisitorConstructor)) {
      const e = ly(this.className, qr(this.gastProductionsCache));
...
class my {
  ...
  RULE(e, n, r = Ra) {
    if (et(this.definedRulesNames, e)) {
      const a = {
        message: Un.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: this.className }),
...
class gy {
  initRecognizerEngine(e, n) {
    ...
    else if (z(e, 'modes') && kt(yt($e(e.modes)), pg)) {
      const s = yt($e(e.modes)),
        a = sl(s);
      this.tokensMap = Je(a, (o, c) => ((o[c.name] = c), o), {});
    } else if (zh(e)) this.tokensMap = Be(e);
    else
      throw new Error(
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
  ...
  optionInternal(e, n) {
    const r = this.getKeyForAutomaticLookahead($f, n);
  ...
  atLeastOneInternalLogic(e, n, r) {
    ...
    } else throw this.raiseEarlyExitException(e, ge.REPETITION_MANDATORY, n.ERR_MSG);
    this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, n], i, Do, e, Sg);
  }
  ...
  atLeastOneSepFirstInternalLogic(e, n, r) {
    ...
    } else throw this.raiseEarlyExitException(e, ge.REPETITION_MANDATORY_WITH_SEPARATOR, n.ERR_MSG);
  }
  manyInternal(e, n) {
  ...
  manyInternalLogic(e, n, r) {
    ...
    let a = !0;
    for (; i.call(this) === !0 && a === !0; ) a = this.doSingleRepetition(s);
    this.attemptInRepetitionRecovery(this.manyInternal, [e, n], i, xo, e, Ag, a);
  }
  manySepFirstInternal(e, n) {
    const r = this.getKeyForAutomaticLookahead(Mo, e);
  ...
  orInternal(e, n) {
    const r = this.getKeyForAutomaticLookahead(Pf, n),
      i = je(e) ? e : e.DEF,
...
class yy {
  initErrorHandler(e) {
    ((this._errors = []),
      (this.errorMessageProvider = z(e, 'errorMessageProvider')
        ? e.errorMessageProvider
        : rn.errorMessageProvider));
  }
  SAVE_ERROR(e) {
    if (ga(e))
      return (
...
class Ty {
  ...
  computeContentAssist(e, n) {
    ...
    return Tf([r], n, this.tokenMatcher, this.maxLookahead);
  }
  getNextPossibleTokenTypes(e) {
    const n = Nt(e.ruleStack),
...
const uu = !0,
  du = Math.pow(2, pn) - 1,
  Of = gf({ name: 'RECORDING_PHASE_TOKEN', pattern: tt.NA });
ls([Of]);
const xf = hl(
  Of,
...
class vy {
  ...
  topLevelRuleRecord(e, n) {
    try {
      const r = new Xr({ definition: [], name: e });
      return (
        (r.name = e),
  ...
  subruleInternalRecord(e, n, r) {
    if ((ya(n), !e || z(e, 'ruleName') === !1)) {
      const o =
        new Error(`<SUBRULE${fu(n)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw ((o.KNOWN_RECORDER_ERROR = !0), o);
    }
    const i = jn(this.recordingProdStack),
      s = e.ruleName,
      a = new Qe({ idx: n, nonTerminalName: s, label: r?.LABEL, referencedRule: void 0 });
    return (i.definition.push(a), this.outputCst ? Ry : za);
  }
  consumeInternalRecord(e, n, r) {
    if ((ya(n), !pf(e))) {
      const a =
        new Error(`<CONSUME${fu(n)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw ((a.KNOWN_RECORDER_ERROR = !0), a);
    }
    const i = jn(this.recordingProdStack),
      s = new le({ idx: n, terminalType: e, label: r?.LABEL });
    return (i.definition.push(s), xf);
  }
}
function yi(t, e, n, r = !1) {
  ya(n);
  const i = jn(this.recordingProdStack),
    s = Yn(e) ? e : e.DEF,
...
function ya(t) {
  if (t < 0 || t > du) {
	...
	Idx value must be a none negative value smaller than ${du + 1}`);
...
const Ta = hl(fn, '', NaN, NaN, NaN, NaN, NaN, NaN);
Object.freeze(Ta);
...
function $y(t, e, n) {
  const r = Le(t, e, n, { type: Mf });
  mn(t, r);
  const i = Qr(t, e, r, n, Xn(t, e, n));
  return jf(t, e, n, i);
}
function Ly(t, e, n) {
  const r = Le(t, e, n, { type: Mf });
  mn(t, r);
  const i = Qr(t, e, r, n, Xn(t, e, n)),
    s = vl(t, e, n.separator, n);
  return jf(t, e, n, i, s);
}
function Oy(t, e, n) {
  const r = Le(t, e, n, { type: Df });
  mn(t, r);
  const i = Qr(t, e, r, n, Xn(t, e, n));
  return qf(t, e, n, i);
}
...
function Dy(t, e, n) {
  const r = Le(t, e, n, { type: hn });
  mn(t, r);
  const i = M(n.definition, (a) => Uf(t, e, a));
  return Qr(t, e, r, n, ...i);
}
function My(t, e, n) {
  const r = Le(t, e, n, { type: hn });
...
function qf(t, e, n, r, i) {
  const s = r.left,
    ...
    o = Le(t, e, n, { type: _y });
  mn(t, o);
  const c = Le(t, e, n, { type: Ff });
  return (
    (s.loopback = o),
    (c.loopback = o),
    (t.decisionMap[zr(e, i ? 'RepetitionMandatoryWithSeparator' : 'RepetitionMandatory', n.idx)] =
      o),
    _e(a, o),
...
function jf(t, e, n, r, i) {
  ...
  return (
    ...
    (t.decisionMap[zr(e, i ? 'RepetitionWithSeparator' : 'Repetition', n.idx)] = o),
    { left: o, right: c }
  );
}
function Fy(t, e, n, r) {
...
function vl(t, e, n, r) {
  const i = Le(t, e, r, { type: hn }),
    s = Le(t, e, r, { type: hn });
  return (El(i, new Tl(s, n)), { left: i, right: s });
}
function qy(t, e, n) {
...
class Wy extends gl {
  ...
  buildLookaheadForAlternation(e) {
    const { prodOccurrence: n, rule: r, hasPredicates: i, dynamicTokensEnabled: s } = e,
      a = this.dfas,
      o = this.logging,
      c = zr(r, 'Alternation', n),
      u = this.atn.decisionMap[c].decision,
      f = M(au({ maxLookahead: 1, occurrence: n, prodType: 'Alternation', rule: r }), (m) =>
        M(m, (p) => p[0]),
      );
    if (mu(f, !1) && !s) {
      const m = Je(
      ...
      return i
        ? function (m) {
            const p = new Bf(),
              A = m === void 0 ? 0 : m.length;
            for (let I = 0; I < A; I++) {
              const C = m?.[I].GATE;
              p.set(I, C === void 0 || C.call(this));
            }
            const b = ro.call(this, a, u, p, o);
            return typeof b == 'number' ? b : void 0;
          }
        : function () {
            const m = ro.call(this, a, u, pu, o);
  ...
  buildLookaheadForOptional(e) {
    const { prodOccurrence: n, rule: r, prodType: i, dynamicTokensEnabled: s } = e,
      ...
      c = zr(r, i, n),
      u = this.atn.decisionMap[c].decision,
      f = M(au({ maxLookahead: 1, occurrence: n, prodType: i, rule: r }), (m) => M(m, (p) => p[0]));
    if (mu(f) && f[0][0] && !s) {
      const m = f[0],
        p = yt(m);
...
function Hy(t, e, n, r, i, s) {
  ...
  if (a.size === 0) return (gu(t, e, n, va), va);
  let o = Wf(a);
  const c = nT(a, i);
  if (c !== void 0) ((o.isAcceptState = !0), (o.prediction = c), (o.configs.uniqueAlt = c));
    ...
    ((o.isAcceptState = !0),
      ...
      Yy.apply(this, [t, r, a.alts, s]));
  }
  return ((o = gu(t, e, n, o)), o);
}
function Yy(t, e, n, r) {
  const i = [];
...
function Qy(t, e, n) {
  const r = dt(e.configs.elements, (s) => s.state.transitions),
    i = vp(
      r.filter((s) => s instanceof Tl).map((s) => s.tokenType),
      (s) => s.tokenTypeIdx,
    );
...
function tT(t, e) {
  if (t instanceof Tl && yf(e, t.tokenType)) return t.target;
}
function nT(t, e) {
  let n;
...
function gu(t, e, n, r) {
  return ((r = Vf(t, r)), (e.edges[n.tokenTypeIdx] = r), r);
}
function Vf(t, e) {
  if (e === va) return e;
...
function iT(t, e) {
  if (e instanceof Gf) return { state: e.target, alt: t.alt, stack: t.stack };
  if (e instanceof Rl) {
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      ...
      (v.undefined(s.relatedInformation) || v.typedArray(s.relatedInformation, ka.is))
    );
  }
  t.is = n;
})(Yi || (Yi = {}));
...
(function (t) {
  ...
  function i(s) {
    const a = s;
    return Ot.is(a) && (qn.is(a.annotationId) || qe.is(a.annotationId));
  }
  t.is = i;
})(Jt || (Jt = {}));
var Xi;
    ...
    return (
      ...
      (r.documentChanges === void 0 ||
        r.documentChanges.every((i) =>
          v.string(i.kind) ? Br.is(i) || Wr.is(i) || Vr.is(i) : Xi.is(i),
        ))
    );
  }
  t.is = e;
...
class dT {
    ...
    ((this._textEditChanges = Object.create(null)),
      e !== void 0
        ? ((this._workspaceEdit = e),
          e.documentChanges
            ? ((this._changeAnnotations = new yu(e.changeAnnotations)),
  ...
  initDocumentChanges() {
    this._workspaceEdit.documentChanges === void 0 &&
      ...
      ((this._changeAnnotations = new yu()),
  ...
  createFile(e, n, r) {
    if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
      throw new Error('Workspace edit is not configured for document changes.');
    let i;
    qn.is(n) || qe.is(n) ? (i = n) : (r = n);
    let s, a;
    if (
      (i === void 0
        ? (s = Br.create(e, r))
        : ((a = qe.is(i) ? i : this._changeAnnotations.manage(i)), (s = Br.create(e, r, a))),
      this._workspaceEdit.documentChanges.push(s),
      a !== void 0)
    )
      return a;
  ...
  renameFile(e, n, r, i) {
    if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
      throw new Error('Workspace edit is not configured for document changes.');
    let s;
    qn.is(r) || qe.is(r) ? (s = r) : (i = r);
    let a, o;
    if (
      (s === void 0
        ? (a = Wr.create(e, n, i))
        : ((o = qe.is(s) ? s : this._changeAnnotations.manage(s)), (a = Wr.create(e, n, i, o))),
  ...
  deleteFile(e, n, r) {
    ...
    if (
      (i === void 0
        ? (s = Vr.create(e, r))
        : ((a = qe.is(i) ? i : this._changeAnnotations.manage(i)), (s = Vr.create(e, r, a))),
      this._workspaceEdit.documentChanges.push(s),
      a !== void 0)
    )
      return a;
...
(function (t) {
  function e(n) {
    const r = n;
    return v.objectLiteral(n) && Na.is(r.kind) && v.string(r.value);
  }
  t.is = e;
})(Kr || (Kr = {}));
var Zo;
...
(function (t) {
  function e(n) {
    ...
    return (
      r &&
      (v.string(r.detail) || r.detail === void 0) &&
      (v.string(r.description) || r.description === void 0)
    );
  }
  t.is = e;
})(ic || (ic = {}));
...
(function (t) {
  function e(n) {
    ...
    return (
      !!r &&
      v.objectLiteral(r) &&
      (Kr.is(r.contents) || Qi.is(r.contents) || v.typedArray(r.contents, Qi.is)) &&
...
(function (t) {
  function e(n, r, ...i) {
    let s = { label: n };
    return (
      v.defined(r) && (s.documentation = r),
      v.defined(i) ? (s.parameters = i) : (s.parameters = []),
      s
    );
  }
  t.create = e;
...
(function (t) {
  function e(r, i, s) {
    let a = { title: r },
      o = !0;
    return (
      typeof i == 'string' ? ((o = !1), (a.kind = i)) : Kn.is(i) ? (a.command = i) : (a.edit = i),
      o && s !== void 0 && (a.kind = s),
      a
    );
  }
  ...
  function n(r) {
    ...
    return (
      ...
      (i.command === void 0 || Kn.is(i.command)) &&
      (i.isPreferred === void 0 || v.boolean(i.isPreferred)) &&
      (i.edit === void 0 || Ca.is(i.edit))
    );
  }
  t.is = n;
})(Rc || (Rc = {}));
...
(function (t) {
  ...
  function n(r) {
    let i = r;
    return v.defined(i) && X.is(i.range) && (v.undefined(i.command) || Kn.is(i.command));
  }
  t.is = n;
})(vc || (vc = {}));
var Ec;
...
(function (t) {
  ...
  function n(r) {
    ...
    return (
      v.objectLiteral(i) &&
      (i.tooltip === void 0 || v.string(i.tooltip) || Kr.is(i.tooltip)) &&
  ...
  function r(s, a) {
    ...
    for (let u = c.length - 1; u >= 0; u--) {
      let f = c[u],
        ...
        p = s.offsetAt(f.range.end);
      if (p <= l) o = o.substring(0, m) + f.newText + o.substring(p, o.length);
...
class mT {
  ...
  buildLeafNode(e, n) {
    const r = new Uc(e.startOffset, e.image.length, bo(e), e.tokenType, !n);
  ...
  addHiddenNodes(e) {
    const n = [];
    for (const s of e) {
      const a = new Uc(s.startOffset, s.image.length, bo(s), s.tokenType, !0);
...
class Al extends Kf {
  constructor() {
    (super(...arguments), (this.content = new Sl(this)));
  }
  get offset() {
...
class Sl extends Array {
  constructor(e) {
    (super(), (this.parent = e), Object.setPrototypeOf(this, Sl.prototype));
  }
  push(...e) {
...
class gT extends Xf {
  ...
  rule(e, n) {
    ...
    const s = this.wrapper.DEFINE_RULE(Yf(e.name), this.startImplementation(r, i, n).bind(this));
  ...
  registerPrecedenceMap(e) {
    ...
    for (let i = 0; i < e.operators.precedences.length; i++) {
      ...
      for (const a of s.operators)
        r.set(a.value, { precedence: i, rightAssoc: s.associativity === 'right' });
    }
    this.operatorPrecedence.set(n, r);
  }
  computeRuleType(e) {
    return la(e) ? Vi(e) : e.fragment ? void 0 : ef(e) ? qc : Vi(e);
  }
  parse(e, n = {}) {
  ...
  constructInfix(e, n) {
    ...
    for (let b = 0; b < i.length; b++) {
      ...
      C.precedence > a
        ? ((a = C.precedence), (s = b))
        : C.precedence === a && (C.rightAssoc || (s = b));
    }
    const o = i.slice(0, s),
      c = i.slice(s + 1),
      l = r.slice(0, s + 1),
      ...
      p = this.constructInfix(f, n),
      A = this.constructInfix(m, n);
    return { $type: e.$type, $cstNode: e.$cstNode, left: p, operator: i[s], right: A };
  }
  getAssignment(e) {
...
class yT {
  buildMismatchTokenMessage(e) {
    return Er.buildMismatchTokenMessage(e);
  }
  buildNotAllInputParsedMessage(e) {
    return Er.buildNotAllInputParsedMessage(e);
  }
  buildNoViableAltMessage(e) {
    return Er.buildNoViableAltMessage(e);
  }
  buildEarlyExitMessage(e) {
    return Er.buildEarlyExitMessage(e);
  }
}
class Jf extends yT {
...
class TT extends Xf {
  ...
  rule(e, n) {
    const r = this.wrapper.DEFINE_RULE(Yf(e.name), this.startImplementation(n).bind(this));
...
class Qf extends ky {
  constructor(e, n) {
    ...
    super(e, {
      ...RT,
      lookaheadStrategy: r
        ? new gl({ maxLookahead: n.maxLookahead })
...
function ET(t, e) {
  ...
  for (const s of r) {
    ...
    t.parser.rule(s, Hn(a, s.definition));
  }
  const i = me(e.rules)
    .filter(la)
    .filter((s) => n.has(s));
...
function AT(t, e) {
  ...
  const r = e.operators.precedences.flatMap((p) => p.operators),
  ...
  a.elements.push(c, l);
  const f = r
    .map((p) => t.tokens[p.value])
    .map((p, A) => ({ ALT: () => t.parser.consume(A, p, c) }));
  let m;
  return (p) => {
    (m ?? (m = kl(t, n)),
      t.parser.subrule(0, m, !1, s, p),
      t.parser.many(0, {
        DEF: () => {
...
function Hn(t, e, n = !1) {
  ...
  else if (zn(e)) r = Hn(t, e.terminal);
  else if (Oa(e)) r = eh(t, e);
  else if (Wn(e)) r = kT(t, e);
  else if (jd(e)) r = NT(t, e);
  else if (Bd(e)) r = wT(t, e);
  else if (cl(e)) r = bT(t, e);
  else if (_p(e)) {
    const i = t.consume++;
    r = () => t.parser.consume(i, fn, e);
  } else throw new Vd(e.$cstNode, `Unexpected element type: ${e.$type}`);
  return th(t, n ? void 0 : _a(e), r, e.cardinality);
}
function ST(t, e) {
  const n = Vi(e);
...
function kT(t, e) {
  ...
  if (ss(n)) {
    const r = t.subrule++,
      i = sn(n) && n.fragment,
      s = e.arguments.length > 0 ? CT(n, e.arguments) : () => ({});
    let a;
    return (o) => {
      (a ?? (a = kl(t, n)), t.parser.subrule(r, a, i, e, s(o)));
    };
  } else if (an(n)) {
    const r = t.consume++,
      i = jc(t, n.name);
  ...
  else throw new Vd(e.$cstNode, `Undefined rule: ${e.rule.$refText}`);
}
function CT(t, e) {
  if (e.some((r) => r.calledByName)) {
    const r = e.map((i) => ({ parameterName: i.parameter?.ref?.name, predicate: Lt(i.value) }));
    return (i) => {
      const s = {};
...
function NT(t, e) {
  if (e.elements.length === 1) return Hn(t, e.elements[0]);
  {
    const n = [];
    for (const i of e.elements) {
      const s = { ALT: Hn(t, i, !0) },
        a = _a(i);
    ...
    s = (o) =>
      t.parser.alternatives(
        ...
        n.map((c, l) => {
          ...
          const m = c.GATE;
          return (
            m ? (u.GATE = () => m(o)) : (u.GATE = () => !f.unorderedGroups.get(i(r, f))?.[l]),
            u
          );
        }),
      ),
...
function bT(t, e) {
  const n = e.elements.map((r) => Hn(t, r));
  return (r) => n.forEach((i) => i(r));
}
function _a(t) {
  if (cl(t)) return t.guardCondition;
}
function eh(t, e, n = e.terminal) {
  if (n)
    if (Wn(n) && sn(n.rule.ref)) {
      const r = n.rule.ref,
        i = t.subrule++;
      let s;
      return (a) => {
        (s ?? (s = kl(t, r)), t.parser.subrule(i, s, !1, e, a));
      };
    } else if (Wn(n) && an(n.rule.ref)) {
      const r = t.consume++,
        i = jc(t, n.rule.ref.name);
      return () => t.parser.consume(r, i, e);
    } else if (Bn(n)) {
      const r = t.consume++,
        i = jc(t, n.value);
    ...
    const i = Qd(e.type.ref)?.terminal;
...
function IT(t, e) {
  ...
  if (t.ruleNames.has(e)) return t.ruleNames.get(e);
  {
    let n = e,
      ...
      i = e.$type;
    for (; !sn(r); )
      ((cl(r) || jd(r) || Bd(r)) && (i = r.elements.indexOf(n).toString() + ':' + i),
        (n = r),
        (r = r.$container));
...
function PT(t) {
  const e = t.Grammar,
    n = t.parser.Lexer,
    r = new TT(t);
  return (Zf(e, r, n.definition), r.finalize(), r);
}
function $T(t) {
  const e = LT(t);
  return (e.finalize(), e);
...
class nh {
  ...
  buildTerminalToken(e) {
    ...
    return (
      ...
      e.hidden && (i.GROUP = Hd(n) ? tt.SKIPPED : 'hidden'),
      i
    );
  }
...
function Jn() {
  if (Ru) return Gs;
  ((Ru = 1), Object.defineProperty(Gs, '__esModule', { value: !0 }));
  let t;
  function e() {
...
function Ba() {
  ...
  ((Au = 1),
    ...
    (Sn.CancellationTokenSource = Sn.CancellationToken = void 0));
  const t = Jn(),
    e = fs(),
    n = Zr();
  var r;
  (function (o) {
    ...
    function c(l) {
      ...
      return (
        ...
        (u === o.None ||
          u === o.Cancelled ||
          (e.boolean(u.isCancellationRequested) && !!u.onCancellationRequested))
      );
    }
    o.is = c;
  })(r || (Sn.CancellationToken = r = {}));
  ...
  return ((Sn.CancellationTokenSource = a), Sn);
}
var ye = Ba();
function OT() {
...
let ia = 0,
  xT = 10;
function DT() {
  return ((ia = performance.now()), new ye.CancellationTokenSource());
}
const Ar = Symbol('OperationCancelled');
function Wa(t) {
  return t === Ar;
}
async function Xe(t) {
  if (t === ye.CancellationToken.None) return;
  const e = performance.now();
  if ((e - ia >= xT && ((ia = e), await OT(), (ia = performance.now())), t.isCancellationRequested))
    throw Ar;
}
class Cl {
  constructor() {
...
class es {
  ...
  update(e, n) {
    for (const r of e)
      if (es.isIncremental(r)) {
        ...
        const u = Su(r.text, !1, s);
        if (c - o === u.length) for (let m = 0, p = u.length; m < p; m++) l[m + o + 1] = u[m];
        else
          u.length < 1e4
            ? l.splice(o + 1, c - o, ...u)
            : (this._lineOffsets = l = l.slice(0, o + 1).concat(u, l.slice(c + 1)));
        const f = r.text.length - (a - s);
        if (f !== 0) for (let m = o + 1 + u.length, p = l.length; m < p; m++) l[m] = l[m] + f;
  ...
  getLineOffsets() {
    return (
      this._lineOffsets === void 0 && (this._lineOffsets = Su(this._content, !0)),
      this._lineOffsets
    );
  }
  positionAt(e) {
  ...
  ensureBeforeEOL(e, n) {
    for (; e > n && ih(this._content.charCodeAt(e - 1)); ) e--;
    return e;
  }
  get lineCount() {
    return this.getLineOffsets().length;
...
(function (t) {
  ...
  function r(i, s) {
    ...
    for (const u of o) {
      ...
      (f > c && l.push(a.substring(c, f)),
        u.newText.length && l.push(u.newText),
        (c = i.offsetAt(u.range.end)));
    }
...
function Su(t, e, n = 0) {
  ...
  for (let i = 0; i < t.length; i++) {
    ...
    ih(s) && (s === 13 && i + 1 < t.length && t.charCodeAt(i + 1) === 10 && i++, r.push(n + i + 1));
  }
  return r;
}
function ih(t) {
...
(() => {
  var t = {
      975: (_) => {
        function T(y) {
          if (typeof y != 'string')
            throw new TypeError('Path must be a string. Received ' + JSON.stringify(y));
        }
        function g(y, R) {
            ...
            if (E === 47) {
              if (!(x === G - 1 || j === 1))
                if (x !== G - 1 && j === 2) {
                  if (
                    ...
                    if (O.length > 2) {
                      ...
                      if (ie !== O.length - 1) {
                        (ie === -1
                          ? ((O = ''), (D = 0))
                          : (D = (O = O.slice(0, ie)).length - 1 - O.lastIndexOf('/')),
                          (x = G),
                          (j = 0));
                        continue;
                      }
                  ...
                  (O.length > 0 ? (O += '/' + y.slice(x + 1, G)) : (O = y.slice(x + 1, G)),
                    (D = G - x - 1));
              ((x = G), (j = 0));
            } else E === 46 && j !== -1 ? ++j : (j = -1);
          }
        ...
        var S = {
          resolve: function () {
            for (var y, R = '', E = !1, O = arguments.length - 1; O >= -1 && !E; O--) {
              var D;
              (O >= 0 ? (D = arguments[O]) : (y === void 0 && (y = ji.cwd()), (D = y)),
                T(D),
                D.length !== 0 && ((R = D + '/' + R), (E = D.charCodeAt(0) === 47)));
            }
            return ((R = g(R, !E)), E ? (R.length > 0 ? '/' + R : '/') : R.length > 0 ? R : '.');
          },
          normalize: function (y) {
            if ((T(y), y.length === 0)) return '.';
            var R = y.charCodeAt(0) === 47,
              E = y.charCodeAt(y.length - 1) === 47;
            return (
              (y = g(y, !R)).length !== 0 || R || (y = '.'),
              y.length > 0 && E && (y += '/'),
              R ? '/' + y : y
            );
          },
          ...
          relative: function (y, R) {
            ...
            var Oe = '';
            for (B = E + ie + 1; B <= O; ++B)
              (B !== O && y.charCodeAt(B) !== 47) ||
                (Oe.length === 0 ? (Oe += '..') : (Oe += '/..'));
            return Oe.length > 0
              ? Oe + R.slice(x + ie)
              : ((x += ie), R.charCodeAt(x) === 47 && ++x, R.slice(x));
          },
          ...
          dirname: function (y) {
            if ((T(y), y.length === 0)) return '.';
            for (
              var R = y.charCodeAt(0), E = R === 47, O = -1, D = !0, x = y.length - 1;
              x >= 1;
              --x
            )
              if ((R = y.charCodeAt(x)) === 47) {
                if (!D) {
                  O = x;
                  break;
                }
            ...
            if (R !== void 0 && R.length > 0 && R.length <= y.length) {
              ...
              for (E = y.length - 1; E >= 0; --E) {
                ...
                if (ie === 47) {
                  ...
                  (G === -1 && ((x = !1), (G = E + 1)),
                    j >= 0 &&
                      (ie === R.charCodeAt(j) ? --j == -1 && (D = E) : ((j = -1), (D = G))));
              }
              return (O === D ? (D = G) : D === -1 && (D = y.length), y.slice(O, D));
            }
            for (E = y.length - 1; E >= 0; --E)
              if (y.charCodeAt(E) === 47) {
                if (!x) {
                  O = E + 1;
                  break;
                }
          ...
          extname: function (y) {
            ...
            for (var R = -1, E = 0, O = -1, D = !0, x = 0, j = y.length - 1; j >= 0; --j) {
              ...
              if (G !== 47)
                (O === -1 && ((D = !1), (O = j + 1)),
                  G === 46 ? (R === -1 ? (R = j) : x !== 1 && (x = 1)) : R !== -1 && (x = -1));
              else if (!D) {
                E = j + 1;
                break;
              }
            }
            return R === -1 || O === -1 || x === 0 || (x === 1 && R === O - 1 && R === E + 1)
              ? ''
              : y.slice(R, O);
          },
          format: function (y) {
            if (y === null || typeof y != 'object')
              throw new TypeError(
                'The "pathObject" argument must be of type Object. Received type ' + typeof y,
              );
            return (function (R, E) {
              var O = E.dir || E.root,
                D = E.base || (E.name || '') + (E.ext || '');
          ...
          parse: function (y) {
            ...
            var E,
              ...
              D = O === 47;
            D ? ((R.root = '/'), (E = 1)) : (E = 0);
            for (var x = -1, j = 0, G = -1, ie = !0, B = y.length - 1, ne = 0; B >= E; --B)
            ...
            return (
              x === -1 || G === -1 || ne === 0 || (ne === 1 && x === G - 1 && x === j + 1)
                ? G !== -1 && (R.base = R.name = j === 0 && D ? y.slice(1, G) : y.slice(j, G))
                : (j === 0 && D
                    ? ((R.name = y.slice(1, x)), (R.base = y.slice(1, G)))
                    : ((R.name = y.slice(j, x)), (R.base = y.slice(j, G))),
                  (R.ext = y.slice(x, G))),
              j > 0 ? (R.dir = y.slice(0, j - 1)) : D && (R.dir = '/'),
              R
            );
          },
          sep: '/',
  ...
  ((n.d = (_, T) => {
    for (var g in T)
      n.o(T, g) && !n.o(_, g) && Object.defineProperty(_, g, { enumerable: !0, get: T[g] });
  }),
  ...
  class m {
    ...
    constructor(T, g, S, y, R, E = !1) {
      typeof T == 'object'
        ? ((this.scheme = T.scheme || l),
          (this.authority = T.authority || l),
          (this.path = T.path || l),
          (this.query = T.query || l),
          (this.fragment = T.fragment || l))
    ...
    with(T) {
      ...
      return (
        ...
        R === void 0 ? (R = this.query) : R === null && (R = l),
        E === void 0 ? (E = this.fragment) : E === null && (E = l),
        g === this.scheme &&
        S === this.authority &&
        y === this.path &&
        R === this.query &&
    ...
    static parse(T, g = !1) {
      const S = f.exec(T);
      return S
        ? new A(S[2] || l, K(S[4] || l), K(S[5] || l), K(S[7] || l), K(S[9] || l), g)
        : new A(l, l, l, l, l);
    }
    static file(T) {
      let g = l;
      if ((i && (T = T.replace(/\\/g, u)), T[0] === u && T[1] === u)) {
        ...
        S === -1
          ? ((g = T.substring(2)), (T = u))
          : ((g = T.substring(2, S)), (T = T.substring(S) || u));
      }
  ...
  class A extends m {
    ...
    toString(T = !1) {
      return T
        ? k(this, !0)
        : (this._formatted || (this._formatted = k(this, !1)), this._formatted);
    }
    toJSON() {
      const T = { $mid: 1 };
      return (
        this._fsPath && ((T.fsPath = this._fsPath), (T._sep = p)),
  ...
  function I(_, T, g) {
    ...
    for (let R = 0; R < _.length; R++) {
      ...
      if (
        ...
        (y !== -1 && ((S += encodeURIComponent(_.substring(y, R))), (y = -1)),
          S !== void 0 && (S += _.charAt(R)));
      else {
        S === void 0 && (S = _.substr(0, R));
        const O = b[E];
        O !== void 0
          ? (y !== -1 && ((S += encodeURIComponent(_.substring(y, R))), (y = -1)), (S += O))
          : y === -1 && (y = R);
      }
    }
  ...
  function k(_, T) {
    const g = T ? C : I;
    let S = '',
      { scheme: y, authority: R, path: E, query: O, fragment: D } = _;
    if ((y && ((S += y), (S += ':')), (R || y === 'file') && ((S += u), (S += u)), R)) {
      ...
      if (x !== -1) {
        ...
        ((R = R.substr(x + 1)),
          ...
          x === -1
            ? (S += g(j, !1, !1))
            : ((S += g(j.substr(0, x), !1, !1)), (S += ':'), (S += g(j.substr(x + 1), !1, !0))),
          (S += '@'));
      }
      ((R = R.toLowerCase()),
        (x = R.lastIndexOf(':')),
        x === -1 ? (S += g(R, !1, !0)) : ((S += g(R.substr(0, x), !1, !0)), (S += R.substr(x))));
    }
    if (E) {
...
const { URI: Ct, Utils: Ti } = ah;
var ut;
(function (t) {
  ((t.basename = Ti.basename),
    (t.dirname = Ti.dirname),
    (t.extname = Ti.extname),
    (t.joinPath = Ti.joinPath),
    (t.resolvePath = Ti.resolvePath));
  const e = typeof ji == 'object' && ji?.platform === 'win32';
  function n(a, o) {
    return a?.toString() === o?.toString();
  }
  t.equals = n;
  function r(a, o) {
    const c = typeof a == 'string' ? Ct.parse(a).path : a.path,
      l = typeof o == 'string' ? Ct.parse(o).path : o.path,
...
class FT {
  ...
  findNode(e) {
    const n = this.normalizeUri(e),
      r = this.getNode(n, !1);
    if (r)
      return { name: r.name, uri: ut.joinPath(Ct.parse(n), r.name).toString(), element: r.element };
  }
  findChildren(e) {
    const n = this.normalizeUri(e),
      r = this.getNode(n, !1);
...
class GT {
  ...
  fromTextDocument(e, n, r) {
    return (
      (n = n ?? Ct.parse(e.uri)),
      ye.CancellationToken.is(r) ? this.createAsync(n, e, r) : this.create(n, e, r)
    );
  }
  fromString(e, n, r) {
  ...
  async update(e, n) {
    const r = e.parseResult.value.$cstNode?.root.fullText,
      i = this.textDocuments?.get(e.uri.toString()),
    ...
    return (
      r !== s &&
        ((e.parseResult = await this.parseAsync(e.uri, s, n)), (e.parseResult.value.$document = e)),
      (e.state = Y.Parsed),
      e
    );
  }
  ...
  createTextDocumentGetter(e, n) {
    ...
    let i;
    return () =>
      i ?? (i = zc.create(e.toString(), r.getServices(e).LanguageMetaData.languageId, 0, n ?? ''));
  }
}
class UT {
  constructor(e) {
...
class qT {
  ...
  async link(e, n = ye.CancellationToken.None) {
    if (this.profiler?.isActive('linking')) {
      ...
      for (const r of Zt(e.parseResult.value))
        (await Xe(n), ca(r).forEach((i) => this.doLink(i, e)));
  }
  doLink(e, n) {
    const r = e.reference;
  ...
  getCandidate(e) {
    return (
      this.scopeProvider.getScope(e).getElement(e.reference.$refText) ?? this.createLinkingError(e)
    );
  }
  getCandidates(e) {
      ...
      a = {
        ...
        get ref() {
          ...
          if (Ep(this._nodeDescription)) {
            ...
            ((this._ref = c.node ?? c.error),
              (this._nodeDescription = c.descr),
              o?.references.push(this));
          } else this._ref === ir && s.throwCyclicReferenceError(e, n, i);
        ...
        get error() {
          return fi(this._ref) ? this._ref : void 0;
        },
      };
    return a;
  }
    ...
    const s = this,
      a = {
        ...
        get items() {
          ...
          } else this._items === ir && s.throwCyclicReferenceError(e, n, i);
          return Array.isArray(this._items) ? this._items : [];
        },
        get error() {
          if (this._linkingError) return this._linkingError;
          if (!(this.items.length > 0))
            return (this._linkingError = s.createLinkingError({
              reference: a,
              container: e,
              property: n,
            }));
...
class BT {
  ...
  findDeclarations(e) {
    if (e) {
      ...
      if (n && r) {
        const i = r[n.feature];
        if (St(i) || un(i)) return Ll(i);
        if (Array.isArray(i)) {
          for (const s of i)
            if (
              (St(s) || un(s)) &&
              s.$refNode &&
              s.$refNode.offset <= e.offset &&
              s.$refNode.end >= e.end
            )
              return Ll(s);
        }
  ...
  findReferences(e, n) {
    ...
    return (
      n.documentUri && (i = i.filter((s) => ut.equals(s.sourceUri, n.documentUri))),
      r.push(...i),
      me(r)
    );
  }
...
class ts {
  ...
  get size() {
    return Ro.sum(me(this.map.values()).map((e) => e.length));
  }
  clear() {
    this.map.clear();
  }
...
class WT {
  ...
  async collectExportedSymbolsForNode(e, n, r = ol, i = ye.CancellationToken.None) {
    const s = [];
...
class Cu {
  constructor(e, n, r) {
    ((this.elements = e),
      (this.outerScope = n),
      (this.caseInsensitive = r?.caseInsensitive ?? !1),
      (this.concatOuterScope = r?.concatOuterScope ?? !0));
  }
  getAllElements() {
  ...
  getElements(e) {
    ...
    return (this.concatOuterScope || r.isEmpty()) && this.outerScope
      ? r.concat(this.outerScope.getElements(e))
      : r;
  }
}
class VT {
  ...
  getElements(e) {
    ...
    return (this.concatOuterScope || r.length === 0) && this.outerScope
      ? me(r).concat(this.outerScope.getElements(e))
      : me(r);
  }
  getAllElements() {
...
class XT {
  ...
  getScope(e) {
    ...
    if (i) {
      let a = e.container;
      do
        (i.has(a) && n.push(i.getStream(a).filter((o) => this.reflection.isSubtype(o.type, r))),
          (a = a.$container));
      while (a);
    }
...
class QT {
  ...
  replacer(e, n, { refText: r, sourceText: i, textRegions: s, comments: a, uriConverter: o }) {
    if (!this.ignoreProperties.has(e))
      if (St(n)) {
        const c = n.ref,
          l = r ? n.$refText : void 0;
        if (c) {
          const u = Qt(c);
          let f = '';
          this.currentDocument &&
            this.currentDocument !== u &&
            (o ? (f = o(u.uri, c)) : (f = u.uri.toString()));
          const m = this.astNodeLocator.getAstNodePath(c);
          return { $ref: `${f}#${m}`, $refText: l };
        } else return { $error: n.error?.message ?? 'Could not resolve reference', $refText: l };
      } else if (un(n)) {
        const c = r ? n.$refText : void 0,
          l = [];
        for (const u of n.items) {
          ...
          this.currentDocument &&
            ...
            (o ? (p = o(m.uri, f)) : (p = m.uri.toString()));
          const A = this.astNodeLocator.getAstNodePath(f);
          l.push(`${p}#${A}`);
        }
        return { $refs: l, $refText: c };
      } else if (We(n)) {
        let c;
        if (
          (s &&
            ((c = this.addAstNodeRegionWithAssignmentsTo({ ...n })),
            (!e || n.$document) &&
              c?.$textRegion &&
              (c.$textRegion.documentURI = this.currentDocument?.uri.toString())),
          i && !e && (c ?? (c = { ...n }), (c.$sourceText = n.$cstNode?.text)),
          a)
        ) {
          c ?? (c = { ...n });
    ...
    for (const [c, l] of Object.entries(e))
      if (Array.isArray(l))
        for (let u = 0; u < l.length; u++) {
          const f = l[u];
          Nu(f)
            ? (l[u] = this.reviveReference(e, c, n, f, r))
            : We(f) && this.linkNode(f, n, r, e, c, u);
        }
      else
        Nu(l)
          ? (e[c] = this.reviveReference(e, c, n, l, r))
          : We(l) && this.linkNode(l, n, r, e, c);
    const o = e;
  ...
  reviveReference(e, n, r, i, s) {
    ...
    if (i.$ref) {
      ...
      if (l.length === 0)
        ((c = { $refText: a ?? '', items: l }), o ?? (o = 'Could not resolve multi-reference'));
...
class ZT {
  ...
  register(e) {
    ...
    if (n.fileNames)
      for (const r of n.fileNames)
        (this.fileNameMap.has(r) &&
          console.warn(
            `The file name ${r} is used by multiple languages. It is now assigned to '${n.languageId}'.`,
          ),
          this.fileNameMap.set(r, e));
  ...
  getServices(e) {
    ...
    if (!s)
      throw n
        ? new Error(
            `The service registry contains no services for the extension '${r}' for language '${n}'.`,
          )
...
class eR {
  constructor(e) {
    ((this.entries = new ts()),
      (this.knownCategories = new Set(Wc.defaults)),
      (this.entriesBefore = []),
      (this.entriesAfter = []),
      (this.reflection = e.shared.AstReflection));
  }
  ...
  async validateDocument(e, n = {}, r = ye.CancellationToken.None) {
    ...
    if (
      ...
      (!n.categories || n.categories.includes('built-in')) &&
        ...
        (n.stopAfterLexingErrors && s.some((a) => a.data?.code === At.LexingError)) ||
          (this.processParsingErrors(i, s, n),
          n.stopAfterParsingErrors && s.some((a) => a.data?.code === At.ParsingError)) ||
          (this.processLinkingErrors(e, s, n),
          n.stopAfterLinkingErrors && s.some((a) => a.data?.code === At.LinkingError))))
    )
      return s;
    try {
    ...
    if (this.profiler?.isActive('validating')) {
      ...
      for (const a of s) {
        ...
        if (o.validateNode) {
          ...
          for (const l of c) await l(a, r, i);
        }
...
function rR(t) {
  ...
  return (
    typeof t.property == 'string'
      ? (e = Jd(t.node.$cstNode, t.property, t.index))
...
function iR(t) {
  switch (t) {
    case 'error':
      return Ui(At.LexingError);
    case 'warning':
      return Ui(At.LexingWarning);
    case 'info':
      return Ui(At.LexingInfo);
    case 'hint':
      return Ui(At.LexingHint);
    default:
      throw new Error('Invalid diagnostic severity: ' + t);
  }
}
...
class aR {
  ...
  createInfoDescriptions(e) {
    ...
    St(n) && n.$nodeDescription
      ? (r = [n.$nodeDescription])
      : un(n) && (r = n.items.map((c) => c.$nodeDescription).filter((c) => c !== void 0));
  ...
  return (
    (function (T) {
      ...
      function y(R) {
        ...
        return (
          E &&
          (E.result !== void 0 || !!E.error) &&
          (t.string(E.id) || t.number(E.id) || E.id === null)
        );
      }
      T.isResponse = y;
    })(_ || (U.Message = _ = {})),
...
function lh() {
  ...
  (Object.defineProperty(Ft, '__esModule', { value: !0 }),
    (Ft.LRUCache = Ft.LinkedMap = Ft.Touch = void 0));
  var e;
  (function (i) {
...
function uR() {
  if (_u) return Ri;
  ((_u = 1), Object.defineProperty(Ri, '__esModule', { value: !0 }), (Ri.Disposable = void 0));
  var t;
  return (
    (function (e) {
      function n(r) {
...
function dR() {
  ...
  ((Iu = 1),
    ...
    (wn.SharedArrayReceiverStrategy = wn.SharedArraySenderStrategy = void 0));
  const t = Ba();
  var e;
  (function (a) {
  ...
  wn.SharedArraySenderStrategy = n;
  class r {
    constructor(o) {
  ...
  return ((wn.SharedArrayReceiverStrategy = s), wn);
}
var Gt = {},
  vi = {},
  Pu;
function uh() {
  if (Pu) return vi;
  ((Pu = 1), Object.defineProperty(vi, '__esModule', { value: !0 }), (vi.Semaphore = void 0));
  const t = Jn();
  class e {
    constructor(r = 1) {
...
function fR() {
  ...
  class s {
    ...
    asError(l) {
      return l instanceof Error
        ? l
        : new Error(
            `Reader received error. Reason: ${e.string(l.message) ? l.message : 'unknown'}`,
          );
    }
  }
  ...
  (function (c) {
    function l(u) {
      ...
      if (u === void 0 || typeof u == 'string') f = u ?? 'utf-8';
        ...
        if (
          ((f = u.charset ?? 'utf-8'),
          u.contentDecoder !== void 0 && ((m = u.contentDecoder), p.set(m.name, m)),
          u.contentDecoders !== void 0)
        )
          for (const I of u.contentDecoders) p.set(I.name, I);
        if (
          (u.contentTypeDecoder !== void 0 && ((A = u.contentTypeDecoder), b.set(A.name, A)),
          u.contentTypeDecoders !== void 0)
        )
          for (const I of u.contentTypeDecoders) b.set(I.name, I);
      }
      return (
        A === void 0 && ((A = (0, t.default)().applicationJson.decoder), b.set(A.name, A)),
        {
          charset: f,
          contentDecoder: m,
          contentDecoders: p,
          contentTypeDecoder: A,
          contentTypeDecoders: b,
        }
      );
    }
    c.fromOptions = l;
  ...
  class o extends s {
    ...
    listen(l) {
      ...
      return (
        this.readable.onError((f) => this.fireError(f)),
              ...
              .lock(async () => {
                const f =
                    this.options.contentDecoder !== void 0
                      ? await this.options.contentDecoder.decode(u)
                      : u,
                  m = await this.options.contentTypeDecoder.decode(f, this.options);
                this.callback(m);
              })
              .catch((f) => {
                this.fireError(f);
        ...
        !(this._partialMessageTimeout <= 0) &&
          (this.partialMessageTimer = (0, t.default)().timer.setTimeout(
            (l, u) => {
              ((this.partialMessageTimer = void 0),
                l === this.messageToken &&
                  (this.firePartialMessage({ messageToken: l, waitingTime: u }),
                  this.setPartialMessageTimer()));
            },
...
`;
  ...
  class o {
    ...
    asError(f) {
      return f instanceof Error
        ? f
        : new Error(
            `Writer received error. Reason: ${e.string(f.message) ? f.message : 'unknown'}`,
          );
    }
  }
  ...
  class l extends o {
    constructor(f, m) {
      (super(),
        (this.writable = f),
        (this.options = c.fromOptions(m)),
        (this.errorCount = 0),
        (this.writeSemaphore = new n.Semaphore(1)),
        this.writable.onError((p) => this.fireError(p)),
    ...
    async write(f) {
      return this.writeSemaphore.lock(async () =>
        this.options.contentTypeEncoder
          ...
          .then((p) =>
            this.options.contentEncoder !== void 0 ? this.options.contentEncoder.encode(p) : p,
          )
          .then(
            (p) => {
              const A = [];
...
function pR() {
  ...
  ((Ou = 1),
    ...
    (Ei.AbstractMessageBuffer = void 0));
  const t = 13,
    e = 10,
    n = `\r
`;
  class r {
    ...
    tryReadHeaders(s = !1) {
      ...
      const u = this._read(l + c),
        f = new Map(),
        m = this.toString(u, 'ascii').split(n);
      if (m.length < 2) return f;
...
${A}`);
  ...
  return ((Ei.AbstractMessageBuffer = r), Ei);
}
var oo = {},
  xu;
function mR() {
  return (
    xu ||
      ...
      (function (t) {
        ...
        (function (g) {
          function S(y) {
            ...
            return (
              ...
              n.func(R.createCancellationTokenSource) &&
              (R.dispose === void 0 || n.func(R.dispose))
            );
          }
          g.is = S;
        ...
        var oe;
        (function (g) {
          g.Message = Object.freeze({ receiver: K.Message, sender: J.Message });
          function S(y) {
            const R = y;
        ...
        (function (g) {
          function S(y) {
            ...
            return (
              R &&
              (oe.is(R.cancellationStrategy) ||
                k.is(R.connectionStrategy) ||
                ue.is(R.messageStrategy))
            );
          }
          g.is = S;
        ...
        function T(g, S, y, R) {
          ...
          let Re,
            ...
            ve,
            Tt = _.New;
          const er = new s.Emitter(),
            ti = new s.Emitter(),
            ni = new s.Emitter(),
            ri = new s.Emitter(),
            ii = new s.Emitter(),
            Rt = R && R.cancellationStrategy ? R.cancellationStrategy : oe.Message;
          function si(h) {
            if (h === null)
              throw new Error(
          ...
          function ms(h, w) {
            r.Message.isRequest(w)
              ? h.set(si(w.id), w)
              : r.Message.isResponse(w)
                ? h.set(hs(w.id), w)
                : h.set(ps(), w);
          }
          function gs(h) {}
          ...
          function ci() {
            (Tt === _.New || Tt === _.Listening) && ((Tt = _.Closed), ti.fire(void 0));
          }
          function ys(h) {
            er.fire([h, void 0, void 0]);
          }
          function Ts(h) {
            er.fire(h);
          }
          (g.onClose(ci), g.onError(ys), S.onClose(ci), S.onError(Ts));
          function li() {
            Re ||
              fe.size === 0 ||
              (Re = (0, e.default)().timer.setImmediate(() => {
                ((Re = void 0), Rs());
              }));
          }
          function ui(h) {
            r.Message.isRequest(h)
              ? Es(h)
              : r.Message.isNotification(h)
                ? Ss(h)
                : r.Message.isResponse(h)
                  ? As(h)
                  : ks(h);
          }
          function Rs() {
            ...
            try {
              ...
              ue.is(w) ? w.handleMessage(h, ui) : ui(h);
            } finally {
              li();
            }
          }
            ...
            try {
              if (r.Message.isNotification(h) && h.method === o.type.method) {
                ...
                if (r.Message.isRequest(F)) {
                  const se = R?.connectionStrategy,
                    Ee = se && se.cancelUndispatched ? se.cancelUndispatched(F, gs) : void 0;
                  if (Ee && (Ee.error !== void 0 || Ee.result !== void 0)) {
                    (fe.delete(L),
                      be.delete(w),
                      (Ee.id = F.id),
                      vn(Ee, h.method, Date.now()),
                      S.write(Ee).catch(() =>
                        E.error('Sending response for canceled message failed.'),
                      ));
                    return;
                  }
                }
          ...
          function Es(h) {
            if (Dt()) return;
            function w(Q, he, re) {
              const Pe = { jsonrpc: j, id: h.id };
              (Q instanceof r.ResponseError
                ? (Pe.error = Q.toJson())
                : (Pe.result = Q === void 0 ? null : Q),
                vn(Pe, he, re),
                S.write(Pe).catch(() => E.error('Sending response failed.')));
            }
            function L(Q, he, re) {
              const Pe = { jsonrpc: j, id: h.id, error: Q.toJson() };
              (vn(Pe, he, re), S.write(Pe).catch(() => E.error('Sending response failed.')));
            }
            function F(Q, he, re) {
              Q === void 0 && (Q = null);
              const Pe = { jsonrpc: j, id: h.id, result: Q };
              (vn(Pe, he, re), S.write(Pe).catch(() => E.error('Sending response failed.')));
            }
            ws(h);
            ...
            const Ne = Date.now();
            if (Ee || G) {
              const Q = h.id ?? String(Date.now()),
                he = P.is(Rt.receiver)
                  ? Rt.receiver.createCancellationTokenSource(Q)
                  : Rt.receiver.createCancellationTokenSource(h);
              ...
              try {
                  ...
                  if (h.params === void 0) {
                    if (se !== void 0 && se.numberOfParams !== 0) {
                      L(
                        new r.ResponseError(
                          ...
                          `Request ${h.method} defines ${se.numberOfParams} params but received none.`,
                        ),
                        h.method,
                        Ne,
                      );
                    ...
                    if (se !== void 0 && se.parameterStructures === r.ParameterStructures.byName) {
                      L(
                        new r.ResponseError(
                          r.ErrorCodes.InvalidParams,
                          `Request ${h.method} defines parameters by name but received parameters by position`,
                        ),
                        h.method,
                        Ne,
                      );
                    ...
                    if (
                      se !== void 0 &&
                      se.parameterStructures === r.ParameterStructures.byPosition
                    ) {
                      L(
                        new r.ResponseError(
                          r.ErrorCodes.InvalidParams,
                          `Request ${h.method} defines parameters by position but received parameters by name`,
                        ),
                        h.method,
                        Ne,
                      );
                ...
                re
                  ? Pe.then
                              ...
                              : Ke && n.string(Ke.message)
                                ? L(
                                    new r.ResponseError(
                                      ...
                                      `Request ${h.method} failed with message: ${Ke.message}`,
                                    ),
                                    h.method,
                                    Ne,
                                  )
                                : L(
                                    new r.ResponseError(
                                      r.ErrorCodes.InternalError,
                                      `Request ${h.method} failed unexpectedly without providing any details.`,
                                    ),
                                    h.method,
                                    Ne,
                                  ));
                    ...
                    : (be.delete(Q), w(re, h.method, Ne))
                  : (be.delete(Q), F(re, h.method, Ne));
              } catch (re) {
                (be.delete(Q),
                  re instanceof r.ResponseError
                    ...
                    : re && n.string(re.message)
                      ? L(
                          new r.ResponseError(
                            r.ErrorCodes.InternalError,
                            `Request ${h.method} failed with message: ${re.message}`,
                          ),
                          h.method,
                          Ne,
                        )
              ...
              L(
                new r.ResponseError(r.ErrorCodes.MethodNotFound, `Unhandled method ${h.method}`),
                h.method,
                Ne,
              );
          }
          function As(h) {
            if (!Dt())
              if (h.id === null)
                h.error
                  ? E.error(`Received response message without id: Error is: 
${JSON.stringify(h.error, void 0, 4)}`)
                  : E.error(
                ...
                if ((bs(h, L), L !== void 0)) {
                  ...
                  try {
                    ...
                    } else if (h.result !== void 0) L.resolve(h.result);
                    else throw new Error('Should never happen.');
                  } catch (F) {
                    F.message
                      ? E.error(`Response handler '${L.method}' failed with message: ${F.message}`)
                      : E.error(`Response handler '${L.method}' failed unexpectedly.`);
                  }
                }
              }
          }
              ...
              try {
                if ((tr(h), L))
                  if (h.params === void 0)
                    (w !== void 0 &&
                      w.numberOfParams !== 0 &&
                      w.parameterStructures !== r.ParameterStructures.byName &&
                      E.error(
                        `Notification ${h.method} defines ${w.numberOfParams} params but received none.`,
                      ),
                      L());
                  else if (Array.isArray(h.params)) {
                    const F = h.params;
                    h.method === l.type.method && F.length === 2 && c.is(F[0])
                      ? L({ token: F[0], value: F[1] })
                      : (w !== void 0 &&
                          (w.parameterStructures === r.ParameterStructures.byName &&
                            E.error(
                              `Notification ${h.method} defines parameters by name but received parameters by position`,
                            ),
                          w.numberOfParams !== h.params.length &&
                            E.error(
                              `Notification ${h.method} defines ${w.numberOfParams} params but received ${F.length} arguments`,
                            )),
                        L(...F));
                  } else
                    (w !== void 0 &&
                      w.parameterStructures === r.ParameterStructures.byPosition &&
                      E.error(
                        `Notification ${h.method} defines parameters by position but received parameters by name`,
                      ),
                      L(h.params));
                else B && B(h.method, h.params);
              } catch (F) {
                F.message
                  ? E.error(`Notification handler '${h.method}' failed with message: ${F.message}`)
                  : E.error(`Notification handler '${h.method}' failed unexpectedly.`);
              }
            else ni.fire(h);
          }
          function ks(h) {
...
${JSON.stringify(h, null, 4)}`);
          ...
          function Cs(h) {
            if (!(Z === m.Off || !ve))
              if (at === A.Text) {
                let w;
                ((Z === m.Verbose || Z === m.Compact) &&
                  h.params &&
                  (w = `Params: ${vt(h.params)}

`),
                  ve.log(`Sending request '${h.method} - (${h.id})'.`, w));
              } else Mt('send-request', h);
          }
          function Ns(h) {
            if (!(Z === m.Off || !ve))
              if (at === A.Text) {
          ...
          function vn(h, w, L) {
            if (!(Z === m.Off || !ve))
              if (at === A.Text) {
                let F;
                ((Z === m.Verbose || Z === m.Compact) &&
                  (h.error && h.error.data
                    ? (F = `Error data: ${vt(h.error.data)}

`)
                    : h.result
                      ? (F = `Result: ${vt(h.result)}
...
`)),
                  ve.log(
                    `Sending response '${w} - (${h.id})'. Processing request took ${Date.now() - L}ms`,
                    F,
                  ));
              } else Mt('send-response', h);
          }
          function ws(h) {
            if (!(Z === m.Off || !ve))
              if (at === A.Text) {
...
`)),
              ...
              } else Mt('receive-notification', h);
          }
          function bs(h, w) {
            if (!(Z === m.Off || !ve))
              if (at === A.Text) {
                ...
                if (
                  ((Z === m.Verbose || Z === m.Compact) &&
                    (h.error && h.error.data
                      ? (L = `Error data: ${vt(h.error.data)}

`)
                      : h.result
                        ? (L = `Result: ${vt(h.result)}
...
`)),
                  ...
                  ve.log(
                    `Received response '${w.method} - (${h.id})' in ${Date.now() - w.timerStart}ms.${F}`,
                    L,
                  );
                } else ve.log(`Received response ${h.id} without active response promise.`, L);
              } else Mt('receive-response', h);
          }
          function Mt(h, w) {
            if (!ve || Z === m.Off) return;
            const L = { isLSPMessage: !0, type: h, message: w, timestamp: Date.now() };
            ve.log(L);
          }
          function on() {
            if (oi()) throw new N(C.Closed, 'Connection is closed.');
            if (Dt()) throw new N(C.Disposed, 'Connection is disposed.');
          }
          function _s() {
            if (ai()) throw new N(C.AlreadyListening, 'Connection is already listening');
          }
          function Is() {
            if (!ai()) throw new Error('Call listen() first.');
          }
          function cn(h) {
          ...
          function Ce(h, w) {
            ...
            switch (F) {
              ...
              default:
                L = [];
                for (let ce = 0; ce < w.length && ce < F; ce++) L.push(cn(w[ce]));
                if (w.length < F) for (let ce = w.length; ce < F; ce++) L.push(null);
                break;
            }
            return L;
          }
          const V = {
            sendNotification: (h, ...w) => {
                ...
                switch (he) {
                  ...
                  default:
                    if (Ne === r.ParameterStructures.byName)
                      throw new Error(
                        `Received ${he} parameters for 'by Name' notification parameter structure.`,
                      );
              ...
              const ce = { jsonrpc: j, method: L, params: F };
              return (
                Ns(ce),
                S.write(ce).catch((se) => {
            ...
            onNotification: (h, w) => {
              ...
              return (
                n.func(h)
                  ...
                  : w &&
                    (n.string(h)
                      ? ((L = h), ne.set(h, { type: void 0, handler: w }))
                      : ((L = h.method), ne.set(h.method, { type: h, handler: w }))),
                {
                  dispose: () => {
            ...
            onProgress: (h, w, L) => {
              if (Oe.has(w)) throw new Error(`Progress handler for token ${w} already registered`);
              return (
                Oe.set(w, L),
                {
                  dispose: () => {
            ...
            sendRequest: (h, ...w) => {
                ...
                switch (_t) {
                  ...
                  default:
                    if (Pe === r.ParameterStructures.byName)
                      throw new Error(
                        `Received ${_t} parameters for 'by Name' request parameter structure.`,
                      );
                    F = w.slice(re, Ke).map((Oh) => cn(Oh));
                    break;
                }
              } else {
                const Q = w;
              ...
              let Ee;
              ce &&
                (Ee = ce.onCancellationRequested(() => {
                  const Q = Rt.sender.sendCancellation(V, se);
                  return Q === void 0
                    ? (E.log(
                        `Received no promise from cancellation strategy when cancelling id ${se}`,
                      ),
                      Promise.resolve())
                    : Q.catch(() => {
              ...
              const Ne = { jsonrpc: j, id: se, method: L, params: F };
              return (
                Cs(Ne),
                typeof Rt.sender.enableCancellation == 'function' &&
                  Rt.sender.enableCancellation(Ne),
                new Promise(async (Q, he) => {
                  const re = (_t) => {
                  ...
                  try {
                    ...
                    throw (
                      E.error('Sending request failed.'),
                      Ke.reject(
                        new r.ResponseError(
                          r.ErrorCodes.MessageWriteError,
                          _t.message ? _t.message : 'Unknown reason',
                        ),
                      ),
                      _t
                    );
            ...
            onRequest: (h, w) => {
              ...
              return (
                f.is(h)
                  ...
                  : n.string(h)
                    ? ((L = null),
                      w !== void 0 && ((L = h), ie.set(h, { handler: w, type: void 0 })))
                    : w !== void 0 && ((L = h.method), ie.set(h.method, { type: h, handler: w })),
                {
                  dispose: () => {
            ...
            trace: async (h, w, L) => {
              ...
              (L !== void 0 &&
                (n.boolean(L)
                  ? (F = L)
                  : ((F = L.sendNotification || !1), (ce = L.traceFormat || A.Text))),
                (Z = h),
                (at = ce),
                Z === m.Off ? (ve = void 0) : (ve = w),
                F &&
                  !oi() &&
                  !Dt() &&
                  (await V.sendNotification(b.type, { value: m.toString(h) })));
            },
            onError: er.event,
            onClose: ti.event,
            onUnhandledNotification: ni.event,
            onDispose: ii.event,
            end: () => {
              S.end();
            },
            dispose: () => {
              if (Dt()) return;
              ((Tt = _.Disposed), ii.fire(void 0));
              const h = new r.ResponseError(
                r.ErrorCodes.PendingResponseRejected,
                'Pending response rejected since connection got disposed',
              );
              for (const w of Ie.values()) w.reject(h);
              ((Ie = new Map()),
                (be = new Map()),
                (xe = new Set()),
                (fe = new i.LinkedMap()),
                n.func(S.dispose) && S.dispose(),
                n.func(g.dispose) && g.dispose());
            },
            listen: () => {
              (on(), _s(), (Tt = _.Listening), g.listen(vs));
            },
            inspect: () => {
...
function gR() {
  if (Mu) return Us;
  ((Mu = 1), Object.defineProperty(Us, '__esModule', { value: !0 }));
  const t = Vc();
  ...
  class r {
    ...
    write(c, l) {
      if (typeof c == 'string') {
        if (l !== void 0 && l !== 'utf-8')
          throw new Error(
            `In a Browser environments only utf-8 text encoding is supported. But got encoding: ${l}`,
          );
        this.socket.send(c);
        ...
        var e =
            ...
            (Object.create
              ? function (c, l, u, f) {
                  ...
                  ((!m || ('get' in m ? !l.__esModule : m.writable || m.configurable)) &&
                    (m = {
                      enumerable: !0,
                      get: function () {
                        return l[u];
          ...
          n =
            ...
            function (c, l) {
              for (var u in c)
                u !== 'default' && !Object.prototype.hasOwnProperty.call(l, u) && e(l, c, u);
            };
        (Object.defineProperty(t, '__esModule', { value: !0 }),
...
function Te() {
  ...
  var e;
  (function (o) {
    ((o.clientToServer = 'clientToServer'),
      (o.serverToClient = 'serverToClient'),
      (o.both = 'both'));
...
function yR() {
  ...
  ((zu = 1),
    ...
    (Ai.ImplementationRequest = void 0));
  const t = Te();
  var e;
  return (
    (function (n) {
...
function TR() {
  ...
  ((Bu = 1),
    ...
    (Si.TypeDefinitionRequest = void 0));
  const t = Te();
  var e;
  return (
    (function (n) {
...
function RR() {
  ...
  ((Wu = 1),
    ...
    (_n.DidChangeWorkspaceFoldersNotification = _n.WorkspaceFoldersRequest = void 0));
  const t = Te();
  var e;
  (function (r) {
  ...
  })(e || (_n.WorkspaceFoldersRequest = e = {}));
  var n;
  return (
    (function (r) {
    ...
    })(n || (_n.DidChangeWorkspaceFoldersNotification = n = {})),
    _n
  );
}
var ki = {},
...
function vR() {
  ...
  ((Vu = 1),
    ...
    (ki.ConfigurationRequest = void 0));
  const t = Te();
  var e;
  return (
    (function (n) {
...
function ER() {
  ...
  ((Ku = 1),
    ...
    (In.ColorPresentationRequest = In.DocumentColorRequest = void 0));
  const t = Te();
  var e;
  (function (r) {
  ...
  return (
    (function (r) {
      ((r.method = 'textDocument/colorPresentation'),
        (r.messageDirection = t.MessageDirection.clientToServer),
        (r.type = new t.ProtocolRequestType(r.method)));
    })(n || (In.ColorPresentationRequest = n = {})),
    In
  );
}
var Pn = {},
...
function AR() {
  ...
  ((Hu = 1),
    ...
    (Pn.FoldingRangeRefreshRequest = Pn.FoldingRangeRequest = void 0));
  const t = Te();
  var e;
  (function (r) {
  ...
  return (
    (function (r) {
      ((r.method = 'workspace/foldingRange/refresh'),
        (r.messageDirection = t.MessageDirection.serverToClient),
        (r.type = new t.ProtocolRequestType0(r.method)));
    })(n || (Pn.FoldingRangeRefreshRequest = n = {})),
    Pn
  );
}
var Ci = {},
...
function kR() {
  ...
  ((Xu = 1),
    ...
    (Ni.SelectionRangeRequest = void 0));
  const t = Te();
  var e;
  return (
    (function (n) {
...
function CR() {
  ...
  ((Ju = 1),
    ...
    (qt.WorkDoneProgressCancelNotification =
      qt.WorkDoneProgressCreateRequest =
      qt.WorkDoneProgress =
        void 0));
  const t = ei(),
    e = Te();
...
function _R() {
  ...
  ((td = 1),
    ...
    (bi.LinkedEditingRangeRequest = void 0));
  const t = Te();
  var e;
  return (
    (function (n) {
      ((n.method = 'textDocument/linkedEditingRange'),
        (n.messageDirection = t.MessageDirection.clientToServer),
        (n.type = new t.ProtocolRequestType(n.method)));
    })(e || (bi.LinkedEditingRangeRequest = e = {})),
    bi
  );
}
var Me = {},
...
function $R() {
  ...
  ((id = 1),
    ...
    (Bt.TypeHierarchySubtypesRequest =
      Bt.TypeHierarchySupertypesRequest =
      Bt.TypeHierarchyPrepareRequest =
        void 0));
  const t = Te();
  var e;
  (function (i) {
...
function LR() {
  ...
  ((sd = 1),
    ...
    ($n.InlineValueRefreshRequest = $n.InlineValueRequest = void 0));
  const t = Te();
  var e;
  (function (r) {
  ...
  return (
    (function (r) {
      ((r.method = 'workspace/inlineValue/refresh'),
        (r.messageDirection = t.MessageDirection.serverToClient),
        (r.type = new t.ProtocolRequestType0(r.method)));
    })(n || ($n.InlineValueRefreshRequest = n = {})),
    $n
  );
}
var Wt = {},
...
function DR() {
  ...
  ((cd = 1),
    ...
    (pe.DidCloseNotebookDocumentNotification =
      pe.DidSaveNotebookDocumentNotification =
      pe.DidChangeNotebookDocumentNotification =
      pe.NotebookCellArrayChange =
      pe.DidOpenNotebookDocumentNotification =
      pe.NotebookDocumentSyncRegistrationType =
      pe.NotebookDocument =
      pe.NotebookCell =
      pe.ExecutionSummary =
      pe.NotebookCellKind =
  ...
  (function (p) {
    ...
    function b(C) {
      ...
      return (
        ...
        (N.success === void 0 || e.boolean(N.success))
      );
    }
    p.is = b;
    function I(C, N) {
      return C === N
        ? !0
        : C == null || N === null || N === void 0
          ? !1
          : C.executionOrder === N.executionOrder && C.success === N.success;
    }
    p.equals = I;
  ...
  (function (p) {
    ...
    function I(N, k) {
      const P = new Set();
      return (
        N.document !== k.document && P.add('document'),
        N.kind !== k.kind && P.add('kind'),
        N.executionSummary !== k.executionSummary && P.add('executionSummary'),
        (N.metadata !== void 0 || k.metadata !== void 0) &&
          !C(N.metadata, k.metadata) &&
          P.add('metadata'),
        (N.executionSummary !== void 0 || k.executionSummary !== void 0) &&
          !i.equals(N.executionSummary, k.executionSummary) &&
    ...
    function C(N, k) {
      ...
      if (P && H) {
        ...
        for (let K = 0; K < N.length; K++) if (!C(N[K], k[K])) return !1;
      }
  ...
  (function (p) {
    ...
    function b(I) {
      ...
      return (
        e.objectLiteral(C) &&
        e.string(C.uri) &&
        t.integer.is(C.version) &&
        e.typedArray(C.cells, s.is)
      );
    }
    p.is = b;
  ...
  var o;
  (function (p) {
    ((p.method = 'notebookDocument/sync'),
      (p.messageDirection = n.MessageDirection.clientToServer),
      (p.type = new n.RegistrationType(p.method)));
  })(o || (pe.NotebookDocumentSyncRegistrationType = o = {}));
  var c;
  (function (p) {
    ((p.method = 'notebookDocument/didOpen'),
      (p.messageDirection = n.MessageDirection.clientToServer),
      (p.type = new n.ProtocolNotificationType(p.method)),
      (p.registrationMethod = o.method));
  ...
  var u;
  (function (p) {
    ((p.method = 'notebookDocument/didChange'),
      (p.messageDirection = n.MessageDirection.clientToServer),
      (p.type = new n.ProtocolNotificationType(p.method)),
      (p.registrationMethod = o.method));
  ...
  var f;
  (function (p) {
    ((p.method = 'notebookDocument/didSave'),
      (p.messageDirection = n.MessageDirection.clientToServer),
      (p.type = new n.ProtocolNotificationType(p.method)),
      (p.registrationMethod = o.method));
  ...
  return (
    (function (p) {
      ((p.method = 'notebookDocument/didClose'),
        (p.messageDirection = n.MessageDirection.clientToServer),
        (p.type = new n.ProtocolNotificationType(p.method)),
        (p.registrationMethod = o.method));
    })(m || (pe.DidCloseNotebookDocumentNotification = m = {})),
    pe
  );
}
var _i = {},
...
function MR() {
  ...
  ((ld = 1),
    ...
    (_i.InlineCompletionRequest = void 0));
  const t = Te();
  var e;
  return (
    (function (n) {
      ((n.method = 'textDocument/inlineCompletion'),
        (n.messageDirection = t.MessageDirection.clientToServer),
        (n.type = new t.ProtocolRequestType(n.method)));
    })(e || (_i.InlineCompletionRequest = e = {})),
    _i
  );
}
var ud;
      ...
      (function (t) {
        ...
        (function (d) {
          function ke(Ce) {
            ...
            return (
              r.objectLiteral(V) &&
              (r.string(V.notebookType) || r.string(V.scheme) || r.string(V.pattern))
            );
          }
          d.is = ke;
        ...
        (function (d) {
          function ke(Ce) {
            ...
            return (
              r.objectLiteral(V) &&
              (r.string(V.notebook) || de.is(V.notebook)) &&
        ...
        (function (d) {
          function ke(Ce) {
            if (!Array.isArray(Ce)) return !1;
            for (let V of Ce) if (!r.string(V) && !ue.is(V) && !_.is(V)) return !1;
            return !0;
          }
          d.is = ke;
        ...
        (function (d) {
          function ke(V) {
            const h = V;
            return (
              r.objectLiteral(h) && (h.workDoneProgress === void 0 || r.boolean(h.workDoneProgress))
            );
          }
          d.is = ke;
          function Ce(V) {
        ...
        (function (d) {
          function ke(V) {
            ...
            return (
              ...
              h.range !== void 0 &&
              (h.rangeLength === void 0 || typeof h.rangeLength == 'number')
            );
          }
          d.isIncremental = ke;
          function Ce(V) {
        ...
        (function (d) {
          ((d.method = 'textDocument/didClose'),
            (d.messageDirection = e.MessageDirection.clientToServer),
            (d.type = new e.ProtocolNotificationType(d.method)));
        })(er || (t.DidCloseTextDocumentNotification = er = {}));
        var ti;
        (function (d) {
          ((d.method = 'textDocument/didSave'),
            (d.messageDirection = e.MessageDirection.clientToServer),
            (d.type = new e.ProtocolNotificationType(d.method)));
        })(ti || (t.DidSaveTextDocumentNotification = ti = {}));
        var ni;
        (function (d) {
          ((d.Manual = 1), (d.AfterDelay = 2), (d.FocusOut = 3));
        })(ni || (t.TextDocumentSaveReason = ni = {}));
        var ri;
        (function (d) {
          ((d.method = 'textDocument/willSave'),
            (d.messageDirection = e.MessageDirection.clientToServer),
            (d.type = new e.ProtocolNotificationType(d.method)));
        })(ri || (t.WillSaveTextDocumentNotification = ri = {}));
        var ii;
        (function (d) {
          ((d.method = 'textDocument/willSaveWaitUntil'),
            (d.messageDirection = e.MessageDirection.clientToServer),
            (d.type = new e.ProtocolRequestType(d.method)));
        })(ii || (t.WillSaveTextDocumentWaitUntilRequest = ii = {}));
        var Rt;
        (function (d) {
        ...
        (function (d) {
          function ke(Ce) {
            ...
            return (
              r.objectLiteral(V) &&
              (n.URI.is(V.baseUri) || n.WorkspaceFolder.is(V.baseUri)) &&
              r.string(V.pattern)
            );
          }
          d.is = ke;
        ...
        (function (d) {
          ((d.method = 'textDocument/completion'),
            (d.messageDirection = e.MessageDirection.clientToServer),
            (d.type = new e.ProtocolRequestType(d.method)));
        })(ai || (t.CompletionRequest = ai = {}));
        var oi;
        (function (d) {
          ((d.method = 'completionItem/resolve'),
            (d.messageDirection = e.MessageDirection.clientToServer),
            (d.type = new e.ProtocolRequestType(d.method)));
        })(oi || (t.CompletionResolveRequest = oi = {}));
        var Dt;
        (function (d) {
        ...
        })(ci || (t.SignatureHelpTriggerKind = ci = {}));
        var ys;
        (function (d) {
        ...
        (function (d) {
          ((d.method = 'textDocument/references'),
            (d.messageDirection = e.MessageDirection.clientToServer),
            (d.type = new e.ProtocolRequestType(d.method)));
        })(li || (t.ReferencesRequest = li = {}));
        var ui;
        (function (d) {
          ((d.method = 'textDocument/documentHighlight'),
            (d.messageDirection = e.MessageDirection.clientToServer),
            (d.type = new e.ProtocolRequestType(d.method)));
        })(ui || (t.DocumentHighlightRequest = ui = {}));
        var Rs;
        (function (d) {
        ...
        (function (d) {
          ((d.method = 'textDocument/formatting'),
            (d.messageDirection = e.MessageDirection.clientToServer),
            (d.type = new e.ProtocolRequestType(d.method)));
        })(ws || (t.DocumentFormattingRequest = ws = {}));
        var tr;
        (function (d) {
          ((d.method = 'textDocument/rangeFormatting'),
            (d.messageDirection = e.MessageDirection.clientToServer),
            (d.type = new e.ProtocolRequestType(d.method)));
        })(tr || (t.DocumentRangeFormattingRequest = tr = {}));
        var bs;
        (function (d) {
        ...
        })(di || (t.ApplyWorkspaceEditRequest = di = {}));
      })(lo)),
    lo
  );
}
...
function GR() {
  ...
  ((dd = 1),
    ...
    (Ii.createProtocolConnection = void 0));
  const t = ei();
  function e(n, r, i, s) {
    return (
      t.ConnectionStrategy.is(s) && (s = { connectionStrategy: s }),
      (0, t.createMessageConnection)(n, r, i, s)
    );
  }
  return ((Ii.createProtocolConnection = e), Ii);
}
var fd;
function UR() {
  return (
      ...
      (function (t) {
        var e =
          ...
          n =
            ...
            function (s, a) {
              for (var o in s)
                o !== 'default' && !Object.prototype.hasOwnProperty.call(a, o) && e(a, s, o);
            };
        (Object.defineProperty(t, '__esModule', { value: !0 }),
...
class jR {
        ...
        if (typeof n.validation == 'boolean' && n.validation)
          ...
          a.length > 0 &&
            (this.buildState.set(s, {
              completed: !1,
              options: { validation: { categories: a } },
    ...
    const o = this.sortDocuments(
      this.langiumDocuments.all
        .filter(
          (c) =>
            c.state < Y.Validated ||
            !this.buildState.get(c.uri.toString())?.completed ||
  ...
  findMissingValidationCategories(e, n) {
    const r = this.buildState.get(e.uri.toString()),
      i = this.serviceRegistry
        .getServices(e.uri)
        .validation.ValidationRegistry.getAllValidationCategories(e),
      s = r?.result?.validationChecks
        ? new Set(r?.result?.validationChecks)
        : r?.completed
          ? i
          : new Set(),
      a =
        n === void 0 || n.validation === !0
          ? i
          : typeof n.validation == 'object'
            ? (n.validation.categories ?? i)
            : [];
    return me(a)
      .filter((o) => !s.has(o))
      .toArray();
  ...
  async buildDocuments(e, n, r) {
    (this.prepareBuild(e, n),
      ...
      await this.runCancelable(e, Y.IndexedContent, r, (a) =>
    ...
    (await this.runCancelable(i, Y.Linked, r, (a) =>
      ...
      await this.runCancelable(i, Y.IndexedReferences, r, (a) =>
  ...
  async runCancelable(e, n, r, i) {
    for (const a of e)
      a.state < n &&
        (await Xe(r), await i(a), (a.state = n), await this.notifyDocumentPhase(a, n, r));
  ...
  awaitDocumentState(e, n, r) {
    ...
    if (i) {
      ...
      if (r.isCancellationRequested) return Promise.reject(Ar);
      ...
      return Promise.reject(
        new qs.ResponseError(
          qs.LSPErrorCodes.ServerCancelled,
          `No document found for URI: ${n.toString()}`,
        ),
      );
  ...
  async validate(e, n) {
    ...
    o &&
      ...
      o.result.validationChecks
        ? (o.result.validationChecks = me(o.result.validationChecks)
            .concat(s.categories)
            .distinct()
            .toArray())
...
class zR {
  ...
  async updateContent(e, n = ye.CancellationToken.None) {
    const i = await this.serviceRegistry
        .getServices(e.uri)
        .references.ScopeComputation.collectExportedSymbols(e, n),
      s = e.uri.toString();
...
class BR {
  ...
  async performStartup(e) {
    ...
    const i = [];
    await Promise.all(
      e.map((a) => this.getRootFolder(a)).map(async (a) => this.traverseFolder(a, i)),
    );
    const s = me(i)
...
class WR {
  buildUnexpectedCharactersMessage(e, n, r, i, s) {
    return $o.buildUnexpectedCharactersMessage(e, n, r, i, s);
  }
  buildUnableToPopLexerModeMessage(e) {
    return $o.buildUnableToPopLexerModeMessage(e);
  }
}
const VR = { mode: 'full' };
class KR {
  constructor(e) {
    ...
    const r = pd(n) ? Object.values(n) : n,
  ...
  toTokenTypeDictionary(e) {
    if (pd(e)) return e;
    const n = dh(e) ? Object.values(e.modes).flat() : e,
      r = {};
...
function QR(t) {
  ...
  for (let i = 0; i < t.lines.length; i++) {
    ...
    if (((o = o.substring(0, nv(o))), Kc(o, c) >= o.length)) {
      if (e.length > 0) {
        const u = te.create(n, r);
        e.push({ type: 'break', content: '', range: X.create(u, u) });
      }
    } else {
      md.lastIndex = c;
      const u = md.exec(o);
      if (u) {
        const f = u[0],
          m = u[1],
          p = te.create(n, r + c),
          A = te.create(n, r + c + f.length);
        (e.push({ type: 'tag', content: m, range: X.create(p, A) }),
          (c += f.length),
          (c = Kc(o, c)));
      }
      if (c < o.length) {
        const f = o.substring(c),
          m = Array.from(f.matchAll(JR));
        e.push(...ZR(m, f, n, r + c));
      }
    }
    (n++, (r = 0));
...
function rv(t) {
  ...
  if (t.tokens.length === 0) return new gd([], X.create(e, e));
  const n = [];
  for (; t.index < t.tokens.length; ) {
    const s = iv(t, n[n.length - 1]);
    s && n.push(s);
  }
  const r = n[0]?.range.start ?? e,
    i = n[n.length - 1]?.range.end ?? e;
  return new gd(n, X.create(r, i));
}
function iv(t, e) {
  const n = t.tokens[t.index];
  if (n.type === 'tag') return ph(t, !1);
  if (n.type === 'text' || n.type === 'inline-tag') return hh(t);
  (sv(n, e), t.index++);
}
function sv(t, e) {
  if (e) {
    const n = new gh('', t.range);
...
function hh(t) {
  ...
  for (; e && e.type !== 'break' && e.type !== 'tag'; )
    (i.push(av(t)), (r = e), (e = t.tokens[t.index]));
  return new Hc(i, X.create(n.range.start, r.range.end));
}
function av(t) {
  return t.tokens[t.index].type === 'inline-tag' ? ph(t, !0) : mh(t);
}
function ph(t, e) {
  const n = t.tokens[t.index++],
  ...
  if (t.tokens[t.index]?.type === 'text')
    if (e) {
      const s = mh(t);
      return new fo(r, new Hc([s], s.range), e, X.create(n.range.start, s.range.end));
    } else {
      const s = hh(t);
    ...
    const s = n.range;
    return new fo(r, new Hc([], s), e, s);
  }
}
function mh(t) {
  const e = t.tokens[t.index++];
  return new gh(e.content, e.range);
}
function bl(t) {
  if (!t) return bl({ start: '/**', end: '*/', line: '*' });
...
function ov(t, e, n) {
  if (t === 'linkplain' || t === 'linkcode' || t === 'link') {
    ...
    return (
      (t === 'linkcode' || (t === 'link' && n.link === 'code')) && (i = `\`${i}\``),
      n.renderLink?.(e, i) ?? cv(e, i)
    );
  }
}
function cv(t, e) {
...
class uv {
  ...
  getComment(e) {
    return JT(e) ? e.$comment : Kp(e.$cstNode, this.grammarConfig().multilineCommentRules)?.text;
  }
}
class dv {
  constructor(e) {
...
class fv {
  constructor() {
    ((this.previousTokenSource = new ye.CancellationTokenSource()),
      (this.writeQueue = []),
      (this.readQueue = []),
      (this.done = !0));
  }
...
class hv {
  constructor(e) {
    ((this.grammarElementIdMap = new ku()),
      (this.tokenTypeIdMap = new ku()),
  ...
  createDehyrationContext(e) {
    ...
    if (e.$cstNode) for (const i of wo(e.$cstNode)) r.set(i, {});
  ...
  createHydrationContext(e) {
    ...
    let i;
    if (e.$cstNode)
      for (const s of wo(e.$cstNode)) {
        let a;
        ('fullText' in s
          ? ((a = new Hf(s.fullText)), (i = a))
          : 'content' in s
            ? (a = new Al())
  ...
  hydrateCstLeafNode(e) {
    const n = this.getTokenType(e.tokenType),
      ...
      c = e.endColumn,
      l = e.hidden;
    return new Uc(r, i, { start: { line: s, character: a }, end: { line: o, character: c } }, n, l);
  }
  getTokenType(e) {
  ...
  createGrammarElementIdMap() {
    let e = 0;
    for (const n of Zt(this.grammar)) kp(n) && this.grammarElementIdMap.set(n, e++);
  }
}
function gn(t) {
  return {
    ...
    parser: {
      ...
      ValueConverter: () => new rh(),
      TokenBuilder: () => new nh(),
      Lexer: (e) => new KR(e),
      ParserErrorMessageProvider: () => new Jf(),
...
function vd(t, e, n, r) {
  if (e in t) {
    ...
    t[e] = Rd;
    try {
      t[e] = typeof i == 'function' ? i(r) : yh(i, r);
    } catch (s) {
...
const Tn = { fileSystemProvider: () => new mv() },
  gv = {
    Grammar: () => {},
    LanguageMetaData: () => ({
      caseInsensitive: !1,
...
function Qn(t) {
  ...
  return (
    e.shared.workspace.LangiumDocumentFactory.fromModel(
      n,
      Ct.parse(`memory:/${n.name ?? 'grammar'}.langium`),
    ),
    n
  );
}
...
$(Sv, 'isGitGraph');
var Pi = { $type: 'Group', icon: 'icon', id: 'id', in: 'in', title: 'title' },
  qi = { $type: 'Info', accDescr: 'accDescr', accTitle: 'accTitle', title: 'title' };
function kv(t) {
  return bt.isInstance(t, qi.$type);
}
$(kv, 'isInfo');
var $i = { $type: 'Item', classSelector: 'classSelector', name: 'name' },
  mo = { $type: 'Junction', id: 'id', in: 'in' },
  Ws = { $type: 'Leaf', classSelector: 'classSelector', name: 'name', value: 'value' },
  yr = { $type: 'Merge', branch: 'branch', id: 'id', tags: 'tags', type: 'type' };
function Cv(t) {
...
$(Nv, 'isPacket');
var Rr = { $type: 'PacketBlock', bits: 'bits', end: 'end', label: 'label', start: 'start' };
function wv(t) {
...
var Ln = {
  ...
  ar = { $type: 'Service', icon: 'icon', iconText: 'iconText', id: 'id', in: 'in', title: 'title' },
  or = { $type: 'Statement' },
  vr = {
    $type: 'Treemap',
    accDescr: 'accDescr',
...
var To = { $type: 'TreemapRow', indent: 'indent', item: 'item' },
      ...
      constructor() {
        (super(...arguments),
          (this.types = {
            ...
            Checkout: {
              name: Ed.$type,
              properties: { branch: { name: Ed.branch } },
              superTypes: [or.$type],
            },
            CherryPicking: {
              name: zs.$type,
            ...
            Commit: {
              ...
              properties: {
                id: { name: gr.id },
                message: { name: gr.message },
                tags: { name: gr.tags, defaultValue: [] },
                type: { name: gr.type },
              },
              superTypes: [or.$type],
            },
            ...
            Direction: {
              ...
              properties: {
                ...
                dir: { name: sr.dir },
                statements: { name: sr.statements, defaultValue: [] },
                title: { name: sr.title },
              },
              superTypes: [Fn.$type],
            },
            ...
            Entry: {
              name: po.$type,
              properties: {
                axis: { name: po.axis, referenceType: js.$type },
                value: { name: po.value },
              },
              superTypes: [],
            },
            GitGraph: {
              name: Fn.$type,
              properties: {
                accDescr: { name: Fn.accDescr },
                accTitle: { name: Fn.accTitle },
                statements: { name: Fn.statements, defaultValue: [] },
                title: { name: Fn.title },
              },
              superTypes: [],
            },
            ...
            Info: {
              name: qi.$type,
              properties: {
                accDescr: { name: qi.accDescr },
                accTitle: { name: qi.accTitle },
                title: { name: qi.title },
              },
              superTypes: [],
            },
            Item: {
              name: $i.$type,
              properties: { classSelector: { name: $i.classSelector }, name: { name: $i.name } },
              superTypes: [],
            },
            Junction: {
              name: mo.$type,
              properties: { id: { name: mo.id }, in: { name: mo.in } },
              superTypes: [],
            },
            Leaf: {
              name: Ws.$type,
            ...
            Packet: {
              name: Tr.$type,
              properties: {
                accDescr: { name: Tr.accDescr },
                accTitle: { name: Tr.accTitle },
                blocks: { name: Tr.blocks, defaultValue: [] },
                title: { name: Tr.title },
              },
              superTypes: [],
            },
            ...
            Pie: {
              ...
              properties: {
                ...
                sections: { name: Gn.sections, defaultValue: [] },
                showData: { name: Gn.showData, defaultValue: !1 },
                title: { name: Gn.title },
              },
              superTypes: [],
            },
            ...
            Radar: {
              name: Ln.$type,
              properties: {
                accDescr: { name: Ln.accDescr },
                accTitle: { name: Ln.accTitle },
                axes: { name: Ln.axes, defaultValue: [] },
                curves: { name: Ln.curves, defaultValue: [] },
                options: { name: Ln.options, defaultValue: [] },
                title: { name: Ln.title },
              },
              superTypes: [],
            },
            ...
            Statement: { name: or.$type, properties: {}, superTypes: [] },
            Treemap: {
              name: vr.$type,
              properties: {
                ...
                title: { name: vr.title },
                TreemapRows: { name: vr.TreemapRows, defaultValue: [] },
              },
              superTypes: [],
            },
            TreemapRow: {
  ...
  Zn = { AstReflection: $(() => new Th(), 'AstReflection') },
  Wv = {
    Grammar: $(() => Pv(), 'Grammar'),
    LanguageMetaData: $(() => Fv, 'LanguageMetaData'),
    parser: {},
  },
  Vv = {
    Grammar: $(() => $v(), 'Grammar'),
    LanguageMetaData: $(() => Gv, 'LanguageMetaData'),
    parser: {},
  },
  Kv = {
    Grammar: $(() => Lv(), 'Grammar'),
    LanguageMetaData: $(() => Uv, 'LanguageMetaData'),
    parser: {},
  },
  Hv = {
    Grammar: $(() => Ov(), 'Grammar'),
    LanguageMetaData: $(() => qv, 'LanguageMetaData'),
    parser: {},
  },
  Yv = {
    Grammar: $(() => xv(), 'Grammar'),
    LanguageMetaData: $(() => jv, 'LanguageMetaData'),
    parser: {},
  },
  Xv = {
    Grammar: $(() => Dv(), 'Grammar'),
    LanguageMetaData: $(() => zv, 'LanguageMetaData'),
    parser: {},
  },
  Jv = {
    Grammar: $(() => Mv(), 'Grammar'),
    LanguageMetaData: $(() => Bv, 'LanguageMetaData'),
    parser: {},
  },
  Qv = /accDescr(?:[\t ]*:([^\n\r]*)|\s*{([^}]*)})/,
  Zv = /accTitle[\t ]*:([^\n\r]*)/,
...
`,
    ...
    $(Cr, 'AbstractMermaidValueConverter'),
    Cr),
  Nr,
  Ka =
    ((Nr = class extends Va {
  ...
  Rn =
    ...
    $(wr, 'AbstractMermaidTokenBuilder'),
    wr),
  br;
((br = class extends Rn {}), $(br, 'CommonTokenBuilder'));
var _r,
  nE =
    ((_r = class extends Rn {
      constructor() {
    ...
    $(_r, 'GitGraphTokenBuilder'),
    _r),
  Rh = {
    parser: {
      TokenBuilder: $(() => new nE(), 'TokenBuilder'),
      ValueConverter: $(() => new Ka(), 'ValueConverter'),
    },
  };
function vh(t = Tn) {
  const e = Ve(yn(t), Zn),
    n = Ve(gn({ shared: e }), Vv, Rh);
  return (e.ServiceRegistry.register(n), { shared: e, GitGraph: n });
}
$(vh, 'createGitGraphServices');
var Ir,
  rE =
    ((Ir = class extends Rn {
      constructor() {
  ...
  Eh = {
    parser: {
      TokenBuilder: $(() => new rE(), 'TokenBuilder'),
      ValueConverter: $(() => new Ka(), 'ValueConverter'),
    },
  };
function Ah(t = Tn) {
  const e = Ve(yn(t), Zn),
    n = Ve(gn({ shared: e }), Kv, Eh);
  return (e.ServiceRegistry.register(n), { shared: e, Info: n });
}
$(Ah, 'createInfoServices');
var Pr,
  iE =
    ((Pr = class extends Rn {
      constructor() {
    ...
    $(Pr, 'PacketTokenBuilder'),
    Pr),
  Sh = {
    parser: {
      TokenBuilder: $(() => new iE(), 'TokenBuilder'),
      ValueConverter: $(() => new Ka(), 'ValueConverter'),
    },
  };
function kh(t = Tn) {
  const e = Ve(yn(t), Zn),
    n = Ve(gn({ shared: e }), Hv, Sh);
  return (e.ServiceRegistry.register(n), { shared: e, Packet: n });
}
$(kh, 'createPacketServices');
var $r,
  sE =
    (($r = class extends Rn {
      constructor() {
  ...
  aE =
    ...
    $(Lr, 'PieValueConverter'),
    Lr),
  Ch = {
    parser: {
      TokenBuilder: $(() => new sE(), 'TokenBuilder'),
      ValueConverter: $(() => new aE(), 'ValueConverter'),
    },
  };
function Nh(t = Tn) {
  const e = Ve(yn(t), Zn),
    n = Ve(gn({ shared: e }), Yv, Ch);
  return (e.ServiceRegistry.register(n), { shared: e, Pie: n });
}
$(Nh, 'createPieServices');
var Or,
  oE =
    ((Or = class extends Rn {
      constructor() {
  ...
  cE =
    ...
    $(xr, 'ArchitectureValueConverter'),
    xr),
  wh = {
    parser: {
      TokenBuilder: $(() => new oE(), 'TokenBuilder'),
      ValueConverter: $(() => new cE(), 'ValueConverter'),
    },
  };
function bh(t = Tn) {
  const e = Ve(yn(t), Zn),
    n = Ve(gn({ shared: e }), Wv, wh);
  return (e.ServiceRegistry.register(n), { shared: e, Architecture: n });
}
$(bh, 'createArchitectureServices');
var Dr,
  lE =
    ((Dr = class extends Rn {
      constructor() {
    ...
    $(Dr, 'RadarTokenBuilder'),
    Dr),
  _h = {
    parser: {
      TokenBuilder: $(() => new lE(), 'TokenBuilder'),
      ValueConverter: $(() => new Ka(), 'ValueConverter'),
    },
  };
function Ih(t = Tn) {
  const e = Ve(yn(t), Zn),
    n = Ve(gn({ shared: e }), Xv, _h);
  return (e.ServiceRegistry.register(n), { shared: e, Radar: n });
}
$(Ih, 'createRadarServices');
var Mr,
  uE =
    ((Mr = class extends Rn {
      constructor() {
...
var Gr,
  ...
  $h = {
    parser: {
      TokenBuilder: $(() => new uE(), 'TokenBuilder'),
      ValueConverter: $(() => new fE(), 'ValueConverter'),
    },
    validation: { TreemapValidator: $(() => new hE(), 'TreemapValidator') },
  };
function Lh(t = Tn) {
  const e = Ve(yn(t), Zn),
    n = Ve(gn({ shared: e }), Jv, $h);
  return (e.ServiceRegistry.register(n), Ph(n), { shared: e, Treemap: n });
}
$(Lh, 'createTreemapServices');
var Yt = {},
  pE = {
    info: $(async () => {
      const { createInfoServices: t } = await En(
          async () => {
    ...
    packet: $(async () => {
      const { createPacketServices: t } = await En(
          async () => {
    ...
    pie: $(async () => {
      const { createPieServices: t } = await En(
          async () => {
    ...
    architecture: $(async () => {
      const { createArchitectureServices: t } = await En(
          async () => {
    ...
    gitGraph: $(async () => {
      const { createGitGraphServices: t } = await En(
          async () => {
    ...
    radar: $(async () => {
      const { createRadarServices: t } = await En(
          async () => {
    ...
    treemap: $(async () => {
      const { createTreemapServices: t } = await En(
          async () => {
    ...
    ((Ur = class extends Error {
      constructor(e) {
        const n = e.lexerErrors.map((i) => {
            const s = i.line !== void 0 && !isNaN(i.line) ? i.line : '?',
              a = i.column !== void 0 && !isNaN(i.column) ? i.column : '?';
            return `Lexer error on line ${s}, column ${a}: ${i.message}`;
          }).join(`
`),
          r = e.parserErrors.map((i) => {
            const s =
                i.token.startLine !== void 0 && !isNaN(i.token.startLine) ? i.token.startLine : '?',
              a =
                i.token.startColumn !== void 0 && !isNaN(i.token.startColumn)
                  ? i.token.startColumn
                  : '?';
...
`);
    ...
    $(Ur, 'MermaidParseError'),
    Ur);
const yE = Object.freeze(
    Object.defineProperty(
      { __proto__: null, InfoModule: Eh, createInfoServices: Ah },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  TE = Object.freeze(
    Object.defineProperty(
      { __proto__: null, PacketModule: Sh, createPacketServices: kh },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  RE = Object.freeze(
    Object.defineProperty(
      { __proto__: null, PieModule: Ch, createPieServices: Nh },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  vE = Object.freeze(
    Object.defineProperty(
      { __proto__: null, ArchitectureModule: wh, createArchitectureServices: bh },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  EE = Object.freeze(
    Object.defineProperty(
      { __proto__: null, GitGraphModule: Rh, createGitGraphServices: vh },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  AE = Object.freeze(
    Object.defineProperty(
      { __proto__: null, RadarModule: _h, createRadarServices: Ih },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  SE = Object.freeze(
    Object.defineProperty(
      { __proto__: null, TreemapModule: $h, createTreemapServices: Lh },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  );
