import { g as ae } from './chunk-55IACEB6-CwkWFNk8.js';
import { s as oe } from './chunk-KX2RTZJC-DTbQz4uU.js';
import {
  _ as c,
  l as O,
  p as ce,
...
import { v as pe } from './v4-BKrj-4V8.js';
...
var W = (function () {
  var r = c(function (L, s, t, a) {
    ...
    z = [1, 25],
    _ = [6, 7, 11],
    Y = [1, 6, 13, 15, 16, 19, 22],
    q = [1, 33],
    J = [1, 34],
    I = [1, 6, 7, 11, 13, 15, 16, 19, 22],
    F = {
      ...
      performAction: c(function (s, t, a, o, d, n, R) {
        var g = n.length - 1;
        switch (d) {
          case 6:
          case 7:
      ...
      table: [
        ...
        r(u, [2, 4]),
        r(u, [2, 5]),
        { 1: [2, 6], 6: i, 12: 21, 13: l, 14: 14, 15: f, 16: h, 17: 17, 18: 18, 19: p, 22: m },
        { 6: i, 9: 22, 12: 11, 13: l, 14: 14, 15: f, 16: h, 17: 17, 18: 18, 19: p, 22: m },
        { 6: N, 7: X, 10: 23, 11: z },
        r(_, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: p, 22: m }),
        r(_, [2, 18]),
        r(_, [2, 19]),
        r(_, [2, 20]),
        r(_, [2, 21]),
        ...
        { 20: [1, 31] },
        { 6: N, 7: X, 10: 32, 11: z },
        { 1: [2, 7], 6: i, 12: 21, 13: l, 14: 14, 15: f, 16: h, 17: 17, 18: 18, 19: p, 22: m },
        r(Y, [2, 14], { 7: q, 11: J }),
        r(I, [2, 8]),
        r(I, [2, 9]),
        r(I, [2, 10]),
      ...
      parse: c(function (s) {
        ...
        function Z() {
          ...
          return (
            (b = o.pop() || y.lex() || Q),
            typeof b != 'number' &&
              (b instanceof Array && ((o = b), (b = o.pop())), (b = t.symbols_[b] || b)),
            b
          );
        }
        c(Z, 'lex');
        for (var E, v, S, j, T = {}, P, k, ee, M; ; ) {
          if (
            ((v = a[a.length - 1]),
            this.defaultActions[v]
              ? (S = this.defaultActions[v])
              : ((E === null || typeof E > 'u') && (E = Z()), (S = R[v] && R[v][E])),
            typeof S > 'u' || !S.length || !S[0])
          ) {
            var $ = '';
            M = [];
            for (P in R[v]) this.terminals_[P] && P > ie && M.push("'" + this.terminals_[P] + "'");
            (y.showPosition
              ? ($ =
                  'Parse error on line ' +
                  (w + 1) +
...
Expecting ` +
              ...
              : ($ =
                  ...
                  (w + 1) +
                  ': Unexpected ' +
                  (E == Q ? 'end of input' : "'" + (this.terminals_[E] || E) + "'")),
              this.parseError($, {
                text: y.match,
          ...
          if (S[0] instanceof Array && S.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + v + ', token: ' + E,
            );
          switch (S[0]) {
            case 1:
              (a.push(E),
            ...
            case 2:
              if (
                ...
                ne && (T._$.range = [n[n.length - (k || 1)].range[0], n[n.length - 1].range[1]]),
                (j = this.performAction.apply(T, [g, K, w, x.yy, S[1], d, n].concat(se))),
                typeof j < 'u')
              )
                return j;
              (k &&
                ((a = a.slice(0, -1 * k * 2)), (d = d.slice(0, -1 * k)), (n = n.slice(0, -1 * k))),
      ...
      var L = {
        ...
        unput: c(function (s) {
          ...
          return (
            ...
            this.options.ranges && (this.yylloc.range = [d[0], d[0] + this.yyleng - t]),
...
` +
        ...
        next: c(function () {
          ...
          for (var d = this._currentRules(), n = 0; n < d.length; n++)
            if (
              ((a = this._input.match(this.rules[d[n]])), a && (!t || a[0].length > t[0].length))
            ) {
              if (((t = a), (o = n), this.options.backtrack_lexer)) {
                if (((s = this.test_match(a, d[n])), s !== !1)) return s;
                if (this._backtrack) {
                  t = !1;
                  continue;
                } else return !1;
          ...
          return t
            ? ((s = this.test_match(t, d[o])), s !== !1 ? s : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: c(function (t, a, o, d) {
          switch (o) {
            case 0:
    ...
    ((C = class {
      ...
      getParent(e) {
        for (let i = this.nodes.length - 1; i >= 0; i--)
          if (this.nodes[i].level < e) return this.nodes[i];
        return null;
      }
      getMindmap() {
      ...
      addNode(e, i, l, f) {
        ...
        const u = {
          ...
          N = this.getParent(e);
        if (N) (N.children.push(u), this.nodes.push(u));
        else if (h) this.nodes.push(u);
        else
          throw new Error(
      ...
      flattenNodes(e, i) {
        ...
        if ((i.push(p), e.children)) for (const m of e.children) this.flattenNodes(m, i);
      }
      generateEdges(e, i) {
        if (e.children)
      ...
      getData() {
        const e = this.getMindmap(),
          ...
          f = he().layout !== void 0,
          h = i;
        if ((f || (h.layout = 'cose-bilkent'), !e)) return { nodes: [], edges: [], config: h };
        (O.debug('getData: mindmapRoot', e, i), this.assignSections(e));
        const p = [],
          m = [];
        (this.flattenNodes(e, p),
          this.generateEdges(e, m),
          O.debug(`getData: processed ${p.length} nodes and ${m.length} edges`));
        const u = new Map();
        for (const N of p)
...
` + r,
    ...
    const f = l.db,
      h = f.getData(),
      p = ae(e, h.config.securityLevel);
    ((h.type = l.type),
      (h.layoutAlgorithm = ce(h.config.layout, { fallback: 'cose-bilkent' })),
      (h.diagramId = e),
      f.getMindmap() &&
        (h.nodes.forEach((u) => {
          u.shape === 'rounded'
            ...
            : u.shape === 'circle'
              ? (u.padding = 10)
              : u.shape === 'rect' && ((u.width = 0), (u.padding = 10));
        }),
        await le(h, p),
        oe(
          p,
  ...
  be = c((r) => {
    ...
    for (let i = 0; i < r.THEME_COLOR_LIMIT; i++)
      ((r['lineColor' + i] = r['lineColor' + i] || r['cScaleInv' + i]),
        ge(r['lineColor' + i])
          ? (r['lineColor' + i] = de(r['lineColor' + i], 20))
          : (r['lineColor' + i] = ue(r['lineColor' + i], 20)));
    for (let i = 0; i < r.THEME_COLOR_LIMIT; i++) {
      const l = '' + (17 - 3 * i);
      e += `
