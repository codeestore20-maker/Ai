...
import { f as h, a2 as c } from './index-wqF_YeCD.js';
const $ = c`
  0%, 100% {
    opacity: 0.3;
  }
    ...
    for (let t = 0; t < 3; t++)
      for (let e = 0; e < 3; e++) {
        ...
        m.push(
          o.jsx(
            'circle',
            { className: a.node, cx: s, cy: l, r: '3', style: { animationDelay: `${r}s` } },
            `node-${t}-${e}`,
          ),
        );
      }
      ...
      for (let e = 0; e < 3; e++) {
        ...
        for (let r = 0; r < 3; r++) {
          ...
          y.push(
            o.jsx(
              'line',
              { className: a.connection, x1: s, x2: x, y1: l, y2: f },
              `connection-${t}-${e}-${r}`,
            ),
          );
        }
    ...
    const d = [0, 1, 2].map((t) =>
      o.jsx(
        'circle',
        {
          ...
          cy: 50,
          r: '1.5',
          style: { '--flow-distance': '50px', 'animationDelay': `${t * 0.6}s` },
        },
        `particle-${t}`,
      ),
    );
    return o.jsx('div', {
      ...
      children: o.jsxs('svg', {
        ...
        children: [
          ...
          m,
          d,
          o.jsx('rect', { className: a.center, height: '6', width: '6', x: '47', y: '47' }),
          o.jsx('circle', { className: a.ring, cx: '50', cy: '50', r: '40' }),
        ],
      }),
    });
  });
