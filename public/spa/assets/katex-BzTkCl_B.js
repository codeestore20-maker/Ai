...
var R1 = /([A-Z])/g,
  At = (r) => r.replace(R1, '-$1').toLowerCase(),
  H1 = { '&': '&amp;', '>': '&gt;', '<': '&lt;', '"': '&quot;', "'": '&#x27;' },
  I1 = /[&><"']/g,
  a0 = (r) => String(r).replace(I1, (e) => H1[e]),
  Be = (r) =>
    r.type === 'ordgroup' || r.type === 'color'
      ...
      : r.type === 'font'
        ? Be(r.body)
        : r,
  N1 = new Set(['mathord', 'textord', 'atom']),
  D0 = (r) => N1.has(Be(r).type),
  O1 = (r) => {
...
var Bt = 0,
  ...
  L1 = [oe, p0, oe, p0, _0, s0, _0, s0],
  P1 = [p0, p0, p0, p0, s0, s0, s0, s0],
  G1 = [Q0, T0, oe, p0, _0, s0, _0, s0],
  V1 = [T0, T0, p0, p0, s0, s0, s0, s0],
  U1 = [Ce, Ce, T0, T0, p0, p0, s0, s0],
  X1 = [Bt, Ce, Q0, T0, Q0, T0, Q0, T0],
  I = { DISPLAY: x0[Bt], TEXT: x0[Q0], SCRIPT: x0[oe], SCRIPTSCRIPT: x0[_0] },
  dt = [
    {
      name: 'latin',
      blocks: [
...
function Y1(r) {
  for (var e = 0; e < dt.length; e++)
    for (var t = dt[e], a = 0; a < t.blocks.length; a++) {
      var n = t.blocks[a];
...
var De = [];
dt.forEach((r) => r.blocks.forEach((e) => De.push(...e)));
function Dr(r) {
  for (var e = 0; e < De.length; e += 2) if (r >= De[e] && r <= De[e + 1]) return !0;
  return !1;
}
var J0 = 80,
  W1 = function (e, t) {
...
var ft = {
  ...
  ra = { ex: !0, em: !0, mu: !0 },
  Cr = function (e) {
    return (typeof e != 'string' && (e = e.unit), e in ft || e in ra || e === 'ex');
  },
  K = function (e, t) {
    var a;
  ...
  Rr = function (e) {
    ...
    var a = '';
    for (var n of Object.keys(this.style)) a += At(n) + ':' + this.style[n] + ';';
    a && (t += ' style="' + a0(a) + '"');
...
class ae {
  constructor(e, t, a, n) {
    (qr.call(this, e, a, n), (this.children = t || []));
  }
  setAttribute(e, t) {
    this.attributes[e] = t;
  }
...
class Ie {
  constructor(e, t, a, n) {
    (qr.call(this, t, n), (this.children = a || []), this.setAttribute('href', e));
  }
  setAttribute(e, t) {
    this.attributes[e] = t;
  }
...
class na {
  ...
  toMarkup() {
    var e = '<img src="' + a0(this.src) + '"' + (' alt="' + a0(this.alt) + '"'),
      t = '';
    for (var a of Object.keys(this.style)) t += At(a) + ':' + this.style[a] + ';';
...
class d0 {
  constructor(e, t, a, n, l, u, h, c) {
    ((this.text = e),
      ...
      (this.style = c || {}),
      (this.maxFontSize = 0));
    var v = Y1(this.text.charCodeAt(0));
    (v && this.classes.push(v + '_fallback'),
      /[îïíì]/.test(this.text) && (this.text = ia[this.text]));
  }
  hasClass(e) {
    return this.classes.includes(e);
  }
  toNode() {
    var e = document.createTextNode(this.text),
      t = null;
    (this.italic > 0 &&
      ((t = document.createElement('span')), (t.style.marginRight = M(this.italic))),
  ...
  toMarkup() {
    var e = !1,
      t = '<span';
    this.classes.length && ((e = !0), (t += ' class="'), (t += a0(F0(this.classes))), (t += '"'));
    var a = '';
...
class L0 {
  ...
  toNode() {
    ...
    return (
      this.alternate ? t.setAttribute('d', this.alternate) : t.setAttribute('d', Jt[this.pathName]),
      t
    );
  }
  toMarkup() {
    return this.alternate
      ? '<path d="' + a0(this.alternate) + '"/>'
      : '<path d="' + a0(Jt[this.pathName]) + '"/>';
  }
}
class vt {
  constructor(e) {
...
var ua = (r) => r instanceof ae || r instanceof Ie || r instanceof re,
  w0 = {
    'AMS-Regular': {
      32: [0, 0, 0, 0, 0.25],
...
function Dt(r, e, t) {
  ...
  var a = r.charCodeAt(0),
    n = w0[e][a];
  if (
    (!n && r[0] in Qt && ((a = Qt[r[0]].charCodeAt(0)), (n = w0[e][a])),
    !n && t === 'text' && Dr(a) && (n = w0[e][77]),
    n)
  )
...
function ha(r) {
  var e;
  if ((r >= 5 ? (e = 0) : r >= 3 ? (e = 1) : (e = 2), !Ke[e])) {
    var t = (Ke[e] = { cssEmPerMu: ye.quad[e] / 18 });
    for (var a in ye) ye.hasOwnProperty(a) && (t[a] = ye[a][e]);
  }
  return Ke[e];
}
var ma = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
  ca = { 'accent-token': 1, 'mathord': 1, 'op-token': 1, 'spacing': 1, 'textord': 1 },
  $ = { math: {}, text: {} };
function i(r, e, t, a, n, l) {
  (($[r][n] = { font: e, group: t, replace: a }), l && a && ($[r][a] = $[r][n]));
}
var s = 'math',
  w = 'text',
  o = 'main',
...
i(w, d, p, '✠', '\\maltese');
var _t = '0123456789/@."';
for (var Je = 0; Je < _t.length; Je++) {
  var er = _t.charAt(Je);
  i(s, o, p, er, er);
}
var tr = '0123456789!@*()-=+";:?/.,';
for (var Qe = 0; Qe < tr.length; Qe++) {
  var rr = tr.charAt(Qe);
  i(w, o, p, rr, rr);
}
var qe = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
for (var _e = 0; _e < qe.length; _e++) {
  var xe = qe.charAt(_e);
  (i(s, o, E, xe, xe), i(w, o, p, xe, xe));
}
i(s, d, p, 'C', 'ℂ');
i(w, d, p, 'C', 'ℂ');
i(s, d, p, 'H', 'ℍ');
...
var ke = [
  ...
  Ne = function (e, t, a) {
    ...
    return { value: e, metrics: Dt(e, t, a) };
  },
  l0 = function (e, t, a, n, l) {
    ...
    if (h) {
      ...
      ((a === 'text' || (n && n.font === 'mathit')) && (v = 0),
        (c = new d0(e, h.height, h.depth, v, h.skew, h.width, l)));
    } else
      (typeof console < 'u' &&
        console.warn(
          'No character metrics ' + ("for '" + e + "' in style '" + t + "' and mode '" + a + "'"),
        ),
        (c = new d0(e, 0, 0, 0, 0, 0, l)));
    if (n) {
  ...
  Oe = function (e, t, a) {
    var n = e.mode,
      ...
      v = '',
      g = '';
    if ((l.charCodeAt(0) === 55349 && ([v, g] = da(l, n)), v.length > 0))
      return l0(l, v, n, t, u.concat(g));
    if (c) {
      var b, y;
      if (c === 'boldsymbol') {
        var x = fa(l, n, t, u, a);
      ...
      if (Hr.hasOwnProperty(l) && b.slice(0, 10) === 'Typewriter') {
    ...
    if (a === 'textord') {
      ...
      if (C === 'ams') {
        ...
        var H = Se('textrm', t.fontWeight, t.fontShape);
        return l0(l, H, n, t, u.concat(t.fontWeight, t.fontShape));
      } else {
        var N = Se(C, t.fontWeight, t.fontShape);
        return l0(l, N, n, t, u.concat(N, t.fontWeight, t.fontShape));
      }
  ...
  te = function (e, t) {
    return e instanceof re ? k([], [e], t) : e;
  },
  ga = function (e) {
    if (e.positionType === 'individualShift') {
      for (
        var t = e.children, a = [t[0]], n = -t[0].shift - t[0].elem.depth, l = n, u = 1;
        u < t.length;
        u++
      ) {
  ...
  G = function (e, t) {
    for (var { children: a, depth: n } = ga(e), l = 0, u = 0; u < a.length; u++) {
      var h = a[u];
      if (h.type === 'elem') {
        var c = h.elem;
    ...
    for (var g = [], b = n, y = n, x = n, A = 0; A < a.length; A++) {
      ...
      if (T.type === 'kern') x += T.size;
        ...
        var C = T.elem,
          ...
          H = T.wrapperStyle || {},
          N = k(q, [v, C], void 0, H);
        ((N.style.top = M(-l - x - C.depth)),
          T.marginLeft && (N.style.marginLeft = T.marginLeft),
          T.marginRight && (N.style.marginRight = T.marginRight),
          g.push(N),
          (x += C.height + C.depth));
      }
    ...
    if (b < 0) {
      var L = k([], []),
        P = k(['vlist'], [L]);
      P.style.height = M(-b);
      var W = k(['vlist-s'], [new d0('​')]);
      U = [k(['vlist-r'], [F, W]), k(['vlist-r'], [P])];
    } else U = [k(['vlist-r'], [F])];
    var X = k(['vlist-t'], U);
    return (U.length === 2 && X.classes.push('vlist-t2'), (X.height = y), (X.depth = -b), X);
  },
  Nr = (r, e) => {
    var t = k(['mspace'], [], e),
      a = K(r, e);
  ...
  M0 = { number: 5, unit: 'mu' },
  ba = {
    mord: { mop: Z, mbin: Y0, mrel: M0, minner: Z },
    mop: { mord: Z, mop: Z, mrel: M0, minner: Z },
    mbin: { mord: Y0, mop: Y0, mopen: Y0, minner: Y0 },
    mrel: { mord: M0, mop: M0, mopen: M0, minner: M0 },
    mopen: {},
    mclose: { mop: Z, mbin: Y0, mrel: M0, minner: Z },
    mpunct: { mord: Z, mop: Z, mrel: M0, mopen: Z, mclose: Z, mpunct: Z, minner: Z },
    minner: { mord: Z, mop: Z, mbin: Y0, mrel: M0, mopen: Z, mpunct: Z, minner: Z },
  },
  ya = {
    mord: { mop: Z },
    mop: { mord: Z, mop: Z },
...
var He = function (e) {
  ...
  xa = new Set(['leftmost', 'mbin', 'mopen', 'mrel', 'mop', 'mpunct']),
  wa = new Set(['rightmost', 'mrel', 'mclose', 'mpunct']),
  ka = { display: I.DISPLAY, text: I.TEXT, script: I.SCRIPT, scriptscript: I.SCRIPTSCRIPT },
  Sa = {
    mord: 'mord',
    mop: 'mop',
    mbin: 'mbin',
  ...
  r0 = function (e, t, a, n) {
    ...
    if (e.length === 1) {
      var g = e[0];
      g.type === 'sizing'
        ? (v = t.havingSize(g.size))
        : g.type === 'styling' && (v = t.havingStyle(ka[g.style]));
    }
    ...
    return (
      bt(
        ...
        (A, T) => {
          ...
          C === 'mbin' && wa.has(q)
            ? (T.classes[0] = 'mord')
            : q === 'mbin' && xa.has(C) && (A.classes[0] = 'mord');
        },
        { node: b },
        y,
        x,
  ...
  bt = function (e, t, a, n, l) {
    n && e.push(n);
    for (var u = 0; u < e.length; u++) {
      var h = e[u],
        c = Pr(h);
      if (c) {
        bt(c.children, t, a, null, l);
        continue;
      }
  ...
  Pr = function (e) {
    return e instanceof re || e instanceof Ie || (e instanceof ae && e.hasClass('enclosing'))
      ? e
      : null;
  },
  yt = function (e, t) {
    ...
    if (a) {
      var n = a.children;
      if (n.length) {
        if (t === 'right') return yt(n[n.length - 1], 'right');
        if (t === 'left') return yt(n[0], 'left');
      }
    }
    return e;
  },
...
function wt(r, e) {
  ...
  for (var l = [], u = [], h = 0; h < a.length; h++)
    if (
      (u.push(a[h]), a[h].hasClass('mbin') || a[h].hasClass('mrel') || a[h].hasClass('allowbreak'))
    ) {
      for (
        var c = !1;
      ...
      a[h].hasClass('newline') &&
        (u.pop(), u.length > 0 && (l.push(ze(u, e)), (u = [])), l.push(a[h]));
  u.length > 0 && l.push(ze(u, e));
  var v;
  t ? ((v = ze(r0(t, e, !0), e)), (v.classes = ['tag']), l.push(v)) : n && l.push(n);
    ...
    for (var a = 0; a < this.children.length; a++)
      if (this.children[a] instanceof _ && this.children[a + 1] instanceof _) {
        for (
          ...
          this.children[a + 1] instanceof _;
        )
...
class Vr {
  ...
  toMarkup() {
    return this.character
      ...
      : '<mspace width="' + M(this.width) + '"/>';
  }
  toText() {
    return this.character ? this.character : ' ';
  }
}
var za = new Set(['\\imath', '\\jmath']),
  Ma = new Set(['mrow', 'mtable']),
  g0 = function (e, t, a) {
    return (
      $[t][e] &&
        $[t][e].replace &&
  ...
  Rt = function (e, t) {
    ...
    var l = e.text;
    if (za.has(l)) return null;
    if ($[n][l]) {
      var u = $[n][l].replace;
      u && (l = u);
    }
    var h = gt[a].fontName;
    return Dt(l, h, n) ? gt[a].variant : null;
  };
function tt(r) {
  if (!r) return !1;
    ...
    for (var l = [], u, h = 0; h < e.length; h++) {
      ...
      if (c instanceof z && u instanceof z) {
        if (
          ...
          u.children.push(...c.children);
          continue;
        } else if (c.type === 'mn' && tt(u))
          ((c.children = [...u.children, ...c.children]), l.pop());
        else if (
          ...
          v instanceof z &&
            v.type === 'mn' &&
            ((v.children = [...u.children, ...v.children]), l.pop());
...
function nr(r, e, t, a, n) {
  var l = v0(r, t),
    u;
  l.length === 1 && l[0] instanceof z && Ma.has(l[0].type) ? (u = l[0]) : (u = new z('mrow', l));
...
var Aa = [
  ...
  ir = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
  lr = function (e, t) {
    return t.size < 2 ? e : Aa[e - 1][t.size - 1];
  };
class A0 {
  constructor(e) {
    ((this.style = e.style),
      ...
      (this.sizeMultiplier = ir[this.size - 1]),
  ...
  havingStyle(e) {
    return this.style === e ? this : this.extend({ style: e, size: lr(this.textSize, e) });
  }
  havingCrampedStyle() {
  ...
  havingSize(e) {
    return this.size === e && this.textSize === e
      ? this
      : this.extend({ style: this.style.text(), size: e, textSize: e, sizeMultiplier: ir[e - 1] });
  }
  havingBaseStyle(e) {
    e = e || this.style.text();
    var t = lr(A0.BASESIZE, e);
  ...
  fontMetrics() {
    return (this._fontMetrics || (this._fontMetrics = ha(this.size)), this._fontMetrics);
  }
  getColor() {
...
var Ur = function (e) {
  ...
  Ta = function (e, t, a) {
    var n = Ur(a),
      l;
    if (a.output === 'mathml') return nr(e, t, n, a.displayMode, !0);
    if (a.output === 'html') {
      var u = wt(e, n);
      l = k(['katex'], [u]);
    } else {
      var h = nr(e, t, n, a.displayMode, !1),
        c = wt(e, n);
      l = k(['katex'], [h, c]);
    }
    return Xr(l, a);
  ...
  Fe = function (e) {
    var t = new z('mo', [new _(Da[e.replace(/^\\/, '')])]);
  ...
  qa = new Set(['widehat', 'widecheck', 'widetilde', 'utilde']),
  Le = function (e, t) {
    function a() {
      var h = 4e5,
        c = e.label.slice(1);
      if (qa.has(c)) {
        ...
        if (P === 1) {
          ...
          ((W = ['halfarrow-left', 'halfarrow-right']), (X = ['xMinYMin', 'xMaxYMin']));
        else if (P === 3)
  ...
  Ea = function (e, t, a, n, l) {
    ...
    if (/fbox|color|angl/.test(t)) {
      ...
      (/^[bx]cancel$/.test(t) &&
        v.push(
          new vt({ 'x1': '0', 'y1': '0', 'x2': '100%', 'y2': '100%', 'stroke-width': '0.046em' }),
        ),
        /^x?cancel$/.test(t) &&
          v.push(
            new vt({ 'x1': '0', 'y1': '100%', 'x2': '100%', 'y2': '0', 'stroke-width': '0.046em' }),
          ));
      var g = new B0(v, { width: '100%', height: M(h) });
      u = P0([], [g], l);
    }
...
function Ge(r) {
  return r && (r.type === 'atom' || ca.hasOwnProperty(r.type)) ? r : null;
}
var Yr = (r) => {
    if (r instanceof d0) return r;
    if (ua(r) && r.children.length === 1) return Yr(r.children[0]);
  },
  Ht = (r, e) => {
    var t, a, n;
    r && r.type === 'supsub'
      ? ((a = O(r.base, 'accent')), (t = a.base), (r.base = t), (n = sa(V(r, e))), (r.base = a))
      : ((a = O(r, 'accent')), (t = a.base));
    var l = V(t, e.havingCrampedStyle()),
      u = a.isShifty && D0(t),
      h = 0;
    if (u) {
      var c, v;
      h = (c = (v = Yr(l)) == null ? void 0 : v.skew) != null ? c : 0;
    }
    var g = a.label === '\\c',
    ...
    if (a.isStretchy)
        ...
        (y = G({
          ...
          children: [
            { type: 'elem', elem: l },
            {
              ...
              wrapperStyle:
                h > 0 ? { width: 'calc(100% - ' + M(2 * h) + ')', marginLeft: M(2 * h) } : void 0,
            },
          ],
        })));
    else {
      var x, A;
      (a.label === '\\vec'
        ? ((x = Fr('vec', e)), (A = Or.vec[1]))
        : ((x = Oe({ mode: a.mode, text: a.label }, e, 'textord')),
          (x = la(x)),
          (x.italic = 0),
          (A = x.width),
          g && (b += x.depth)),
    ...
    return n
      ? ((n.children[0] = q), (n.height = Math.max(q.height, n.height)), (n.classes[0] = 'mord'), n)
      : q;
  },
  Wr = (r, e) => {
    var t = r.isStretchy ? Fe(r.label) : new z('mo', [g0(r.label, r.mode)]),
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    r.below &&
      ...
      (u = te(V(r.below, a, e), e)),
      u.classes.push(l + '-arrow-pad'));
    var h = Le(r, e),
...
var Ha = {
  ...
  sr = () => ({ type: 'styling', body: [], mode: 'math', style: 'display' }),
  ur = (r) => r.type === 'textord' && r.text === '@',
  Ia = (r, e) => (r.type === 'mathord' || r.type === 'atom') && r.text === e;
function Na(r, e, t) {
  var a = Ha[r];
  switch (a) {
    case '\\\\cdrightarrow':
...
function Oa(r) {
  ...
  for (var a = [], n = [a], l = 0; l < e.length; l++) {
    for (var u = e[l], h = sr(), c = 0; c < u.length; c++)
      if (!ur(u[c])) h.body.push(u[c]);
      else {
        (a.push(h), (c += 1));
        var v = Pe(u[c]).text,
          g = new Array(2);
          ...
          if ('<>AV'.includes(v))
            for (var b = 0; b < 2; b++) {
              for (var y = !0, x = c + 1; x < u.length; x++) {
                ...
                if (ur(u[x]))
                  throw new S('Missing a ' + v + ' character to complete a CD arrow.', u[x]);
                g[b].body.push(u[x]);
              }
...
B({
  ...
  handler(r, e) {
    for (
      var { parser: t } = r, a = O(e[0], 'ordgroup'), n = a.body, l = '', u = 0;
      u < n.length;
      u++
    ) {
      var h = O(n[u], 'textord');
...
var Zr = (r, e) => {
  ...
  Kr = (r, e) => {
    var t = v0(r.body, e.withColor(r.color)),
      a = new z('mstyle', t);
...
B({
  ...
  htmlBuilder(r, e) {
    var t = k(['mspace'], [], e);
    return (
      r.newLine && (t.classes.push('newline'), r.size && (t.style.marginTop = M(K(r.size, e)))),
      t
    );
  },
  mathmlBuilder(r, e) {
    ...
    return (
      r.newLine &&
        ...
        r.size && t.setAttribute('height', M(K(r.size, e)))),
      t
    );
  },
});
...
B({
  ...
  handler(r) {
    ...
    if (kt[a.text])
      return (
        (t === '\\global' || t === '\\\\globallong') && (a.text = kt[a.text]),
        O(e.parseFunction(), 'internal')
      );
...
B({
  ...
  handler(r) {
    ...
    return (
      ...
      e.gullet.macros.set(n, { tokens: c, numArgs: l, delimiters: h }, t === kt[t]),
...
var se = function (e, t, a) {
  ...
  e1 = function (e, t, a, n, l, u) {
    var h = Pa(e, t, l, n),
      c = It(k(['delimsizing', 'size' + t], [h], n), I.TEXT, n, u);
    return (a && _r(c, n, I.TEXT), c);
  },
  rt = function (e, t, a) {
    var n;
  ...
  at = function (e, t, a) {
    var n = w0['Size4-Regular'][e.charCodeAt(0)]
      ...
      l = new L0('inner', ea(e, Math.round(1e3 * t))),
      u = new B0([l], {
        width: M(n),
        height: M(t),
        style: 'width:' + M(n),
  ...
  St = 0.008,
  Ae = { type: 'kern', size: -1 * St },
  Ga = new Set(['|', '\\lvert', '\\rvert', '\\vert']),
  ...
  t1 = function (e, t, a, n, l, u) {
    ...
    if (c !== null) {
      var L = se(c, x, l);
      ((F = L.height + L.depth), (U = 2));
    }
    var P = T + N + F,
      W = Math.max(0, Math.ceil((t - P) / (U * q))),
      X = P + W * U * q,
    ...
    if (b.length > 0) {
      var U0 = X - T - N,
        ...
        $0 = M(y / 1e3),
        j0 = M(h0 / 1e3),
        je = new B0([E0], { width: $0, height: j0, viewBox: '0 0 ' + y + ' ' + h0 }),
        R0 = P0([], [je], n);
      ((R0.height = h0 / 1e3),
        (R0.style.width = $0),
        (R0.style.height = j0),
        t0.push({ type: 'elem', elem: R0 }));
    } else {
      if ((t0.push(rt(g, x, l)), t0.push(Ae), c === null)) {
        var H0 = X - T - N + 2 * St;
        t0.push(at(v, H0, n));
      } else {
        var le = (X - T - N - F) / 2 + 2 * St;
        (t0.push(at(v, le, n)),
          t0.push(Ae),
          t0.push(rt(c, x, l)),
          t0.push(Ae),
      ...
      (t0.push(Ae), t0.push(rt(h, x, l)));
    }
    var y0 = n.havingBaseStyle(I.TEXT),
      de = G({ positionType: 'bottom', positionData: n0, children: t0 });
    return It(k(['delimsizing', 'mult'], [de], y0), I.TEXT, n, u);
  },
  nt = 80,
  it = 0.08,
  lt = function (e, t, a, n, l) {
    var u = _1(e, n, a),
      h = new L0(e, u),
      c = new B0([h], {
        width: '400em',
      ...
      n.type === 'small'
        ...
        : n.type === 'large'
          ? ((g = (1e3 + nt) * ue[n.size]),
            (v = (ue[n.size] + u) / l),
            (c = (ue[n.size] + u + it) / l),
            (h = lt('sqrtSize' + n.size, c, g, u, t)),
            (h.style.minWidth = '1.02em'),
            (b = 1 / l))
          : ((c = e + u + it),
            (v = e + u),
            (g = Math.floor(1e3 * e + u) + nt),
            (h = lt('sqrtTall', c, g, u, t)),
  ...
  n1 = function (e, t, a, n, l) {
    ...
    if (Xa.has(e)) return t1(e, ue[t], !1, a, n, l);
  ...
  zt = function (e, t, a, n, l, u) {
    e === '<' || e === '\\lt' || e === '⟨'
      ? (e = '\\langle')
      : (e === '>' || e === '\\gt' || e === '⟩') && (e = '\\rangle');
    var h;
    a1.has(e) ? (h = Ya) : r1.has(e) ? (h = i1) : (h = Wa);
    var c = l1(e, t, h, n);
    return c.type === 'small'
      ? La(e, c.style, a, n, l, u)
      : c.type === 'large'
        ? e1(e, c.size, a, n, l, u)
        : t1(e, t, a, n, l, u);
  },
  st = function (e, t, a, n, l, u) {
    var h = n.fontMetrics().axisHeight * n.sizeMultiplier,
      c = 901,
      v = 5 / n.fontMetrics().ptPerEm,
      g = Math.max(t - h, a + h),
      b = Math.max((g / 500) * c, 2 * g - v);
    return zt(e, b, !0, n, l, u);
  },
  or = {
...
B({
  ...
  handler: (r, e) => {
    ...
    return {
      type: 'delimsizing',
      mode: r.parser.mode,
      size: or[r.funcName].size,
      mclass: or[r.funcName].mclass,
      delim: t.text,
    };
  },
  htmlBuilder: (r, e) =>
    r.delim === '.' ? k([r.mclass]) : n1(r.delim, r.size, e, r.mode, [r.mclass]),
  mathmlBuilder: (r) => {
    var e = [];
...
B({
  ...
  htmlBuilder: (r, e) => {
    hr(r);
    for (
      var t = r0(r.body, e, !0, ['mopen', 'mclose']), a = 0, n = 0, l = !1, u = 0;
      u < t.length;
      u++
    )
    ...
    var h;
    if (
      (r.left === '.' ? (h = he(e, ['mopen'])) : (h = st(r.left, a, n, e, r.mode, ['mopen'])),
      t.unshift(h),
      l)
    )
      for (var c = 1; c < t.length; c++) {
        var v = t[c],
          g = v.isMiddle;
        g && (t[c] = st(g.delim, a, n, g.options, r.mode, []));
      }
    var b;
    if (r.right === '.') b = he(e, ['mclose']);
    else {
      var y = r.rightColor ? e.withColor(r.rightColor) : e;
      b = st(r.right, a, n, y, r.mode, ['mclose']);
    }
...
var Xe = (r, e) => {
    ...
    if (a === 'sout')
      ...
      (/box/.test(a)
        ...
        /fbox|boxed|fcolorbox/.test(a)
          ...
          : a === 'angl' &&
            q !== 0.049 &&
            ((l.style.borderTopWidth = M(q)), (l.style.borderRightWidth = M(q))),
        (u = t.depth + C),
        r.backgroundColor &&
    ...
    if (r.backgroundColor)
      ...
      H = G({
        ...
        children: [
          { type: 'elem', elem: t, shift: 0 },
          { type: 'elem', elem: l, shift: u, wrapperClasses: N },
        ],
      });
    }
    return (
      /cancel/.test(a) && ((H.height = t.height), (H.depth = t.depth)),
      /cancel/.test(a) && !h ? k(['mord', 'cancel-lap'], [H], e) : k(['mord'], [H], e)
    );
  },
  Ye = (r, e) => {
    var t = 0,
  ...
  function F() {
    H &&
      (r.gullet.macros.get('\\df@tag')
        ? (H.push(r.subparse([new c0('\\df@tag')])), r.gullet.macros.set('\\df@tag', void 0, !0))
        : H.push(!!c && r.gullet.macros.get('\\@eqnsw') === '1'));
  }
  for (N(), q.push(mr(r)); ; ) {
    var U = r.parseExpression(!1, v ? '\\end' : '\\\\');
    (r.gullet.endGroup(), r.gullet.beginGroup());
    var L = { type: 'ordgroup', mode: r.mode, body: U };
...
var S0 = function (e, t) {
    ...
    var A = e.colSeparationType === 'CD' ? K({ number: 3, unit: 'ex' }, t) : 12 * b,
      T = 3 * b,
      C = e.arraystretch * A,
      q = 0.7 * C,
      H = 0.3 * C,
    ...
    function F(ge) {
      for (var be = 0; be < ge.length; ++be)
        (be > 0 && (N += 0.25), v.push({ pos: N, isDashed: ge[be] }));
    }
    for (F(u[0]), a = 0; a < e.body.length; ++a) {
      ...
      var o0 = e.rowGaps[a],
        n0 = 0;
      (o0 && ((n0 = K(o0, t)), n0 > 0 && ((n0 += H), P < n0 && (P = n0), (n0 = 0))),
    ...
    var t0 = N / 2 + t.fontMetrics().axisHeight,
      U0 = e.cols || [],
      h0 = [],
      b0,
      E0,
    ...
    if (e.tags && e.tags.some((ge) => ge))
      for (a = 0; a < l; ++a) {
        ...
        (R0 === !0
          ...
          (H0.depth = j0.depth),
          (H0.height = j0.height),
          $0.push({ type: 'elem', elem: H0, shift: je }));
      }
    for (n = 0, E0 = 0; n < h || E0 < U0.length; ++n, ++E0) {
      for (var le, y0 = U0[E0], de = !0; ((Vt = y0) == null ? void 0 : Vt.type) === 'separator'; ) {
        var Vt;
        if (
          (de ||
            ((b0 = k(['arraycolsep'], [])),
          ...
          var Ut = N - t0;
          (Ut && (Z0.style.verticalAlign = M(-Ut)), h0.push(Z0));
      ...
      if (!(n >= h)) {
        ...
        for (a = 0; a < l; ++a) {
          ...
          if (ve) {
            ...
            ((ve.depth = fe.depth),
              (ve.height = fe.height),
              Wt.push({ type: 'elem', elem: ve, shift: A1 }));
          }
        }
        var T1 = G({ positionType: 'individualShift', children: Wt }),
          B1 = k(['col-align-' + (((le = y0) == null ? void 0 : le.align) || 'c')], [T1]);
        if ((h0.push(B1), n < h - 1 || e.hskipBeforeAndAfter)) {
          var $t, jt;
          ((K0 = ($t = (jt = y0) == null ? void 0 : jt.postgap) != null ? $t : y),
            K0 !== 0 && ((b0 = k(['arraycolsep'], [])), (b0.style.width = M(K0)), h0.push(b0)));
        }
      }
    }
    ...
    if (v.length > 0) {
      for (
        var D1 = ee('hline', t, g),
          C1 = ee('hdashline', t, g),
          Ze = [{ type: 'elem', elem: pe, shift: 0 }];
        v.length > 0;
      ) {
        var Zt = v.pop(),
          Kt = Zt.pos - t0;
        Zt.isDashed
          ? Ze.push({ type: 'elem', elem: C1, shift: Kt })
          : Ze.push({ type: 'elem', elem: D1, shift: Kt });
      }
      pe = G({ positionType: 'individualShift', children: Ze });
    }
    if ($0.length === 0) return k(['mord'], [pe], t);
    var q1 = G({ positionType: 'individualShift', children: $0 }),
      E1 = k(['tag'], [q1], t);
    return q0([pe, E1]);
  },
  Ka = { c: 'center ', l: 'left ', r: 'right ' },
  z0 = function (e, t) {
    for (
      ...
      (e.tags && e.tags[u] && (c.unshift(n), c.push(n), e.leqno ? c.unshift(l) : c.push(l)),
        a.push(new z('mtr', c)));
    }
    ...
    if (e.cols && e.cols.length > 0) {
      ...
      (A[0].type === 'separator' && ((y += 'top '), (q = 1)),
        A[A.length - 1].type === 'separator' && ((y += 'bottom '), (H -= 1)));
      for (var N = q; N < H; N++) {
        var F = A[N];
        F.type === 'align'
          ? ((x += Ka[F.align]), C && (T += 'none '), (C = !0))
          : F.type === 'separator' &&
            C &&
            ((T += F.separator === '|' ? 'solid ' : 'dashed '), (C = !1));
      }
      (g.setAttribute('columnalign', x.trim()),
        /[sd]/.test(T) && g.setAttribute('columnlines', T.trim()));
    }
    if (e.colSeparationType === 'align') {
      for (var U = e.cols || [], L = '', P = 1; P < U.length; P++) L += P % 2 ? '0em ' : '1em ';
    ...
    for (var o0 = 1; o0 < X.length - 1; o0++)
      W += X[o0].length === 0 ? 'none ' : X[o0][0] ? 'dashed ' : 'solid ';
    return (
      /[sd]/.test(W) && g.setAttribute('rowlines', W.trim()),
      y !== '' && ((g = new z('menclose', [g])), g.setAttribute('notation', y.trim())),
      e.arraystretch &&
        e.arraystretch < 1 &&
        ((g = new z('mstyle', [g])), g.setAttribute('scriptlevel', '1')),
      g
    );
  },
  o1 = function (e, t) {
    ...
    u.body.forEach(function (q) {
      for (var H = 1; H < q.length; H += 2) {
        var N = O(q[H], 'styling'),
          F = O(N.body[0], 'ordgroup');
        F.body.unshift(v);
      }
      if (x) c < q.length && (c = q.length);
        ...
        var U = q.length / 2;
        if (h < U)
          throw new S('Too many math in a row: ' + ('expected ' + h + ', but got ' + U), q[0]);
      }
    });
    for (var A = 0; A < c; ++A) {
      var T = 'r',
        C = 0;
      (A % 2 === 1 ? (T = 'l') : A > 0 && x && (C = 1),
        (a[A] = { type: 'align', align: T, pregap: C, postgap: 0 }));
    }
...
k0({
  ...
  handler(r, e) {
    ...
    return V0(r.parser, l, Ot(r.envName));
  },
  htmlBuilder: S0,
  mathmlBuilder: z0,
});
k0({
  ...
  handler(r) {
    ...
    var l = V0(r.parser, a, Ot(r.envName)),
...
B({
  ...
  handler(r, e) {
    ...
    if (a === '\\begin') {
      if (!cr.hasOwnProperty(l)) throw new S('No such environment: ' + l, n);
      var h = cr[l],
      ...
      if (x.name !== l)
        throw new S('Mismatch: \\begin{' + l + '} matched by \\end{' + x.name + '}', y);
      return b;
    }
...
B({
  ...
  handler: (r, e) => {
    var { parser: t, funcName: a } = r,
      n = He(e[0]),
      l = a;
    return (l in dr && (l = dr[l]), { type: 'font', mode: t.mode, font: l.slice(1), body: n });
  },
  htmlBuilder: h1,
  mathmlBuilder: m1,
});
...
var Ja = (r, e) => {
    ...
    r.hasBarLine
      ? (r.barSize
          ? ((b = K(r.barSize, e)), (g = ee('frac-line', e, b)))
          : (g = ee('frac-line', e)),
        (b = g.height),
        (y = g.height))
    ...
    if (g) {
      ...
      (x - u.depth - (H + 0.5 * b) < A && (x += A - (x - u.depth - (H + 0.5 * b))),
        H - 0.5 * b - (v.height - T) < A && (T += A - (H - 0.5 * b - (v.height - T))));
      var N = -(H - 0.5 * b);
      C = G({
        positionType: 'individualShift',
        children: [
          { type: 'elem', elem: v, shift: T },
          { type: 'elem', elem: g, shift: N },
    ...
    t.size === I.DISPLAY.size
      ...
      : t.size === I.SCRIPTSCRIPT.size
        ? (F = e.havingStyle(I.SCRIPT).fontMetrics().delim2)
        : (F = e.fontMetrics().delim2);
    var U, L;
    return (
      r.leftDelim == null
        ? (U = he(e, ['mopen']))
        : (U = zt(r.leftDelim, F, !0, e.havingStyle(t), r.mode, ['mopen'])),
      r.continued
        ? (L = k([]))
        : r.rightDelim == null
          ? (L = he(e, ['mclose']))
          : (L = zt(r.rightDelim, F, !0, e.havingStyle(t), r.mode, ['mclose'])),
      k(['mord'].concat(l.sizingClasses(e)), [U, k(['mfrac'], [C]), L], e)
    );
  },
  Qa = (r, e) => {
...
var fr = ['display', 'text', 'script', 'scriptscript'],
  vr = function (e) {
    var t = null;
...
B({
  ...
  handler(r, e) {
    ...
    } else ((x = O(x, 'textord')), (y = fr[Number(x.text)]));
    return c1(
      {
        type: 'genfrac',
        mode: t.mode,
...
var d1 = (r, e) => {
    var t = e.style,
      ...
      n;
    r.type === 'supsub'
      ? ((a = r.sup ? V(r.sup, e.havingStyle(t.sup()), e) : V(r.sub, e.havingStyle(t.sub()), e)),
        (n = O(r.base, 'horizBrace')))
      : (n = O(r, 'horizBrace'));
    var l = V(n.base, e.havingBaseStyle(I.DISPLAY)),
      u = Le(n, e),
      h;
    if (
      (n.isOver
...
var ut = function (e) {
  ...
  if (!Cr(a)) throw new S("Invalid unit: '" + a.unit + "' in \\includegraphics.");
  return a;
};
B({
  ...
  handler: (r, e, t) => {
    var { parser: a } = r,
      ...
      h = '';
    if (t[0])
      for (var c = O(t[0], 'raw').string, v = c.split(','), g = 0; g < v.length; g++) {
        var b = v[g].split('=');
        if (b.length === 2) {
          var y = b[1].trim();
          switch (b[0].trim()) {
  ...
  mathmlBuilder: (r, e) => {
    ...
    var a = K(r.height, e),
      n = 0;
    if (
      (r.totalheight.number > 0 && ((n = K(r.totalheight, e) - a), t.setAttribute('valign', M(-n))),
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t;
    r.alignment === 'clap'
      ? ((t = k([], [V(r.body, e)])), (t = k(['inner'], [t], e)))
      : (t = k(['inner'], [V(r.body, e)]));
    var a = k(['fix'], []),
...
B({
  ...
  handler(r, e) {
    ...
    return (
      a.expect(l),
      a.switchMode(n),
      { type: 'styling', mode: a.mode, style: 'text', body: u }
    );
  },
});
B({
...
var f1 = (r, e, t, a, n, l, u) => {
    ...
    var h = t && D0(t),
      ...
      v;
    if (e) {
      var g = V(e, a.havingStyle(n.sup()), a);
      v = {
        elem: g,
  ...
  ie = (r, e) => {
    var t,
      ...
      l;
    r.type === 'supsub'
      ? ((t = r.sup), (a = r.sub), (l = O(r.base, 'op')), (n = !0))
      : (l = O(r, 'op'));
    var u = e.style,
      h = !1;
    u.size === I.DISPLAY.size && l.symbol && !v1.has(l.name) && (h = !0);
    var c;
    if (l.symbol) {
      ...
      if (
        ...
        (c = l0(l.name, v, 'math', e, ['mop', 'op-symbol', h ? 'large-op' : 'small-op'])),
        g.length > 0)
      ) {
        var b = c.italic,
          y = Fr(g + 'Size' + (h ? '2' : '1'), e);
      ...
      var x = r0(l.body, e, !0);
      x.length === 1 && x[0] instanceof d0
        ? ((c = x[0]), (c.classes[0] = 'mop'))
        : (c = k(['mop'], x, e));
    } else {
      for (var A = [], T = 1; T < l.name.length; T++) A.push(Ct(l.name[T], l.mode, e));
      c = k(['mop'], A, e);
    }
    var C = 0,
      q = 0;
    return (
      (c instanceof d0 || l.name === '\\oiint' || l.name === '\\oiiint') &&
        !l.suppressBaseShift &&
        ((C = (c.height - c.depth) / 2 - e.fontMetrics().axisHeight), (q = c.italic || 0)),
      n
        ? f1(c, t, a, e, u, q, C)
        : (C && ((c.style.position = 'relative'), (c.style.top = M(C))), c)
    );
  },
  ce = (r, e) => {
    var t;
    if (r.symbol)
      ((t = new z('mo', [g0(r.name, r.mode)])),
      ...
      r.parentIsSupSub ? (t = new z('mrow', [t, a])) : (t = Gr([t, a]));
    }
    return t;
  },
  e4 = {
...
var p1 = (r, e) => {
  ...
  r4 = (r, e) => {
    for (var t = v0(r.body, e.withFont('mathrm')), a = !0, n = 0; n < t.length; n++) {
      var l = t[n];
      if (!(l instanceof Vr))
        if (l instanceof z)
          switch (l.type) {
    ...
    return r.parentIsSupSub ? new z('mrow', [c, v]) : Gr([c, v]);
  };
B({
  type: 'operatorname',
...
B({
  ...
  htmlBuilder: (r, e) => {
    var t = k(['inner'], [V(r.body, e.withPhantom())]),
      a = k(['fix'], []);
...
B({
  ...
  mathmlBuilder(r, e) {
    var t = K(r.width, e),
      ...
      u = new z('mspace');
    (u.setAttribute('mathbackground', l),
      u.setAttribute('width', M(t)),
      u.setAttribute('height', M(a)));
    var h = new z('mpadded', [u]);
    return (
      n >= 0
        ? h.setAttribute('height', M(n))
        : (h.setAttribute('height', M(n)), h.setAttribute('depth', M(-n))),
...
function g1(r, e, t) {
  for (var a = r0(r, e, !1), n = e.sizeMultiplier / t.sizeMultiplier, l = 0; l < a.length; l++) {
    ...
    (u < 0
      ...
      : a[l].classes[u + 1] === 'reset-size' + e.size &&
        (a[l].classes[u + 1] = 'reset-size' + t.size),
      (a[l].height *= n),
      (a[l].depth *= n));
  }
  return q0(a);
...
B({
  ...
  handler: (r, e) => {
    ...
    return { type: 'sizing', mode: n.mode, size: gr.indexOf(a) + 1, body: l };
  },
  htmlBuilder: a4,
  mathmlBuilder: (r, e) => {
    var t = e.havingSize(r.size),
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    var a = e.fontMetrics(),
      ...
      l = n;
    e.style.id < I.TEXT.id && (l = e.fontMetrics().xHeight);
    var u = n + l / 4,
      h = t.height + t.depth + u + n,
      { span: c, ruleWidth: v, advanceWidth: g } = Ua(h, e),
      b = c.height - v;
...
var br = { display: I.DISPLAY, text: I.TEXT, script: I.SCRIPT, scriptscript: I.SCRIPTSCRIPT };
B({
  type: 'styling',
...
var n4 = function (e, t) {
  ...
  if (a)
    if (a.type === 'op') {
      ...
      var l = a.alwaysHandleSupSub && (t.style.size === I.DISPLAY.size || a.limits);
      return l ? p1 : null;
    } else {
      if (a.type === 'accent') return D0(a.base) ? Ht : null;
...
W0({
  ...
  htmlBuilder(r, e) {
    ...
    if (n) {
      ...
      ((h = V(n, x, e)),
        y || (g = u.height - (x.fontMetrics().supDrop * x.sizeMultiplier) / e.sizeMultiplier));
    }
    if (l) {
      var A = e.havingStyle(e.style.sub());
      ((c = V(l, A, e)),
        y || (b = u.depth + (A.fontMetrics().subDrop * A.sizeMultiplier) / e.sizeMultiplier));
    }
    var T;
    e.style === I.DISPLAY ? (T = v.sup1) : e.style.cramped ? (T = v.sup3) : (T = v.sup2);
    ...
    if (c) {
      ...
      (u instanceof d0 || N) && (H = M(-u.italic));
    }
    var F;
    if (h && c) {
      ((g = Math.max(g, T, h.depth + 0.25 * v.xHeight)), (b = Math.max(b, v.sub2)));
      var U = v.defaultRuleThickness,
        L = 4 * U;
      ...
      var W = [
        { type: 'elem', elem: c, shift: b, marginRight: q, marginLeft: H },
      ...
      var X = [{ type: 'elem', elem: c, marginLeft: H, marginRight: q }];
  ...
  mathmlBuilder(r, e) {
    ...
    if (t) u = a ? 'mover' : 'munder';
      ...
      if (r.sup) {
        var v = r.base;
        (v && v.type === 'op' && v.limits && e.style === I.DISPLAY) ||
        (v &&
          v.type === 'operatorname' &&
          v.alwaysHandleSupSub &&
          (e.style === I.DISPLAY || v.limits))
          ? (u = 'munderover')
          : (u = 'msubsup');
      } else {
        var c = r.base;
        (c && c.type === 'op' && c.limits && (e.style === I.DISPLAY || c.alwaysHandleSupSub)) ||
        (c &&
          c.type === 'operatorname' &&
          c.alwaysHandleSupSub &&
          (c.limits || e.style === I.DISPLAY))
          ? (u = 'munder')
          : (u = 'msub');
      }
    else {
      var h = r.base;
      (h && h.type === 'op' && h.limits && (e.style === I.DISPLAY || h.alwaysHandleSupSub)) ||
      (h &&
        h.type === 'operatorname' &&
...
W0({
  type: 'atom',
  htmlBuilder(r, e) {
    return Ct(r.text, r.mode, e, ['m' + r.family]);
  },
  mathmlBuilder(r, e) {
...
W0({
  ...
  htmlBuilder(r, e) {
    if (ht.hasOwnProperty(r.text)) {
      var t = ht[r.text].className || '';
      if (r.mode === 'text') {
        var a = Oe(r, e, 'textord');
        return (a.classes.push(t), a);
      } else return k(['mspace', t], [Ct(r.text, r.mode, e)], e);
    } else {
      if (ot.hasOwnProperty(r.text)) return k(['mspace', ot[r.text]], [], e);
      throw new S('Unknown type of space "' + r.text + '"');
    }
  },
  mathmlBuilder(r, e) {
    var t;
    if (ht.hasOwnProperty(r.text)) t = new z('mtext', [new _(' ')]);
    else {
      if (ot.hasOwnProperty(r.text)) return new z('mspace');
      throw new S('Unknown type of space "' + r.text + '"');
    }
    return t;
  },
...
W0({
  ...
  mathmlBuilder(r, e) {
    var t = new z('mtable', [
      new z('mtr', [yr(), new z('mtd', [G0(r.body, e)]), yr(), new z('mtd', [G0(r.tag, e)])]),
    ]);
...
var xr = {
  ...
  wr = { '\\textbf': 'textbf', '\\textmd': 'textmd' },
  i4 = { '\\textit': 'textit', '\\textup': 'textup' },
  kr = (r, e) => {
    var t = r.font;
    if (t) {
...
B({
  ...
  htmlBuilder(r, e) {
    for (var t = Sr(r), a = [], n = e.havingStyle(e.style.text()), l = 0; l < t.length; l++) {
      var u = t[l];
      (u === '~' && (u = '\\textasciitilde'),
        a.push(l0(u, 'Typewriter-Regular', r.mode, n, ['mord', 'texttt'])));
    }
    return k(['mord', 'text'].concat(n.sizingClasses(e)), Ir(a), n);
  },
  mathmlBuilder(r, e) {
    var t = new _(Sr(r)),
      a = new z('mtext', [t]);
...
var Sr = (r) => r.body.replace(/ /g, r.star ? '␣' : ' '),
  O0 = Lr,
  y1 = `[ \r
	]`,
  l4 = '\\\\[a-zA-Z@]+',
...
class zr {
  constructor(e, t) {
    ((this.input = e),
      (this.settings = t),
      (this.tokenRegex = new RegExp(m4, 'g')),
      (this.catcodes = { '%': 14, '~': 13 }));
  }
  setCatcode(e, t) {
    this.catcodes[e] = t;
...
var Ft = (r, e, t, a) => {
  ...
  if (!u && !t)
    throw new S(
      '\\renewcommand{' + l + '} when command ' + l + ' does not yet exist; use \\newcommand',
    );
  var h = 0;
...
m('\\show', (r) => {
  var e = r.popToken(),
    t = e.text;
  return (console.log(e, r.macros.get(t), O0[t], $.math[t], $.text[t]), '');
});
m('\\bgroup', '{');
m('\\egroup', '}');
m('~', '\\nobreakspace');
...
m('\\dots', function (r) {
  ...
  return (
    t in Ar
      ? (e = Ar[t])
      : (t.slice(0, 4) === '\\not' || (t in $.math && f4.has($.math[t].group))) && (e = '\\dotsb'),
    e
  );
});
var Lt = {
...
m(
  '\\LaTeX',
  '\\textrm{\\html@mathml{' +
    ('L\\kern-.36em\\raisebox{' + x1 + '}{\\scriptstyle A}') +
    '\\kern-.15em\\TeX}{LaTeX}}',
);
m(
  '\\KaTeX',
  '\\textrm{\\html@mathml{' +
    ('K\\kern-.17em\\raisebox{' + x1 + '}{\\scriptstyle A}') +
    '\\kern-.15em\\TeX}{KaTeX}}',
);
...
class v4 {
  constructor(e, t, a) {
    ((this.settings = t),
      ...
      this.feed(e),
      (this.macros = new c4(d4, t.macros)),
      (this.mode = a),
      (this.stack = []));
  }
  feed(e) {
    this.lexer = new zr(e, this.settings);
  }
  switchMode(e) {
    this.mode = e;
  }
  ...
  _getExpansion(e) {
    ...
    if (typeof n == 'string') {
      ...
      for (var h = new zr(n, this.settings), c = [], v = h.lex(); v.text !== 'EOF'; )
        (c.push(v), (v = h.lex()));
      c.reverse();
  ...
  isExpandable(e) {
    ...
    return t != null
      ...
      : O0.hasOwnProperty(e) && !O0[e].primitive;
  }
}
var Tr = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/,
  Te = Object.freeze({
    '₊': '+',
    '₋': '-',
    '₌': '=',
...
class $e {
  constructor(e, t) {
    ((this.mode = 'math'),
      (this.gullet = new v4(e, t, this.mode)),
      (this.settings = t),
  ...
  parseExpression(e, t) {
    for (var a = []; ; ) {
      ...
      var n = this.fetch();
      if (
        $e.endOfExpression.has(n.text) ||
        (t && n.text === t) ||
        (e && O0[n.text] && O0[n.text].infix)
      )
        break;
  ...
  handleInfixNodes(e) {
    ...
    if (t !== -1 && a) {
      ...
      (c.length === 1 && c[0].type === 'ordgroup'
        ? (u = c[0])
        : (u = { type: 'ordgroup', mode: this.mode, body: c }),
        v.length === 1 && v[0].type === 'ordgroup'
          ? (h = v[0])
          : (h = { type: 'ordgroup', mode: this.mode, body: v }));
      var g;
      return (
        a === '\\\\abovefrac'
          ? (g = this.callFunction(a, [u, e[t], h], []))
          : (g = this.callFunction(a, [u, h], [])),
        [g]
      );
    } else return e;
  }
  ...
  parseArguments(e, t) {
    ...
    for (var n = [], l = [], u = 0; u < a; u++) {
      ...
      (('primitive' in t && t.primitive && h == null) ||
        (t.type === 'sqrt' && u === 1 && l[0] == null)) &&
        (h = 'primitive');
  ...
  parseRegexGroup(e, t) {
    for (
      var a = this.fetch(), n = a, l = '', u;
      (u = this.fetch()).text !== 'EOF' && e.test(l + u.text);
    )
  ...
  parseSizeGroup(e) {
    ...
    if (!Cr(l)) throw new S("Invalid unit: '" + l.unit + "'", t);
  ...
  parseGroup(e, t) {
    ...
    if (n === '{' || n === '\\begingroup') {
      ...
      l == null && n[0] === '\\' && !k1.hasOwnProperty(n))
    ) {
          ...
          if (l === '-' && u.text === '-') {
            ...
            a + 1 < t && h && h.type === 'textord' && h.text === '-'
              ? (e.splice(a, 3, {
                ...
                (t -= 2))
              : (e.splice(a, 2, { type: 'textord', mode: 'text', loc: m0.range(n, u), text: '--' }),
                (t -= 1));
          }
          (l === "'" || l === '`') &&
            u.text === l &&
            (e.splice(a, 2, { type: 'textord', mode: 'text', loc: m0.range(n, u), text: l + l }),
            (t -= 1));
        }
      }
    }
  ...
  parseSymbol() {
    ...
    if ((this.consume(), l))
      for (var b = 0; b < l[0].length; b++) {
        var y = l[0][b];
        if (!mt[y]) throw new S("Unknown accent ' " + y + "'", e);
        var x = mt[y][this.mode] || mt[y].text;
...
$e.endOfExpression = new Set(['}', '\\endgroup', '\\end', '\\right', '&']);
var Pt = function (e, t) {
...
var p4 = function (e, t) {
  ...
  y4 = '0.16.44',
  x4 = { Span: ae, Anchor: Ie, SymbolNode: d0, SvgNode: B0, PathNode: L0, LineNode: vt },
  w4 = {
    version: y4,
    render: S1,
    renderToString: p4,
...
export {
  ...
  b4 as __renderToHTMLTree,
  oa as __setFontMetrics,
  w4 as default,
  S1 as render,
  p4 as renderToString,
  y4 as version,
};
