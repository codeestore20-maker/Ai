...
import { F as Ce } from './index-C4ykDyek.js';
import { t as Ge } from './index-B07VoX3S.js';
import { u as V } from './index-lGs56uop.js';
import { u as U, b as Y, d as Xe } from './store-I8paDSMM.js';
import { u as Te } from './store-2_FS7oYO.js';
import { B as ge } from './Block-BiiCaTlV.js';
import { b as pe } from './SortableList-DHVIGREt.js';
import {
  b5 as be,
  $ as re,
  cW as me,
...
import { a as tr } from './imperative-B-AzY3pC.js';
import { L as he } from './index-Dg-2tPEz.js';
import { u as or } from './useAppOrigin-Bqb5nk4d.js';
import { d as ye } from './downloadFile-DYbfnmZ_.js';
import { M as nr } from './Modal-BOLB10DT.js';
import { R as Ie } from './Table-DuZTR643.js';
import { I as sr } from './index-vHLvwros.js';
import { S as Fe } from './index-BkwR-xvn.js';
const ar = () => {
    const e = We(),
      n = Oe(),
      h = e.id || null,
  ...
  X = async (e) => {
    ...
    try {
      const { mutate: c } = await ve(
          async () => {
            const { mutate: l } = await import('./index-wqF_YeCD.js').then((f) => f.kE);
            return { mutate: l };
          },
      ...
      async (d) => {
        ...
        try {
          ...
          const { mutate: r } = await ve(
              async () => {
                const { mutate: y } = await import('./index-wqF_YeCD.js').then((L) => L.kE);
                return { mutate: y };
              },
              __vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7, 8]),
            ),
