...
import { I as U, a as H } from './index-CzIxmgzL.js';
import { j as p } from '../vendor/vendor-motion-Dbb9VQJo.js';
import { _ as D, dw as Z } from './index-NXWXCubP.js';
import { a as L } from './store-DPVFoUA8.js';
var h = 'Notion',
  X = 0.7,
  Y = 0.3,
  V = '#fff',
...
`,
              ...
              const { message: m } = await D(
                async () => {
                  const { message: s } = await import('./index-B7kSaMsB.js');
                  return { message: s };
                },
                __vite__mapDeps([
