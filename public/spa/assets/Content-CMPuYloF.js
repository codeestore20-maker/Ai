...
import { i as g, F as e } from './index-NXWXCubP.js';
import { r as u } from '../vendor/vendor-emotion-DdM-9MtU.js';
import { t as f } from './index-DaaCQ1_i.js';
import { A as h } from './AgentSelectionEmpty-DGPBYHK7.js';
import { S as x } from './NavItem-DzbtAjUo.js';
import { i as s } from './index-4ACezDLV.js';
import { h as A } from './selectors-3paDlMAr.js';
import { G as S, A as j } from './index-DmVYTRkA.js';
...
const w = u.memo(({ searchKeyword: n }) => {
  const i = n.trim(),
    r = i.length > 0,
    [a] = s((o) => [o.useSearchAgents]),
    { data: m, isLoading: d } = a(r ? i : void 0),
    c = s(A.ungroupedAgents, g),
    p = r ? m || [] : c,
    l = p.length;
  return r && (d || !m)
    ? t.jsx(e, { gap: 1, paddingBlock: 1, paddingInline: 4, children: t.jsx(x, { rows: 5 }) })
    : l === 0
      ? t.jsx(h, { search: r })
      : t.jsx(f, {
          ...
          children: p.map((o) =>
            t.jsx(
              e,
              {
                paddingBlock: 1,
                paddingInline: 4,
                children: o.type === 'group' ? t.jsx(S, { item: o }) : t.jsx(j, { item: o }),
              },
              o.id,
            ),
          ),
...
w.displayName = 'AllAgentsDrawerContent';
export { w as default };
