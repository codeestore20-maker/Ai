import { g as Vt } from './chunk-55IACEB6-CwkWFNk8.js';
import { s as Mt } from './chunk-KX2RTZJC-DTbQz4uU.js';
import {
  _ as u,
  b as Bt,
  a as Ft,
...
import { c as Ht } from './channel--5rCQMgh.js';
...
var _t = (function () {
  var s = u(function (R, n, a, c) {
    ...
    ut = {
      ...
      performAction: u(function (n, a, c, r, p, t, j) {
        var e = t.length - 1;
        switch (p) {
          case 1:
            break;
      ...
      table: [
        ...
        { 16: 48, 40: O, 41: N },
        s(i, [2, 4]),
        { 11: 49, 40: S, 48: T, 50: I, 51: M, 52: B },
        { 16: 50, 40: O, 41: N },
        { 18: 51, 19: [1, 52], 53: 53, 54: 54, 58: Y },
        { 11: 56, 40: S, 48: T, 50: I, 51: M, 52: B },
        ...
        { 58: [2, 65] },
        { 21: [1, 78] },
        { 63: 79, 65: nt, 66: at, 67: ct, 68: lt, 69: ot },
        s(gt, [2, 77]),
        s(gt, [2, 78]),
        { 6: bt, 10: mt, 39: 80, 42: Et, 47: kt },
        { 40: [1, 85], 41: [1, 86] },
        ...
        s(v, [2, 53]),
        s(i, [2, 41], { 42: A }),
        { 6: bt, 10: mt, 39: 88, 42: Et, 47: kt },
        { 14: 89, 40: q, 50: H, 72: J },
        { 16: 93, 40: O, 41: N },
        { 11: 94, 40: S, 48: T, 50: I, 51: M, 52: B },
        { 18: 95, 19: [1, 96], 53: 53, 54: 54, 58: Y },
        s(i, [2, 12]),
        { 19: [2, 60] },
        s(Z, [2, 61], { 56: 97, 57: 98, 59: 99, 61: Tt, 62: Ot }),
        s([19, 58, 61, 62], [2, 66]),
        ...
        { 19: [1, 108] },
        s(i, [2, 15]),
        s(Z, [2, 62], { 57: 109, 60: [1, 110], 62: Ot }),
        s(Z, [2, 63]),
        s(ht, [2, 67]),
        s(Z, [2, 70]),
        s(ht, [2, 69]),
        ...
        { 14: 114, 40: q, 50: H, 72: J },
        { 16: 115, 40: O, 41: N },
        { 14: 116, 40: q, 50: H, 72: J },
        s(i, [2, 13]),
        s(Z, [2, 64]),
        { 59: 117, 61: Tt },
        { 19: [1, 118] },
      ...
      parse: u(function (n) {
        ...
        function Rt() {
          ...
          return (
            (b = r.pop() || f.lex() || At),
            typeof b != 'number' &&
              (b instanceof Array && ((r = b), (b = r.pop())), (b = a.symbols_[b] || b)),
            b
          );
        }
        u(Rt, 'lex');
        for (var g, C, m, ft, D = {}, et, k, It, st; ; ) {
          if (
            ...
            this.defaultActions[C]
              ? (m = this.defaultActions[C])
              : ((g === null || typeof g > 'u') && (g = Rt()), (m = j[C] && j[C][g])),
...
Expecting ` +
              ...
              : (yt =
                  ...
                  (tt + 1) +
                  ': Unexpected ' +
                  (g == At ? 'end of input' : "'" + (this.terminals_[g] || g) + "'")),
              this.parseError(yt, {
                text: f.match,
          ...
          if (m[0] instanceof Array && m.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + C + ', token: ' + g,
            );
          switch (m[0]) {
            case 1:
              (c.push(g),
            ...
            case 2:
              if (
                ...
                Lt && (D._$.range = [t[t.length - (k || 1)].range[0], t[t.length - 1].range[1]]),
                (ft = this.performAction.apply(D, [e, Nt, tt, x.yy, m[1], p, t].concat(Dt))),
                typeof ft < 'u')
              )
                return ft;
              (k &&
                ((c = c.slice(0, -1 * k * 2)), (p = p.slice(0, -1 * k)), (t = t.slice(0, -1 * k))),
                c.push(this.productions_[m[1]][0]),
                p.push(D.$),
                t.push(D._$),
                (It = j[c[c.length - 2]][c[c.length - 1]]),
                c.push(It));
              break;
            case 3:
              return !0;
...
` +
        ...
        next: u(function () {
          ...
          for (var p = this._currentRules(), t = 0; t < p.length; t++)
            if (
              ((c = this._input.match(this.rules[p[t]])), c && (!a || c[0].length > a[0].length))
            ) {
...
var Jt = _t,
    ...
    ((w = class {
      constructor() {
        ((this.entities = new Map()),
          ...
          (this.setAccTitle = Bt),
          (this.getAccTitle = Ft),
          (this.setAccDescription = Yt),
          (this.getAccDescription = Pt),
          (this.setDiagramTitle = zt),
          (this.getDiagramTitle = Gt),
          (this.getConfig = u(() => it().er, 'getConfig')),
          this.clear(),
      ...
      addEntity(i, l = '') {
        return (
          this.entities.has(i)
            ? !this.entities.get(i)?.alias &&
              l &&
              ((this.entities.get(i).alias = l), L.info(`Add alias '${l}' to entity '${i}'`))
            : (this.entities.set(i, {
      ...
      addAttributes(i, l) {
        ...
        for (o = l.length - 1; o >= 0; o--)
          (l[o].keys || (l[o].keys = []),
            l[o].comment || (l[o].comment = ''),
            d.attributes.push(l[o]),
            L.debug('Added attribute ', l[o].name));
      }
      addRelationship(i, l, d, o) {
        const h = this.entities.get(i),
          y = this.entities.get(d);
        if (!h || !y) return;
        const _ = { entityA: h.id, roleA: l, entityB: y.id, relSpec: o };
      ...
      getCompiledStyles(i) {
        ...
        for (const d of i) {
          ...
          (o?.styles && (l = [...l, ...(o.styles ?? [])].map((h) => h.trim())),
            o?.textStyles && (l = [...l, ...(o.textStyles ?? [])].map((h) => h.trim())));
        }
        return l;
      }
      addCssStyles(i, l) {
        for (const d of i) {
          ...
          if (!l || !o) return;
          for (const h of l) o.cssStyles.push(h);
        }
      }
      addClass(i, l) {
        i.forEach((d) => {
      ...
      setClass(i, l) {
        for (const d of i) {
          const o = this.entities.get(d);
          if (o) for (const h of l) o.cssClasses += ' ' + h;
        }
      }
      clear() {
        ((this.entities = new Map()), (this.classes = new Map()), (this.relationships = []), Kt());
      }
      getData() {
        const i = [],
          l = [],
        ...
        for (const h of this.relationships) {
          const y = {
            id: Ut(h.entityA, h.entityB, { prefix: 'id', counter: o++ }),
            type: 'normal',
            curve: 'basis',
            start: h.entityA,
            end: h.entityB,
  ...
  xt = {};
jt(xt, { draw: () => te });
var te = u(async function (s, i, l, d) {
    (L.info('REF0:'), L.info('Drawing er diagram (unified)', i));
    const { securityLevel: o, er: h, layout: y } = it(),
      _ = d.db.getData(),
      E = Vt(i, o);
    ((_.type = d.type),
      (_.layoutAlgorithm = Wt(y)),
      (_.config.flowchart.nodeSpacing = h?.nodeSpacing || 140),
      (_.config.flowchart.rankSpacing = h?.rankSpacing || 80),
    ...
    Array.from(V).length > 0 &&
      V.each(function () {
        const S = Xt(this),
          Q = S.attr('id').replace('-background', ''),
          T = E.select(`#${CSS.escape(Q)}`);
        if (!T.empty()) {
    ...
    const W = 8;
    (qt.insertTitle(E, 'erDiagramTitleText', h?.titleTopMargin ?? 25, d.db.getDiagramTitle()),
