...
import { p as _ } from './chunk-4BX2VUAB-BeN7F7vo.js';
import { p as N } from './treemap-KZPCXAKY-DVXiEiew.js';
...
var L = E.packet,
  ...
  Y = m((e, t) => {
    ...
    for (let { start: a, end: s, bits: d, label: c } of e.blocks) {
      ...
      for (
        ...
        const [p, i] = G({ start: a, end: s, bits: d, label: c }, n, l);
        if ((o.push(p), p.end + 1 === n * l && (t.pushWord(o), (o = []), n++), !i)) break;
  ...
  H = m((e, t, r, o) => {
    const n = o.db,
      l = n.getConfig(),
      { rowHeight: a, paddingY: s, bitWidth: d, bitsPerRow: c } = l,
      p = n.getPacket(),
      i = n.getDiagramTitle(),
      h = a + s,
      g = h * (p.length + 1) - (i ? 0 : a),
      k = d * c + 2,
      f = B(t);
  ...
  I = m(
    (
      ...
      t,
      r,
      { rowHeight: o, paddingX: n, paddingY: l, bitWidth: a, bitsPerRow: s, showBits: d },
    ) => {
      const c = e.append('g'),
        p = r * (o + l) + l;
      for (const i of t) {
        const h = (i.start % s) * a + 1,
          g = (i.end - i.start + 1) * a - n;
        if (
          (c
            .append('rect')
            .attr('x', h)
