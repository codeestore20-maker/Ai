...
import { I as U, a as H } from './index-DZgkT6q2.js';
import { j as p } from '../vendor/vendor-motion-Dbb9VQJo.js';
import { _ as D, dw as Z } from './index-wqF_YeCD.js';
import { a as L } from './store-I8paDSMM.js';
var h = 'Notion',
  X = 0.7,
  Y = 0.3,
  V = '#fff',
...
`,
              ...
              const { message: m } = await D(
                async () => {
                  const { message: s } = await import('./index-1ziTTVCC.js');
                  return { message: s };
                },
                __vite__mapDeps([
