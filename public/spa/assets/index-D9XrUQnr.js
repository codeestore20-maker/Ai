...
import { u as p, c as h } from '../vendor/vendor-motion-Dbb9VQJo.js';
var J = {
  icon: {
    tag: 'svg',
...
const K = (t, a) => e.createElement(w, u({}, t, { ref: a, icon: J })),
  Q = e.forwardRef(K),
  Z = () =>
    e.createElement(
      'svg',
      ...
      e.createElement(
        ...
        e.createElement('circle', { cx: '126.75', cy: '128.1', r: '126', fill: '#E4EBF7' }),
        e.createElement('circle', { cx: '31.55', cy: '130.8', r: '8.3', fill: '#FFF' }),
        ...
        e.createElement('circle', { cx: '204.3', cy: '30', r: '29.5', fill: '#1677ff' }),
        e.createElement('path', {
          fill: '#FFF',
        ...
        e.createElement('path', { fill: '#CC9B6E', d: 'M123.7 128.4H99.2v-.5h24.2l7.2-10.2.4.3z' }),
        e.createElement('path', {
          fill: '#F4D19D',
  ...
  e1 = () =>
    e.createElement(
      ...
      e.createElement(
        ...
        e.createElement('circle', { cx: '201.35', cy: '30.2', r: '29.7', fill: '#FF603B' }),
        e.createElement('path', {
          fill: '#FFF',
        ...
        e.createElement('path', { fill: '#A3B4C6', d: 'M154.1 190.1h70.5v-84.6h-70.5z' }),
        e.createElement('path', {
          fill: '#BFCDDD',
  ...
  t1 = (t) => {
    ...
    return {
      [a]: { 'padding': `${p(t.calc(o).mul(2).equal())} ${p(s)}`, '&-rtl': { direction: 'rtl' } },
      [`${a} ${a}-image`]: { width: t.imageWidth, height: t.imageHeight, margin: 'auto' },
      [`${a} ${a}-icon`]: {
        marginBottom: o,
        textAlign: 'center',
        [`& > ${l}`]: { fontSize: t.iconFontSize },
      },
      [`${a} ${a}-title`]: {
      ...
      [`${a} ${a}-body`]: {
        marginTop: o,
        padding: `${p(o)} ${p(t.calc(c).mul(2.5).equal())}`,
        backgroundColor: t.colorFillAlter,
      },
      [`${a} ${a}-extra`]: {
        'margin': t.extraMargin,
        'textAlign': 'center',
        '& > *': { 'marginInlineEnd': k, '&:last-child': { marginInlineEnd: 0 } },
      },
    };
  },
  a1 = (t) => {
    const { componentCls: a, iconCls: r } = t;
    return {
      [`${a}-success ${a}-icon > ${r}`]: { color: t.resultSuccessIconColor },
      [`${a}-error ${a}-icon > ${r}`]: { color: t.resultErrorIconColor },
      [`${a}-info ${a}-icon > ${r}`]: { color: t.resultInfoIconColor },
      [`${a}-warning ${a}-icon > ${r}`]: { color: t.resultWarningIconColor },
    };
  },
  r1 = (t) => [t1(t), a1(t)],
  l1 = (t) => ({
  ...
  s1 = { success: Y, error: U, info: q, warning: Q },
  E = { 404: Z, 500: e1, 403: c1 },
  f = Object.keys(E),
  o1 = ({ icon: t, status: a, className: r, style: l }) => {
    if (f.includes(`${a}`)) {
      const s = E[a];
      return e.createElement('div', { className: r, style: l }, e.createElement(s, null));
    }
    const c = e.createElement(s1[a]);
    return t === null || t === !1
      ? null
      : e.createElement('div', { className: r, style: l }, t || c);
  },
  i1 = ({ className: t, extra: a, style: r }) =>
    a ? e.createElement('div', { className: t, style: r }, a) : null,
  M = (t) => {
    const {
        prefixCls: a,
        className: r,
      ...
      n = g('result', a),
      [S, x] = n1(n),
      y = h(n, `${n}-${i}`, r, A, l, { [`${n}-rtl`]: D === 'rtl' }, S, x, m.root),
      b = h(`${n}-title`, m.title),
      N = h(`${n}-subtitle`, m.subTitle),
      H = h(`${n}-extra`, m.extra),
      I = h(`${n}-body`, m.body),
      R = h(`${n}-icon`, { [`${n}-image`]: f.includes(`${i}`) }, m.icon),
      T = { ...d.root, ...W, ...k },
      V = X(C, { aria: !0, data: !0 });
    return e.createElement(
      'div',
      { ...V, className: y, style: T },
      e.createElement(o1, { className: R, style: d.icon, status: i, icon: F }),
      e.createElement('div', { className: b, style: d.title }, s),
      c && e.createElement('div', { className: N, style: d.subTitle }, c),
      e.createElement(i1, { className: H, extra: L, style: d.extra }),
      o && e.createElement('div', { className: I, style: d.body }, o),
    );
  };
M.PRESENTED_IMAGE_403 = E[403];
M.PRESENTED_IMAGE_404 = E[404];
M.PRESENTED_IMAGE_500 = E[500];
export { M as R };
