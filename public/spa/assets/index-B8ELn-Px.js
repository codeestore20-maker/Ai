import { _ as X, a as _, b as E, d as k, c as H, n as D } from './index-B67vSqwk.js';
import { S as Q } from './base-80a1f760-B0hjtGv2.js';
import {
  g as W,
  r as F,
  f as Z,
  ...
  E as te,
  c as re,
} from './consoleHook-59e792cb-B4HY-Mzy.js';
...
var ie = Object.create,
  ...
  ae = (t, i, e) =>
    i in t ? T(t, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (t[i] = e),
  P = (t, i) =>
    function () {
      return (i || (0, t[V(t)[0]])((i = { exports: {} }).exports, i), i.exports);
    },
  ce = (t, i, e, r) => {
    if ((i && typeof i == 'object') || typeof i == 'function')
      for (let o of V(i))
        !se.call(t, o) &&
          o !== e &&
          T(t, o, { get: () => i[o], enumerable: !(r = ne(i, o)) || r.enumerable });
    return t;
  },
  j = (t, i, e) => (
    (e = t != null ? ie(oe(t)) : {}),
    ce(!t || !t.__esModule ? T(e, 'default', { value: t, enumerable: !0 }) : e, t)
  ),
  de = (t, i, e) => (ae(t, i + '', e), e),
  R = (t, i, e) => {
    if (!i.has(t)) throw TypeError('Cannot ' + e);
  },
  g = (t, i, e) => (R(t, i, 'read from private field'), e ? e.call(t) : i.get(t)),
  M = (t, i, e) => {
    if (i.has(t)) throw TypeError('Cannot add the same private member more than once');
    i instanceof WeakSet ? i.add(t) : i.set(t, e);
  },
  O = (t, i, e, r) => (R(t, i, 'write to private field'), i.set(t, e), e),
  y = (t, i, e) => (R(t, i, 'access private method'), e),
  z = P({
    '../../node_modules/.pnpm/cuid@2.1.8/node_modules/cuid/lib/pad.js'(t, i) {
      i.exports = function (r, o) {
        var n = '000000000' + r;
        return n.substr(n.length - o);
      };
    },
  }),
  le = P({
    '../../node_modules/.pnpm/cuid@2.1.8/node_modules/cuid/lib/fingerprint.browser.js'(t, i) {
      var e = z(),
        r = typeof window == 'object' ? window : self,
        o = Object.keys(r).length,
        n = navigator.mimeTypes ? navigator.mimeTypes.length : 0,
        s = e((n + navigator.userAgent.length).toString(36) + o.toString(36), 4);
      i.exports = function () {
        return s;
      };
    },
  ...
  ue = P({
    '../../node_modules/.pnpm/cuid@2.1.8/node_modules/cuid/lib/getRandomValue.browser.js'(t, i) {
      var e,
        r =
          (typeof window < 'u' && (window.crypto || window.msCrypto)) ||
  ...
  G = P({
    '../../node_modules/.pnpm/cuid@2.1.8/node_modules/cuid/index.js'(t, i) {
      var e = le(),
        r = z(),
        o = ue(),
        n = 0,
        ...
        d = Math.pow(a, s);
      function l() {
        return r(((o() * d) << 0).toString(a), s);
      }
      function h() {
        return ((n = n < d ? n : 0), n++, n - 1);
      }
      function m() {
        var f = 'c',
          v = new Date().getTime().toString(a),
          b = r(h().toString(a), s),
          c = e(),
          u = l() + l();
        return f + v + b + c + u;
      ...
      ((m.slug = function () {
        var v = new Date().getTime().toString(36),
          b = h().toString(36).slice(-4),
          c = e().slice(0, 1) + e().slice(-1),
          u = l().slice(-2);
        ...
        const e = (r, o) => {
          ((e.state = 'pending'),
            (e.resolve = (n) => {
              ...
              e.result = n;
              const s = (a) => ((e.state = 'fulfilled'), a);
              return r(n instanceof Promise ? n : Promise.resolve(n).then(s));
            }),
            (e.reject = (n) => {
              if (e.state === 'pending')
                return (
                  ...
                  o((e.rejectionReason = n))
                );
            }));
        };
        return e;
      }
      t.createDeferredExecutor = i;
    },
  }),
  he = P({
    '../../node_modules/.pnpm/@open-draft+deferred-promise@2.1.0/node_modules/@open-draft/deferred-promise/build/DeferredPromise.js'(
      ...
      var i = J(),
        e = class extends Promise {
          ...
          reject;
          constructor(r = null) {
            const o = (0, i.createDeferredExecutor)();
            (super((n, s) => {
              (o(n, s), r?.(o.resolve, o.reject));
            }),
              (this.#e = o),
    ...
    '../../node_modules/.pnpm/@open-draft+deferred-promise@2.1.0/node_modules/@open-draft/deferred-promise/build/index.js'(
      ...
      var i =
        ...
        e =
          ...
          function (r, o) {
            for (var n in r)
              n !== 'default' && !Object.prototype.hasOwnProperty.call(o, n) && i(o, r, n);
          };
  ...
  Y = P({
    '../../node_modules/.pnpm/strict-event-emitter@0.4.3/node_modules/strict-event-emitter/lib/MemoryLeakError.js'(
      ...
      var i = class extends Error {
        ...
        constructor(e, r, o) {
          (super(
            `Possible EventEmitter memory leak detected. ${o} ${r.toString()} listeners added. Use emitter.setMaxListeners() to increase limit`,
          ),
            (this.emitter = e),
            (this.type = r),
            (this.count = o),
  ...
  pe = P({
    '../../node_modules/.pnpm/strict-event-emitter@0.4.3/node_modules/strict-event-emitter/lib/Emitter.js'(
        ...
        v = class {
          constructor() {
            (M(this, n),
              ...
              M(this, o, void 0),
              O(this, e, new Map()),
              O(this, r, v.defaultMaxListeners),
              O(this, o, !1));
          }
          ...
          emit(c, ...u) {
            const p = y(this, n, s).call(this, c);
            return (
              p.forEach((I) => {
                I.apply(this, u);
              }),
          ...
          addListener(c, u) {
            y(this, m, f).call(this, 'newListener', c, u);
            const p = y(this, n, s).call(this, c).concat(u);
            if (
              (g(this, e).set(c, p),
              g(this, r) > 0 && this.listenerCount(c) > g(this, r) && !g(this, o))
            ) {
              O(this, o, !0);
              const I = new i.MemoryLeakError(this, c, this.listenerCount(c));
              console.warn(I);
            }
            return this;
          }
          ...
          prependListener(c, u) {
            ...
            if (p.length > 0) {
              const I = [u].concat(p);
              g(this, e).set(c, I);
            } else g(this, e).set(c, p.concat(u));
            return this;
          }
          ...
          removeListener(c, u) {
            ...
            return (
              p.length > 0 &&
                (y(this, a, d).call(this, p, u),
                g(this, e).set(c, p),
                y(this, m, f).call(this, 'removeListener', c, u)),
              this
            );
          }
          off(c, u) {
          ...
          listeners(c) {
            return Array.from(y(this, n, s).call(this, c));
          }
          listenerCount(c) {
            return y(this, n, s).call(this, c).length;
          }
          rawListeners(c) {
      ...
      ((e = new WeakMap()),
        ...
        (d = function (c, u) {
          const p = c.indexOf(u);
          return (p > -1 && c.splice(p, 1), []);
        }),
        (l = new WeakSet()),
        (h = function (c, u) {
          const p = (...I) => {
            (this.removeListener(c, p), u.apply(this, I));
          };
          return p;
        }),
        (m = new WeakSet()),
  ...
  me = P({
    '../../node_modules/.pnpm/strict-event-emitter@0.4.3/node_modules/strict-event-emitter/lib/index.js'(
      ...
      (Object.defineProperty(t, '__esModule', { value: !0 }), e(pe(), t), e(Y(), t));
    },
  }),
  fe = j(G()),
  ve = /(%?)(%([sdjo]))/g;
...
function w(t, ...i) {
  ...
  let e = 0,
    r = t.replace(ve, (o, n, s, a) => {
      const d = i[e],
        l = we(d, a);
      return n ? o : (e++, l);
    });
  return (e < i.length && (r += ` ${i.slice(e).join(' ')}`), (r = r.replace(/%{2,2}/g, '%')), r);
}
var ge = 2;
function ye(t) {
  if (!t.stack) return;
  const i = t.stack.split(`
`);
  (i.splice(1, ge),
    (t.stack = i.join(`
`)));
...
var _e = class extends Error {
  ...
  S = (t, i, ...e) => {
    if (!t) throw new _e(i, ...e);
  };
S.as = (t, i, e, ...r) => {
  if (!i) throw t.prototype.name != null ? new t(w(e, r)) : t(w(e, r));
};
var A = j(U()),
  Ee = window.localStorage.CSB_EMULATOR_DEBUG,
  Pe = '\x1B[0m',
  be = '\x1B[32;1m',
  Se = '\x1B[31m',
  Le = '\x1B[34m',
  ...
  Me = '\x1B[35;1m',
  B = '\x1B[36;1m',
  je = { 'preview': Ie, 'emulator': Me, 'runtime': B, 'bridge': Le, 'runtime:worker': B };
function K(t) {
  return function (e, ...r) {
    if (Ee === 'true') {
      const o = () =>
          e.includes('sender') ? `${be}sender` : e.includes('receiver') ? `${Se}receiver` : '',
        n = e.replace(/\[.+\]:/, '');
      console.debug(`${je[t]}${t}:${o()}${Pe}:${n}`, ...r);
    }
  };
}
var L = K('emulator'),
  Oe = class {
    constructor(t) {
      ...
      const i = new A.DeferredPromise(),
        e = (r) => {
          r.data.type === 'internal/ready' &&
            (L('[message-sender]: runtime is ready'), i.resolve());
        };
      (window.addEventListener('message', e),
        i.then(() => {
          window.removeEventListener('message', e);
        }),
        (this.receiverReadyPromise = i),
        (this.receiverPort.onmessage = (r) => {
          const o = r.data;
          o.type != null &&
            (L('[message-sender]: emitting "%s" event...', o.type, o.payload),
            this.emitter.dispatchEvent(new MessageEvent(o.type, { data: o.payload })));
        }));
    }
    emitter;
    channel;
    ...
    on(t, i, e) {
      (L('[message-sender]: add listener "%s"', t),
        this.emitter.addEventListener(
          t,
          (r) => {
            r instanceof MessageEvent && i(r);
          },
          e,
        ));
    }
    off(t, i, e) {
      this.emitter.removeEventListener(t, i, e);
    }
    async send(t, ...i) {
      const e = new A.DeferredPromise(),
        r = (0, fe.default)(),
        o = i[0] || {};
      (L('[message-sender]: send "%s" (%s)', t, r, o),
        this.receiverPort.postMessage({ type: t, payload: { operationId: r, payload: o } }),
        L('[message-sender]: adding done listener for "%s" (%s)', t, r));
      const n = (a) => {
          const { data: d } = a;
          if (d.operationId === r) {
            const l = d.listenerPayload || {};
            (L('[message-sender]: resolving "%s (%s) promise!', t, r),
              e.resolve({ ...l, operationId: d.operationId }));
          }
        },
        s = (a) => {
          const { data: d } = a;
          d.operationId === r &&
            (L('[message-sender]: rejecting "%s (%s) promise!', t, r), e.reject(d.error));
        };
      return (
        this.on('internal/operation/done', n),
        this.on('internal/operation/failed', s),
        e.finally(() => {
          (this.emitter.removeEventListener('internal/operation/done', n),
            this.emitter.removeEventListener('internal/operation/failed', s));
        })
      );
    }
  },
  ...
  Ce = class {
    ...
    async readFile(t, i) {
      const e = await this.channel.send('fs/readFile', { path: t, encoding: i }).catch((r) => {
        throw new Error(w('Failed to read file at path "%s"', t), { cause: r });
      });
      if (!e) throw new Error('File not found');
      return e.data;
    }
    async writeFile(t, i, e) {
      let r,
        o = !1;
      (typeof e == 'object'
        ? ((r = e.encoding), (o = !!e.recursive))
        : typeof e == 'string' && (r = e),
        await this.channel
          .send('fs/writeFile', { path: t, content: i, encoding: r, recursive: o })
          .catch((n) => {
            throw new Error(w('Failed to write file at path "%s"', t), { cause: n });
          }));
    }
    async readdir(t) {
      const i = await this.channel.send('fs/readdir', { path: t }).catch((e) => {
        throw new Error(w('Failed to read directory at path "%s"', t), { cause: e });
      });
      if (!i) throw new Error('Directory not found');
      return i.data;
    }
    async mkdir(t, i) {
      const e = !!i?.recursive;
    ...
    async stat(t) {
      const i = await this.channel.send('fs/stat', { path: t }).catch((e) => {
        throw new Error(w('Failed to stat file at path "%s"', t), { cause: e });
      });
      if (!i) throw new Error('File not found');
      return i.data;
    }
    async rm(t, i) {
      const { force: e, recursive: r } = i || {};
      await this.channel.send('fs/rm', { path: t, force: e, recursive: r }).catch((o) => {
        throw new Error(w('Failed to remove file at path "%s"', t), { cause: o });
      });
    }
    async watch(t, i, e) {
      const r = (0, ke.default)();
      return (
        await this.channel.send('fs/watch', { watcherId: r, includes: t, excludes: i }),
        this.channel.on('fs/watch-event', ({ data: o }) => {
          if (o.watcherId === r && e) {
            const n = { ...o };
            (delete n.watcherId, e(n));
          }
        }),
  ...
  xe = class {
    constructor(t) {
      ((this.channel = t),
        (this.state = 'running'),
        (this.stdout = new q.Emitter()),
        (this.stderr = new q.Emitter()),
        (this.stdin = {
          write: (i) => {
            if (!this.id)
              throw new Error('Failed to write to stdin, no process is currently running');
            return this.channel.send('shell/stdin', { data: i, workerId: this.id });
          },
        }),
    ...
    forwardStdEvents() {
      this.channel.on('worker/tty', (t) => {
        const { data: i } = t;
        if (i.workerId === this.id)
          switch (i.payload.type) {
            case 'out': {
              this.stdout.emit('data', i.payload.data);
              break;
            }
            case 'err': {
              this.stderr.emit('data', i.payload.data);
              break;
            }
          }
      });
    }
    async runCommand(t, i, e = {}) {
      S(
        !this.id,
        'Failed to run "runCommand" on a ShellProcess: there is already a process running.',
      );
      const r = await this.channel.send('shell/runCommand', { command: t, args: i, options: e });
      return (
        S(
          r,
      ...
      switch (t) {
        ...
        case 'exit': {
          this.channel.on('worker/exit', ({ data: e }) => {
            e.workerId === this.id && i(e.exitCode, e.error);
          });
          return;
        }
      }
    ...
    async kill() {
      (S(
        ...
        (this.state = 'idle'),
        await this.channel.send('shell/exit', { id: this.id }).catch((t) => {
  ...
  Te = class {
    ...
    async waitFor(t, i, e = De) {
      const r = new Ae.DeferredPromise(),
        o = setTimeout(() => {
          r.reject();
        }, e),
        n = await this.channel.send('preview/get/info', t).catch((a) => {
          r.reject(
            new Error(
              w(
        ...
        s = n && i(n);
      return (
        s && r.resolve({ url: n.url, port: n.port, sourceShellId: n.sourceShellId }),
        this.channel.on('preview/port/ready', ({ data: a }) => {
          !s && i(a) && r.resolve({ url: a.url, port: a.port, sourceShellId: a.sourceShellId });
        }),
        r.finally(() => {
          clearTimeout(o);
        })
    ...
    async getByShellId(t, i) {
      return this.waitFor({ sourceShellId: t }, (e) => e.sourceShellId === t, i).catch((e) => {
        throw new Error(w('Failed to get shell by ID "%s"', t), { cause: e });
      });
    }
    async waitForPort(t, i) {
      return this.waitFor({ port: t }, (e) => e.port === t, i).catch((e) => {
        throw new Error(w('Failed to await port %d', t), { cause: e });
      });
    }
  },
  Re = 'https://nodebox-runtime.codesandbox.io',
  C = K('emulator'),
  Ue = class {
    constructor(t) {
      ((this.options = t),
        ...
        (this.url = this.options.runtimeUrl || Re),
        (this.isConnected = !1));
    }
    channel = null;
    isConnected;
    ...
    previewApi = null;
    async connect() {
      const { iframe: t, cdnUrl: i } = this.options;
      ...
      return (
        ...
        await r,
        C('[message-sender]: IFrame loaded...'),
        await this.channel.handshake(),
        C('[message-sender]: Handshake completed...'),
        this.channel.send('connect', { cdnUrl: i }),
    ...
    get fs() {
      return (
        ...
        this.fileSystemApi
          ? this.fileSystemApi
          : ((this.fileSystemApi = new Ce(this.channel)), this.fileSystemApi)
      );
    }
    get shell() {
      return (
    ...
    get preview() {
      return (
        ...
        this.previewApi
          ? this.previewApi
          : ((this.previewApi = new Te(this.channel)), this.previewApi)
      );
    }
  },
  We = 'INJECT_AND_INVOKE',
  Be = 'PREVIEW_LOADED';
function Ne(t, i) {
  return _(this, void 0, void 0, function () {
    ...
    return E(this, function (a) {
      return (
        (e = t.contentWindow),
        D(e, 'Failed to await preview iframe: no content window found'),
        (r = 9e4),
        (o = 20),
        (n = 0),
        [
          2,
          new Promise(function (d, l) {
            var h = function () {
              var m = function () {
                (clearTimeout(s), (n = o), d(), t.removeEventListener('load', m));
              };
              if (n >= o) {
              ...
              (t.setAttribute('src', i),
                (s = setTimeout(function () {
                  (h(), t.removeEventListener('load', m));
                }, r)),
                (n = n + 1),
...
var qe = function (t, i) {
  ((t.style.border = '0'),
    (t.style.width = i.width || '100%'),
    (t.style.height = i.height || '100%'),
    (t.style.overflow = 'hidden'),
    (t.allow = 'cross-origin-isolated'));
};
function He(t) {
  var i = t.scope,
    e = window.history.__proto__,
    r = [],
    o = 0,
    n = function (d) {
      parent.postMessage(
  ...
  function s(d, l) {
    (r.splice(o + 1), r.push({ url: d, state: l }), (o = r.length - 1));
  }
  Object.assign(window.history, {
    go: function (d) {
      ...
      if (l >= 0 && l <= r.length - 1) {
        ...
        var h = r[o],
          m = h.url,
          f = h.state;
        e.replaceState.call(window.history, f, '', m);
        var v = document.location.href;
        (n(v), window.dispatchEvent(new PopStateEvent('popstate', { state: f })));
      }
    },
    back: function () {
      window.history.go(-1);
    ...
    pushState: function (d, l, h) {
      (e.replaceState.call(window.history, d, l, h), s(h, d), n(document.location.href));
    },
    replaceState: function (d, l, h) {
      (e.replaceState.call(window.history, d, l, h),
        (r[o] = { state: d, url: h }),
...
function Ve(t) {
  ...
  function o() {
    ...
    (e !== a &&
      window.parent.postMessage(
        { type: 'resize', height: a, codesandbox: !0, channelId: i.channelId },
        '*',
      ),
      (e = a));
  }
  ...
  (s.observe(document, { attributes: !0, childList: !0, subtree: !0 }), setInterval(o, 300));
}
var ze = [
  ...
  Ge = function (t, i) {
    ze.forEach(function (e) {
      var r,
        o = e.code,
        n = e.id,
        s = { uid: n, type: We, code: 'exports.activate = '.concat(o), scope: { channelId: i } };
      (r = t.contentWindow) === null || r === void 0 || r.postMessage(s, '*');
    });
  },
  mn = (function (t) {
    X(i, t);
    function i(e, r, o) {
      o === void 0 && (o = {});
      var n = t.call(this, e, r, k(k({}, o), { bundlerURL: o.bundlerURL })) || this;
      return (
        (n._modulesCache = new Map()),
        (n.messageChannelId = ee()),
        (n._initPromise = null),
        (n.emitter = new te()),
        n.manageIframes(e),
        (n.emulator = new Ue({ iframe: n.emulatorIframe, runtimeUrl: n.options.bundlerURL })),
        n.updateSandbox(r),
        n
      );
    }
    return (
        ...
        return _(this, void 0, void 0, function () {
          ...
          return E(this, function (n) {
            switch (n.label) {
              ...
              case 2:
                return ((r = n.sent().id), [4, this.createPreviewURLFromId(r)]);
              case 3:
                return (n.sent(), [4, this.setLocationURLIntoIFrame()]);
              case 4:
                return (n.sent(), this.dispatchDoneMessage(), [3, 6]);
              case 5:
                return (
                  (o = n.sent()),
                  this.dispatch({
      ...
      (i.prototype.createShellProcessFromTask = function (e) {
        return _(this, void 0, void 0, function () {
          var r,
            o,
            n = this;
                    ...
                    this.emulatorShellProcess.on('progress', function (a) {
                      ...
                      if (a.state === 'command_running' || a.state === 'starting_command') {
                        (n.dispatch({
                          ...
                          data: k(k({}, a), {
                            command: [
                              (d = n.emulatorCommand) === null || d === void 0 ? void 0 : d[0],
                              (l = n.emulatorCommand) === null || l === void 0
                                ? void 0
                                : l[1].join(' '),
                            ].join(' '),
                          }),
                        }),
                          (n.status = 'installing-dependencies'));
                        return;
                      }
                      n.dispatch({ type: 'shell/progress', data: a });
                    }),
                  ]
                );
              case 2:
                return (
                  ...
                  this.emulatorShellProcess.stdout.on('data', function (a) {
                    n.dispatch({ type: 'stdout', payload: { data: a, type: 'out' } });
                  }),
                  this.emulatorShellProcess.stderr.on('data', function (a) {
                    n.dispatch({ type: 'stdout', payload: { data: a, type: 'err' } });
                  }),
                  [4, (o = this.emulatorShellProcess).runCommand.apply(o, this.emulatorCommand)]
                );
              case 3:
                return [2, s.sent()];
            }
      ...
      (i.prototype.createPreviewURLFromId = function (e) {
        var r;
        return _(this, void 0, void 0, function () {
          var o;
          return E(this, function (n) {
              ...
              case 1:
                return (
                  ...
                  (this.iframePreviewUrl =
                    o + ((r = this.options.startRoute) !== null && r !== void 0 ? r : '')),
                  [2]
                );
            }
          });
      ...
      (i.prototype.manageIframes = function (e) {
        var r;
        if (typeof e == 'string') {
          var o = document.querySelector(e);
          (D(o, "The element '".concat(e, "' was not found")),
            (this.iframe = document.createElement('iframe')),
            o?.appendChild(this.iframe));
        } else this.iframe = e;
        (qe(this.iframe, this.options),
          D(this.iframe.parentNode, 'The given iframe does not have a parent.'),
          (this.emulatorIframe = document.createElement('iframe')),
          this.emulatorIframe.classList.add('sp-bridge-frame'),
          (r = this.iframe.parentNode) === null ||
            r === void 0 ||
            r.appendChild(this.emulatorIframe));
      }),
      ...
      (i.prototype.dispatchDoneMessage = function () {
        ((this.status = 'done'),
      ...
      (i.prototype.globalListeners = function () {
        return _(this, void 0, void 0, function () {
          var e = this;
          return E(this, function (r) {
            switch (r.label) {
              case 0:
                return (
                  window.addEventListener('message', function (o) {
                    (o.data.type === Be && Ge(e.iframe, e.messageChannelId),
                      o.data.type === 'urlchange' && o.data.channelId === e.messageChannelId
                        ? e.dispatch({
                            type: 'urlchange',
                            url: o.data.url,
                            back: o.data.back,
                            forward: o.data.forward,
                          })
                        : o.data.channelId === e.messageChannelId && e.dispatch(o.data));
                  }),
                  [
                    4,
                          ...
                          return E(this, function (f) {
                            switch (f.label) {
                              case 0:
                                return o
                                  ? ((n = o),
                                    (s = 'newPath' in n ? n.newPath : 'path' in n ? n.path : ''),
                                    [4, this.emulator.fs.stat(s)])
                                  : [2];
                              case 1:
                                if (((a = f.sent().type), a !== 'file')) return [2, null];
                                f.label = 2;
                              case 2:
                                switch ((f.trys.push([2, 10, , 11]), (d = n.type), d)) {
                                  case 'change':
                                    return [3, 3];
                                  case 'create':
                                    return [3, 3];
                                ...
                                return [3, 9];
                              case 3:
                                return [4, this.emulator.fs.readFile(n.path, 'utf8')];
                              case 4:
                                return (
                                  (l = f.sent()),
                                  this.dispatch({ type: 'fs/change', path: n.path, content: l }),
                                  this._modulesCache.set(n.path, x(l)),
                                  [3, 9]
                                );
                              case 5:
                                return (
                                  this.dispatch({ type: 'fs/remove', path: n.path }),
                                  this._modulesCache.delete(n.path),
                                  [3, 9]
                                );
                              case 6:
                                return (
                                  this.dispatch({ type: 'fs/remove', path: n.oldPath }),
                                  this._modulesCache.delete(n.oldPath),
                                  [4, this.emulator.fs.readFile(n.newPath, 'utf8')]
                                );
                              case 7:
                                return (
                                  (h = f.sent()),
                                  this.dispatch({ type: 'fs/change', path: n.newPath, content: h }),
                                  this._modulesCache.set(n.newPath, x(h)),
                                  [3, 9]
                                );
                              case 8:
                                return [3, 9];
      ...
      (i.prototype.restartShellProcess = function () {
        var e;
        return _(this, void 0, void 0, function () {
          return E(this, function (r) {
            switch (r.label) {
              ...
              case 1:
                return (
                  r.sent(),
                  (e = this.iframe) === null || e === void 0 || e.removeAttribute('attr'),
      ...
      (i.prototype.updateSandbox = function (e) {
        var r = this,
          o,
          n = $(e.files);
        if (
          ((o = this.emulatorShellProcess) === null || o === void 0 ? void 0 : o.state) ===
          'running'
        ) {
          Object.entries(n).forEach(function (s) {
            var a = s[0],
              d = s[1];
            (!r._modulesCache.get(a) || F(d) !== F(r._modulesCache.get(a))) &&
              r.emulator.fs.writeFile(a, d, { recursive: !0 });
          });
          return;
        }
        (this.dispatch({ codesandbox: !0, modules: n, template: e.template, type: 'compile' }),
          Object.entries(n).forEach(function (s) {
            var a = s[0],
              d = s[1];
        ...
        return _(this, void 0, void 0, function () {
          ...
          return E(this, function (s) {
            switch (s.label) {
              ...
              case 4:
                return (
                  (o = (r = this.iframe) === null || r === void 0 ? void 0 : r.contentWindow) ===
                    null ||
                    o === void 0 ||
                    o.postMessage(e, '*'),
                  [3, 8]
              ...
              case 7:
                (this.emitter.dispatch(e), (s.label = 8));
              case 8:
                return [2];
            }
          });
