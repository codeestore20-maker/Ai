...
import { c as y, g as n, F as c, L as f, f as k, aE as v } from './index-NXWXCubP.js';
import { r as p } from '../vendor/vendor-emotion-DdM-9MtU.js';
import { S as x, N as h, a as j } from './index-DmVYTRkA.js';
import { M as b } from './McpIcon-Cnqa4sOi.js';
import { P as S } from './ProviderIcon-Dg9rvCHb.js';
import { S as g } from './SkillsIcon-DjXX_Ijx.js';
import { N as s, i as C } from './NavItem-DzbtAjUo.js';
import { a as N } from './navigation-BncxkyKj.js';
import { D as i } from './index-C67aJrLL.js';
import { bS as B, i as M, o as P } from '../vendor/vendor-icons-BHMUH78i.js';
...
const H = () => {
    const r = N();
    return r === '/community' ? i.Home : r.split('/community/').find(Boolean) || i.Home;
  },
  I = p.memo(() => {
    const r = H(),
      e = y(),
      ...
      u = p.useMemo(
        () => [
          { icon: B, key: i.Home, title: m('tab.home'), url: '/community' },
          { icon: M, key: i.Assistants, title: m('tab.assistant'), url: '/community/agent' },
          { icon: g, key: i.Skills, title: m('tab.skill'), url: '/community/skill' },
          { icon: b, key: i.Mcp, title: 'MCP', url: '/community/mcp' },
          { icon: P, key: i.Models, title: m('tab.model'), url: '/community/model' },
          { icon: S, key: i.Providers, title: m('tab.provider'), url: '/community/provider' },
        ],
        [m],
      );
    return t.jsx(c, {
      ...
      children: u.map((o) => {
        const d = t.jsx(
          s,
          { active: r.startsWith(o.key), icon: o.icon, title: o.title, onClick: o.onClick },
          o.key,
        );
        return o.url
          ? t.jsx(
              f,
              {
                to: o.url,
                onClick: (a) => {
                  C(a) || (a.preventDefault(), o?.onClick?.(), o.url && e(o.url));
                },
                children: t.jsx(s, { active: r.startsWith(o.key), icon: o.icon, title: o.title }),
              },
              o.key,
            )
          : d;
  ...
  L = p.memo(() => {
    ...
    return t.jsxs(t.Fragment, {
      children: [
        t.jsx(x, { breadcrumb: [{ href: '/community', title: r('tab.community') }] }),
        t.jsx(I, {}),
      ],
    });
  }),
  l = p.memo(() => t.jsx(h, { navKey: 'discover', children: t.jsx(j, { header: t.jsx(L, {}) }) }));
l.displayName = 'DisocverSidebar';
const D = k(({ css: r, cssVar: e }) => ({
    mainContainer: r`
    position: relative;
    overflow: hidden;
  ...
  Ur = () =>
    t.jsxs(t.Fragment, {
      children: [
        t.jsx(l, {}),
        t.jsx(c, { className: D.mainContainer, flex: 1, height: '100%', children: t.jsx(v, {}) }),
      ],
    });
