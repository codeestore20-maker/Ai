...
import { M as p, A as e } from './providerConfig-B8LLUHQ4.js';
import { F as a } from './FormInput-CBTw9hAf.js';
import { F as s } from './FormPassword-bx6ZkU2-.js';
import { P as n, S as t } from './index-CfiK1ayV.js';
import { u as d } from './store-Zk6c4erU.js';
import { K as m, L as l, a as u } from './index-D4Bg4BdT.js';
import { g as c } from './index-NXWXCubP.js';
...
const P = p.AzureAI,
  v = () => {
    const { t: r } = c('modelProvider'),
      i = d(f.isAiProviderConfigLoading(P));
    return {
      ...e,
      apiKeyItems: [
        {
          children: i
            ...
            : o.jsx(s, {
                ...
                placeholder: r('azureai.token.placeholder'),
              }),
          desc: r('azureai.token.desc'),
          label: r('azureai.token.title'),
          name: [m, l],
        },
        {
          children: i
            ? o.jsx(t, {})
            : o.jsx(a, { allowClear: !0, placeholder: r('azureai.endpoint.placeholder') }),
          desc: r('azureai.endpoint.desc'),
          label: r('azureai.endpoint.title'),
          name: [m, u],
        },
      ],
    };
