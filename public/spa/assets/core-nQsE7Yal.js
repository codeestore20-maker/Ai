import { i as le } from './browser-DjXL3BqG.js';
    ...
    G ||
      ...
      (L.read = function (i, e, t, n, r) {
        var a,
          ...
          w = i[e + x];
        for (
          x += y, a = w & ((1 << -f) - 1), w >>= -f, f += o;
          f > 0;
          a = a * 256 + i[e + x], x += y, f -= 8
        );
        for (
          s = a & ((1 << -f) - 1), a >>= -f, f += n;
          f > 0;
          s = s * 256 + i[e + x], x += y, f -= 8
        );
        if (a === 0) a = 1 - c;
        else {
          if (a === m) return s ? NaN : (w ? -1 : 1) * (1 / 0);
          ((s = s + Math.pow(2, n)), (a = a - c));
        }
        return (w ? -1 : 1) * s * Math.pow(2, a - n);
      }),
      (L.write = function (i, e, t, n, r, a) {
        var s,
          o,
          m,
          c = a * 8 - r - 1,
          f = (1 << c) - 1,
          x = f >> 1,
          y = r === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0,
          w = n ? 0 : a - 1,
          N = n ? 1 : -1,
          he = e < 0 || (e === 0 && 1 / e < 0) ? 1 : 0;
        for (
          e = Math.abs(e),
            isNaN(e) || e === 1 / 0
              ? ((o = isNaN(e) ? 1 : 0), (s = f))
              : ((s = Math.floor(Math.log(e) / Math.LN2)),
                e * (m = Math.pow(2, -s)) < 1 && (s--, (m *= 2)),
                s + x >= 1 ? (e += y / m) : (e += y * Math.pow(2, 1 - x)),
                e * m >= 2 && (s++, (m /= 2)),
                s + x >= f
                  ? ((o = 0), (s = f))
                  : s + x >= 1
                    ? ((o = (e * m - 1) * Math.pow(2, r)), (s = s + x))
                    : ((o = e * Math.pow(2, x - 1) * Math.pow(2, r)), (s = 0)));
          r >= 8;
          i[t + w] = o & 255, w += N, o /= 256, r -= 8
        );
        for (s = (s << r) | o, c += r; c > 0; i[t + w] = s & 255, w += N, s /= 256, c -= 8);
        i[t + w - N] |= he * 128;
      })),
    L
  );
...
for (const [i, e] of Object.entries(me));
let O;
function ge() {
  if (!(typeof globalThis.TextDecoder > 'u')) return O ?? (O = new globalThis.TextDecoder('utf-8'));
}
const A = 32 * 1024,
  b = 65533;
function we(i, e = 'utf-8') {
  switch (e.toLowerCase()) {
    case 'utf-8':
    case 'utf8': {
      const t = ge();
      return t ? t.decode(i) : ye(i);
    }
    case 'utf-16le':
      return be(i);
    case 'us-ascii':
...
function W(i, e) {
  e.length !== 0 && (i.push(String.fromCharCode.apply(null, e)), (e.length = 0));
}
function h(i, e, t) {
  (e.push(t), e.length >= A && W(i, e));
}
function ke(i, e, t) {
  if (t <= 65535) {
    h(i, e, t);
  ...
  ((t -= 65536), h(i, e, 55296 + (t >> 10)), h(i, e, 56320 + (t & 1023)));
}
function ye(i) {
  const e = [],
    t = [];
  let n = 0;
  for (i.length >= 3 && i[0] === 239 && i[1] === 187 && i[2] === 191 && (n = 3); n < i.length; ) {
    const r = i[n];
    if (r <= 127) {
      (h(e, t, r), n++);
      continue;
    ...
    const c = ((r & 7) << 18) | ((a & 63) << 12) | ((s & 63) << 6) | (o & 63);
    (ke(e, t, c), (n += 4));
  }
  return (W(e, t), e.join(''));
}
function be(i) {
  ...
  for (; r + 1 < n; ) {
    const a = i[r] | (i[r + 1] << 8);
    if (((r += 2), a >= 55296 && a <= 56319)) {
      if (r + 1 < n) {
        const s = i[r] | (i[r + 1] << 8);
        s >= 56320 && s <= 57343 ? (h(e, t, a), h(e, t, s), (r += 2)) : h(e, t, b);
      } else h(e, t, b);
      continue;
    }
    if (a >= 56320 && a <= 57343) {
  ...
  return (r < n && h(e, t, b), W(e, t), e.join(''));
}
function Se(i) {
  const e = [];
  for (let t = 0; t < i.length; t += A) {
    const n = Math.min(i.length, t + A),
      r = new Array(n - t);
    for (let a = t, s = 0; a < n; a++, s++) r[s] = i[a] & 127;
    e.push(String.fromCharCode.apply(null, r));
  }
  return e.join('');
}
function ve(i) {
  ...
  for (let t = 0; t < i.length; t += A) {
    const n = Math.min(i.length, t + A),
      r = new Array(n - t);
    for (let a = t, s = 0; a < n; a++, s++) r[s] = i[a];
    e.push(String.fromCharCode.apply(null, r));
  }
  return e.join('');
}
function Fe(i) {
  ...
  for (let n = 0; n < i.length; n++) {
    const r = i[n],
      a = r >= 128 && r <= 159 ? me[r] : void 0;
    ((t += a ?? String.fromCharCode(r)), t.length >= A && (e.push(t), (t = '')));
  }
...
class B {
  ...
  get(e, t = 0) {
    ...
    return we(n, this.encoding);
  }
}
const Te = 'End-Of-Stream';
class l extends Error {
  constructor() {
    (super(Te), (this.name = 'EndOfStreamError'));
  }
}
...
class xe {
  ...
  async read(e, t = !1) {
    ...
    if (
      (this.endOfStream || (n += await this.readRemainderFromStream(e.subarray(n), t)),
      n === 0 && !t)
    )
      throw new l();
    return n;
  ...
  readFromPeekBuffer(e) {
    ...
    for (; this.peekQueue.length > 0 && t > 0; ) {
      ...
      (e.set(r.subarray(0, a), n),
        (n += a),
        (t -= a),
        a < r.length && this.peekQueue.push(r.subarray(a)));
    }
    return n;
  }
  async readRemainderFromStream(e, t) {
    ...
    for (; n < e.length && !this.endOfStream; ) {
      if (this.interrupted) throw new Ce();
      const r = await this.readFromStream(e.subarray(n), t);
      if (r === 0) break;
      n += r;
    }
    if (!t && n < e.length) throw new l();
    return n;
  }
}
class ze extends xe {
...
class Q extends xe {
  ...
  async readFromStream(e, t) {
    ...
    if (!t && n === 0 && this.endOfStream) throw new l();
    return n;
  }
  abort() {
...
function Ie(i) {
  try {
    ...
    return e instanceof ReadableStreamDefaultReader ? new Q(e) : new Ae(e);
  } catch (e) {
    if (e instanceof TypeError) return new Q(i.getReader());
    throw e;
  }
}
class $ {
  ...
  async readToken(e, t = this.position) {
    ...
    if ((await this.readBuffer(n, { position: t })) < e.len) throw new l();
    return e.get(n, 0);
  }
  async peekToken(e, t = this.position) {
    const n = new Uint8Array(e.len);
    if ((await this.peekBuffer(n, { position: t })) < e.len) throw new l();
    return e.get(n, 0);
  }
  async readNumber(e) {
    if ((await this.readBuffer(this.numBuffer, { length: e.len })) < e.len) throw new l();
    return e.get(this.numBuffer, 0);
  }
  async peekNumber(e) {
    if ((await this.peekBuffer(this.numBuffer, { length: e.len })) < e.len) throw new l();
    return e.get(this.numBuffer, 0);
  }
  async ignore(e) {
...
class Re extends $ {
  ...
  async readBuffer(e, t) {
    ...
    if (((this.position += a), (!t || !t.mayBeLess) && a < n.length)) throw new l();
    return a;
  }
  async peekBuffer(e, t) {
    ...
    if (n.position) {
      ...
      if (a > 0) {
        ...
        return (
          (r = await this.peekBuffer(s, { mayBeLess: n.mayBeLess })),
          e.set(s.subarray(a)),
          r - a
        );
      }
    ...
    if (n.length > 0) {
      try {
        ...
        if (t?.mayBeLess && a instanceof l) return 0;
        throw a;
      }
      if (!n.mayBeLess && r < n.length) throw new l();
    }
    return r;
  }
  async ignore(e) {
    if (e < 0) throw new RangeError('ignore length must be ≥ 0 bytes');
    const t = Math.min(Me, e),
      n = new Uint8Array(t);
    let r = 0;
    for (; r < e; ) {
      const a = e - r,
        s = await this.readBuffer(n, { length: Math.min(t, a) });
      if (s < 0) return s;
      r += s;
    }
    return r;
...
class Oe extends $ {
  constructor(e, t) {
    (super(t),
      (this.blob = e),
      (this.fileInfo = { ...(t?.fileInfo ?? {}), size: e.size, mimeType: e.type }));
  }
  async readBuffer(e, t) {
    t?.position && (this.position = t.position);
    const n = await this.peekBuffer(e, t);
...
const z = {
  ...
  K = {
    get(i) {
      return {
        signature: u.get(i, 0),
        compressedSize: u.get(i, 8),
        uncompressedSize: u.get(i, 12),
      };
    },
    len: 16,
  },
  Ne = {
    get(i) {
      ...
      return {
        signature: u.get(i, 0),
        minVersion: p.get(i, 4),
        dataDescriptor: !!(e & 8),
        compressedMethod: p.get(i, 8),
        compressedSize: u.get(i, 18),
        uncompressedSize: u.get(i, 22),
        filenameLength: p.get(i, 26),
        extraFieldLength: p.get(i, 28),
        filename: null,
      };
    },
    len: 30,
  ...
  Ze = {
    get(i) {
      return {
        signature: u.get(i, 0),
        nrOfThisDisk: p.get(i, 4),
        nrOfThisDiskWithTheStart: p.get(i, 6),
        nrOfEntriesOnThisDisk: p.get(i, 8),
        nrOfEntriesOfSize: p.get(i, 10),
        sizeOfCd: u.get(i, 12),
        offsetOfStartOfCd: u.get(i, 16),
        zipFileCommentLength: p.get(i, 20),
      };
    },
    len: 22,
  },
  _e = {
    get(i) {
      ...
      return {
        signature: u.get(i, 0),
        minVersion: p.get(i, 6),
        dataDescriptor: !!(e & 8),
        compressedMethod: p.get(i, 10),
        compressedSize: u.get(i, 20),
        uncompressedSize: u.get(i, 24),
        filenameLength: p.get(i, 28),
        extraFieldLength: p.get(i, 30),
        fileCommentLength: p.get(i, 32),
        relativeOffsetOfLocalHeader: u.get(i, 42),
        filename: null,
      };
    },
    len: 46,
...
function pe(i) {
  const e = new Uint8Array(u.len);
  return (u.put(e, 0, i), e);
}
const S = le('tokenizer:inflate'),
  Z = 256 * 1024,
  qe = pe(z.DataDescriptor),
  P = pe(z.EndOfCentralDirectory);
class R {
  constructor(e) {
    ((this.tokenizer = e), (this.syncBuffer = new Uint8Array(Z)));
  }
  async isZip() {
    return (await this.peekSignature()) === z.LocalFileHeader;
  }
  peekSignature() {
    return this.tokenizer.peekToken(u);
  }
  async findEndOfCentralDirectoryLocator() {
    ...
    for (let r = n.length - 4; r >= 0; r--)
      if (n[r] === P[0] && n[r + 1] === P[1] && n[r + 2] === P[2] && n[r + 3] === P[3])
  ...
  async readCentralDirectory() {
    ...
    if (t > 0) {
      ...
      const n = await this.tokenizer.readToken(Ze, t),
        r = [];
      this.tokenizer.setPosition(n.offsetOfStartOfCd);
      for (let a = 0; a < n.nrOfEntriesOfSize; ++a) {
        const s = await this.tokenizer.readToken(_e);
        if (s.signature !== z.CentralFileHeader)
          throw new Error('Expected Central-File-Header signature');
        ((s.filename = await this.tokenizer.readToken(new B(s.filenameLength, 'utf-8'))),
          await this.tokenizer.ignore(s.extraFieldLength),
          await this.tokenizer.ignore(s.fileCommentLength),
          r.push(s),
          S(`Add central-directory file-entry: n=${a + 1}/${r.length}: filename=${r[a].filename}`));
      }
  ...
  async unzip(e) {
    ...
    do {
      ...
      if (
        ...
        r.dataDescriptor && r.compressedSize === 0)
      ) {
        const o = [];
        let m = Z;
        ...
        let c = -1;
        for (; c < 0 && m === Z; ) {
          ((m = await this.tokenizer.peekBuffer(this.syncBuffer, { mayBeLess: !0 })),
            (c = We(this.syncBuffer.subarray(0, m), qe)));
          const f = c >= 0 ? c : m;
          if (a.handler) {
            const x = new Uint8Array(f);
            (await this.tokenizer.readBuffer(x), o.push(x));
          } else await this.tokenizer.ignore(f);
        }
        (S(`Found data-descriptor-signature at pos=${this.tokenizer.position}`),
          a.handler && (await this.inflate(r, $e(o), a.handler)));
      } else
        a.handler
          ? (S(`Reading compressed-file-data: ${r.compressedSize} bytes`),
            (s = new Uint8Array(r.compressedSize)),
            await this.tokenizer.readBuffer(s),
            await this.inflate(r, s, a.handler))
          : (S(`Ignoring compressed-file-data: ${r.compressedSize} bytes`),
            await this.tokenizer.ignore(r.compressedSize));
      if (
        (S(`Reading data-descriptor at pos=${this.tokenizer.position}`),
        r.dataDescriptor && (await this.tokenizer.readToken(K)).signature !== 134695760)
      )
        throw new Error(
          `Expected data-descriptor-signature at position ${this.tokenizer.position - K.len}`,
        );
    } while (!n);
  }
    ...
    for (const n of e) {
      ...
      if (r.handler) {
        ...
        if (a) {
          ...
          (await this.tokenizer.readBuffer(s), await this.inflate(a, s, r.handler));
        }
      }
      if (r.stop) break;
    }
  ...
  async inflate(e, t, n) {
    ...
    const r = await R.decompressDeflateRaw(t);
    return n(r);
  }
  static async decompressDeflateRaw(e) {
    const t = new ReadableStream({
      ...
      r = t.pipeThrough(n);
    try {
      const s = await new Response(r).arrayBuffer();
      return new Uint8Array(s);
    } catch (a) {
      const s =
        a instanceof Error
          ? `Failed to deflate ZIP entry: ${a.message}`
          : 'Unknown decompression error in ZIP entry';
      throw new TypeError(s);
    }
  }
  async readLocalFileHeader() {
    const e = await this.tokenizer.peekToken(u);
    if (e === z.LocalFileHeader) {
      const t = await this.tokenizer.readToken(Ne);
      return ((t.filename = await this.tokenizer.readToken(new B(t.filenameLength, 'utf-8'))), t);
    }
    if (e === z.CentralFileHeader) return !1;
...
function $e(i) {
  const e = i.reduce((r, a) => r + a.length, 0),
    t = new Uint8Array(e);
  let n = 0;
  for (const r of i) (t.set(r, n), (n += r.length));
  return t;
}
class Ve {
  constructor(e) {
...
function He(i, e = 0) {
  ...
  let n = 256;
  for (let r = e; r < e + 148; r++) n += i[r];
  for (let r = e + 156; r < e + 512; r++) n += i[r];
  return t === n;
}
const Qe = {
  ...
  ot = j,
  se = k,
  ct = new Set(['Unexpected signature', 'Encrypted ZIP', 'Expected Central-File-Header signature']),
  ft = [
  ...
  mt = new Set(['Z_BUF_ERROR', 'Z_DATA_ERROR', 'ERR_INVALID_STATE']);
class D extends Error {}
function xt(i) {
  const e = i?.streamReader;
  if (e?.constructor?.name !== 'WebStreamByobReader') return i;
  const { reader: t } = e,
    n = async () => {
      (await t.cancel(), t.releaseLock());
    };
  return (
    (e.close = n),
    (e.abort = async () => {
      ((e.interrupted = !0), await n());
    }),
    i
  );
}
function V(i, e, t) {
  if (!Number.isFinite(i) || i < 0 || i > e)
    throw new D(`${t} has invalid size ${i} (maximum ${e} bytes)`);
  return i;
}
async function E(i, e, { maximumLength: t = k, reason: n = 'skip' } = {}) {
  const r = V(e, t, n);
  await i.ignore(r);
}
async function q(i, e, t, { maximumLength: n = e.length, reason: r = 'read' } = {}) {
  const a = e.length,
    s = V(a, n, r);
  return i.readBuffer(e, { ...t, length: s });
}
async function pt(i, { maximumLength: e = F } = {}) {
  ...
  try {
    for (;;) {
      ...
      if (c) break;
      if (((s += f.length), s > e))
        throw (await r.cancel(), new Error(`ZIP entry decompressed data exceeds ${e} bytes`));
      a.push(f);
    }
  } finally {
    r.releaseLock();
  ...
  let m = 0;
  for (const c of a) (o.set(c, m), (m += c.length));
  return o;
}
const ue = 134695760,
  U = 16,
  ut = U - 1;
function ht(i, e) {
  if (i.length < U) return -1;
  const t = i.length - U;
  for (let n = 0; n <= t; n++) if (u.get(i, n) === ue && u.get(i, n + 8) === e + n) return n;
  return -1;
}
function lt(i) {
  return (i.codePointAt(0) & 32) !== 0;
}
function dt(i, e) {
...
async function gt(i, { shouldBuffer: e, maximumLength: t = F } = {}) {
  const { syncBuffer: n } = i,
    { length: r } = n,
    a = [];
  let s = 0;
  for (;;) {
    const o = await i.tokenizer.peekBuffer(n, { mayBeLess: !0 }),
      m = ht(n.subarray(0, o), s),
      c = m >= 0 ? 0 : o === r ? Math.min(ut, o - 1) : 0,
      f = m >= 0 ? m : o - c;
    if (f === 0) break;
    if (((s += f), s > t)) throw new Error(`ZIP entry compressed data exceeds ${t} bytes`);
    if (e) {
      const x = new Uint8Array(f);
      (await i.tokenizer.readBuffer(x), a.push(x));
    } else await i.tokenizer.ignore(f);
    if (m >= 0) break;
  }
  if ((d(i.tokenizer) || (i.knownSizeDescriptorScannedBytes += s), !!e)) return dt(a, s);
}
function wt(i, e) {
  return d(i.tokenizer)
    ? Math.max(0, k - (i.tokenizer.position - e))
    : Math.max(0, F - i.knownSizeDescriptorScannedBytes);
}
async function kt(i, e, { shouldBuffer: t, maximumDescriptorLength: n = F } = {}) {
  if (e.dataDescriptor && e.compressedSize === 0)
    return gt(i, { shouldBuffer: t, maximumLength: n });
  if (!t) {
    await E(i.tokenizer, e.compressedSize, {
      maximumLength: d(i.tokenizer) ? F : i.tokenizer.fileInfo.size,
      reason: 'ZIP entry compressed data',
    });
    return;
  }
  const r = Bt(i.tokenizer);
  if (!Number.isFinite(e.compressedSize) || e.compressedSize < 0 || e.compressedSize > r)
    throw new Error(`ZIP entry compressed data exceeds ${r} bytes`);
  const a = new Uint8Array(e.compressedSize);
  return (await i.tokenizer.readBuffer(a), a);
}
R.prototype.inflate = async function (i, e, t) {
  if (i.compressedMethod === 0) return t(e);
  if (i.compressedMethod !== 8)
    throw new Error(`Unsupported ZIP compression method: ${i.compressedMethod}`);
  const n = await pt(e, { maximumLength: F });
  return t(n);
};
R.prototype.unzip = async function (i) {
  let e = !1,
    t = 0;
  const n = this.tokenizer.position;
  this.knownSizeDescriptorScannedBytes = 0;
  do {
    if (M(this.tokenizer, n, k)) throw new D(`ZIP stream probing exceeds ${k} bytes`);
    const r = await this.readLocalFileHeader();
    if (!r) break;
    if ((t++, t > J)) throw new Error(`ZIP entry count exceeds ${J}`);
    const a = i(r);
    ((e = !!a.stop), await this.tokenizer.ignore(r.extraFieldLength));
    const s = await kt(this, r, {
      shouldBuffer: !!a.handler,
      maximumDescriptorLength: Math.min(F, wt(this, n)),
    });
    if ((a.handler && (await this.inflate(r, s, a.handler)), r.dataDescriptor)) {
      const o = new Uint8Array(U);
      if ((await this.tokenizer.readBuffer(o), u.get(o, 0) !== ue))
        throw new Error(
          `Expected data-descriptor-signature at position ${this.tokenizer.position - o.length}`,
        );
    }
    if (M(this.tokenizer, n, k)) throw new D(`ZIP stream probing exceeds ${k} bytes`);
  } while (!e);
...
function yt(i, e) {
  ...
  return new ReadableStream({
    async pull(o) {
      ...
      const { done: m, value: c } = await t.read();
      if (m || !c) {
        ((r = !0), o.close());
        return;
      }
      const f = e - n;
      if (c.length > f) {
        (o.enqueue(c.subarray(0, f)), (n += f), o.close(), await s());
        return;
      }
      (o.enqueue(c), (n += c.length));
    },
    async cancel(o) {
      await s(o);
    },
...
async function jt(i, e) {
  return new T(e).fromStream(i);
}
async function Nt(i, e) {
  return new T(e).fromBuffer(i);
}
async function Zt(i, e) {
  return new T(e).fromBlob(i);
}
function oe(i) {
...
function v(i, e, t) {
  ...
  for (const [n, r] of e.entries())
    if (t.mask) {
      if (r !== (t.mask[n] & i[n + t.offset])) return !1;
    } else if (r !== i[n + t.offset]) return !1;
  return !0;
}
function bt(i) {
  return Number.isFinite(i) ? Math.max(1, Math.trunc(i)) : I;
}
function St(i, e, t) {
  return t === void 0
    ? i.read(e)
...
function vt(i) {
  return Number.isFinite(i) ? Math.max(0, Math.min(Je, Math.trunc(i))) : 0;
}
function Ft(i) {
  return Number.isFinite(i) ? Math.max(0, i) : Number.MAX_SAFE_INTEGER;
}
function d(i) {
...
function M(i, e, t) {
  return d(i) && i.position - e > t;
}
function Bt(i) {
  const e = i.fileInfo.size,
    t = Number.isFinite(e) ? Math.max(0, e - i.position) : Number.MAX_SAFE_INTEGER;
  return Math.min(t, Ye);
}
function Et(i) {
  if (i instanceof l || i instanceof D) return !0;
  if (!(i instanceof Error)) return !1;
  if (ct.has(i.message) || mt.has(i.code)) return !0;
  for (const e of ft) if (i.message.startsWith(e)) return !0;
  return !1;
}
function ce(i, e = F) {
  const t = [i.compressedSize, i.uncompressedSize];
  for (const n of t) if (!Number.isFinite(n) || n < 0 || n > e) return !1;
  return !0;
}
function Dt() {
  return {
...
function Tt(i, e) {
  (e.startsWith('word/') && (i.hasWordDirectory = !0),
    e.startsWith('ppt/') && (i.hasPresentationDirectory = !0),
    e.startsWith('xl/') && (i.hasSpreadsheetDirectory = !0),
    e.startsWith('3D/') && e.endsWith('.model') && (i.hasThreeDimensionalModelEntry = !0));
}
function fe(i) {
  if (
    !(
      !i.hasContentTypesEntry ||
      i.hasUnparseableContentTypes ||
      i.isParsingContentTypes ||
      i.hasParsedContentTypesEntry
    )
  ) {
    if (i.hasWordDirectory)
      return {
        ext: 'docx',
        mime: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
      };
    if (i.hasPresentationDirectory)
      return {
        ext: 'pptx',
        mime: 'application/vnd.openxmlformats-officedocument.presentationml.presentation',
      };
    if (i.hasSpreadsheetDirectory)
      return {
        ext: 'xlsx',
        mime: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
      };
    if (i.hasThreeDimensionalModelEntry) return { ext: '3mf', mime: 'model/3mf' };
  }
}
function Ct(i) {
  const e = i.indexOf('.main+xml"');
  if (e === -1) {
    const r = 'application/vnd.ms-package.3dmanufacturing-3dmodel+xml';
    return i.includes(`ContentType="${r}"`) ? r : void 0;
  }
  const t = i.slice(0, e),
    n = t.lastIndexOf('"');
  return t.slice(n + 1);
}
async function _t(i, e) {
  return new T(e).fromTokenizer(i);
}
async function qt(i, e) {
  return new T(e).toDetectionStream(i, e);
}
class T {
  constructor(e) {
    const t = vt(e?.mpegOffsetTolerance);
  ...
  createTokenizerFromWebStream(e) {
    return xt(Pe(e, this.getTokenizerOptions()));
  }
  async parseTokenizer(e, t = 0) {
    ...
    for (const r of this.detectors) {
      ...
      try {
        ...
        if (s instanceof l || s instanceof D) return;
        throw s;
      }
      if (a) return a;
  ...
  async fromBuffer(e) {
    ...
    if (t?.length > 1) return this.fromTokenizer(Ue(t, this.getTokenizerOptions()));
  }
  async fromBlob(e) {
    this.options.signal?.throwIfAborted();
    const t = je(e, this.getTokenizerOptions());
  ...
  async toDetectionStream(e, t) {
    const n = bt(t?.sampleSize ?? I);
    let r, a;
    const s = e.getReader({ mode: 'byob' });
    try {
      const { value: c, done: f } = await St(s, new Uint8Array(n), this.options.signal);
      if (((a = c), !f && c))
        try {
          r = await this.fromBuffer(c.subarray(0, n));
        } catch (x) {
  ...
  async detectGzip(e) {
    if (this.gzipProbeDepth >= tt) return { ext: 'gz', mime: 'application/gzip' };
    const t = new Ve(e),
      n = yt(t.inflate(), et),
      r = d(e);
    let a, s, o, m;
    if (r) {
      ...
      ((a = setTimeout(() => {
        c.abort(new DOMException(`Operation timed out after ${ee} ms`, 'TimeoutError'));
      }, ee)),
        (s =
          this.options.signal === void 0
            ? c.signal
            : AbortSignal.any([this.options.signal, c.signal])),
        (o = new T({ ...this.options, signal: s })),
        (o.gzipProbeDepth = this.gzipProbeDepth + 1));
    } else this.gzipProbeDepth++;
    try {
      m = await (o ?? this).fromStream(n);
    } catch (c) {
      if (c?.name === 'AbortError' && s?.reason?.name !== 'TimeoutError') throw c;
    } finally {
      (clearTimeout(a), r || this.gzipProbeDepth--);
    }
    return m?.ext === 'tar'
  ...
  checkString(e, t) {
    return this.check(Ge(e, t?.encoding), t);
  }
  detectConfident = async (e) => {
    if (
      ...
      (this.tokenizer = e),
      d(e) &&
        (await e.peekBuffer(this.buffer, { length: 3, mayBeLess: !0 }), this.check([31, 139, 8])))
    )
    ...
    if (this.check([239, 187, 191]))
      return this.detectionReentryCount >= ne
        ? void 0
        : (this.detectionReentryCount++, await this.tokenizer.ignore(3), this.detectConfident(e));
    ...
    if (this.checkString('ID3')) {
      await E(e, 6, { maximumLength: 6, reason: 'ID3 header prefix' });
      const t = await e.readToken(Qe),
        n = d(e);
      if (!Number.isFinite(t) || t < 0 || (n && (t > _ || e.position + t > _))) return;
      if (e.position + t > e.fileInfo.size) return n ? void 0 : { ext: 'mp3', mime: 'audio/mpeg' };
      try {
        await E(e, t, { maximumLength: n ? _ : e.fileInfo.size, reason: 'ID3 payload' });
      } catch (r) {
      ...
      return this.detectionReentryCount >= ne
        ? void 0
        : (this.detectionReentryCount++, this.parseTokenizer(e, this.detectionReentryCount));
    }
    ...
    if (this.check([80, 75, 3, 4])) {
      ...
      const n = Dt();
      try {
        await new R(e).unzip((r) => {
          Tt(n, r.filename);
          const a = r.filename === '[Content_Types].xml',
            s = fe(n);
          if (!a && s) return ((t = s), { stop: !0 });
          switch (r.filename) {
            ...
            case 'mimetype':
              return ce(r, Y)
                ? {
                    async handler(o) {
                      const m = new TextDecoder('utf-8').decode(o).trim();
                      t = oe(m);
                    },
                    stop: !0,
                  }
              ...
              return (
                ...
                ce(r, Y)
                  ? ((n.isParsingContentTypes = !0),
                    {
                      async handler(o) {
                        const m = new TextDecoder('utf-8').decode(o),
                          c = Ct(m);
                        (c && (t = oe(c)),
            ...
            default:
              return /classes\d*\.dex/.test(r.filename)
                ? ((t = { ext: 'apk', mime: 'application/vnd.android.package-archive' }),
                  { stop: !0 })
                : {};
          }
        });
      ...
      return t ?? fe(n) ?? { ext: 'zip', mime: 'application/zip' };
    }
    if (this.checkString('OggS')) {
      ...
      return (
        ...
        v(t, [79, 112, 117, 115, 72, 101, 97, 100])
    ...
    if (this.check([26, 69, 223, 163])) {
      async function t() {
        const m = await e.peekNumber(Be);
        let c = 128,
          f = 0;
        for (; (m & c) === 0 && c !== 0; ) (++f, (c >>= 1));
        const x = new Uint8Array(f + 1);
        return (await q(e, x, void 0, { maximumLength: x.length, reason: 'EBML field' }), x);
      }
      async function n() {
        const m = await t(),
          c = await t();
        c[0] ^= 128 >> (c.length - 1);
        const f = Math.min(6, c.length),
          x = new DataView(m.buffer),
          y = new DataView(c.buffer, c.length - f, f);
        return { id: X(x), len: X(y) };
      }
      async function r(m) {
        let c = 0;
        for (; m > 0; ) {
          if ((c++, c > it || M(e, s, k))) return;
          const f = e.position,
            x = await n();
          if (x.id === 17026) {
            if (x.len > te) return;
            const y = V(x.len, te, 'EBML DocType');
            return (await e.readToken(new B(y))).replaceAll(/\00.*$/g, '');
          }
          if (
            (d(e) && (!Number.isFinite(x.len) || x.len < 0 || x.len > ie)) ||
            (await E(e, x.len, {
              maximumLength: d(e) ? ie : e.fileInfo.size,
              reason: 'EBML payload',
            }),
            --m,
            e.position <= f)
    ...
    if (this.check([202, 254, 186, 190])) {
      const t = H.get(this.buffer, 4),
        n = C.get(this.buffer, 6);
      if (t > 0 && t <= 30) return { ext: 'macho', mime: 'application/x-mach-binary' };
      if (n > 30) return { ext: 'class', mime: 'application/java-vm' };
    }
    ...
    if (this.checkString('!<arch>'))
      return (
        await e.ignore(8),
        (await e.readToken(new B(13, 'ascii'))) === 'debian-binary'
...
`,
    ...
    if (this.check([137, 80, 78, 71, 13, 10, 26, 10])) {
      const t = { ext: 'png', mime: 'image/png' },
        n = { ext: 'apng', mime: 'image/apng' };
      await e.ignore(8);
      async function r() {
        return { length: await e.readToken(Ee), type: await e.readToken(new B(4, 'latin1')) };
      }
      const a = d(e),
        s = e.position;
      let o = 0,
      ...
      do {
        ...
        switch (f.type) {
          ...
          case 'acTL':
            return n;
          default:
            if (!m && f.type !== 'CgBI') return;
            if (a && f.length > re) return m && lt(f.type) ? t : void 0;
            try {
              await E(e, f.length + 4, {
                maximumLength: a ? re + 4 : e.fileInfo.size,
                reason: 'PNG chunk payload',
              });
            } catch (x) {
              if (!a && (x instanceof D || x instanceof l)) return t;
              throw x;
            }
        }
...
`)
    ...
    if (this.check([48, 38, 178, 117, 142, 102, 207, 17, 166, 217])) {
      ...
      try {
        async function n() {
          ...
          return (
            await q(e, o, void 0, { maximumLength: o.length, reason: 'ASF header GUID' }),
            { id: o, size: Number(await e.readToken(De)) }
          );
        }
        await E(e, 30, { maximumLength: 30, reason: 'ASF header prelude' });
        const r = d(e),
          a = e.position;
        let s = 0;
        for (; e.position + 24 < e.fileInfo.size && (s++, !(s > at || M(e, a, k))); ) {
          const o = e.position,
            m = await n();
          let c = m.size - 24;
          ...
          if (v(m.id, [145, 7, 220, 183, 183, 169, 207, 17, 142, 230, 0, 192, 12, 32, 83, 101])) {
            const f = new Uint8Array(16);
            if (
              ((c -= await q(e, f, void 0, {
                maximumLength: f.length,
                reason: 'ASF stream type GUID',
              })),
              v(f, [64, 158, 105, 248, 77, 91, 207, 17, 168, 253, 0, 128, 95, 92, 68, 43]))
            )
              return { ext: 'asf', mime: 'audio/x-ms-asf' };
            if (v(f, [192, 239, 25, 188, 77, 91, 207, 17, 168, 253, 0, 128, 95, 92, 68, 43]))
          ...
          if (
            (await E(e, c, {
              maximumLength: r ? ae : e.fileInfo.size,
        ...
        if (n instanceof l || n instanceof D) d(e) && (t = !0);
        else throw n;
      }
    ...
    if (
      ...
      (this.checkString('ustar', { offset: 257 }) &&
        ...
        (this.check([0, 0, 0, 0, 0, 0], { offset: 257 }) && He(this.buffer)))
    )
    ...
    if (this.check([255, 254])) {
      ...
      return this.checkString('<?xml ', { offset: 2, encoding: t })
        ...
        : this.check([255, 14], { offset: 2 }) &&
            this.checkString('SketchUp Model', { offset: 4, encoding: t })
...
`,
  ...
  detectImprecise = async (e) => {
    this.buffer = new Uint8Array(I);
    const t = Ft(e.fileInfo.size);
    if (
      (await e.peekBuffer(this.buffer, { length: Math.min(8, t), mayBeLess: !0 }),
    ...
    if (
      ...
      for (let n = 0; n <= this.options.mpegOffsetTolerance; ++n) {
        const r = this.scanMpeg(n);
        if (r) return r;
      }
  };
  async readTiffTag(e) {
    const t = await this.tokenizer.readToken(e ? C : p);
  ...
  async readTiffIFD(e) {
    const t = await this.tokenizer.readToken(e ? C : p);
    if (!(t > st) && !(d(this.tokenizer) && 2 + t * 12 > se))
      for (let n = 0; n < t; ++n) {
  ...
  async readTiffHeader(e) {
    const t = { ext: 'tif', mime: 'image/tiff' },
      n = (e ? C : p).get(this.buffer, 2),
      r = (e ? H : u).get(this.buffer, 4);
    if (n === 42) {
      if (r >= 6) {
        if (this.checkString('CR', { offset: 8 })) return { ext: 'cr2', mime: 'image/x-canon-cr2' };
        if (r >= 8) {
          const o = (e ? C : p).get(this.buffer, 8),
            m = (e ? C : p).get(this.buffer, 10);
          if ((o === 28 && m === 254) || (o === 31 && m === 11))
            return { ext: 'nef', mime: 'image/x-nikon-nef' };
        }
      }
      if (d(this.tokenizer) && r > ot) return t;
      const a = d(this.tokenizer) ? se : this.tokenizer.fileInfo.size;
      try {
        await E(this.tokenizer, r, { maximumLength: a, reason: 'TIFF IFD offset' });
      } catch (o) {
...
export {
  T as FileTypeParser,
  Zt as fileTypeFromBlob,
  Nt as fileTypeFromBuffer,
  jt as fileTypeFromStream,
  _t as fileTypeFromTokenizer,
  qt as fileTypeStream,
  bt as normalizeSampleSize,
  I as reasonableDetectionSizeInBytes,
  Wt as supportedExtensions,
  $t as supportedMimeTypes,
};
