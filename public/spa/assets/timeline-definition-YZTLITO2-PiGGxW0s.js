...
import { d as nt } from './arc-CP6XhVRu.js';
...
var Q = (function () {
  var n = s(function (x, r, a, c) {
    ...
    p = {
      ...
      performAction: s(function (r, a, c, u, y, o, w) {
        var v = o.length - 1;
        switch (y) {
          case 1:
            return o[v - 1];
      ...
      table: [
        ...
        n(t, [2, 7], { 1: [2, 1] }),
        n(t, [2, 3]),
        { 9: 18, 11: e, 12: l, 14: i, 16: d, 17: h, 18: 14, 19: 15, 20: f, 21: m },
        n(t, [2, 5]),
        n(t, [2, 6]),
        n(t, [2, 8]),
        { 13: [1, 19] },
      ...
      parse: s(function (r) {
        ...
        function tt() {
          ...
          return (
            (T = u.pop() || g.lex() || U),
            typeof T != 'number' &&
              (T instanceof Array && ((u = T), (T = u.pop())), (T = a.symbols_[T] || T)),
            T
          );
        }
        s(tt, 'lex');
        for (var S, A, I, J, R = {}, B, M, et, O; ; ) {
          if (
            ...
            this.defaultActions[A]
              ...
              : ((S === null || typeof S > 'u') && (S = tt()), (I = w[A] && w[A][S])),
            typeof I > 'u' || !I.length || !I[0])
          ) {
            var K = '';
            O = [];
            for (B in w[A]) this.terminals_[B] && B > V && O.push("'" + this.terminals_[B] + "'");
            (g.showPosition
              ? (K =
                  'Parse error on line ' +
                  (N + 1) +
...
Expecting ` +
              ...
              : (K =
                  ...
                  (N + 1) +
                  ': Unexpected ' +
                  (S == U ? 'end of input' : "'" + (this.terminals_[S] || S) + "'")),
              this.parseError(K, {
                text: g.match,
          ...
          if (I[0] instanceof Array && I.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + A + ', token: ' + S,
            );
          switch (I[0]) {
            case 1:
              (c.push(S),
            ...
            case 2:
              if (
                ...
                W && (R._$.range = [o[o.length - (M || 1)].range[0], o[o.length - 1].range[1]]),
                (J = this.performAction.apply(R, [v, P, N, b.yy, I[1], y, o].concat(H))),
                typeof J < 'u')
              )
                return J;
              (M &&
                ((c = c.slice(0, -1 * M * 2)), (y = y.slice(0, -1 * M)), (o = o.slice(0, -1 * M))),
...
` +
        ...
        next: s(function () {
          ...
          for (var y = this._currentRules(), o = 0; o < y.length; o++)
            if (
              ((c = this._input.match(this.rules[y[o]])), c && (!a || c[0].length > a[0].length))
            ) {
              if (((a = c), (u = o), this.options.backtrack_lexer)) {
                if (((r = this.test_match(c, y[o])), r !== !1)) return r;
                if (this._backtrack) {
                  a = !1;
                  continue;
                } else return !1;
...
` +
        ...
        performAction: s(function (a, c, u, y) {
          switch (u) {
            case 0:
              break;
            case 1:
...
var z = '',
  ...
  pt = s(function (n, t, e) {
    const l = { id: lt++, section: z, type: z, task: n, score: t || 0, events: e ? [e] : [] };
    F.push(l);
  }, 'addTask'),
  yt = s(function (n) {
  ...
  gt = s(function (n) {
    const t = { section: z, type: z, description: n, task: n, classes: [] };
    G.push(t);
  }, 'addTaskOrg'),
  it = s(function () {
    ...
    let t = !0;
    for (const [e, l] of F.entries()) (n(e), (t = t && l.processed));
    return t;
  }, 'compileTasks'),
  It = {
    clear: ct,
...
var zt = s(function (n, t, e, l) {
    ...
    const h = d.append('g'),
      ...
      p = f
        ...
        .node()
        .getBBox(),
      k = l.fontSize?.replace ? l.fontSize.replace('px', '') : l.fontSize;
    return (
      (t.height = p.height + k * 1.1 * 0.5 + t.padding),
  ...
  Ft = s(function (n, t, e) {
    const l = n.append('g'),
      d = l
        ...
        .node()
        .getBBox(),
      h = e.fontSize?.replace ? e.fontSize.replace('px', '') : e.fontSize;
  ...
  Wt = s(function (n, t, e, l) {
    ...
    for (const [H, g] of k.entries()) {
      const b = { number: H, descr: g, section: g.section, width: 150, padding: 20, maxHeight: a },
        L = C.getVirtualNodeHeight(p, b, i);
      (E.debug('taskHeight before draw', L),
        (a = Math.max(a, L + 20)),
      ...
      x && x.length > 0
        ? x.forEach((H) => {
            ...
            (E.debug('sectionNode output', $),
              ...
              (o += r + 50),
              g.length > 0 && st(p, g, w, y, o, a, i, N, P, r, !1),
              (y += 200 * Math.max(g.length, 1)),
              (o = u),
              w++);
          })
        : ((v = !1), st(p, k, w, y, o, a, i, N, P, r, !0)));
    ...
    (E.debug('bounds', V),
      ...
      kt(void 0, p, i.timeline?.padding ?? 50, i.timeline?.useMaxWidth ?? !1));
  }, 'draw'),
  st = s(function (n, t, e, l, i, d, h, f, m, p, k) {
    for (const _ of t) {
      const x = { descr: _.task, section: e, number: e, width: 150, padding: 20, maxHeight: d };
      E.debug('taskNode', x);
      const r = n.append('g').attr('class', 'taskWrapper'),
        c = C.drawNode(r, x, e, h).height;
      if (
        (E.debug('taskHeight after draw', c),
...
`,
  ...
  qt = Gt,
  se = { db: at, renderer: Ot, parser: Tt, styles: qt };
