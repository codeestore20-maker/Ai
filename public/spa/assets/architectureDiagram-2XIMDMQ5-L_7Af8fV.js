...
import { p as lr } from './chunk-4BX2VUAB-BeN7F7vo.js';
import { p as fr } from './treemap-KZPCXAKY-DVXiEiew.js';
import { c as Fe } from './cytoscape.esm-D_Z0Bbqx.js';
import { g as cr } from '../vendor/vendor-emotion-DdM-9MtU.js';
...
import './_basePickBy-BrwF_vq7.js';
import './clone-DXI9Sofg.js';
var he = { exports: {} },
  le = { exports: {} },
  fe = { exports: {} },
  gr = fe.exports,
        ...
        (function (P, N) {
          ...
          return (function (C) {
            ...
            function N(u) {
              ...
              return (C[u].call(h.exports, h, h.exports, N), (h.l = !0), h.exports);
            }
            return (
              (N.m = C),
              (N.c = P),
              ...
              ((o.prototype.getNodes = function () {
                ...
                (o.prototype.remove = function (c) {
                  ...
                  if (c instanceof r) {
                    ...
                    var A = d.source.edges.indexOf(d),
                      G = d.target.edges.indexOf(d);
                    if (!(A > -1 && G > -1)) throw "Source and/or target doesn't know this edge!";
                    (d.source.edges.splice(A, 1),
              ...
              ((h.calcSeparationAmount = function (a, e, r, l) {
                ...
                (h.getIntersection2 = function (a, e, r) {
                  ...
                  if (l === g) {
                    ...
                    if (i < t) return ((r[0] = l), (r[1] = T), (r[2] = g), (r[3] = A), !1);
                  } else if (i === t) {
                    ...
                    if (!m)
                      switch (w) {
                        case 1:
                          ((q = A), (x = g + -it / y), (r[2] = x), (r[3] = q));
                          break;
                        case 2:
                          ((x = K), (q = t + O * y), (r[2] = x), (r[3] = q));
                          break;
                        case 3:
                          ((q = Y), (x = g + it / y), (r[2] = x), (r[3] = q));
                          break;
                        case 4:
                          ((x = Z), (q = t + -O * y), (r[2] = x), (r[3] = q));
                          break;
                      }
                  }
                  return !1;
                ...
                (h.getIntersection = function (a, e, r, l) {
                  ...
                  return (
                    ...
                    K === 0
                      ? null
                      : ((d = (A * Y - G * Z) / K), (v = (b * Z - L * Y) / K), new u(d, v))
                  );
                }),
            ...
            function (C, P, N) {
              function u() {}
              ((u.MAX_VALUE = 2147483647), (u.MIN_VALUE = -2147483648), (C.exports = u));
            },
            function (C, P, N) {
              var u = (function () {
                function i(g, t) {
              ...
              ((o.RANDOM_SEED = 1),
                ...
                (o.findCenterOfTree = function (s) {
                  ...
                  for (var L = 0; L < c.length; L++) {
                    var b = c[L],
                      A = b.getNeighborsList().size;
                    (T.set(b, b.getNeighborsList().size), A == 1 && f.push(b));
                  }
                  var G = [];
                  for (G = G.concat(f); !d; ) {
                    var Z = [];
                        ...
                        if (!(v < 0 || L < 0 || v >= d.length || L >= d[0].length)) {
                          for (var b = 0; b < d[v][L].length; b++)
                            if (
                              ...
                              A <= this.repulsionRange && G <= this.repulsionRange && f.add(T);
                            }
                        }
                ...
                for (var V = this.n - 1; V >= 0; V--) {
                  if (
                    ...
                    for (var X = V + 1; X < a; X++) {
                      ...
                      et = -et / this.V[V + 1][V];
                      for (var M = V + 1; M < this.n; M++) this.V[M][X] += et * this.V[M][V];
                    }
                ...
                765: (a, e, r) => {
                  ...
                  ((O.prototype.newGraphManager = function () {
                            ...
                            this.constraints.relativePlacementConstraint.forEach(function (M) {
                              if (M.left) {
                                var H = w.has(M.left) ? w.get(M.left) : M.left,
                                  $ = w.has(M.right) ? w.get(M.right) : M.right;
                                (n.nodesInRelativeHorizontal.includes(H) ||
                                  ...
                                  n.nodeToRelativeConstraintMapHorizontal
                                    .get(H)
                                    .push({ right: $, gap: M.gap }),
                                  n.nodeToRelativeConstraintMapHorizontal
                                    .get($)
                                    .push({ left: H, gap: M.gap }));
                              } else {
                                var _ = S.has(M.top) ? S.get(M.top) : M.top,
                                  ht = S.has(M.bottom) ? S.get(M.bottom) : M.bottom;
                                (n.nodesInRelativeVertical.includes(_) ||
                                  ...
                                  n.nodeToRelativeConstraintMapVertical
                                    .get(_)
                                    .push({ bottom: ht, gap: M.gap }),
                                  n.nodeToRelativeConstraintMapVertical
                                    .get(ht)
                                    .push({ top: _, gap: M.gap }));
                              }
                            }));
                        else {
                          var q = new Map(),
                            ...
                            this.nodesInRelativeVertical.forEach(function (z) {
                              if (!n.fixedNodesOnHorizontal.has(z)) {
                                ...
                                (n.dummyToNodeForHorizontalAlignment.has(z)
                                  ...
                                  n.nodeToTempPositionMapVertical.set(
                                    z,
                                    n.nodeToTempPositionMapVertical.get(z) + M,
                                  ),
                                  n.dummyToNodeForHorizontalAlignment.has(z)
                    ...
                    (O.prototype.positionNodesRadially = function (n) {
                      for (
                        ...
                        S % p == 0 &&
                          ...
                          (E = 0));
                        var W = n[S],
                          x = b.findCenterOfTree(W);
                        ((m.x = R),
                          (m.y = y),
                          (w = O.radialLayout(W, x, m)),
                    ...
                    (O.branchRadialLayout = function (n, m, p, E, y, R) {
                      ...
                      for (var ht = Math.abs(E - p) / X, Q = M; et != X; Q = ++Q % z) {
                    ...
                    (O.prototype.tileNodesByFavoringDim = function (n, m, p) {
                      ...
                      for (var V = 0; V < n.length; V++) {
                        var X = n[V];
                        if (w.rows.length == 0) this.insertNodeToRow(w, X, 0, m);
                          ...
                          (w.idealRowWidth || (et = this.getShortestRowIndex(w)),
                            this.insertNodeToRow(w, X, et, m));
                        } else this.insertNodeToRow(w, X, w.rows.length, m);
                    ...
                    (O.prototype.findPlaceforPrunedNode = function (n) {
                      ...
                      if (
                        ...
                        for (var z = A.MAX_VALUE, M, H, $ = 0; $ < X.length; $++)
                          X[$] < z ? ((z = X[$]), (M = 1), (H = $)) : X[$] == z && M++;
                        if (M == 3 && z == 0)
                          X[0] == 0 && X[1] == 0 && X[2] == 0
                            ? (m = 1)
                  ...
                  ((s.handleConstraints = function (c) {
                    ...
                    if (
                      ...
                      if (f.fixedNodeConstraint && f.fixedNodeConstraint.length > 1)
                              ...
                              var U = f.alignmentConstraint.vertical,
                                B = function (tt) {
                                  ...
                                  var ut = new Set(
                                    ...
                                    wt = void 0;
                                  (ut.size > 0
                                    ? (wt = v[d.get(ut.values().next().value)])
                                    : (wt = K(j).x),
                                    U[tt].forEach(function (pt) {
                                      ((E[F] = [wt, L[d.get(pt)]]),
                        ...
                        if (V < x.size / 2) (it(f.relativePlacementConstraint), (R = !1), (w = !1));
                        else {
                          var z = new Map(),
                            M = new Map(),
                            H = [];
                          (q[X].forEach(function (F) {
                            W.get(F).forEach(function (U) {
                              U.direction == 'horizontal'
                                ...
                                : (M.has(F) ? M.get(F).push(U) : M.set(F, [U]),
                      ...
                      f.relativePlacementConstraint &&
                        (function () {
                          ...
                          if (
                            ...
                            if (f.alignmentConstraint.horizontal)
                              for (
                                var wt = f.alignmentConstraint.horizontal,
                                  pt = function (yt) {
                                    (J.set('dummy' + yt, []),
                          ...
                          try {
                            for (
                              var ve = Jt.keys()[Symbol.iterator](), we;
                              !(de = (we = ve.next()).done);
                              de = !0
                            ) {
                              var ue = we.value;
                    ...
                    (g.relocateComponent = function (t, o, s) {
                      if (!s.fixedNodeConstraint) {
                        ...
                        if (s.quality == 'draft') {
                          ...
                          try {
                            for (
                              var A = o.nodeIndexes[Symbol.iterator](), G;
                              !(v = (G = A.next()).done);
                              v = !0
                            ) {
                              var Z = G.value,
                  ...
                  var l = r(548),
                    ...
                    T = function (v, L) {
                      ...
                      var n = function (x) {
                        ...
                        p = l.calcParentsWithoutChildren(b, A),
                        E = function W(x, q, V, X) {
                          for (var et = q.length, z = 0; z < et; z++) {
                            var M = q[z],
                              H = null;
                            M.intersection(p).length == 0 && (H = M.children());
                            var $ = void 0,
                              _ = M.layoutDimensions({
                              ...
                              if (X.randomize)
                                if (!M.isParent())
                                  $ = x.add(
                                    new g(
                                      V.graphManager,
                                      new t(K[Y.get(M.id())] - _.w / 2, O[Y.get(M.id())] - _.h / 2),
                                      new o(parseFloat(_.w), parseFloat(_.h)),
                                    ),
                                  );
                                else {
                                  var ht = l.calcBoundingBox(M, K, O, Y);
                            ...
                            if (
                              (($.id = M.data('id')),
                              ($.nodeRepulsion = m(X.nodeRepulsion, M)),
                              ($.paddingLeft = parseInt(M.css('padding'))),
                              ...
                              X.nodeDimensionsIncludeLabels &&
                                (($.labelWidth = M.boundingBox({
                                  includeLabels: !0,
                                  includeNodes: !1,
                                  includeOverlays: !1,
                                }).w),
                                ($.labelHeight = M.boundingBox({
                                  includeLabels: !0,
                                  includeNodes: !1,
                                  includeOverlays: !1,
                                }).h),
                                ($.labelPosVertical = M.css('text-valign')),
                                ($.labelPosHorizontal = M.css('text-halign'))),
                              (it[M.data('id')] = $),
                      ...
                      var w = new i(),
                        S = w.newGraphManager();
                      return (
                        E(S.addRoot(), l.getTopMostNodes(G), w, v),
                        y(w, S, Z),
                        R(w, v),
                        w.runLayout(),
                        it
                ...
                212: (a, e, r) => {
                  var l = (function () {
                    ...
                    return function (L, b, A) {
                      return (b && v(L.prototype, b), A && v(L, A), L);
                    };
                  })();
                  function i(v, L) {
                        ...
                        l(v, [
                          {
                            ...
                            value: function () {
                              ...
                              if (
                                ...
                                if (p) {
                                  var R = t.getTopMostNodes(A.eles.nodes());
                                  if (
                                    ((O = t.connectComponents(G, A.eles, R)),
                                    ...
                                    O.forEach(function (vt, rt) {
                                      t.relocateComponent(it[rt], Y[rt], A);
                                    });
                                  var M = new Set();
                                  if (O.length > 1) {
                                    var H = [],
                                    ...
                                    O.forEach(function (vt, rt) {
                                      var gt = void 0;
                                      if (
                                        (A.quality == 'draft' && (gt = Y[rt].nodeIndexes),
                                        ...
                                        (vt
                                          ...
                                          mt.nodes.length > 0 && (H.push(mt), M.add(rt)));
                                      }
                                    });
                                  ...
                                  A.quality == 'default' || A.quality == 'proof'
                                    ? (K.push(f(A, Y[0])), t.relocateComponent(it[0], K[0], A))
                                    : t.relocateComponent(it[0], Y[0], A);
                                }
                              ...
                              if (A.quality == 'default' || A.quality == 'proof' || A.randomize) {
                                ...
                                ((A.eles = Z.not(Nt)),
                                  Z.nodes().not(':parent').not(Nt).layoutPositions(b, A, Q),
                                  It.length > 0 &&
                      ...
                      var c = s.cy,
                        ...
                        q = function (U) {
                          ...
                          if (U) {
                            ...
                            for (var at = 0; at < S; at++) ((Y[at] = B), (B = x(B, at, U)));
                          } else {
                            W();
                            for (var J = 0; J < S; J++) x(Y[J], J, U);
                          }
                            ...
                            F.neighborhood()
                              ...
                              .forEach(function (B) {
                                f.intersection(F.edgesWith(B)).length > 0 &&
                                  (B.isParent() ? A[U].push(b.get(B.id())) : A[U].push(B.id()));
                              }));
                        }));
                      var Nt = function (U) {
                          var B = L.get(U),
...
var xe = { L: 'left', R: 'right', T: 'top', B: 'bottom' },
  ...
  ye = dt(function (I, D) {
    const C = `${I}${D}`;
    return Lr(C) ? C : void 0;
  }, 'getArchitectureDirectionPair'),
  Cr = dt(function ([I, D], C) {
    const P = C[0],
      N = C[1];
    return Wt(P)
      ? qt(N)
  ...
  Pe =
    ((ae = class {
      ...
      addService({ id: D, icon: C, in: P, title: N, iconText: u }) {
      ...
      addJunction({ id: D, in: C }) {
        if (this.registeredIds[D] !== void 0)
          throw new Error(
            `The junction id [${D}] is already in use by another ${this.registeredIds[D]}`,
          );
        if (C !== void 0) {
          if (D === C) throw new Error(`The junction [${D}] cannot be placed within itself`);
          if (this.registeredIds[C] === void 0)
            throw new Error(
              `The junction [${D}]'s parent does not exist. Please make sure the parent is created before this junction`,
            );
          if (this.registeredIds[C] === 'node')
            throw new Error(`The junction [${D}]'s parent is not a group`);
        }
        ((this.registeredIds[D] = 'node'),
          (this.nodes[D] = { id: D, type: 'junction', edges: [], in: C }));
      }
      getJunctions() {
      ...
      addGroup({ id: D, icon: C, in: P, title: N }) {
        if (this.registeredIds?.[D] !== void 0)
          throw new Error(
        ...
        ((this.registeredIds[D] = 'group'), (this.groups[D] = { id: D, icon: C, title: N, in: P }));
      }
      getGroups() {
      ...
      addEdge({
        ...
        if (!Re(P))
          throw new Error(
            `Invalid direction given for left hand side of edge ${D}--${C}. Expected (L,R,T,B) got ${String(P)}`,
          );
        if (!Re(N))
          throw new Error(
            `Invalid direction given for right hand side of edge ${D}--${C}. Expected (L,R,T,B) got ${String(N)}`,
          );
      ...
      getDataStructures() {
        if (this.dataStructures === void 0) {
          const D = {},
            C = Object.entries(this.nodes).reduce(
              (e, [r, l]) => (
                (e[r] = l.edges.reduce((i, g) => {
                  const t = this.getNode(g.lhsId)?.in,
                    o = this.getNode(g.rhsId)?.in;
                  if (t && o && t !== o) {
                    const s = wr(g.lhsDir, g.rhsDir);
                    s !== 'bend' && ((D[t] ??= {}), (D[t][o] = s), (D[o] ??= {}), (D[o][t] = s));
                  }
                  if (g.lhsId === r) {
            ...
            P = Object.keys(C)[0],
            N = { [P]: 1 },
            u = Object.keys(C).reduce((e, r) => (r === P ? e : { ...e, [r]: 1 }), {}),
            h = dt((e) => {
              const r = { [e]: [0, 0] },
                l = [e];
              for (; l.length > 0; ) {
          ...
          this.dataStructures = { adjList: C, spatialMaps: a, groupAlignments: D };
        }
  ...
  xr = dt((I, D) => {
    (lr(I, D),
      I.groups.map((C) => D.addGroup(C)),
      I.services.map((C) => D.addService({ ...C, type: 'service' })),
      I.junctions.map((C) => D.addJunction({ ...C, type: 'junction' })),
      I.edges.map((C) => D.addEdge(C)));
  }, 'populateDb'),
  Ge = {
    parser: { yy: void 0 },
    parse: dt(async (I) => {
...
`,
  ...
  Sr = dt(async function (I, D, C) {
    const P = C.getConfigField('padding'),
      N = C.getConfigField('iconSize'),
      u = N / 2,
      h = N / 6,
      a = h / 2;
    await Promise.all(
      D.edges().map(async (e) => {
        ...
        let { x: b, y: A } = e[0].targetEndpoint();
        const G = P + 4;
        if (
          (g && (Wt(l) ? (T += l === 'L' ? -G : G) : (d += l === 'T' ? -G : G + 18)),
          c && (Wt(o) ? (b += o === 'L' ? -G : G) : (A += o === 'T' ? -G : G + 18)),
          !g &&
            C.getNode(r)?.type === 'junction' &&
            (Wt(l) ? (T += l === 'L' ? u : -u) : (d += l === 'T' ? u : -u)),
          !c &&
            C.getNode(t)?.type === 'junction' &&
            (Wt(o) ? (b += o === 'L' ? u : -u) : (A += o === 'T' ? u : -u)),
          e[0]._private.rscratch)
        ) {
          const Z = I.insert('g');
          if (
            (Z.insert('path')
              .attr('d', `M ${T},${d} L ${v},${L} L${b},${A} `)
              .attr('class', 'edge')
              .attr('id', or(r, t, { prefix: 'L' })),
            i)
          ) {
  ...
  Fr = dt(async function (I, D, C) {
    const N = C.getConfigField('padding') * 0.75,
      u = C.getConfigField('fontSize'),
      a = C.getConfigField('iconSize') / 2;
    await Promise.all(
      D.nodes().map(async (e) => {
        const r = ie(e);
        if (r.type === 'group') {
          ...
          C.setElementForId(r.id, o);
        }
      }),
    );
  }, 'drawGroups'),
  br = dt(async function (I, D, C) {
    const P = Ee();
    for (const N of C) {
      const u = D.append('g'),
      ...
      if (N.icon)
        ...
        a.append('path')
          .attr('class', 'node-bkg')
          .attr('id', 'node-' + N.id)
          .attr('d', `M0,${h} V5 Q0,0 5,0 H${h - 5} Q${h},0 ${h},5 V${h} Z`);
...
function We(I, D) {
  I.forEach((C) => {
    const {
      ...
      g = Te(C.lhsDir, C.rhsDir) ? 'segments' : 'straight',
      t = {
        id: `${P}-${N}`,
        label: i,
        source: P,
          ...
          if (i) {
            ...
            Object.entries(r).forEach(([t, o]) => {
              ...
              c &&
                !e[s] &&
                (a.push(s),
                C.push({ [xe[t]]: c, [xe[Tr(t)]]: i, gap: 1.5 * D.getConfigField('iconSize') }));
            });
          }
        }
      }
...
function $e(I, D, C, P, N, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    ...
    (e.remove(), He(C, r), Ue(I, r, N), Ye(D, r, N), We(P, r));
    const l = Ve(N, u, h),
      i = ze(u, N),
      g = r.layout({
        name: 'fcose',
    ...
    (g.one('layoutstop', () => {
      function t(o, s, c, f) {
        ...
        const { x: v, y: L } = o,
          { x: b, y: A } = s;
        ((d =
          (f - L + ((v - c) * (L - A)) / (v - b)) / Math.sqrt(1 + Math.pow((L - A) / (v - b), 2))),
          (T = Math.sqrt(Math.pow(f - L, 2) + Math.pow(c - v, 2) - Math.pow(d, 2))));
        const G = Math.sqrt(Math.pow(b - v, 2) + Math.pow(A - L, 2));
        T = T / G;
        let Z = (b - v) * (f - L) - (A - L) * (c - v);
        switch (!0) {
          case Z >= 0:
            Z = 1;
            break;
        ...
        if (o.data?.()) {
          ...
          if (s !== f && c !== T) {
            const d = o.sourceEndpoint(),
              v = o.targetEndpoint(),
              { sourceDir: L } = be(o),
              [b, A] = qt(L) ? [d.x, v.y] : [v.x, d.y],
              { weights: G, distances: Z } = t(d, v, b, A);
...
var Gr = dt(async (I, D, C, P) => {
    ...
    (await Sr(i, o, N),
      await Fr(t, o, N),
      Xe(N, o),
      Ze(void 0, l, N.getConfigField('padding'), N.getConfigField('useMaxWidth')));
  }, 'draw'),
  Ur = { draw: Gr },
  ii = {
    parser: Ge,
