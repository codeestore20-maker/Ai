...
import { g as Ne } from './chunk-FMBD7UC4-DXdf8TpC.js';
          ...
          switch (x[0]) {
            ...
            case 2:
              if (
                ...
                de && (G._$.range = [t[t.length - (C || 1)].range[0], t[t.length - 1].range[1]]),
                (Q = this.performAction.apply(G, [c, se, W, R.yy, x[1], h, t].concat(ge))),
                typeof Q < 'u')
              )
                return Q;
              (C &&
...
`,
  ...
  Me = Fe,
  tt = { db: Ve, renderer: Ge, parser: xe, styles: Me };
