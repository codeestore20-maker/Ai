...
import { R as yt } from './index-0iAZOanv.js';
import { r as M, b as vt, g as Xt } from '../vendor/vendor-emotion-DdM-9MtU.js';
import { a as Yt } from './ChatInputActionBar-CEmIn8SH.js';
...
import { u as Ne } from './useEnabledChatModels-BFidc089.js';
import { s as se } from './getPseudoElementBounds-dE4zhuHB.js';
import { P as je, M as we } from './index-Chxc_ga_.js';
import '../vendor/vendor-es-toolkit-DEdCfXFH.js';
import { h as G, f as tn } from './format-9T4dPj0t.js';
import './providerConfig-B8LLUHQ4.js';
import { c as bt, g as nn, a as on } from './pricing-CTrHA2DR.js';
import { A as rn, a as he } from './AccordionItem-Ct90feYU.js';
import { u as St } from './store-Zk6c4erU.js';
import {
  aM as sn,
  aL as an,
  I as wt,
...
import { F as Ae } from './index-COTQuEIN.js';
import {
  u as hn,
  r as fn,
  j as gn,
...
import { o as Be, q as Bn } from './index-4ACezDLV.js';
import { S as xe } from './index-BX7o7WZ0.js';
import { F as Hn } from './index-D0G2dzZj.js';
import { T as He } from './Trans-vAGQFfL0.js';
import { a as Dt } from './_auth-D9iY1Apm.js';
import { B as Wn } from './Block-DRcWCw_2.js';
import { S as Ln } from './SearchBar-Bbn5Y5cl.js';
import { S as $n } from './Segmented-TX6sA7RP.js';
...
const go = 320,
  ...
  ko = M.memo(({ model: n, provider: o }) => {
    const { t: e } = oe('chat'),
      t = hn(),
      { updateAgentChatConfig: a } = fn(),
      [i, s] = Se((c) => [Be.getAgentModelById(t)(c), Be.getAgentModelProviderById(t)(c)]),
      l = n ?? i,
      b = o ?? s,
      [v] = Ae.useForm(),
      k = Hn.useWatch(['enableReasoning'], v),
      h = Se((c) => Bn.getChatConfigById(t)(c), Ft),
      u = St(Dt.modelExtendParams(l, b)),
  ...
  No = [
    { color: 'success', icon: sn, key: 'vision' },
    { color: 'success', icon: an, key: 'files' },
    { color: 'success', icon: wt, key: 'imageOutput' },
    { color: 'magenta', icon: ln, key: 'video' },
    { color: 'info', icon: dn, key: 'functionCall' },
    { color: 'purple', icon: cn, key: 'reasoning' },
    { color: 'cyan', icon: un, key: 'search' },
  ],
  ne = M.memo(({ model: n, provider: o, enabledList: e, pricingMode: t }) => {
    const { t: a } = oe('components'),
      ...
      b = St(Dt.isModelHasExtendParams(n ?? '', o ?? '')),
      [v, k] = M.useState(() => {
        const c = ['pricing'];
                        ...
                        children: [
                          ...
                          r.jsx(ze, {
                            ...
                            children: r.jsxs(T, {
                              ...
                              align: 'center',
                              gap: 2,
                              children: [r.jsx(U, { icon: ve, size: 'small' }), u.input],
                            }),
                          }),
                          r.jsx(ze, {
                            ...
                            children: r.jsxs(T, {
                              ...
                              align: 'center',
                              gap: 2,
                              children: [r.jsx(U, { icon: ye, size: 'small' }), u.output],
                            }),
                          }),
                        ],
                      })),
                    ...
                    o.providers.map((f) => {
                      ...
                      return r.jsxs(
                        Kt,
                        {
                          ...
                          children: [
                            r.jsx(Jt, { children: x ? r.jsx(Pt, { size: 16 }) : null }),
                            r.jsx(Zt, {
                              children: r.jsxs(T, {
                                horizontal: !0,
                                align: 'center',
