import { g as te } from './chunk-55IACEB6-Bjeejiqx.js';
import { s as ee } from './chunk-KX2RTZJC-B3VwtEdY.js';
import {
  _ as u,
  l as b,
  c as w,
...
var vt = (function () {
  var t = u(function (Y, o, c, n) {
    ...
    gt = {
      ...
      performAction: u(function (o, c, n, g, E, i, J) {
        var l = i.length - 1;
        switch (E) {
          case 3:
        ...
        for (var x, M, N, mt, W = {}, dt, F, It, ft; ; ) {
          if (
            ...
            this.defaultActions[M]
              ...
              : ((x === null || typeof x > 'u') && (x = Lt()), (N = J[M] && J[M][x])),
...
Expecting ` +
              ...
              : (bt =
                  ...
                  (B + 1) +
                  ': Unexpected ' +
                  (x == q ? 'end of input' : "'" + (this.terminals_[x] || x) + "'")),
              this.parseError(bt, {
                text: D.match,
          ...
          switch (N[0]) {
            ...
            case 2:
              if (
                ...
                (mt = this.performAction.apply(W, [l, z, B, V.yy, N[1], E, i].concat(Tt))),
                typeof mt < 'u')
              )
                return mt;
              (F &&
    ...
    qt = (function () {
      var Y = {
        EOF: 1,
        parseError: u(function (c, n) {
          if (this.yy.parser) this.yy.parser.parseError(c, n);
          else throw new Error(c);
        }, 'parseError'),
        setInput: u(function (o, c) {
          return (
            (this.yy = c || this.yy || {}),
            (this._input = o),
...
` +
        ...
        next: u(function () {
          ...
          for (var E = this._currentRules(), i = 0; i < E.length; i++)
            if (
              ((n = this._input.match(this.rules[E[i]])), n && (!c || n[0].length > c[0].length))
            ) {
              if (((c = n), (g = i), this.options.backtrack_lexer)) {
                if (((o = this.test_match(n, E[i])), o !== !1)) return o;
                if (this._backtrack) {
                  c = !1;
                  continue;
                } else return !1;
          ...
          return c
            ? ((o = this.test_match(c, E[g])), o !== !1 ? o : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: u(function (c, n, g, E) {
          switch (g) {
            case 0:
              return 38;
            case 1:
...
var Be = vt,
  ...
  Ne = u(async function (t, e, s, a) {
    ...
    ((S.type = a.type),
      (S.layoutAlgorithm = d),
      (S.nodeSpacing = h?.nodeSpacing || 50),
      (S.rankSpacing = h?.rankSpacing || 50),
      (S.markers = ['barb']),
      (S.diagramId = e),
      await se(S, f));
    const T = 8;
    try {
      (typeof a.db.getLinks == 'function' ? a.db.getLinks() : new Map()).forEach((m, A) => {
        ...
        (R.replaceChild(L, k),
          L.appendChild(k),
          b.info('🔗 Wrapped node in <a> tag for:', v, m.url));
      });
    } catch (_) {
      b.error('❌ Error injecting clickable links:', _);
    }
    (ie.insertTitle(f, 'statediagramTitleText', h?.titleTopMargin ?? 25, a.db.getDiagramTitle()),
      ee(f, T, et, h?.useMaxWidth ?? !0));
  }, 'draw'),
  Ve = { getClasses: Re, draw: Ne, getDir: Kt },
  St = new Map(),
  G = 0;
    ...
    (b.trace('items', e),
      e.forEach((f) => {
        switch (f.stmt) {
          ...
          case Ct:
            {
              (Z(t, f.state1, s, a, r, h, d, S), Z(t, f.state2, s, a, r, h, d, S));
              const T = {
                id: 'edge' + G,
                start: f.state1.id,
                end: f.state2.id,
...
var Z = u((t, e, s, a, r, h, d, S) => {
    ...
    if ((b.info('dataFetcher parsedItem', e, T, m), f !== 'root')) {
      ...
      (e.description &&
        (Array.isArray(p.description)
          ? ((p.shape = kt), p.description.push(e.description))
          : p.description?.length && p.description.length > 0
            ? ((p.shape = kt),
              p.description === f
                ? (p.description = [e.description])
                : (p.description = [p.description, e.description]))
            : ((p.shape = Dt), (p.description = e.description)),
        (p.description = U.sanitizeTextOrArray(p.description, A))),
        p.description?.length === 1 &&
          p.shape === kt &&
          (p.type === 'group' ? (p.shape = Nt) : (p.shape = Dt)),
        !p.type &&
          e.doc &&
          (b.info('Setting cluster for XCX', f, $t(e)),
          (p.type = 'group'),
          (p.isGroup = !0),
          (p.dir = $t(e)),
          (p.shape = e.type === Gt ? Rt : Nt),
          (p.cssClasses = `${p.cssClasses} ${Ae} ${h ? Le : ''}`)));
      const k = {
        labelStyle: '',
        shape: p.shape,
        label: p.description,
      ...
      if (
        ...
        t &&
          t.id !== 'root' &&
          (b.trace('Setting node ', f, ' to be child of its parent ', t.id), (k.parentId = t.id)),
        (k.centerLabel = !0),
        e.note)
      ) {
        const R = {
        ...
        let I = f,
          P = R.id;
        (e.note.position === 'left of' && ((I = R.id), (P = f)),
          r.push({
            id: I + '-' + P,
            start: I,
            end: P,
  ...
  Pt = u(() => new Map(), 'newClassesList'),
  Ft = u(() => ({ relations: [], states: new Map(), documents: {} }), 'newDoc'),
  pt = u((t) => JSON.parse(JSON.stringify(t)), 'clone'),
  j,
  Me =
    ((j = class {
      constructor(e) {
      ...
      extract(e) {
        ...
        const s = this.getStates(),
          a = w();
        ($e(), Z(void 0, this.getRootDocV2(), s, this.nodes, this.edges, !0, a.look, this.classes));
      ...
      docTranslator(e, s, a) {
        ...
        if (r.length > 0 && h.length > 0) {
          const d = { stmt: X, id: he(), type: 'divider', doc: pt(h) };
          (r.push(pt(d)), (s.doc = r));
        }
      ...
      getRootDocV2() {
        return (
          this.docTranslator({ id: K, stmt: K }, { id: K, stmt: K, doc: this.rootDoc }, !0),
      ...
      addState(e, s = tt, a = void 0, r = void 0, h = void 0, d = void 0, S = void 0, f = void 0) {
        ...
        if (
          (r &&
            (b.info('Setting state description', T, r),
            (Array.isArray(r) ? r : [r]).forEach((m) => this.addDescription(T, m.trim()))),
          h)
        ) {
          const _ = this.currentDocument.states.get(T);
          if (!_) throw new Error(`State not found: ${T}`);
        ...
        (d &&
          ...
          f &&
            (b.info('Setting state styles', T, S),
            (Array.isArray(f) ? f : [f]).forEach((m) => this.setTextStyle(T, m.trim()))));
      }
      clear(e) {
        ((this.nodes = []),
          (this.edges = []),
      ...
      addRelationObjs(e, s, a = '') {
        const r = this.startIdIfNeeded(e.id.trim()),
          h = this.startTypeIfNeeded(e.id.trim(), e.type),
      ...
      addDescription(e, s) {
        const a = this.currentDocument.states.get(e),
          r = s.startsWith(':') ? s.replace(':', '').trim() : s;
      ...
      addStyleClass(e, s = '') {
        ...
        s &&
          a &&
          s.split(C.STYLECLASS_SEP).forEach((r) => {
