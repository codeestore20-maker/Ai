import { _ as R, a as A, b as L } from './index-D75tDTkj.js';
import { a as $, E as H, b as N, c as W } from './consoleHook-59e792cb-CwMz6hFJ.js';
import { S as D } from './base-80a1f760-IPNbIDMK.js';
...
function B() {
  ...
  var u = Object.create,
    ...
    o = (a, e) =>
      function () {
        return (e || (0, a[n(a)[0]])((e = { exports: {} }).exports, e), e.exports);
      },
    x = (a, e) => {
      for (var c in e) p(a, c, { get: e[c], enumerable: !0 });
    },
    b = (a, e, c, r) => {
      if ((e && typeof e == 'object') || typeof e == 'function')
        for (let t of n(e))
          !l.call(a, t) &&
            t !== c &&
            p(a, t, { get: () => e[t], enumerable: !(r = i(e, t)) || r.enumerable });
      return a;
    },
    m = (a, e, c) => (
      (c = a != null ? u(s(a)) : {}),
      b(!a || !a.__esModule ? p(c, 'default', { value: a, enumerable: !0 }) : c, a)
    ),
    h = (a) => b(p({}, '__esModule', { value: !0 }), a),
    T = o({
      'node_modules/.pnpm/mime-db@1.52.0/node_modules/mime-db/db.json'(a, e) {
        e.exports = {
    ...
    P = o({
      'node_modules/.pnpm/mime-db@1.52.0/node_modules/mime-db/index.js'(a, e) {
        e.exports = T();
      },
    }),
    j = {};
  ...
  var g = '$CSB_RELAY',
    S = m(P()),
    z = new Map(),
    E = Object.entries(S.default);
  for (const [a, e] of E) {
    const c = e.extensions;
    if (c?.length) for (const r of c) z.set(r, a);
  }
  var C = z,
    M = 0;
  function I() {
  ...
  var O = class {
    constructor(a) {
      ((this.initPromise = null),
        (this.baseUrl = new URL(a.baseUrl)),
        (this.getFileContent = a.getFileContent),
        (this.indexFiles = a.indexFiles ?? ['index.html', 'index.html']));
    }
    async getIndexAtPath(a) {
      for (const e of this.indexFiles)
        try {
          return await this.getFileContent(q(a, e));
        } catch {}
      throw new Error('No index file not found');
    }
    async handleWorkerRequest(a) {
      if (!this.initPromise) throw new Error('Init promise is null');
      const [e, c] = await this.initPromise;
      try {
        const r = w(new URL(a.url, e).pathname);
        let t = null;
        const v = {};
        try {
          t = await this.getFileContent(r);
        } catch {}
        if (
          (t == null &&
            ((t = await this.getIndexAtPath(r)), (v['Content-Type'] = 'text/html; charset=utf-8')),
          t == null)
        )
    ...
    async _initPreview() {
      ...
      ((e.hostname = a + '-' + e.hostname), (e.pathname = '/'));
      const c = this.getRelayUrl(e.toString()),
        r = document.createElement('iframe');
      (r.setAttribute('src', c.toString()),
        (r.style.display = 'none'),
        document.body.appendChild(r));
      const t = new MessageChannel(),
        v = r.contentWindow;
      if (!v) throw new Error('Could not get iframe contentWindow');
      return new Promise((y) => {
        const f = t.port1;
        ((f.onmessage = (d) => {
          if (typeof d.data == 'object' && d.data.$channel === g)
            switch (d.data.$type) {
              case 'preview/ready':
                y([e.toString(), f, r]);
                break;
              case 'preview/request':
                this.handleWorkerRequest(d.data);
                break;
            }
        }),
          (r.onload = () => {
            const d = { $channel: g, $type: 'preview/init' };
            v.postMessage(d, '*', [t.port2]);
          }));
      });
    }
    initPreview() {
      return (
        this.initPromise || (this.initPromise = this._initPreview()),
        this.initPromise.then((a) => a[0])
      );
    }
    destroy() {
      this.initPromise &&
        (this.initPromise.then((e) => {
          e[1].close();
          const c = this.getRelayUrl(e[0]);
          document.body.querySelectorAll(`src="${c}"`).forEach((t) => t.remove());
        }),
        (this.initPromise = null));
    }
  };
...
var J = B(),
  ...
  X = function (u) {
    var p = F(u),
      i = new DOMParser(),
      n = i.parseFromString(p, 'text/html');
...
`.concat(s);
  ...
  bn = (function (u) {
    ...
    function p(i, n, s) {
      s === void 0 && (s = {});
      var l,
        o = u.call(this, i, n, s) || this;
      if (
        ((o.files = new Map()),
        (o.status = 'initializing'),
        (o.emitter = new H()),
        (o.previewController = new J.PreviewController({
          baseUrl:
            (l = s.bundlerURL) !== null && l !== void 0
              ? l
              : 'https://preview.sandpack-static-server.codesandbox.io',
          getFileContent: function (b) {
            var m = o.files.get(b);
            if (!m) throw new Error('File not found');
            if (b.endsWith('.html') || b.endsWith('.htm'))
              try {
                ((m = X(m)),
                  (m = o.injectProtocolScript(m)),
                  (m = o.injectExternalResources(m, s.externalResources)),
                  (m = o.injectScriptIntoHead(m, { script: W, scope: { channelId: N() } })));
              } catch (h) {
                console.error('Runtime injection failed', h);
              }
            return m;
          },
        })),
        ...
        ((o.element = x), (o.iframe = document.createElement('iframe')));
      } else ((o.element = i), (o.iframe = i));
      return (
    ...
    return (
      (p.prototype.injectContentIntoHead = function (i, n) {
        var s;
        return (
          (i = F(i)),
          (i =
...
` +
      ...
      (p.prototype.injectProtocolScript = function (i) {
        var n = `<script>
...
<\/script>`;
        return this.injectContentIntoHead(i, n);
      }),
      (p.prototype.injectExternalResources = function (i, n) {
        n === void 0 && (n = []);
        var s = n.map(function (l) {
          var o = l.match(/\.([^.]*)$/),
            x = o?.[1];
          if (x === 'css' || l.includes('fonts.googleapis'))
            return '<link rel="stylesheet" href="'.concat(l, '">');
          if (x === 'js') return '<script src="'.concat(l, '"><\/script>');
          throw new Error('Unable to determine file type for external resource: '.concat(l));
        }).join(`
`);
        return this.injectContentIntoHead(i, s);
      }),
      (p.prototype.injectScriptIntoHead = function (i, n) {
        var s = n.script,
          l = n.scope,
          o = l === void 0 ? {} : l,
          x = `
    ...
    `,
            ...
            .trim();
        return this.injectContentIntoHead(i, x);
      }),
      (p.prototype.updateSandbox = function (i, n) {
        i === void 0 && (i = this.sandboxSetup);
        var s = $(i.files);
        this.dispatch({ codesandbox: !0, modules: s, template: i.template, type: 'compile' });
      }),
      (p.prototype.compile = function (i) {
        return A(this, void 0, void 0, function () {
          ...
          return L(this, function (s) {
            switch (s.label) {
              case 0:
                return (
                  (this.files = new Map(Object.entries(i))),
      ...
      (p.prototype.eventListener = function (i) {
        if (i.source === this.iframe.contentWindow) {
          var n = i.data;
          n.codesandbox && this.dispatch(n);
        }
      }),
      (p.prototype.dispatch = function (i) {
        var n;
        i.type === 'compile'
          ? this.compile(i.modules)
          : ((n = this.iframe.contentWindow) === null || n === void 0 || n.postMessage(i, '*'),
            this.emitter.dispatch(i));
      }),
      (p.prototype.listen = function (i) {
        return this.emitter.listener(i);
      }),
      (p.prototype.destroy = function () {
        (this.emitter.cleanup(),
          typeof window < 'u' && window.removeEventListener('message', this.eventListener));
      }),
      p
    );
  })(D);
export { bn as SandpackStatic };
