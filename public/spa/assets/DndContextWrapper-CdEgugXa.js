...
import { F as Ce } from './index-DuC_d2Pa.js';
import { t as Ve } from './index-DaaCQ1_i.js';
import { u as G } from './index-Db46Nfj1.js';
import { u as U, b as Y, d as Xe } from './store-DPVFoUA8.js';
import { u as Te } from './store-BjR_Vge-.js';
import { B as ge } from './Block-DRcWCw_2.js';
import { b as pe } from './SortableList-BAvO8YgC.js';
import {
  b5 as be,
  $ as re,
  cW as me,
...
import { a as tr } from './imperative-Dtu7KcF3.js';
import { L as he } from './index-VzDe8hCZ.js';
import { u as or } from './useAppOrigin-5rnG8iNn.js';
import { d as ye } from './downloadFile-DYbfnmZ_.js';
import { M as nr } from './Modal-Uxr9iemi.js';
import { R as Ie } from './Table-CeFUm3yf.js';
import { I as sr } from './index-MPEu_fqB.js';
import { S as Fe } from './index-ByEGfox1.js';
const ar = () => {
    const e = We(),
      n = Oe(),
      h = e.id || null,
  ...
  X = async (e) => {
    ...
    try {
      const { mutate: c } = await ve(
          async () => {
            const { mutate: l } = await import('./index-NXWXCubP.js').then((f) => f.kG);
            return { mutate: l };
          },
      ...
      async (d) => {
        ...
        try {
          ...
          const { mutate: r } = await ve(
              async () => {
                const { mutate: y } = await import('./index-NXWXCubP.js').then((E) => E.kG);
                return { mutate: y };
              },
              __vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7, 8]),
            ),
