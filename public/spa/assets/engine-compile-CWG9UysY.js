...
const je = x`\[\^?`,
  Xe = `c.? | C(?:-.?)?|${x`[pP]\{(?:\^?[-\x20_]*[A-Za-z][-\x20\w]*\})?`}|${x`x[89A-Fa-f]\p{AHex}(?:\\x[89A-Fa-f]\p{AHex})*`}|${x`u(?:\p{AHex}{4})? | x\{[^\}]*\}? | x\p{AHex}{0,2}`}|${x`o\{[^\}]*\}?`}|${x`\d{1,3}`}`,
  xe = /[?*+][?+]?|\{(?:\d+(?:,\d*)?|,\d+)\}\??/,
  K = new RegExp(
    x`
  \\ (?:
...
function br(e, t = {}) {
  ...
  for (K.lastIndex = 0; (i = K.exec(e)); ) {
    const p = Cr(s, e, i[0], K.lastIndex);
    (p.tokens ? o.push(...p.tokens) : p.token && o.push(p.token),
      p.lastIndex !== void 0 && (K.lastIndex = p.lastIndex));
  }
  const u = [];
  let c = 0;
  (o
  ...
  const l = c || u.length;
  return { tokens: o.map((p) => (p.type === 'EscapedNumber' ? Tr(p, l) : p)).flat(), flags: n };
}
function Cr(e, t, r, n) {
  const [a, s] = r;
  if (r === '[' || r === '[^') {
  ...
  if (a === '(') {
    ...
    if (
      ...
      return { token: z('capturing', r, { ...(r !== '(' && { name: r.slice(3, -1) }) }) };
    if (r.startsWith('(?~')) {
    ...
    throw r === '(?('
      ...
      : new Error(`Invalid or unsupported group option "${r}"`);
  }
  if (r === ')') {
...
`,
  ...
  return r === '|' ? { token: $r(r) } : xe.test(r) ? { tokens: Br(r) } : { token: L(H(r), r) };
}
function xr(e, t, r) {
  const n = [Se(t[1] === '^', t)];
  let a = 1,
...
function kr(e) {
  ...
  if (e[0] === '[') {
    ...
    if (!t || !Ce.has(t.groups.name)) throw new Error(`Invalid POSIX class "${e}"`);
    return U('posix', e, { value: t.groups.name, negate: !!t.groups.negate });
  }
  return e === '-' ? Ar(e) : e === '&&' ? Ir(e) : L(H(e), e);
}
function Ze(e, { inCharClass: t }) {
  const r = e[1];
  if (r === 'c' || r === 'C') return Fr(e);
  if ('dDhHsSwW'.includes(r)) return Rr(e);
  if (e.startsWith(x`\o{`))
  ...
  if (new RegExp('^\\\\x[89A-Fa-f]\\p{AHex}', 'u').test(e))
    try {
      const n = e
          ...
          .slice(1)
          .map((o) => parseInt(o, 16)),
        a = new TextDecoder('utf-8', { ignoreBOM: !0, fatal: !0 }).decode(new Uint8Array(n)),
        s = new TextEncoder();
      return [...a].map((o) => {
  ...
  if (r === 'u' || r === 'x') return L(Dr(e), e);
  if (ve.has(r)) return L(ve.get(r), e);
  if (/\d/.test(r)) return Sr(t, e);
...
function qe(e, t, r = {}) {
  return e === 'keep'
    ...
    : { type: 'Directive', kind: e, flags: j(r.flags), raw: t };
}
function Sr(e, t) {
...
const Lr = new Set(['COUNT', 'CMP', 'ERROR', 'FAIL', 'MAX', 'MISMATCH', 'SKIP', 'TOTAL_COUNT']),
  ve = new Map([
    ['a', 7],
    ['b', 8],
    ['e', 27],
...
function Gr(e, t) {
  ...
  n ??= '';
  const a = (t.getCurrentModX() || r.includes('x')) && !n.includes('x'),
    s = Me(r),
    o = Me(n),
    i = {};
  if ((s && (i.enable = s), o && (i.disable = o), e.endsWith(')')))
    return (t.replaceCurrentModX(a), qe('flags', e, { flags: i }));
  if (e.endsWith(':'))
    return (t.pushModX(a), t.numOpenGroups++, z('group', e, { ...((s || o) && { flags: i }) }));
...
function Pr(e) {
  ...
  const s = a
      ...
      : [],
    [o, i, u] = s,
    c = Lr.has(r) ? r.toLowerCase() : 'custom';
  switch (c) {
    case 'fail':
    case 'mismatch':
    case 'skip':
  ...
  return _r(c, n ?? null, a?.split(',') ?? null, e);
}
function _e(e) {
  let t = null,
    r,
    n;
  if (e[0] === '{') {
    const { minStr: a, maxStr: s } = /^\{(?<minStr>\d*)(?:,(?<maxStr>\d*))?/.exec(e).groups,
      o = 1e5;
    if (+a > o || (s && +s > o)) throw new Error('Quantifier value unsupported in Oniguruma');
    if (
      ((r = +a),
      (n = s === void 0 ? +a : s === '' ? 1 / 0 : +s),
      r > n && ((t = 'possessive'), ([r, n] = [n, r])),
      e.endsWith('?'))
    ) {
      if (t === 'possessive')
  ...
  for (let i = 0; i < o.length; i++) {
    ...
    if (i === 0 && u !== '8' && u !== '9') {
      if (((c = parseInt(u, 8)), c > 127))
        throw new Error(x`Octal encoded byte above 177 unsupported "${r}"`);
    } else c = H(u);
    s.push(L(c, (i === 0 ? '\\' : '') + u));
  }
  return s;
...
function Ke(e, t = {}) {
    ...
    a = (f, g) => {
      ...
      switch (((s.parent = f), s.nextIndex++, d.type)) {
        ...
        case 'CharacterSet':
          return Zr(d, s);
        case 'Directive':
          return et(d.kind, { flags: d.flags });
        case 'GroupOpen':
          return Qr(d, s, g);
        case 'NamedCallout':
          return tt(d.kind, d.tag, d.arguments);
        case 'Quantifier':
          return qr(d, s);
        case 'Subroutine':
          return Jr(d, s);
  ...
  if (c && l.size && !r.rules.captureGroup)
...
function Hr({ raw: e }, t) {
  const r = /^\\k[<']/.test(e),
    ...
    a = (s, o = !1) => {
      ...
      let u = !1;
      if (s > i)
        if (t.skipBackrefValidation) u = !0;
...
function jr(e, t, r) {
  ...
  if (
    ...
    if (o.type === 'Character' && u.type === 'Character') return (s.body.pop(), Yr(o, u));
    throw new Error('Invalid character class range');
  }
  return ne(H('-'));
}
function Xr({ negate: e }, t, r) {
  const { tokens: n, walk: a } = t,
    s = n[t.nextIndex],
    o = [re()];
  let i = Fe(s);
  for (; i.type !== 'CharacterClassClose'; ) {
    if (i.type === 'CharacterClassIntersector') (o.push(re()), t.nextIndex++);
    else {
      const c = o.at(-1);
      c.body.push(a(c, r));
    }
    i = Fe(n[t.nextIndex], s);
  }
  const u = re({ negate: e });
  return (
    o.length === 1
      ? (u.body = o[0].body)
      : ((u.kind = 'intersection'), (u.body = o.map((c) => (c.body.length === 1 ? c.body[0] : c)))),
    t.nextIndex++,
    u
  );
}
function Zr({ kind: e, negate: t, value: r }, n) {
  const {
    normalizeUnknownPropertyNames: a,
    skipPropertyNameValidation: s,
    unicodePropertyMap: o,
  } = n;
  if (e === 'property') {
    const i = se(r);
    if (Ce.has(i) && !o?.has(i)) ((e = 'posix'), (r = i));
    else
      return W(r, {
        negate: t,
        normalizeUnknownPropertyNames: a,
  ...
  return e === 'posix' ? nt(r, { negate: t }) : we(e, { negate: t });
}
function Qr(e, t, r) {
  const {
      tokens: n,
    ...
    u = at(e),
    c = u.type === 'AbsenceFunction',
    l = Le(u),
    p = l && u.negate;
  if (
    (u.type === 'CapturingGroup' && (a.push(u), u.name && yr(s, u.name, []).push(u)),
    ...
    if (f.type === 'Alternator') (u.body.push(O()), t.nextIndex++);
      ...
      const g = u.body.at(-1),
        d = i(g, {
          ...
          isInLookbehind: r.isInLookbehind || l,
          isInNegLookbehind: r.isInNegLookbehind || p,
        });
...
function qr({ kind: e, min: t, max: r }, n) {
  const a = n.parent,
    s = a.body.at(-1);
  if (!s || !Vr(s)) throw new Error('Quantifier requires a repeatable token');
  const o = er(e, t, r, s);
  return (a.body.pop(), o);
}
function Jr({ raw: e }, t) {
  ...
  if (s) {
    const i = +s.groups.num,
      u = r.length;
    if (
      ((t.hasNumberedRef = !0), (a = { '': i, '+': u + i, '-': u + 1 - i }[s.groups.sign]), a < 1)
    )
...
function Ye(e, t) {
  ...
  if (r.name !== void 0 && !ot(r.name))
    throw new Error(`Group name "${r.name}" invalid in Oniguruma`);
  return {
    type: 'CapturingGroup',
    number: e,
    ...(r.name && { name: r.name }),
    ...(r.isSubroutined && { isSubroutined: r.isSubroutined }),
    body: q(t?.body),
  };
}
function ne(e, t) {
  ...
  if (e > 1114111) {
    ...
    if (r.useLastValid) e = 1114111;
      ...
      throw e > 1310719
        ? new Error(`Invalid code point out of range "\\x{${n}}"`)
        : new Error(`Invalid code point out of range in JS "\\x{${n}}"`);
  }
...
function we(e, t) {
  ...
  return (
    (e === 'digit' || e === 'hex' || e === 'newline' || e === 'space' || e === 'word') &&
      (n.negate = r),
    (e === 'text_segment' || (e === 'newline' && !r)) && (n.variableLength = !0),
    n
  );
}
function et(e, t = {}) {
...
function W(e, t) {
  ...
  if (!n) {
    if (r.normalizeUnknownPropertyNames) n = it(e);
...
function at({ flags: e, kind: t, name: r, negate: n, number: a }) {
  switch (t) {
...
function q(e) {
  if (e === void 0) e = [O()];
  else if (!Array.isArray(e) || !e.length || !e.every((t) => t.type === 'Alternative'))
...
function it(e) {
  return e
    ...
    .replace(/[A-Za-z]+/g, (t) => t[0].toUpperCase() + t.slice(1).toLowerCase());
}
function se(e) {
...
function Z(e, t, r = null) {
  ...
  function a(s, o = null, i = null, u = null) {
    ...
    const p = {
        ...
        replaceWith(y, $ = {}) {
          const E = !!$.traverse;
          (u ? (u[Math.max(0, B(i) + c)] = y) : (j(o, "Can't replace root node")[i] = y),
            E && a(y, o, i, u),
            (l = !0));
        },
      ...
      g = t['*'],
      d = t[f],
      w = typeof g == 'function' ? g : g?.enter,
      m = typeof d == 'function' ? d : d?.enter;
    if ((w?.(p, r), m?.(p, r), !l))
      switch (f) {
...
const ut = String.raw`\(\?(?:[:=!>A-Za-z\-]|<[=!]|\(DEFINE\))`;
function ct(e, t) {
  for (let r = 0; r < e.length; r++) e[r] >= t && e[r]++;
}
function lt(e, t, r, n) {
  return e.slice(0, t) + n + e.slice(t + r.length);
}
const S = Object.freeze({ DEFAULT: 'DEFAULT', CHAR_CLASS: 'CHAR_CLASS' });
function ke(e, t, r, n) {
  const a = new RegExp(String.raw`${t}|(?<$skip>\[\^?|\\?.)`, 'gsu'),
    s = [!1];
  let o = 0,
    i = '';
  for (const u of e.matchAll(a)) {
    ...
    if (!l && (!n || (n === S.DEFAULT) == !o)) {
      r instanceof Function
        ? (i += r(u, { context: o ? S.CHAR_CLASS : S.DEFAULT, negated: s[s.length - 1] }))
        : (i += r);
      continue;
    }
...
const Pe = new RegExp(
  String.raw`(?<noncapturingStart>${ut})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`,
  'gsu',
);
function dt(e, t) {
  const r = t?.hiddenCaptures ?? [];
  let n = t?.captureTransfers ?? new Map();
  if (!/\(\?>/.test(e)) return { pattern: e, captureTransfers: n, hiddenCaptures: r };
  const a = '(?>',
    s = '(?:(?=(',
    o = [0],
    i = [];
  ...
  do {
    ...
    for (Pe.lastIndex = Number.isNaN(l) ? 0 : l + s.length; (w = Pe.exec(e)); ) {
      const {
        0: m,
        index: y,
        groups: { capturingStart: $, noncapturingStart: E },
      } = w;
      if (m === '[') f++;
      else if (f) m === ']' && f--;
      else if (m === a && !d) ((l = y), (d = !0));
      else if (d && E) g++;
      else if ($) d ? g++ : (u++, o.push(u + c));
      else if (m === ')' && d) {
        if (!g) {
          c++;
          const k = u + c;
          if (
            ((e = `${e.slice(0, l)}${s}${e.slice(l + a.length, y)}))<$$${k}>)${e.slice(y + 1)}`),
            (p = !0),
            i.push(k),
            ct(r, k),
            n.size)
  ...
  return (
    ...
    (e = ke(
      ...
      ({ 0: f, groups: { backrefNum: g, wrappedBackrefNum: d } }) => {
        if (g) {
          const w = +g;
          if (w > o.length - 1) throw new Error(`Backref "${f}" greater than number of captures`);
          return `\\${o[w]}`;
        }
        return `\\${d}`;
      },
    ...
    { pattern: e, captureTransfers: n, hiddenCaptures: r }
  );
}
...
function gt(e) {
  if (!new RegExp(`${sr}\\+`).test(e)) return { pattern: e };
  const t = [];
  let r = null,
    n = null,
    a = '',
  ...
  for (ue.lastIndex = 0; (o = ue.exec(e)); ) {
    const {
      0: i,
      index: u,
      groups: { qBase: c, qMod: l, invalidQ: p },
    } = o;
    if (i === '[') (s || (n = u), s++);
    else if (i === ']') s ? s-- : (n = null);
    else if (!s)
      if (l === '+' && a && !a.startsWith('(')) {
        if (p) throw new Error(`Invalid quantifier "${i}"`);
        let f = -1;
        if (/^\{\d+\}$/.test(c)) e = lt(e, u + c.length, l, '');
        else {
          if (a === ')' || a === ']') {
            const g = a === ')' ? r : n;
            if (g === null) throw new Error(`Invalid unmatched "${a}"`);
            e = `${e.slice(0, g)}(?>${e.slice(g, u)}${c})${e.slice(u + i.length)}`;
          } else e = `${e.slice(0, u - a.length)}(?>${a}${c})${e.slice(u + i.length)}`;
          f += 4;
        }
        ue.lastIndex += f;
...
const I = String.raw,
  ht = I`\\g<(?<gRNameOrNum>[^>&]+)&R=(?<gRDepth>[^>]+)>`,
  me = I`\(\?R=(?<rDepth>[^\)]+)\)|${ht}`,
  ae = I`\(\?<(?![=!])(?<captureName>[^>]+)>`,
  ar = I`${ae}|(?<unnamed>\()(?!\?)`,
  P = new RegExp(I`${ae}|${me}|\(\?|\\?.`, 'gsu'),
  ce = 'Cannot use multiple overlapping recursions';
function wt(e, t) {
  const { hiddenCaptures: r, mode: n } = { hiddenCaptures: [], mode: 'plugin', ...t };
  let a = t?.captureTransfers ?? new Map();
  if (!new RegExp(me, 'su').test(e)) return { pattern: e, captureTransfers: a, hiddenCaptures: r };
  if (n === 'plugin' && ee(e, I`\(\?\(DEFINE\)`, S.DEFAULT))
    throw new Error('DEFINE groups cannot be used with recursion');
  const s = [],
    o = ee(e, I`\\[1-9]`, S.DEFAULT),
    i = new Map(),
    u = [];
  let c = !1,
    l = 0,
  ...
  for (P.lastIndex = 0; (f = P.exec(e)); ) {
    const {
      0: g,
      groups: { captureName: d, rDepth: w, gRNameOrNum: m, gRDepth: y },
    } = f;
    if (g === '[') l++;
    else if (l) g === ']' && l--;
    else if (w) {
      if ((Re(w), c)) throw new Error(ce);
      if (o)
        throw new Error(
          `${n === 'external' ? 'Backrefs' : 'Numbered backrefs'} cannot be used with global recursion`,
        );
      const $ = e.slice(0, f.index),
        E = e.slice(P.lastIndex);
      if (ee(E, me, S.DEFAULT)) throw new Error(ce);
      const k = +w - 1;
      ((e = Ue($, E, k, !1, r, s, p)), (a = De(a, $, k, s.length, 0, p)));
      break;
    } else if (m) {
      Re(y);
      let $ = !1;
      for (const X of u)
        if (X.name === m || X.num === +m) {
          if ((($ = !0), X.hasRecursedWithin)) throw new Error(ce);
          break;
        }
      if (!$)
        throw new Error(
          I`Recursive \g cannot be used outside the referenced group "${n === 'external' ? m : I`\g<${m}&R=${y}>`}"`,
        );
      const E = i.get(m),
        k = ft(e, E);
      ...
      const A = e.slice(E, f.index),
        J = k.slice(A.length + g.length),
        D = s.length,
        T = +y - 1,
        Ae = Ue(A, J, T, !0, r, s, p);
      a = De(a, A, T, s.length - D, D, p);
      const wr = e.slice(0, E),
        mr = e.slice(E + k.length);
      ((e = `${wr}${Ae}${mr}`),
        (P.lastIndex += Ae.length - g.length - A.length - J.length),
        u.forEach((X) => (X.hasRecursedWithin = !0)),
        (c = !0));
    } else if (d)
      (p++, i.set(String(p), P.lastIndex), i.set(d, P.lastIndex), u.push({ num: p, name: d }));
    else if (g[0] === '(') {
      const $ = g === '(';
      ($ && (p++, i.set(String(p), P.lastIndex)), u.push($ ? { num: p } : {}));
    } else g === ')' && u.pop();
  }
  return (r.push(...s), { pattern: e, captureTransfers: a, hiddenCaptures: r });
}
function Re(e) {
  ...
  for (let l = 0; l < r; l++) {
    ...
    c += ke(
      ...
      ({ 0: f, groups: { captureName: g, unnamed: d, backref: w } }) => {
        if (w && n && !n.has(w)) return f;
        const m = `_$${p}`;
        if (d || g) {
          const y = o + s.length + 1;
          return (s.push(y), mt(a, y), d ? f : `(?<${g}${m}>`);
        }
        return I`\k<${w}${m}>`;
      },
      S.DEFAULT,
  ...
  if (e.size && n) {
    ...
    return (
      e.forEach((c, l) => {
        ...
        for (const w of c)
          if (w <= i) d.push(w);
          else if (w > i + o + p) d.push(w + n);
          else if (w <= i + o) for (let m = 0; m <= r; m++) d.push(w + o * m);
          else for (let m = 0; m <= r; m++) d.push(w + f + p * m);
        u.set(g, d);
      }),
      u
    );
...
var Te = { ES2025: 2025, ES2024: 2024, ES2018: 2018 },
  bt = { auto: 'auto', ES2025: 'ES2025', ES2024: 'ES2024', ES2018: 'ES2018' };
function or(e = {}) {
  if ({}.toString.call(e) !== '[object Object]') throw new Error('Unexpected options');
  if (e.target !== void 0 && !bt[e.target]) throw new Error(`Unexpected target "${e.target}"`);
  const t = {
    accuracy: 'default',
    avoidSubclass: !1,
    flags: '',
  ...
  return (
    t.target === 'auto' &&
      (t.target = _.flagGroups ? 'ES2025' : _.unicodeSets ? 'ES2024' : 'ES2018'),
    t
  );
}
var Ct = '[	-\r ]',
  xt = new Set([C(304), C(305)]),
  M = h`[\p{L}\p{M}\p{N}\p{Pc}]`;
function ir(e) {
  if (xt.has(e)) return [e];
  const t = new Set(),
    r = e.toLowerCase(),
    n = r.toUpperCase(),
    a = Et.get(r),
...
function St(e, t) {
  ...
  return (Z(e, Mt, o), (e._originMap = s.groupOriginByCopy), (e._strategy = n.strategy), e);
}
var vt = {
    AbsenceFunction({ node: e, parent: t, replaceWith: r }) {
      ...
      if (a === 'repeater') {
        const s = v();
        s.body[0].body.push(R({ negate: !0, body: n }), W('Any'));
        const o = v();
        (o.body[0].body.push(er('greedy', 0, 1 / 0, s)), r(b(o, t), { traverse: !0 }));
    ...
    Assertion({ node: e, parent: t, key: r, container: n, root: a, remove: s, replaceWith: o }, i) {
      const { kind: u, negate: c } = e,
        { asciiWordBoundaries: l, avoidSubclass: p, supportedGNodes: f, wordIsAscii: g } = i;
      if (u === 'text_segment_boundary')
        throw new Error(`Unsupported text segment boundary "\\${c ? 'Y' : 'y'}"`);
      if (u === 'line_end')
        o(b(R({ body: [O({ body: [ge('string_end')] }), O({ body: [ne(10)] })] }), t));
      else if (u === 'line_start')
        o(b(N(h`(?<=\A|\n(?!\z))`, { skipLookbehindValidation: !0 }), t));
      else if (u === 'search_start')
        if (f.has(e)) ((a.flags.sticky = !0), s());
        else {
          const d = n[r - 1];
          if (d && Rt(d)) o(b(R({ negate: !0 }), t));
          else {
            if (p) throw new Error(h`Uses "\G" in a way that requires a subclass`);
            (o(G(ge('string_start'), t)), (i.strategy = 'clip_search'));
          }
        }
      else if (!(u === 'string_end' || u === 'string_start'))
        if (u === 'string_end_newline') o(b(N(h`(?=\n?\z)`), t));
    ...
    CharacterSet(
      ...
      { accuracy: n, minTargetEs2024: a, digitIsAscii: s, spaceIsAscii: o, wordIsAscii: i },
    ) {
      ...
      if (u === 'any') r(G(W('Any'), t));
      else if (u === 'digit') r(G(W('Nd', { negate: c }), t));
      else if (u !== 'dot')
        if (u === 'text_segment') {
          if (n === 'strict') throw new Error(h`Use of "\X" requires non-strict accuracy`);
          const p = '\\p{Emoji}(?:\\p{EMod}|\\uFE0F\\u20E3?|[\\x{E0020}-\\x{E007E}]+\\x{E007F})?',
            f = h`\p{RI}{2}|${p}(?:\u200D${p})*`;
          r(
            b(
        ...
        } else if (u === 'hex') r(G(W('AHex', { negate: c }), t));
        else if (u === 'newline')
          r(
            b(
              N(
...
\v\f\u2028\u2029])`,
          ...
          if (!a && (l === 'graph' || l === 'print')) {
            if (n === 'strict')
              throw new Error(
                `POSIX class "${l}" requires min target ES2024 or non-strict accuracy`,
              );
            let p = { graph: '!-~', print: ' -~' }[l];
            (c && (p = `\0-${C(p.codePointAt(0) - 1)}${C(p.codePointAt(2) + 1)}-􏿿`),
              r(b(N(`[${p}]`), t)));
          } else r(b(de(N(At.get(l)), c), t));
        else if (u === 'property') $e.has(se(l)) || (e.key = 'sc');
        else if (u === 'space') r(G(W('space', { negate: c }), t));
        else if (u === 'word') r(b(de(N(M), c), t));
    ...
    Directive({
      ...
      if (i === 'flags')
        if (!u.enable && !u.disable) n();
        else {
          const c = v({ flags: u });
          ((c.body[0].body = o()), a(b(c, t), { traverse: !0 }));
        }
      else if (i === 'keep') {
        const c = r.body[0],
          p =
            r.body.length === 1 && Je(c, { type: 'Group' }) && c.body[0].body.length === 1
              ? c.body[0]
              : r;
        if (t.parent !== p || p.body.length > 1)
          throw new Error(h`Uses "\K" in a way that's unsupported`);
        const f = R({ behind: !0 });
        ((f.body[0].body = s()), a(b(f, t)));
  ...
  _t = {
    ...
    CapturingGroup: {
      enter(
        ...
        if (
          (o.get(e.number).push({ node: e, origin: c }),
          e.name && o.get(e.name).push({ node: e, origin: c }),
          e.name)
        ) {
          const p = Q(s, e.name, new Map());
          let f = !1;
          if (c) f = !0;
          else
    ...
    Subroutine({ node: e, parent: t, replaceWith: r }, n) {
      ...
      if (a) {
        ...
        for (
          ;
          (l = l.parent) && !(l.type === 'CapturingGroup' && (l.name === s || l.number === s));
        );
        n.reffedNodesByReferencer.set(e, l);
        return;
      }
      const o = n.subroutineRefMap.get(s),
        i = s === 0,
        u = i ? Be(0) : lr(o, n.groupOriginByCopy, null);
      let c = u;
      if (!i) {
        const l = pr(Ft(o, (f) => f.type === 'Group' && !!f.flags)),
          p = l ? te(n.globalFlags, l) : n.globalFlags;
        Nt(p, n.currentFlags) || ((c = v({ flags: Gt(p) })), c.body[0].body.push(u));
      }
      r(b(c, t), { traverse: !i });
    },
  },
  Mt = {
    Backreference({ node: e, parent: t, replaceWith: r }, n) {
      ...
      const s = n.reffedNodesByReferencer.get(e).filter((o) => Lt(o, e));
      if (!s.length) r(b(R({ negate: !0 }), t));
      else if (s.length > 1) {
        const o = v({ atomic: !0, body: s.reverse().map((i) => O({ body: [he(i.number)] })) });
        r(b(o, t));
      } else e.ref = s[0].number;
    },
...
function Lt(e, t) {
  let r = t;
  do {
    if (r.type === 'Regex') return !1;
    if (r.type === 'Alternative') continue;
    if (r === e) return !1;
    const n = fr(r.parent);
    for (const a of n) {
      if (a === r) break;
      if (a === e || gr(a, e)) return !0;
    }
  } while ((r = r.parent));
...
function lr(e, t, r, n) {
  ...
  for (const [s, o] of Object.entries(e))
    s === 'parent'
      ? (a.parent = Array.isArray(r) ? n : r)
      : o && typeof o == 'object'
        ? (a[s] = lr(o, t, a, r))
        : (s === 'type' && o === 'CapturingGroup' && t.set(a, t.get(e) ?? e), (a[s] = o));
  return a;
}
function Be(e) {
  const t = rr(e);
...
function pr(e) {
  ...
  return (
    e.forEach(({ flags: n }) => {
      t.forEach((a) => {
        (n.enable?.[a] && (delete r.disable[a], (r.enable[a] = !0)),
          n.disable?.[a] && (r.disable[a] = !0));
      });
    }),
...
function Gt({ dotAll: e, ignoreCase: t }) {
  const r = {};
  return (
    (e || t) && ((r.enable = {}), e && (r.enable.dotAll = !0), t && (r.enable.ignoreCase = !0)),
    (!e || !t) &&
      ((r.disable = {}), !e && (r.disable.dotAll = !0), !t && (r.disable.ignoreCase = !0)),
    r
  );
}
function fr(e) {
...
function dr(e) {
  const t = e.find((r) => r.kind === 'search_start' || Ut(r, { negate: !1 }) || !Pt(r));
  if (!t) return null;
...
function gr(e, t) {
  const r = fr(e) ?? [];
  for (const n of r) if (n === t || gr(n, t)) return !0;
  return !1;
}
function Pt({ type: e }) {
...
function Ut(e, t) {
  ...
  return (
    ...
    (r.negate === null || e.negate === r.negate) &&
    e.body.length === 1 &&
    Je(e.body[0], { type: 'Assertion', kind: 'search_start' })
  );
}
function fe(e) {
...
function N(e, t) {
  const n = Ke(e, { ...t, unicodePropertyMap: $e }).body;
...
function Ot(e, t) {
  const r = or(t),
    n = ye(r.target, 'ES2024'),
    a = ye(r.target, 'ES2025'),
    s = r.rules.recursionLimit;
  if (!Number.isInteger(s) || s < 2 || s > 20) throw new Error('Invalid recursionLimit; use 2-20');
  let o = null,
    i = null;
  if (!a) {
  ...
  function p(g) {
    return ((l.lastNode = c), (c = g), yt(Tt[g.type], `Unexpected node type "${g.type}"`)(g, l, p));
  }
  const f = { pattern: e.body.map(p).join('|'), flags: p(e.flags), options: { ...e.options } };
  return (
    n ||
      (delete f.options.force.v, (f.options.disable.v = !0), (f.options.unicodeSetsPlugin = null)),
    (f._captureTransfers = new Map()),
    (f._hiddenCaptures = []),
    l.captureMap.forEach((g, d) => {
      (g.hidden && f._hiddenCaptures.push(d),
        g.transferTo && Q(f._captureTransfers, g.transferTo, []).push(d));
    }),
    f
  );
}
var Dt = {
    '*': {
      enter({ node: e }, t) {
        if (ze(e)) {
          ...
          t.pushModI(e.flags ? te({ ignoreCase: r }, e.flags).ignoreCase : r);
        }
      },
      exit({ node: e }, t) {
        ze(e) && t.popModI();
    ...
    'Character'({ node: e }, t) {
      Ee(C(e.value)) && t.setHasCasedChar();
    },
  ...
  Tt = {
    ...
    Assertion({ kind: e, negate: t }) {
      ...
      if (e === 'word_boundary') return t ? h`\B` : h`\b`;
    ...
    CharacterClass(e, t, r) {
      ...
      _.bugFlagVLiteralHyphenIsRange &&
        t.useFlagV &&
        o.some(We) &&
        (o = [ne(45), ...o.filter((c) => !We(c))]);
      const i = () => `[${a ? '^' : ''}${o.map(r).join(n === 'intersection' ? '&&' : '')}]`;
      if (!t.inCharClass) {
        if ((!t.useFlagV || _.bugNestedClassIgnoresNegation) && !a) {
          const l = o.filter((p) => p.type === 'CharacterClass' && p.kind === 'union' && p.negate);
          if (l.length) {
            const p = v(),
              f = p.body[0];
            return (
              (p.parent = s),
              (f.parent = p),
              (o = o.filter((g) => !l.includes(g))),
              (e.body = o),
              o.length ? ((e.parent = f), f.body.push(e)) : p.body.pop(),
              l.forEach((g) => {
                const d = O({ body: [g] });
      ...
      if (
        ...
        (((!t.useFlagV || !t.verbose) &&
          s.kind === 'union' &&
          !(_.bugFlagVLiteralHyphenIsRange && t.useFlagV)) ||
          (!t.verbose &&
            s.kind === 'intersection' &&
            o.length === 1 &&
            u.type !== 'CharacterClassRange'))
      )
        return o.map(r).join('');
    ...
    CharacterClassRange(e, t) {
      ...
      if (t.useAppliedIgnoreCase && t.currentFlags.ignoreCase) {
        const u = hr(e);
        Ht(u).forEach((l) => {
          i.add(Array.isArray(l) ? `${V(l[0], a)}-${V(l[1], a)}` : V(l, a));
        });
      }
      return `${s}-${o}${[...i].join('')}`;
    },
    ...
    Group({ atomic: e, body: t, flags: r, parent: n }, a, s) {
      ...
      const i = t.map(s).join('|'),
        u =
          !a.verbose && t.length === 1 && n.type !== 'Quantifier' && !e && (!a.useFlagMods || !r)
            ? i
            : `(?${jt(e, r, a.useFlagMods)}${i})`;
...
function hr(e, t) {
  const r = !!t?.firstOnly,
    ...
    a = e.max.value,
    s = [];
  if ((n < 65 && (a === 65535 || a >= 131071)) || (n === 65536 && a >= 131071)) return s;
  for (let o = n; o <= a; o++) {
    const i = C(o);
    if (!Ee(i)) continue;
...
function Xt({ kind: e, max: t, min: r }) {
  let n;
  return (
    !r && t === 1
      ? (n = '?')
...
var Qt = class be extends RegExp {
  #r = new Map();
  #e = null;
  #n;
  #t = null;
  ...
  constructor(t, r, n) {
    ...
    if (t instanceof RegExp) {
      ...
      (super(s, r),
        (this.#n = s.source),
        s instanceof be &&
          ((this.#r = s.#r), (this.#t = s.#t), (this.#s = s.#s), (this.rawOptions = s.rawOptions)));
    } else {
      const s = { hiddenCaptures: [], strategy: null, transfers: [], ...n };
      (super(a ? '' : t, r),
        (this.#n = t),
        (this.#r = Jt(s.hiddenCaptures, s.transfers)),
        (this.#s = s.strategy),
        (this.rawOptions = n ?? {}));
    }
    a || (this.#e = this);
  ...
  exec(t) {
    if (!this.#e) {
      ...
      this.#e = new be(this.#n, this.flags, s);
    }
    ...
    if (this.#s === 'clip_search' && r && n) {
      ...
      return (a && (qt(a, n, t, this.hasIndices), (this.lastIndex += n)), a);
    }
    return this.#a(t);
  }
  #a(t) {
    ...
    if (((this.lastIndex = this.#e.lastIndex), !r || !this.#r.size)) return r;
    const n = [...r];
    r.length = 1;
    let a;
...
function Jt(e, t) {
  const r = new Map();
  for (const n of e) r.set(n, { hidden: !0 });
  for (const [n, a] of t) for (const s of a) Q(r, s, {}).transferTo = n;
  return r;
}
function Kt(e) {
...
function en(e, t) {
  const r = or(t),
    ...
    i = gt(o.pattern),
    u = dt(i.pattern, { captureTransfers: o.captureTransfers, hiddenCaptures: o.hiddenCaptures }),
    c = {
      pattern: u.pattern,
      flags: `${r.hasIndices ? 'd' : ''}${r.global ? 'g' : ''}${s.flags}${s.options.disable.v ? 'u' : 'v'}`,
    };
  if (r.avoidSubclass) {
    if (r.lazyCompileLength !== 1 / 0) throw new Error('Lazy compilation requires subclass');
  } else {
    const l = u.hiddenCaptures.sort((d, w) => d - w),
      p = Array.from(u.captureTransfers),
      f = a._strategy,
      g = c.pattern.length >= r.lazyCompileLength;
    (l.length || p.length || f || g) &&
      (c.options = {
...
class rn {
  constructor(t, r = {}) {
    ...
    const { forgiving: n = !1, cache: a, regexConstructor: s } = r;
  ...
  findNextMatchSync(t, r, n) {
    const a = typeof t == 'string' ? t : t.content,
      s = [];
    function o(i, u, c = 0) {
      return {
        index: i,
        captureIndices: u.indices.map((l) =>
          l == null
            ? { start: He, end: He, length: 0 }
            : { start: l[0] + c, end: l[1] + c, length: l[1] - l[0] },
        ),
      };
    }
    ...
    if (s.length) {
      ...
      for (const [u, c, l] of s) if (c.index === i) return o(u, c, l);
    }
    return null;
  }
}
...
function nn(e = {}) {
  ...
  return (
    (t.regexConstructor ||= (r) => tn(r, { target: t.target })),
    {
      createScanner(r) {
        return new rn(r, t);
      },
