...
import { c as d, g as n, u as b, F as s, L as x, f, aE as h } from './index-wqF_YeCD.js';
import { r as m } from '../vendor/vendor-emotion-DdM-9MtU.js';
import { S as k, N as g, a as j } from './index-CKMyoT-m.js';
import { N as a, i as v } from './NavItem-E5iVvhE8.js';
import { a as C } from './navigation--piBCllx.js';
import {
  l as S,
  bU as N,
  bV as B,
...
const E = () => {
    const o = C();
    return o === '/memory' ? 'home' : o.split('/memory/').find(Boolean) || 'home';
  },
  H = m.memo(() => {
    const o = E(),
      p = d(),
      { t: i } = n('memory'),
      l = b((t) => t.toggleCommandMenu),
      u = m.useMemo(
        () => [
          {
            icon: S,
          ...
          { icon: N, key: 'home', title: i('tab.home'), url: '/memory' },
          { icon: B, key: 'identities', title: i('tab.identities'), url: '/memory/identities' },
          { icon: L, key: 'contexts', title: i('tab.contexts'), url: '/memory/contexts' },
          { icon: M, key: 'preferences', title: i('tab.preferences'), url: '/memory/preferences' },
          { icon: F, key: 'experiences', title: i('tab.experiences'), url: '/memory/experiences' },
          { icon: P, key: 'activities', title: i('tab.activities'), url: '/memory/activities' },
        ],
        [i],
      );
    return r.jsx(s, {
      ...
      children: u.map((t) => {
        const y = r.jsx(
          a,
          { active: o === t.key, icon: t.icon, title: t.title, onClick: t.onClick },
          t.key,
        );
        return t.url
          ? r.jsx(
              x,
              {
                to: t.url,
                onClick: (e) => {
                  v(e) || (e.preventDefault(), t?.onClick?.(), t.url && p(t.url));
                },
                children: r.jsx(a, { active: o === t.key, icon: t.icon, title: t.title }),
              },
              t.key,
            )
          : y;
  ...
  D = m.memo(() => {
    ...
    return r.jsxs(r.Fragment, {
      children: [
        r.jsx(k, { breadcrumb: [{ href: '/memory', title: o('tab.memory') }] }),
        r.jsx(H, {}),
      ],
    });
  }),
  c = m.memo(() => r.jsx(g, { navKey: 'memory', children: r.jsx(j, { header: r.jsx(D, {}) }) }));
c.displayName = 'MemorySidebar';
const I = f(({ css: o, cssVar: p }) => ({
    mainContainer: o`
    position: relative;
    overflow: hidden;
  ...
  _o = () =>
    r.jsxs(r.Fragment, {
      children: [
        r.jsx(c, {}),
        r.jsx(s, { className: I.mainContainer, flex: 1, height: '100%', children: r.jsx(h, {}) }),
      ],
    });
