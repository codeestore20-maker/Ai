import { g as ze } from './chunk-55IACEB6-CwkWFNk8.js';
import { s as Ge } from './chunk-KX2RTZJC-DTbQz4uU.js';
import {
  _ as m,
  b as Xe,
  a as Je,
...
var Ae = (function () {
  var e = m(function (P, i, n, c) {
    ...
    h = [1, 5],
    r = [1, 6],
    o = [5, 6, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90],
    f = [1, 22],
    y = [2, 7],
    _ = [1, 26],
    I = [1, 27],
    ...
    E = [1, 39],
    R = [1, 40],
    p = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90],
    $ = [1, 61],
    X = [89, 90],
    Ce = [
    ...
    Se = {
      ...
      performAction: m(function (i, n, c, s, d, t, de) {
        var a = t.length - 1;
        switch (d) {
          case 4:
      ...
      table: [
        { 3: 1, 4: 2, 6: l, 9: u, 11: h, 13: r },
        { 1: [3] },
        { 3: 8, 4: 2, 5: [1, 7], 6: l, 9: u, 11: h, 13: r },
        { 5: [1, 9] },
        { 10: [1, 10] },
        { 12: [1, 11] },
        e(o, [2, 6]),
        { 3: 12, 4: 2, 6: l, 9: u, 11: h, 13: r },
        { 1: [2, 2] },
        {
          4: 17,
          5: f,
        ...
        e(p, [2, 19]),
        e(p, [2, 20]),
        { 30: 60, 33: 62, 75: $, 89: E, 90: R },
        { 30: 63, 33: 62, 75: $, 89: E, 90: R },
        { 30: 64, 33: 62, 75: $, 89: E, 90: R },
        e(X, [2, 29]),
        e(X, [2, 30]),
        e(X, [2, 31]),
        e(X, [2, 32]),
        ...
        e(pe, [2, 85]),
        e(pe, [2, 86]),
        { 62: 69, 65: Ve, 66: ve, 67: xe, 68: Le, 69: De, 70: we, 71: Oe },
        { 62: 77, 65: Ve, 66: ve, 67: xe, 68: Le, 69: De, 70: we, 71: Oe },
        { 30: 78, 33: 62, 75: $, 89: E, 90: R },
        {
          73: 79,
          75: ee,
          76: U,
        ...
        { 30: 94, 33: 62, 75: $, 76: U, 89: E, 90: R },
        { 5: [1, 95] },
        { 30: 96, 33: 62, 75: $, 89: E, 90: R },
        { 5: [1, 97] },
        { 30: 98, 33: 62, 75: $, 89: E, 90: R },
        { 63: [1, 99] },
        e(Y, [2, 50]),
        e(Y, [2, 51]),
        e(Y, [2, 52]),
      ...
      parse: m(function (i) {
        ...
        for (var be in this.yy)
          Object.prototype.hasOwnProperty.call(this.yy, be) && (z.yy[be] = this.yy[be]);
        (g.setInput(i, z.yy),
          (z.yy.lexer = g),
          (z.yy.parser = this),
        ...
        function je(b) {
          ((c.length = c.length - 2 * b), (d.length = d.length - b), (t.length = t.length - b));
        }
        m(je, 'popStack');
        function Ue() {
          var b;
          return (
            (b = s.pop() || g.lex() || $e),
            typeof b != 'number' &&
              (b instanceof Array && ((s = b), (b = s.pop())), (b = n.symbols_[b] || b)),
            b
          );
        }
        m(Ue, 'lex');
        for (var S, G, k, Te, J = {}, ge, F, Ye, _e; ; ) {
          if (
            ...
            this.defaultActions[G]
              ? (k = this.defaultActions[G])
              : ((S === null || typeof S > 'u') && (S = Ue()), (k = de[G] && de[G][S])),
...
Expecting ` +
              ...
              : (ke =
                  ...
                  (ye + 1) +
                  ': Unexpected ' +
                  (S == $e ? 'end of input' : "'" + (this.terminals_[S] || S) + "'")),
              this.parseError(ke, {
                text: g.match,
          ...
          if (k[0] instanceof Array && k.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + G + ', token: ' + S,
            );
          switch (k[0]) {
            case 1:
              (c.push(S),
            ...
            case 2:
              if (
                ...
                (Te = this.performAction.apply(J, [a, Pe, ye, z.yy, k[1], d, t].concat(Ke))),
                typeof Te < 'u')
              )
                return Te;
              (F &&
                ((c = c.slice(0, -1 * F * 2)), (d = d.slice(0, -1 * F)), (t = t.slice(0, -1 * F))),
                c.push(this.productions_[k[1]][0]),
                d.push(J.$),
                t.push(J._$),
                (Ye = de[c[c.length - 2]][c[c.length - 1]]),
                c.push(Ye));
              break;
            case 3:
              return !0;
        ...
        unput: m(function (i) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: c
                ? (c.length === s.length ? this.yylloc.first_column : 0) +
                  s[s.length - c.length].length -
                  c[0].length
...
` +
        ...
        next: m(function () {
          ...
          for (var d = this._currentRules(), t = 0; t < d.length; t++)
            if (
              ((c = this._input.match(this.rules[d[t]])), c && (!n || c[0].length > n[0].length))
            ) {
              if (((n = c), (s = t), this.options.backtrack_lexer)) {
                if (((i = this.test_match(c, d[t])), i !== !1)) return i;
                if (this._backtrack) {
                  n = !1;
                  continue;
                } else return !1;
          ...
          return n
            ? ((i = this.test_match(n, d[s])), i !== !1 ? i : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: m(function (n, c, s, d) {
          switch (s) {
            case 0:
              return 'title';
            case 1:
...
var ct = Ae,
  ...
  ot =
    ((Z = class {
      ...
      addRequirement(l, u) {
        return (
          this.requirements.has(l) ||
            this.requirements.set(l, {
              name: l,
              type: u,
      ...
      addRelationship(l, u, h) {
        this.relations.push({ type: l, src: u, dst: h });
      }
      getRelationships() {
      ...
      setClass(l, u) {
        for (const h of l) {
          ...
          if (r)
            for (const o of u) {
              r.classes.push(o);
              const f = this.classes.get(o)?.styles;
      ...
      defineClass(l, u) {
        for (const h of l) {
          ...
          (r === void 0 && ((r = { id: h, styles: [], textStyles: [] }), this.classes.set(h, r)),
            u &&
              u.forEach(function (o) {
                if (/color/.exec(o)) {
                  const f = o.replace('fill', 'bgFill');
                  r.textStyles.push(f);
                }
                r.styles.push(o);
              }),
            this.requirements.forEach((o) => {
              o.classes.includes(h) && o.cssStyles.push(...u.flatMap((f) => f.split(',')));
            }),
      ...
      getData() {
        ...
        for (const r of this.requirements.values()) {
          const o = r;
          ((o.id = r.name),
            (o.cssStyles = r.cssStyles),
            (o.cssClasses = r.classes.join(' ')),
            (o.shape = 'requirementBox'),
            (o.look = l.look),
            u.push(o));
        }
        ...
        for (const r of this.relations) {
          let o = 0;
          const f = r.type === this.Relationships.CONTAINS,
            y = {
              id: `${r.src}-${r.dst}-${o}`,
...
`,
  ...
  Be = {};
rt(Be, { draw: () => mt });
var mt = m(async function (e, l, u, h) {
    (qe.info('REF0:'), qe.info('Drawing requirement diagram (unified)', l));
    const { securityLevel: r, state: o, layout: f } = Ne(),
      y = h.db.getData(),
      _ = ze(l, r);
    ((y.type = h.type),
      (y.layoutAlgorithm = nt(f)),
      (y.nodeSpacing = o?.nodeSpacing ?? 50),
      (y.rankSpacing = o?.rankSpacing ?? 50),
      (y.markers = ['requirement_contains', 'requirement_arrow']),
      (y.diagramId = l),
      await at(y, _));
    const I = 8;
    (lt.insertTitle(
      ...
      Ge(_, I, 'requirementDiagram', o?.useMaxWidth ?? !0));
  }, 'draw'),
  qt = {
    parser: ct,
    get db() {
