const e = {
  'azure.azureApiVersion.desc':
    'إصدار واجهة برمجة التطبيقات لـ Azure، اتبع التنسيق YYYY-MM-DD، تحقق من [أحدث إصدار](https://learn.microsoft.com/en-us/azure/ai-services/openai/reference#chat-completions)',
  ...
  'azure.endpoint.desc':
    "عند التحقق من الموارد من بوابة Azure، يمكنك العثور على هذه القيمة في قسم 'المفاتيح ونقاط النهاية'",
  ...
  'azure.token.desc':
    "عند التحقق من الموارد من بوابة Azure، يمكنك العثور على هذه القيمة في قسم 'المفاتيح ونقاط النهاية'. يمكنك استخدام KEY1 أو KEY2",
  'azure.token.placeholder': 'مفتاح Azure API',
  'azure.token.title': 'مفتاح API',
  'azureai.azureApiVersion.desc':
    'إصدار واجهة برمجة التطبيقات لـ Azure، باتباع تنسيق YYYY-MM-DD. راجع [أحدث إصدار](https://learn.microsoft.com/en-us/azure/ai-services/openai/reference#chat-completions)',
  'azureai.azureApiVersion.fetch': 'جلب القائمة',
  'azureai.azureApiVersion.title': 'إصدار Azure API',
  'azureai.endpoint.desc':
    'اعثر على نقطة نهاية استدلال نموذج Azure AI من نظرة عامة على مشروع Azure AI',
  ...
  'bedrock.unlock.description':
    'أدخل AccessKeyId / SecretAccessKey الخاص بك لبدء الجلسة. لن يقوم التطبيق بتخزين إعدادات المصادقة الخاصة بك',
  'bedrock.unlock.imageGenerationDescription':
    'أدخل AccessKeyId / SecretAccessKey الخاص بك لبدء التوليد. لن يقوم التطبيق بتخزين بيانات اعتماد المصادقة الخاصة بك.',
  ...
  'createNewAiProvider.id.format':
    'يمكن أن يحتوي فقط على أرقام، حروف صغيرة، شرطات (-)، وشرطات سفلية (_)',
  'createNewAiProvider.id.placeholder':
    'يفضل أن يكون بحروف صغيرة، مثل openai، لا يمكن تعديله بعد الإنشاء',
  ...
  'createNewAiProvider.proxyUrl.required': 'يرجى إدخال عنوان الوكيل',
  'createNewAiProvider.proxyUrl.title': 'عنوان الوكيل',
  ...
  'github.personalAccessToken.desc':
    'أدخل رمز الوصول الشخصي (PAT) الخاص بك على GitHub. انقر [هنا](https://github.com/settings/tokens) لإنشاء واحد.',
  ...
  'huggingface.accessToken.desc':
    'أدخل رمز HuggingFace الخاص بك، انقر [هنا](https://huggingface.co/settings/tokens) لإنشاء واحد',
  ...
  'ollama.download.desc':
    'يقوم Ollama بتنزيل النموذج. يُفضل عدم إغلاق هذه الصفحة. سيستأنف التنزيل من حيث توقف إذا تم قطعه.',
  'ollama.download.failed':
    'فشل تنزيل النموذج. يرجى التحقق من الشبكة أو إعدادات Ollama والمحاولة مرة أخرى.',
  ...
  'providerModels.config.aesGcm':
    'سيتم تشفير مفتاحك وعنوان البروكسي باستخدام خوارزمية التشفير <1>AES-GCM</1>',
  'providerModels.config.apiKey.desc': 'يرجى إدخال مفتاح API الخاص بـ {{name}}',
  'providerModels.config.apiKey.descWithUrl':
    'يرجى إدخال مفتاح API الخاص بـ {{name}}. <3>انقر هنا للحصول عليه</3>',
  ...
  'providerModels.config.fetchOnClient.desc':
    'وضع طلب العميل سيبدأ الطلبات مباشرة من المتصفح، مما قد يحسن سرعة الاستجابة',
  ...
  'providerModels.config.oauth.desc':
    'قم بالتفويض باستخدام حسابك على {{name}} للوصول إلى النماذج من خلال اشتراكك.',
  'providerModels.config.oauth.disconnect': 'قطع الاتصال',
  'providerModels.config.oauth.disconnectConfirm':
    'هل أنت متأكد أنك تريد قطع الاتصال؟ ستحتاج إلى إعادة التفويض لاستخدام هذا المزود.',
  ...
  'providerModels.config.responsesApi.desc':
    'يستخدم تنسيق الطلب الجديد من OpenAI لتمكين ميزات متقدمة مثل سلسلة التفكير (مدعومة فقط من نماذج OpenAI)',
  'providerModels.config.responsesApi.title': 'استخدام مواصفات Responses API',
  'providerModels.config.waitingForMore':
    'يتم حاليًا <1>التخطيط لإضافة المزيد من النماذج</1>، يرجى المتابعة للبقاء على اطلاع',
  ...
  'providerModels.item.modelConfig.files.extra':
    'تنفيذ رفع الملفات الحالي هو حل مؤقت، مخصص للتجربة الذاتية فقط. يرجى الانتظار حتى تتوفر إمكانيات رفع الملفات الكاملة في المستقبل.',
  'providerModels.item.modelConfig.files.title': 'دعم رفع الملفات',
  'providerModels.item.modelConfig.functionCall.extra':
    'سيمكن هذا الإعداد النموذج من استخدام الأدوات، ولكن قدرة النموذج الفعلية على استخدامها تعتمد عليه بالكامل؛ يرجى الاختبار بنفسك.',
  'providerModels.item.modelConfig.functionCall.title': 'دعم استخدام الأدوات',
  'providerModels.item.modelConfig.id.extra':
    'لا يمكن تعديله بعد الإنشاء وسيُستخدم كمعرف النموذج عند استدعاء الذكاء الاصطناعي',
  'providerModels.item.modelConfig.id.placeholder':
    'يرجى إدخال معرف النموذج، مثل gpt-4o أو claude-3.5-sonnet',
  'providerModels.item.modelConfig.id.title': 'معرف النموذج',
  'providerModels.item.modelConfig.imageOutput.extra':
    'يُمكّن هذا الإعداد قدرة النموذج على توليد الصور فقط. الأداء الفعلي يعتمد على النموذج نفسه. يرجى اختباره.',
  ...
  'providerModels.item.modelConfig.reasoning.extra':
    'سيمكن هذا الإعداد قدرات التفكير العميق للنموذج. التأثير الفعلي يعتمد على النموذج. يرجى اختباره.',
  'providerModels.item.modelConfig.reasoning.title': 'دعم التفكير العميق',
  'providerModels.item.modelConfig.search.extra':
    'يُمكّن هذا الإعداد قدرة البحث عبر الإنترنت المدمجة في النموذج. يعتمد الدعم على النموذج نفسه. يرجى اختباره.',
  'providerModels.item.modelConfig.search.title': 'يدعم البحث عبر الإنترنت',
  'providerModels.item.modelConfig.tokens.extra':
    'تحديد الحد الأقصى لعدد الرموز التي يدعمها النموذج',
  ...
  'providerModels.item.modelConfig.type.extra':
    'أنواع النماذج المختلفة لها استخدامات وقدرات مختلفة',
  ...
  'providerModels.item.modelConfig.video.extra':
    'يُمكّن هذا الإعداد تكوين التعرف على الفيديو داخل التطبيق. يعتمد الدعم على النموذج نفسه. يرجى اختباره.',
  'providerModels.item.modelConfig.video.title': 'يدعم التعرف على الفيديو',
  'providerModels.item.modelConfig.vision.extra':
    'يُمكّن هذا الإعداد فقط من رفع الصور داخل التطبيق. يعتمد دعم التعرف على الصور على النموذج نفسه. يرجى اختباره.',
  ...
  'providerModels.list.enabledEmpty':
    'لا توجد نماذج مفعلة. يرجى تفعيل النماذج المفضلة من القائمة أدناه~',
  ...
  'providerModels.list.resetAll.conform':
    'هل أنت متأكد أنك تريد إعادة تعيين جميع التعديلات على النموذج الحالي؟ بعد إعادة التعيين، ستعود قائمة النماذج إلى حالتها الافتراضية.',
  ...
  'updateAiProvider.confirmDelete':
    'أنت على وشك حذف مزود الذكاء الاصطناعي هذا. لا يمكن استعادته بعد الحذف. هل أنت متأكد من الحذف؟',
  ...
  'vertexai.region.desc':
    'اختر المنطقة لخدمة Vertex AI. بعض النماذج مثل Gemini 2.5 متاحة فقط في مناطق محددة (مثل global)',
