const e = {
  'azure.azureApiVersion.desc':
    'Версия на Azure API, следвайте формата ГГГГ-ММ-ДД, проверете [последната версия](https://learn.microsoft.com/en-us/azure/ai-services/openai/reference#chat-completions)',
  ...
  'azure.endpoint.desc':
    "Когато проверявате ресурсите в Azure портала, можете да намерите тази стойност в секцията 'Ключове и крайни точки'",
  ...
  'azure.token.desc':
    "Когато проверявате ресурсите в Azure портала, можете да намерите тази стойност в секцията 'Ключове и крайни точки'. Можете да използвате KEY1 или KEY2",
  'azure.token.placeholder': 'Ключ за Azure API',
  'azure.token.title': 'API ключ',
  'azureai.azureApiVersion.desc':
    'Версия на API за Azure, следва формата ГГГГ-ММ-ДД. Вижте [последната версия](https://learn.microsoft.com/en-us/azure/ai-services/openai/reference#chat-completions)',
  'azureai.azureApiVersion.fetch': 'Изтегли списък',
  'azureai.azureApiVersion.title': 'Версия на Azure API',
  'azureai.endpoint.desc':
    'Намерете крайния адрес за инференция на модела от прегледа на проекта в Azure AI',
  ...
  'bedrock.unlock.description':
    'Въведете вашите AWS AccessKeyId / SecretAccessKey, за да започнете сесията. Приложението няма да съхранява вашата конфигурация за удостоверяване',
  'bedrock.unlock.imageGenerationDescription':
    'Въведете вашите AWS AccessKeyId / SecretAccessKey, за да започнете генерирането. Приложението няма да съхранява вашите удостоверителни данни.',
  ...
  'cloudflare.baseURLOrAccountID.desc':
    'Въведете вашия Cloudflare Account ID или персонализиран API адрес',
  ...
  'comfyui.customHeaders.desc':
    'Хедъри на заявката, необходими за потребителско удостоверяване, във формат ключ-стойност',
  ...
  'createNewAiProvider.id.desc':
    'Уникален идентификатор за доставчика на услуги, който не може да бъде променян след създаване',
  'createNewAiProvider.id.duplicate': 'Идентификаторът на доставчика вече съществува',
  'createNewAiProvider.id.format':
    'Може да съдържа само цифри, малки букви, тирета (-) и долни черти (_)',
  'createNewAiProvider.id.placeholder':
    'Препоръчително е да е с малки букви, напр. openai, не може да се променя след създаване',
  ...
  'github.personalAccessToken.desc':
    'Въведете вашия GitHub PAT. Натиснете [тук](https://github.com/settings/tokens), за да създадете такъв.',
  'github.personalAccessToken.placeholder': 'ghp_xxxxxx',
  'github.personalAccessToken.title': 'GitHub PAT',
  'huggingface.accessToken.desc':
    'Въведете вашия HuggingFace Token, натиснете [тук](https://huggingface.co/settings/tokens), за да създадете такъв',
  ...
  'ollama.download.desc':
    'Ollama изтегля модела. Моля, не затваряйте страницата. Ако изтеглянето бъде прекъснато, ще се възобнови от мястото, където е спряло.',
  'ollama.download.failed':
    'Неуспешно изтегляне на модела. Моля, проверете мрежата или настройките на Ollama и опитайте отново.',
  ...
  'ollama.endpoint.desc':
    'Трябва да включва http(s)://; може да се остави празно, ако не е зададено локално.',
  ...
  'providerModels.config.aesGcm':
    'Вашият ключ и прокси URL ще бъдат криптирани с <1>AES-GCM</1> алгоритъм',
  'providerModels.config.apiKey.desc': 'Моля, въведете вашия {{name}} API ключ',
  'providerModels.config.apiKey.descWithUrl':
    'Моля, въведете вашия {{name}} API ключ. <3>Кликнете тук, за да го получите</3>',
  ...
  'providerModels.config.checker.desc':
    'Провери дали API ключът и прокси URL са попълнени правилно',
  ...
  'providerModels.config.fetchOnClient.desc':
    'Режимът на клиентска заявка ще стартира сесии директно от браузъра, което може да подобри скоростта на отговор',
  ...
  'providerModels.config.oauth.authorizedDesc':
    'Свързахте се с {{name}}. Щракнете, за да прекъснете връзката.',
  'providerModels.config.oauth.cancel': 'Отказ',
  'providerModels.config.oauth.codeExpired':
    'Кодът за удостоверяване е изтекъл. Моля, опитайте отново.',
  'providerModels.config.oauth.connect': 'Свържете се с {{name}}',
  'providerModels.config.oauth.connectDesc':
    'Щракнете, за да се удостоверите чрез браузър. Не се изисква API ключ.',
  ...
  'providerModels.config.oauth.desc':
    'Удостоверете се с вашия акаунт в {{name}}, за да получите достъп до моделите чрез вашия абонамент.',
  'providerModels.config.oauth.disconnect': 'Прекъсни връзката',
  'providerModels.config.oauth.disconnectConfirm':
    'Сигурни ли сте, че искате да прекъснете връзката? Ще трябва да се удостоверите отново, за да използвате този доставчик.',
  ...
  'providerModels.config.responsesApi.desc':
    'Използва новия формат на заявки на OpenAI за отключване на разширени функции като верига на мисълта (поддържа се само от OpenAI модели)',
  'providerModels.config.responsesApi.title': 'Използвай Responses API спецификация',
  'providerModels.config.waitingForMore':
    'В момента се <1>планира интеграция</1> на още модели, следете за новини',
  ...
  'providerModels.item.customModelCards.confirmDelete':
    'Ще изтриете този персонализиран модел. След изтриване не може да бъде възстановен. Продължете с внимание.',
  'providerModels.item.delete.confirm':
    'Сигурни ли сте, че искате да изтриете модела {{displayName}}?',
  ...
  'providerModels.item.modelConfig.azureDeployName.extra':
    'Поле, използвано за реални заявки в Azure OpenAI',
  'providerModels.item.modelConfig.azureDeployName.placeholder':
    'Въведете името на разгръщане на модела в Azure',
  ...
  'providerModels.item.modelConfig.deployName.extra':
    'Това поле ще се използва като ID на модела при изпращане на заявки',
  'providerModels.item.modelConfig.deployName.placeholder':
    'Въведете реалното име или ID на разгръщане на модела',
  ...
  'providerModels.item.modelConfig.displayName.placeholder':
    'Въведете показваното име на модела, напр. ChatGPT, GPT-4 и др.',
  ...
  'providerModels.item.modelConfig.extendParams.extra':
    'Изберете разширени параметри, поддържани от модела. Задръжте курсора върху опция, за да видите контролите. Неправилни конфигурации могат да доведат до неуспешни заявки.',
  'providerModels.item.modelConfig.extendParams.options.codexMaxReasoningEffort.hint':
    'За модели Codex; контролира интензивността на разсъжденията.',
  'providerModels.item.modelConfig.extendParams.options.disableContextCaching.hint':
    'За моделите Claude; може да намали разходите и да ускори отговорите.',
  'providerModels.item.modelConfig.extendParams.options.effort.hint':
    'За Claude Opus 4.6; контролира нивото на усилие (ниско/средно/високо/максимално).',
  'providerModels.item.modelConfig.extendParams.options.enableAdaptiveThinking.hint':
    'За Claude Opus 4.6; включва или изключва адаптивното мислене.',
  'providerModels.item.modelConfig.extendParams.options.enableReasoning.hint':
    'За Claude, DeepSeek и други модели с логическо мислене; отключва по-задълбочено разсъждение.',
  'providerModels.item.modelConfig.extendParams.options.gpt5ReasoningEffort.hint':
    'За серията GPT-5; контролира интензивността на разсъждението.',
  'providerModels.item.modelConfig.extendParams.options.gpt5_1ReasoningEffort.hint':
    'За серията GPT-5.1; контролира интензивността на разсъждението.',
  'providerModels.item.modelConfig.extendParams.options.gpt5_2ProReasoningEffort.hint':
    'За серията GPT-5.2 Pro; контролира интензивността на разсъждението.',
  'providerModels.item.modelConfig.extendParams.options.gpt5_2ReasoningEffort.hint':
    'За серията GPT-5.2; контролира интензивността на разсъждението.',
  'providerModels.item.modelConfig.extendParams.options.grok4_20ReasoningEffort.hint':
    'За серията Grok 4.20; контролира интензивността на разсъжденията. Ниско/Средно използва 4 агента, Високо/Много високо използва 16 агента.',
  'providerModels.item.modelConfig.extendParams.options.imageAspectRatio.hint':
    'За моделите за генериране на изображения Gemini; контролира съотношението на страните на генерираните изображения.',
  'providerModels.item.modelConfig.extendParams.options.imageAspectRatio2.hint':
    'За Nano Banana 2; контролира съотношението на страните на генерираните изображения (поддържа изключително широки 1:4, 4:1, 1:8, 8:1).',
  'providerModels.item.modelConfig.extendParams.options.imageResolution.hint':
    'За моделите Gemini 3 за генериране на изображения; контролира резолюцията на генерираните изображения.',
  'providerModels.item.modelConfig.extendParams.options.imageResolution2.hint':
    'За модели Gemini 3.1 Flash Image; контролира резолюцията на генерираните изображения (поддържа 512px).',
  'providerModels.item.modelConfig.extendParams.options.reasoningBudgetToken.hint':
    'За Claude, Qwen3 и подобни; контролира бюджета от токени за разсъждение.',
  'providerModels.item.modelConfig.extendParams.options.reasoningBudgetToken32k.hint':
    'За GLM-5 и GLM-4.7; контролира бюджета за токени за разсъждение (максимум 32k).',
  'providerModels.item.modelConfig.extendParams.options.reasoningBudgetToken80k.hint':
    'За серията Qwen3; контролира бюджета за токени за разсъждение (максимум 80k).',
  'providerModels.item.modelConfig.extendParams.options.reasoningEffort.hint':
    'За OpenAI и други модели с логическо мислене; контролира усилието за разсъждение.',
  'providerModels.item.modelConfig.extendParams.options.textVerbosity.hint':
    'За серията GPT-5+; контролира обемността на изходния текст.',
  'providerModels.item.modelConfig.extendParams.options.thinking.hint':
    'За някои модели Doubao; позволява на модела да реши дали да мисли задълбочено.',
  'providerModels.item.modelConfig.extendParams.options.thinkingBudget.hint':
    'За серията Gemini; контролира бюджета за мислене.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel.hint':
    'За модели Gemini 3 Flash Preview; контролира дълбочината на мислене.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel2.hint':
    'За модели Gemini 3 Pro Preview; контролира дълбочината на мислене.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel3.hint':
    'За модели Gemini 3.1 Pro Preview; контролира дълбочината на мислене с ниско/средно/високо ниво.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel4.hint':
    'За модели Gemini 3.1 Flash Image; включване/изключване на мисленето.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel5.hint':
    'За Gemini 3.1 Flash-Lite Preview; контролира дълбочината на мислене с минимално/ниско/средно/високо ниво.',
  'providerModels.item.modelConfig.extendParams.options.urlContext.hint':
    'За серията Gemini; поддържа предоставяне на контекст чрез URL.',
  'providerModels.item.modelConfig.extendParams.placeholder':
    'Изберете разширени параметри за активиране',
  ...
  'providerModels.item.modelConfig.files.extra':
    'Текущата реализация на качване на файлове е временна и е предназначена само за експерименти. Очаквайте пълна поддръжка в бъдеще.',
  ...
  'providerModels.item.modelConfig.functionCall.extra':
    'Тази настройка активира възможността на модела да използва инструменти. Дали ще ги използва ефективно зависи от самия модел. Моля, тествайте.',
  ...
  'providerModels.item.modelConfig.id.extra':
    'Не може да се променя след създаване и ще се използва като ID на модела при извикване',
  'providerModels.item.modelConfig.id.placeholder':
    'Въведете ID на модела, напр. gpt-4o или claude-3.5-sonnet',
  'providerModels.item.modelConfig.id.title': 'ID на модела',
  'providerModels.item.modelConfig.imageOutput.extra':
    'Тази настройка активира само възможността за генериране на изображения. Реалната поддръжка зависи от модела. Моля, тествайте.',
  ...
  'providerModels.item.modelConfig.type.extra':
    'Различните типове модели имат различни приложения и възможности',
  ...
  'providerModels.item.modelConfig.video.extra':
    'Активира конфигурация за разпознаване на видео. Поддръжката зависи от модела. Моля, тествайте.',
  'providerModels.item.modelConfig.video.title': 'Поддържа разпознаване на видео',
  'providerModels.item.modelConfig.vision.extra':
    'Активира възможност за качване на изображения. Поддръжката зависи от модела. Моля, тествайте.',
  ...
  'providerModels.list.empty.desc':
    'Моля, създайте персонализиран модел или изтеглете модел, за да започнете.',
  ...
  'providerModels.list.enabledEmpty':
    'Няма активирани модели. Моля, активирайте предпочитаните модели от списъка по-долу~',
  ...
  'providerModels.list.resetAll.conform':
    'Сигурни ли сте, че искате да нулирате всички промени по текущия модел? След нулиране списъкът ще се върне към първоначалното си състояние.',
  ...
  'updateAiProvider.confirmDelete':
    'Ще изтриете този AI доставчик. След изтриване не може да бъде възстановен. Сигурни ли сте?',
  ...
  'vertexai.region.desc':
    'Изберете регион за услугата Vertex AI. Някои модели като Gemini 2.5 са налични само в определени региони (напр. global)',
