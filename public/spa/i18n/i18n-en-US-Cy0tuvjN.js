...
var Gi = { yearFormat: 'YYYY', dayFormat: 'D', cellMeridiemFormat: 'A', monthBeforeYear: !0 };
function n(t) {
...
function s(t, e) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    (e &&
      (o = o.filter(function (Ui) {
        return Object.getOwnPropertyDescriptor(t, Ui).enumerable;
      })),
      a.push.apply(a, o));
  }
  return a;
...
function r(t) {
  for (var e = 1; e < arguments.length; e++) {
    ...
    e % 2
      ? s(Object(a), !0).forEach(function (o) {
          qi(t, o, a[o]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(a))
        : s(Object(a)).forEach(function (o) {
...
const c = { placeholder: 'Select time', rangePlaceholder: ['Start time', 'End time'] },
  l = {
    lang: {
  ...
  d = 'Active',
  u = `Hi, I’m **{{name}}**. One sentence is enough.

Want me to match your workflow better? Go to [Agent Settings]({{url}}) and fill in the Agent Profile (you can edit it anytime).`,
  p = "Hi, I’m **{{name}}**. One sentence is enough—you're in control.",
  m = "Hi, I’m **{{name}}**. One sentence is enough—you're in control.",
  g = 'Agents',
  h = 'Available Agents',
  y = 'Jump to latest',
  b = 'Built-in Copilot',
  f = 'Clear current session messages',
  v = 'Compressed History',
  k =
  ...
  z = 'Create Group',
  H = 'Create Page',
  W = 'This group has no members yet. Click the + button to invite agents.',
  _ = 'No members available to invite',
  j = 'No matching members found',
  V = "This group doesn't have any members yet. Click the + button to invite agents.",
  Y = 'No members selected yet',
  K = 'Open in New Window',
  $ = 'Group owner',
  J = 'Pin',
  Q = 'Unpin',
  X = 'Regenerate',
  Z = 'Agent Profile & History',
  ee = 'Search agents...',
  te = 'Search agents...',
  ae = 'Selected agents',
  ie = 'Ask, create, or start a task, <hotkey><hotkey/>',
  oe =
...
Writing, coding, or data analysis—anything works. You own the goal and standards; I’ll break it down into collaborative, runnable Agents.`,
    'agentDefaultMessage': u,
    'agentDefaultMessageWithSystemRole': p,
    'agentDefaultMessageWithoutEdit': m,
    'agents': g,
    ...
    'confirmRemoveGroupItemAlert': S,
    'confirmRemoveGroupSuccess': C,
    'confirmRemoveSessionItemAlert': A,
    'confirmRemoveSessionSuccess': P,
    'defaultAgent': T,
    'defaultGroupChat': I,
    'defaultList': M,
    'defaultSession': x,
    ...
    'messages.modelCard.pricing.inputCachedTokens':
      'Cached input {{amount}} credits · ${{amount}}/M',
...
Draft, rewrite, or polish—tell me your intent and I'll refine the rest.`,
  ...
  de = 'About',
  ue = 'Advanced Settings',
  pe = 'Already Up to Date',
  me = 'Autocomplete',
  ge = 'Autocomplete the description from the Agent Profile',
  he = 'Add an Agent Profile first to use Autocomplete',
  ye = 'Back',
  be = 'Batch Delete',
  fe = 'Product Blog',
  ve = 'Create Subtopic',
  ...
  we = 'Current topic is not saved, please save it first to use subtopic feature',
  Se = 'Cancel',
  Ce = 'Changelog',
  Ae = 'Check for Updates',
  Pe = 'Close',
  Te = 'Confirm',
  Ie = 'Contact Us',
  Me = 'Copy',
  ...
  Fe = 'User Manual',
  Ne = 'Download',
  Le = 'Downloading {{percent}}%',
  Ue = 'Duplicate',
  Oe = 'Edit',
  Ge = 'Feedback',
  qe = 'Follow us on {{name}}',
  Be = 'Full Screen Mode',
  ze = 'Get Desktop App',
  He = 'History Range',
  We = 'Import Data',
  _e = 'Community and News',
  je = 'Install browser app',
  Ve = 'Labs',
  Ye = 'Loading layout...',
  Ke = 'Legal Disclaimer',
  $e = 'Loading...',
  ...
  ji = {
    ...
    'branching': ve,
    'branchingDisable': ke,
    'branchingRequiresSavedTopic': we,
    'cancel': Se,
    'changelog': Ce,
    'checkForUpdates': Ae,
  ...
  Tt = 'Test connection failed: {{error}}',
  Vi = {
  ...
  Uo = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Vi, testConnectionFailed: Tt },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ...
  Bo = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Ji, login: It, loginOrSignup: Mt, signout: xt, signup: Dt },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  Rt = 'Authentication Error',
  Qi = {
  ...
  zo = Object.freeze(
    Object.defineProperty({ __proto__: null, default: Qi, title: Rt }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  Et = "We've introduced new features while you were away.",
  Ft = 'View all changelogs',
  Nt = 'Stay updated on the new features and improvements of {{appName}}',
  Lt = 'Read details',
  Ut = 'Changelog',
  Ot = 'Version details',
  Gt = 'Welcome back!',
  ...
  eo = {
    ...
    'FileParsingStatus.chunks.embeddingStatus.success':
      'All current text chunks have been embedded',
  ...
  jo = Object.freeze(
    Object.defineProperty(
      { __proto__: null, back: aa, default: to, next: ia },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  oa = 'Back to Discovery',
  na = 'Clear Filter',
  sa = 'Create',
  ra = 'Dislike',
  la = 'Filter',
  ...
  ao = {
    ...
    'assistants.empty.description':
      'Try adjusting filters, or explore more Agents in the Community.',
    ...
    'assistants.status.deprecated.subtitle':
      'This Agent is currently unavailable. Possible reasons:',
    ...
    'createGuide.func1.desc1':
      'In a conversation, open the Agent settings from the top-right menu.',
    ...
    'mcp.categories.gaming-entertainment.description':
      'Games, Entertainment, and Leisure Activities',
...
- Set \`require_approval\` to control tool execution approval`,
    ...
    'mcp.validated.desc':
      'This MCP Server has been validated to ensure its quality and reliability.',
    ...
    'skills.categories.finance.description':
      'Finance, banking, payments, and financial data skills',
  ...
  Yo = Object.freeze(
    Object.defineProperty(
      { __proto__: null, cancel: ga, confirm: ha, default: io },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  oo = {
    ...
    'remoteServer.configDesc':
      'Connect to the remote LobeHub server to enable data synchronization',
  ...
  ba = 'Add',
  fa = 'Create Page',
  va = 'No files or folders have been uploaded yet.',
  ka = 'Load More',
  wa = 'Failed to retrieve libraries. Please check your network connection and try again.',
  Sa = 'Resource',
  Ca = 'Search Files',
  Aa = 'Search Pages',
  Pa = 'Resources',
  Ta = 'Show/Hide Left Panel',
  so = {
    'addFolder': ya,
    'addLibrary': ba,
    'addPage': fa,
    ...
    'header.actions.builtInBlockList.filtered':
      '{{ignored}} files filtered (out of {{total}} total)',
    ...
    'header.actions.gitignore.filtered':
      '{{ignored}} files filtered out ({{total}} files in total)',
    ...
    'resource': Sa,
    'searchFilePlaceholder': Ca,
    'searchPagePlaceholder': Aa,
    'tab.all': 'All',
    'tab.audios': 'Audio',
  ...
  en = Object.freeze(
    Object.defineProperty({ __proto__: null, default: uo, title: Ia }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  Ma =
  ...
  tn = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: po, desc: Ma, title: xa },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  mo = {
    ...
    'authorize.description':
      'Your community profile is separate from your {{appName}} user account.',
    ...
    'errors.codeVerifierMissing':
      'Invalid authorization session. Please restart the login process.',
  ...
  on = Object.freeze(
    Object.defineProperty({ __proto__: null, default: go, loading: Da }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  ho = {
  ...
  Ra = 'Image "{{prompt}}" generated successfully',
  Ea = 'Image Generated',
  Fa = 'Video "{{prompt}}" generated successfully',
  Na = 'Video Generated',
  bo = {
    'image_generation_completed': Ra,
    'image_generation_completed_title': Ea,
    ...
    'video_generation_completed': Fa,
    'video_generation_completed_title': Na,
  },
  rn = Object.freeze(
    Object.defineProperty(
      {
  ...
  fo = {
    ...
    'consent.error.unknown.message':
      'An unknown error occurred while loading authorization details.',
  ...
  cn = Object.freeze(
    Object.defineProperty(
      { __proto__: null, back: La, default: vo, finish: Ua, next: Oa, title: Ga },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
 ...
 {{error}}`,
  ...
  ja = 'Artifacts',
  Va = 'Skills',
  Ya = 'No Artifacts yet. Use Skills in the conversation, then come back here.',
  Ka = 'This list is empty.',
  $a = 'Files',
  Ja = 'Message Details',
  Qa = 'Edit in Page',
  Xa = 'Workspace',
  wo = {
    ...
    'emptyArtifactList': Ya,
    'emptyKnowledgeList': Ka,
    'files': $a,
    'messageDetail': Ja,
  ...
  So = {
    ...
    'bfl.description':
      'A leading frontier AI research lab building the visual infrastructure of tomorrow.',
    ...
    'cloudflare.description':
      'Run serverless GPU-powered ML models across Cloudflare’s global network.',
    'cohere.description':
    ...
    'githubcopilot.description':
      'Access Claude, GPT, and Gemini models through your GitHub Copilot subscription.',
    ...
    'newapi.description':
      'An open-source aggregation and routing platform for multiple AI services.',
    'novita.description':
  ...
  Co = {
    ...
    'evaluation.emptyGuide':
      'There are currently no evaluation tasks. Start creating an evaluation.',
  ...
  Za = 'Advanced Settings',
  ei = 'Agent Skill',
  ti = 'Checking...',
  ai = 'Checking permissions...',
  ii = 'Publish to Community',
  oi = 'Start Conversation',
  Ao = {
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  ni = 'Cancel Subscription',
  si = 'View All Plans',
  ri = 'View Plans',
  li = 'Failed to create subscription',
  ci = 'Pay Difference',
  di = 'Approx.',
  ui = 'Actual amount subject to payment page',
  pi = 'Switch Downgrade Target',
  mi = 'Downgrade',
  gi = 'Upgrade',
  hi = 'Upgrade Now',
  yi = 'Upgrade Plan',
  To = {
    ...
    'credits.autoTopUp.targetBalanceDesc':
      'The credit level to restore to when auto top-up triggers',
  ...
  Io = {
    ...
    'agent.13.prompt': `Create an Interactive Photography Coach. Provide a "Composition Deconstructor" to analyze uploaded/described photos. Offer a "Technical Setting Simulator" (Aperture/ISO/Shutter Speed) for specific lighting scenarios and generate structured 7-day creative challenge plans tailored to the user's current skill level.`,
  ...
  Mo = {
    ...
    'notSupportMultiModals': bi,
  },
  fn = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Mo, notSupportMultiModals: bi },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  xo = {
    ...
    'securityBlacklist.browserCredentials':
      'Accessing browser credential storage may leak passwords',
    'securityBlacklist.chownSystemDirs':
      'Changing file ownership of system directories is dangerous',
    ...
    'securityBlacklist.gcpCredentials':
      'Reading GCP credentials may leak cloud service account keys',
    ...
    'updateArgs.stringifyError':
      'Unable to serialize parameters, please check the parameter format',
  },
  vn = Object.freeze(
  ...
  vi = 'Display Items',
  ki = 'Copying Topic...',
  wi = 'Topic Copied Successfully',
  Si = 'Favorite',
  Ci = 'Import Failed',
  Ai = 'Invalid file format. Please ensure it is a valid JSON file.',
  Pi = 'Importing conversation...',
  Ti = 'Successfully imported {{count}} messages',
  Ii = 'Load More',
  Mi = 'Search Topics...',
  xi = 'No search results found.',
  Di = 'Temporary',
  Ri = 'Topic',
  Do = {
    ...
    'actions.confirmRemoveTopic':
      'You are about to delete this topic. This action cannot be undone.',
    ...
    'importError': Ci,
    'importInvalidFormat': Ai,
    'importLoading': Pi,
    'importSuccess': Ti,
    'loadMore': Ii,
    'searchPlaceholder': Mi,
    'searchResultEmpty': xi,
    'temp': Di,
    'title': Ri,
  },
  kn = Object.freeze(
  ...
  Ei = 'Welcome',
  Fi = 'Or choose from the agent templates below',
  Ni = 'Skip Creation',
  Li = {
    1: 'Welcome back 😊',
    2: "Hi, I'm here",
  ...
  Sn = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Eo, header: Ei, pickAgent: Fi, skip: Ni, welcomeMessages: Li },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  );
