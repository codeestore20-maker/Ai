      ...
      (function (l, r) {
        (function (p, u) {
          ...
          var p = 1e3,
            ...
            No = {
              ...
              ordinal: function (o) {
                var i = ['th', 'st', 'nd', 'rd'],
                  e = o % 100;
                return '[' + o + (i[(e - 20) % 10] || i[e] || i[0]) + ']';
              },
            },
            z = function (o, i, e) {
              var a = String(o);
              return !a || a.length >= i ? o : '' + Array(i + 1 - a.length).join(e) + o;
            },
            Fo = {
              s: z,
              z: function (o) {
                var i = -o.utcOffset(),
                  ...
                  a = Math.floor(e / 60),
                  t = e % 60;
                return (i <= 0 ? '+' : '-') + z(a, 2, '0') + ':' + z(t, 2, '0');
              },
              m: function o(i, e) {
                if (i.date() < e.date()) return -o(e, i);
                var a = 12 * (e.year() - i.year()) + (e.month() - i.month()),
                  t = i.clone().add(a, S),
                  s = e - t < 0,
                  n = i.clone().add(a + (s ? -1 : 1), S);
                return +(-(a + (e - t) / (s ? t - n : n - t)) || 0);
              },
              a: function (o) {
              ...
              p: function (o) {
                return (
                  { M: S, y: P, w: G, d: w, D: F, h: k, m: M, s: h, ms: N, Q: K }[o] ||
                  String(o || '')
                    .toLowerCase()
                    .replace(/s$/, '')
                );
          ...
          var V = '$isDayjsObject',
            ...
            U = function o(i, e, a) {
              ...
              if (typeof i == 'string') {
                ...
                (T[s] && (t = s), e && ((T[s] = e), (t = s)));
                var n = i.split('-');
                if (!t && n.length > 1) return o(n[0]);
              } else {
                var d = i.name;
                ((T[d] = i), (t = d));
              }
              return (!a && t && (O = t), t || (!a && O));
            },
            g = function (o, i) {
              if (q(o)) return o.clone();
              var e = typeof i == 'object' ? i : {};
              return ((e.date = o), (e.args = arguments), new B(e));
            },
            c = Fo;
          ((c.l = U),
            (c.i = q),
            (c.w = function (o, i) {
              return g(o, { locale: i.$L, utc: i.$u, x: i.$x, $offset: i.$offset });
            }));
          var B = (function () {
              function o(e) {
              ...
              return (
                (i.parse = function (e) {
                  ((this.$d = (function (a) {
                    ...
                    if (typeof t == 'string' && !/Z$/i.test(t)) {
                      ...
                      if (n) {
                        var d = n[2] - 1 || 0,
                          m = (n[7] || '0').substring(0, 3);
                        return s
                          ? new Date(
                              Date.UTC(n[1], d, n[3] || 1, n[4] || 0, n[5] || 0, n[6] || 0, m),
                            )
                          : new Date(n[1], d, n[3] || 1, n[4] || 0, n[5] || 0, n[6] || 0, m);
                      }
                    }
                    return new Date(t);
                  })(e)),
                ...
                (i.$g = function (e, a, t) {
                  return c.u(e) ? this[a] : this.set(t, e);
                }),
                (i.unix = function () {
                ...
                (i.startOf = function (e, a) {
                  var t = this,
                    ...
                    n = c.p(e),
                    d = function (D, y) {
                      var C = c.w(t.$u ? Date.UTC(t.$y, y, D) : new Date(t.$y, y, D), t);
                      return s ? C : C.endOf(w);
                    },
                    m = function (D, y) {
                      return c.w(
                        t
                          .toDate()
                          [D].apply(t.toDate('s'), (s ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(y)),
                        t,
                      );
                    },
                    b = this.$W,
                ...
                (i.$set = function (e, a) {
                  var t,
                    ...
                    (t[N] = n + 'Milliseconds'),
                    t)[s],
                    m = s === w ? this.$D + (a - this.$W) : a;
                  if (s === S || s === P) {
                    var b = this.clone().set(F, 1);
                    (b.$d[d](m),
                      b.init(),
                      (this.$d = b.set(F, Math.min(this.$D, b.daysInMonth())).$d));
                  } else d && this.$d[d](m);
                ...
                (i.add = function (e, a) {
                  ...
                  var n = c.p(a),
                    d = function (f) {
                      var A = g(s);
                      return c.w(A.date(A.date() + Math.round(f * e)), s);
                    };
                  if (n === S) return this.set(S, this.$M + e);
                  if (n === P) return this.set(P, this.$y + e);
                  if (n === w) return d(1);
                  if (n === G) return d(7);
                  var m = ((t = {}), (t[M] = u), (t[k] = x), (t[h] = p), t)[n] || 1,
                    b = this.$d.getTime() + e * m;
                  return c.w(b, this);
                }),
                ...
                (i.format = function (e) {
                  ...
                  var s = e || 'YYYY-MM-DDTHH:mm:ssZ',
                    ...
                    L = t.meridiem,
                    I = function (y, C, _, $) {
                      return (y && (y[C] || y(a, s))) || _[C].slice(0, $);
                    },
                    E = function (y) {
                  ...
                  return s.replace(xo, function (y, C) {
                    return (
                      C ||
                      (function (_) {
                        switch (_) {
                          ...
                          case 'd':
                            return String(a.$W);
                          case 'dd':
                            return I(t.weekdaysMin, a.$W, f, 2);
                          case 'ddd':
                            return I(t.weekdaysShort, a.$W, f, 3);
                          case 'dddd':
                            return f[a.$W];
                          case 'H':
                            return String(d);
                ...
                (i.diff = function (e, a, t) {
                  var s,
                    n = this,
                    d = c.p(a),
                    m = g(e),
                    b = (m.utcOffset() - this.utcOffset()) * u,
                    f = this - m,
                    A = function () {
                      return c.m(n, m);
                    };
          ...
          return (
            ...
            (g.extend = function (o, i) {
              return (o.$i || (o(i, B, g), (o.$i = !0)), g);
            }),
            (g.locale = U),
            (g.isDayjs = q),
            (g.unix = function (o) {
...
const _o = {
  ...
  Go = {
    ...
    'channel.debounceMs': '防抖窗口（毫秒）',
    'channel.debounceMsHint': '在派发给 Agent 之前等待更多消息的时间（毫秒）',
    'channel.deleteAllChannels': '移除所有频道',
    'channel.deleteAllConfirm': '确定要移除所有频道吗？',
    'channel.deleteAllConfirmDesc': '此操作将永久移除该助手的所有消息频道及其配置，且无法撤销。',
    'channel.deleteAllFailed': '移除所有频道失败',
    'channel.deleteAllSuccess': '所有频道已移除',
    ...
    'channel.devWebhookProxyUrlHint':
      '可选。用于将 webhook 请求转发到本地开发服务器的 HTTPS 隧道 URL。',
    ...
    'channel.endpointUrlHint':
      '请复制此 URL 并粘贴到 {{name}} 开发者门户的 <bold>{{fieldName}}</bold> 字段中。',
    ...
    'channel.runtimeDisconnected': '机器人已断开连接',
    'channel.save': '保存配置',
    ...
    'channel.wechatRebind': '通过二维码重新绑定',
    'channel.wechatScanTitle': '连接微信机器人',
    'channel.wechatScanToConnect': '扫码连接',
    'channel.wechatTips':
      '请将微信更新至最新版本并重新启动。ClawBot 插件正在逐步推广，请前往设置 > 插件确认是否已获得访问权限。',
    'channel.wechatUserId': '微信用户 ID',
    'channel.wechatUserIdHint': '通过授权流程返回的微信账号标识符。',
  },
  Os = Object.freeze(
    Object.defineProperty({ __proto__: null, default: Go }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  Uo = {
  ...
  Bo = {
    ...
    'betterAuth.signin.socialOnlyHint':
      '此邮箱是通过第三方社交账号注册的。请使用该服务提供商登录，或',
    ...
    'betterAuth.signup.invalidReferralCodeContent':
      '您输入的邀请码 "{{code}}" 无效或已过期。是否继续注册？',
    'betterAuth.signup.invalidReferralCodeTitle': '无效的邀请码',
    'betterAuth.signup.lastNamePlaceholder': '姓氏',
    'betterAuth.signup.passwordPlaceholder': '请输入密码',
    'betterAuth.signup.referralCodePlaceholder': '邀请码（可选）',
    ...
    'heatmaps.tooltip': '{{date}} 当日产生 {{count}} 条消息',
    'heatmaps.totalCount': '过去一年共发送 {{count}} 条消息',
    'login': te,
    'loginGuide.f1': '获取免费使用额度',
    'loginGuide.f2': '跨设备同步消息',
    'loginGuide.f3': '访问丰富的智能助手',
  ...
  _s = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Bo, login: te, loginOrSignup: ie, signout: ae, signup: oe },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ...
  Rs = Object.freeze(
    Object.defineProperty({ __proto__: null, default: $o, title: se }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  ne = '在你离开期间，我们带来了新的特性',
  re = '查看所有更新日志',
  le = '持续追踪 {{appName}} 的新功能和改进',
  ce = '阅读详情',
  de = '更新日志',
  pe = '版本详情',
  ue = '欢迎回来!',
  ...
  me = '活跃',
  ge = `你好，我是 **{{name}}**。从一句话开始就行。

想让我更贴近你的工作方式：去 [助理设置]({{url}}) 补充助理档案（随时可改）`,
  be = '你好，我是 **{{name}}**。从一句话开始就行——决定权在你',
  he = '你好，我是 **{{name}}**。从一句话开始就行——决定权在你',
  fe = '助理',
  ye = '可用助理',
  ve = '跳转到最新',
  ke = '内置 Copilot',
  Ae = '清空当前会话消息',
  Se = '压缩历史',
  Me = '确认清空当前会话消息吗？清空后无法恢复',
  we = '确认删除该群组吗？群组专有助理将会被同样删除，外部助理不受影响',
  Pe = '确认删除该分类吗？分类内的助理会移回默认列表',
  Ce = '群组已删除',
  Te = '确认删除该助理吗？删除后无法恢复',
  Ie = '助理已删除',
  De = '自定义助理',
  ...
  Fe = '自定义助理',
  Le = '{{title}} 副本',
  Oe = '还没有助理。从第一个助理开始，慢慢搭建你的助理体系',
  Ee = '创建助理',
  _e = '群组描述',
  Re = '私信内容已隐藏。可在设置中开启「显示私信内容」查看',
  Ge = '历史范围',
  Ue = '历史消息总结',
  Be = '不活跃',
  $e = '邀请成员',
  ...
  ze = '创建群组',
  qe = '创建文稿',
  We = '这个群组还没有成员。点击「+」邀请助理加入',
  Ke = '暂无可邀请的成员',
  Je = '未找到匹配的成员',
  Ve = '这个群组还没有成员。点击「+」邀请助理加入',
  Ye = '还未选择成员',
  Qe = '在新窗口打开',
  Xe = '群主',
  Ze = '置顶',
  ...
  ot = '搜索助理…',
  st = '已选助理',
  nt = '从任何想法开始… <hotkey><hotkey/>',
  rt = '此内容由用户分享，不代表 LobeHub 观点。LobeHub 不对该分享内容产生的任何后果承担责任。',
  lt = '未命名助理',
  ct = '未命名群组',
  dt = '更新助理信息',
  pt = '你',
...
写作、编程、数据分析都可以——你负责目标与标准，我来帮你把想法拆成可协作、可运行的助理。`,
    'agentDefaultMessage': ge,
    'agentDefaultMessageWithSystemRole': be,
    'agentDefaultMessageWithoutEdit': he,
    'agents': fe,
    ...
    'clearCurrentMessages': Ae,
    'compressedHistory': Se,
    'compression.cancel': '取消压缩',
    'compression.cancelConfirm': '确定要取消压缩吗？这将恢复原始消息。',
    'compression.history': '历史记录',
    'compression.summary': '摘要',
    'confirmClearCurrentMessages': Me,
    'confirmRemoveChatGroupItemAlert': we,
    'confirmRemoveGroupItemAlert': Pe,
    'confirmRemoveGroupSuccess': Ce,
    'confirmRemoveSessionItemAlert': Te,
    'confirmRemoveSessionSuccess': Ie,
    'defaultAgent': De,
    'defaultGroupChat': xe,
    'defaultList': Ne,
    'defaultSession': Fe,
    ...
    'extendParams.disableContextCaching.desc':
      '最多可减少90%的单次对话生成成本，并将速度提升至最多4倍。<1>了解更多</1>',
    ...
    'extendParams.enableAdaptiveThinking.desc':
      '启用自适应思维模式，让 Claude 动态决定思考的时机和深度。',
...
起草、改写、润色都可以。你把意图说清楚，其余交给我打磨`,
    ...
    'shareModal.popover.privacyWarning.content':
      '请确保对话中不含个人隐私或敏感信息，LobeHub 不对任何分享的内容及其产生的后果负责。',
  ...
  qo = {
    ...
    'alert.cloud.desc':
      '所有注册用户每月可获得 {{credit}} 免费计算额度—无需设置。包括全球云同步和高级网页搜索功能。',
    ...
    'autoGenerate': Lt,
    'autoGenerateTooltip': Ot,
    'autoGenerateTooltipDisabled': Et,
    'back': _t,
    'batchDelete': Rt,
    'blog': Gt,
    'branching': Ut,
    'branchingDisable': Bt,
    'branchingRequiresSavedTopic': $t,
    'cancel': Ht,
    'changelog': jt,
    'checkForUpdates': zt,
    ...
    'cmdk.keywords.about': '关于 版本 信息',
    'cmdk.keywords.apikey': 'apikey api 密钥 令牌',
    'cmdk.keywords.appearance': '通用 外观 主题 显示',
    'cmdk.keywords.billing': '账单 支付 发票 交易',
    'cmdk.keywords.community': '发现 市场 助理 模型 提供商 mcp',
    'cmdk.keywords.contactUs': '反馈 问题 错误 建议 联系',
    'cmdk.keywords.discord': 'discord 帮助 支持 客服 社区',
    'cmdk.keywords.funds': '资金 余额 积分 充值',
    'cmdk.keywords.hotkey': '热键 快捷键 键盘',
    'cmdk.keywords.image': '图像 图片 照片',
    'cmdk.keywords.memory': '身份 上下文 偏好 经验 记忆',
    'cmdk.keywords.pages': '文档 写作 笔记 文稿',
    'cmdk.keywords.painting': '绘画 艺术 生成 画图 绘图',
    'cmdk.keywords.plans': '订阅 计划 升级 定价 会员',
    'cmdk.keywords.profile': '个人资料 用户 账户 账号',
    'cmdk.keywords.provider': '提供商 llm 模型 ai 大模型',
    'cmdk.keywords.proxy': '代理 网络 连接',
    'cmdk.keywords.referral': '推荐 奖励 邀请 返利',
    'cmdk.keywords.resources': '知识 文件 库 文档 资源',
    'cmdk.keywords.settings': '设置 偏好 配置 选项',
    ...
    'cmdk.newLibrary': '新建库',
    'cmdk.newPage': '新建文稿',
    'cmdk.newTopic': '在当前助手中创建新话题',
    'cmdk.noResults': '未找到结果',
    ...
    'cmdk.search.memories': '记忆',
    'cmdk.search.memory': '记忆',
    ...
    'feedback.errors.uploadFailed': '上传失败',
    'feedback.fields.message.label': '详细信息',
    'feedback.fields.message.maxLength': '详细信息不能超过 5000 个字符',
    'feedback.fields.message.placeholder': '请详细描述您的问题、建议或反馈...',
    'feedback.fields.message.required': '请输入详细信息',
    'feedback.fields.screenshot.hint': '最大文件大小：5MB。支持格式：PNG、JPG、GIF',
    'feedback.fields.screenshot.label': '截图（可选）',
    'feedback.fields.screenshot.remove': '移除',
    'feedback.fields.screenshot.upload': '上传截图',
    'feedback.fields.screenshot.uploading': '上传中...',
    'feedback.fields.title.label': '标题',
    'feedback.fields.title.maxLength': '标题不能超过 200 个字符',
    'feedback.fields.title.placeholder': '简要描述您的问题或反馈',
    'feedback.fields.title.required': '请输入标题',
    'feedback.screenshotUploaded': '截图上传成功',
    'feedback.submit': '提交反馈',
    'feedback.success': '感谢您的反馈！我们已收到您的意见。',
    'feedback.title': '我们能帮您什么？',
    'follow': si,
    ...
    'serverVersionOutdated.warning':
      '部分功能可能无法正常使用或出现非预期行为。建议更新服务端以获得最佳体验。',
    'setting': Ri,
    'share': Gi,
    'stop': Ui,
    'switch': '切换',
  ...
  Wo = {
    ...
    'FileManager.actions.confirmDeleteAllFiles':
      '将删除当前结果中的全部数据，删除后不可恢复。建议确认无误再继续',
    ...
    'FileManager.actions.confirmRemoveFromLibrary':
      '您即将从资料库中移除 {{count}} 个已选文件。它们仍可在“所有文件”中访问。请确认以继续。',
    ...
    'GenerationModelItem.creditsPerImageApproximate': '约 {{amount}} 算力积分/张',
    'GenerationModelItem.creditsPerImageExact': '{{amount}} 算力积分/张',
    'GenerationModelItem.creditsPerVideoApproximate': '约 {{amount}} 算力积分/条',
    'GenerationModelItem.creditsPerVideoExact': '{{amount}} 算力积分/条',
    'GoBack.back': '返回',
    ...
    'ImageUpload.validation.imageAspectRatioInvalid':
      '{{fileName}} 宽高比 ({{actualRatio}}) 超出范围，要求：{{range}}',
    'ImageUpload.validation.imageDimensionTooLarge':
      '{{fileName}} ({{width}}x{{height}}) 尺寸过大，要求：{{maxDimension}}',
    'ImageUpload.validation.imageDimensionTooSmall':
      '{{fileName}} ({{width}}x{{height}}) 尺寸过小，要求：{{minDimension}}',
    ...
    'ModelSelect.featureTag.custom':
      '自定义模型，默认支持函数调用和视觉识别。请根据实际情况确认上述功能是否可用。',
    ...
    'OllamaSetupGuide.install.linux.manual':
      '或者，你也可以参考 <1>Linux 手动安装指南</1> 自行安装',
  ...
  Ko = {
    ...
    'screen1.slogan.line1': '为你而生',
    'screen1.slogan.line2': '超级个体',
    'screen2.badge': '功能亮点',
    'screen2.description': '为你的工作流量身打造的高级 AI 能力',
    'screen2.features.1.subtitle': '图像生成',
    'screen2.features.1.title': '把灵感变成画面',
    'screen2.features.2.subtitle': 'MCP 市场',
    'screen2.features.2.title': '发现 · 连接 · 扩展',
    'screen2.features.3.subtitle': '智能网页搜索',
    'screen2.features.3.title': '世界知识随时可用',
    'screen2.features.4.subtitle': '跨端同步',
    'screen2.features.4.title': '你的空间，随时随地',
    'screen2.features.5.subtitle': 'Artifacts',
    'screen2.features.5.title': 'AI 与视觉创作相遇',
    ...
    'screen3.badge': '权限',
    'screen3.description': '授予权限以解锁代理和群组的全部潜能。您可以随时在设置中进行管理。',
    'screen3.permissions.1.description': '在任务完成、代理响应或有重要更新时接收通知',
    'screen3.permissions.1.title': '通知',
    'screen3.permissions.2.description':
      '访问文件和文件夹，以启用文档分析、知识库创建和文件处理流程',
    'screen3.permissions.2.title': '文件访问',
    'screen3.permissions.3.description': '捕捉屏幕内容和音频，用于语音交互、屏幕分析和多模态辅助',
    'screen3.permissions.3.title': '屏幕与音频',
    'screen3.permissions.4.description': '启用系统级自动化，实现跨应用的无缝工作流执行',
    'screen3.permissions.4.title': '辅助功能',
    'screen3.title': '授予权限',
    'screen3.title2': '启用访问权限以解锁完整功能',
    'screen3.title3': '您可以随时在设置中进行管理',
    'screen4.badge': '隐私',
    'screen4.description':
      '选择您希望如何共享数据。您的选择将帮助我们改进，您也可以随时在设置中更改。',
    'screen4.footerNote': '您可以随时在设置中更改',
    'screen4.navigation.next': '继续',
    'screen4.privacy.description':
      '不共享匿名使用数据，也不会上传性能、模型使用或功能交互等统计信息。',
    'screen4.privacy.items.1': '不收集数据',
    'screen4.privacy.items.2': '不做使用分析',
    'screen4.privacy.items.3': '处理尽量在本地完成',
    'screen4.privacy.title': '隐私模式',
    'screen4.share.description':
      '共享匿名使用数据，帮助我们改进 LobeHub。这有助于我们了解代理的使用方式并加以优化。',
    'screen4.share.items.1': '性能指标',
    'screen4.share.items.2': '模型使用情况',
    'screen4.share.items.3': '功能交互数据',
    'screen4.share.title': '帮助改进 LobeHub',
    ...
    'screen5.methods.selfhost.name': '自托管实例',
    'screen5.navigation.next': '开始使用',
    'screen5.selfhost.endpointPlaceholder': '请输入您的服务器地址（例如：https://your-server.com）',
    'screen5.title': '登录以实现跨设备同步',
    'screen5.title2': '让您的数据随处同步',
    'screen5.title3': '您的数据始终由您掌控',
  },
  js = Object.freeze(
    Object.defineProperty(
      { __proto__: null, back: Wi, default: Ko, next: Ki },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ...
  Jo = {
    ...
    'home.more': '发现更多',
    'home.recommendAgents': '推荐助理',
    'home.recommendEmpty': '暂无推荐内容',
    'home.recommendGroups': '推荐群组',
    'home.recommendWritingAgents': '写作助理',
    'isClaimed': Zi,
    'isFeatured': ea,
    'isOfficial': ta,
    'like': ia,
    ...
    'mcp.categories.discover.description': '推荐和热门的 MCP 服务器',
    'mcp.categories.discover.name': '发现',
    ...
    'mcp.details.agents.empty': '暂无助理使用此技能',
    'mcp.details.agents.networkError': '数据加载失败，请检查网络后重试',
    'mcp.details.agents.title': '使用该技能的助理',
    ...
    'mcp.details.deployment.platform.steps.claude': `- 打开 **Claude Desktop** 应用
- 前往 **设置**，然后选择 **开发者**
- 点击 **编辑配置**
- 打开 **claude_desktop_config.json** 文件
- 复制并粘贴服务器配置到现有文件中，然后保存`,
    'mcp.details.deployment.platform.steps.cline': `- 打开安装了 Cline 扩展的 VS Code
- 点击侧边栏中的 Cline 图标
- 从下拉菜单中选择 **MCP Servers**
- 在 **Remote Servers** 标签页中，输入服务器名称和你的 MCP 服务器 URL
- 点击 **Add Server** 进行连接`,
    'mcp.details.deployment.platform.steps.cursor': `- 导航到 **设置**，然后选择 Cursor 设置
- 在左侧选择 **MCP**
- 点击右上角的 **添加新的全局 MCP 服务器**
- 复制并粘贴服务器配置到现有文件中，然后保存`,
    'mcp.details.deployment.platform.steps.lobeChat': `- 打开 **LobeHub 桌面版** 应用
- 前往 **设置** - **默认助理**
- 然后选择 **技能设置** - **自定义技能**
- 点击 **快速导入 JSON 配置**
- 复制并粘贴服务器配置到文本框，然后安装`,
    'mcp.details.deployment.platform.steps.openai': `- 打开你的 **OpenAI 应用** 或开发环境
...
- 设置 \`require_approval\` 来控制工具执行审批`,
    ...
    'mcp.details.githubBadge.desc': `LobeHub 定期对代码库和文档进行扫描，以便于：
...
请将以下代码复制到你的 \`README.md\` 文件中：`,
    ...
    'mcp.details.score.deployment.desc':
      '该 MCP Server 提供了至少一种安装方式，允许用户部署和使用。',
    ...
    'user.githubUrl': 'GitHub 仓库地址',
    'user.githubUrlInvalid': '请输入有效的 GitHub 仓库地址',
    'user.githubUrlRequired': '请输入 GitHub 仓库地址',
    'user.login': '成为创作者',
    'user.logout': '退出登录',
    'user.myProfile': '我的主页',
    ...
    'user.noPlugins': '该用户暂未发布插件',
    'user.noSkills': '该用户暂未发布技能',
    'user.plugins': '插件',
    ...
    'user.submit': '提交',
    'user.submitRepo': '提交仓库',
    'user.submitRepoDescription': '提交你的 GitHub 仓库，将你的 Skills 或 MCP 导入到社区。',
    'user.submitRepoError': '提交仓库失败，请重试。',
    'user.submitRepoHint': '仓库将在审核后发布。',
    'user.submitRepoSuccess': '仓库提交成功！审核通过后将自动发布。',
    'user.submitRepoTitle': '提交你的仓库',
  ...
  qs = Object.freeze(
    Object.defineProperty(
      { __proto__: null, cancel: oa, confirm: sa, default: Vo },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ...
  Qo = {
    ...
    'exceededContext.desc':
      '对话已超出模型上下文窗口限制。你可以压缩上下文来压缩历史记录并继续对话。',
    ...
    'response.ExceededContextWindowCloud':
      '当前对话内容过长，无法继续处理。请编辑最后一条消息减少输入内容或者删除一些消息重试。',
    'response.FreePlanLimit': '当前计划不支持该功能。请升级到付费计划后继续',
    'response.GoogleAIBlockReason.BLOCKLIST': '内容包含被屏蔽的词语。请重新措辞后再试。',
    'response.GoogleAIBlockReason.IMAGE_SAFETY': '生成的图像因安全原因被屏蔽。请尝试修改您的请求。',
    'response.GoogleAIBlockReason.LANGUAGE': '请求的语言不受支持。请尝试使用支持的语言。',
    'response.GoogleAIBlockReason.OTHER': '内容因未知原因被屏蔽。请重新措辞后再试。',
    'response.GoogleAIBlockReason.PROHIBITED_CONTENT': '内容可能包含禁止内容。请调整后再试。',
    'response.GoogleAIBlockReason.RECITATION': '内容因复述风险被屏蔽。请使用更原创的措辞后再试。',
    'response.GoogleAIBlockReason.SAFETY': '内容因安全原因被屏蔽。请调整后再试。',
    'response.GoogleAIBlockReason.SPII': '内容可能包含敏感个人信息（SPII）。请移除敏感信息后再试。',
    'response.GoogleAIBlockReason.default': '内容被屏蔽（{{blockReason}}）。请调整后再试。',
    'response.InsufficientBudgetForModel':
      '剩余额度不足以使用此模型。请充值额度、升级订阅计划，或尝试使用费用更低的模型。',
    ...
    'response.InvalidProviderAPIKey':
      '{{provider}} API Key 为空或不正确，请检查 {{provider}} API Key 后重试',
    ...
    'response.PluginServerError':
      '技能服务端返回错误，请根据下方信息检查技能描述、配置或服务端实现',
    ...
    'response.SubscriptionPlanLimitUltimate':
      '您的订阅积分已用尽，无法使用此功能。请充值积分或配置自定义模型 API 以继续使用。',
    ...
    'upload.storageLimitExceeded':
      '文件存储空间已达到当前套餐上限，请升级套餐或删除不需要的文件以释放空间。',
    'upload.title': '上传未能完成',
  ...
  Ks = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Qo, testConnectionFailed: na },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  Xo = {
    ...
    'run.actions.retryErrors.confirm':
      '将重新运行所有错误和超时的用例。已通过和未通过的用例不受影响。',
    'run.actions.run': '执行',
  ...
  la = '添加',
  ca = '创建文稿',
  da = '这里还没有文件或文件夹。先上传一个文件，或创建文稿开始整理',
  pa = '加载更多',
  ua = '获取资源库失败，请检测网络连接后重试',
  ma = '资源',
  ga = '搜索文件',
  ba = '搜索文稿',
  ha = '资源',
  ...
  Zo = {
    ...
    'resource': ma,
    'searchFilePlaceholder': ga,
    'searchPagePlaceholder': ba,
    'tab.all': '全部',
    'tab.audios': '语音',
    'tab.documents': '文档',
    'tab.home': '首页',
  ...
  es = {
    ...
    'starter.videoGeneration': '视频生成',
    'starter.write': '写作',
  },
  Ys = Object.freeze(
    Object.defineProperty({ __proto__: null, default: es }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  ts = {
  ...
  Qs = Object.freeze(
    Object.defineProperty({ __proto__: null, default: ts }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  is = {
  ...
  ya = '资料库',
  as = {
    'addToKnowledgeBase.addSuccess': '文件添加成功',
    'addToKnowledgeBase.alreadyExists': '该文件已在此资源库中',
    ...
    'moveToKnowledgeBase.error': '移动文件到资源库失败',
    'moveToKnowledgeBase.success': '文件移动成功',
    'tab.evals': '评估',
    'tab.files': '文件',
    'tab.settings': '设置',
    'tab.testing': '回忆测试',
  ...
  Zs = Object.freeze(
    Object.defineProperty({ __proto__: null, default: as, title: ya }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  va = '这里会不定期更新我们正在探索的新功能，欢迎试用！',
  ka = '实验室',
  os = {
    'desc': va,
  ...
  en = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: os, desc: va, title: ka },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ss = {
    'authorize.cancel': '暂不授权',
    ...
    'claimResources.claim': '认领所选',
    'claimResources.description': '我们发现了与你的账户关联的资源，你可以认领它们：',
    'claimResources.error': '认领资源失败，请重试。',
    'claimResources.mcpSection': 'MCP 服务器',
    'claimResources.selectedCount': '已选择 {{count}} 项',
    'claimResources.skillSection': 'Skills',
    'claimResources.skip': '跳过',
    'claimResources.success': '成功认领 {{count}} 个资源',
    'claimResources.title': '认领你的资源',
    ...
    'profileSetup.confirmChangeUserId.confirm': '确认修改',
    'profileSetup.confirmChangeUserId.description':
      '切换到 @{{newId}} 后，其他人可以注册你的旧 ID @{{oldId}}，已有的主页链接也会全部失效且无法恢复。确定要继续吗？',
    'profileSetup.confirmChangeUserId.title': '确认修改用户 ID？',
    ...
    'profileSetup.socialLinks.connectProvider': '连接 {{provider}}',
    'profileSetup.socialLinks.connected': '已连接',
    'profileSetup.socialLinks.connecting': '连接中…',
    'profileSetup.socialLinks.disconnect': '断开连接',
  ...
  tn = Object.freeze(
    Object.defineProperty({ __proto__: null, default: ss }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  Aa = '加载中...',
  ns = {
    ...
    'activity.defaultType': '活动',
    'activity.deleteConfirm': '您确定要删除此活动记忆吗？此操作无法撤销。',
    'activity.deleteTitle': '删除活动记忆',
    'activity.empty': '暂无活动记忆',
    'activity.feedback': '反馈',
    'activity.narrative': '叙述',
    'activity.notes': '备注',
    'analysis.action.button': '请求记忆分析',
    'analysis.modal.cancel': '取消',
    'analysis.modal.helper':
      '默认情况下，Lobe AI 将分析所有未处理的对话。您也可以选择一个日期范围进行分析（可选）。',
    'analysis.modal.rangePlaceholder': '未选择日期范围；将分析所有对话。',
    'analysis.modal.rangeSelected': '正在分析 {{start}} 至 {{end}} 的对话',
    'analysis.modal.submit': '请求记忆分析',
    'analysis.modal.title': '分析对话以生成记忆',
    'analysis.range.all': '全部对话',
    'analysis.range.end': '今天',
    'analysis.range.start': '最初',
    'analysis.status.errorTitle': '记忆分析请求失败',
    'analysis.status.progress': '已处理 {{completed}} / {{total}} 个话题',
    'analysis.status.progressUnknown': '目前已处理 {{completed}} 个主题',
    'analysis.status.tip': '我们正在处理您的对话内容，以构建个人记忆。这可能需要几分钟时间。',
    'analysis.status.title': '记忆分析中',
    'analysis.toast.deduped': '已有记忆分析请求正在进行，继续处理进度中…',
    'analysis.toast.failed': '记忆分析请求失败。请重试。',
    'analysis.toast.started': '记忆分析已开始。准备就绪后我们会通知您。',
    ...
    'identity.list.deleteOk': '删除',
    'identity.list.noResults': '未找到匹配的身份记忆',
    'identity.list.updated': '已更新',
    'identity.roleCloud.collapse': '收起',
    'identity.roleCloud.expand': '显示更多',
    'identity.view.list': '列表',
    'identity.view.timeline': '时间轴',
    'loading': Aa,
    'preference.actions.delete': '删除',
    'preference.actions.edit': '编辑',
    'preference.conclusionDirectives': '结论指令',
    ...
    'purge.action': '清除全部',
    'purge.confirm': '您确定要删除所有记忆吗？这将永久移除每一条记忆记录，且无法撤销。',
    'purge.error': '清除记忆失败。请重试。',
    'purge.success': '所有记忆已被删除。',
    'purge.title': '清除所有记忆',
    'tab.activities': '活动',
    'tab.contexts': '情境',
    'tab.experiences': '经验',
  ...
  an = Object.freeze(
    Object.defineProperty({ __proto__: null, default: ns, loading: Aa }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  rs = {
    'changelog.description': '随时了解 {{appName}} 的新功能与改进',
    'changelog.title': '更新日志',
    'chat.description':
      '{{appName}} 致力于构建下一代工作与生活空间，你可以找到、创建，或与 Agent 团队共事，无限进步！',
    'chat.title': '{{appName}} · 同 Agent 团队一起无限进步',
    'discover.assistants.description':
      '内容、问答、图像、视频、语音、工作流——从社区中浏览并添加智能体。',
    'discover.assistants.title': '智能体社区',
    'discover.description': '探索智能体、技能、模型提供商、模型和 MCP 服务器。',
    'discover.mcp.description':
      '搜索、比较并连接数千个 MCP 服务器，使 AI 系统能够轻松访问文件系统、数据库、API 及其他关键资源，全面扩展您的 AI 能力。',
    'discover.mcp.title': 'MCP 服务器社区',
    'discover.models.description':
      '探索主流 AI 模型：OpenAI / GPT / Claude 3 / Gemini / Ollama / Azure / DeepSeek',
    'discover.models.title': '模型社区',
    'discover.plugins.description':
      '探索图表、学术工具、图像/视频/语音生成与工作流——为您的智能体添加技能。',
    'discover.plugins.title': '技能社区',
    'discover.providers.description':
      '探索领先的模型提供商：OpenAI / 通义千问 / Ollama / Anthropic / DeepSeek / Google Gemini / OpenRouter',
    'discover.providers.title': '提供商社区',
    'discover.search': '搜索',
    'discover.title': '探索',
    'image.description':
      '{{appName}} 携手 GPT Image、Flux、Midjourney 和 Stable Diffusion，为您带来卓越的体验',
    'image.title': 'AI 艺术',
    'plugins.description':
      '搜索、图表、学术工具、图像/视频/语音生成、工作流——为您的智能体添加技能。',
    'plugins.title': '技能社区',
    'welcome.description':
      '{{appName}} 为 ChatGPT、Claude、Gemini 和 OLLaMA 提供最佳的用户界面体验。',
    'welcome.title': '欢迎使用 {{appName}} · Agent 协同平台',
  },
  on = Object.freeze(
  ...
  ls = {
    ...
    'dbV1.features.use.desc':
      '支持标题、描述、标签、消息内容乃至翻译文本检索，日常搜索效率大大提升',
    'dbV1.features.use.title': '更易用',
    'dbV1.title': '{{appName}} 数据进化',
    'dbV1.upgrade.error.subTitle': `升级过程中遇到问题。你可以：A. 先清空本地数据，再导入备份；B. 点击「重新升级」再试一次。
...
如果仍然失败：请通过 <1>提交问题</1> 发送错误信息，我们会尽快排查。`,
  ...
  sn = Object.freeze(
    Object.defineProperty({ __proto__: null, default: ls }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  Sa = '图片 "{{prompt}}" 已生成完成',
  ...
  Pa = '视频已生成',
  cs = {
    'image_generation_completed': Sa,
    'image_generation_completed_title': Ma,
    ...
    'inbox.title': '通知',
    'video_generation_completed': wa,
    'video_generation_completed_title': Pa,
  },
  nn = Object.freeze(
    Object.defineProperty(
      {
  ...
  rn = Object.freeze(
    Object.defineProperty({ __proto__: null, default: ds }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  Ca = '上一步',
  ...
  ln = Object.freeze(
    Object.defineProperty(
      { __proto__: null, back: Ca, default: ps, finish: Ta, next: Ia, title: Da },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
 ...
 {{error}}`,
    ...
    'search.searchxng.unconfiguredDesc':
      '请联系管理员完成 SearchXNG 搜索引擎配置，即可开始联网搜索',
    ...
    'skillDetail.trustWarning':
      '请仅使用您信任的开发者提供的连接器。LobeHub 无法控制开发者提供哪些工具，也无法验证这些工具是否按预期工作或是否会发生变化。',
  ...
  _a = '构件',
  Ra = '技能',
  Ga = '当前 Artifacts 列表为空，请在会话中按需使用技能后再查看',
  Ua = '当前知识列表为空',
  Ba = '文件',
  $a = '消息详情',
  Ha = '在文稿中编辑',
  ...
  ms = {
    ...
    'emptyArtifactList': Ga,
    'emptyKnowledgeList': Ua,
    'files': Ba,
    'messageDetail': $a,
  ...
  gs = {
    'ai21.description': 'AI21 Labs 为企业构建基础模型和 AI 系统，加速生成式 AI 的落地应用。',
    'ai302.description': '302.AI 是一个按需付费的 AI 平台，提供丰富的 AI API 和在线 AI 应用目录。',
    'ai360.description':
      '360 AI 是来自 360 的模型与服务平台，提供如 360GPT2 Pro、360GPT Pro 和 360GPT Turbo 等自然语言处理模型，结合大参数规模与多模态能力，支持文本生成、语义理解、对话与代码处理，定价灵活，满足多样化需求。',
    'aihubmix.description': 'AiHubMix 通过统一 API 提供多种 AI 模型的访问能力。',
    'akashchat.description':
      'Akash 是一个无需许可的云资源市场，与传统云提供商相比，其定价具有竞争力。',
    'anthropic.description':
      'Anthropic 构建了先进的语言模型，如 Claude 3.5 Sonnet、Claude 3 Sonnet、Claude 3 Opus 和 Claude 3 Haiku，兼顾智能、速度与成本，适用于企业级到快速响应等多种场景。',
    'azure.description':
      'Azure 提供先进的 AI 模型，包括 GPT-3.5 和 GPT-4 系列，支持多种数据类型和复杂任务，注重安全、可靠与可持续的 AI 实践。',
    'azureai.description':
      'Azure 提供先进的 AI 模型，包括 GPT-3.5 和 GPT-4 系列，支持多种数据类型和复杂任务，注重安全、可靠与可持续的 AI 实践。',
    'baichuan.description':
      '百川智能专注于基础模型研发，具备强大的中文知识理解、长文本处理与创意生成能力。其模型（如百川4、百川3 Turbo、百川3 Turbo 128k）针对不同场景优化，性价比高。',
    'bailiancodingplan.description':
      '阿里云百炼编程计划是一项专用的 AI 编程服务，通过专属端点提供来自通义千问、智谱、Kimi 和 MiniMax 的编程优化模型。',
    'bedrock.description':
      'Amazon Bedrock 为企业提供先进的语言与视觉模型，包括 Anthropic Claude 和 Meta Llama 3.1，涵盖轻量级到高性能选项，支持文本、对话与图像任务。',
    'bfl.description': '一家前沿 AI 研究实验室，致力于构建未来的视觉基础设施。',
    'cerebras.description':
      'Cerebras 是基于其 CS-3 系统构建的推理平台，专注于超低延迟和高吞吐量的大模型服务，适用于代码生成和智能体等实时任务。',
    'cloudflare.description': '在 Cloudflare 全球网络上运行无服务器、GPU 加速的机器学习模型。',
    'cohere.description':
      'Cohere 提供前沿的多语言模型、先进的检索能力和 AI 工作空间，为现代企业提供一体化、安全的平台。',
    'cometapi.description':
      'CometAPI 提供对 OpenAI、Anthropic、Google 等前沿模型的访问，用户可根据不同需求选择最优模型与价格。',
    'comfyui.description':
      '一个强大的开源工作流引擎，支持图像、视频和音频生成，兼容 SD、FLUX、Qwen、混元、WAN 等模型，支持节点式编辑与私有部署。',
    'deepseek.description':
      'DeepSeek 专注于 AI 研究与应用，其最新 DeepSeek-V3 在基准测试中超越 Qwen2.5-72B 和 Llama-3.1-405B 等开源模型，接近 GPT-4o 和 Claude-3.5-Sonnet 等闭源领先模型。',
    'fal.description': '一个为开发者打造的生成式媒体平台。',
    'fireworksai.description':
      'Fireworks AI 提供先进的语言模型服务，支持函数调用与多模态处理。Firefunction V2（基于 Llama-3）优化了函数调用、对话与指令执行，FireLLaVA-13B 支持图文混合输入，另有 Llama 与 Mixtral 系列模型。',
    'giteeai.description': 'Gitee AI Serverless API 为开发者提供即插即用的大模型推理服务。',
    'github.description': '通过 GitHub Models，开发者可使用行业领先模型构建 AI 工程项目。',
    'githubcopilot.description': '通过您的 GitHub Copilot 订阅访问 Claude、GPT 和 Gemini 模型。',
    'glmcodingplan.description':
      'GLM Coding Plan 提供对智谱 AI 模型（包括 GLM-5 和 GLM-4.7）的访问，适用于编程任务，采用固定月费订阅模式。',
    'google.description':
      'Google 的 Gemini 系列是其最先进的通用 AI，由 Google DeepMind 构建，支持文本、代码、图像、音频与视频的多模态应用，具备从数据中心到移动设备的高效扩展能力。',
    'groq.description':
      'Groq 的 LPU 推理引擎在基准测试中表现卓越，具备极高速度与效率，为低延迟云端大模型推理设立新标杆。',
    'higress.description':
      'Higress 是阿里巴巴内部打造的云原生 API 网关，解决 Tengine 重载对长连接的影响及 gRPC/Dubbo 负载均衡的不足。',
    'huggingface.description':
      'Hugging Face 推理 API 提供快速访问数千个高性能模型，适用于原型开发与机器学习实验。',
    'hunyuan.description':
      '腾讯自研大模型，具备强大的中文写作能力、复杂语境下的推理能力与任务执行稳定性。',
    'infiniai.description':
      '为应用开发者提供高性能、易用、安全的大模型服务，覆盖从模型开发到生产部署的完整流程。',
    'internlm.description':
      '一个专注于大模型研究与工具链的开源组织，提供高效、易用的平台，让前沿模型与算法触手可及。',
    'jina.description':
      'Jina AI 成立于 2020 年，是领先的搜索 AI 公司，其搜索技术栈包括向量模型、重排序器与小型语言模型，支持构建高质量的生成式与多模态搜索应用。',
    'kimicodingplan.description':
      'Kimi Code Plan 由 Moonshot AI 提供，通过固定月费订阅方式访问 Kimi 模型（包括 K2.5）用于编程任务。',
    'lmstudio.description': 'LM Studio 是一款桌面应用，支持在本地开发与实验大语言模型。',
    'lobehub.description':
      'LobeHub Cloud 使用官方 API 访问 AI 模型，并通过与模型令牌相关的积分来衡量使用情况。',
    'longcat.description':
      'LongCat 是由美团自主研发的生成式 AI 大模型系列，旨在通过高效的计算架构和强大的多模态能力，提升企业内部工作效率并推动创新应用的发展。',
    'minimax.description':
      'MiniMax 成立于 2021 年，致力于构建通用 AI，拥有多模态基础模型，包括万亿参数的 MoE 文本模型、语音模型与视觉模型，并推出海螺 AI 等应用。',
    'minimaxcodingplan.description':
      'MiniMax Token Plan 提供对 MiniMax 模型（包括 M2.7）的访问，适用于编程任务，采用固定月费订阅模式。',
    'mistral.description':
      'Mistral 提供先进的通用、专业与研究型模型，支持复杂推理、多语言任务与代码生成，具备函数调用能力以实现定制集成。',
    'modelscope.description': 'ModelScope 是阿里云的模型即服务平台，提供丰富的 AI 模型与推理服务。',
    'moonshot.description':
      'Moonshot（北京月之暗面科技）推出多款 NLP 模型，适用于内容创作、科研、推荐与医疗分析等场景，具备强大的长文本与复杂生成能力。',
    'nebius.description':
      'Nebius 通过大规模 GPU 集群与垂直整合的云平台，为全球 AI 创新者提供高性能基础设施。',
    'newapi.description': '一个开源的多 AI 服务聚合与路由平台。',
    'novita.description':
      'Novita AI 提供灵活、可靠、性价比高的 LLM 与图像生成 API，支持 Llama 3、Mistral 等模型，适合生成式 AI 初创企业的可扩展开发需求。',
    'nvidia.description':
      'NVIDIA NIM 提供自托管、GPU 加速的推理微服务容器，适用于云端、数据中心、RTX AI PC 与工作站，支持预训练与自定义模型。',
    'ollama.description':
      'Ollama 提供涵盖代码生成、数学、多语言处理与对话的模型，支持企业级与本地部署。',
    'ollamacloud.description':
      'Ollama Cloud 提供托管推理服务，开箱即用访问 Ollama 模型库与兼容 OpenAI 的 API。',
    'openai.description':
      'OpenAI 是领先的 AI 研究实验室，其 GPT 模型推动自然语言处理发展，在科研、商业与创新中表现卓越、价值显著。',
    'openrouter.description':
      'OpenRouter 提供对 OpenAI、Anthropic、LLaMA 等前沿模型的访问，用户可根据需求选择最优模型与价格。',
    'perplexity.description':
      'Perplexity 提供先进的对话模型，包括 Llama 3.1 变体，适用于在线与离线使用及复杂 NLP 任务。',
    'ppio.description':
      'PPIO 提供可靠、性价比高的开源模型 API，支持 DeepSeek、Llama、Qwen 等主流模型。',
    'qiniu.description': '七牛云提供可靠、性价比高的实时与批量 AI 推理服务，使用便捷。',
    'qwen.description':
      'Qwen 是阿里云的大规模语言模型，具备强大的理解与生成能力，覆盖问答、写作、观点表达与代码等多个领域。',
    'replicate.description':
      'Replicate 通过简单的云 API 运行开源图像模型，如 FLUX 与 Stable Diffusion。',
    'sambanova.description': 'SambaNova Cloud 让开发者以极快速度使用顶级开源模型进行推理。',
    'search1api.description':
      'Search1API 提供 DeepSeek 模型访问，支持可选联网功能，涵盖多个参数规模的标准与极速版本。',
    'sensenova.description': 'SenseNova 基于商汤基础设施，提供高效、易用的全栈大模型服务。',
    'siliconcloud.description': 'SiliconCloud 是基于强大开源模型构建的高性价比生成式 AI 云服务。',
    'spark.description':
      '讯飞星火提供强大的多语言 AI 能力，广泛应用于智能硬件、医疗、金融等垂直领域，推动创新发展。',
    'stepfun.description':
      'Stepfun 模型具备领先的多模态与复杂推理能力，支持长文本理解与强大的自主搜索编排。',
    'straico.description':
      'Straico 致力于简化 AI 集成，通过提供一个整合了顶尖文本、图像和音频生成式 AI 模型的统一工作空间，赋能营销人员、企业家及爱好者等各类用户，实现对多样化 AI 工具的无缝访问。',
    'taichu.description':
      '太初是中科院自动化所与武汉人工智能研究院联合研发的新一代多模态模型，支持多轮问答、写作、图像生成、3D 理解与信号分析，具备更强的认知与创造力。',
    'tencentcloud.description':
      '腾讯云大模型知识引擎原子能力为企业与开发者提供端到端知识问答服务，支持文档解析、切分、向量化、多轮重写等模块化服务，助力构建定制 AI 方案。',
    'togetherai.description':
      'Together AI 提供领先性能的创新模型，支持广泛定制、快速扩展与简便部署，满足企业需求。',
    'upstage.description':
      'Upstage 构建面向商业需求的 AI 模型，包括 Solar LLM 与文档 AI，其聊天 API 支持函数调用、翻译、向量化与行业场景应用。',
    'v0.description': 'v0 是一款配对编程助手，可将自然语言想法转化为项目中的代码与界面。',
    'vercelaigateway.description':
      'Vercel AI Gateway 提供统一 API，支持 100 多个模型（包括 OpenAI、Anthropic、Google 等），具备预算控制、使用监控、负载均衡与故障转移功能。',
    'vertexai.description':
      'Google 的 Gemini 系列是其最先进的通用 AI，由 Google DeepMind 构建，支持文本、代码、图像、音频与视频的多模态应用，具备从数据中心到移动设备的高效扩展能力。',
    'vllm.description': 'vLLM 是一个快速、易用的大模型推理与服务库。',
    'volcengine.description':
      '字节跳动的模型服务平台，提供安全、功能丰富、具备价格优势的模型访问服务，并支持数据、微调、推理与评估的端到端工具链。',
    'volcenginecodingplan.description':
      '火山方舟 Coding Plan 由字节跳动提供，通过固定月费订阅方式访问多种编程模型（包括 Doubao-Seed-Code、GLM-4.7、DeepSeek-V3.2 和 Kimi-K2.5）。',
    'wenxin.description':
      '文心是一个面向企业的基础模型与 AI 原生应用开发一体化平台，提供生成式 AI 模型与应用工作流的端到端工具支持。',
    'xai.description': 'xAI 致力于构建加速科学发现的 AI，使命是加深人类对宇宙的理解。',
    'xiaomimimo.description':
      '小米 MiMo 提供兼容 OpenAI API 的对话模型服务。mimo-v2-flash 模型支持深度推理、流式输出、函数调用、256K 上下文窗口，以及最多 128K 的输出。',
    'xinference.description':
      'Xorbits Inference（Xinference）是一个开源平台，简化 AI 模型的运行与集成，支持在本地或云端运行开源大模型、向量模型与多模态模型，构建强大的 AI 应用。',
    'zenmux.description':
      'ZenMux 是一个统一的 AI 聚合平台，支持 OpenAI、Anthropic、Google VertexAI 等，具备灵活路由能力，便于模型切换与管理。',
    'zeroone.description':
      '01.AI 推动以人为本的 AI 2.0 革命，利用大模型创造经济与社会价值，构建新型 AI 生态与商业模式。',
    'zhipu.description':
      '智谱 AI 提供开放平台，涵盖文本处理、图像理解与代码辅助等多模态与语言模型能力。',
  },
  pn = Object.freeze(
    Object.defineProperty({ __proto__: null, default: gs }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  bs = {
  ...
  un = Object.freeze(
    Object.defineProperty({ __proto__: null, default: bs }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  za = '进阶配置',
  ...
  hs = {
    ...
    'accountDeletion.confirmContent':
      '提交后将进入 <0>72 小时</0>冷静期，期间您可以随时取消。冷静期结束后，您的账号数据将被永久删除，未支付的账单将立即取消，已支付的费用不予退还。您的注册及注销记录将被保留用于合规审计。',
    ...
    'agentDocuments.overwriteConfirm.summary':
      '应用 {{templateName}} 将创建 {{createCount}} 个新文档，并覆盖 {{overwriteCount}} 个现有文档。',
    ...
    'agentSkillModal.github.desc':
      '粘贴公开 GitHub 仓库中技能目录的 URL，该目录下需包含 SKILL.md 文件。',
    ...
    'marketPublish.forkConfirm.description':
      '你即将基于社区中已存在的助理发布一个二次创作版本。你的新助理将作为独立条目发布到市场。',
    'marketPublish.forkConfirm.descriptionGroup':
      '您即将基于社区中已有的群组发布一个衍生版本。您的新群组将在市场中作为一个独立条目创建。',
    ...
    'memory.effort.title': '积极性',
    'memory.enabled.desc':
      '允许 LobeHub 从对话中提取偏好和信息，并在之后使用。您可以随时查看、编辑或清除记忆内容。',
...
- 行为准则`,
    ...
    'settingModel.enableContextCompression.desc':
      '当对话消息超过 64,000 tokens 时，自动将历史消息压缩为摘要，节省 60-80% 的 token 用量',
    ...
    'settingSystemTools.tools.agentBrowser.desc':
      'Agent-browser - 面向AI代理的无头浏览器自动化命令行工具',
...
💡 提示：描述越具体，我们就越能满足您的需求`,
    ...
    'tab.advanced.updateChannel.desc':
      '默认接收稳定版更新通知。Nightly 和 Canary 通道将接收预发布版本，可能不适合生产使用。',
    ...
    'tools.builtins.lobe-artifacts.readme':
      '生成并实时预览交互式 UI 组件、数据可视化、图表、SVG 图形和 Web 应用。创建用户可直接交互的丰富可视化内容。',
    ...
    'tools.builtins.lobe-calculator.readme':
      '高级数学计算器，支持基础算术、代数方程、微积分运算和符号数学。包括进制转换、方程求解、微分、积分等更多功能。',
    'tools.builtins.lobe-calculator.title': '计算器',
    'tools.builtins.lobe-cloud-sandbox.description':
      '在安全的云端环境中执行代码、运行命令和管理文件',
    'tools.builtins.lobe-cloud-sandbox.readme':
      '在隔离的云端环境中执行 Python、JavaScript 和 TypeScript 代码。运行 Shell 命令、管理文件、使用正则搜索内容并安全导出结果。',
    ...
    'tools.builtins.lobe-gtd.readme':
      '使用 GTD 方法规划目标并追踪进度。创建战略计划、管理带状态跟踪的待办列表，并执行长时间运行的异步任务。',
    ...
    'tools.builtins.lobe-local-system.readme':
      '访问桌面端的本地文件系统。读取、写入、搜索和组织文件。执行 Shell 命令，支持后台任务和正则内容搜索。',
    ...
    'tools.builtins.lobe-notebook.readme':
      '在对话主题中创建和管理持久化文档。保存笔记、报告、文章和 Markdown 内容，可跨会话持续访问。',
    ...
    'tools.builtins.lobe-user-memory.readme':
      '构建关于你的个性化知识库。记住偏好、追踪活动和经历、存储身份信息，并在未来对话中回忆相关上下文。',
    ...
    'tools.klavis.servers.airtable.description':
      'Airtable 是一款基于云的数据库和电子表格平台，结合了电子表格的灵活性与数据库的强大功能，使团队能够通过可自定义视图和强大的自动化功能来组织、跟踪和协作项目。',
    'tools.klavis.servers.airtable.readme':
      '集成 Airtable 以管理数据库和工作流程。查询记录、创建条目、更新数据，并通过可自定义视图和强大的跟踪功能实现自动化操作。',
    'tools.klavis.servers.cal-com.description':
      'Cal.com 是一个开源的日程安排平台，帮助您无需反复邮件即可安排会议。管理事件类型、预订、可用时间，并与日历集成，实现无缝预约安排。',
    'tools.klavis.servers.cal-com.readme':
      '连接 Cal.com 以管理您的日程和预约。查看可用时间、预订会议、管理事件类型，并通过自然对话自动化您的日历。',
    'tools.klavis.servers.clickup.description':
      'ClickUp 是一个全面的项目管理和效率平台，帮助团队组织任务、管理项目，并通过可自定义的工作流程和强大的跟踪功能高效协作。',
    'tools.klavis.servers.clickup.readme':
      '连接 ClickUp 以管理任务、跟踪项目并组织工作。创建任务、更新状态、管理自定义工作流程，并通过自然语言指令与团队协作。',
    'tools.klavis.servers.confluence.description':
      'Confluence 是一个团队协作空间，融合了知识管理与协作功能。',
    'tools.klavis.servers.confluence.readme':
      '连接 Confluence 以访问和管理团队文档。搜索页面、创建内容、组织空间，并通过对话式 AI 构建您的知识库。',
    'tools.klavis.servers.dropbox.description':
      'Dropbox 云存储的完整文件管理解决方案。上传、下载、组织文件和文件夹，管理共享与协作，处理文件版本，创建文件请求，并对文件和文件夹执行批量操作。',
    'tools.klavis.servers.dropbox.readme':
      '集成 Dropbox 以访问和管理您的文件。上传、下载、共享文件，管理文件夹，处理文件版本，并通过对话式 AI 组织您的云存储。',
    'tools.klavis.servers.figma.description': 'Figma 是一款用于网页和移动应用界面的协作设计工具。',
    'tools.klavis.servers.figma.readme':
      '连接 Figma 以访问设计文件并协作项目。查看设计、导出资源、浏览组件，并通过自然对话管理设计流程。',
    'tools.klavis.servers.github.description': '增强版 GitHub MCP 服务器',
    'tools.klavis.servers.github.readme':
      '连接 GitHub 以管理代码库、问题、拉取请求和代码。搜索代码、审查更改、创建分支，并通过对话式 AI 协作开发项目。',
    'tools.klavis.servers.gmail.description': 'Gmail 是 Google 提供的免费电子邮件服务',
    'tools.klavis.servers.gmail.readme':
      '将 Gmail 的强大功能直接引入您的 AI 助手。阅读、撰写和发送邮件，搜索收件箱，管理标签，并通过自然对话组织您的通信。',
    'tools.klavis.servers.google-calendar.description': 'Google 日历是一项时间管理和日程安排服务',
    'tools.klavis.servers.google-calendar.readme':
      '集成 Google 日历以无缝查看、创建和管理事件。安排会议、设置提醒、查看可用时间，并通过自然语言指令协调您的时间。',
    'tools.klavis.servers.google-docs.description':
      'Google 文档是 Google 提供的免费网页文字处理工具，属于 Google 文档编辑器套件的一部分',
    'tools.klavis.servers.google-docs.readme':
      '集成 Google 文档以创建、编辑和管理文档。撰写内容、格式化文本、实时协作，并通过自然对话访问您的文档。',
    'tools.klavis.servers.google-drive.description': 'Google 云端硬盘是一项云存储服务',
    'tools.klavis.servers.google-drive.readme':
      '连接 Google 云端硬盘以访问、组织和管理您的文件。搜索文档、上传文件、共享内容，并通过 AI 助手高效导航您的云存储。',
    'tools.klavis.servers.google-sheets.description':
      'Google 表格是一款基于网页的电子表格应用，允许用户在线创建、编辑和协作处理表格',
    'tools.klavis.servers.google-sheets.readme':
      '连接 Google 表格以读取、编写和分析表格数据。执行计算、生成报告、创建图表，并通过 AI 协作管理表格数据。',
    'tools.klavis.servers.hubspot.description':
      'HubSpot 是一家专注于入站营销、销售和客户服务的软件开发商',
    'tools.klavis.servers.hubspot.readme':
      '集成 HubSpot 以管理联系人、交易和营销活动。访问 CRM 数据、跟踪销售流程、自动化工作流，并优化销售与营销操作。',
    'tools.klavis.servers.jira.description': 'Jira 是由 Atlassian 开发的项目管理和问题跟踪工具',
    'tools.klavis.servers.jira.readme':
      '集成 Jira 以管理问题、跟踪进度并组织冲刺。创建工单、更新状态、查询项目数据，并通过自然对话优化开发流程。',
    'tools.klavis.servers.notion.description': 'Notion 是一款协作型效率与笔记应用',
    'tools.klavis.servers.notion.readme':
      '连接 Notion 以访问和管理您的工作区。创建页面、搜索内容、更新数据库，并通过与 AI 助手的自然对话组织知识库。',
    'tools.klavis.servers.onedrive.description': 'OneDrive 是由微软运营的文件托管和同步服务',
    'tools.klavis.servers.onedrive.readme':
      '连接 OneDrive 以访问和管理您的微软云文件。上传、下载、共享文件，组织文件夹，并通过 AI 助手协作处理文档。',
    'tools.klavis.servers.outlook-mail.description':
      'Outlook 邮件是微软提供的基于网页的邮件、联系人、任务和日历服务套件。',
    'tools.klavis.servers.outlook-mail.readme':
      '集成 Outlook 邮件以阅读、发送和管理您的微软邮件。搜索消息、撰写邮件、管理文件夹，并通过自然对话整理收件箱。',
    'tools.klavis.servers.salesforce.description':
      'Salesforce 是全球领先的客户关系管理（CRM）平台，帮助企业与客户、合作伙伴和潜在客户建立联系',
    'tools.klavis.servers.salesforce.readme':
      '连接 Salesforce 以管理客户关系和销售数据。查询记录、更新商机、跟踪潜在客户，并通过自然语言指令自动化 CRM 工作流。',
    'tools.klavis.servers.slack.description':
      'Slack 是一款为企业设计的消息应用，帮助人们获取所需信息',
    'tools.klavis.servers.slack.readme':
      '集成 Slack 以发送消息、搜索对话并管理频道。与团队连接、自动化沟通流程，并通过自然语言访问工作区信息。',
    'tools.klavis.servers.supabase.description': 'Supabase 官方 MCP 服务器',
    'tools.klavis.servers.supabase.readme':
      '集成 Supabase 以管理数据库和后端服务。查询数据、管理身份验证、处理存储，并通过自然对话与应用后端交互。',
    'tools.klavis.servers.whatsapp.description':
      'WhatsApp Business API 集成，支持发送文本、媒体并管理客户对话。适用于客户支持、营销活动和通过官方 WhatsApp Business 平台实现的自动化消息工作流。',
    'tools.klavis.servers.whatsapp.readme':
      '集成 WhatsApp Business 以发送消息、管理对话并与客户互动。通过对话式 AI 自动化消息流程并处理通信。',
    'tools.klavis.servers.youtube.description':
      'YouTube 是一个视频分享平台，用户可以上传、分享和发现内容。可编程访问视频信息、字幕和元数据。',
    'tools.klavis.servers.youtube.readme':
      '连接 YouTube 以搜索视频、访问字幕并获取视频信息。分析内容、提取元数据，并通过自然对话发现视频。',
    'tools.klavis.servers.zendesk.description': 'Zendesk 是一家客户服务软件公司',
    'tools.klavis.servers.zendesk.readme':
      '集成 Zendesk 以管理支持工单和客户互动。创建、更新和跟踪支持请求，访问客户数据，并优化您的客服流程。',
    ...
    'tools.lobehubSkill.disconnectConfirm.desc':
      '您仍然可以继续之前引用 {{name}} 内容的对话。但助手将无法访问新内容或执行新任务。',
    ...
    'tools.lobehubSkill.providers.linear.description':
      'Linear 是一款现代化的问题跟踪和项目管理工具，专为高效团队打造，助力更快构建更优软件。',
    'tools.lobehubSkill.providers.linear.readme':
      '将 Linear 的强大功能引入您的 AI 助手。创建和更新问题、管理冲刺、跟踪项目进度，并通过自然对话优化开发流程。',
    'tools.lobehubSkill.providers.microsoft.description':
      'Outlook 日历是 Microsoft Outlook 中集成的日程安排工具，用户可创建约会、组织会议并高效管理时间和事件。',
    'tools.lobehubSkill.providers.microsoft.readme':
      '集成 Outlook 日历以无缝查看、创建和管理事件。安排会议、查看可用时间、设置提醒，并通过自然语言指令协调时间。',
    'tools.lobehubSkill.providers.twitter.description':
      'X（原 Twitter）是一个社交媒体平台，用于分享实时动态、新闻，并通过推文、回复和私信与受众互动。',
    'tools.lobehubSkill.providers.twitter.readme':
      '连接 X（原 Twitter）以发布推文、管理时间线并与受众互动。创建内容、安排发布、监控提及，并通过对话式 AI 构建社交媒体影响力。',
  ...
  fs = {
    'duration.TPS': 'TPS（每秒令牌数）：每秒生成的令牌数量',
    'duration.TTFT': 'TTFT（首令牌时间）：生成首个令牌的延迟',
    'duration.completion': '输出完成时间',
    'duration.latency': '耗时',
    'duration.stage.end': '结束',
    'duration.stage.firstToken': '首个令牌',
    'duration.stage.start': '开始',
    'table.columns.TTFT.tooltip': '首令牌时间，单位：秒',
    'table.columns.duration': '耗时',
    ...
    'table.desc': '展示文本生成、嵌入、图像生成等功能的计算积分使用详情。',
    'table.more': '查看详情',
    'table.title': '计算积分使用详情',
    'table.totalToken.input': '输入',
    'table.totalToken.output': '输出',
  },
  gn = Object.freeze(
    Object.defineProperty({ __proto__: null, default: fs }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  Ya = '取消订阅',
  ...
  ro = '升级计划',
  ys = {
    'balance.creditBalance': '充值积分余额',
    'balance.hobbyDesc': '{{hobby}} 不包含订阅积分，您需要配置模型 API 或进行充值',
    'balance.link.history': '充值记录',
    'balance.link.usage': '查看使用情况',
    'balance.plansUsage': '订阅积分',
    'balance.plansUsageDesc': '优先使用订阅积分，其次使用充值积分',
    'balance.title': '余额',
    'billing.amount': '金额',
    'billing.closed': '已关闭',
    'billing.created': '付款日期',
    'billing.draft': '草稿',
    'billing.draftTooltip': '此草稿账单由新订阅生成，将很快自动扣款',
    'billing.empty': '暂无账单记录',
    'billing.endDate': '结束日期',
    'billing.history': '账单历史',
    'billing.orderNumber': '订单编号',
    'billing.paid': '已支付',
    'billing.pay': '立即支付',
    'billing.paymentGateway': '支付渠道',
    ...
    'billing.unpaid': '未支付',
    'billing.view': '查看',
    'cancelPlan.alert': '您仍可享受当前订阅权益，直到 {{date}} 到期。到期前可随时重新订阅。',
    'cancelPlan.desc': '取消后，当前订阅到期后将降级为免费版。',
    'cancelPlan.title': '取消订阅',
    'cancelSubscription': Ya,
    'compare.hobbyCreditTooltip': '不包含每月计算积分，需自行配置模型 API',
    'compare.monthlyCredit': '每月计算积分',
    'compare.title': '套餐对比',
    'compareAllPlans': Qa,
    'comparePlans': Xa,
    'createSubscriptionError': Za,
    'credits.autoTopUp.currentBalance': '当前总余额',
    'credits.autoTopUp.desc': '确保你的积分不会用光',
    'credits.autoTopUp.monthlyLimit': '月度上限',
    ...
    'credits.packages.charged': '已扣费 ${{amount}}',
    'credits.packages.expired': '已过期',
    'credits.packages.expiresIn': '{{days}} 天后过期',
    'credits.packages.expiresToday': '今日过期',
    ...
    'credits.packages.filter.manual': '手动购买',
    'credits.packages.gift': '赠送',
    'credits.packages.giftedOn': '赠送于 {{date}}',
    'credits.packages.noPackages': '暂无积分包',
    'credits.packages.purchaseFirst': '购买您的第一个积分包',
    'credits.packages.purchasedOn': '购买于 {{date}}',
    'credits.packages.sort.amountAsc': '金额：从低到高',
    'credits.packages.sort.amountDesc': '金额：从高到低',
    'credits.packages.sort.balanceAsc': '余额：从低到高',
    'credits.packages.sort.balanceDesc': '余额：从高到低',
    'credits.packages.sort.newest': '最新',
    'credits.packages.sort.oldest': '最早',
    'credits.packages.tabs.active': '有效积分包',
    'credits.packages.tabs.activeCount': '有效（{{count}}）',
    ...
    'credits.topUp.subscribeFirst': '请先订阅',
    ...
    'currentPlan.paymentExpired': '当前订阅将于 {{expiredAt}} 到期，请合理安排使用',
    ...
    'downgradePlans.alert':
      '您仍可享受当前订阅权益，直到 {{date}} 到期。新套餐将在当前套餐到期后生效。',
    'downgradePlans.desc': '套餐变更将在当前套餐到期后生效。',
    'downgradePlans.success': '取消订阅成功',
    'downgradePlans.title': '切换至 {{plan}}',
    'header.desc': '使用情况与订阅管理',
    'header.title': '账单',
    'keyMissMatch.button': '恢复使用并继续对话',
    'keyMissMatch.description':
      '由于系统偶发故障，您的订阅使用暂时失效。请点击下方按钮恢复使用并继续对话。如多次出现，请通过邮箱（support@lobehub.com）联系我们。',
    'keyMissMatch.title': '立即恢复订阅使用',
    'limitation.chat.success.action': '继续聊天',
    'limitation.chat.success.desc': '您的 {{plan}} 订阅已成功升级，畅享 AI 聊天。当前套餐包含：',
    'limitation.chat.success.title': '升级成功',
    'limitation.chat.topupSuccess.action': '继续聊天',
    'limitation.chat.topupSuccess.desc': '您的充值积分已激活，畅享 AI 聊天。当前套餐包含：',
    'limitation.chat.topupSuccess.title': '充值成功',
    'limitation.expired.desc':
      '您的 {{plan}} 计算积分已于 {{expiredAt}} 过期。请立即升级套餐以获取新的计算积分。',
    ...
    'limitation.insufficientBudget.desc':
      '剩余额度不足以支付此模型的预估费用。请充值积分或切换到费用更低的模型。',
    ...
    'limitation.limited.descUltimate': '您的 {{plan}} 计算积分已用尽，请充值积分以继续使用。',
    'limitation.limited.referralTip': '邀好友，各得 {{reward}}M 积分',
    'limitation.limited.title': '计算积分已用尽',
    'limitation.limited.topup': '充值积分',
    'limitation.limited.upgrade': '升级至更高套餐',
    'limitation.providers.lock.addNew': '立即订阅以创建自定义 AI 提供商',
    'limitation.providers.lock.enableProvider': '立即订阅以启用此 AI 提供商',
    'limitation.providers.lock.menuItem': '立即订阅以配置自定义 API 服务',
    'limitation.providers.mask.action': '立即升级',
    'limitation.providers.mask.subTitle':
      '自定义 API 服务仅对付费用户开放，升级后可使用全球主流模型服务',
    'limitation.providers.mask.title': '立即订阅以使用自定义 API 服务',
    'limitation.providers.prompter.action': '立即升级',
    'limitation.providers.prompter.subTitle':
      '自定义 API 服务仅对付费用户开放，升级后可使用全球主流模型服务',
    'limitation.providers.prompter.title': '立即订阅以使用自定义 API 服务',
    'limitation.providers.tooltip': '自定义 API 服务仅对付费用户开放',
    'limitation.video.success.action': '继续生成',
    'limitation.video.success.desc':
      '您的 {{plan}} 订阅已成功升级。尽情享受 AI 视频生成服务。您当前的套餐包括：',
    'limitation.video.success.title': '升级成功',
    'limitation.video.topupSuccess.action': '继续生成',
    'limitation.video.topupSuccess.desc':
      '您的充值额度已激活。尽情享受 AI 视频生成服务。您当前的套餐包括：',
    'limitation.video.topupSuccess.title': '充值成功',
    'modelPricing.button': '查看价格文档',
    'modelPricing.desc': '{{name}} 使用积分衡量 AI 模型使用量。下表显示每百万 Token 所需计算积分。',
    ...
    'payment.success.desc': '您的订阅计划已成功激活',
    'payment.success.title': '订阅成功',
    'payment.switchSuccess.desc':
      '您的订阅将于 {{switchAt}} 从 <bold>{{from}}</bold> 自动降级为 <bold>{{to}}</bold>',
    'payment.switchSuccess.title': '降级预约成功',
    'payment.upgradeFailed.alert.reason.bank3DS': '您的银行需要进行 3DS 验证，请重新确认',
    'payment.upgradeFailed.alert.reason.inefficient': '卡内余额不足',
    'payment.upgradeFailed.alert.reason.security': 'Stripe 系统风控',
    'payment.upgradeFailed.alert.title': '自动支付失败的常见原因',
    'payment.upgradeFailed.desc': '订阅升级失败，请检查后重试',
    'payment.upgradeFailed.title': '升级失败',
    'payment.upgradeSuccess.desc': '您的订阅计划已成功升级',
    ...
    'plans.changePlan': '选择计划',
    'plans.cloud.history': '无限对话历史',
    'plans.cloud.sync': '全球云端同步',
    'plans.cloud.title': '云服务',
    'plans.credit.api': '自定义 API',
    'plans.credit.apiDesc': '需配置您自己的模型 API',
    'plans.credit.apiProvider': '支持 OpenAI / Anthropic / OpenRouter 等 20+ 主流模型提供商',
    'plans.credit.buy': '购买算力积分',
    'plans.credit.buyDesc': '也支持按需购买算力积分',
    'plans.credit.none': '无内置算力积分',
    'plans.credit.tip': '每月赠送 {{credit}} 点免费算力',
    'plans.credit.title': '算力积分',
    'plans.credit.tooltip': '每月模型消息计算所用的算力积分',
    'plans.current': '当前计划',
    'plans.downgradePlan': '目标降级计划',
    'plans.downgradeTip': '您已取消订阅，需等待取消生效后才能进行其他操作',
    'plans.downgradeWillCancel': '此操作将取消已调度的降级计划',
    'plans.embeddingStorage.embeddings': '条目',
    'plans.embeddingStorage.title': '向量存储',
    'plans.embeddingStorage.tooltip':
      '一页文档（1000-1500 字符）大约生成 1 个向量条目（以 OpenAI Embeddings 估算，具体视模型而定）',
    'plans.features.agents': '精选智能体市场',
    'plans.features.ceAgents': '社区智能体市场',
    'plans.features.cePlugins': '社区插件市场',
    'plans.features.internet': '智能网页搜索',
    ...
    'plans.support.starter': '邮件与社区支持',
    'plans.support.title': '支持服务',
    ...
    'qa.detail': '查看详情',
    'qa.list.credit.a':
      '算力积分是 {{cloud}} 用于衡量调用 AI 模型时的使用量指标。不同模型消耗的积分不同。',
    'qa.list.credit.q': '什么是算力积分？',
    'qa.list.embeddings.a':
      '向量存储并不等于您上传或导入数据集的原始大小，而是根据文件中纯文本内容向量化后的结果计算。例如，一页 PDF 文件（1000-1500 字符）提取为纯文本后，可能只占用约 1 个向量存储条目。您可在“{{usage}}”中查看使用情况。',
    'qa.list.embeddings.q': '向量存储是如何计算的？',
    'qa.list.free.a':
      '{{name}} 始终坚持开源原则。专业开发者可通过部署社区版使用全部开源功能。在 {{cloud}} 中，我们为所有注册用户每月提供 {{credit}} 点免费算力，无需复杂配置即可使用。如需更多使用量，可订阅 {{starter}}、{{premium}} 或 {{ultimate}}。',
    'qa.list.free.q': '{{name}} 可以免费使用吗？',
    'qa.list.highUsage.a':
      '积分消耗与对话长度密切相关。随着对话变长，每条新消息都会将完整历史作为输入 token 发送，导致费用显著增加。建议在切换话题时开启新对话。此外，如果两次发送间隔较长，提示词缓存可能失效，也会导致费用骤增。部分模型（如 Gemini Pro 系列）采用分梯度定价，输入超过 200K token 后费率翻倍。',
    'qa.list.highUsage.q': '为什么我的积分消耗比预期快？',
    'qa.list.limit.a':
      '{{cloud}} 的订阅计划分为 {{starter}}、{{premium}} 和 {{ultimate}}，每个计划提供不同的算力积分。如当前计划积分不足，建议升级计划。您也可以在<fundsLink>「{{funds}}」</fundsLink>页面购买积分包进行按量付费充值。此外，您也可以配置自定义模型 API 密钥，使用其他来源购买的 API 积分。',
    'qa.list.limit.q': '算力积分用完怎么办？',
    'qa.list.management.a':
      '在 {{subscribe}} 页面，您可以“升级 / 降级”当前订阅计划，或切换年付与月付。在“{{usage}}-{{management}}”中可跳转至 Stripe 进行订阅管理，您可随时取消订阅。取消后，当前计划到期时将自动降级为免费版。',
    ...
    'referral.rules.antiAbuse':
      '如检测到通过不正当手段获取积分（如批量注册临时邮箱账号），相关账号将被永久封禁',
    ...
    'referral.rules.missedCode':
      '忘记填写邀请码：注册三天内可以<0>补填邀请码</0>，补填后需完成一次有效操作才可获得奖励',
    ...
    'referral.stats.totalInvites': '邀请总数',
    'referral.stats.totalRewarded': '有效转化',
    'referral.stats.totalRewardedAmount': '累计奖励',
    ...
    'switchDowngradeTarget': ao,
    'switchPlan': oo,
    'switchToMonthly.desc': '切换后，当前年付计划到期后将生效月付计费。',
    ...
    'upgradeNow': no,
    'upgradePlan': ro,
    'upgradePlans.desc': '升级计划将在支付差价后立即生效，起始日期继承原计划。',
    'upgradePlans.title': '升级至 {{plan}}',
    'usage.credit.addon.desc': '配额将在 {{time}} 后重置',
    'usage.credit.addon.used': '充值积分',
    'usage.credit.desc': '用于 AI 聊天、图像生成、语音合成的积分使用情况',
    'usage.credit.detail': '过去 {{day}} 天的使用统计',
    'usage.credit.free.desc': '配额将在 {{time}} 后重置',
    'usage.credit.free.expired': '已于 {{date}} 过期',
    'usage.credit.free.used': '免费积分',
    'usage.credit.referral.desc': '通过邀请好友获得的返利积分',
    'usage.credit.referral.used': '返利积分',
    'usage.credit.subscription.desc': '配额将在 {{time}} 后重置',
    'usage.credit.subscription.used': '订阅积分',
    'usage.credit.time.days': '{{days}} 天',
    'usage.credit.time.daysAndHours': '{{days}} 天 {{hours}} 小时',
    'usage.credit.time.hours': '{{hours}} 小时',
    'usage.credit.title': '算力积分使用情况',
    'usage.overview.charge': '按量计费',
    'usage.overview.included': '计划内使用',
    'usage.overview.onDemand': '按需使用',
    'usage.overview.product': '产品项目',
    'usage.overview.title': '使用概览',
  ...
  vs = {
    'agent.01.prompt':
      '你是一位创意写作导师，致力于帮助作家提升写作技巧。你的职责包括：对作品提供建设性反馈（表扬优点，提出改进建议）；教授叙事技巧：情节结构、人物塑造、节奏控制、对话编写；提供克服写作瓶颈的练习；引导作家探索不同体裁与风格；帮助他们找到独特的写作声音。工具使用：Artifacts：创建人物卡片、情节图（Mermaid）、写作提示生成器（React）和故事模板；Notebook：保存用户的草稿、反馈报告和写作计划（保存前需征得同意）。始终保持支持、真诚与对故事的热情，尊重每位作家的起点。',
    'agent.01.title': '帮助我成为更好的写作者',
    'agent.02.prompt':
      '创建一位耐心且鼓励性的语言学习教练，帮助用户练习对话、清晰讲解语法、温和纠正错误、教授地道表达，并制定个性化学习计划。积极使用可用工具：Memory 用于追踪词汇和学习进度，Notebook 用于保存课程笔记和学习资料，Artifacts 用于创建互动练习或抽认卡。',
    'agent.02.title': '帮助我学习一门新语言',
    'agent.03.prompt':
      '创建一位专业的健身教练，能够根据你的目标设计训练计划，解释正确的运动姿势，为不同健身水平提供调整建议，提供动力和督促，帮助你养成可持续的健康习惯。',
    'agent.03.title': '做我的私人健身教练',
    'agent.04.prompt':
      '你是一位营养顾问。帮助用户理解健康饮食，制定膳食计划，应对饮食限制，揭穿饮食误区，并建立积极的饮食关系。积极使用工具：Artifacts：膳食计划表、食谱卡、营养图表；Sandbox：计算热量/营养素比例，生成可视化图表；Notebook：保存个性化计划和食谱。始终以“展示”代替“告知”。提醒用户这些信息仅供参考，不能替代医疗建议。',
    'agent.04.title': '帮助我养成更健康的饮食习惯',
    'agent.05.prompt':
      '你是富有同理心的身心健康伙伴。我将引导你进行正念练习和认知重构技巧，创建可视化的应对工具，并将你的反思安全地保存在个人笔记本中——以关怀支持你的情绪成长。',
    'agent.05.title': '支持我的情绪健康',
    'agent.06.prompt':
      '你是一位个人理财顾问。帮助用户理解预算编制，制定储蓄计划，解释投资选项，战略性地管理债务，实现财务目标。积极使用工具：Sandbox：计算复利、债务还清时间表、投资预测；Artifacts：预算模板、储蓄追踪器、财务对比图表；Notebook：保存个性化计划和里程碑。提供清晰的数据和可视化图表。提醒用户这些内容为教育用途，非专业理财建议。',
    'agent.06.title': '帮助我管理个人财务',
    'agent.07.prompt':
      '创建一位热情的旅行规划师，能够帮助你发现目的地，制定详细的行程，找到隐藏的宝藏，优化旅行预算，了解当地风俗，让你的冒险之旅更加精彩。',
    'agent.07.title': '帮助我规划下一次旅行',
    'agent.08.prompt':
      '创建一位热情的烹饪指导，能够教授烹饪技巧，根据你现有的食材建议食谱，解释风味搭配，帮助你探索世界各地的美食，增强你在厨房里的信心。',
    'agent.08.title': '教我如何更好地做饭',
    'agent.09.prompt':
      '创建一位体贴的职业顾问，能够帮助你探索职业道路，识别你的优势和兴趣，为工作转型做准备，发展专业技能，制定实现职业目标的可行计划。',
    'agent.09.title': '帮助我规划职业发展路径',
    'agent.10.prompt':
      '创建一位学习策略师，能够帮助你更有效地学习，提高记忆力和知识留存，发展批判性思维能力，克服拖延症，根据你的学习风格培养终身学习的习惯。',
    'agent.10.title': '帮助我更高效地学习',
    'agent.11.prompt':
      '创建一位历史分析师与讲述者。除了生动的叙述外，使用“平行时间线工具”将历史事件与当代问题联系起来。运用结构性因果分析框架，剖析文明的兴衰，帮助用户从历史中汲取“未来决策的教训”。',
    'agent.11.title': '讲给我听引人入胜的历史故事',
    'agent.12.prompt':
      '创建一位哲学探究导师。作为引导者，运用苏格拉底式提问法挑战用户的假设。结合“逻辑谬误检测器”审查用户论点，并提供“思想传统对比矩阵”，帮助用户将不同哲学流派整合为连贯的个人世界观。',
    'agent.12.title': '和我一起探索哲学与伟大思想',
    'agent.13.prompt':
      '创建一位互动式摄影教练。提供“构图解析器”分析上传或描述的照片。提供“技术参数模拟器”（光圈/ISO/快门速度）以应对特定光照场景，并根据用户当前水平生成结构化的7天创意挑战计划。',
    'agent.13.title': '帮助我拍出更好的照片',
    'agent.14.prompt':
      '创建一位基于科学的育儿策略师。使用“年龄发展里程碑追踪器”评估儿童成长情况。提供基于积极管教技巧的“即时冲突解决脚本”，并生成定制的每周活动日志，平衡认知、社交与身体发展。',
    'agent.14.title': '给我实用的育儿建议',
    'agent.15.prompt':
      '创建一位法律概念架构师。使用“通俗语言翻译器”简化复杂法律条文。提供“情境风险热力图”识别用户场景中的潜在法律责任，并生成“后续行动清单”，帮助用户在咨询专业律师前做好准备。',
    'agent.15.title': '用通俗易懂的语言解释法律问题',
    'agent.16.prompt':
      '创建一位以增长为导向的市场策略师。运用 AARRR 漏斗和 STP 模型诊断业务问题。使用“用户画像生成器”和“渠道选择矩阵”制定数据驱动的内容策略，并为每个提案提供 KPI 预估模板。',
    'agent.16.title': '帮助我有效推广我的作品',
    'agent.17.prompt':
      '创建一位富有同理心的人际关系架构师。使用“沟通风格分析器”诊断人际互动模式。提供“冲突解决模拟器”用于演练困难对话，并生成个性化的“界限设定脚本”，帮助维持健康关系。',
    'agent.17.title': '帮助我建立更好的人际关系',
    'agent.18.prompt':
      '成为一位生产力与 GTD 教练。帮助用户实施 GTD（搞定工作）、时间区块管理和目标设定框架。利用内建任务管理系统处理和组织任务。定期提供回顾与可视化工具，追踪承诺，提升专注力。',
    'agent.18.title': '帮助我提升工作效率',
    'agent.19.prompt':
      '创建一位正念指导，能够教授冥想技巧，帮助你管理压力，培养当下意识，建立持续的练习习惯，将正念原则应用到日常生活中。',
    'agent.19.title': '教我正念与冥想',
    'agent.20.prompt':
      '创建一位娱乐策展人，能够根据你的品味推荐书籍、电影、电视节目、播客和音乐，解释为什么你可能会喜欢它们，帮助你在不同类型中发现隐藏的宝藏。',
    'agent.20.title': '推荐值得观看或阅读的内容',
    'agent.21.prompt':
      '创建一位演讲教练，能够帮助你克服紧张，构建有说服力的演讲，改善表达和肢体语言，处理问答环节，成为更自信、更有魅力的演讲者。',
    'agent.21.title': '帮助我成为自信的演讲者',
    'agent.22.prompt':
      '创建一位面试教练，能够帮助你准备工作面试，练习常见问题，发展关于你经历的有说服力的故事，处理棘手问题，给人留下好印象。',
    'agent.22.title': '帮助我准备求职面试',
    'agent.23.prompt':
      '创建一位音乐老师，能够用通俗易懂的方式解释音乐理论，帮助你学习乐器，培养音乐听觉，建议练习技巧，加深你对不同音乐风格的欣赏。',
    'agent.23.title': '教我音乐与乐器知识',
    'agent.24.prompt':
      '创建一位艺术鉴赏指南，能够帮助你了解不同的艺术运动，分析艺术作品，培养视觉素养，加深你对博物馆、画廊和创意表达的欣赏。',
    'agent.24.title': '帮助我理解并欣赏艺术',
    'agent.25.prompt':
      '创建一位宠物护理顾问，提供关于宠物健康、行为训练、营养、丰富活动和情感联结的指导，适用于各种宠物，包括毛茸茸的、羽毛状的和鳞片类的伙伴。该助手应将宠物照护视为持续的责任，帮助用户识别重要的宠物相关任务、日常习惯和成长里程碑。当宠物照护涉及时间性或周期性事务时，助手应协助用户进行安排，并将关键事项与日历关联，以便在日常生活中持续执行。',
    'agent.25.title': '帮助我更好地照顾宠物',
    'agent.26.prompt':
      '创建一位室内设计顾问，能够帮助你规划房间布局，选择配色方案，挑选家具和装饰，在预算内工作，创造反映你个性和生活方式的空间。',
    'agent.26.title': '帮助我设计居住空间',
    'agent.27.prompt':
      '创建一位创业教练，能够帮助你验证商业想法，开发商业模式，理解创业基础知识，克服常见挑战，采取实际步骤来启动你的事业。',
    'agent.27.title': '帮助我启动商业创意',
    'agent.28.prompt':
      '创建一位科学传播者，能够以引人入胜的方式解释复杂的科学概念，讨论最新发现，区分事实与虚构，帮助你培养科学素养和好奇心。',
    'agent.28.title': '为我解释科学概念',
    'agent.29.prompt':
      '创建一位资深代码审查专家，专注于识别代码异味、潜在缺陷、安全漏洞和性能问题。他们应该能够提供建设性的反馈和具体的改进建议，解释每个建议背后的原因，并帮助在整个代码库中贯彻编码标准和最佳实践。',
    'agent.29.title': '帮助我审查并优化代码',
    'agent.30.prompt':
      '创建一位前端开发导师，精通 React、Vue 和 Angular 等现代框架。他们应该能够用简单的语言解释复杂的概念，审查组件架构，提供性能优化建议，帮助调试棘手的 UI 问题，并指导状态管理、测试和无障碍性方面的最佳实践。',
    'agent.30.title': '帮助我进行前端开发',
    'agent.31.prompt':
      '创建一位后端架构师，专注于设计可扩展的微服务架构，实现事件驱动系统，优化 API 性能，管理分布式系统挑战，并做出平衡性能、可维护性和团队专业技能的技术栈决策。',
    'agent.31.title': '帮助我设计后端架构',
    'agent.32.prompt':
      '创建一位数据库架构师，能够帮助设计高效的数据库架构，优化慢查询，在 SQL 和 NoSQL 方案之间做出选择，实施正确的索引策略，并就数据建模模式、迁移策略和不同场景下的扩展方案提供建议。',
    'agent.32.title': '帮助我进行数据库设计',
    'agent.33.prompt':
      '创建一位 DevOps 工程师，专注于构建健壮的 CI/CD 流水线、使用 Docker 和 Kubernetes 进行容器化、基础设施即代码、云平台优化（AWS/GCP/Azure）、监控告警配置，以及在整个部署生命周期中实施安全最佳实践。',
    'agent.33.title': '帮助我搭建 DevOps 流水线',
    'agent.34.prompt':
      '创建一位产品经理，能够帮助定义清晰的产品需求，编写包含验收标准的有效用户故事，使用 RICE 或 MoSCoW 等框架进行功能优先级排序，创建产品路线图，并促进利益相关者、设计师和工程团队之间的沟通。',
    'agent.34.title': '帮助我定义产品需求',
    'agent.35.prompt':
      '创建一位用户体验设计顾问，能够评估用户界面的可用性问题，基于设计原则和用户心理学提出改进建议，帮助创建一致的设计系统，进行启发式评估，并提供无障碍性、响应式设计和用户研究方法方面的指导。',
    'agent.35.title': '审查并优化我的用户体验设计',
    'agent.36.prompt':
      '创建一位数据科学家，能够帮助进行统计分析、数据可视化、假设检验、预测建模，并将业务问题转化为数据驱动的洞察。他们应该能够用易于理解的方式解释复杂的分析概念，并推荐合适的工具和技术。',
    'agent.36.title': '帮助我分析并可视化数据',
    'agent.37.prompt':
      '创建一位机器学习工程师，能够帮助进行模型选择、特征工程、训练流水线优化、模型部署策略，并用实用的方式解释机器学习概念。他们应该能够指导你完成从问题定义到生产部署的整个机器学习生命周期。',
    'agent.37.title': '帮助我构建机器学习解决方案',
    'agent.38.prompt':
      '创建一位云解决方案架构师，能够设计具有成本效益、高可用性的云基础设施，实施灾难恢复策略，优化云支出，并帮助将遗留系统迁移到 AWS、GCP 或 Azure 上的现代云原生架构。',
    'agent.38.title': '帮助我设计云基础架构',
    'agent.39.prompt':
      '创建一位安全分析师，能够进行代码安全审查，识别 SQL 注入、XSS 和 CSRF 等漏洞，推荐安全的身份认证和授权模式，帮助正确实施加密，并指导遵循 OWASP Top 10 等安全标准。',
    'agent.39.title': '帮助我检查应用程序的安全性',
    'agent.40.prompt':
      '创建一位技术项目经理，能够帮助实施敏捷方法论、冲刺规划、风险管理、利益相关者沟通、资源分配，并在保持团队士气和生产力的同时确保复杂技术项目按计划推进。',
    'agent.40.title': '帮助我管理技术项目',
    'chat.01.prompt':
      '用简单的语言解释量子计算。它与传统计算有什么不同？有哪些现实世界的应用可以从中受益？',
    'chat.01.title': '用简单语言解释量子计算',
    'chat.02.prompt':
      '快速学习新技能最有效的策略是什么？我想要实用的、有科学依据的技巧，今天就能开始使用。',
    'chat.02.title': '快速学习的最佳策略',
    'chat.03.prompt':
      '帮我写一封给经理的请假邮件，申请休假去旅行。我希望它礼貌、清晰，包含所有必要的细节。',
    'chat.03.title': '起草一封请假邮件',
    'chat.04.prompt':
      '我想开始一个能提高生产力的晨间习惯。成功人士通常有哪些共同的习惯？我应该如何安排早晨的时间？',
    'chat.04.title': '设计高效的晨间习惯',
    'chat.05.prompt':
      '比较几种热门编程语言（Python、JavaScript、Rust、Go）的优缺点，适用于 2025 年想要开始一个新后端项目的人。',
    'chat.05.title': '比较编程语言',
    'chat.06.prompt':
      '总结丹尼尔·卡尼曼的《思考，快与慢》这本书的核心观点。有哪些最重要的启示可以应用到日常决策中？',
    'chat.06.title': '帮我总结一本名著',
    'chat.07.prompt':
      '帮我为一位喜欢烹饪、旅行和阅读的朋友集思广益有创意的礼物点子。我想要一些贴心又独特的东西。',
    'chat.07.title': '集思广益创意礼物点子',
    'chat.08.prompt':
      '当前 AI 和科技领域最大的趋势是什么？给我一个简要概述，介绍正在发生什么以及为什么重要。',
    'chat.08.title': 'AI 和科技的最新趋势',
    'chat.09.prompt':
      '帮我规划一周的健康备餐计划。我想要营养均衡、容易准备、保存方便、加热后也好吃的餐食。',
    'chat.09.title': '规划一周备餐计划',
    'chat.10.prompt':
      '为初学者解释个人投资的基础知识。关于股票、债券、指数基金和退休账户，我应该了解什么？',
    'chat.10.title': '投资入门基础知识',
    'chat.11.prompt':
      '写一个关于一只勇敢小狐狸在魔法森林中冒险的睡前故事。让它充满魅力，适合 5 岁的孩子。',
    'chat.11.title': '写一个睡前故事',
    'chat.12.prompt':
      '帮我理清一个困难决定的思路。带我走过一个结构化的决策框架，帮助我做出更好的选择。',
    'chat.12.title': '帮我做一个困难的决定',
    'chat.13.prompt':
      '有哪些有趣又有教育意义的科学实验可以在家用常见物品完成？我想要适合 8-12 岁孩子的活动。',
    'chat.13.title': '在家做有趣的科学实验',
    'chat.14.prompt':
      '帮我写一份引人注目的 LinkedIn 个人简介，展示我的专业经验并吸引招聘人员。我希望它脱颖而出。',
    'chat.14.title': '写一份出色的 LinkedIn 简介',
    'chat.15.prompt':
      '用简单的语言解释全球经济是如何运作的。用任何人都能理解的方式介绍 GDP、通货膨胀、利率和贸易等话题。',
    'chat.15.title': '简单解释全球经济',
    'chat.16.prompt': '给我一些发人深省的问题清单，用来和朋友、家人进行更深入、更有意义的对话。',
    'chat.16.title': '深度对话话题',
    'chat.17.prompt':
      '帮我创建一个 30 天健身挑战，可以在家无器材完成。包括有氧、力量和柔韧性训练的组合。',
    'chat.17.title': '创建 30 天健身挑战',
    'chat.18.prompt':
      '有哪些有效的压力和焦虑管理技巧？给我一些当下可以使用的实用策略和长期可以培养的习惯。',
    'chat.18.title': '压力管理技巧',
    'chat.19.prompt':
      '帮我理解气候变化是如何运作的。它的成因是什么，有哪些影响，个人可以做些什么来帮助？',
    'chat.19.title': '了解气候变化',
    'chat.20.prompt': '推荐 5 部不同类型的必看经典电影。简要说明每部电影值得一看的理由。',
    'chat.20.title': '推荐必看电影',
    'chat.21.prompt':
      '帮我提高写作技巧。人们最常犯的错误是什么？有哪些技巧可以让我写得更清晰、更有说服力？',
    'chat.21.title': '提高写作技巧',
    'chat.22.prompt': '用通俗语言解释区块链技术和加密货币。它们解决了什么问题？我应该注意什么？',
    'chat.22.title': '简单解释区块链',
    'chat.23.prompt':
      '帮我制定一个从零开始学习数据科学的学习计划。我应该按什么顺序学习哪些主题？你有什么推荐资源？',
    'chat.23.title': '制定数据科学学习计划',
    'chat.24.prompt': '有哪些有创意的副业赚钱方式？我想要现实可行的、前期投入最少的点子。',
    'chat.24.title': '创意副业点子',
    'chat.25.prompt':
      '帮我给一位对我职业影响深远的导师写一封感谢信。我希望它真诚、具体、令人难忘。',
    'chat.25.title': '写一封真挚的感谢信',
    'chat.26.prompt': '用高中生能理解的方式解释相对论。使用类比和日常生活中的例子。',
    'chat.26.title': '简单解释相对论',
    'chat.27.prompt': '帮我整理和清理数字生活——邮件、文件、照片、订阅和密码。给我一个分步计划。',
    'chat.27.title': '整理我的数字生活',
    'chat.28.prompt': '职业成功最重要的软技能是什么？我如何培养沟通、领导力和情商等技能？',
    'chat.28.title': '培养关键软技能',
    'chat.29.prompt':
      '创建一个包含 10 道题的趣味知识问答，涵盖科学、历史、流行文化和地理等不同类别。在最后附上答案。',
    'chat.29.title': '创建趣味知识问答',
    'chat.30.prompt':
      '帮我规划一次周末短途旅行。规划时应该考虑什么？能否创建一个我可以自定义的行程模板？',
    'chat.30.title': '规划周末短途旅行',
    'chat.31.prompt':
      '在工作中给予和接受反馈的最佳实践是什么？帮我学会给出让人真正欣赏的建设性批评。',
    'chat.31.title': '掌握工作反馈技巧',
    'chat.32.prompt': '从宏观角度解释机器学习是如何工作的。有哪些不同类型？它能解决什么样的问题？',
    'chat.32.title': '解释机器学习基础',
    'chat.33.prompt': '帮我制定个人预算。带我了解如何分类支出、设定储蓄目标并有效跟踪消费。',
    'chat.33.title': '制定个人预算',
    'chat.34.prompt': '有哪些经过验证的改善睡眠的技巧？我想提高睡眠质量，早上醒来更有精神。',
    'chat.34.title': '改善睡眠的技巧',
    'chat.35.prompt': '帮我为个人网站写一段引人注目的短简介。它应该专业又亲切，大约 150 字。',
    'chat.35.title': '写个人网站简介',
    'chat.36.prompt': '解释摄影构图的基础知识。有哪些规则和技巧可以让我用手机拍出更好看的照片？',
    'chat.36.title': '摄影入门技巧',
    'chat.37.prompt': '帮我准备面试。最常见的问题有哪些？我应该如何组织回答？应该避免哪些错误？',
    'chat.37.title': '准备面试',
    'chat.38.prompt':
      '有哪些有趣的哲学思想实验？解释几个经典的思想实验，以及它们关于伦理、现实和意识教会了我们什么。',
    'chat.38.title': '探索哲学思想实验',
    'chat.39.prompt': '帮我设定明年有意义的目标。带我走过一个平衡雄心与务实的目标设定框架。',
    'chat.39.title': '设定有意义的年度目标',
    'chat.40.prompt':
      '教我烹饪基础。每个家庭厨师应该掌握哪些基本技巧、工具和食谱，才能在厨房里得心应手？',
    'chat.40.title': '学习烹饪基础',
    'group.01.prompt':
      '组建一个读书俱乐部讨论，由不同视角的读者组成——一位文学评论家分析主题和技巧，一位普通读者分享情感反应，一位历史爱好者提供背景，一位哲学爱好者探索更深层的含义。让他们讨论书籍的影响以及它揭示的人性。',
    'group.01.title': '和我一起进行读书会讨论',
    'group.02.prompt':
      '组织一场友好的辩论，参与者对一个话题持不同立场。包括一位确保公平讨论的主持人，各方的倡导者提出有说服力的论点，以及一位中立的分析师总结要点。让他们在从多个角度探讨问题的同时保持尊重。',
    'group.02.title': '就某个观点与我进行友好辩论',
    'group.03.prompt':
      '创建一个创意写作工作坊，由不同阶段的作者组成——一位出版小说家分享写作技巧，一位编辑提供反馈，一位诗歌专家讨论语言，以及有抱负的作家分享他们的作品。让他们给予建设性的反馈并相互启发。',
    'group.03.title': '帮助我打磨和提升写作',
    'group.04.prompt':
      '组建一个投资讨论小组，由一位价值投资者、一位关注增长的分析师、一位风险管理专家和一位理财规划师组成。让他们分析投资机会，讨论市场趋势，分享不同的策略，同时强调尽职调查的重要性。',
    'group.04.title': '和我一起探讨投资策略',
    'group.05.prompt':
      '组建一个旅行规划团队，由一位冒险爱好者建议刺激的活动，一位文化爱好者推荐地道的体验，一位预算旅行者分享省钱技巧，以及一位豪华旅行专家建议高端选项。让他们协作制定完美的行程。',
    'group.05.title': '帮助我规划梦想假期',
    'group.06.prompt':
      '创建一个电影讨论圈，由一位电影历史学家提供背景，一位导演视角谈论技艺，一位普通观众分享娱乐价值，以及一位影评人分析主题和执行。让他们讨论什么使电影有意义和令人难忘。',
    'group.06.title': '和我一起讨论电影',
    'group.07.prompt':
      '组织一场创业头脑风暴会议，由一位创意构思者生成概念，一位市场研究员验证需求，一位商业策略师评估可行性，以及一位创业者分享实际经验。让他们一起开发和完善商业创意。',
    'group.07.title': '一起头脑风暴商业创意',
    'group.08.prompt':
      '组建一个人生规划委员会，由一位职业教练专注于职业成长，一位财务顾问关注金钱事务，一位健康专家关注健康与平衡，以及一位人生教练关注个人满足。让他们帮助创建一个全面的人生计划。',
    'group.08.title': '帮助我规划人生目标',
    'group.09.prompt':
      '组建一个健康讨论小组，由一位健身教练、一位营养师、一位心理健康倡导者和一位睡眠专家组成。让他们讨论整体健康方法，分享实用技巧，并解决维持健康生活方式的常见挑战。',
    'group.09.title': '和我一起聊聊健康与养生',
    'group.10.prompt':
      '创建一个育儿圆桌会议，由不同年龄段孩子的父母、一位儿童心理学家、一位教育工作者和一位家庭顾问组成。让他们分享经验，讨论挑战，并在尊重不同育儿方式的同时提供支持。',
    'group.10.title': '分享育儿经验与建议',
    'group.11.prompt':
      '组织一个历史讨论小组，由不同时代和地区的专家组成——一位古代历史专家、一位现代历史学家、一位文化人类学家和一位政治学家。让他们分析历史事件及其与当今的相关性。',
    'group.11.title': '一起探索迷人的历史',
    'group.12.prompt':
      '组建一个哲学沙龙，由不同传统的思想家组成——一位东方哲学专家、一位西方哲学学者、一位伦理学专家和一位存在主义者。让他们通过不同的哲学视角探索人生的重大问题。',
    'group.12.title': '一起思考人生的大问题',
    'group.13.prompt':
      '组建一个艺术鉴赏小组，由一位艺术历史学家、一位实践艺术家、一位博物馆策展人和一位艺术收藏家组成。让他们讨论艺术作品、艺术运动，以及什么使艺术在不同文化和时代具有意义。',
    'group.13.title': '和我一起讨论艺术',
    'group.14.prompt':
      '创建一个美食探索俱乐部，由一位专业厨师、一位美食评论家、一位家庭厨师和一位美食历史学家组成。让他们讨论美食，分享食谱，探索烹饪技巧，并庆祝菜肴背后的文化故事。',
    'group.14.title': '一起探索世界美食',
    'group.15.prompt':
      '组建一个语言交流小组，由不同语言的母语者、一位解释语言结构的语言学家和不同水平的语言学习者组成。让他们练习对话，分享学习技巧，探索文化细微差别。',
    'group.15.title': '和我一起练习外语',
    'group.16.prompt':
      '组织一个职业转型支持小组，由一位职业教练、一位成功转型的人、一位人力资源专业人士和一位技能发展专家组成。让他们讨论策略，分享经验，为职业转型者提供鼓励。',
    'group.16.title': '帮助我应对职业转型',
    'group.17.prompt':
      '创建一个人际关系建议圈，由一位婚姻治疗师、一位沟通专家、一位分享智慧的长期已婚夫妇和一位提供新视角的单身人士组成。让他们讨论健康的关系动态和沟通策略。',
    'group.17.title': '一起探讨健康的人际关系',
    'group.18.prompt':
      '组建一个个人理财工作坊，由一位预算专家、一位投资顾问、一位债务咨询师和一位实现了财务独立的人组成。让他们分享建立财富和财务安全的实用策略。',
    'group.18.title': '帮助我掌握个人理财',
    'group.19.prompt':
      '组建一个心理健康支持圈，由一位治疗师、一位正念练习者、一位人生教练和一位分享心理健康旅程的人组成。让他们讨论应对策略、自我关怀实践，并减少心理健康的污名化。',
    'group.19.title': '支持我的心理健康之旅',
    'group.20.prompt':
      '创建一个创意营销团队，由一位品牌策略师、一位内容创作者、一位社交媒体专家和一位消费者心理学家组成。让他们开发有吸引力的营销活动，讨论什么使信息与受众产生共鸣。',
    'group.20.title': '帮助我制定营销策略',
    'group.21.prompt':
      '组织一个品牌建设工作坊，由一位品牌专家、一位视觉设计师、一位故事讲述专家和一位成功的创业者组成。让他们帮助开发有吸引力的品牌身份、信息和策略。',
    'group.21.title': '帮助我打造个人品牌',
    'group.22.prompt':
      '组建一个时事讨论小组，由一位记者、一位政治分析师、一位经济学家和一位社会评论员组成。让他们从多个角度分析新闻报道，区分事实与观点，探索其影响。',
    'group.22.title': '一起讨论时事新闻',
    'group.23.prompt':
      '创建一个科学探索团队，由不同领域的科学家组成——一位物理学家、一位生物学家、一位环境科学家和一位科学传播者。让他们解释复杂的话题，讨论最新发现，探索科学的奇迹。',
    'group.23.title': '一起探索科学新发现',
    'group.24.prompt':
      '组建一个文化交流小组，由来自不同文化背景的人、一位人类学家和一位旅行作家组成。让他们分享传统，尊重地讨论文化差异，找到共同的人类经历。',
    'group.24.title': '分享并探索文化体验',
    'group.25.prompt':
      '组建一个个人发展智囊团，由一位效率专家、一位习惯教练、一位激励专家和分享他们旅程的成功人士组成。让他们讨论成长策略、责任和实现目标。',
    'group.25.title': '帮助我实现自我成长',
    'group.26.prompt':
      '创建一个播客或内容规划团队，由一位内容策略师、一位故事讲述专家、一位技术制作人和一位成功的内容创作者组成。让他们头脑风暴想法，规划内容系列，讨论什么使内容引人入胜。',
    'group.26.title': '帮助我策划有吸引力的内容',
    'group.27.prompt':
      '组织一个写作反馈圈，由不同类型的作家、一位提供技术反馈的编辑和分享受众视角的读者组成。让他们讨论作品，给予建设性批评，支持彼此的创作成长。',
    'group.27.title': '对我的写作给予建设性反馈',
    'group.28.prompt':
      '组建一个音乐鉴赏小组，由一位音乐历史学家、一位音乐家、一位制作人和一位热情的听众组成。让他们探索不同的流派，讨论什么使音乐有力量，分享来自不同时代和文化的发现。',
    'group.28.title': '一起发现新音乐',
    'group.29.prompt':
      '组建一个完整的软件开发团队，包括负责架构决策的技术主管、专注于用户体验的前端开发人员、处理数据和 API 的后端开发人员，以及确保质量的 QA 工程师。让他们协作规划、讨论权衡，并为新功能制定实施策略。',
    'group.29.title': '一起规划新功能',
    'group.30.prompt':
      '组建一个代码审查小组，由来自不同专业领域的资深工程师组成——后端专家、前端专家、安全工程师和性能优化专家。让他们从各自独特的角度彻底审查代码，提供全面的反馈。',
    'group.30.title': '从多个角度审查我的代码',
    'group.31.prompt':
      '建立一个技术架构评审会，由系统架构师提出设计方案，安全专家评估漏洞，性能工程师评估可扩展性，资深开发人员考虑实现复杂性。让他们挑战假设并完善架构。',
    'group.31.title': '审查我的系统架构',
    'group.32.prompt':
      '创建一个创业创始团队，由专注于愿景和战略的 CEO、评估技术可行性和架构的 CTO，以及规划市场进入策略的 CMO 组成。让他们就产品方向、资源分配、竞争定位和增长策略进行辩论并达成一致。',
    'group.32.title': '模拟初创团队讨论',
    'group.33.prompt':
      '组建一个招聘委员会，由招聘经理、资深工程师、HR 代表和团队文化倡导者组成。让他们就候选人要求达成一致，设计面试流程，并全面评估候选人。',
    'group.33.title': '帮助我优化招聘流程',
    'group.34.prompt':
      '组建一个创新实验室，由产品愿景家、原型工程师、市场研究员和设计思维者组成。让他们探索新兴技术，快速验证新想法，并提出创新的产品方向。',
    'group.34.title': '一起探索新兴技术',
    'group.35.prompt':
      '创建一个客户反馈评审小组，由产品经理、用户体验研究员、客户成功经理和工程代表组成。让他们综合客户反馈，识别模式，并确定改进的优先级。',
    'group.35.title': '帮助我分析客户反馈',
    'group.36.prompt':
      '组建一个产品发布团队，由产品经理、市场主管、客户成功经理和工程主管组成。让他们协调发布活动，为潜在问题做好准备，并确保产品顺利发布。',
    'group.36.title': '帮助我协调产品发布',
    'group.37.prompt':
      '组织一个技术评估委员会，由技术架构师、将使用该技术的开发人员、安全评审员和考虑总拥有成本的经理组成。让他们系统地评估新工具或框架。',
    'group.37.title': '帮助我评估新技术',
    'group.38.prompt':
      '创建一个安全评审委员会，由安全工程师、合规官员、后端开发人员和 DevOps 工程师组成。让他们评估系统的安全漏洞、合规差距和运营风险，然后确定修复工作的优先级。',
    'group.38.title': '审查我的系统安全状况',
    'group.39.prompt':
      '组建一个指标和 KPI 工作坊，由产品经理、数据分析师、工程主管和业务利益相关者参与。让他们定义有意义的指标，建立基线，并创建推动良好决策的仪表板。',
    'group.39.title': '帮助我定义有意义的指标',
    'group.40.prompt':
      '组建一个设计评审小组，由 UX 设计师展示设计，前端开发人员评估实现可行性，产品经理检查与需求的一致性，无障碍专家确保包容性设计。让他们提供建设性反馈并进行迭代。',
    'group.40.title': '从多个角度审查我的设计',
    'write.01.prompt':
      '写一个引人入胜的短篇故事，包含令人印象深刻的角色、吸引人的情节和令人满意的结局。包括生动的描述让场景栩栩如生，自然的对话揭示角色性格，不断升级的紧张感让读者着迷，以及贯穿整个叙事的有意义的主题或信息。',
    'write.01.title': '写一个引人入胜的短篇故事',
    'write.02.prompt':
      '创作一首美丽的诗歌，表达深刻的情感或捕捉某个时刻。尝试使用意象、隐喻、韵律和声音手法。诗歌可以遵循传统形式（十四行诗、俳句等）或自由诗，但应该有清晰的声音和情感共鸣。',
    'write.02.title': '为我写一首优美的诗',
    'write.03.prompt':
      '为短片、戏剧或视频写一个引人入胜的剧本。包括听起来自然的对话，清晰的场景描述和舞台指示，具有独特声音的发展完善的角色，以及推动故事前进的戏剧张力。',
    'write.03.title': '写一个电影或舞台剧剧本',
    'write.04.prompt':
      '写一个富有想象力的儿童故事或童话，包含令人难忘的角色、明确的道德教训、适合年龄的语言，以及奇迹和魔法的感觉。包含激发想象力的元素，同时保持故事对年轻读者的可读性和吸引力。',
    'write.04.title': '写一个充满魔力的儿童故事',
    'write.05.prompt':
      '创作一个身临其境的科幻或奇幻故事，包含创意世界观、独特概念和引人入胜的角色。一致地发展你虚构世界的规则，通过冲突制造紧张感，探索与读者产生共鸣的主题。',
    'write.05.title': '写一篇沉浸式的科幻或奇幻故事',
    'write.06.prompt':
      '写一个扣人心弦的悬疑或惊悚故事，包含紧张的节奏、巧妙的情节转折和贯穿叙事的线索。为读者创造一个有趣的谜题，让他们与主角一起解谜，同时保持紧张感直到令人满意的揭示。',
    'write.06.title': '写一个扣人心弦的悬疑故事',
    'write.07.prompt':
      '写一篇深思熟虑的个人散文或回忆录，反思生活经历、观察或情感。使用生动的细节让回忆栩栩如生，在个人故事中找到普遍主题，创作既亲密又对读者有意义的散文。',
    'write.07.title': '写一篇反思性的个人随笔',
    'write.08.prompt':
      '创作闪小说或微型故事，用很少的文字产生强大的冲击力。每个词都应该有意义，用简洁的散文、暗示的背景故事和令人惊讶或引起共鸣的结局。目标是在1000字以内完成给人留下深刻印象的完整故事。',
    'write.08.title': '写一篇有力的闪小说',
    'write.09.prompt':
      '写一封专业的电子邮件，清晰、简洁地实现其目的。无论是请求信息、跟进、提出建议还是处理敏感问题，确保语气适当，结构合理，行动号召明确。',
    'write.09.title': '帮助我撰写专业电子邮件',
    'write.10.prompt':
      '创建一份有吸引力的简历，有效地突出你的技能、经验和成就。使用强有力的动词，尽可能量化成就，根据目标角色定制内容，确保格式清晰，既能通过 ATS 系统又保持可读性。',
    'write.10.title': '帮助我制作一份出色的简历',
    'write.11.prompt':
      '写一封有说服力的求职信，补充你的简历并讲述你的职业故事。展示对职位和公司的真诚热情，突出与工作要求匹配的相关经验，以令人难忘的方式展示你独特的价值主张。',
    'write.11.title': '帮助我写一封有说服力的求职信',
    'write.12.prompt':
      '写一份引人入胜的演讲稿或演示文稿脚本，能够抓住并保持听众的注意力。包括强有力的开场钩子，清晰的结构和流畅的过渡，引人入胜的故事或例子，以及带有明确要点或行动号召的令人难忘的结论。',
    'write.12.title': '为我写一篇引人入胜的演讲稿',
    'write.13.prompt':
      '写一封真诚的感谢信，表达真挚的感激之情。无论是感谢礼物、面试、帮助还是支持，具体说明你感谢什么，解释它对你的影响，保持真诚的语气以加强关系。',
    'write.13.title': '写一封真挚的感谢信',
    'write.14.prompt':
      '写一封真诚的道歉信，承担责任，表达真诚的悔意，并提供前进的道路。承认造成的具体伤害，避免找借口，解释如何防止再次发生，请求原谅但不强求。',
    'write.14.title': '写一封诚恳的道歉信',
    'write.15.prompt':
      '为活动创建一份优雅的邀请函，无论是正式的（婚礼、晚宴）还是休闲的（派对、聚会）。包括所有必要的细节（谁、什么、何时、何地、回复），设定适当的基调，在明确期望的同时营造期待感。',
    'write.15.title': '设计一份优雅的活动邀请函',
    'write.16.prompt':
      '写一封有力的推荐信，有效地为某人代言。包括他们优势和成就的具体例子，提供你们关系和观察的背景，提供真诚的认可，帮助读者做出明智的决定。',
    'write.16.title': '写一封有力的推荐信',
    'write.17.prompt':
      '写一篇诚实有用的产品评测，指导潜在买家。涵盖主要功能、实际性能、优缺点、性价比，以及产品最适合谁。包括你使用经验的具体例子和明确的推荐。',
    'write.17.title': '写一篇有帮助的产品评价',
    'write.18.prompt':
      '为目的地创建一份全面的旅行指南或行程。包括必看景点、隐藏的宝藏、实用提示（交通、住宿、美食）、预算考虑，以及帮助旅行者充分利用旅程的内部建议。',
    'write.18.title': '制作一份全面的旅行指南',
    'write.19.prompt':
      '写引人入胜的社交媒体内容，能够抓住注意力并促进互动。无论是针对 Instagram、Twitter/X、LinkedIn 还是 TikTok，创作适合平台、与目标受众产生共鸣、包含吸引人的钩子和明确行动号召的内容。',
    'write.19.title': '撰写吸引人的社交媒体内容',
    'write.20.prompt':
      '写一篇令人垂涎的美食评论或食谱，用生动的描述让读者感到饥饿。对于评论，捕捉氛围、服务和风味。对于食谱，提供清晰的说明、有用的技巧，以及菜肴背后的故事。',
    'write.20.title': '写一篇令人垂涎的美食评论',
    'write.21.prompt':
      '写一篇深思熟虑的书评或影评，帮助读者决定是否适合他们。总结但不剧透，分析主题和技巧，讨论什么有效什么无效，确定理想的受众，并提供明确的评分或推荐。',
    'write.21.title': '写一篇有见地的书评或影评',
    'write.22.prompt':
      '写一篇引人入胜的个人博客文章，与读者产生联系。选择你关心的话题，分享你独特的观点，使用对话式的语调，包括个人轶事或例子，以邀请读者反思或讨论的想法结束。',
    'write.22.title': '写一篇引人入胜的博客文章',
    'write.23.prompt':
      '按照新闻标准写一篇清晰客观的新闻报道。涵盖基本的谁、什么、何时、何地、为什么和如何。使用倒金字塔结构，包含相关引用，保持中立，在报道前核实事实。',
    'write.23.title': '写一篇清晰的新闻报道',
    'write.24.prompt':
      '写一篇有洞察力的访谈文章，让对话栩栩如生。准备深思熟虑的问题，捕捉受访者的个性和声音，将引用编织成引人入胜的叙事，提供帮助读者理解为什么这个人的故事重要的背景。',
    'write.24.title': '写一篇有深度的访谈文章',
    'write.25.prompt':
      '写一份全面的商业计划书，说服投资者或指导你的事业。包括执行摘要、市场分析、竞争格局、商业模式、营销策略、财务预测、团队概述，以及明确资金用途的融资需求。',
    'write.25.title': '撰写一份全面的商业计划书',
    'write.26.prompt':
      '写详细有用的读书笔记或书籍摘要，捕捉关键见解。包括主要论点和支持要点、令人难忘的引用、个人反思、实际应用，以及进一步探索的问题。',
    'write.26.title': '写一份实用的读书笔记',
    'write.27.prompt':
      '写一份关于某个主题的详尽研究报告或分析。包括清晰的方法论、组织良好的发现、数据可视化描述、对不同观点的平衡分析，以及有证据支持的可行结论。',
    'write.27.title': '撰写一份详尽的研究报告',
    'write.28.prompt':
      '写一份识别机会和威胁的市场分析。包括行业概述、目标客户分析、竞争对手映射、趋势识别、SWOT 分析，以及基于发现的战略建议。',
    'write.28.title': '撰写一份详细的市场分析',
    'write.29.prompt':
      '写清晰可操作的会议纪要，捕捉决策和后续步骤。包括参会者、讨论的议程项目、关键讨论要点、做出的决定、带有负责人和截止日期的行动项，以及需要跟进的事项。',
    'write.29.title': '写一份清晰的会议纪要',
    'write.30.prompt':
      '写一份反思性的年终总结或年度回顾，捕捉成就和学习。包括带有指标的关键成就、克服的挑战、学到的教训、目标评估，以及来年的目标。',
    'write.30.title': '撰写我的年终总结',
    'write.31.prompt':
      '撰写一篇全面的技术博客文章，以易于理解的方式解释复杂的编程概念。包括能吸引读者的清晰引言、从基础到高级主题的渐进式解释、带有详细注释的实用代码示例、视觉图表描述、真实世界用例、需要避免的常见陷阱，以及包含进一步学习内容的结论。',
    'write.31.title': '写一篇有趣的技术博客文章',
    'write.32.prompt':
      '为开源项目生成一个完整、专业的 README.md，包括带有徽章的引人注目的项目描述、针对不同平台的清晰安装说明、带有基本用法示例的快速入门指南、包含所有可用选项的全面 API 文档、带有代码风格要求的贡献指南、许可证信息和致谢部分。',
    'write.32.title': '创建一份专业的 README 文件',
    'write.33.prompt':
      '编写开发者真正愿意阅读的详细 API 文档。包括 API 目的和功能概述、带有示例的身份验证和授权要求、带有请求/响应模式的端点参考、多种编程语言的交互式代码示例、带有故障排除提示的全面错误代码文档、速率限制详情和版本控制策略。',
    'write.33.title': '撰写详细的 API 文档',
    'write.34.prompt':
      '创建一份技术设计文档，清晰地向技术和非技术利益相关者传达系统架构。包括问题陈述和目标、带有组件图的高级架构概述、详细的数据流描述、带有理由的技术选择、可扩展性和性能考虑、安全措施、测试策略，以及带有风险缓解的上线计划。',
    'write.34.title': '撰写技术设计文档',
    'write.35.prompt':
      '编写一份用户友好的指南，帮助用户使用你的软件实现他们的目标。包括带有前提条件的入门部分、带有清晰截图描述的分步说明、有用的提示和快捷方式、常见问题解答、常见问题的故障排除部分，以及为高级用户提供的额外资源链接。',
    'write.35.title': '创建一份用户友好的使用指南',
    'write.36.prompt':
      '起草专业的发布说明，让用户了解并对更新感到兴奋。包括发布亮点摘要、带有用法示例的新功能详细描述、所做的改进和优化、已修复的缺陷及问题引用、带有清晰迁移说明的破坏性变更、弃用通知，以及对贡献者的致谢。',
    'write.36.title': '撰写专业的版本更新说明',
    'write.37.prompt':
      '创建一份全面的入职指南，帮助新团队成员快速上手。包括团队介绍和沟通渠道、环境设置说明、代码库架构概述和关键目录、标准和约定、常见工作流程、调试技巧、有用资源列表，以及第一周建议任务。',
    'write.37.title': '构建一份全面的入职指南',
    'write.38.prompt':
      '撰写一份有说服力的项目提案文档，清晰阐述正在解决的问题及其业务影响，呈现经过深思熟虑的解决方案和技术方法，包括现实的里程碑和时间表，指定资源需求和预算考虑，定义可衡量的成功指标和 KPI，并提出潜在风险的缓解策略。',
    'write.38.title': '起草一份有说服力的项目提案',
    'write.39.prompt':
      '编写一份产品需求文档（PRD），清晰定义要构建的内容。包括问题陈述和用户需求、用户画像和用例、带有验收标准的功能需求、非功能需求（性能、安全等）、带有线框图的 UI/UX 需求、成功指标，以及带有依赖关系的时间表。',
    'write.39.title': '撰写产品需求文档',
    'write.40.prompt':
      '编写一篇知识库文章，帮助用户解决特定问题。包括清晰的问题陈述、前提条件和假设、带有截图的分步解决方案、适用时的替代方法、常见问题的故障排除提示、相关文章和后续步骤，以及反馈机制。',
    'write.40.title': '撰写知识库文章',
  },
  hn = Object.freeze(
    Object.defineProperty({ __proto__: null, default: vs }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  lo = '子话题目前不支持文件/图片上传。如有任何需求，欢迎在<1>💬 讨论区</1>留言。',
  ks = {
    ...
    'notSupportMultiModals': lo,
  },
  fn = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: ks, notSupportMultiModals: lo },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  As = {
    'agentGroupManagement.executeTask.agent': '执行代理',
    'agentGroupManagement.executeTask.cancelled': '已取消',
    'agentGroupManagement.executeTask.completed': '任务已完成',
    'agentGroupManagement.executeTask.cost': '成本',
    'agentGroupManagement.executeTask.failed': '任务失败',
    'agentGroupManagement.executeTask.interrupted': '已中断',
    ...
    'agentGroupManagement.executeTask.processing': '处理中...',
    'agentGroupManagement.executeTask.steps': '执行步骤',
    'agentGroupManagement.executeTask.task': '任务内容',
    ...
    'codeInterpreter-legacy.output': '输出：',
    ...
    'dalle.autoGenerate': '自动生成',
    'dalle.downloading': 'DALL·E3 生成的图片链接仅在 1 小时内有效，正在本地缓存图片...',
    'dalle.generate': '生成',
    ...
    'localFiles.editFile.oldString': '查找',
    ...
    'localFiles.moveFiles.itemsToMove_one': '待移动 {{count}} 项：',
    'localFiles.moveFiles.itemsToMove_other': '待移动 {{count}} 项：',
    'localFiles.open': '打开',
    ...
    'securityBlacklist.awsCredentials': '访问 AWS 凭证可能泄露云访问密钥',
    'securityBlacklist.browserCredentials': '访问浏览器凭证存储可能泄露密码',
    'securityBlacklist.chownSystemDirs': '更改系统目录的文件所有权是危险操作',
    'securityBlacklist.ddDiskWrite': '向磁盘设备写入随机数据可能导致数据丢失',
    'securityBlacklist.directMemoryAccess': '直接内存访问极其危险',
    'securityBlacklist.disableFirewall': '禁用防火墙会使系统暴露于攻击之下',
    'securityBlacklist.dockerConfig': '读取 Docker 配置可能泄露镜像仓库凭证',
    'securityBlacklist.envFiles': '读取 .env 文件可能泄露敏感凭证和 API 密钥',
    'securityBlacklist.etcPasswd': '修改 /etc/passwd 可能导致系统无法登录',
    'securityBlacklist.forkBomb': 'Fork 炸弹可能导致系统崩溃',
    'securityBlacklist.formatPartition': '格式化系统分区将导致数据丢失',
    'securityBlacklist.gcpCredentials': '读取 GCP 凭证可能泄露云服务账户密钥',
    'securityBlacklist.gitCredentials': '读取 Git 凭证文件可能泄露访问令牌',
    'securityBlacklist.historyFiles': '读取历史文件可能泄露敏感命令和凭证',
    'securityBlacklist.kernelParams': '在不了解的情况下修改内核参数可能导致系统崩溃',
    'securityBlacklist.kubeConfig': '读取 Kubernetes 配置可能泄露集群凭证',
    'securityBlacklist.npmrc': '读取 npm token 文件可能泄露包注册表凭证',
    'securityBlacklist.removeSystemPackages': '移除关键系统软件包可能导致系统损坏',
    'securityBlacklist.rmForceRecursive': '未指定目标的强制递归删除过于危险',
    'securityBlacklist.rmHomeDir': '递归删除主目录极其危险',
    'securityBlacklist.rmRootDir': '递归删除根目录将摧毁整个系统',
    'securityBlacklist.sshConfig': '更改 SSH 配置可能导致无法远程登录',
    'securityBlacklist.sshPrivateKeys': '读取 SSH 私钥可能危及系统安全',
    'securityBlacklist.sudoers': '未经正确验证修改 sudoers 文件是危险操作',
    'securityBlacklist.suidShells': '在 Shell 或解释器上设置 SUID 是安全风险',
    ...
    'updateArgs.stringifyError': '无法序列化参数，请检查参数格式',
  },
  yn = Object.freeze(
    Object.defineProperty({ __proto__: null, default: As }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  co = '默认话题',
  ...
  Ss = {
    ...
    'guide.title': '话题列表',
    'importError': bo,
    'importInvalidFormat': ho,
    'importLoading': fo,
    'importSuccess': yo,
    'loadMore': vo,
    'searchPlaceholder': ko,
    'searchResultEmpty': Ao,
    'temp': So,
    'title': Mo,
  },
  vn = Object.freeze(
  ...
  Ms = {
    'config.aspectRatio.label': '宽高比',
    'config.cameraFixed.label': '固定镜头',
    'config.duration.label': '时长',
    ...
    'generation.validation.endFrameRequiresStartFrame':
      '使用结束画面前需先设置起始画面。请先设置起始画面。',
    'topic.createNew': '创作新主题',
    'topic.deleteConfirm': '删除视频主题',
    'topic.deleteConfirmDesc': '你即将删除该视频主题，此操作无法撤销。',
    'topic.title': '视频主题',
    'topic.untitled': '默认主题',
  },
  kn = Object.freeze(
  ...
  An = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: ws, header: wo, pickAgent: Po, skip: Co, welcomeMessages: To },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  );
...
function Z(l) {
  for (var r = 1; r < arguments.length; r++) {
    ...
    r % 2
      ? X(Object(p), !0).forEach(function (u) {
          Ps(l, u, p[u]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(l, Object.getOwnPropertyDescriptors(p))
        : X(Object(p)).forEach(function (u) {
            Object.defineProperty(l, u, Object.getOwnPropertyDescriptor(p, u));
          });
  }
  return l;
}
function Ps(l, r, p) {
  return (
    (r = Cs(r)),
    r in l
      ? Object.defineProperty(l, r, { value: p, enumerable: !0, configurable: !0, writable: !0 })
      : (l[r] = p),
    l
  );
}
...
const Io = { placeholder: '请选择时间', rangePlaceholder: ['开始时间', '结束时间'] },
  W = {
    lang: {
      placeholder: '请选择日期',
...
const v = '${label}不是一个有效的${type}',
  Ds = {
    ...
    TimePicker: Io,
    Calendar: W,
    global: { placeholder: '请选择', close: '关闭', sortable: '可排序' },
    Table: {
      filterTitle: '筛选',
      filterConfirm: '确定',
      filterReset: '重置',
    ...
    Icon: { icon: '图标' },
    Text: { edit: '编辑', copy: '复制', copied: '复制成功', expand: '展开', collapse: '收起' },
    Form: {
      optional: '（可选）',
    ...
    ee ||
      ...
      (function (l, r) {
        (function (p, u) {
          ...
          return (x.default.locale(N, null, !0), N);
        });
      })(j)),
    j.exports
  );
