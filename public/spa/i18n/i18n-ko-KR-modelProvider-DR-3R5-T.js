const e = {
  'azure.azureApiVersion.desc':
    'Azure의 API 버전으로, YYYY-MM-DD 형식을 따릅니다. [최신 버전](https://learn.microsoft.com/zh-cn/azure/ai-services/openai/reference#chat-completions)을 참조하세요.',
  'azure.azureApiVersion.fetch': '목록 가져오기',
  'azure.azureApiVersion.title': 'Azure API 버전',
  'azure.empty': '모델 ID를 입력하여 첫 번째 모델을 추가하세요',
  'azure.endpoint.desc':
    "Azure 포털에서 리소스를 확인할 때 '키 및 엔드포인트' 섹션에서 이 값을 찾을 수 있습니다",
  ...
  'azure.token.desc':
    "Azure 포털에서 리소스를 확인할 때 '키 및 엔드포인트' 섹션에서 이 값을 찾을 수 있습니다. KEY1 또는 KEY2를 사용할 수 있습니다",
  ...
  'azureai.endpoint.desc':
    'Azure AI 프로젝트 개요에서 Azure AI 모델 추론 엔드포인트를 찾을 수 있습니다',
  ...
  'bedrock.unlock.description':
    'AWS AccessKeyId / SecretAccessKey를 입력하면 세션을 시작할 수 있습니다. 애플리케이션은 인증 구성을 저장하지 않습니다',
  'bedrock.unlock.imageGenerationDescription':
    'AWS AccessKeyId / SecretAccessKey를 입력하면 이미지 생성을 시작할 수 있습니다. 애플리케이션은 인증 구성을 저장하지 않습니다',
  ...
  'github.personalAccessToken.desc':
    'Github PAT를 입력하세요. [여기](https://github.com/settings/tokens)를 클릭하여 생성할 수 있습니다',
  'github.personalAccessToken.placeholder': 'ghp_xxxxxx',
  'github.personalAccessToken.title': 'Github PAT',
  'huggingface.accessToken.desc':
    'HuggingFace Token을 입력하세요. [여기](https://huggingface.co/settings/tokens)를 클릭하여 생성할 수 있습니다',
  ...
  'ollama.download.desc':
    'Ollama가 모델을 다운로드 중입니다. 이 페이지를 닫지 마세요. 재다운로드 시 중단된 지점부터 이어집니다',
  'ollama.download.failed':
    '모델 다운로드 실패. 네트워크 또는 Ollama 설정을 확인한 후 다시 시도하세요',
  ...
  'ollama.endpoint.desc':
    'http(s)://를 포함해야 하며, 로컬에서 별도 지정하지 않은 경우 비워둘 수 있습니다',
  ...
  'providerModels.config.checker.desc':
    'API Key 및 프록시 주소가 올바르게 입력되었는지 테스트합니다',
  ...
  'providerModels.config.fetchOnClient.desc':
    '클라이언트 요청 모드는 브라우저에서 직접 세션 요청을 시작하여 응답 속도를 향상시킵니다',
  ...
  'providerModels.config.oauth.authorizedDesc':
    '{{name}}에 연결되었습니다. 연결을 해제하려면 클릭하세요.',
  ...
  'providerModels.config.oauth.connectDesc':
    '브라우저를 통해 인증하려면 클릭하세요. API 키는 필요하지 않습니다.',
  ...
  'providerModels.config.oauth.disconnectConfirm':
    '정말 연결을 해제하시겠습니까? 이 공급자를 사용하려면 다시 인증해야 합니다.',
  ...
  'providerModels.config.responsesApi.desc':
    'OpenAI의 차세대 요청 형식 규격을 사용하여, 사고의 흐름 등 고급 기능을 활성화합니다 (OpenAI 모델에서만 지원됨)',
  ...
  'providerModels.item.customModelCards.confirmDelete':
    '이 사용자 정의 모델을 삭제하려고 합니다. 삭제 후 복구할 수 없으니 신중히 진행해 주세요.',
  ...
  'providerModels.item.modelConfig.reasoning.extra':
    '이 설정은 모델의 심층 사고 기능만 활성화합니다. 실제 효과는 모델에 따라 다르므로 직접 테스트해 주세요',
  'providerModels.item.modelConfig.reasoning.title': '심층 사고 지원',
  'providerModels.item.modelConfig.search.extra':
    '이 설정은 모델 내장 검색 엔진의 인터넷 검색 기능만 활성화하며, 내장 검색 엔진 지원 여부는 모델 자체에 따라 달라집니다. 해당 모델의 내장 검색 엔진 기능이 사용 가능한지 직접 테스트해 주세요.',
  ...
  'providerModels.item.modelConfig.video.extra':
    '이 설정은 애플리케이션 내의 비디오 인식 설정만 활성화하며, 인식 가능 여부는 전적으로 모델 자체에 따라 달라집니다. 해당 모델의 비디오 인식 기능이 사용 가능한지 직접 테스트해 주세요.',
  'providerModels.item.modelConfig.video.title': '비디오 인식 지원',
  'providerModels.item.modelConfig.vision.extra':
    '이 설정은 애플리케이션 내 이미지 업로드 기능만 활성화합니다. 실제 인식 가능 여부는 모델에 따라 다르므로 직접 테스트해 주세요',
  ...
  'providerModels.list.empty.desc':
    '사용자 정의 모델을 생성하거나 모델을 가져온 후 사용을 시작해 보세요',
  ...
  'providerModels.list.enabledEmpty':
    '활성화된 모델이 없습니다. 아래 목록에서 원하는 모델을 활성화해 보세요~',
  ...
  'providerModels.list.resetAll.conform':
    '현재 모델의 모든 수정을 초기화하시겠습니까? 초기화 후 모델 목록이 기본 상태로 돌아갑니다',
  ...
  'updateAiProvider.confirmDelete':
    '이 AI 서비스 제공자를 삭제하려고 합니다. 삭제 후 복구할 수 없습니다. 삭제하시겠습니까?',
  ...
  'vertexai.region.desc':
    'Vertex AI 서비스 지역을 선택하세요. Gemini 2.5와 같은 일부 모델은 특정 지역(예: global)에서만 사용할 수 있습니다.',
