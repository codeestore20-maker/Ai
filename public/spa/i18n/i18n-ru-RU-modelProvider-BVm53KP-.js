const e = {
  'azure.azureApiVersion.desc':
    'Версия Azure API в формате ГГГГ-ММ-ДД. Ознакомьтесь с [последней версией](https://learn.microsoft.com/ru-ru/azure/ai-services/openai/reference#chat-completions)',
  ...
  'azure.endpoint.desc':
    'При просмотре ресурсов в портале Azure это значение можно найти в разделе «Ключи и конечные точки»',
  ...
  'azure.token.desc':
    'При просмотре ресурсов в портале Azure это значение можно найти в разделе «Ключи и конечные точки». Можно использовать KEY1 или KEY2',
  'azure.token.placeholder': 'Ключ Azure API',
  'azure.token.title': 'API-ключ',
  'azureai.azureApiVersion.desc':
    'Версия API для Azure в формате ГГГГ-ММ-ДД. См. [последнюю версию](https://learn.microsoft.com/ru-ru/azure/ai-services/openai/reference#chat-completions)',
  'azureai.azureApiVersion.fetch': 'Получить список',
  'azureai.azureApiVersion.title': 'Версия Azure API',
  'azureai.endpoint.desc':
    'Найдите конечную точку вывода модели Azure AI в обзоре проекта Azure AI',
  ...
  'bedrock.unlock.description':
    'Введите AccessKeyId / SecretAccessKey AWS, чтобы начать сеанс. Приложение не сохраняет ваши данные аутентификации',
  'bedrock.unlock.imageGenerationDescription':
    'Введите AccessKeyId / SecretAccessKey AWS, чтобы начать генерацию. Приложение не сохраняет ваши учетные данные.',
  ...
  'cloudflare.baseURLOrAccountID.desc':
    'Введите идентификатор учетной записи Cloudflare или пользовательский адрес API',
  'cloudflare.baseURLOrAccountID.placeholder':
    'ID учетной записи Cloudflare / пользовательский URL API',
  ...
  'comfyui.customHeaders.desc':
    'Заголовки запроса, необходимые для пользовательской аутентификации, в формате ключ-значение',
  ...
  'createNewAiProvider.id.desc':
    'Уникальный идентификатор провайдера, не может быть изменен после создания',
  'createNewAiProvider.id.duplicate': 'ID провайдера уже существует',
  'createNewAiProvider.id.format':
    'Может содержать только цифры, строчные буквы, дефисы (-) и подчеркивания (_)',
  'createNewAiProvider.id.placeholder':
    'Рекомендуется использовать строчные буквы, например openai. Не может быть изменен после создания',
  ...
  'github.personalAccessToken.desc':
    'Введите ваш персональный токен GitHub. Нажмите [здесь](https://github.com/settings/tokens), чтобы создать его.',
  ...
  'huggingface.accessToken.desc':
    'Введите ваш токен HuggingFace. Нажмите [здесь](https://huggingface.co/settings/tokens), чтобы создать его',
  ...
  'ollama.download.desc':
    'Ollama загружает модель. Пожалуйста, не закрывайте эту страницу. Загрузка продолжится с места остановки в случае прерывания.',
  'ollama.download.failed':
    'Не удалось загрузить модель. Проверьте подключение к сети или настройки Ollama и попробуйте снова.',
  ...
  'ollama.endpoint.desc':
    'Должен включать http(s)://; можно оставить пустым, если не указано локально.',
  ...
  'providerModels.config.aesGcm':
    'Ваш ключ и URL прокси будут зашифрованы с использованием алгоритма <1>AES-GCM</1>',
  'providerModels.config.apiKey.desc': 'Пожалуйста, введите ваш ключ API {{name}}',
  'providerModels.config.apiKey.descWithUrl':
    'Пожалуйста, введите ваш ключ API {{name}}. <3>Нажмите здесь, чтобы получить его</3>',
  ...
  'providerModels.config.fetchOnClient.desc':
    'Режим клиентского запроса инициирует сессии напрямую из браузера, что может повысить скорость отклика',
  ...
  'providerModels.config.oauth.desc':
    'Авторизуйтесь через аккаунт {{name}}, чтобы получить доступ к моделям по вашей подписке.',
  'providerModels.config.oauth.disconnect': 'Отключить',
  'providerModels.config.oauth.disconnectConfirm':
    'Вы уверены, что хотите отключиться? Для использования этого провайдера потребуется повторная авторизация.',
  ...
  'providerModels.config.responsesApi.desc':
    'Использует формат запроса следующего поколения от OpenAI для активации расширенных функций, таких как цепочка рассуждений (поддерживается только моделями OpenAI)',
  'providerModels.config.responsesApi.title': 'Использовать спецификацию Responses API',
  'providerModels.config.waitingForMore':
    'В настоящее время <1>планируется интеграция</1> дополнительных моделей, следите за обновлениями',
  ...
  'providerModels.item.customModelCards.confirmDelete':
    'Вы собираетесь удалить эту пользовательскую модель. После удаления восстановление будет невозможно. Пожалуйста, действуйте осторожно.',
  ...
  'providerModels.item.modelConfig.azureDeployName.extra':
    'Поле, используемое для реальных запросов в Azure OpenAI',
  'providerModels.item.modelConfig.azureDeployName.placeholder':
    'Введите имя развертывания модели в Azure',
  ...
  'providerModels.item.modelConfig.deployName.extra':
    'Это поле будет использоваться как ID модели при отправке запросов',
  'providerModels.item.modelConfig.deployName.placeholder':
    'Введите фактическое имя или ID развертывания модели',
  ...
  'providerModels.item.modelConfig.displayName.placeholder':
    'Введите отображаемое имя модели, например, ChatGPT, GPT-4 и т.д.',
  ...
  'providerModels.item.modelConfig.extendParams.extra':
    'Выберите расширенные параметры, поддерживаемые моделью. Наведите курсор на опцию, чтобы просмотреть элементы управления. Неверные настройки могут привести к сбоям запроса.',
  'providerModels.item.modelConfig.extendParams.options.codexMaxReasoningEffort.hint':
    'Для моделей Codex; регулирует интенсивность рассуждений.',
  'providerModels.item.modelConfig.extendParams.options.disableContextCaching.hint':
    'Для моделей Claude; может снизить стоимость и ускорить ответы.',
  'providerModels.item.modelConfig.extendParams.options.effort.hint':
    'Для Claude Opus 4.6; управляет уровнем усилий (низкий/средний/высокий/максимальный).',
  'providerModels.item.modelConfig.extendParams.options.enableAdaptiveThinking.hint':
    'Для Claude Opus 4.6; включает или отключает адаптивное мышление.',
  'providerModels.item.modelConfig.extendParams.options.enableReasoning.hint':
    'Для моделей Claude, DeepSeek и других с поддержкой рассуждений; активирует более глубокое мышление.',
  'providerModels.item.modelConfig.extendParams.options.gpt5ReasoningEffort.hint':
    'Для серии GPT-5; управляет интенсивностью рассуждений.',
  'providerModels.item.modelConfig.extendParams.options.gpt5_1ReasoningEffort.hint':
    'Для серии GPT-5.1; управляет интенсивностью рассуждений.',
  'providerModels.item.modelConfig.extendParams.options.gpt5_2ProReasoningEffort.hint':
    'Для серии GPT-5.2 Pro; управляет интенсивностью рассуждений.',
  'providerModels.item.modelConfig.extendParams.options.gpt5_2ReasoningEffort.hint':
    'Для серии GPT-5.2; управляет интенсивностью рассуждений.',
  'providerModels.item.modelConfig.extendParams.options.grok4_20ReasoningEffort.hint':
    'Для серии Grok 4.20; регулирует интенсивность рассуждений. Низкий/Средний использует 4 агента, Высокий/Очень высокий использует 16 агентов.',
  'providerModels.item.modelConfig.extendParams.options.imageAspectRatio.hint':
    'Для моделей генерации изображений Gemini; управляет соотношением сторон создаваемых изображений.',
  'providerModels.item.modelConfig.extendParams.options.imageAspectRatio2.hint':
    'Для Nano Banana 2; управляет соотношением сторон создаваемых изображений (поддерживает сверхширокие 1:4, 4:1, 1:8, 8:1).',
  'providerModels.item.modelConfig.extendParams.options.imageResolution.hint':
    'Для моделей генерации изображений Gemini 3; управляет разрешением создаваемых изображений.',
  'providerModels.item.modelConfig.extendParams.options.imageResolution2.hint':
    'Для моделей Gemini 3.1 Flash Image; управляет разрешением создаваемых изображений (поддерживает 512px).',
  'providerModels.item.modelConfig.extendParams.options.reasoningBudgetToken.hint':
    'Для моделей Claude, Qwen3 и аналогичных; управляет бюджетом токенов для рассуждений.',
  'providerModels.item.modelConfig.extendParams.options.reasoningBudgetToken32k.hint':
    'Для GLM-5 и GLM-4.7; управляет бюджетом токенов для рассуждений (максимум 32k).',
  'providerModels.item.modelConfig.extendParams.options.reasoningBudgetToken80k.hint':
    'Для серии Qwen3; управляет бюджетом токенов для рассуждений (максимум 80k).',
  'providerModels.item.modelConfig.extendParams.options.reasoningEffort.hint':
    'Для моделей OpenAI и других с поддержкой рассуждений; управляет усилиями на рассуждение.',
  'providerModels.item.modelConfig.extendParams.options.textVerbosity.hint':
    'Для серии GPT-5+; управляет подробностью вывода.',
  'providerModels.item.modelConfig.extendParams.options.thinking.hint':
    'Для некоторых моделей Doubao; позволяет модели решать, нужно ли углублённое мышление.',
  'providerModels.item.modelConfig.extendParams.options.thinkingBudget.hint':
    'Для серии Gemini; управляет бюджетом на размышления.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel.hint':
    'Для моделей Gemini 3 Flash Preview; управляет глубиной размышлений.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel2.hint':
    'Для моделей Gemini 3 Pro Preview; управляет глубиной размышлений.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel3.hint':
    'Для моделей Gemini 3.1 Pro Preview; управляет глубиной размышлений с уровнями низкий/средний/высокий.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel4.hint':
    'Для моделей Gemini 3.1 Flash Image; переключает размышления вкл/выкл.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel5.hint':
    'Для Gemini 3.1 Flash-Lite Preview; управляет глубиной мышления с минимальным/низким/средним/высоким уровнями.',
  'providerModels.item.modelConfig.extendParams.options.urlContext.hint':
    'Для серии Gemini; поддерживает предоставление контекста по URL.',
  ...
  'providerModels.item.modelConfig.files.extra':
    'Текущая реализация загрузки файлов является временным решением, предназначенным только для экспериментов. Полноценная поддержка загрузки будет добавлена позже.',
  'providerModels.item.modelConfig.files.title': 'Поддержка загрузки файлов',
  'providerModels.item.modelConfig.functionCall.extra':
    'Эта настройка активирует возможность модели использовать инструменты. Однако фактическая поддержка зависит от самой модели. Пожалуйста, протестируйте самостоятельно.',
  ...
  'providerModels.item.modelConfig.id.extra':
    'Не может быть изменено после создания и будет использоваться как ID модели при вызове AI',
  'providerModels.item.modelConfig.id.placeholder':
    'Введите ID модели, например, gpt-4o или claude-3.5-sonnet',
  'providerModels.item.modelConfig.id.title': 'ID модели',
  'providerModels.item.modelConfig.imageOutput.extra':
    'Эта настройка активирует только возможность генерации изображений. Фактическая поддержка зависит от модели. Пожалуйста, протестируйте.',
  ...
  'providerModels.item.modelConfig.reasoning.extra':
    'Эта настройка активирует способность модели к глубокому мышлению. Эффективность зависит от самой модели. Пожалуйста, протестируйте.',
  'providerModels.item.modelConfig.reasoning.title': 'Поддержка глубокого мышления',
  'providerModels.item.modelConfig.search.extra':
    'Эта настройка активирует встроенный веб-поиск. Поддержка зависит от модели. Пожалуйста, протестируйте.',
  'providerModels.item.modelConfig.search.title': 'Поддержка веб-поиска',
  'providerModels.item.modelConfig.tokens.extra':
    'Установите максимальное количество токенов, поддерживаемое моделью',
  ...
  'providerModels.item.modelConfig.type.extra':
    'Разные типы моделей имеют различные возможности и сценарии использования',
  ...
  'providerModels.item.modelConfig.video.extra':
    'Эта настройка активирует распознавание видео. Поддержка зависит от модели. Пожалуйста, протестируйте.',
  'providerModels.item.modelConfig.video.title': 'Поддержка распознавания видео',
  'providerModels.item.modelConfig.vision.extra':
    'Эта настройка активирует возможность загрузки изображений. Поддержка распознавания зависит от модели. Пожалуйста, протестируйте.',
  ...
  'providerModels.list.disabledActions.sortReleasedAt':
    'Сортировать по дате выпуска (сначала старые)',
  'providerModels.list.disabledActions.sortReleasedAtDesc':
    'Сортировать по дате выпуска (сначала новые)',
  'providerModels.list.empty.desc':
    'Создайте пользовательскую модель или загрузите модель для начала работы.',
  ...
  'providerModels.list.enabledEmpty':
    'Нет включенных моделей. Пожалуйста, включите нужные модели из списка ниже~',
  ...
  'providerModels.list.resetAll.conform':
    'Вы уверены, что хотите сбросить все изменения текущей модели? После сброса список моделей вернется к состоянию по умолчанию.',
  ...
  'updateAiProvider.confirmDelete':
    'Вы собираетесь удалить этого AI-провайдера. После удаления восстановление будет невозможно. Вы уверены?',
  ...
  'vertexai.region.desc':
    'Выберите регион для сервиса Vertex AI. Некоторые модели, такие как Gemini 2.5, доступны только в определенных регионах (например, global)',
