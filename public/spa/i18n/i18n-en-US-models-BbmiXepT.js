const e = {
  ...
  'GLM-5-Turbo.description':
    'GLM-5-Turbo: Optimized version of GLM-5 with faster inference for coding tasks.',
  'GLM-5.description':
  ...
  'Gryphe/MythoMax-L2-13b.description':
    'MythoMax-L2 (13B) is an innovative model for diverse domains and complex tasks.',
  ...
  'Llama-3.2-90B-Vision-Instruct	.description':
    'Advanced image reasoning for visual-understanding agent applications.',
  ...
  'Meta-Llama-3-3-70B-Instruct.description':
    'Llama 3.3 70B is a versatile Transformer model for chat and generation tasks.',
  ...
  'MiniMax-M2.5-Lightning.description':
    'M2.5 Lightning: Same performance, faster and more agile (approx. 100 tps).',
  'MiniMax-M2.5-highspeed.description':
    'MiniMax M2.5 Highspeed: Same performance as M2.5 with faster inference.',
  ...
  'Phi-3-mini-4k-instruct.description':
    'The smallest Phi-3 family member, optimized for quality and low latency.',
  ...
  'QwQ-32B-Preview.description':
    'Qwen QwQ is an experimental research model focused on improving reasoning.',
  ...
  'Qwen/QwQ-32B-Preview.description':
    'Qwen QwQ is an experimental research model focused on improved AI reasoning.',
  ...
  'Qwen/Qwen2.5-72B-Instruct-Turbo.description':
    'Qwen2.5 is a new LLM family optimized for instruction-style tasks.',
  ...
  'Qwen2.5-72B-Instruct.description':
    'LLM for Chinese and English, tuned for language, coding, math, and reasoning.',
  ...
  'SenseChat-Character.description':
    'Standard character chat model with 8K context and high response speed.',
  ...
  'baichuan-m2-32b.description':
    'Baichuan M2 32B is a MoE model from Baichuan Intelligence with strong reasoning.',
  ...
  'black-forest-labs/flux-dev.description':
    'FLUX Dev is the development version of FLUX for non-commercial use.',
  'black-forest-labs/flux-pro.description':
    'FLUX Pro is the professional FLUX model for high-quality image output.',
  'black-forest-labs/flux-schnell.description':
    'FLUX Schnell is a fast image generation model optimized for speed.',
  ...
  'claude-3-5-haiku-latest.description':
    'Claude 3.5 Haiku delivers fast responses for lightweight tasks.',
  ...
  'cohere-command-r-plus.description':
    'Command R+ is an advanced RAG-optimized model built for enterprise workloads.',
  ...
  'command-light.description':
    'A smaller, faster Command variant that is nearly as capable but faster.',
  ...
  'command-r-08-2024.description':
    'command-r-08-2024 is an updated Command R model released in August 2024.',
  ...
  'databricks/dbrx-instruct.description':
    'DBRX Instruct offers highly reliable instruction handling across industries.',
  ...
  'deepseek-r1-distill-llama.description':
    'deepseek-r1-distill-llama is distilled from DeepSeek-R1 on Llama.',
  ...
  'deepseek-r1-distill-qianfan-llama-70b.description':
    'DeepSeek R1 Distill Qianfan Llama 70B is an R1 distill based on Llama-70B.',
  'deepseek-r1-distill-qwen-1.5b.description':
  ...
  'deepseek-r1-distill-qwen.description':
    'deepseek-r1-distill-qwen is distilled from DeepSeek-R1 on Qwen.',
  ...
  'deepseek-v2:236b.description':
    'DeepSeek V2 236B is DeepSeek’s code-focused model with strong code generation.',
...
Fine-tuning on DeepSeek R1 outputs delivers competitive performance with larger frontier models.`,
  ...
  'ernie-4.5-8k-preview.description':
    'ERNIE 4.5 8K Preview is an 8K context preview model for evaluating ERNIE 4.5.',
  ...
  'ernie-x1.1-preview.description':
    'ERNIE X1.1 Preview is a thinking-model preview for evaluation and testing.',
  ...
  'fal-ai/flux-kontext/dev.description':
    'FLUX.1 model focused on image editing, supporting text and image inputs.',
  ...
  'gemini-1.5-pro-001.description':
    'Gemini 1.5 Pro 001 is a scalable multimodal AI solution for complex tasks.',
  ...
  'gemini-2.5-flash-preview-04-17.description':
    'Gemini 2.5 Flash Preview is Google’s best-value model with full capabilities.',
  ...
  'glm-4-flashx.description':
    'GLM-4-FlashX is an enhanced Flash version with ultra-fast reasoning.',
  ...
  'glm-4v-plus.description':
    'GLM-4V-Plus understands video and multiple images, suitable for multimodal tasks.',
  'glm-4v.description':
    'GLM-4V provides strong image understanding and reasoning across visual tasks.',
  'glm-5.description':
  ...
  'glm-z1-air.description':
    'Reasoning model with strong reasoning for tasks that require deep inference.',
  ...
  'google/gemini-2.5-flash-image-preview.description':
    'Gemini 2.5 Flash experimental model with image generation support.',
...
Gemini 2.5 Flash can also be configured via the “max reasoning tokens” parameter as documented (https://openrouter.ai/docs/use-cases/reasoning-tokens#max-tokens-for-reasoning).`,
  ...
  'google/gemma-2-9b-it:free.description':
    'Gemma 2 is Google’s lightweight open-source text model family.',
  ...
  'gpt-35-turbo-16k.description':
    'GPT-3.5 Turbo 16k is a high-capacity text generation model for complex tasks.',
  ...
  'gpt-4-vision-preview.description':
    'GPT-4 Vision preview, designed for image analysis and processing tasks.',
  ...
  'gpt-4o-mini-realtime-preview.description':
    'GPT-4o-mini realtime variant with audio and text real-time I/O.',
  ...
  'gpt-4o-realtime-preview-2024-10-01.description':
    'GPT-4o realtime variant with audio and text real-time I/O.',
  ...
  'hunyuan-vision.description':
    'Hunyuan latest multimodal model supporting image + text inputs to generate text.',
  ...
  'imagen-4.0-fast-generate-001.description':
    'Imagen 4th generation text-to-image model series Fast version',
  ...
  'internvl3-14b.description':
    'InternVL3 14B is a mid-size multimodal model balancing performance and cost.',
  ...
  'llama3-70b-8192.description':
    'Meta Llama 3 70B offers exceptional complexity handling for demanding projects.',
  'llama3-8b-8192.description':
    'Meta Llama 3 8B delivers strong reasoning performance for diverse scenarios.',
  ...
  'megrez-3b-instruct.description':
    'Megrez 3B Instruct is a small, efficient model from Wuwen Xinqiong.',
  ...
  'meta-llama-3-8b-instruct.description':
    'A versatile 8B-parameter model optimized for chat and text generation.',
  'meta-llama-3.1-405b-instruct.description':
    'Llama 3.1 instruction-tuned text model optimized for multilingual chat, performing strongly on common industry benchmarks among open and closed chat models.',
  'meta-llama-3.1-70b-instruct.description':
    'Llama 3.1 instruction-tuned text model optimized for multilingual chat, performing strongly on common industry benchmarks among open and closed chat models.',
  ...
  'meta-llama/Llama-2-70b-hf.description':
    'LLaMA-2 provides strong language handling and a solid interaction experience.',
  'meta-llama/Llama-3-70b-chat-hf.description':
    'Llama 3 70B Instruct Reference is a powerful chat model for complex dialogues.',
  ...
  'meta-llama/Meta-Llama-3-70B-Instruct-Lite.description':
    'Llama 3 70B Instruct Lite is built for high performance with lower latency.',
  ...
  'meta/llama-3.2-90b.description':
    'An instruction-tuned image reasoning model (text+image input, text output) optimized for visual recognition, image reasoning, captioning, and general image QA.',
  'meta/llama-3.3-70b-instruct.description':
    'An advanced LLM strong at reasoning, math, common sense, and function calling.',
  ...
  'ministral-8b-latest.description':
    'Ministral 8B is a highly cost-effective edge model from Mistral.',
  ...
  'mistral-nemo.description':
    'Mistral Nemo is a high-efficiency 12B model from Mistral AI and NVIDIA.',
  ...
  'mistral/mixtral-8x22b-instruct.description':
    '8x22B Instruct model. 8x22B is an open MoE model served by Mistral.',
  ...
  'mistralai/Mistral-7B-Instruct-v0.2.description':
    'Mistral (7B) Instruct v0.2 improves instruction handling and result accuracy.',
  ...
  'mistralai/Mixtral-8x22B-Instruct-v0.1.description':
    'Mixtral-8x22B Instruct (141B) is a very large LLM for heavy workloads.',
  ...
  'mixtral-8x7b-32768.description':
    'Mixtral 8x7B provides fault-tolerant parallel compute for complex tasks.',
  'mixtral.description':
  ...
  'nvidia/llama-3.1-nemotron-51b-instruct.description':
    'A distinctive language model delivering exceptional accuracy and efficiency.',
  ...
  'openai/gpt-4o-mini.description':
    'GPT-4o-mini is a fast, small GPT-4o variant for low-latency multimodal use.',
  ...
  'openai/gpt-5-mini.description':
    'GPT-5 Mini is a smaller GPT-5 variant for low-latency, low-cost scenarios.',
  ...
  'openai/gpt-oss-120b.description':
    'A highly capable general-purpose LLM with strong, controllable reasoning.',
  ...
  'openai/o4-mini.description':
    'OpenAI o4-mini is a small, efficient reasoning model for low-latency scenarios.',
  'openai/text-embedding-3-large.description':
    'OpenAI’s most capable embedding model for English and non-English tasks.',
  'openai/text-embedding-3-small.description':
    'OpenAI’s improved, higher-performance ada embedding model variant.',
  ...
  'oswe-vscode-prime.description':
    'Raptor mini is a preview model optimized for code-related tasks.',
  ...
  'qianfan-vl-70b.description':
    'Qianfan VL 70B is a large VLM for complex image-text understanding.',
  'qianfan-vl-8b.description':
    'Qianfan VL 8B is a lightweight VLM for daily image-text QA and analysis.',
  ...
  'qwen/qwen3-14b.description':
    'Qwen3-14B is the 14B variant for general reasoning and chat scenarios.',
...
Qwen3 significantly outperforms prior models like QwQ and Qwen2.5, delivering excellent math, coding, commonsense reasoning, creative writing, and interactive chat. The Qwen3-30B-A3B variant has 30.5B parameters (3.3B active), 48 layers, 128 experts (8 active per task), and supports up to 131K context with YaRN, setting a new bar for open models.`,
  ...
  'qwen2.5-vl-instruct.description':
    'Qwen2.5-VL is the latest vision-language model in the Qwen family.',
  'qwen2.5.description':
  ...
  'qwen3-30b-a3b.description':
    'Qwen3 30B A3B is a mid-large general model balancing cost and quality.',
  'qwen3-32b.description':
    'Qwen3 32B is suited for general tasks requiring stronger understanding.',
  ...
  'text-embedding-3-large.description':
    'The most capable embedding model for English and non-English tasks.',
  ...
  'thudm/glm-4-32b:free.description':
    'GLM-4-32B-0414 is a 32B bilingual (Chinese/English) open-weights model optimized for code generation, function calling, and agent tasks. It is pretrained on 15T high-quality and reasoning-heavy data and further refined with human preference alignment, rejection sampling, and RL. It excels at complex reasoning, artifact generation, and structured output, reaching GPT-4o and DeepSeek-V3-0324-level performance on multiple benchmarks.',
  'thudm/glm-4-9b-chat.description':
    'The open-source release of Zhipu AI’s latest GLM-4 pretraining model.',
...
It merges pretrained weights to balance reasoning, efficiency, and instruction following. Released under the MIT license for research and commercial use.`,
  ...
  'volcengine/doubao-seed-2-0-mini.description':
    'Points to the latest version of doubao-seed-2-0-mini',
  'volcengine/doubao-seed-2-0-pro.description':
    'Points to the latest version of doubao-seed-2-0-pro',
  ...
  'wan2.5-i2i-preview.description':
    'Wanxiang 2.5 I2I Preview supports single-image editing and multi-image fusion.',
  ...
  'wan2.6-image.description':
    'Wanxiang 2.6 Image supports image editing and mixed image–text layout output.',
  ...
  'yi-lightning.description':
    'A latest high-performance model with faster inference and high-quality output.',
  'yi-medium-200k.description':
    'A 200K long-context model for deep long-form understanding and generation.',
  ...
  'yi-vision.description':
    'A vision model for complex tasks with strong image understanding and analysis.',
