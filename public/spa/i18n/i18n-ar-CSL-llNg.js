...
const _a = {
    ...
    'hotkey.invalidCombination':
      'يجب أن يتضمن الاختصار مفتاح تعديل (Ctrl أو Alt أو Shift) ومفتاح عادي واحد فقط.',
  ...
  Ba = {
    ...
    'channel.concurrencyHint':
      'يقوم الوضع التتابعي بمعالجة الرسائل واحدة تلو الأخرى؛ بينما ينتظر وضع إزالة الارتداد انتهاء دفعة الرسائل قبل المعالجة',
    ...
    'channel.deleteAllConfirmDesc':
      'سيؤدي هذا الإجراء إلى إزالة جميع قنوات الرسائل وتكويناتها لهذا الوكيل بشكل دائم. لا يمكن التراجع عن هذا.',
    ...
    'channel.deleteConfirmDesc':
      'سيؤدي هذا الإجراء إلى إزالة قناة الرسائل وتكوينها بشكل دائم. لا يمكن التراجع عن ذلك.',
    'channel.devWebhookProxyUrl': 'عنوان URL لنفق HTTPS',
    'channel.devWebhookProxyUrlHint':
      'اختياري. عنوان URL لنفق HTTPS لإعادة توجيه طلبات الويب هوك إلى خادم التطوير المحلي.',
    'channel.disabled': 'معطل',
    'channel.discord.description':
      'قم بتوصيل هذا المساعد بخادم Discord للدردشة في القنوات والرسائل المباشرة.',
    ...
    'channel.endpointUrlHint':
      'يرجى نسخ هذا العنوان ولصقه في الحقل <bold>{{fieldName}}</bold> في بوابة مطوري {{name}}.',
    ...
    'channel.settingsResetConfirm':
      'هل أنت متأكد أنك تريد إعادة تعيين الإعدادات المتقدمة إلى الوضع الافتراضي؟',
    ...
    'channel.slack.description':
      'قم بتوصيل هذا المساعد بـ Slack للمحادثات القنوية والرسائل المباشرة.',
    ...
    'channel.wechat.description':
      'قم بتوصيل هذا المساعد بـ WeChat عبر iLink Bot للمحادثات الخاصة والجماعية.',
    ...
    'channel.wechatManagedCredentials':
      'تم توصيل هذه القناة بالفعل من خلال تفويض رمز الاستجابة السريعة. يتم إدارة بيانات الاعتماد تلقائيًا.',
    'channel.wechatQrExpired':
      'انتهت صلاحية رمز الاستجابة السريعة. يرجى التحديث للحصول على رمز جديد.',
    ...
    'channel.wechatTips':
      'يرجى تحديث تطبيق WeChat إلى أحدث إصدار وإعادة تشغيله. يتم طرح إضافة ClawBot تدريجيًا، لذا تحقق من الإعدادات > الإضافات لتأكيد الوصول.',
  ...
  Ua = {
    'avatar.sizeExceeded': 'يتجاوز حجم الصورة الرمزية الحد المسموح به',
    'backgroundColor.title': 'لون الخلفية',
    'name.placeholder': 'أدخل اسم المجموعة',
  },
  Lo = Object.freeze(
  ...
  Ha = {
    ...
    'authModal.description':
      'انتهت صلاحية جلسة تسجيل الدخول الخاصة بك. يرجى تسجيل الدخول مرة أخرى لمتابعة استخدام ميزات مزامنة السحابة.',
    ...
    'betterAuth.signin.continueWithCloudflareZeroTrust':
      'تسجيل الدخول باستخدام Cloudflare Zero Trust',
    ...
    'betterAuth.signin.invalidReferralCodeContent':
      'رمز الإحالة "{{code}}" الذي استخدمته غير صالح أو منتهي الصلاحية. هل ترغب في المتابعة؟',
    'betterAuth.signin.invalidReferralCodeTitle': 'رمز إحالة غير صالح',
    'betterAuth.signin.lastUsed': 'آخر استخدام',
    ...
    'betterAuth.signin.magicLinkSent':
      'تم إرسال رابط تسجيل الدخول، يرجى التحقق من بريدك الإلكتروني',
    ...
    'betterAuth.signin.socialOnlyHint':
      'تم تسجيل هذا البريد الإلكتروني عبر حساب اجتماعي تابع لطرف ثالث. سجّل الدخول باستخدام ذلك المزود، أو',
    'betterAuth.signin.ssoOnlyNoProviders':
      'تم تعطيل التسجيل عبر البريد الإلكتروني ولم يتم تكوين أي موفري تسجيل دخول موحد (SSO). يرجى التواصل مع المسؤول.',
    ...
    'betterAuth.signup.invalidReferralCodeContent':
      'رمز الإحالة "{{code}}" الذي أدخلته غير صالح أو منتهي الصلاحية. هل ترغب في المتابعة؟',
    ...
    'betterAuth.verifyEmail.checkSpam':
      'إذا لم يصلك البريد الإلكتروني، يرجى التحقق من مجلد الرسائل غير المرغوب فيها',
    ...
    'betterAuth.verifyEmail.resend.success':
      'تمت إعادة إرسال رسالة التحقق. يرجى التحقق من بريدك الوارد.',
    'betterAuth.verifyEmail.title': 'تحقق من بريدك الإلكتروني',
    'date.prevMonth': 'الشهر الماضي',
    'date.recent30Days': 'آخر 30 يومًا',
    'footer.agreement':
      'بالمتابعة، فإنك تؤكد أنك قرأت ووافقت على <terms>الشروط والأحكام</terms> و<privacy>سياسة الخصوصية</privacy>',
    ...
    'profile.authorizations.revoke.description':
      'بعد الإلغاء، لن يتمكن الأداة من الوصول إلى بياناتك. ستحتاج إلى إعادة التفويض لاستخدامها مرة أخرى.',
    ...
    'profile.emailChangeSuccess':
      'تم إرسال بريد التحقق. يرجى التحقق من صندوق الوارد للبريد الإلكتروني الجديد.',
    ...
    'profile.sso.unlink.description':
      'ستحتاج إلى إعادة التفويض أو الربط لتسجيل الدخول باستخدام {{provider}} مرة أخرى بعد إلغاء الربط.',
    ...
    'profile.updateEmail': 'تحديث البريد الإلكتروني',
  ...
  ja = {
    ...
    'codes.DELETED_ACCOUNT_EMAIL':
      'تم ربط هذا البريد الإلكتروني بحساب محذوف ولا يمكن استخدامه للتسجيل',
    ...
    'codes.EMAIL_NOT_FOUND':
      'لا يوجد بريد إلكتروني مرتبط بهذا الحساب. يرجى التحقق مما إذا كان حسابك مرتبطًا ببريد إلكتروني.',
    ...
    'codes.USER_ALREADY_EXISTS_USE_ANOTHER_EMAIL':
      'البريد الإلكتروني مستخدم بالفعل، يرجى تجربة بريد آخر',
  ...
  g = 'قمنا بإضافة ميزات جديدة أثناء غيابك.',
  b = 'عرض جميع سجلات التغييرات',
  h = 'ابقَ على اطلاع بآخر الميزات والتحسينات في {{appName}}',
  f = 'اقرأ التفاصيل',
  y = 'سجل التغييرات',
  v = 'تفاصيل الإصدار',
  k = 'مرحبًا بعودتك!',
  ...
  S = 'نشط',
  A = `مرحبًا، أنا **{{name}}**. جملة واحدة تكفي.

هل ترغب في أن أتناسب مع سير عملك بشكل أفضل؟ انتقل إلى [إعدادات الوكيل]({{url}}) واملأ ملف تعريف الوكيل (يمكنك تعديله في أي وقت).`,
  w = 'مرحبًا، أنا **{{name}}**. جملة واحدة تكفي — أنت المتحكم.',
  C = 'مرحبًا، أنا **{{name}}**. جملة واحدة تكفي — أنت المتحكم.',
  M = 'الوكلاء',
  P = 'الوكلاء المتاحون',
  T = 'الانتقال إلى الأحدث',
  I = 'المساعد المدمج',
  D = 'مسح رسائل الجلسة الحالية',
  x = 'السجل المضغوط',
  F = 'أنت على وشك مسح رسائل الجلسة الحالية. بمجرد المسح، لا يمكن استعادتها. يرجى تأكيد الإجراء.',
  N =
    'سيتم حذف هذه المجموعة. سيتم أيضًا حذف المساعدين الخاصين بالمجموعة، بينما لن يتأثر المساعدون الخارجيون.',
  E =
    'أنت على وشك حذف هذه المجموعة. بعد الحذف، سيتم نقل وكلائها إلى القائمة الافتراضية. يرجى تأكيد الإجراء.',
  R = 'تم حذف المجموعة بنجاح',
  O = 'أنت على وشك حذف هذا الوكيل. بمجرد الحذف، لا يمكن استعادته. يرجى تأكيد الإجراء.',
  L = 'تم حذف الوكيل بنجاح',
  G = 'الوكيل الافتراضي',
  _ = 'مجموعة',
  B = 'القائمة الافتراضية',
  U = 'الوكيل الافتراضي',
  H = 'نسخة {{title}}',
  j = 'لا يوجد وكلاء بعد. ابدأ بأول وكيل لك — وابنِ نظامك بمرور الوقت.',
  q = 'إنشاء وكيل',
  z = 'وصف المجموعة',
  W = "محتوى الرسائل الخاصة مخفي. يرجى تفعيل 'عرض محتوى الرسائل الخاصة' في الإعدادات لعرضه.",
  $ = 'نطاق السجل',
  J = 'ملخص الرسائل السابقة',
  V = 'غير نشط',
  K = 'دعوة الأعضاء',
  Q = 'الأعضاء',
  X = 'إنشاء وكيل',
  Y = 'إنشاء مجموعة',
  Z = 'إنشاء صفحة',
  ee = 'لا يوجد أعضاء في هذه المجموعة بعد. انقر على زر + لدعوة وكلاء.',
  te = 'لا يوجد أعضاء متاحون للدعوة',
  ie = 'لم يتم العثور على أعضاء مطابقين',
  ae = 'لا تحتوي هذه المجموعة على أي أعضاء بعد. انقر على زر + لدعوة وكلاء.',
  oe = 'لم يتم تحديد أي أعضاء بعد',
  se = 'فتح في نافذة جديدة',
  ne = 'مالك المجموعة',
  re = 'تثبيت',
  le = 'إلغاء التثبيت',
  ce = 'إعادة التوليد',
  de = 'ملف الوكيل وسجل المحادثات',
  pe = 'البحث عن وكلاء...',
  ue = 'البحث عن وكلاء...',
  me = 'الوكلاء المحددون',
  ge = 'اطرح سؤالًا، أنشئ، أو ابدأ مهمة، <hotkey><hotkey/>',
  be =
    'تمت مشاركة هذا المحتوى من قبل مستخدم ولا يعبر عن آراء LobeHub. لا تتحمل LobeHub أي مسؤولية عن أي نتائج ناتجة عن هذا المحتوى المشترك.',
  he = 'وكيل بدون اسم',
  fe = 'مجموعة بدون اسم',
  ye = 'تحديث معلومات الوكيل',
  ve = 'أنت',
  ke = 'وضع التركيز',
  za = {
    ...
    'agentBuilder.installPlugin.clickApproveToConnect':
      'انقر على "موافقة" للاتصال وتفويض هذا التكامل',
    ...
    'agentBuilder.installPlugin.connectionFailed':
      'فشل الاتصال. أعد المحاولة أو تحقق من التفويض وإعدادات الشبكة.',
    'agentBuilder.installPlugin.installFailed':
      'فشل التثبيت. أعد المحاولة أو اعرض التفاصيل وحاول مرة أخرى.',
...
كتابة، برمجة، أو تحليل بيانات — أي شيء يناسبك. أنت تملك الهدف والمعايير؛ سأقوم بتقسيمها إلى وكلاء تعاونيين قابلين للتنفيذ.`,
    ...
    'artifact.inThread':
      'لا يمكن العرض في الموضوع الفرعي، يرجى التبديل إلى منطقة المحادثة الرئيسية للفتح',
    ...
    'compression.cancelConfirm':
      'هل أنت متأكد أنك تريد إلغاء الضغط؟ سيؤدي ذلك إلى استعادة الرسائل الأصلية.',
    ...
    'extendParams.disableContextCaching.desc':
      'قلل تكلفة إنشاء محادثة واحدة بنسبة تصل إلى 90٪ وزد السرعة حتى 4 أضعاف. <1>اعرف المزيد</1>',
    'extendParams.disableContextCaching.title': 'تفعيل تخزين السياق المؤقت',
    'extendParams.effort.desc':
      'تحكم في عدد الرموز التي يستخدمها كلود عند الرد باستخدام معلمة الجهد.',
    'extendParams.effort.title': 'الجهد',
    'extendParams.enableAdaptiveThinking.desc':
      'اسمح لكلود باتخاذ قرارات ديناميكية حول متى وكم يفكر باستخدام وضع التفكير التكيفي.',
    'extendParams.enableAdaptiveThinking.title': 'تفعيل التفكير التكيفي',
    'extendParams.enableReasoning.desc':
      'استنادًا إلى حد آلية التفكير في Claude. <1>اعرف المزيد</1>',
    ...
    'extendParams.urlContext.desc':
      'عند التفعيل، سيتم تحليل الروابط تلقائيًا لاستخراج محتوى صفحة الويب الفعلي',
    ...
    'group.profile.contentPlaceholder':
      'قم بتحديد أهداف المجموعة/طرق العمل هنا. سيتم مشاركة هذه المعلومات مع جميع أعضاء المجموعة.',
    'group.profile.external': 'خارجي',
    'group.profile.externalAgentWarning':
      'هذا وكيل خارجي. أي تغييرات يتم إجراؤها هنا ستُعدل مباشرة إعدادات الوكيل الأصلية.',
    'group.profile.groupSettings': 'إعدادات المجموعة',
    'group.profile.supervisor': 'المشرف',
    'group.profile.supervisorPlaceholder':
      'يقوم المشرف بتنسيق عمل الوكلاء المختلفين. تعيين معلومات المشرف هنا يتيح تنسيقًا أدق لسير العمل.',
    ...
    'knowledgeBase.disabled':
      'دردشة المكتبة غير متاحة في هذا النشر. يرجى التبديل إلى قاعدة بيانات على الخادم أو استخدام {{cloud}}.',
    ...
    'messages.modelCard.creditTooltip':
      'لأغراض العد، نعتبر 1 دولار = 1 مليون رصيد. مثال: 3 دولارات/مليون رموز → 3 أرصدة لكل رمز.',
    'messages.modelCard.pricing.inputCachedTokens':
      'المدخلات المخزنة {{amount}} أرصدة · ${{amount}}/مليون',
    ...
    'messages.modelCard.pricing.writeCacheInputTokens':
      'كتابة إلى التخزين المؤقت {{amount}} أرصدة · ${{amount}}/مليون',
    ...
    'messages.tokenDetails.speed.tps.tooltip':
      'الرموز في الثانية (TPS). يشير إلى متوسط سرعة المحتوى الذي يولده الذكاء الاصطناعي (رموز/ثانية)، محسوبًا من لحظة استلام أول رمز.',
    'messages.tokenDetails.speed.ttft.title': 'TTFT',
    'messages.tokenDetails.speed.ttft.tooltip':
      'الوقت لأول رمز (TTFT). يشير إلى الفترة الزمنية من إرسال الرسالة إلى استلام أول رمز من العميل.',
...
اكتب مسودة أو أعد الصياغة أو حسّن—أخبرني بنيتك وسأتولى الباقي.`,
    ...
    'prompts.summaryExpert':
      'بصفتك خبيرًا في التلخيص، يرجى تلخيص المحتوى التالي بناءً على التعليمات أعلاه:',
    ...
    'search.searchModel.desc':
      'النموذج الحالي لا يدعم استدعاء الوظائف، لذا يجب إقرانه بنموذج يدعم ذلك للبحث عبر الإنترنت.',
    ...
    'sessionGroup.confirmRemoveGroupAlert':
      'سيتم حذف هذه المجموعة. بعد الحذف، سيتم نقل الوكلاء إلى القائمة الافتراضية. يرجى تأكيد العملية.',
    ...
    'shareModal.popover.privacyWarning.content':
      'يرجى التأكد من أن محادثتك لا تحتوي على أي معلومات شخصية أو حساسة. أنت المسؤول عن أي محتوى تختار مشاركته وما يترتب عليه من نتائج.',
    ...
    'tool.intervention.rejectReasonPlaceholder':
      'سيساعد السبب الوكيل على فهم حدودك وتحسين التصرفات المستقبلية',
    ...
    'toolAuth.hint':
      'بدون التفويض أو الإعداد، قد لا تعمل المهارات. قد يؤدي ذلك إلى تقييد الوكيل أو حدوث أخطاء.',
    ...
    'upload.action.imageDisabled':
      'النموذج الحالي لا يدعم التعرف البصري. يرجى التبديل إلى نموذج آخر لاستخدام هذه الميزة.',
    ...
    'upload.clientMode.disabled':
      'النموذج الحالي لا يدعم التعرف البصري وتحليل الملفات. يرجى التبديل إلى نموذج آخر لاستخدام هذه الميزة.',
    ...
    'upload.clientMode.visionNotSupported':
      'النموذج الحالي لا يدعم التعرف البصري. يرجى التبديل إلى نموذج مختلف لاستخدام هذه الميزة.',
    ...
    'upload.validation.videoSizeExceeded':
      'يجب ألا يتجاوز حجم ملف الفيديو 20 ميغابايت. الحجم الحالي هو {{actualSize}}.',
  ...
  _e = 'حول',
  Be = 'الإعدادات المتقدمة',
  Ue = 'محدث بالفعل',
  He = 'إكمال تلقائي',
  je = 'إكمال الوصف تلقائيًا من ملف تعريف الوكيل',
  qe = 'أضف ملف تعريف وكيل أولاً لاستخدام الإكمال التلقائي',
  ze = 'رجوع',
  We = 'حذف جماعي',
  $e = 'مدونة المنتج',
  Je = 'إنشاء موضوع فرعي',
  Ve =
    'ميزة "الموضوع الفرعي" غير متاحة في الوضع الحالي. لاستخدام هذه الميزة، يرجى التبديل إلى وضع قاعدة بيانات Postgres/Pglite أو استخدام LobeHub Cloud.',
  Ke = 'الموضوع الحالي غير محفوظ، يرجى حفظه أولاً لاستخدام ميزة الموضوع الفرعي',
  Qe = 'إلغاء',
  Xe = 'سجل التغييرات',
  Ye = 'تحقق من التحديثات',
  Ze = 'إغلاق',
  et = 'تأكيد',
  tt = 'اتصل بنا',
  it = 'نسخ',
  ...
  rt = 'دليل المستخدم',
  lt = 'تنزيل',
  ct = 'جارٍ تنزيل {{percent}}%',
  dt = 'تكرار',
  pt = 'تعديل',
  ut = 'ملاحظات',
  mt = 'تابعنا على {{name}}',
  gt = 'وضع ملء الشاشة',
  bt = 'احصل على تطبيق سطح المكتب',
  ht = 'نطاق السجل',
  ft = 'استيراد البيانات',
  yt = 'المجتمع والأخبار',
  vt = 'تثبيت تطبيق المتصفح',
  kt = 'المختبرات',
  St = 'جارٍ تحميل التخطيط...',
  At = 'إخلاء المسؤولية القانونية',
  wt = 'جارٍ التحميل...',
  Ct = 'المزيد',
  Mt = 'لا يوجد محتوى',
  Pt = 'تسجيل الدخول الموحد',
  Tt = 'الموقع الرسمي',
  It = 'موافق',
  Dt = 'أو',
  xt = '{{count}} عنصر',
  ...
  $a = {
    ...
    'alert.cloud.desc':
      'جميع المستخدمين المسجلين يحصلون على {{credit}} من أرصدة الحوسبة المجانية شهريًا — دون الحاجة إلى إعداد. يشمل المزامنة السحابية العالمية والبحث المتقدم على الويب.',
    'alert.cloud.descOnMobile':
      'جميع المستخدمين المسجلين يحصلون على {{credit}} من أرصدة الحوسبة المجانية شهريًا — دون الحاجة إلى إعداد.',
    ...
    'appLoading.failed':
      'حدث خطأ أثناء بدء التشغيل. اعرض التفاصيل لاستكشاف الأخطاء، أو حاول مرة أخرى لاحقًا.',
    ...
    'clientDB.error.desc':
      'فشل تهيئة PGlite. حاول مرة أخرى أولاً. إذا لم تنجح، افتح الإصلاحات الذاتية واتبع الخطوات. لا تزال تواجه مشكلة؟ استخدم خيار الإبلاغ عن المشكلة لإرسال تفاصيل الخطأ.',
    ...
    'clientDB.modal.desc':
      'فعّل قاعدة البيانات العميلة من الجيل التالي. احفظ بيانات الدردشة في متصفحك وافتح ميزات متقدمة مثل المكتبة.',
    'clientDB.modal.enable': 'فعّل الآن',
    'clientDB.modal.features.knowledgeBase.desc':
      'أنشئ مكتبتك الشخصية وتحدث مع الوكلاء باستخدامها (قريبًا).',
    'clientDB.modal.features.knowledgeBase.title': 'دردشة المكتبة — عقلك الثاني',
    'clientDB.modal.features.localFirst.desc':
      'يتم تخزين بيانات الدردشة بالكامل في المتصفح، مما يحافظ على خصوصيتك وتحكمك الكامل.',
    'clientDB.modal.features.localFirst.title': 'محلي أولاً، خصوصية أولاً',
    'clientDB.modal.features.pglite.desc':
      'مبني على PGlite، مع دعم مدمج لميزات متقدمة مثل البحث الشعاعي',
    'clientDB.modal.features.pglite.title': 'بنية تخزين عميل من الجيل التالي',
    'clientDB.modal.init.desc':
      'يتم تهيئة قاعدة البيانات. قد يستغرق ذلك من 5 إلى 30 ثانية حسب جهازك وشبكتك. يمكنك القيام بشيء آخر والعودة لاحقًا.',
    ...
    'clientDB.solve.backup.exportDesc':
      'سيتم حفظ البيانات المصدرة بصيغة JSON، ويمكن استخدامها للاستعادة أو التحليل لاحقًا.',
    'clientDB.solve.backup.reset.alert': 'تحذير',
    'clientDB.solve.backup.reset.alertDesc':
      'قد تؤدي الإجراءات التالية إلى حذف البيانات. قم بالنسخ الاحتياطي أولاً — القرار لك.',
    ...
    'clientDB.solve.backup.reset.confirm.desc':
      'سيؤدي هذا الإجراء إلى حذف جميع البيانات ولا يمكن التراجع عنه. هل تؤكد المتابعة؟',
    'clientDB.solve.backup.reset.confirm.title': 'تأكيد إعادة تعيين قاعدة البيانات',
    'clientDB.solve.backup.reset.desc':
      'أعد تعيين قاعدة البيانات في حال حدوث ترحيل غير قابل للاسترداد',
    ...
    'cmdk.keywords.about': 'حول معلومات الإصدار',
    'cmdk.keywords.apikey': 'مفتاح api رمز التوكن',
    'cmdk.keywords.appearance': 'المظهر العام السمة العرض',
    'cmdk.keywords.billing': 'الفوترة الدفع الفاتورة المعاملة',
    'cmdk.keywords.community': 'اكتشف السوق المساعد النموذج المزود mcp',
    'cmdk.keywords.contactUs': 'ملاحظات مشكلة خلل عطل',
    'cmdk.keywords.discord': 'ديسكورد المساعدة الدعم خدمة العملاء',
    'cmdk.keywords.funds': 'الأموال الرصيد الائتمان النقود',
    'cmdk.keywords.hotkey': 'اختصار مفتاح سريع لوحة المفاتيح',
    'cmdk.keywords.image': 'صورة صورة فوتوغرافية',
    'cmdk.keywords.memory': 'الهويات السياقات التفضيلات التجارب',
    'cmdk.keywords.pages': 'مستندات كتابة ملاحظات',
    'cmdk.keywords.painting': 'رسم فن توليد رسم',
    'cmdk.keywords.plans': 'الاشتراك الخطة الترقية التسعير',
    'cmdk.keywords.profile': 'الملف الشخصي المستخدم الحساب الشخصي',
    'cmdk.keywords.provider': 'مزود نموذج llm ذكاء اصطناعي',
    'cmdk.keywords.proxy': 'بروكسي الشبكة الاتصال',
    'cmdk.keywords.referral': 'إحالة مكافآت دعوة بونص',
    'cmdk.keywords.resources': 'معرفة ملفات مكتبة مستندات',
    'cmdk.keywords.settings': 'الإعدادات التفضيلات التهيئة الخيارات',
    ...
    'cmdk.search.chatGroup': 'فريق الوكلاء',
    'cmdk.search.chatGroups': 'فرق الوكلاء',
    ...
    'cmdk.search.knowledgeBase': 'المكتبة',
    'cmdk.search.knowledgeBases': 'المكتبات',
    'cmdk.search.loading': 'يتم البحث...',
    'cmdk.search.market': 'المجتمع',
    'cmdk.search.mcp': 'خادم MCP',
    'cmdk.search.mcps': 'خوادم MCP',
    'cmdk.search.memories': 'الذكريات',
    'cmdk.search.memory': 'الذاكرة',
    ...
    'footer.feedback.desc':
      'أفكارك تساعدنا على تحسين {{appName}}. شاركنا اقتراحاتك أو ملاحظاتك حول تجربة الاستخدام وسنتولى الأمر.',
    ...
    'importModal.error.desc':
      'عذرًا، حدث خطأ أثناء عملية استيراد البيانات. يرجى المحاولة مرة أخرى، أو <1>إرسال طلب</1> وسنساعدك في حل المشكلة في أقرب وقت ممكن.',
    ...
    'serverVersionOutdated.warning':
      'قد لا تعمل بعض الميزات بشكل صحيح أو قد تتصرف بشكل غير متوقع. يُرجى تحديث الخادم للحصول على أفضل تجربة.',
    'setting': Wt,
    'share': $t,
    'stop': Jt,
    'switch': 'تبديل',
    ...
    'sync.disabled.desc':
      'يتم تخزين بيانات الجلسة الحالية فقط في هذا المتصفح. إذا كنت بحاجة إلى مزامنة البيانات عبر أجهزة متعددة، يرجى تهيئة وتمكين المزامنة السحابية.',
    ...
    'sync.unconnected.tip':
      'فشل الاتصال بخادم الإشارة، ولا يمكن إنشاء قناة اتصال من نظير إلى نظير. يرجى التحقق من الشبكة والمحاولة مرة أخرى.',
    'tab.audio': 'الصوت',
    'tab.chat': 'الدردشة',
    ...
    'telemetry.deny': 'رفض',
    'telemetry.desc':
      'نود جمع معلومات الاستخدام بشكل مجهول لمساعدتنا في تحسين {{appName}} وتقديم تجربة أفضل لك. يمكنك تعطيل هذا في أي وقت من خلال الإعدادات - حول.',
  ...
  Ja = {
    ...
    'FileManager.actions.chunkingTooltip':
      'تقسيم الملف إلى أجزاء نصية متعددة وتضمينها للبحث الدلالي والحوار مع الملف.',
    'FileManager.actions.chunkingUnsupported': 'هذا الملف لا يدعم التجزئة.',
    'FileManager.actions.confirmDelete':
      'أنت على وشك حذف هذا الملف. لا يمكن استعادته بعد الحذف. يرجى تأكيد الإجراء.',
    'FileManager.actions.confirmDeleteAllFiles':
      'أنت على وشك حذف جميع النتائج في العرض الحالي. بمجرد حذفها، لا يمكن استعادتها. يرجى تأكيد الإجراء.',
    'FileManager.actions.confirmDeleteFolder':
      'أنت على وشك حذف هذا المجلد وجميع محتوياته. لا يمكن التراجع عن هذا الإجراء. يرجى تأكيد القرار.',
    'FileManager.actions.confirmDeleteMultiFiles':
      'أنت على وشك حذف {{count}} ملفًا محددًا. لا يمكن استعادتها بعد الحذف. يرجى تأكيد الإجراء.',
    'FileManager.actions.confirmRemoveFromLibrary':
      'أنت على وشك إزالة {{count}} ملف/ملفات محددة من المكتبة. ستظل متاحة في جميع الملفات. أكد للمتابعة.',
    ...
    'FileParsingStatus.chunks.embeddingStatus.empty':
      'لم يتم تضمين جميع أجزاء النص، مما يجعل ميزة البحث الدلالي غير متاحة. لتحسين جودة البحث، يرجى تضمين أجزاء النص.',
    'FileParsingStatus.chunks.embeddingStatus.error': 'فشل في التضمين',
    'FileParsingStatus.chunks.embeddingStatus.errorResult':
      'فشل في التوجيه الشعاعي، يرجى التحقق والمحاولة مرة أخرى. تفاصيل الخطأ:',
    ...
    'FileParsingStatus.chunks.status.errorResult':
      'فشل في التجزئة، يرجى التحقق والمحاولة مرة أخرى. تفاصيل الخطأ:',
    'FileParsingStatus.chunks.status.processing': 'جارٍ التجزئة',
    'FileParsingStatus.chunks.status.processingTip':
      'الخادم يقوم بتقسيم أجزاء النص؛ إغلاق الصفحة لن يؤثر على تقدم التجزئة.',
    ...
    'ImageUpload.actions.dropMultipleFiles':
      'تحميل ملفات متعددة غير مدعوم؛ سيتم استخدام الملف الأول فقط',
    ...
    'ImageUpload.validation.imageAspectRatioInvalid':
      'نسبة العرض إلى الارتفاع للصورة {{fileName}} ({{actualRatio}}) خارج النطاق المطلوب: {{range}}',
    'ImageUpload.validation.imageDimensionTooLarge':
      'الصورة {{fileName}} ({{width}}x{{height}}) كبيرة جدًا، الحد الأقصى المطلوب: {{maxDimension}}',
    'ImageUpload.validation.imageDimensionTooSmall':
      'الصورة {{fileName}} ({{width}}x{{height}}) صغيرة جدًا، الحد الأدنى المطلوب: {{minDimension}}',
    ...
    'ModelSelect.featureTag.custom':
      'نموذج مخصص، يدعم افتراضيًا استدعاء الوظائف والتعرف البصري. يرجى التحقق من توفر هذه القدرات حسب الحالة الفعلية.',
    ...
    'MultiImagesUpload.validation.fileSizeExceededDetail':
      '{{fileName}} ({{actualSize}}) يتجاوز الحد الأقصى المسموح به وهو {{maxSize}}',
    'MultiImagesUpload.validation.fileSizeExceededMultiple':
      '{{count}} ملف(ات) تتجاوز الحد الأقصى المسموح به وهو {{maxSize}}: {{fileList}}',
    ...
    'OllamaSetupGuide.cors.description':
      'بسبب قيود أمان المتصفح، تحتاج إلى تكوين إعدادات الوصول عبر النطاقات ليعمل Ollama بشكل صحيح.',
    'OllamaSetupGuide.cors.linux.env':
      'أضف `Environment` ضمن قسم [Service]، وقم بتعيين متغير البيئة OLLAMA_ORIGINS:',
    ...
    'OllamaSetupGuide.cors.macos':
      "يرجى فتح تطبيق 'Terminal'، ولصق الأمر التالي، ثم الضغط على Enter لتنفيذه.",
    ...
    'OllamaSetupGuide.cors.windows':
      "في Windows، انقر على 'لوحة التحكم' واذهب إلى تحرير متغيرات بيئة النظام. أنشئ متغير بيئة جديد باسم 'OLLAMA_ORIGINS' لحساب المستخدم الخاص بك، واجعل القيمة *، ثم انقر على 'موافق/تطبيق' للحفظ.",
    'OllamaSetupGuide.install.description':
      'يرجى التأكد من أنك قمت بتشغيل Ollama. إذا لم تقم بتنزيله بعد، يرجى زيارة الموقع الرسمي لـ<1>تحميله</1>.',
    'OllamaSetupGuide.install.docker':
      'إذا كنت تفضل استخدام Docker، فإن Ollama يوفر أيضًا صورة Docker رسمية يمكنك سحبها باستخدام الأمر التالي:',
    'OllamaSetupGuide.install.linux.command': 'قم بالتثبيت باستخدام الأمر التالي:',
    'OllamaSetupGuide.install.linux.manual':
      'بدلاً من ذلك، يمكنك الرجوع إلى <1>دليل التثبيت اليدوي لنظام Linux</1>.',
  ...
  Va = {
    ...
    'screen3.description':
      'امنح الأذونات لفتح الإمكانات الكاملة للوكلاء والمجموعات. يمكنك إدارة هذه الأذونات في أي وقت من الإعدادات.',
    'screen3.permissions.1.description':
      'تلقي الإشعارات عند اكتمال المهام، أو استجابة الوكلاء، أو وصول التحديثات المهمة',
    'screen3.permissions.1.title': 'الإشعارات',
    'screen3.permissions.2.description':
      'الوصول إلى الملفات والمجلدات لتمكين تحليل المستندات، وإنشاء قواعد المعرفة، وسير عمل معالجة الملفات',
    'screen3.permissions.2.title': 'الوصول إلى الملفات',
    'screen3.permissions.3.description':
      'التقاط محتوى الشاشة والصوت للتفاعل الصوتي، وتحليل الشاشة، والمساعدة متعددة الوسائط',
    'screen3.permissions.3.title': 'الشاشة والصوت',
    'screen3.permissions.4.description':
      'تمكين الأتمتة على مستوى النظام لتنفيذ سير العمل بسلاسة عبر التطبيقات',
    ...
    'screen4.description':
      'اختر كيف تريد مشاركة البيانات. يساعدنا اختيارك على التحسين، ويمكنك تغيير ذلك في أي وقت من الإعدادات.',
    'screen4.footerNote': 'يمكنك تغيير ذلك في أي وقت من الإعدادات',
    'screen4.navigation.next': 'متابعة',
    'screen4.privacy.description':
      'عطّل تحليلات الاستخدام المجهّلة. لا تتم مشاركة بيانات الأداء أو استخدام النماذج أو تفاعلات الميزات.',
    ...
    'screen4.share.description':
      'شارك بيانات استخدام مجهولة المصدر لمساعدتنا في تحسين LobeHub. يساعدنا ذلك على فهم كيفية استخدام الوكلاء وتحسينهم.',
    ...
    'screen5.description':
      'سجّل الدخول لمزامنة الوكلاء والمجموعات والإعدادات والسياق عبر جميع الأجهزة.',
    ...
    'screen5.methods.cloud.description':
      'سجّل الدخول باستخدام حساب LobeHub Cloud الخاص بك لمزامنة كل شيء بسلاسة',
  ...
  zo = Object.freeze(
    Object.defineProperty(
      { __proto__: null, back: ei, default: Va, next: ti },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ii = 'العودة إلى الاكتشاف',
  ai = 'مسح الفلاتر',
  oi = 'إنشاء',
  si = 'عدم الإعجاب',
  ni = 'تصفية',
  ...
  Ka = {
    ...
    'assistant.underReview': 'قيد المراجعة',
    ...
    'assistants.conversation.l1':
      'مرحبًا، أنا **{{name}}**. شاركني هدفك أو السياق وسنتعاون من هنا.',
    ...
    'assistants.details.capabilities.knowledge.desc':
      'يتضمن هذا الوكيل المكتبات التالية للمساعدة في الإجابة على المزيد من الأسئلة.',
    'assistants.details.capabilities.knowledge.title': 'المكتبة',
    'assistants.details.capabilities.plugin.desc':
      'يتضمن هذا الوكيل المهارات التالية لمساعدتك في إنجاز المزيد من المهام.',
    ...
    'assistants.duplicateAdd.content':
      '“{{title}}” موجود بالفعل في وكلائك. هل ترغب في إضافة نسخة أخرى؟',
    ...
    'assistants.sorts.mostUsage': 'الأكثر استخدامًا',
    'assistants.sorts.recommended': 'موصى به',
    'assistants.sorts.updatedAt': 'تم التحديث مؤخرًا',
    'assistants.status.archived.reasons.official':
      'قامت المنصة بإزالة هذا الوكيل لأسباب تتعلق بالأمان أو السياسات أو غيرها.',
    ...
    'assistants.status.support':
      'لأي استفسارات، يرجى نسخ الرابط وإرساله إلى <email>support@lobehub.com</email> للحصول على المساعدة.',
    'assistants.status.unpublished.subtitle':
      'هذا الوكيل قيد المراجعة. لتأكيد حالته، انسخ الرابط وأرسله إلى <email>support@lobehub.com</email>.',
    ...
    'createGuide.func1.desc1':
      'في المحادثة، افتح إعدادات الوكيل من القائمة في الزاوية العلوية اليمنى.',
    ...
    'createGuide.func2.desc':
      'لإضافة وكيل إلى الفهرس، أنشئ إدخالًا في `plugins/` باستخدام `agent-template.json` أو `agent-template-full.json`، أضف وصفًا قصيرًا وعلامات، ثم افتح طلب سحب.',
    ...
    'footer.desc':
      'تطوّر مع مستخدمي الذكاء الاصطناعي حول العالم. كن منشئًا وشارك وكلاءك ومهاراتك في مجتمع LobeHub.',
    ...
    'home.recommendAgents': 'الوكلاء الموصى بهم',
    'home.recommendEmpty': 'لا توجد توصيات متاحة',
    'home.recommendGroups': 'المجموعات الموصى بها',
    'home.recommendWritingAgents': 'وكلاء الكتابة',
    'isClaimed': ri,
    'isFeatured': li,
    'isOfficial': ci,
    'like': di,
    ...
    'mcp.categories.discover.description': 'خوادم MCP الموصى بها والرائجة',
    'mcp.categories.discover.name': 'استكشاف',
    ...
    'mcp.details.agents.networkError':
      'فشل في تحميل البيانات. تحقق من الاتصال بالشبكة وحاول مرة أخرى.',
    'mcp.details.agents.title': 'الوكلاء الذين يستخدمون هذه المهارة',
    'mcp.details.connectionType.hybrid.desc':
      'يمكن تشغيل هذه الخدمة محليًا أو عبر السحابة حسب الإعداد أو سيناريو الاستخدام، مما يوفر إمكانية التشغيل المزدوج.',
    'mcp.details.connectionType.hybrid.title': 'خدمة هجينة',
    'mcp.details.connectionType.local.desc':
      'يمكن تشغيل هذا الخادم فقط على جهاز المستخدم المحلي، ويتطلب التثبيت ويعتمد على الموارد المحلية.',
    'mcp.details.connectionType.local.title': 'خدمة محلية',
    'mcp.details.connectionType.remote.desc':
      'يتم استضافة هذا الخادم عن بُعد لأنه يعتمد بشكل أساسي على خدمات خارجية ولا يعتمد على البيئة المحلية.',
...
- عيّن \`require_approval\` للتحكم في الموافقة على تنفيذ الأدوات`,
    ...
    'mcp.details.deployment.table.description': 'الوصف',
    'mcp.details.deployment.table.name': 'الاسم',
...
- تساعد شارة MCP المستخدمين على تقييم أمان الخادم وميزاته وتعليمات التثبيت بسرعة. يرجى نسخ الكود التالي إلى ملف \`README.md\` الخاص بك:`,
    ...
    'mcp.details.schema.tools.desc':
      'واجهات وظيفية مكشوفة لنماذج اللغة الكبيرة (LLM) لتنفيذ العمليات',
    ...
    'mcp.details.score.claimed.desc':
      'تم تأكيد ملكية هذا الخادم MCP من قبل مالكه، مما يضمن إدارته.',
    'mcp.details.score.claimed.title': 'تمت المطالبة به من قبل المالك',
    'mcp.details.score.deployMoreThanManual.desc':
      'يوفر هذا الخادم MCP طرق تثبيت أسهل من التثبيت اليدوي، مما يسهل على المستخدمين نشره واستخدامه.',
    'mcp.details.score.deployMoreThanManual.title': 'يوفر طرق تثبيت سهلة',
    'mcp.details.score.deployment.desc':
      'يوفر هذا الخادم MCP طريقة تثبيت واحدة على الأقل، مما يتيح للمستخدمين نشره واستخدامه.',
    'mcp.details.score.deployment.descWithCount':
      'يوفر هذا الخادم MCP {{number}} طريقة تثبيت، مما يتيح للمستخدمين نشره واستخدامه.',
    ...
    'mcp.details.score.notClaimed.desc':
      'إذا كنت مالك هذا الخادم MCP، يمكنك المطالبة به عبر الطرق التالية.',
    'mcp.details.score.notClaimed.title': 'لم تتم المطالبة به من قبل المالك',
    'mcp.details.score.prompts.desc':
      'يوفر هذا الخادم MCP تعليمات تتيح للمستخدمين التفاعل مع الخدمة.',
    'mcp.details.score.prompts.descWithCount':
      'يوفر هذا الخادم MCP {{number}} تعليمات تتيح للمستخدمين التفاعل مع الخدمة.',
    ...
    'mcp.details.score.resources.desc':
      'يوفر هذا الخادم MCP موارد تتيح للمستخدمين إرفاق بيانات السياق وإدارتها.',
    'mcp.details.score.resources.descWithCount':
      'يوفر هذا الخادم MCP {{number}} من الموارد تتيح للمستخدمين إرفاق بيانات السياق وإدارتها.',
    'mcp.details.score.resources.title': 'يتضمن موارد',
    'mcp.details.score.title': 'التقييم',
    'mcp.details.score.tools.desc':
      'يجب أن يوفر هذا الخادم أداة واحدة على الأقل تتيح للمستخدمين تنفيذ عمليات محددة.',
    'mcp.details.score.tools.descWithCount':
      'يوفر هذا الخادم MCP {{number}} من الأدوات التي تتيح للمستخدمين تنفيذ عمليات محددة.',
    ...
    'mcp.details.scoreLevel.a.desc':
      'تم التحقق من هذا الخادم MCP بدقة، ويقدم ميزات شاملة وتجربة مستخدم عالية الجودة.',
    'mcp.details.scoreLevel.a.fullTitle': 'مهارة ممتازة',
    'mcp.details.scoreLevel.a.title': 'مميز',
    'mcp.details.scoreLevel.b.desc':
      'يقدم هذا الخادم MCP ميزات جيدة وتجربة مستخدم مقبولة، لكنه قد يحتاج إلى تحسينات في بعض الجوانب.',
    'mcp.details.scoreLevel.b.fullTitle': 'وظائف جيدة',
    'mcp.details.scoreLevel.b.title': 'جيد',
    'mcp.details.scoreLevel.f.desc':
      'هذا الخادم MCP غير مكتمل أو منخفض الجودة؛ يُنصح المستخدمون باستخدامه بحذر.',
    ...
    'mcp.details.totalScore.popover.completedOptional':
      '✅ العناصر الاختيارية المكتملة ({{count}})',
    ...
    'mcp.details.totalScore.popover.incompleteOptional':
      '⏸️ العناصر الاختيارية غير المكتملة ({{count}})',
    'mcp.details.totalScore.popover.incompleteRequired':
      '❌ العناصر المطلوبة غير المكتملة ({{count}})',
    ...
    'mcp.hero.desc':
      'مجتمع خوادم MCP مفتوح المصدر وقابل للنشر—يساعد أنظمة الذكاء الاصطناعي على الوصول إلى أنظمة الملفات وقواعد البيانات وواجهات البرمجة وغيرها من الموارد الأساسية.',
    ...
    'models.parameterList.max_tokens.desc':
      'يحدد هذا الإعداد الحد الأقصى لطول الرد الذي يمكن أن يولده النموذج. القيم الأعلى تسمح بردود أطول، بينما القيم الأقل تجعل الردود أكثر إيجازًا.',
    'models.parameterList.max_tokens.title': 'حد الرد الواحد',
    'models.parameterList.presence_penalty.desc':
      'يتحكم هذا الإعداد في استخدام المفردات بناءً على تكرارها في الإدخال. القيم الأعلى تقلل من استخدام الكلمات المتكررة، بينما القيم السالبة تشجع على إعادة استخدامها.',
    ...
    'models.parameterList.reasoning_effort.desc':
      'يتحكم هذا الإعداد في مستوى التفكير الذي يستخدمه النموذج قبل توليد الرد. القيم الأعلى توفر استدلالًا أعمق ولكنها أبطأ، بينما القيم الأقل أسرع ولكنها أقل دقة.',
    'models.parameterList.reasoning_effort.title': 'شدة الاستدلال',
    'models.parameterList.temperature.desc':
      'يؤثر هذا الإعداد على تنوع الردود. القيم المنخفضة تؤدي إلى ردود أكثر توقعًا، بينما القيم الأعلى تنتج ردودًا أكثر تنوعًا.',
    'models.parameterList.temperature.title': 'العشوائية',
    'models.parameterList.title': 'معلمات النموذج',
    'models.parameterList.top_p.desc':
      'يحدد هذا الإعداد نسبة الكلمات الأكثر احتمالًا التي يمكن للنموذج اختيارها. القيم المنخفضة تجعل الردود أكثر قابلية للتنبؤ.',
    ...
    'skillEmpty.description': 'حاول تعديل الفلاتر أو البحث باستخدام كلمات مفتاحية مختلفة.',
    'skillEmpty.search': 'لم يتم العثور على مهارات مطابقة',
    'skillEmpty.title': 'لم يتم العثور على مهارات',
    'skills.categories.agent-to-agent-protocols.description':
      'التواصل بين الوكلاء، التنسيق، ومهارات البروتوكول',
    'skills.categories.agent-to-agent-protocols.name': 'بروتوكولات الوكيل إلى الوكيل',
    'skills.categories.ai-llms.description':
      'تكامل نماذج الذكاء الاصطناعي، أدوات LLM، ومهارات هندسة التوجيه',
    'skills.categories.ai-llms.name': 'الذكاء الاصطناعي وLLMs',
    'skills.categories.all.description': 'جميع المهارات',
    'skills.categories.all.name': 'الكل',
    'skills.categories.apple-apps-services.description': 'تطبيقات وخدمات نظام Apple ومنصات التكامل',
    'skills.categories.apple-apps-services.name': 'تطبيقات وخدمات Apple',
    'skills.categories.browser-automation.description':
      'التحكم في المتصفح، استخراج البيانات من الويب، ومهارات أتمتة واجهة المستخدم',
    'skills.categories.browser-automation.name': 'المتصفح والأتمتة',
    'skills.categories.calendar-scheduling.description':
      'إدارة التقويم، جدولة الاجتماعات، ومهارات تنسيق الوقت',
    'skills.categories.calendar-scheduling.name': 'التقويم والجدولة',
    'skills.categories.clawdbot-tools.description': 'مهارات وأدوات مخصصة لنظام Clawdbot',
    'skills.categories.clawdbot-tools.name': 'أدوات Clawdbot',
    'skills.categories.cli-utilities.description': 'أدوات سطر الأوامر، برمجة الشيل، وأدوات الطرفية',
    'skills.categories.cli-utilities.name': 'أدوات CLI',
    'skills.categories.coding-agents-ides.description':
      'مهارات للوكلاء البرمجيين، بيئات التطوير المتكاملة، والتطوير بمساعدة الذكاء الاصطناعي',
    'skills.categories.coding-agents-ides.name': 'الوكلاء البرمجيون وبيئات التطوير',
    'skills.categories.communication.description':
      'الرسائل، البريد الإلكتروني، منصات الدردشة، ومهارات سير العمل في التواصل',
    'skills.categories.communication.name': 'التواصل',
    'skills.categories.data-analytics.description': 'تحليل البيانات، التصور، ومهارات ذكاء الأعمال',
    'skills.categories.data-analytics.name': 'البيانات والتحليلات',
    'skills.categories.devops-cloud.description':
      'خطوط DevOps، البنية التحتية السحابية، ومهارات النشر',
    'skills.categories.devops-cloud.name': 'DevOps والسحابة',
    'skills.categories.finance.description': 'التمويل، البنوك، المدفوعات، ومهارات البيانات المالية',
    'skills.categories.finance.name': 'التمويل',
    'skills.categories.gaming.description':
      'بيانات الألعاب، الإنجازات، لوحات الصدارة، ومهارات منصات الألعاب',
    'skills.categories.gaming.name': 'الألعاب',
    'skills.categories.git-github.description': 'إدارة الإصدارات باستخدام Git وتكاملات منصة GitHub',
    'skills.categories.git-github.name': 'Git وGitHub',
    'skills.categories.health-fitness.description': 'تتبع الصحة، تخطيط اللياقة، ومهارات العافية',
    'skills.categories.health-fitness.name': 'الصحة واللياقة',
    'skills.categories.image-video-generation.description':
      'توليد الصور باستخدام الذكاء الاصطناعي، إنشاء الفيديو، ومهارات الوسائط البصرية',
    'skills.categories.image-video-generation.name': 'توليد الصور والفيديو',
    'skills.categories.ios-macos-development.description':
      'تطوير تطبيقات iOS وmacOS، أدوات Xcode، ومهارات Swift',
    'skills.categories.ios-macos-development.name': 'تطوير iOS وmacOS',
    'skills.categories.marketing-sales.description':
      'حملات التسويق، سير عمل المبيعات، ومهارات أتمتة النمو',
    'skills.categories.marketing-sales.name': 'التسويق والمبيعات',
    'skills.categories.media-streaming.description':
      'تشغيل الوسائط، منصات البث، ومهارات توصيل المحتوى',
    'skills.categories.media-streaming.name': 'الوسائط والبث',
    'skills.categories.moltbook.description': 'تكاملات منصة Moltbook وأتمتة الدفاتر',
    'skills.categories.moltbook.name': 'Moltbook',
    'skills.categories.notes-pkm.description':
      'تدوين الملاحظات، إدارة المعرفة الشخصية، ومهارات الدماغ الثاني',
    'skills.categories.notes-pkm.name': 'الملاحظات وإدارة المعرفة الشخصية',
    'skills.categories.pdf-documents.description':
      'معالجة ملفات PDF، تحليل المستندات، ومهارات إدارة الملفات',
    'skills.categories.pdf-documents.name': 'ملفات PDF والمستندات',
    'skills.categories.personal-development.description':
      'النمو الشخصي، بناء العادات، ومهارات تحسين الذات',
    'skills.categories.personal-development.name': 'التطوير الشخصي',
    'skills.categories.productivity-tasks.description':
      'إدارة المهام، أتمتة سير العمل، ومهارات الإنتاجية',
    'skills.categories.productivity-tasks.name': 'الإنتاجية والمهام',
    'skills.categories.search-research.description':
      'البحث على الويب، استرجاع البيانات، ومهارات أتمتة البحث',
    'skills.categories.search-research.name': 'البحث والدراسة',
    'skills.categories.security-passwords.description':
      'تدقيق الأمان، إدارة كلمات المرور، ومهارات حماية الخصوصية',
    'skills.categories.security-passwords.name': 'الأمان وكلمات المرور',
    'skills.categories.self-hosted-automation.description':
      'الخدمات المستضافة ذاتيًا، أتمتة المختبرات المنزلية، ومهارات البنية التحتية',
    'skills.categories.self-hosted-automation.name': 'الخدمات المستضافة ذاتيًا والأتمتة',
    'skills.categories.shopping-ecommerce.description':
      'تكاملات التجارة الإلكترونية، أتمتة التسوق، ومهارات البيع بالتجزئة',
    'skills.categories.shopping-ecommerce.name': 'التسوق والتجارة الإلكترونية',
    'skills.categories.smart-home-iot.description':
      'أتمتة المنازل الذكية، التحكم في أجهزة إنترنت الأشياء، ومهارات إدارة المنازل',
    'skills.categories.smart-home-iot.name': 'المنازل الذكية وإنترنت الأشياء',
    'skills.categories.speech-transcription.description':
      'التعرف على الكلام، نسخ الصوت، ومهارات واجهات الصوت',
    'skills.categories.speech-transcription.name': 'الكلام والنسخ',
    'skills.categories.transportation.description':
      'النقل، الخدمات اللوجستية، التوجيه، ومهارات التنقل',
    'skills.categories.transportation.name': 'النقل',
    'skills.categories.web-frontend-development.description':
      'تطوير الويب، أطر العمل الأمامية، وأدوات واجهة المستخدم',
    'skills.categories.web-frontend-development.name': 'تطوير الويب والواجهة الأمامية',
    'skills.details.nav.needHelp': 'تحتاج مساعدة؟',
    'skills.details.nav.reportIssue': 'الإبلاغ عن مشكلة',
    'skills.details.nav.viewSourceCode': 'عرض الكود المصدري',
    'skills.details.overview.title': 'نظرة عامة',
    'skills.details.rating.title': 'التقييمات',
    'skills.details.related.empty': 'لا توجد مهارات ذات صلة حتى الآن',
    'skills.details.related.listTitle': 'المهارات ذات الصلة',
    'skills.details.related.more': 'عرض المزيد',
    'skills.details.related.title': 'المهارات ذات الصلة',
    'skills.details.resources.empty': 'لا توجد موارد متاحة',
    'skills.details.resources.table.name': 'الاسم',
    'skills.details.resources.table.size': 'الحجم',
    'skills.details.resources.title': 'الموارد',
    'skills.details.review.title': 'كيفية تقديم مراجعة',
    'skills.details.sidebar.agent.copied': 'تم نسخ التوجيه',
    'skills.details.sidebar.agent.copyPrompt': 'نسخ التوجيه',
    'skills.details.sidebar.agent.title': 'أرسل هذا التوجيه إلى وكيلك لتثبيت هذه المهارة',
    'skills.details.sidebar.agent.useOnLobeAI': 'استخدام على LobeAI',
    'skills.details.sidebar.description': 'الوصف',
    'skills.details.sidebar.details': 'التفاصيل',
    'skills.details.sidebar.directoryLayout': 'تخطيط الدليل',
    'skills.details.sidebar.downloadSkill': 'تنزيل المهارة',
    'skills.details.sidebar.files': 'شجرة الملفات',
    'skills.details.sidebar.installCommand': 'أمر التثبيت',
    'skills.details.sidebar.installationConfig': 'التثبيت',
    'skills.details.sidebar.platform.layout.lobehub': 'يتم إدارة المهارات تلقائيًا بواسطة LobeHub',
    'skills.details.sidebar.platform.layout.resourcesHint': 'موارد أخرى',
    'skills.details.sidebar.platform.steps.claude':
      'قم بتشغيل أمر التثبيت في الطرفية لتنزيل وتكوين هذه المهارة لـ Claude Code.',
    'skills.details.sidebar.platform.steps.cline':
      'قم بتشغيل أمر التثبيت في الطرفية لتنزيل وتكوين هذه المهارة لـ Cline.',
    'skills.details.sidebar.platform.steps.codex':
      'قم بتشغيل أمر التثبيت في الطرفية لتنزيل وتكوين هذه المهارة لـ Codex.',
    'skills.details.sidebar.platform.steps.cursor':
      'قم بتشغيل أمر التثبيت في الطرفية لتنزيل وتكوين هذه المهارة لـ Cursor.',
    'skills.details.sidebar.platform.steps.lobehub':
      'قم بالتثبيت مباشرة من سوق LobeHub بنقرة واحدة.',
    'skills.details.sidebar.platform.steps.vscode':
      'قم بتشغيل أمر التثبيت في الطرفية لتنزيل وتكوين هذه المهارة لـ VS Code.',
    'skills.details.sidebar.platform.title': 'التثبيت على {{platform}}',
    'skills.details.sidebar.tags': 'العلامات',
    'skills.details.summary.title': 'الملخص',
    'skills.details.versions.empty': 'لا توجد إصدارات تاريخية حتى الآن',
    'skills.details.versions.table.isLatest': 'الأحدث',
    'skills.details.versions.table.publishAt': 'تاريخ النشر',
    'skills.details.versions.table.version': 'الإصدار',
    'skills.details.versions.title': 'تاريخ الإصدارات',
    'skills.hero.guide.agent': 'أنا وكيل',
    'skills.hero.guide.human': 'أنا إنسان',
    'skills.sorts.createdAt': 'تم النشر مؤخرًا',
    'skills.sorts.installCount': 'التنزيلات',
    'skills.sorts.name': 'الاسم',
    'skills.sorts.stars': 'نجوم GitHub',
    'skills.sorts.updatedAt': 'تم التحديث مؤخرًا',
    ...
    'user.submitRepoDescription':
      'أرسل مستودع GitHub الخاص بك لاستيراد مهاراتك أو MCPs إلى المجتمع.',
  ...
  Qa = {
    ...
    'markdown.parseMessage':
      'سيتم التحويل إلى تنسيق Markdown. سيتم استبدال المحتوى الحالي. هل أنت متأكد؟ (سيُغلق تلقائيًا خلال 5 ثوانٍ)',
  ...
  Xa = {
    ...
    'proxy.testDescription':
      'اختبر الاتصال باستخدام إعدادات البروكسي الحالية للتحقق من عمله بشكل صحيح',
    ...
    'updater.newVersionAvailableDesc':
      'تم العثور على إصدار جديد {{version}}، هل ترغب في تحميله الآن؟',
    ...
    'updater.updateReadyDesc':
      'تم تحميل الإصدار الجديد {{version}}. أعد تشغيل التطبيق لإكمال التثبيت.',
    ...
    'waitingOAuth.helpText':
      'إذا لم يفتح المتصفح تلقائياً، يرجى النقر على إلغاء والمحاولة مرة أخرى',
  ...
  Ya = {
    ...
    'exceededContext.desc':
      'تجاوزت المحادثة حد نافذة السياق. يمكنك ضغط السياق لتقليل التاريخ ومواصلة الدردشة.',
    ...
    'import.incompatible.description':
      'تم تصدير هذا الملف من إصدار أحدث. يرجى الترقية إلى أحدث إصدار ثم إعادة الاستيراد.',
    ...
    'response.401':
      'عذرًا، تم رفض طلبك من قبل الخادم، ربما بسبب عدم كفاية الصلاحيات أو فشل التوثيق.',
    'response.403': 'عذرًا، تم رفض طلبك. ليس لديك إذن للوصول إلى هذا المحتوى.',
    'response.404':
      'عذرًا، لم يتم العثور على الصفحة أو المورد المطلوب. يرجى التأكد من صحة عنوان URL.',
    ...
    'response.408':
      'عذرًا، انتهت مهلة الخادم أثناء انتظار الطلب. يرجى التحقق من اتصالك بالشبكة والمحاولة مرة أخرى.',
    'response.409':
      'عذرًا، لا يمكن معالجة الطلب بسبب تعارض، ربما بسبب حالة المورد غير المتوافقة مع الطلب.',
    ...
    'response.499':
      'نعتذر، تم قطع طلبك بشكل غير متوقع أثناء معالجته من قبل الخادم، ربما بسبب إلغاء العملية أو ضعف الاتصال. يرجى التحقق من الشبكة والمحاولة مجددًا.',
    'response.500':
      'عذرًا، يبدو أن الخادم يواجه صعوبات مؤقتة ولا يمكنه إكمال طلبك. يرجى المحاولة لاحقًا.',
    'response.501': 'عذرًا، لا يعرف الخادم كيفية معالجة هذا الطلب بعد. يرجى التأكد من صحة العملية.',
    'response.502':
      'عذرًا، يبدو أن الخادم غير متصل مؤقتًا ولا يمكنه تقديم الخدمة. يرجى المحاولة لاحقًا.',
    'response.503':
      'عذرًا، لا يمكن للخادم حاليًا معالجة طلبك، ربما بسبب الحمل الزائد أو الصيانة. يرجى المحاولة لاحقًا.',
    ...
    'response.507':
      'عذرًا، لا توجد مساحة تخزين كافية على الخادم لمعالجة طلبك. يرجى المحاولة لاحقًا.',
    ...
    'response.520':
      'نعتذر، واجه الخادم مشكلة غير متوقعة منعته من إكمال طلبك. يرجى المحاولة لاحقًا، نحن نعمل على حل المشكلة.',
    'response.522':
      'نعتذر، انتهت مهلة الاتصال بالخادم ولم يتمكن من الرد في الوقت المناسب. قد يكون السبب ضعف الشبكة أو تعذر الوصول المؤقت. يرجى المحاولة لاحقًا.',
    'response.524':
      'نعتذر، انتهت مهلة الخادم أثناء انتظار الرد، ربما بسبب بطء الاستجابة. يرجى المحاولة لاحقًا.',
    'response.AgentRuntimeError':
      'حدث خطأ أثناء تنفيذ نموذج Lobe. يرجى التحقق أو إعادة المحاولة بناءً على المعلومات التالية.',
    'response.ComfyUIBizError':
      'حدث خطأ أثناء طلب خدمة ComfyUI. يرجى التحقق من المعلومات أدناه أو إعادة المحاولة.',
    'response.ComfyUIEmptyResult':
      'لم يتم إنشاء أي صورة بواسطة ComfyUI. يرجى التحقق من إعدادات النموذج أو إعادة المحاولة.',
    'response.ComfyUIModelError': 'فشل تحميل نموذج ComfyUI. يرجى التأكد من وجود ملف النموذج.',
    'response.ComfyUIServiceUnavailable':
      'فشل الاتصال بخدمة ComfyUI. يرجى التأكد من أنها تعمل بشكل صحيح وأن عنوان الخدمة مضبوط بشكل صحيح.',
    'response.ComfyUIUploadFailed':
      'فشل تحميل الصورة إلى ComfyUI. يرجى التحقق من الاتصال بالخادم أو إعادة المحاولة.',
    'response.ComfyUIWorkflowError': 'فشل تنفيذ سير عمل ComfyUI. يرجى التحقق من إعدادات سير العمل.',
    'response.ConnectionCheckFailed':
      'الطلب أعاد نتيجة فارغة. يرجى التحقق من أن عنوان وكيل API لا ينتهي بـ `/v1`.',
    'response.CreateMessageError':
      'عذرًا، لم يتم إرسال الرسالة بنجاح. يرجى نسخ المحتوى والمحاولة مرة أخرى. لن يتم الاحتفاظ بهذه الرسالة بعد تحديث الصفحة.',
    'response.ExceededContextWindow':
      'يتجاوز محتوى الطلب الحالي الحد الأقصى الذي يمكن للنموذج معالجته. يرجى تقليل المحتوى والمحاولة مجددًا.',
    'response.ExceededContextWindowCloud':
      'المحادثة طويلة جدًا لمعالجتها. يرجى تعديل رسالتك الأخيرة لتقليل الإدخال أو حذف بعض الرسائل والمحاولة مرة أخرى.',
    'response.FreePlanLimit':
      'أنت تستخدم الخطة المجانية حاليًا ولا يمكنك استخدام هذه الميزة. يرجى الترقية إلى خطة مدفوعة للمتابعة.',
    'response.GoogleAIBlockReason.BLOCKLIST':
      'يتضمن المحتوى مصطلحات محظورة. يرجى إعادة الصياغة والمحاولة مرة أخرى.',
    'response.GoogleAIBlockReason.IMAGE_SAFETY':
      'تم حظر الصورة المُنشأة لأسباب تتعلق بالسلامة. يرجى تعديل طلبك والمحاولة مرة أخرى.',
    'response.GoogleAIBlockReason.LANGUAGE':
      'اللغة المطلوبة غير مدعومة. يرجى المحاولة مرة أخرى بلغة مدعومة.',
    'response.GoogleAIBlockReason.OTHER':
      'تم حظر المحتوى لسبب غير معروف. يرجى إعادة الصياغة والمحاولة مرة أخرى.',
    'response.GoogleAIBlockReason.PROHIBITED_CONTENT':
      'قد يحتوي المحتوى على مواد محظورة. يرجى تعديله والمحاولة مرة أخرى.',
    'response.GoogleAIBlockReason.RECITATION':
      'تم حظر المحتوى بسبب خطر التكرار. يرجى استخدام صياغة أكثر أصالة والمحاولة مرة أخرى.',
    'response.GoogleAIBlockReason.SAFETY':
      'تم حظر المحتوى لأسباب تتعلق بالسلامة. يرجى تعديله والمحاولة مرة أخرى.',
    'response.GoogleAIBlockReason.SPII':
      'قد يتضمن المحتوى معلومات شخصية حساسة (SPII). يرجى إزالة التفاصيل الحساسة والمحاولة مرة أخرى.',
    'response.GoogleAIBlockReason.default':
      'تم حظر المحتوى ({{blockReason}}). يرجى تعديله والمحاولة مرة أخرى.',
    'response.InsufficientBudgetForModel':
      'رصيدك المتبقي غير كافٍ لهذا النموذج. يرجى إعادة شحن الرصيد، ترقية خطتك، أو تجربة نموذج أقل تكلفة.',
    'response.InsufficientQuota':
      'عذرًا، تم استهلاك الحصة المخصصة لهذا المفتاح. يرجى التحقق من رصيد حسابك أو زيادة الحصة والمحاولة مجددًا.',
    'response.InvalidAccessCode':
      'رمز الوصول غير صالح أو فارغ. يرجى إدخال رمز الوصول الصحيح أو إضافة مفتاح API مخصص.',
    'response.InvalidBedrockCredentials':
      'فشل التوثيق مع Bedrock. يرجى التحقق من AccessKeyId/SecretAccessKey والمحاولة مجددًا.',
    'response.InvalidComfyUIArgs':
      'إعدادات ComfyUI غير صالحة. يرجى التحقق من الإعدادات والمحاولة مجددًا.',
    'response.InvalidGithubToken':
      'رمز GitHub الشخصي غير صحيح أو فارغ. يرجى التحقق من الرمز والمحاولة مجددًا.',
    'response.InvalidOllamaArgs': 'إعدادات Ollama غير صالحة، يرجى التحقق منها والمحاولة مجددًا.',
    'response.InvalidProviderAPIKey':
      'مفتاح API الخاص بـ {{provider}} غير صحيح أو فارغ، يرجى التحقق منه والمحاولة مجددًا.',
    'response.InvalidVertexCredentials':
      'فشل التوثيق مع Vertex. يرجى التحقق من بيانات الاعتماد والمحاولة مجددًا.',
    'response.LocationNotSupportError':
      'نعتذر، لا يدعم موقعك الحالي هذه الخدمة. قد يكون ذلك بسبب قيود إقليمية أو عدم توفر الخدمة. يرجى التأكد من دعم الموقع الحالي أو المحاولة من موقع مختلف.',
    'response.ModelNotFound':
      'عذرًا، لم يتم العثور على النموذج المطلوب. قد لا يكون موجودًا أو ليس لديك صلاحية الوصول. يرجى المحاولة بعد تغيير مفتاح API أو تعديل الصلاحيات.',
    'response.NoOpenAIAPIKey': 'مفتاح OpenAI API فارغ، يرجى إضافة مفتاح API مخصص.',
    'response.OllamaBizError':
      'حدث خطأ أثناء طلب خدمة Ollama، يرجى التحقق أو إعادة المحاولة بناءً على المعلومات التالية.',
    'response.OllamaServiceUnavailable':
      'خدمة Ollama غير متوفرة. يرجى التحقق من تشغيلها بشكل صحيح أو إعدادات التكوين.',
    'response.PermissionDenied':
      'عذرًا، لا تملك صلاحية الوصول إلى هذه الخدمة. يرجى التحقق من صلاحيات المفتاح.',
    'response.PluginApiNotFound':
      'عذرًا، لم يتم العثور على API في ملف تعريف المهارة. يرجى التحقق من تطابق طريقة الطلب مع API المعرفة.',
    'response.PluginApiParamsError':
      'عذرًا، فشل التحقق من معلمات الطلب للمهارة. يرجى التحقق من تطابق المعلمات مع وصف API.',
    'response.PluginFailToTransformArguments':
      'عذرًا، فشلت المهارة في تحليل المعلمات. يرجى إعادة إنشاء رسالة الوكيل أو استخدام نموذج AI أقوى يدعم استدعاء الأدوات.',
    'response.PluginGatewayError':
      'عذرًا، حدث خطأ في بوابة المهارة. يرجى التحقق من إعدادات البوابة.',
    'response.PluginManifestInvalid':
      'عذرًا، فشل التحقق من ملف تعريف المهارة. يرجى التحقق من صحة التنسيق.',
    'response.PluginManifestNotFound':
      'عذرًا، لم يتم العثور على ملف تعريف المهارة (manifest.json). يرجى التحقق من العنوان.',
    'response.PluginMarketIndexInvalid':
      'عذرًا، فشل التحقق من فهرس المهارة. يرجى التحقق من تنسيق الملف.',
    'response.PluginMarketIndexNotFound':
      'عذرًا، لم يتم العثور على فهرس المهارة. يرجى التحقق من العنوان.',
    'response.PluginMetaInvalid': 'عذرًا، فشل التحقق من بيانات المهارة. يرجى التحقق من التنسيق.',
    'response.PluginMetaNotFound':
      'عذرًا، لم يتم العثور على المهارة في الفهرس. يرجى التحقق من إعدادات المهارة.',
    'response.PluginOpenApiInitError':
      'عذرًا، فشل تهيئة عميل OpenAPI. يرجى التحقق من إعدادات OpenAPI.',
    'response.PluginServerError':
      'أعاد خادم المهارة خطأ. يرجى التحقق من ملف تعريف المهارة أو إعدادات الخادم.',
    'response.PluginSettingsInvalid':
      'تتطلب هذه المهارة إعدادًا صحيحًا قبل الاستخدام. يرجى التحقق من الإعدادات.',
    'response.ProviderBizError':
      'حدث خطأ أثناء طلب خدمة {{provider}}، يرجى التحقق أو إعادة المحاولة.',
    'response.QuotaLimitReached':
      'عذرًا، تم الوصول إلى الحد الأقصى لاستخدام الرموز أو عدد الطلبات لهذا المفتاح. يرجى زيادة الحصة أو المحاولة لاحقًا.',
    'response.QuotaLimitReachedCloud':
      'خدمة النموذج تحت ضغط كبير حاليًا. يرجى المحاولة مرة أخرى لاحقًا.',
    'response.ServerAgentRuntimeError':
      'عذرًا، خدمة الوكيل غير متوفرة حاليًا. يرجى المحاولة لاحقًا أو التواصل معنا عبر البريد الإلكتروني.',
    'response.StreamChunkError':
      'حدث خطأ أثناء تحليل جزء الرسالة من الطلب المتدفق. يرجى التحقق من توافق واجهة API أو التواصل مع مزود الخدمة.',
    'response.SubscriptionKeyMismatch':
      'نعتذر عن الإزعاج. بسبب خلل مؤقت في النظام، اشتراكك غير نشط حاليًا. يرجى النقر على الزر أدناه لاستعادته أو التواصل معنا عبر البريد الإلكتروني.',
    'response.SubscriptionPlanLimit':
      'تم استنفاد نقاط اشتراكك، ولا يمكنك استخدام هذه الميزة. يرجى الترقية إلى خطة أعلى أو إعداد API مخصص.',
    'response.SubscriptionPlanLimitUltimate':
      'تم استنفاد نقاط اشتراكك، ولا يمكنك استخدام هذه الميزة. يرجى شحن الرصيد أو إعداد API مخصص.',
    'response.SystemTimeNotMatchError':
      'عذرًا، لا يتطابق وقت نظامك مع الخادم. يرجى التحقق من الوقت والمحاولة مجددًا.',
    'response.UnknownChatFetchError':
      'عذرًا، حدث خطأ غير معروف في الطلب. يرجى التحقق من المعلومات أدناه أو إعادة المحاولة.',
    'stt.responseError': 'فشل طلب الخدمة، يرجى التحقق من الإعدادات أو إعادة المحاولة.',
    'supervisor.decisionFailed':
      'المضيف الجماعي غير قادر على العمل. يرجى التحقق من إعدادات المضيف والتأكد من صحة النموذج ومفتاح API ونقطة النهاية.',
    ...
    'unlock.oauth.description':
      'قام المسؤول بتمكين تسجيل الدخول الموحد. انقر على الزر أدناه لتسجيل الدخول وفتح التطبيق.',
    ...
    'unlock.password.description':
      'تم تفعيل تشفير التطبيق من قبل المسؤول. أدخل كلمة مرور التطبيق لفتحه. لا حاجة لإدخالها مرة أخرى.',
    ...
    'upload.fileOnlySupportInServerMode':
      'وضع النشر الحالي لا يدعم تحميل الملفات غير الصورية. لتحميل ملفات بصيغة {{ext}}، يرجى التبديل إلى وضع قاعدة بيانات الخادم أو استخدام خدمة {{cloud}}.',
    'upload.networkError':
      'يرجى التحقق من اتصال الشبكة والتأكد من صحة إعدادات CORS لخدمة تخزين الملفات.',
    'upload.storageLimitExceeded':
      'لقد وصلت مساحة تخزين الملفات إلى الحد الأقصى للخطة. يرجى ترقية خطتك أو حذف الملفات غير المستخدمة لتوفير مساحة.',
  ...
  Za = {
    ...
    'benchmark.actions.delete.confirm':
      'هل أنت متأكد أنك تريد حذف هذا المعيار؟ سيتم أيضًا حذف مجموعات البيانات وسجلات التقييم المرتبطة.',
    ...
    'benchmark.detail.datasetCount':
      '{{count}} مجموعة بيانات{{count, plural, one {} other {s}}} في هذا المعيار',
    'benchmark.detail.runCount':
      '{{count}} تشغيل تقييم{{count, plural, one {} other {s}}} على هذا المعيار',
    ...
    'dataset.delete.confirm':
      'هل أنت متأكد أنك تريد حذف هذه المجموعة؟ سيتم أيضًا حذف جميع حالات الاختبار الموجودة بها.',
    ...
    'dataset.evalMode.hint':
      'وضع التقييم الافتراضي لمجموعة البيانات، يمكن تجاوزه على مستوى حالة الاختبار',
    ...
    'run.actions.retryErrors.confirm':
      'سيتم إعادة تشغيل جميع الحالات التي تحتوي على أخطاء أو انتهاء المهلة. لن تتأثر الحالات التي نجحت أو فشلت.',
    ...
    'run.config.k.hint':
      'قم بتشغيل كل حالة اختبار {{k}} مرات للحصول على مقاييس pass@{{k}}/pass^{{k}}',
    ...
    'run.status.external.tooltip':
      'أنهى الوكيل التشغيل. في انتظار النظام الخارجي لتقديم نتائج التقييم.',
  ...
  yi = 'لم يتم تحميل أي ملفات أو مجلدات بعد.',
  vi = 'تحميل المزيد',
  ki = 'فشل في استرداد المكتبات. يرجى التحقق من اتصال الشبكة والمحاولة مرة أخرى.',
  Si = 'المورد',
  Ai = 'البحث في الملفات',
  wi = 'البحث في الصفحات',
  Ci = 'الموارد',
  Mi = 'إظهار/إخفاء اللوحة الجانبية',
  eo = {
    'addFolder': bi,
    'addLibrary': hi,
    'addPage': fi,
    ...
    'header.actions.gitignore.content':
      'تم اكتشاف ملف .gitignore ({{count}} ملفًا إجمالاً). هل ترغب في تطبيق قواعد التجاهل؟',
    ...
    'header.actions.notionGuide.desc':
      'أولاً، قم بتصدير المحتوى من Notion كملف Markdown (ZIP). ثم انقر على متابعة لتحديد ملف ZIP واستيراد جميع الصفحات.',
    ...
    'library.list.confirmRemoveLibrary':
      'أنت على وشك حذف هذه المكتبة. لن يتم حذف الملفات الموجودة بداخلها، بل سيتم نقلها إلى جميع الملفات. لا يمكن التراجع عن هذا الإجراء، لذا يرجى المتابعة بحذر.',
    ...
    'notSupportGuide.desc':
      'وضع النشر الحالي لا يدعم إدارة الملفات. قم بالتبديل إلى <1>وضع قاعدة بيانات الخادم</1>، أو استخدم <3>LobeHub Cloud</3>.',
    'notSupportGuide.features.allKind.desc':
      'يدعم أنواع الملفات الشائعة، بما في ذلك تنسيقات الصفحات مثل Word وPPT وExcel وPDF وTXT، بالإضافة إلى ملفات البرمجة مثل JS وPython.',
    'notSupportGuide.features.allKind.title': 'تحليل أنواع ملفات متعددة',
    'notSupportGuide.features.embeddings.desc':
      'يستخدم نماذج متجهات عالية الأداء لتحويل أجزاء النص إلى متجهات، مما يتيح البحث الدلالي في محتوى الملفات.',
    ...
    'pageEditor.deleteConfirm.content':
      'سيتم حذف هذه الصفحة ولا يمكن استعادتها. يرجى المتابعة بحذر.',
    ...
    'preview.unsupportedFileAndContact':
      'تنسيق هذا الملف غير مدعوم حاليًا للمعاينة عبر الإنترنت. إذا كان لديك طلب للمعاينة، لا تتردد في <1>الاتصال بنا</1>.',
    'resource': Si,
  ...
  io = {
    ...
    'switchAgent.desc':
      'التبديل بين الوكلاء المثبتين في الشريط الجانبي بالضغط على Ctrl مع الأرقام من 0 إلى 9',
  ...
  ao = {
    ...
    'generation.actions.downloadFailed':
      'فشل في تنزيل الصورة. يرجى التحقق من اتصال الشبكة أو إعدادات CORS لتخزين S3.',
    ...
    'notSupportGuide.desc':
      'وضع النشر الحالي لا يدعم إنشاء الصور بالذكاء الاصطناعي. قم بالتبديل إلى <1>وضع نشر قاعدة بيانات الخادم</1>، أو استخدم <3>LobeHub Cloud</3>.',
    'notSupportGuide.features.fileIntegration.desc':
      'تكامل عميق مع نظام إدارة الملفات؛ يتم حفظ الصور المُنشأة تلقائيًا في نظام الملفات لإدارة وتنظيم موحد.',
    'notSupportGuide.features.fileIntegration.title': 'تكامل مع نظام الملفات',
    'notSupportGuide.features.llmAssisted.desc':
      'يجمع بين قدرات نماذج اللغة الكبيرة لتحسين وتوسيع الأوصاف بذكاء، مما يعزز جودة إنشاء الصور (قريبًا).',
    'notSupportGuide.features.llmAssisted.title': 'إنشاء صور بمساعدة LLM',
    'notSupportGuide.features.multiProviders.desc':
      'يدعم عدة مزودي خدمات لإنشاء الصور بالذكاء الاصطناعي، بما في ذلك OpenAI gpt-image-1 وGoogle Imagen وFAL.ai والمزيد، مما يوفر مجموعة واسعة من النماذج.',
    ...
    'topic.deleteConfirmDesc':
      'أنت على وشك حذف موضوع الإنشاء هذا. لا يمكن التراجع عن هذا الإجراء، يرجى المتابعة بحذر.',
  ...
  Pi = 'المكتبة',
  oo = {
    'addToKnowledgeBase.addSuccess': 'تمت إضافة الملف بنجاح',
    'addToKnowledgeBase.alreadyExists': 'هذا الملف موجود بالفعل في المكتبة',
    ...
    'moveToKnowledgeBase.error': 'فشل في نقل الملف إلى المكتبة',
    'moveToKnowledgeBase.success': 'تم نقل الملف بنجاح',
    'tab.evals': 'التقييمات',
    'tab.files': 'الملفات',
  ...
  es = Object.freeze(
    Object.defineProperty({ __proto__: null, default: oo, title: Pi }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  Ti = 'ستجد هنا تحديثات عرضية حول الميزات الجديدة التي نستكشفها — لا تتردد في تجربتها!',
  Ii = 'المختبرات',
  so = {
    'desc': Ti,
    ...
    'features.inputMarkdown.desc':
      'عرض Markdown في منطقة الإدخال في الوقت الفعلي (نص عريض، كتل الشيفرة، جداول، إلخ).',
  ...
  no = {
    ...
    'authorize.description':
      'ملفك الشخصي في المجتمع منفصل عن حساب المستخدم الخاص بك في {{appName}}.',
    'authorize.footer.agreement':
      'بالمتابعة، فإنك تؤكد أنك قرأت ووافقت على <terms>الشروط والأحكام</terms> و<privacy>سياسة الخصوصية</privacy>.',
    'authorize.footer.privacy': 'سياسة الخصوصية',
    'authorize.footer.terms': 'شروط الخدمة',
    'authorize.subtitle':
      'أنشئ ملفًا شخصيًا في المجتمع لتتمكن من إرسال وإدارة القوائم داخل المجتمع.',
    ...
    'callback.messages.missingParams': 'معلمات التفويض مفقودة',
    'callback.messages.processing': 'جارٍ معالجة التفويض...',
    'callback.messages.successWithCountdown':
      '{{message}} سيتم إغلاق النافذة تلقائيًا خلال {{countdown}} ثانية',
    ...
    'errors.handoffTimeout':
      'انتهت مهلة التفويض. يرجى إكمال العملية في المتصفح والمحاولة مرة أخرى.',
    ...
    'errors.openPopupFailed':
      'فشل في فتح نافذة التفويض المنبثقة. يرجى التحقق من إعدادات حظر النوافذ المنبثقة في المتصفح.',
    ...
    'messages.authorizationFailed':
      'حدثت مشكلة أثناء التفويض. أعد المحاولة، أو تحقق مما إذا كنت قد أكملت تسجيل الدخول في المتصفح.',
    ...
    'profileSetup.confirmChangeUserId.description':
      'بمجرد التبديل إلى @{{newId}}، يمكن لأي شخص المطالبة بمعرفك القديم @{{oldId}} وستتوقف جميع الروابط الحالية إلى ملفك الشخصي عن العمل. لا يمكن التراجع عن هذا الإجراء. هل أنت متأكد أنك تريد المتابعة؟',
    ...
    'profileSetup.fields.bannerUrl.tooltip':
      'ستظهر صورة الغلاف في أعلى صفحة ملفك الشخصي (نسبة 16:9 موصى بها)',
    ...
    'profileSetup.fields.userName.pattern':
      'يمكن أن يحتوي معرّف المستخدم على أحرف وأرقام وشرطات سفلية وشرطات فقط',
    ...
    'profileSetup.fields.userName.tooltip':
      'معرّف المستخدم هو معرفك الفريد وسيُستخدم في عنوان URL لصفحة ملفك الشخصي',
    ...
    'profileSetup.titleFirstTime': 'أكمل ملفك الشخصي',
  },
  is = Object.freeze(
  ...
  ro = {
    ...
    'activity.actions.edit': 'تعديل',
    'activity.defaultType': 'نشاط',
    'activity.deleteConfirm':
      'هل أنت متأكد أنك تريد حذف ذاكرة هذا النشاط؟ لا يمكن التراجع عن هذا الإجراء.',
    'activity.deleteTitle': 'حذف ذاكرة النشاط',
    'activity.empty': 'لا توجد ذكريات نشاط متاحة',
    'activity.feedback': 'ملاحظات',
    'activity.narrative': 'سرد',
    'activity.notes': 'ملاحظات',
    'analysis.action.button': 'طلب تحليل الذاكرة',
    'analysis.modal.cancel': 'إلغاء',
    'analysis.modal.helper':
      'بشكل افتراضي، سيقوم Lobe AI بتحليل جميع المحادثات غير المعالجة. من الممكن اختيار نطاق زمني للتحليل.',
    'analysis.modal.rangePlaceholder': 'لم يتم تحديد نطاق؛ سيتم تحليل جميع المحادثات.',
    'analysis.modal.rangeSelected': 'جارٍ تحليل المحادثات من {{start}} إلى {{end}}',
    'analysis.modal.submit': 'طلب تحليل الذاكرة',
    'analysis.modal.title': 'تحليل المحادثات لإنشاء الذكريات',
    'analysis.range.all': 'جميع المحادثات',
    'analysis.range.end': 'اليوم',
    'analysis.range.start': 'البداية',
    'analysis.status.errorTitle': 'فشل طلب تحليل الذاكرة',
    'analysis.status.progress': 'تمت معالجة {{completed}} من أصل {{total}} موضوع',
    'analysis.status.progressUnknown': 'تمت معالجة {{completed}} موضوع حتى الآن',
    'analysis.status.tip': 'نقوم بمعالجة محادثاتك لبناء ذكريات شخصية. قد يستغرق هذا بضع دقائق.',
    'analysis.status.title': 'جارٍ تحليل الذاكرة',
    'analysis.toast.deduped': 'يوجد طلب ذاكرة قيد التشغيل بالفعل، جاري المتابعة…',
    'analysis.toast.failed': 'فشل طلب تحليل الذاكرة. يرجى المحاولة مرة أخرى.',
    'analysis.toast.started': 'بدأ تحليل الذاكرة. سنقوم بإعلامك عند الانتهاء.',
    'context.actions.delete': 'حذف',
    'context.actions.edit': 'تعديل',
    'context.defaultType': 'سياق',
    'context.deleteConfirm':
      'هل أنت متأكد أنك تريد حذف هذه الذاكرة السياقية؟ لا يمكن التراجع عن هذا الإجراء.',
    ...
    'empty.description':
      'استرجاع الذكريات هو عملية تدريجية. يرجى التفاعل أكثر لإثراء المحتوى المتاح للاسترجاع. حاول إجراء محادثات أعمق مع الوكيل لالتقاط وتخزين معلومات أكثر قيمة.',
    ...
    'experience.deleteConfirm':
      'هل أنت متأكد أنك تريد حذف هذه الذاكرة التجريبية؟ لا يمكن التراجع عن هذا الإجراء.',
    ...
    'filter.sort.startsAt': 'وقت البدء',
    ...
    'identity.list.deleteContent':
      'هل أنت متأكد أنك تريد حذف هذه الذاكرة المتعلقة بالهوية؟ لا يمكن التراجع عن هذا الإجراء.',
    ...
    'preference.deleteConfirm':
      'هل أنت متأكد أنك تريد حذف هذه الذاكرة التفضيلية؟ لا يمكن التراجع عن هذا الإجراء.',
    ...
    'purge.confirm':
      'هل أنت متأكد أنك تريد حذف جميع الذكريات؟ سيؤدي ذلك إلى إزالة كل إدخال للذكريات بشكل دائم ولا يمكن التراجع عنه.',
  ...
  lo = {
    ...
    'chat.description':
      '{{appName}} هو مساحة للعمل ونمط الحياة للعثور على فرق الوكلاء، وبنائها، والتعاون معها لتنمو معك.',
    'chat.title': '{{appName}} · فرق وكلاء تنمو معك',
    'discover.assistants.description':
      'محتوى، أسئلة وأجوبة، صور، فيديو، صوت، سير عمل—تصفح وأضف وكلاء من المجتمع.',
    ...
    'discover.mcp.description':
      'ابحث، قارن، واتصل بآلاف خوادم MCP، مما يمكّن أنظمة الذكاء الاصطناعي من الوصول بسهولة إلى أنظمة الملفات، قواعد البيانات، واجهات البرمجة، وغيرها من الموارد الأساسية، لتوسيع قدراتك في الذكاء الاصطناعي بشكل شامل.',
    'discover.mcp.title': 'مجتمع خوادم MCP',
    'discover.models.description':
      'استكشف نماذج الذكاء الاصطناعي الرائدة OpenAI / GPT / Claude 3 / Gemini / Ollama / Azure / DeepSeek',
    'discover.models.title': 'مجتمع النماذج',
    'discover.plugins.description':
      'استكشف الرسوم البيانية، الأدوات الأكاديمية، توليد الصور/الفيديو/الصوت، وسير العمل—أضف مهارات إلى وكلائك.',
    'discover.plugins.title': 'مجتمع المهارات',
    'discover.providers.description':
      'استكشف أبرز مزودي النماذج OpenAI / Qwen / Ollama / Anthropic / DeepSeek / Google Gemini / OpenRouter',
    'discover.providers.title': 'مجتمع المزودين',
    'discover.search': 'بحث',
    'discover.title': 'استكشاف',
    'image.description':
      '{{appName}} يقدم لك أفضل تجربة مع GPT Image وFlux وMidjourney وStable Diffusion',
    'image.title': 'فن الذكاء الاصطناعي',
    'plugins.description':
      'بحث، رسوم بيانية، أدوات أكاديمية، توليد الصور/الفيديو/الصوت، سير العمل—أضف مهارات إلى وكلائك.',
    'plugins.title': 'مجتمع المهارات',
    'welcome.description':
      '{{appName}} يقدم لك أفضل تجربة واجهة مستخدم لـ ChatGPT وClaude وGemini وOLLaMA.',
  ...
  co = {
    ...
    'dbV1.clear.confirm':
      'أنت على وشك مسح البيانات المحلية (لن تتأثر الإعدادات العامة). يرجى التأكد من أنك قمت بتنزيل نسخة احتياطية من البيانات.',
    'dbV1.description':
      'في الإصدار الجديد، شهد تخزين البيانات في {{appName}} تطورًا كبيرًا. لذلك، نحتاج إلى ترقية البيانات القديمة لتقديم تجربة مستخدم أفضل.',
    'dbV1.features.capability.desc':
      'يعتمد على تقنية IndexedDB، وقادر على تخزين رسائل محادثة تدوم مدى الحياة.',
    'dbV1.features.capability.title': 'سعة تخزين كبيرة',
    'dbV1.features.performance.desc':
      'يقوم بفهرسة ملايين الرسائل تلقائيًا، مع استجابة فورية لطلبات البحث خلال أجزاء من الثانية.',
    'dbV1.features.performance.title': 'أداء عالي',
    'dbV1.features.use.desc':
      'يدعم البحث حسب العنوان والوصف والوسوم ومحتوى الرسائل وحتى النصوص المترجمة، مما يعزز كفاءة البحث اليومي بشكل كبير.',
    'dbV1.features.use.title': 'أسهل في الاستخدام',
    'dbV1.title': 'تطور بيانات {{appName}}',
    'dbV1.upgrade.error.subTitle':
      "نعتذر، حدث خطأ أثناء عملية ترقية قاعدة البيانات. يرجى تجربة الحلول التالية: أ. مسح البيانات المحلية وإعادة استيراد النسخة الاحتياطية؛ ب. النقر على زر 'إعادة المحاولة'.<br><br> إذا استمرت المشكلة، يرجى <1>إرسال تقرير بالمشكلة</1> وسنقوم بمساعدتك في أقرب وقت ممكن.",
    'dbV1.upgrade.error.title': 'فشل ترقية قاعدة البيانات',
    'dbV1.upgrade.success.subTitle':
      'تمت ترقية قاعدة البيانات إلى أحدث إصدار. يمكنك المتابعة الآن.',
    'dbV1.upgrade.success.title': 'تمت ترقية قاعدة البيانات بنجاح',
    'dbV1.upgradeTip':
      'ستستغرق الترقية حوالي 10 إلى 20 ثانية. يرجى عدم إغلاق {{appName}} أثناء عملية الترقية.',
    'migrateError.missVersion':
      'البيانات المستوردة تفتقر إلى رقم الإصدار. يرجى التحقق من الملف والمحاولة مرة أخرى.',
    'migrateError.noMigration':
      'لم يتم العثور على حل ترحيل للإصدار الحالي. يرجى التحقق من رقم الإصدار والمحاولة مرة أخرى. إذا استمرت المشكلة، يرجى إرسال ملاحظة دعم.',
  },
  ss = Object.freeze(
  ...
  xi = 'تم إنشاء الصورة "{{prompt}}" بنجاح',
  Fi = 'تم إنشاء الصورة',
  Ni = 'تم إنشاء الفيديو "{{prompt}}" بنجاح',
  Ei = 'تم إنشاء الفيديو',
  po = {
    ...
    'video_generation_completed_title': Ei,
  },
  ns = Object.freeze(
    Object.defineProperty(
      {
  ...
  uo = {
    ...
    'consent.error.sessionInvalid.message':
      'انتهت صلاحية جلسة التفويض أو أنها غير صالحة. يرجى إعادة بدء عملية التفويض.',
    ...
    'device.success.description':
      'لقد قمت بالسماح للجهاز بنجاح. يمكنك إغلاق علامة التبويب هذه والعودة إلى جهازك الطرفي.',
    ...
    'handoff.desc.processing':
      'يقوم التطبيق بمعالجة التفويض وسيتم إعادة التوجيه إلى الصفحة التالية قريبًا...',
    'handoff.desc.success':
      'تمت محاولة فتح التطبيق على سطح المكتب. إذا لم يتم فتحه تلقائيًا، يرجى التبديل يدويًا. يمكنك إغلاق نافذة المتصفح لاحقًا.',
    ...
    'success.subTitle':
      'لقد قمت بتفويض التطبيق للوصول إلى حسابك بنجاح. يمكنك الآن إغلاق هذه الصفحة.',
  ...
  mo = {
    ...
    'modeSelection.lite.desc':
      'مثالي للمحادثات اليومية، الأسئلة والأجوبة، الإنتاجية الخفيفة، وتجربة النماذج',
    'modeSelection.lite.subtitle':
      'خفيف ومركّز — مثالي للتعاون الفعّال مع وكيل شامل واحد. يمكنك التبديل بين النماذج الشائعة في أي وقت للحفاظ على أفضل حالة تفكير.',
    'modeSelection.lite.title': 'الوضع الخفيف',
    'modeSelection.pro.desc':
      'مصمم للمستخدمين الذين يركزون على سير العمل ويبحثون عن تعاون عميق وتخصيص متقدم',
    'modeSelection.pro.subtitle':
      'وضع الإنتاجية الاحترافية. قم بإدارة شركة فردية، وتعاون مع عدة وكلاء، وخصص النماذج وسير العمل لبناء مركز ذكي خاص بك.',
    ...
    'responseLanguage.hint':
      'بعد اختيار اللغة، ستُستخدم هذه اللغة في ردود الذكاء الاصطناعي، كما ستتزامن لغة الواجهة',
    ...
    'telemetry.agreement':
      'جميع البيانات التي يتم جمعها مجهولة وتُستخدم فقط لتحسين تجربة المنتج. بمتابعتك، فإنك تؤكد أنك تفهم وتوافق على <terms>الشروط والأحكام</terms> و<privacy>سياسة الخصوصية</privacy>.',
    'telemetry.desc':
      'أنا مساعدك الشخصي — هنا لأساعدك في التفكير، الإبداع، وإدارة الوكلاء والمجموعات.',
    ...
    'telemetry.rows.collaborate.desc':
      'هنا، يعمل الناس والوكلاء معًا، يتعلمون ويتطورون — مما يجعل الإنتاجية تتدفق بشكل طبيعي.',
    ...
    'telemetry.rows.evolve.desc':
      'كل تفاعل يساعدني على فهمك بشكل أفضل — ليس فقط في الرد، بل في الفهم أيضًا.',
    'telemetry.rows.evolve.title': 'تطوّر · كلما استخدمتني أكثر، فهمتك أكثر',
    'telemetry.rows.privacy.desc':
      'نستخدم بيانات مجهولة لتحسين التجربة باستمرار. يمكنك تغيير هذا في أي وقت من تفضيلات الخصوصية.',
  ...
  ls = Object.freeze(
    Object.defineProperty(
      { __proto__: null, back: Ri, default: mo, finish: Oi, next: Li, title: Gi },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ...
  Bi = 'المهارات',
  Ui = 'الإعدادات',
  Hi = 'عرض التفاصيل في مساحة العمل',
  ji = 'خطأ غير معروف',
  qi = 'مهارة غير معروفة',
  go = {
    ...
    'builtins.lobe-agent-builder.apiName.installPlugin': 'تثبيت المهارة',
    ...
    'builtins.lobe-agent-builder.inspector.chars': ' أحرف',
    'builtins.lobe-agent-builder.inspector.disablePlugin': 'تعطيل',
    'builtins.lobe-agent-builder.inspector.enablePlugin': 'تمكين',
    'builtins.lobe-agent-builder.inspector.modelsCount': '{{count}} نماذج',
    ...
    'builtins.lobe-group-agent-builder.apiName.searchAgent': 'البحث عن وكلاء',
    ...
    'builtins.lobe-group-agent-builder.apiName.updateAgentPrompt': 'تحديث موجه الوكيل',
    'builtins.lobe-group-agent-builder.apiName.updateGroup': 'تحديث المجموعة',
    'builtins.lobe-group-agent-builder.apiName.updateGroupPrompt': 'تحديث موجه المجموعة',
    'builtins.lobe-group-agent-builder.apiName.updateSupervisorPrompt': 'تحديث موجه المشرف',
    'builtins.lobe-group-agent-builder.inspector.agents': 'الوكلاء',
    'builtins.lobe-group-agent-builder.inspector.avatar': 'الصورة الرمزية',
    'builtins.lobe-group-agent-builder.inspector.backgroundColor': 'لون الخلفية',
    'builtins.lobe-group-agent-builder.inspector.description': 'الوصف',
    'builtins.lobe-group-agent-builder.inspector.noResults': 'لا توجد نتائج',
    'builtins.lobe-group-agent-builder.inspector.openingMessage': 'رسالة البداية',
    'builtins.lobe-group-agent-builder.inspector.openingQuestions': 'الأسئلة الافتتاحية',
    'builtins.lobe-group-agent-builder.inspector.title': 'العنوان',
    ...
    'builtins.lobe-group-management.apiName.executeAgentTask': 'تنفيذ مهمة الوكيل',
    'builtins.lobe-group-management.apiName.executeAgentTasks': 'تنفيذ مهام الوكلاء المتوازية',
    ...
    'builtins.lobe-notebook.actions.collapse': 'طي',
    'builtins.lobe-notebook.actions.copy': 'نسخ',
    'builtins.lobe-notebook.actions.creating': 'جارٍ إنشاء المستند...',
    'builtins.lobe-notebook.actions.edit': 'تحرير',
    'builtins.lobe-notebook.actions.expand': 'توسيع',
    'builtins.lobe-notebook.apiName.createDocument': 'إنشاء مستند',
    'builtins.lobe-notebook.apiName.deleteDocument': 'حذف المستند',
    'builtins.lobe-notebook.apiName.getDocument': 'عرض المستند',
    'builtins.lobe-notebook.apiName.updateDocument': 'تحديث المستند',
    'builtins.lobe-notebook.title': 'دفتر الملاحظات',
    ...
    'builtins.lobe-page-agent.apiName.editTitle.result':
      'تمت إعادة التسمية إلى "<title>{{title}}</title>"',
    ...
    'builtins.lobe-skill-store.inspector.noResults': 'لا توجد نتائج',
    'builtins.lobe-skill-store.render.installs': 'التثبيتات',
    ...
    'builtins.lobe-skills.apiName.importFromMarket': 'استيراد من السوق',
    'builtins.lobe-skills.apiName.importSkill': 'استيراد المهارة',
    'builtins.lobe-skills.apiName.readReference': 'قراءة المرجع',
    ...
    'builtins.lobe-user-memory.inspector.noResults': 'لا توجد نتائج',
    'builtins.lobe-user-memory.render.contexts': 'السياقات',
    'builtins.lobe-user-memory.render.experiences': 'التجارب',
    'builtins.lobe-user-memory.render.preferences': 'التفضيلات',
    ...
    'dev.customParams.useProxy.label':
      'التثبيت عبر وكيل (فعّل إذا واجهت أخطاء CORS، ثم أعد المحاولة)',
    ...
    'dev.meta.identifier.pattenErrorMessage':
      'يسمح فقط بالأحرف، الأرقام، الشرطات، والشرطات السفلية',
    ...
    'dev.modalDesc':
      'يمكن استخدام المهارات المخصصة للتطوير أو مباشرة في المحادثات. راجع <1>الوثائق↗</1>',
    ...
    'dev.save': 'تثبيت',
    'dev.saveError': 'فشل التثبيت، يرجى المحاولة مرة أخرى',
    'dev.saveSuccess': 'تم حفظ الإعدادات',
    'dev.tabs.manifest': 'البيان',
    'dev.tabs.meta': 'معلومات التعريف',
    'dev.title.create': 'إضافة مهارة MCP مخصصة',
    'dev.title.edit': 'تعديل مهارة MCP مخصصة',
...
{{error}}`,
    ...
    'inspector.orphanedToolCall':
      'تم اكتشاف استدعاء مهارة يتيم، قد يؤثر على تنفيذ الوكيل. قم بإزالته.',
    ...
    'localSystem.workingDirectory.agentDescription':
      'دليل العمل الافتراضي لجميع المحادثات مع هذا الوكيل',
    ...
    'localSystem.workingDirectory.topicDescription':
      'تجاوز الإعداد الافتراضي للوكيل لهذه المحادثة فقط',
    ...
    'mcpInstall.errorDetails.env': 'متغيرات البيئة',
    'mcpInstall.errorDetails.errorOutput': 'سجل الأخطاء',
    'mcpInstall.errorDetails.exitCode': 'رمز الخروج',
    ...
    'protocolInstall.custom.security.description':
      'مهارة غير رسمية، قد تحتوي على مخاطر أمنية. تحقق من المصدر قبل التثبيت.',
    ...
    'protocolInstall.marketplace.unverified.warning':
      'تحقق من المصدر قبل تثبيت هذه المهارة المجتمعية.',
    ...
    'protocolInstall.messages.installSuccess':
      '{{name}} تم تثبيتها. يمكنك تفعيلها الآن أو إعدادها لاحقًا.',
    'protocolInstall.messages.manifestError':
      'فشل في جلب معلومات المهارة. تحقق من الشبكة أو حاول لاحقًا.',
    ...
    'protocolInstall.warning':
      'تحقق من مصدر المهارة. يمكنك تعطيلها أو إزالتها في أي وقت من الإعدادات.',
    ...
    'search.crawPages.detail.tooLong':
      'تم تقليص النص إلى {{characters}} حرفًا للسياق، وتم حذف الزائد.',
    ...
    'skillDetail.trustWarning':
      'استخدم الموصلات فقط من المطورين الذين تثق بهم. لا تتحكم LobeHub في الأدوات التي يتيحها المطورون ولا يمكنها التحقق من أنها ستعمل كما هو متوقع أو أنها لن تتغير.',
    ...
    'store.actions.confirmUninstall':
      'سيؤدي إلغاء التثبيت إلى مسح إعدادات المهارة. هل ترغب في المتابعة؟',
  ...
  zi = 'القطع الأثرية',
  Wi = 'المهارات',
  $i = 'لا توجد قطع أثرية بعد. استخدم المهارات في المحادثة، ثم عد إلى هنا.',
  Ji = 'هذه القائمة فارغة.',
  Vi = 'الملفات',
  Ki = 'تفاصيل الرسالة',
  Qi = 'تحرير في الصفحة',
  Xi = 'مساحة العمل',
  ...
  ho = {
    'ai21.description':
      'تقوم AI21 Labs ببناء نماذج أساسية وأنظمة ذكاء اصطناعي للمؤسسات، مما يسرّع من تطبيق الذكاء الاصطناعي التوليدي في بيئات الإنتاج.',
    'ai302.description':
      '302.AI هي منصة ذكاء اصطناعي تعتمد على الدفع حسب الاستخدام، وتقدم مجموعة واسعة من واجهات برمجة التطبيقات (APIs) والتطبيقات الذكية عبر الإنترنت.',
    'ai360.description':
      '360 AI هي منصة نماذج وخدمات من شركة 360، تقدم نماذج معالجة اللغة الطبيعية مثل 360GPT2 Pro و360GPT Pro و360GPT Turbo. تجمع هذه النماذج بين المعلمات واسعة النطاق والقدرات متعددة الوسائط لتوليد النصوص، وفهم المعاني، والدردشة، والبرمجة، مع تسعير مرن لتلبية احتياجات متنوعة.',
    'aihubmix.description':
      'يوفر AiHubMix الوصول إلى نماذج ذكاء اصطناعي متعددة من خلال واجهة برمجة تطبيقات موحدة.',
    'akashchat.description':
      'أكاش هو سوق موارد سحابية غير مركزي يتميز بأسعار تنافسية مقارنة بمزودي الخدمات السحابية التقليديين.',
    'anthropic.description':
      'تقوم Anthropic بتطوير نماذج لغوية متقدمة مثل Claude 3.5 Sonnet وClaude 3 Sonnet وClaude 3 Opus وClaude 3 Haiku، وتوازن بين الذكاء والسرعة والتكلفة لتناسب مختلف حالات الاستخدام من المؤسسات إلى الاستجابات السريعة.',
    'azure.description':
      'تقدم Azure نماذج ذكاء اصطناعي متقدمة، بما في ذلك سلسلة GPT-3.5 وGPT-4، لمعالجة أنواع بيانات متنوعة ومهام معقدة مع التركيز على الأمان والموثوقية والاستدامة.',
    'azureai.description':
      'توفر Azure نماذج ذكاء اصطناعي متقدمة، بما في ذلك سلسلة GPT-3.5 وGPT-4، لمعالجة أنواع بيانات متنوعة ومهام معقدة مع التركيز على الأمان والموثوقية والاستدامة.',
    'baichuan.description':
      'تركز Baichuan AI على النماذج الأساسية ذات الأداء القوي في المعرفة الصينية، ومعالجة السياقات الطويلة، والتوليد الإبداعي. تم تحسين نماذجها (Baichuan 4 وBaichuan 3 Turbo وBaichuan 3 Turbo 128k) لسيناريوهات مختلفة وتقدم قيمة عالية.',
    'bailiancodingplan.description':
      'خطة الترميز علي بابليون هي خدمة ذكاء اصطناعي متخصصة توفر الوصول إلى نماذج محسّنة للترميز من Qwen وGLM وKimi وMiniMax عبر نقطة نهاية مخصصة.',
    'bedrock.description':
      'توفر Amazon Bedrock للمؤسسات نماذج لغوية وبصرية متقدمة، بما في ذلك Anthropic Claude وMeta Llama 3.1، بدءًا من الخيارات الخفيفة إلى عالية الأداء لمهام النصوص والدردشة والصور.',
    'bfl.description':
      'مختبر أبحاث رائد في مجال الذكاء الاصطناعي المتقدم، يعمل على بناء البنية التحتية البصرية للمستقبل.',
    'cerebras.description':
      'Cerebras هي منصة استدلال تعتمد على نظام CS-3، تركز على تقديم خدمات نماذج لغوية كبيرة بزمن استجابة منخفض جدًا وسرعة عالية لمهام الوقت الحقيقي مثل توليد الأكواد والمهام التفاعلية.',
    'cloudflare.description':
      'تشغيل نماذج تعلم الآلة المعتمدة على وحدات معالجة الرسومات (GPU) بدون خوادم عبر شبكة Cloudflare العالمية.',
    'cohere.description':
      'تقدم Cohere نماذج متعددة اللغات متطورة، واسترجاعًا متقدمًا، ومساحات عمل ذكاء اصطناعي للمؤسسات الحديثة — كل ذلك ضمن منصة آمنة واحدة.',
    'cometapi.description':
      'توفر CometAPI الوصول إلى نماذج متقدمة من OpenAI وAnthropic وGoogle وغيرها، مما يتيح للمستخدمين اختيار النموذج والسعر الأنسب لحالات الاستخدام المختلفة.',
    'comfyui.description':
      'محرك سير عمل مفتوح المصدر قوي لتوليد الصور والفيديو والصوت، يدعم نماذج مثل SD وFLUX وQwen وHunyuan وWAN مع تحرير قائم على العقد ونشر خاص.',
    'deepseek.description':
      'تركز DeepSeek على أبحاث وتطبيقات الذكاء الاصطناعي؛ تتفوق أحدث نماذجها DeepSeek-V3 على نماذج مفتوحة مثل Qwen2.5-72B وLlama-3.1-405B، وتقترب من أداء النماذج المغلقة الرائدة مثل GPT-4o وClaude-3.5-Sonnet.',
    'fal.description': 'منصة وسائط توليدية مصممة للمطورين.',
    'fireworksai.description':
      'توفر Fireworks AI خدمات نماذج لغوية متقدمة مع دعم استدعاء الوظائف والمعالجة متعددة الوسائط. تم تحسين Firefunction V2 (المبني على Llama-3) لاستدعاء الوظائف والدردشة وتنفيذ التعليمات، بينما يدعم FireLLaVA-13B إدخال الصور والنصوص معًا. تشمل النماذج الأخرى Llama وMixtral.',
    'giteeai.description':
      'توفر Gitee AI واجهات برمجة تطبيقات بدون خوادم لخدمات استدلال النماذج اللغوية الكبيرة، جاهزة للاستخدام من قبل المطورين.',
    'github.description':
      'مع نماذج GitHub، يمكن للمطورين العمل كمهندسي ذكاء اصطناعي باستخدام نماذج رائدة في الصناعة.',
    'githubcopilot.description':
      'يمكنك الوصول إلى نماذج Claude وGPT وGemini من خلال اشتراكك في GitHub Copilot.',
    'glmcodingplan.description':
      'خطة الترميز GLM توفر الوصول إلى نماذج الذكاء الاصطناعي Zhipu بما في ذلك GLM-5 وGLM-4.7 لأداء مهام الترميز عبر اشتراك ثابت الرسوم.',
    'google.description':
      'عائلة Gemini من Google هي أكثر نماذج الذكاء الاصطناعي تطورًا للأغراض العامة، تم تطويرها بواسطة Google DeepMind للاستخدام متعدد الوسائط عبر النصوص والرموز والصور والصوت والفيديو. يمكن تشغيلها من مراكز البيانات إلى الأجهزة المحمولة بكفاءة عالية وانتشار واسع.',
    'groq.description':
      'توفر محركات الاستدلال LPU من Groq أداءً متميزًا في المعايير مع سرعة وكفاءة استثنائية، مما يضع معيارًا عاليًا للاستدلال منخفض الكمون في السحابة.',
    'higress.description':
      'Higress هو بوابة API سحابية أصلية تم تطويرها داخل Alibaba لمعالجة تأثير إعادة تحميل Tengine على الاتصالات طويلة الأمد وسد الفجوات في موازنة تحميل gRPC/Dubbo.',
    'huggingface.description':
      'توفر واجهة برمجة التطبيقات للاستدلال من Hugging Face طريقة سريعة لاستكشاف آلاف النماذج لمهام متعددة، مع وصول فوري إلى نماذج عالية الأداء لتجارب النماذج وتطوير تعلم الآلة.',
    'hunyuan.description':
      'نموذج لغوي كبير من تطوير Tencent يتميز بقدرات قوية في الكتابة باللغة الصينية، والتفكير المنطقي في السياقات المعقدة، وتنفيذ المهام بدقة.',
    'infiniai.description':
      'توفر خدمات نماذج لغوية كبيرة عالية الأداء وسهلة الاستخدام وآمنة لمطوري التطبيقات، تغطي كامل دورة العمل من تطوير النموذج إلى نشره في الإنتاج.',
    'internlm.description':
      'منظمة مفتوحة المصدر تركز على أبحاث النماذج الكبيرة والأدوات، وتوفر منصة فعالة وسهلة الاستخدام تتيح الوصول إلى أحدث النماذج والخوارزميات.',
    'jina.description':
      'تأسست Jina AI في عام 2020، وهي شركة رائدة في مجال البحث الذكي. تشمل تقنياتها نماذج المتجهات، ومعيدو الترتيب، ونماذج لغوية صغيرة لبناء تطبيقات بحث توليدية ومتعددة الوسائط عالية الجودة.',
    'kimicodingplan.description':
      'كود Kimi من Moonshot AI يوفر الوصول إلى نماذج Kimi بما في ذلك K2.5 لأداء مهام الترميز.',
    'lmstudio.description':
      'LM Studio هو تطبيق سطح مكتب لتطوير وتجربة النماذج اللغوية الكبيرة على جهازك.',
    'lobehub.description':
      'LobeHub Cloud يستخدم واجهات برمجية رسمية للوصول إلى نماذج الذكاء الاصطناعي ويقيس الاستخدام عبر أرصدة مرتبطة برموز النماذج.',
    'longcat.description':
      'LongCat هو سلسلة من نماذج الذكاء الاصطناعي التوليدية الكبيرة التي تم تطويرها بشكل مستقل بواسطة Meituan. تم تصميمه لتعزيز إنتاجية المؤسسة الداخلية وتمكين التطبيقات المبتكرة من خلال بنية حسابية فعالة وقدرات متعددة الوسائط قوية.',
    'minimax.description':
      'تأسست MiniMax في عام 2021، وتبني نماذج ذكاء اصطناعي متعددة الوسائط للأغراض العامة، بما في ذلك نماذج نصية بمليارات المعلمات، ونماذج صوتية وبصرية، بالإضافة إلى تطبيقات مثل Hailuo AI.',
    'minimaxcodingplan.description':
      'خطة الرموز MiniMax توفر الوصول إلى نماذج MiniMax بما في ذلك M2.7 لأداء مهام الترميز عبر اشتراك ثابت الرسوم.',
    'mistral.description':
      'تقدم Mistral نماذج متقدمة عامة ومتخصصة وبحثية للتفكير المعقد، والمهام متعددة اللغات، وتوليد الأكواد، مع دعم استدعاء الوظائف للتكامل المخصص.',
    'modelscope.description':
      'ModelScope هي منصة نماذج كخدمة من Alibaba Cloud، تقدم مجموعة واسعة من النماذج وخدمات الاستدلال.',
    'moonshot.description':
      'تقدم Moonshot، من Moonshot AI (شركة Beijing Moonshot Technology)، نماذج معالجة لغة طبيعية متعددة لحالات استخدام مثل إنشاء المحتوى، والبحث، والتوصيات، والتحليل الطبي، مع دعم قوي للسياقات الطويلة والتوليد المعقد.',
    'nebius.description':
      'توفر Nebius بنية تحتية عالية الأداء لمبتكري الذكاء الاصطناعي حول العالم من خلال مجموعات GPU واسعة النطاق ومنصة سحابية متكاملة رأسياً.',
    'newapi.description': 'منصة مفتوحة المصدر لتجميع وتوجيه خدمات الذكاء الاصطناعي المتعددة.',
    'novita.description':
      'تقدم Novita AI واجهات برمجة تطبيقات مرنة وموثوقة وفعالة من حيث التكلفة للنماذج اللغوية الكبيرة وتوليد الصور. تدعم نماذج مثل Llama 3 وMistral وتوفر واجهات برمجة تطبيقات قابلة للتوسع وسهلة الاستخدام للشركات الناشئة في مجال الذكاء الاصطناعي التوليدي.',
    'nvidia.description':
      'توفر NVIDIA NIM حاويات لخدمات استدلال ذاتية الاستضافة مع تسريع GPU عبر السحابة ومراكز البيانات وأجهزة RTX AI وأجهزة العمل، للنماذج المدربة مسبقًا والمخصصة.',
    'ollama.description':
      'تقدم Ollama نماذج لتوليد الأكواد، والرياضيات، والمعالجة متعددة اللغات، والدردشة، مع دعم للنشر المؤسسي والمحلي.',
    'ollamacloud.description':
      'توفر Ollama Cloud استدلالًا مدارًا مع وصول فوري إلى مكتبة نماذج Ollama وواجهات برمجة تطبيقات متوافقة مع OpenAI.',
    'openai.description':
      'OpenAI هي مختبر أبحاث رائد في مجال الذكاء الاصطناعي، طورت نماذج GPT التي أحدثت تقدمًا كبيرًا في معالجة اللغة الطبيعية، مع أداء قوي وقيمة عالية في البحث والأعمال والابتكار.',
    'openrouter.description':
      'يوفر OpenRouter الوصول إلى العديد من النماذج المتقدمة من OpenAI وAnthropic وLLaMA وغيرها، مما يتيح للمستخدمين اختيار النموذج والسعر الأنسب لحالتهم.',
    'perplexity.description':
      'تقدم Perplexity نماذج دردشة متقدمة، بما في ذلك إصدارات Llama 3.1، للاستخدام عبر الإنترنت وغير المتصل ولمهام معالجة اللغة الطبيعية المعقدة.',
    'ppio.description':
      'توفر PPIO واجهات برمجة تطبيقات موثوقة وفعالة من حيث التكلفة للنماذج المفتوحة، بما في ذلك DeepSeek وLlama وQwen وغيرها من النماذج الرائدة.',
    'qiniu.description':
      'توفر Qiniu خدمات استدلال ذكاء اصطناعي في الوقت الحقيقي وعلى دفعات، موثوقة وسهلة الاستخدام وفعالة من حيث التكلفة.',
    'qwen.description':
      'Qwen هو نموذج لغوي كبير من Alibaba Cloud يتميز بفهم وتوليد قوي، ويغطي الأسئلة والأجوبة، والكتابة، والتعبير عن الرأي، والبرمجة في مجالات متعددة.',
    'replicate.description':
      'تشغل Replicate نماذج صور مفتوحة المصدر مثل FLUX وStable Diffusion عبر واجهة برمجة تطبيقات سحابية بسيطة.',
    'sambanova.description':
      'تتيح SambaNova Cloud للمطورين استخدام نماذج مفتوحة المصدر رائدة مع استدلال فائق السرعة.',
    'search1api.description':
      'توفر Search1API الوصول إلى نماذج DeepSeek مع إمكانية الاتصال بالويب، بما في ذلك إصدارات قياسية وسريعة بأحجام معلمات متعددة.',
    'sensenova.description':
      'تقدم SenseNova خدمات نماذج لغوية كبيرة كاملة المكدس، فعالة وسهلة الاستخدام، مدعومة ببنية SenseTime التحتية.',
    'siliconcloud.description':
      'SiliconCloud هي خدمة سحابية للذكاء الاصطناعي التوليدي فعالة من حيث التكلفة، مبنية على نماذج مفتوحة المصدر قوية.',
    'spark.description':
      'يوفر iFLYTEK Spark ذكاءً اصطناعيًا متعدد اللغات قويًا عبر مجالات متعددة، مما يمكّن من الابتكار في الأجهزة الذكية والرعاية الصحية والتمويل وغيرها.',
    'stepfun.description':
      'تقدم نماذج Stepfun قدرات رائدة في التعدد الوسائطي والتفكير المعقد، مع فهم طويل للسياق وتنظيم بحث مستقل قوي.',
    'straico.description':
      'يُبسط Straico دمج الذكاء الاصطناعي من خلال توفير مساحة عمل موحدة تجمع بين أفضل نماذج الذكاء الاصطناعي التوليدية للنصوص والصور والصوت، مما يمكّن المسوقين ورواد الأعمال والهواة من الوصول السلس إلى أدوات الذكاء الاصطناعي المتنوعة.',
    'taichu.description':
      'Taichu هو نموذج متعدد الوسائط من الجيل التالي من CASIA ومعهد ووهان للذكاء الاصطناعي، يدعم الأسئلة والأجوبة متعددة الجولات، والكتابة، وتوليد الصور، وفهم الأبعاد الثلاثية، وتحليل الإشارات بقدرات إدراكية وإبداعية متقدمة.',
    'tencentcloud.description':
      'توفر Tencent Cloud محرك معرفة قائم على النماذج اللغوية الكبيرة يقدم إجابات معرفية شاملة للمؤسسات والمطورين، مع خدمات معيارية مثل تحليل المستندات، والتقسيم، والتضمين، وإعادة الصياغة متعددة الجولات لبناء حلول ذكاء اصطناعي مخصصة.',
    'togetherai.description':
      'توفر Together AI أداءً رائدًا من خلال نماذج مبتكرة، وتخصيص واسع، وتوسع سريع، ونشر بسيط لتلبية احتياجات المؤسسات.',
    'upstage.description':
      'تقوم Upstage ببناء نماذج ذكاء اصطناعي لتلبية احتياجات الأعمال، بما في ذلك Solar LLM وDocument AI، مع واجهات دردشة تدعم استدعاء الوظائف، والترجمة، والتضمين، وحالات الاستخدام المتخصصة.',
    'v0.description':
      'v0 هو مساعد برمجة ثنائي يحول الأفكار المكتوبة بلغة طبيعية إلى كود وواجهة مستخدم لمشروعك.',
    'vercelaigateway.description':
      'يوفر Vercel AI Gateway واجهة برمجة تطبيقات موحدة لأكثر من 100 نموذج من OpenAI وAnthropic وGoogle وغيرها، مع ميزات الميزانية، ومراقبة الاستخدام، وموازنة التحميل، والتجاوز التلقائي.',
    'vertexai.description':
      'عائلة Gemini من Google هي أكثر نماذج الذكاء الاصطناعي تطورًا للأغراض العامة، تم تطويرها بواسطة Google DeepMind للاستخدام متعدد الوسائط عبر النصوص والرموز والصور والصوت والفيديو. يمكن تشغيلها من مراكز البيانات إلى الأجهزة المحمولة، مما يعزز الكفاءة ومرونة النشر.',
    'vllm.description': 'vLLM مكتبة سريعة وسهلة الاستخدام لاستدلال وخدمة النماذج اللغوية الكبيرة.',
    'volcengine.description':
      'توفر منصة نماذج ByteDance وصولًا آمنًا وغنيًا بالميزات وفعالًا من حيث التكلفة إلى النماذج، بالإضافة إلى أدوات شاملة للبيانات، والتخصيص، والاستدلال، والتقييم.',
    'volcenginecodingplan.description':
      'خطة الترميز Volcengine من ByteDance توفر الوصول إلى نماذج ترميز متعددة بما في ذلك Doubao-Seed-Code وGLM-4.7 وDeepSeek-V3.2 وKimi-K2.5 عبر اشتراك ثابت الرسوم.',
    'wenxin.description':
      'منصة متكاملة للمؤسسات لتطوير النماذج الأساسية والتطبيقات الذكية، تقدم أدوات شاملة لسير عمل النماذج التوليدية وتطبيقاتها.',
    'xai.description':
      'تقوم xAI ببناء ذكاء اصطناعي لتسريع الاكتشاف العلمي، بهدف تعميق فهم البشرية للكون.',
    'xiaomimimo.description':
      'تقدم Xiaomi MiMo خدمة نموذج محادثة متوافقة مع واجهة برمجة تطبيقات OpenAI. يدعم نموذج mimo-v2-flash التفكير العميق، الإخراج المتدفق، استدعاء الوظائف، نافذة سياق بسعة 256 ألف، وإخراجًا أقصى يصل إلى 128 ألف.',
    'xinference.description':
      'Xorbits Inference (Xinference) هي منصة مفتوحة المصدر تسهّل تشغيل ودمج نماذج الذكاء الاصطناعي. تتيح تشغيل النماذج اللغوية الكبيرة، ونماذج التضمين، والنماذج متعددة الوسائط محليًا أو في السحابة لبناء تطبيقات ذكاء اصطناعي قوية.',
    'zenmux.description':
      'ZenMux هي منصة تجميع ذكاء اصطناعي موحدة تدعم OpenAI وAnthropic وGoogle VertexAI وغيرها، مع توجيه مرن لتبديل وإدارة النماذج بسهولة.',
    'zeroone.description':
      '01.AI تقود ثورة الذكاء الاصطناعي 2.0 المتمحورة حول الإنسان، باستخدام النماذج اللغوية الكبيرة لخلق قيمة اقتصادية واجتماعية وبناء أنظمة بيئية ونماذج أعمال جديدة.',
    'zhipu.description':
      'توفر ZhiPu AI منصة مفتوحة للنماذج متعددة الوسائط واللغوية، تغطي معالجة النصوص، وفهم الصور، والمساعدة في البرمجة.',
  },
  ps = Object.freeze(
  ...
  fo = {
    ...
    'evaluation.table.columns.actions.confirmRun':
      'هل أنت متأكد أنك تريد بدء التشغيل؟ سيتم تنفيذ مهمة التقييم بشكل غير متزامن في الخلفية، ولن يؤثر إغلاق الصفحة على تنفيذ المهمة.',
  ...
  Yi = 'الإعدادات المتقدمة',
  Zi = 'مهارة الوكيل',
  ea = 'جارٍ التحقق...',
  ta = 'جارٍ التحقق من الأذونات...',
  ia = 'النشر في المجتمع',
  aa = 'ابدأ المحادثة',
  yo = {
    '_cloud.officialProvider': 'خدمة النماذج الرسمية من {{name}}',
    'about.title': 'حول',
    'accountDeletion.cancelButton': 'إلغاء الحذف',
    'accountDeletion.cancelConfirmTitle': 'هل تريد إلغاء طلب حذف الحساب؟',
    'accountDeletion.cancelFailed': 'فشل في إلغاء طلب الحذف',
    'accountDeletion.cancelSuccess': 'تم إلغاء طلب الحذف',
    'accountDeletion.confirmCheckbox':
      'لقد قرأت وفهمت ما ورد أعلاه، وأؤكد رغبتي في متابعة حذف الحساب',
    'accountDeletion.confirmContent':
      'بعد الإرسال، ستدخل في <0>فترة تهدئة مدتها 72 ساعة</0> يمكنك خلالها الإلغاء في أي وقت. بعد انتهاء هذه الفترة، سيتم حذف بيانات حسابك نهائيًا، وسيتم إلغاء الفواتير غير المدفوعة فورًا، ولن يتم رد أي رسوم مدفوعة. سيتم الاحتفاظ بسجلات التسجيل والحذف لأغراض الامتثال.',
    'accountDeletion.confirmOk': 'حذف الحساب',
    'accountDeletion.confirmRequired': 'يرجى تأكيد فهمك للعواقب',
    'accountDeletion.confirmTitle': 'هل تريد حذف الحساب؟',
    'accountDeletion.desc':
      'احذف حسابك وجميع البيانات المرتبطة به بشكل دائم. لا يمكن التراجع عن هذا الإجراء.',
    'accountDeletion.pendingDesc': 'تم جدولة حذف حسابك',
    'accountDeletion.pendingMessage': 'سيتم حذف حسابك خلال {{hours}} ساعة',
    'accountDeletion.reasonPlaceholder': 'يرجى إخبارنا بسبب رغبتك في حذف حسابك...',
    'accountDeletion.reasonRequired': 'يرجى تقديم سبب الحذف',
    'accountDeletion.requestButton': 'طلب حذف الحساب',
    'accountDeletion.requestFailed': 'فشل في تقديم طلب حذف الحساب',
    'accountDeletion.requestSuccess': 'تم تقديم طلب الحذف',
    'accountDeletion.sectionTitle': 'حذف الحساب',
    ...
    'agentDocuments.overwriteConfirm.summary':
      'تطبيق {{templateName}} سيؤدي إلى إنشاء {{createCount}} مستندات جديدة واستبدال {{overwriteCount}} مستندات موجودة.',
    ...
    'agentSkillDetail.addedAt': 'تمت الإضافة',
    'agentSkillDetail.publishedAt': 'تم النشر',
    'agentSkillDetail.repository': 'مستودع GitHub',
    'agentSkillDetail.skillContent': 'محتوى المهارة',
    'agentSkillDetail.sourceUrl': 'مصدر استيراد المهارة',
    'agentSkillDetail.updatedAt': 'تم التحديث',
    'agentSkillEdit.descriptionDesc':
      'ملخص موجز لما تفعله المهارة، يساعد الوكيل على فهم متى يستخدمها',
    'agentSkillEdit.fileReadonly': 'هذا الملف للقراءة فقط. يمكن تعديل وصف المهارة والتعليمات فقط.',
    'agentSkillEdit.instructions': 'التعليمات',
    'agentSkillEdit.instructionsDesc':
      'التعليمات الأساسية بصيغة Markdown التي تحدد سلوك المهارة وسير العمل',
    'agentSkillEdit.instructionsPlaceholder': 'أدخل تعليمات المهارة بصيغة Markdown...',
    'agentSkillEdit.nameDesc': 'المعرف الفريد لهذه المهارة، غير قابل للتعديل بعد الإنشاء',
    'agentSkillEdit.saveSuccess': 'تم تحديث المهارة بنجاح',
    'agentSkillEdit.title': 'إعدادات المهارة',
    'agentSkillItem.deleteConfirm.desc':
      'هل أنت متأكد أنك تريد حذف مهارة الوكيل "{{name}}"؟ لا يمكن التراجع عن هذا الإجراء.',
    'agentSkillItem.deleteConfirm.title': 'حذف مهارة الوكيل',
    'agentSkillModal.content': 'محتوى المهارة',
    'agentSkillModal.contentPlaceholder': 'أدخل محتوى المهارة بصيغة Markdown...',
    'agentSkillModal.description': 'الوصف',
    'agentSkillModal.descriptionPlaceholder': 'قم بوصف هذه المهارة بشكل موجز',
    'agentSkillModal.github.desc': 'استيراد المهارات مباشرة من مستودع GitHub عام.',
    'agentSkillModal.github.title': 'استيراد من GitHub',
    'agentSkillModal.github.urlPlaceholder': 'https://github.com/username/repo',
    'agentSkillModal.importError': 'فشل الاستيراد: {{error}}',
    'agentSkillModal.importSuccess': 'تم استيراد مهارة الوكيل بنجاح',
    'agentSkillModal.upload.desc': 'قم برفع ملف .zip أو .skill محلي للتثبيت.',
    'agentSkillModal.upload.dragText': 'اسحب وأفلت أو انقر للرفع',
    'agentSkillModal.upload.requirementSkillMd': 'SKILL.md يحتوي على اسم المهارة ووصفها بصيغة YAML',
    'agentSkillModal.upload.requirementZip':
      'ملف .zip أو .skill يحتوي على SKILL.md في الدليل الرئيسي',
    'agentSkillModal.upload.requirements': 'متطلبات الملف',
    'agentSkillModal.upload.title': 'رفع المهارة',
    'agentSkillModal.upload.uploading': 'جارٍ الرفع...',
    'agentSkillModal.url.desc': 'استيراد مهارة عن طريق توفير رابط مباشر إلى ملف SKILL.md.',
    'agentSkillModal.url.title': 'استيراد من رابط',
    ...
    'creds.actions.deleteConfirm.content':
      'سيتم حذف بيانات الاعتماد هذه بشكل دائم. لا يمكن التراجع عن هذا الإجراء.',
    ...
    'danger.clear.desc':
      'سيتم حذف جميع البيانات، بما في ذلك الوكلاء والملفات والرسائل والمهارات. لن يتم حذف حسابك.',
    ...
    'hotkey.errors.INVALID_FORMAT':
      'تنسيق اختصار غير صالح: يرجى استخدام التنسيق الصحيح (مثل CommandOrControl+E)',
    ...
    'hotkey.invalidCombination':
      'يجب أن يحتوي الاختصار على مفتاح معدل واحد على الأقل (Ctrl، Alt، Shift) ومفتاح عادي واحد',
    ...
    'llm.customModelCards.confirmDelete':
      'أنت على وشك حذف هذا النموذج المخصص. لا يمكن استعادته بعد الحذف. يرجى المتابعة بحذر.',
    'llm.customModelCards.modelConfig.azureDeployName.extra':
      'الحقل المطلوب فعليًا في Azure OpenAI',
    ...
    'llm.customModelCards.modelConfig.displayName.placeholder':
      'أدخل اسم العرض للنموذج، مثل ChatGPT، GPT-4، إلخ.',
    'llm.customModelCards.modelConfig.displayName.title': 'اسم عرض النموذج',
    'llm.customModelCards.modelConfig.files.extra':
      'تنفيذ تحميل الملفات الحالي هو حل مؤقت مخصص للتجارب الشخصية فقط. يرجى انتظار ميزة تحميل الملفات الكاملة في التحديثات القادمة.',
    'llm.customModelCards.modelConfig.files.title': 'دعم تحميل الملفات',
    'llm.customModelCards.modelConfig.functionCall.extra':
      'هذا يمكّن فقط استدعاء المهارات داخل التطبيق. دعم النموذج الفعلي لاستدعاء المهارات يعتمد على النموذج نفسه — يرجى اختباره.',
    ...
    'llm.customModelCards.modelConfig.id.placeholder':
      'أدخل معرف النموذج، مثل gpt-4-turbo-preview أو claude-2.1',
    ...
    'llm.customModelCards.modelConfig.vision.extra':
      'هذا يمكّن فقط تحميل الصور داخل التطبيق. دعم النموذج للرؤية يعتمد على النموذج نفسه — يرجى اختباره.',
    ...
    'llm.modelList.desc':
      'حدد النماذج التي سيتم عرضها في الجلسة. سيتم عرض النماذج المحددة في قائمة النماذج.',
    ...
    'marketPublish.forkConfirm.description':
      'أنت على وشك نشر نسخة مشتقة تستند إلى وكيل موجود من المجتمع. سيتم إنشاء وكيلك الجديد كإدخال منفصل في السوق.',
    'marketPublish.forkConfirm.descriptionGroup':
      'أنت على وشك نشر نسخة مشتقة تستند إلى مجموعة موجودة من المجتمع. سيتم إنشاء مجموعتك الجديدة كإدخال منفصل في السوق.',
    ...
    'marketPublish.modal.identifier.extra':
      'هذا هو المعرف الفريد للوكيل. استخدم أحرفًا صغيرة وأرقامًا وشرطات.',
    ...
    'marketPublish.modal.identifier.patternError':
      'يمكن أن يحتوي المعرف فقط على أحرف صغيرة وأرقام وشرطات',
    ...
    'marketPublish.modal.messages.notAuthenticated':
      'يرجى تسجيل الدخول إلى حسابك في المجتمع أولاً.',
    ...
    'marketPublish.resultModal.message':
      'تم إرسال وكيلك للمراجعة. بمجرد الموافقة عليه، سيتم نشره تلقائيًا.',
    'marketPublish.resultModal.messageGroup':
      'تم إرسال مجموعتك للمراجعة. بمجرد الموافقة عليها، سيتم نشرها تلقائيًا.',
    ...
    'marketPublish.validation.confirmPublish': 'هل أنت متأكد أنك تريد النشر في السوق؟',
    ...
    'marketPublish.validation.underReview':
      'إصدارك الجديد قيد المراجعة حاليًا. يرجى انتظار الموافقة قبل نشر إصدار جديد.',
    ...
    'memory.effort.level.low': 'منخفض',
    'memory.effort.level.medium': 'متوسط',
    'memory.effort.low': 'منخفض — عمليات ذاكرة محدودة',
    'memory.effort.medium': 'متوسط — سلوك متوازن',
    'memory.effort.title': 'العدوانية',
    'memory.enabled.desc':
      'اسمح لـ LobeHub باستخلاص التفضيلات والمعلومات من المحادثات واستخدامها لاحقًا. يمكنك عرض أو تعديل أو مسح الذاكرة في أي وقت.',
    ...
    'myAgents.actions.deprecateConfirmContent':
      'بعد الإيقاف، سيتم إزالة هذا الوكيل نهائيًا من السوق ولا يمكن إعادة نشره. هذا الإجراء لا يمكن التراجع عنه، يرجى المتابعة بحذر.',
...
- إرشادات السلوك`,
    ...
    'settingAppearance.contextMenuMode.desc':
      'تمكين قائمة النقر بزر الماوس الأيمن لبعض عناصر القائمة.',
    ...
    'settingChat.autoCreateTopicThreshold.desc':
      'إنشاء موضوع تلقائيًا عند تجاوز عدد الرسائل الحالية هذه القيمة',
    ...
    'settingChat.compressThreshold.desc':
      'عند تجاوز عدد الرسائل غير المضغوطة هذه القيمة، سيتم تطبيق الضغط',
    'settingChat.compressThreshold.title': 'حد ضغط طول سجل الرسائل',
    'settingChat.enableAutoCreateTopic.desc':
      'ما إذا كان سيتم إنشاء موضوع تلقائيًا أثناء المحادثة، فعال فقط في المواضيع المؤقتة',
    'settingChat.enableAutoCreateTopic.title': 'إنشاء موضوع تلقائيًا',
    'settingChat.enableAutoScrollOnStreaming.desc': 'تجاوز الإعداد العام لهذا المساعد',
    'settingChat.enableAutoScrollOnStreaming.title':
      'التمرير التلقائي أثناء استجابة الذكاء الاصطناعي',
    ...
    'settingChat.enableStreaming.desc':
      'تمكين الإخراج المتدفق لعرض الردود في الوقت الفعلي. عند التعطيل، يتم عرض الرد الكامل فقط.',
    ...
    'settingChat.inputTemplate.placeholder':
      'سيتم استبدال قالب المعالجة المسبقة {{text}} بمعلومات الإدخال الفعلية',
    ...
    'settingChatAppearance.autoScrollOnStreaming.desc':
      'التمرير تلقائيًا إلى الأسفل عند توليد الذكاء الاصطناعي للاستجابة',
    ...
    'settingChatAppearance.transitionMode.options.none.desc':
      'يعتمد هذا على طريقة إخراج استجابة النموذج؛ يرجى اختباره بنفسك.',
    ...
    'settingGroupChat.maxResponseInRow.desc':
      'حدد عدد الرسائل المتتالية التي يمكن للعضو الرد بها. اضبط على 0 لتعطيل هذا الحد.',
    'settingGroupChat.maxResponseInRow.title': 'عدد الردود المتتالية',
    'settingGroupChat.model.desc':
      'أعضاء المجموعة غير متأثرين. بعض النماذج لا يمكن استخدامها كنموذج منسق.',
    ...
    'settingGroupChat.systemPrompt.desc':
      'موجه نظام مخصص لمضيف دردشة المجموعة. قد يؤثر على سلوك المضيف الافتراضي.',
    ...
    'settingGroupMembers.host.description':
      'مع وجود منسق، يمكن للمجموعة العمل تلقائيًا بشكل أكبر — مثالي للمهام المفتوحة.',
    ...
    'settingImage.defaultCount.desc':
      'تحديد عدد الصور الافتراضي الذي يتم إنشاؤه عند بدء مهمة جديدة في لوحة توليد الصور.',
    ...
    'settingModel.enableContextCompression.desc':
      'ضغط الرسائل التاريخية تلقائيًا إلى ملخصات عند تجاوز المحادثة 64,000 رمز، مما يوفر من 60٪ إلى 80٪ من استخدام الرموز',
    ...
    'settingModel.frequencyPenalty.desc':
      'كلما زادت القيمة، زادت تنوع وغنى المفردات؛ وكلما انخفضت، أصبحت اللغة أبسط وأكثر مباشرة.',
    ...
    'settingModel.presencePenalty.desc':
      'كلما زادت القيمة، زاد الميل لاستخدام تعبيرات متنوعة وتجنب تكرار المفاهيم؛ وكلما انخفضت، زاد الميل لتكرار المفاهيم أو السرد، مما يؤدي إلى تعبير أكثر اتساقًا.',
    'settingModel.presencePenalty.title': 'تنوع التعبير',
    'settingModel.reasoningEffort.desc':
      'القيم الأعلى تعزز القدرة على الاستدلال ولكن قد تزيد من وقت الاستجابة واستهلاك الرموز.',
    ...
    'settingModel.temperature.desc':
      'كلما زادت القيمة، أصبحت الردود أكثر إبداعًا وخيالًا؛ وكلما انخفضت، أصبحت أكثر دقة وانضباطًا.',
    'settingModel.temperature.title': 'مستوى الإبداع',
    'settingModel.temperature.warning':
      'إذا تم ضبط مستوى الإبداع على قيمة عالية جدًا، فقد تصبح المخرجات غير مفهومة.',
    'settingModel.title': 'إعدادات النموذج',
    'settingModel.topP.desc':
      'عدد الاحتمالات التي يتم أخذها في الاعتبار؛ القيمة الأعلى تقبل المزيد من الإجابات المحتملة، بينما القيمة الأقل تميل لاختيار الإجابة الأكثر احتمالاً. لا يُنصح بتغييرها مع مستوى الإبداع.',
    'settingModel.topP.title': 'الانفتاح على الأفكار',
    'settingOpening.openingMessage.desc':
      'الرسالة الافتتاحية التي تظهر عند بدء المحادثة، وتُستخدم لتقديم ميزات الوكيل',
    'settingOpening.openingMessage.placeholder':
      'مرحبًا، أنا وكيلك المخصص. يمكنك البدء في الدردشة معي فورًا، أو الانتقال إلى إعدادات الوكيل لإكمال معلوماتي.',
    ...
    'settingOpening.openingQuestions.empty':
      'أضف أسئلة افتتاحية لمساعدة المستخدمين على بدء المحادثة بسرعة',
    ...
    'settingSystemTools.category.browserAutomation.desc':
      'أدوات لأتمتة المتصفح بدون واجهة والتفاعل مع الويب',
    'settingSystemTools.category.contentSearch': 'البحث في المحتوى',
    'settingSystemTools.category.contentSearch.desc': 'أدوات للبحث عن النصوص داخل الملفات',
    'settingSystemTools.category.fileSearch': 'البحث عن الملفات',
    'settingSystemTools.category.fileSearch.desc': 'أدوات للعثور على الملفات حسب الاسم أو النمط',
    'settingSystemTools.category.runtimeEnvironment': 'بيئة التشغيل',
    'settingSystemTools.category.runtimeEnvironment.desc': 'بيئات تشغيل لتشغيل السكربتات والحزم',
    'settingSystemTools.detecting': 'جارٍ الكشف...',
    'settingSystemTools.redetect': 'إعادة الكشف',
    'settingSystemTools.status.available': 'متاح',
    'settingSystemTools.status.notDetected': 'لم يتم الكشف',
    'settingSystemTools.status.unavailable': 'غير متاح',
    'settingSystemTools.title': 'أدوات النظام',
    'settingSystemTools.tools.ag.desc':
      'The Silver Searcher - أداة سريعة للبحث في الشيفرة البرمجية',
    'settingSystemTools.tools.agentBrowser.desc':
      'Agent-browser - واجهة سطر الأوامر لأتمتة المتصفح بدون واجهة لوكلاء الذكاء الاصطناعي',
    ...
    'settingTTS.showAllLocaleVoice.desc':
      'إذا تم إيقافه، سيتم عرض الأصوات المتوفرة للغة الحالية فقط',
    ...
    'settingTTS.sttAutoStop.desc':
      'عند الإيقاف، لن يتوقف التعرف على الكلام تلقائيًا ويتطلب النقر يدويًا للإيقاف',
    ...
    'settingTTS.ttsService.desc':
      'إذا كنت تستخدم خدمة OpenAI لتحويل النص إلى كلام، تأكد من تفعيل خدمة نموذج OpenAI',
...
💡 نصيحة: كلما كانت وصفك أكثر تحديدًا، تمكنا من تلبية احتياجاتك بشكل أفضل`,
    ...
    'submitAgentModal.metaMiss':
      'يرجى إكمال معلومات الوكيل قبل الإرسال. يجب أن تتضمن الاسم والوصف والوسوم.',
    ...
    'sync.warning.tip':
      'بعد فترة طويلة من الاختبار المجتمعي، قد لا تلبي مزامنة WebRTC احتياجات مزامنة البيانات العامة بشكل موثوق. يرجى <1>نشر خادم الإشارة</1> قبل الاستخدام.',
    'sync.webrtc.channelName.desc':
      'سيستخدم WebRTC هذا الاسم لإنشاء قناة مزامنة. تأكد من أن الاسم فريد.',
    ...
    'sync.webrtc.channelPassword.desc':
      'أضف كلمة مرور لضمان خصوصية القناة. يمكن فقط للأجهزة التي تملك كلمة المرور الصحيحة الانضمام.',
    ...
    'sync.webrtc.desc':
      'الاتصال بالبيانات في الوقت الحقيقي من نظير إلى نظير يتطلب أن تكون جميع الأجهزة متصلة بالإنترنت.',
    ...
    'systemAgent.customPrompt.desc':
      'عند تعبئته، سيستخدم الوكيل النظامي الموجه المخصص عند توليد المحتوى',
    ...
    'systemAgent.generationTopic.modelDesc':
      'النموذج المخصص لتسمية مواضيع فن الذكاء الاصطناعي تلقائيًا',
    'systemAgent.generationTopic.title': 'وكيل تسمية مواضيع فن الذكاء الاصطناعي',
    'systemAgent.helpInfo':
      'عند إنشاء وكيل جديد، سيتم استخدام إعدادات الوكيل الافتراضية كقيم مسبقة.',
    ...
    'tab.about': 'حول',
    'tab.addAgentSkill': 'إضافة مهارة الوكيل',
    'tab.addCustomMcp': 'إضافة مهارة MCP مخصصة',
    'tab.addCustomMcp.desc': 'تكوين خادم MCP مخصص يدويًا',
    'tab.addCustomSkill': 'إضافة مهارة مخصصة',
    'tab.advanced': 'متقدم',
    'tab.advanced.updateChannel.canary': 'كناري',
    'tab.advanced.updateChannel.canaryDesc':
      'يتم تشغيله عند كل دمج PR، مع عدة إصدارات يومياً. الأكثر عدم استقراراً.',
    'tab.advanced.updateChannel.desc':
      'افتراضياً، يتم تلقي الإشعارات للتحديثات المستقرة. قنوات Nightly وCanary تتلقى إصدارات ما قبل الإصدار التي قد تكون غير مستقرة للعمل الإنتاجي.',
    ...
    'tab.advanced.updateChannel.stableDesc': 'إصدارات جاهزة للإنتاج.',
    'tab.advanced.updateChannel.title': 'قناة التحديث',
    ...
    'tab.importFromGithub': 'استيراد من GitHub',
    'tab.importFromGithub.desc': 'استيراد من مستودع GitHub عام',
    'tab.importFromUrl': 'استيراد من رابط',
    'tab.importFromUrl.desc': 'استيراد عبر رابط مباشر إلى SKILL.md',
    'tab.llm': 'نموذج اللغة',
    ...
    'tools.builtins.lobe-artifacts.description':
      'إنشاء ومعاينة مكونات واجهة المستخدم التفاعلية، وتصوير البيانات، والمخططات، والرسومات بصيغة SVG، وتطبيقات الويب بشكل مباشر. أنشئ محتوى بصريًا غنيًا يمكن للمستخدمين التفاعل معه مباشرة.',
    'tools.builtins.lobe-artifacts.readme':
      'أنشئ معاينات حية وتفاعلية لمكونات واجهة المستخدم، وتصوير البيانات، والمخططات، والرسومات بصيغة SVG، وتطبيقات الويب. أنشئ محتوى بصريًا غنيًا يمكن للمستخدمين التفاعل معه مباشرة.',
    'tools.builtins.lobe-artifacts.title': 'القطع الفنية',
    'tools.builtins.lobe-calculator.description':
      'إجراء العمليات الحسابية، حل المعادلات، والعمل مع التعبيرات الرمزية',
    'tools.builtins.lobe-calculator.readme':
      'آلة حاسبة رياضية متقدمة تدعم العمليات الحسابية الأساسية، المعادلات الجبرية، عمليات التفاضل والتكامل، والرياضيات الرمزية. تشمل تحويل القواعد، حل المعادلات، التفاضل، التكامل، وأكثر.',
    'tools.builtins.lobe-calculator.title': 'آلة حاسبة',
    'tools.builtins.lobe-cloud-sandbox.description':
      'تنفيذ تعليمات برمجية بلغة بايثون، جافاسكريبت، وتايب سكريبت في بيئة سحابية معزولة. شغّل أوامر الصدفة، إدارة الملفات، البحث باستخدام تعبيرات regex، وتصدير النتائج بأمان.',
    'tools.builtins.lobe-cloud-sandbox.readme':
      'نفّذ تعليمات برمجية بلغة Python وJavaScript وTypeScript في بيئة سحابية معزولة. شغّل أوامر الصدفة، وأدر الملفات، وابحث في المحتوى باستخدام regex، وصدّر النتائج بأمان.',
    'tools.builtins.lobe-cloud-sandbox.title': 'بيئة سحابية تجريبية',
    'tools.builtins.lobe-gtd.description':
      'خطط للأهداف وتابع التقدم باستخدام منهجية GTD. أنشئ خططًا استراتيجية، وأدر قوائم المهام مع تتبع الحالة، ونفّذ مهام غير متزامنة طويلة الأمد.',
    'tools.builtins.lobe-gtd.readme':
      'خطط لأهدافك وتابع تقدمك باستخدام منهجية GTD. أنشئ خططًا استراتيجية، وأدر قوائم المهام مع تتبع الحالة، ونفّذ المهام غير المتزامنة طويلة الأمد.',
    'tools.builtins.lobe-gtd.title': 'أدوات GTD',
    'tools.builtins.lobe-local-system.description':
      'الوصول إلى نظام الملفات المحلي على سطح المكتب. قراءة، وكتابة، والبحث، وتنظيم الملفات. تنفيذ أوامر الصدفة مع دعم المهام الخلفية والبحث في المحتوى باستخدام تعبيرات regex.',
    'tools.builtins.lobe-local-system.readme':
      'يمكنك الوصول إلى نظام الملفات المحلي على سطح المكتب. اقرأ، واكتب، وابحث، ونظّم الملفات. نفّذ أوامر الصدفة مع دعم المهام الخلفية وابحث في المحتوى باستخدام أنماط regex.',
    'tools.builtins.lobe-local-system.title': 'النظام المحلي',
    'tools.builtins.lobe-notebook.description':
      'إنشاء وإدارة مستندات دائمة ضمن مواضيع المحادثة. احفظ الملاحظات، والتقارير، والمقالات، ومحتوى Markdown الذي يبقى متاحًا عبر الجلسات.',
    'tools.builtins.lobe-notebook.readme':
      'أنشئ وادِر مستندات دائمة ضمن مواضيع المحادثة. احفظ الملاحظات، والتقارير، والمقالات، ومحتوى Markdown ليبقى متاحًا عبر الجلسات.',
    'tools.builtins.lobe-notebook.title': 'دفتر الملاحظات',
    'tools.builtins.lobe-user-memory.description':
      'أنشئ قاعدة معرفة مخصصة عنك. تذكّر التفضيلات، وتتبع الأنشطة والتجارب، واحفظ معلومات الهوية، واسترجع السياق المناسب في المحادثات المستقبلية.',
    'tools.builtins.lobe-user-memory.readme':
      'أنشئ قاعدة معرفة مخصصة عنك. تذكّر التفضيلات، وتتبع الأنشطة والتجارب، واحتفظ بمعلومات الهوية، واسترجع السياق المناسب في المحادثات المستقبلية.',
    ...
    'tools.builtins.uninstallConfirm.desc':
      'هل أنت متأكد أنك تريد إلغاء تثبيت {{name}}؟ سيتم إزالة هذه المهارة من الوكيل الحالي.',
    ...
    'tools.klavis.servers.airtable.description':
      'Airtable هي منصة قواعد بيانات وجداول بيانات سحابية تجمع بين مرونة الجداول وقوة قواعد البيانات، مما يمكّن الفرق من تنظيم المشاريع وتتبعها والتعاون فيها من خلال طرق عرض قابلة للتخصيص وميزات أتمتة قوية.',
    'tools.klavis.servers.airtable.readme':
      'تكامل مع Airtable لإدارة قواعد البيانات وسير العمل. استعلم عن السجلات، وأنشئ إدخالات، وحدث البيانات، وأتمت العمليات باستخدام طرق عرض قابلة للتخصيص وميزات تتبع قوية.',
    'tools.klavis.servers.cal-com.description':
      'Cal.com هي منصة جدولة مفتوحة المصدر تساعدك على تحديد مواعيد الاجتماعات دون الحاجة إلى تبادل الرسائل الإلكترونية. إدارة أنواع الفعاليات، الحجوزات، التوفر، والتكامل مع التقويمات لتحديد المواعيد بسلاسة.',
    'tools.klavis.servers.cal-com.readme':
      'اتصل بـ Cal.com لإدارة جدولك ومواعيدك. اعرض التوفر، واحجز الاجتماعات، وأدر أنواع الفعاليات، وأتمت تقويمك من خلال المحادثة الطبيعية.',
    'tools.klavis.servers.clickup.description':
      'ClickUp هي منصة شاملة لإدارة المشاريع والإنتاجية تساعد الفرق على تنظيم المهام، إدارة المشاريع، والتعاون بفعالية من خلال سير عمل قابل للتخصيص وميزات تتبع قوية.',
    'tools.klavis.servers.clickup.readme':
      'اتصل بـ ClickUp لإدارة المهام، وتتبع المشاريع، وتنظيم عملك. أنشئ مهام، وحدث الحالات، وأدر سير العمل المخصص، وتعاون مع فريقك باستخدام أوامر اللغة الطبيعية.',
    'tools.klavis.servers.confluence.description':
      'Confluence هي مساحة عمل جماعية حيث يلتقي التعاون والمعرفة.',
    'tools.klavis.servers.confluence.readme':
      'اتصل بـ Confluence للوصول إلى مستندات الفريق وإدارتها. ابحث في الصفحات، وأنشئ محتوى، ونظّم المساحات، وابنِ قاعدة معرفتك بمساعدة الذكاء الاصطناعي الحواري.',
    'tools.klavis.servers.dropbox.description':
      'حل متكامل لإدارة الملفات على Dropbox. رفع، تنزيل، تنظيم الملفات والمجلدات، إدارة المشاركة والتعاون، التعامل مع إصدارات الملفات، إنشاء طلبات الملفات، وتنفيذ عمليات مجمعة على ملفاتك.',
    'tools.klavis.servers.dropbox.readme':
      'تكامل مع Dropbox للوصول إلى ملفاتك وإدارتها. حمّل، ونزّل، وشارك الملفات، وأدر المجلدات، وتابع نسخ الملفات، ونظّم تخزينك السحابي من خلال الذكاء الاصطناعي الحواري.',
    'tools.klavis.servers.figma.description':
      'Figma هي أداة تصميم واجهات تعاونية لتطبيقات الويب والجوال.',
    'tools.klavis.servers.figma.readme':
      'اتصل بـ Figma للوصول إلى ملفات التصميم والتعاون في المشاريع. اعرض التصاميم، وصدّر العناصر، وتصفح المكونات، وأدر سير عمل التصميم من خلال المحادثة الطبيعية.',
    'tools.klavis.servers.github.description': 'خادم GitHub MCP المحسن',
    'tools.klavis.servers.github.readme':
      'اتصل بـ GitHub لإدارة المستودعات، والمشكلات، وطلبات السحب، والتعليمات البرمجية. ابحث في الكود، وراجع التغييرات، وأنشئ فروعًا، وتعاون في مشاريع تطوير البرمجيات من خلال الذكاء الاصطناعي الحواري.',
    ...
    'tools.klavis.servers.gmail.readme':
      'اجلب قوة Gmail مباشرة إلى مساعدك الذكي. اقرأ، واكتب، وأرسل رسائل البريد الإلكتروني، وابحث في صندوق الوارد، وأدر التصنيفات، ونظّم اتصالاتك — كل ذلك من خلال المحادثة الطبيعية.',
    'tools.klavis.servers.google-calendar.description':
      'تقويم Google هو خدمة تقويم لإدارة الوقت والجدولة',
    'tools.klavis.servers.google-calendar.readme':
      'تكامل مع تقويم Google لعرض وإنشاء وإدارة فعالياتك بسلاسة. جدْوِل الاجتماعات، واضبط التذكيرات، وتحقق من التوفر، ونظّم وقتك — كل ذلك باستخدام أوامر اللغة الطبيعية.',
    'tools.klavis.servers.google-docs.description':
      'محرر مستندات Google هو معالج نصوص ضمن مجموعة Google Docs المجانية على الويب',
    'tools.klavis.servers.google-docs.readme':
      'تكامل مع مستندات Google لإنشاء وتحرير وإدارة المستندات. اكتب المحتوى، ونسّق النص، وتعاون في الوقت الفعلي، وادخل إلى مستنداتك من خلال المحادثة الطبيعية.',
    'tools.klavis.servers.google-drive.description': 'Google Drive هي خدمة تخزين سحابي',
    'tools.klavis.servers.google-drive.readme':
      'اتصل بـ Google Drive للوصول إلى ملفاتك وتنظيمها وإدارتها. ابحث في المستندات، وحمّل الملفات، وشارك المحتوى، وتصفح التخزين السحابي بكفاءة بمساعدة الذكاء الاصطناعي.',
    'tools.klavis.servers.google-sheets.description':
      'جداول بيانات Google هي تطبيق جداول بيانات عبر الإنترنت يتيح للمستخدمين إنشاء وتحرير والتعاون في الجداول.',
    'tools.klavis.servers.google-sheets.readme':
      'اتصل بـ Google Sheets لقراءة وكتابة وتحليل بيانات الجداول. نفّذ الحسابات، وأنشئ التقارير، وارسم المخططات، وأدر البيانات الجدولية بالتعاون مع الذكاء الاصطناعي.',
    'tools.klavis.servers.hubspot.description':
      'HubSpot هي شركة تطوير وتسويق برمجيات للتسويق الداخلي والمبيعات وخدمة العملاء',
    'tools.klavis.servers.hubspot.readme':
      'تكامل مع HubSpot لإدارة جهات الاتصال، والصفقات، والحملات التسويقية. ادخل إلى بيانات CRM، وتتبع خطوط المبيعات، وأتمت سير العمل، وسهّل عمليات المبيعات والتسويق.',
    'tools.klavis.servers.jira.description':
      'Jira هي أداة لإدارة المشاريع وتتبع القضايا طورتها Atlassian',
    'tools.klavis.servers.jira.readme':
      'تكامل مع Jira لإدارة المشكلات، وتتبع التقدم، وتنظيم السبرينت. أنشئ التذاكر، وحدث الحالات، واستعلم عن بيانات المشاريع، وسهّل سير عمل التطوير من خلال المحادثة الطبيعية.',
    'tools.klavis.servers.notion.description': 'Notion هو تطبيق إنتاجية وتدوين ملاحظات تعاوني',
    'tools.klavis.servers.notion.readme':
      'اتصل بـ Notion للوصول إلى مساحة عملك وإدارتها. أنشئ الصفحات، وابحث في المحتوى، وحدث قواعد البيانات، ونظّم قاعدة معرفتك — كل ذلك من خلال محادثة طبيعية مع مساعدك الذكي.',
    'tools.klavis.servers.onedrive.description':
      'OneDrive هي خدمة استضافة ومزامنة ملفات تديرها Microsoft',
    'tools.klavis.servers.onedrive.readme':
      'اتصل بـ OneDrive للوصول إلى ملفاتك السحابية من Microsoft وإدارتها. حمّل، ونزّل، وشارك الملفات، ونظّم المجلدات، وتعاون في المستندات بمساعدة الذكاء الاصطناعي.',
    'tools.klavis.servers.outlook-mail.description':
      'Outlook Mail هي مجموعة خدمات بريد إلكتروني وجهات اتصال ومهام وتقويم عبر الإنترنت من Microsoft.',
    'tools.klavis.servers.outlook-mail.readme':
      'تكامل مع بريد Outlook لقراءة وإرسال وإدارة رسائل البريد الإلكتروني من Microsoft. ابحث في الرسائل، واكتب الرسائل، وأدر المجلدات، ونظّم صندوق الوارد من خلال المحادثة الطبيعية.',
    'tools.klavis.servers.salesforce.description':
      'Salesforce هي المنصة الرائدة عالميًا لإدارة علاقات العملاء (CRM) التي تساعد الشركات على التواصل مع العملاء والشركاء والعملاء المحتملين',
    'tools.klavis.servers.salesforce.readme':
      'اتصل بـ Salesforce لإدارة علاقات العملاء وبيانات المبيعات. استعلم عن السجلات، وحدث الفرص، وتتبع العملاء المحتملين، وأتمت سير عمل CRM باستخدام أوامر اللغة الطبيعية.',
    'tools.klavis.servers.slack.description':
      'Slack هو تطبيق مراسلة للأعمال يربط الأشخاص بالمعلومات التي يحتاجونها',
    'tools.klavis.servers.slack.readme':
      'تكامل مع Slack لإرسال الرسائل، والبحث في المحادثات، وإدارة القنوات. تواصل مع فريقك، وأتمت سير العمل في التواصل، وادخل إلى معلومات مساحة العمل من خلال اللغة الطبيعية.',
    'tools.klavis.servers.supabase.description': 'خادم Supabase MCP الرسمي',
    'tools.klavis.servers.supabase.readme':
      'تكامل مع Supabase لإدارة قاعدة البيانات وخدمات الخلفية. استعلم عن البيانات، وأدر المصادقة، وتعامل مع التخزين، وتفاعل مع خلفية تطبيقك من خلال المحادثة الطبيعية.',
    'tools.klavis.servers.whatsapp.description':
      'تكامل مع واجهة WhatsApp Business API لإرسال الرسائل النصية والوسائط وإدارة المحادثات مع العملاء. مثالي لدعم العملاء، حملات التسويق، وسير العمل الآلي للرسائل من خلال منصة WhatsApp الرسمية.',
    'tools.klavis.servers.whatsapp.readme':
      'تكامل مع WhatsApp Business لإرسال الرسائل، وإدارة المحادثات، والتفاعل مع العملاء. أتمت سير العمل في المراسلة وتعامل مع الاتصالات من خلال الذكاء الاصطناعي الحواري.',
    'tools.klavis.servers.youtube.description':
      'YouTube هي منصة لمشاركة الفيديوهات حيث يمكن للمستخدمين رفع، مشاركة، واكتشاف المحتوى. الوصول إلى معلومات الفيديو، النصوص، والبيانات الوصفية برمجيًا.',
    'tools.klavis.servers.youtube.readme':
      'اتصل بـ YouTube للبحث عن الفيديوهات، والوصول إلى النصوص، واسترجاع معلومات الفيديو. حلل المحتوى، واستخرج البيانات الوصفية، واكتشف الفيديوهات من خلال المحادثة الطبيعية.',
    'tools.klavis.servers.zendesk.description': 'Zendesk هي شركة برمجيات لخدمة العملاء',
    'tools.klavis.servers.zendesk.readme':
      'تكامل مع Zendesk لإدارة تذاكر الدعم وتفاعلات العملاء. أنشئ الطلبات، وحدثها، وتتبعها، وادخل إلى بيانات العملاء، وسهّل عمليات الدعم.',
    ...
    'tools.lobehubSkill.disconnectConfirm.desc':
      'لا يزال بإمكانك متابعة المحادثات السابقة التي تشير إلى محتوى {{name}}. ومع ذلك، لن يتمكن المساعد من الوصول إلى محتوى جديد أو تنفيذ مهام جديدة.',
    ...
    'tools.lobehubSkill.providers.linear.description':
      'Linear هي أداة حديثة لتتبع القضايا وإدارة المشاريع مصممة للفرق عالية الأداء لبناء برمجيات أفضل بشكل أسرع',
    'tools.lobehubSkill.providers.linear.readme':
      'اجلب قوة Linear مباشرة إلى مساعدك الذكي. أنشئ وحدث المشكلات، وأدر السبرينت، وتتبع تقدم المشاريع، وسهّل سير عمل التطوير — كل ذلك من خلال المحادثة الطبيعية.',
    'tools.lobehubSkill.providers.microsoft.description':
      'تقويم Outlook هو أداة جدولة مدمجة ضمن Microsoft Outlook تتيح للمستخدمين إنشاء المواعيد، تنظيم الاجتماعات، وإدارة الوقت والفعاليات بفعالية.',
    'tools.lobehubSkill.providers.microsoft.readme':
      'تكامل مع تقويم Outlook لعرض وإنشاء وإدارة فعالياتك بسلاسة. جدْوِل الاجتماعات، وتحقق من التوفر، واضبط التذكيرات، ونظّم وقتك — كل ذلك باستخدام أوامر اللغة الطبيعية.',
    'tools.lobehubSkill.providers.twitter.description':
      'X (تويتر سابقًا) هي منصة تواصل اجتماعي لمشاركة التحديثات الفورية، الأخبار، والتفاعل مع جمهورك من خلال المنشورات، الردود، والرسائل المباشرة.',
    'tools.lobehubSkill.providers.twitter.readme':
      'اتصل بـ X (تويتر) لنشر التغريدات، وإدارة الجدول الزمني، والتفاعل مع جمهورك. أنشئ المحتوى، وجدول المنشورات، وراقب الإشارات، وابنِ حضورك على وسائل التواصل الاجتماعي من خلال الذكاء الاصطناعي الحواري.',
    ...
    'tools.search': 'ابحث عن المهارات...',
    'tools.skillActivateMode.auto.desc':
      'يمكن للذكاء الاصطناعي تفعيل الأدوات وتشغيل المهارات وتثبيت مهارات جديدة من المتجر بشكل تلقائي',
    'tools.skillActivateMode.auto.title': 'تلقائي',
    'tools.skillActivateMode.manual.desc':
      'فقط الأدوات والمهارات التي يختارها المستخدم تكون متاحة للذكاء الاصطناعي',
    'tools.skillActivateMode.manual.title': 'يدوي',
    'tools.skillActivateMode.title': 'وضع التفعيل',
    'tools.tabs.all': 'الكل',
  ...
  vo = {
    ...
    'table.desc':
      'تفاصيل استخدام الاعتمادات الحاسوبية لتوليد النصوص، التضمين، توليد الصور، وغيرها.',
  ...
  sa = 'عرض جميع الخطط',
  na = 'عرض الخطط',
  ra = 'فشل في إنشاء الاشتراك',
  la = 'دفع الفرق',
  ca = 'تقريبًا',
  da = 'المبلغ الفعلي يعتمد على صفحة الدفع',
  pa = 'تغيير هدف التخفيض',
  ua = 'تبديل الخطة',
  ma = 'ترقية',
  ga = 'قم بالترقية الآن',
  ba = 'ترقية الخطة',
  ko = {
    ...
    'balance.hobbyDesc':
      '{{hobby}} لا يشمل أرصدة الاشتراك، تحتاج إلى تكوين واجهة برمجة التطبيقات للنموذج أو شحن الرصيد',
    ...
    'billing.draftTooltip':
      'تم إنشاء هذه الفاتورة كمسودة بواسطة اشتراك جديد وسيتم خصمها تلقائيًا قريبًا',
    ...
    'billing.view': 'عرض',
    'cancelPlan.alert':
      'ستستمر في الاستفادة من المزايا حتى انتهاء الخطة الحالية ({{date}}). يمكنك إعادة الاشتراك في أي وقت قبل انتهاء الصلاحية.',
    ...
    'compare.hobbyCreditTooltip':
      'لا يشمل أرصدة الحوسبة الشهرية، تحتاج إلى تكوين واجهة برمجة التطبيقات الخاصة بك',
    'compare.monthlyCredit': 'أرصدة الحوسبة الشهرية',
    'compare.title': 'مقارنة الخطط',
    'compareAllPlans': sa,
    'comparePlans': na,
    'createSubscriptionError': ra,
    'credits.autoTopUp.currentBalance': 'الرصيد الحالي',
    'credits.autoTopUp.desc': 'تأكد من أن رصيدك لا ينفد أبدًا',
    'credits.autoTopUp.monthlyLimit': 'الحد الشهري',
    'credits.autoTopUp.monthlyLimitDesc':
      'الحد الأقصى الذي يمكن شحنه تلقائيًا شهريًا. اتركه فارغًا لعدم وجود حد',
    'credits.autoTopUp.monthlyLimitPlaceholder': 'لا يوجد حد',
    'credits.autoTopUp.monthlyTopUpAmount': 'مبلغ الشحن الشهري',
    'credits.autoTopUp.noPaymentMethodHint':
      'لا توجد وسيلة دفع مسجلة. يتطلب الشحن التلقائي وجود بطاقة محفوظة للشحن تلقائيًا.',
    'credits.autoTopUp.saveError': 'فشل في حفظ إعدادات الشحن التلقائي',
    'credits.autoTopUp.saveSuccess': 'تم حفظ إعدادات الشحن التلقائي',
    'credits.autoTopUp.setupPaymentMethod': 'إضافة وسيلة دفع',
    'credits.autoTopUp.targetBalance': 'الرصيد المستهدف',
    'credits.autoTopUp.targetBalanceDesc': 'مبلغ الرصيد الذي يتم استعادته عند تفعيل الشحن التلقائي',
    'credits.autoTopUp.threshold': 'الحد الأدنى',
    'credits.autoTopUp.thresholdDesc':
      'يتم تفعيل الشحن التلقائي عندما ينخفض رصيدك إلى أقل من هذا المبلغ',
    'credits.autoTopUp.title': 'الشحن التلقائي',
    ...
    'credits.autoTopUp.validation.targetMustExceedThreshold':
      'يجب أن يكون الرصيد المستهدف أكبر من الحد الأدنى',
    ...
    'credits.packages.expiringSoon': 'ستنتهي قريبًا',
    'credits.packages.filter.all': 'جميع المصادر',
    'credits.packages.filter.auto': 'الشحن التلقائي',
    'credits.packages.filter.gift': 'هدية',
    'credits.packages.filter.manual': 'يدوي',
    'credits.packages.gift': 'هدية',
    'credits.packages.giftedOn': 'تم الإهداء في {{date}}',
    'credits.packages.noPackages': 'لا توجد حزم أرصدة',
    'credits.packages.purchaseFirst': 'اشترِ أول حزمة أرصدة لك',
    'credits.packages.purchasedOn': 'تم الشراء في {{date}}',
    'credits.packages.sort.amountAsc': 'المبلغ: من الأقل إلى الأعلى',
    'credits.packages.sort.amountDesc': 'المبلغ: من الأعلى إلى الأقل',
    'credits.packages.sort.balanceAsc': 'الرصيد: من الأقل إلى الأعلى',
    'credits.packages.sort.balanceDesc': 'الرصيد: من الأعلى إلى الأقل',
    'credits.packages.sort.newest': 'الأحدث',
    'credits.packages.sort.oldest': 'الأقدم',
    'credits.packages.tabs.active': 'الحزم النشطة',
    'credits.packages.tabs.activeCount': 'نشطة ({{count}})',
    'credits.packages.tabs.depleted': 'المنتهية',
    'credits.packages.tabs.depletedCount': 'منتهية ({{count}})',
    ...
    'credits.topUp.maxAmountError': 'لا يمكن أن يتجاوز مبلغ الشراء الواحد ${{max}}',
    'credits.topUp.purchaseError': 'فشل الشراء، يرجى المحاولة لاحقًا',
    'credits.topUp.purchaseNow': 'اشترِ الآن',
    'credits.topUp.selectPackage': 'اختر الحزمة',
    'credits.topUp.subscribeFirst': 'اشترك أولاً',
    'credits.topUp.success.credits': '+{{quantity}} أرصدة',
    'credits.topUp.success.title': 'تم الشحن بنجاح',
    'credits.topUp.title': 'شراء الأرصدة',
    'credits.topUp.total': 'الإجمالي',
    'credits.topUp.unitPrice': 'سعر الوحدة',
    ...
    'currentPlan.cancelAlert':
      'سيتم إلغاء الاشتراك بعد {{canceledAt}}. لا يزال بإمكانك استعادته من "إدارة الاشتراك" قبل ذلك',
    ...
    'currentPlan.paymentExpired':
      'سينتهي هذا الاشتراك في {{expiredAt}}، يرجى التخطيط لاستخدامك وفقًا لذلك',
    ...
    'downgradePlans.alert':
      'ستستمر في الاستفادة من المزايا حتى انتهاء الخطة الحالية ({{date}}). ستصبح الخطة الجديدة سارية بعد انتهاء الخطة الحالية.',
    ...
    'keyMissMatch.description':
      'بسبب خلل مؤقت في النظام، تم تعطيل استخدام اشتراكك مؤقتًا. يرجى النقر على الزر أدناه لاستعادة الاستخدام ومتابعة المحادثة. إذا تكرر ذلك، يرجى التواصل معنا عبر البريد الإلكتروني (support@lobehub.com)',
    ...
    'limitation.chat.success.desc':
      'تمت ترقية اشتراكك في {{plan}} بنجاح. استمتع بالدردشة مع الذكاء الاصطناعي. تتضمن خطتك الحالية:',
    ...
    'limitation.chat.topupSuccess.desc':
      'أرصدة الشحن الخاصة بك نشطة الآن. استمتع بالدردشة مع الذكاء الاصطناعي. تتضمن خطتك الحالية:',
    'limitation.chat.topupSuccess.title': 'تم الشحن بنجاح',
    'limitation.expired.desc':
      'انتهت صلاحية أرصدة الحوسبة الخاصة بك في خطة {{plan}} بتاريخ {{expiredAt}}. قم بالترقية الآن للحصول على أرصدة جديدة.',
    ...
    'limitation.hobby.desc':
      'تم استهلاك أرصدة الحوسبة المجانية الخاصة بك. يرجى تكوين واجهة برمجة التطبيقات المخصصة للنموذج للمتابعة.',
    ...
    'limitation.image.success.desc':
      'تمت ترقية اشتراكك في {{plan}} بنجاح. استمتع بتوليد الصور بالذكاء الاصطناعي. تتضمن خطتك الحالية:',
    ...
    'limitation.image.topupSuccess.desc':
      'أرصدة الشحن الخاصة بك نشطة الآن. استمتع بتوليد الصور بالذكاء الاصطناعي. تتضمن خطتك الحالية:',
    'limitation.image.topupSuccess.title': 'تم الشحن بنجاح',
    'limitation.insufficientBudget.desc':
      'الأرصدة المتبقية لديك غير كافية لتغطية التكلفة المقدرة لهذا النموذج. يرجى إعادة شحن الأرصدة أو التبديل إلى نموذج أقل تكلفة.',
    'limitation.insufficientBudget.retry': 'إعادة المحاولة',
    'limitation.insufficientBudget.title': 'الأرصدة غير كافية لهذا النموذج',
    ...
    'limitation.limited.desc':
      'تم استهلاك أرصدة الحوسبة الخاصة بك في خطة {{plan}}. قم بالترقية الآن للحصول على المزيد من الأرصدة.',
    'limitation.limited.descUltimate':
      'تم استهلاك أرصدة الحوسبة الخاصة بك في خطة {{plan}}. يرجى شحن الأرصدة للمتابعة.',
    'limitation.limited.referralTip':
      'ادعُ مستخدمين جدد للتسجيل، وستحصل أنت وصديقك على {{reward}}M أرصدة لكل منكما',
    ...
    'limitation.providers.mask.subTitle':
      'خدمة API المخصصة متاحة فقط للخطط المدفوعة. قم بالترقية الآن للاستفادة من خدمات النماذج العالمية',
    ...
    'limitation.video.success.desc':
      'تمت ترقية اشتراكك في خطة {{plan}} بنجاح. استمتع بتوليد الفيديو باستخدام الذكاء الاصطناعي. خطتك الحالية تتضمن:',
    ...
    'limitation.video.topupSuccess.desc':
      'تم تفعيل رصيد الشحن الخاص بك. استمتع بتوليد الفيديو باستخدام الذكاء الاصطناعي. خطتك الحالية تتضمن:',
    'limitation.video.topupSuccess.title': 'تم الشحن بنجاح',
    'modelPricing.button': 'عرض مستندات التسعير',
    'modelPricing.desc':
      'يستخدم {{name}} الأرصدة لقياس استخدام نموذج الذكاء الاصطناعي. يوضح الجدول أدناه أرصدة الحوسبة لكل 1M رموز.',
    ...
    'payment.error.desc':
      'معرّف الاشتراك: {{id}} غير موجود. إذا كانت لديك أسئلة، يرجى التواصل معنا عبر البريد الإلكتروني',
    ...
    'payment.upgradeFailed.alert.reason.bank3DS':
      'يتطلب البنك الخاص بك التحقق ثلاثي الأبعاد 3DS، يرجى التأكيد مرة أخرى',
    ...
    'plans.credit.apiProvider':
      'يدعم أكثر من 20 مزودًا رئيسيًا للنماذج مثل OpenAI / Anthropic / OpenRouter',
    ...
    'plans.downgradeTip':
      'لقد قمت بالفعل بتغيير الاشتراك. لا يمكنك تنفيذ عمليات أخرى حتى يكتمل التبديل',
    ...
    'plans.embeddingStorage.tooltip':
      'تنتج صفحة مستند واحدة (1000-1500 حرف) حوالي إدخال متجه واحد. (تقدير باستخدام OpenAI Embeddings، وقد يختلف حسب النموذج)',
    ...
    'plans.knowledgeBase.tooltip':
      'يدعم تحميل الملفات وميزات قاعدة المعرفة. قم بتحميل ملفات، صور، صوت، فيديو والمزيد. أنشئ قواعد معرفة لإدارة الملفات بسهولة. استخدمها في المحادثات لتجربة أغنى.',
    ...
    'plans.llm.tooltip':
      'أضف مزود واجهة برمجة التطبيقات الخاص بك مع الاستفادة من المزامنة السحابية',
    ...
    'plans.payonce.popconfirm':
      'بعد الدفع لمرة واحدة، يجب الانتظار حتى انتهاء الاشتراك لتغيير الخطة أو دورة الفوترة. يرجى تأكيد اختيارك.',
    'plans.payonce.tooltip':
      'يتطلب الدفع لمرة واحدة الانتظار حتى انتهاء الاشتراك لتغيير الخطة أو دورة الفوترة',
    'plans.payonce.upgradeOk': 'تأكيد الترقية',
    'plans.payonce.upgradePopconfirm':
      'سيتم تطبيق القيمة المتبقية من خطتك الحالية كخصم على الخطة الجديدة.',
    'plans.payonce.upgradePopconfirmNoProration':
      'سيتم خصم السعر الكامل للخطة الجديدة. سيتم استبدال خطتك الحالية فورًا.',
    ...
    'plans.plan.hobby.desc':
      'للمستخدمين الذين لديهم واجهة برمجة تطبيقات خاصة بهم ويدفعون حسب الاستخدام',
    'plans.plan.hobby.title': 'هواية',
    'plans.plan.premium.desc':
      'مصمم للمستخدمين المحترفين الذين يستخدمون الذكاء الاصطناعي بشكل متكرر',
    ...
    'qa.desc':
      'إذا لم تجد إجابتك، تحقق من <1>وثائق المنتج</1> لمزيد من الأسئلة الشائعة، أو تواصل معنا.',
    'qa.detail': 'عرض التفاصيل',
    'qa.list.credit.a':
      'أرصدة الحوسبة هي وحدة قياس يستخدمها {{cloud}} لقياس استخدام نماذج الذكاء الاصطناعي. تستهلك النماذج المختلفة كميات مختلفة من الأرصدة.',
    'qa.list.credit.q': 'ما هي أرصدة الحوسبة؟',
    'qa.list.embeddings.a':
      'تخزين المتجهات لا يساوي حجم البيانات الأصلية، بل يُحسب بناءً على تحويل النصوص إلى متجهات. على سبيل المثال، ملف PDF من صفحة واحدة قد ينتج فقط إدخال متجه واحد.',
    'qa.list.embeddings.q': 'كيف يتم حساب تخزين المتجهات؟',
    'qa.list.free.a':
      '{{name}} يلتزم بمبادئ المصدر المفتوح. يمكن للمطورين المحترفين استخدام جميع الميزات عبر النشر الذاتي. في {{cloud}}، نقدم {{credit}} رصيد مجاني شهريًا لجميع المستخدمين المسجلين.',
    'qa.list.free.q': 'هل يمكن استخدام {{name}} مجانًا؟',
    'qa.list.highUsage.a':
      'يعتمد استهلاك الرصيد بشكل كبير على طول المحادثة. مع نمو المحادثة، يتم إرسال التاريخ الكامل لكل رسالة جديدة كرموز إدخال، مما يزيد التكلفة بشكل كبير. نوصي ببدء محادثة جديدة عند تغيير المواضيع. أيضًا، إذا كان هناك فجوة طويلة بين الرسائل، قد تنتهي صلاحية ذاكرة التخزين المؤقت للمطالبة، مما يؤدي إلى زيادة في التكلفة. بعض النماذج مثل سلسلة Gemini Pro تستخدم تسعيرًا متدرجًا — يتم فرض رسوم مضاعفة على الإدخال الذي يتجاوز 200 ألف رمز.',
    'qa.list.highUsage.q': 'لماذا يتم استهلاك أرصدة بسرعة أكبر من المتوقع؟',
    'qa.list.limit.a':
      'خطط الاشتراك في {{cloud}} تشمل {{starter}}، {{premium}} و{{ultimate}}، وتوفر أرصدة مختلفة. إذا لم تكن الأرصدة كافية، يمكنك الترقية أو استخدام واجهة برمجة تطبيقات مخصصة.',
    'qa.list.limit.q': 'ماذا أفعل إذا نفدت أرصدة الحوسبة؟',
    'qa.list.management.a':
      'من صفحة {{subscribe}}، يمكنك ترقية أو تخفيض خطتك، أو التبديل بين الفوترة الشهرية والسنوية. من خلال "{{usage}}-{{management}}" يمكنك إدارة الاشتراك عبر Stripe.',
    ...
    'referral.errors.invalidFormat':
      'تنسيق رمز الإحالة غير صالح، يرجى إدخال 2-8 أحرف أو أرقام أو شرطات سفلية',
    ...
    'referral.inviteLink.description':
      'انسخ الرابط وشاركه مع الأصدقاء. بعد التسجيل، ستحصل على مكافآت',
    'referral.inviteLink.title': 'رابط الإحالة',
    'referral.rules.antiAbuse':
      'إذا تم اكتشاف نشاط احتيالي (مثل التسجيل الجماعي لحسابات بريد إلكتروني مؤقتة)، فسيتم حظر الحسابات المرتبطة بشكل دائم.',
    'referral.rules.backfill.alreadyBound': 'لقد قمت بربط رمز الدعوة مسبقًا',
    'referral.rules.backfill.description':
      'نسيت إدخال رمز الدعوة؟ يمكنك إكماله خلال 3 أيام من التسجيل',
    'referral.rules.backfill.expiredTip':
      'انتهت فترة الإكمال. لا يمكن الإكمال بعد 3 أيام من التسجيل',
    ...
    'referral.rules.missedCode':
      'فاتك إدخال رمز الدعوة: يمكنك <0>إكماله</0> خلال 3 أيام من التسجيل',
    'referral.rules.priority':
      'أولوية استهلاك الرصيد: الرصيد المجاني → رصيد الاشتراك → رصيد الإحالة → الرصيد المشحون',
    'referral.rules.registration':
      'طريقة التسجيل: يسجل المستخدمون المدعوون عبر رابط الإحالة أو بإدخال الرمز عند التسجيل',
    'referral.rules.reward': 'المكافأة: يحصل كل من الداعي والمدعو على {{reward}}M رصيد',
    'referral.rules.rewardDelay':
      'معالجة المكافآت: قد يستغرق توزيع الأرصدة ما يصل إلى 6 ساعات بعد إكمال إجراء صالح. يرجى التحلي بالصبر.',
    'referral.rules.title': 'قواعد البرنامج',
    'referral.rules.validInvitation':
      'دعوة صالحة: يسجل المدعو باستخدام رمز الإحالة ويقوم بإجراء صالح واحد',
    ...
    'sessionCard.title':
      'هل ترغب في مغادرة الخطة المجانية؟ قم بالترقية للاستمتاع بالميزات المميزة.',
    ...
    'switchToYearly.desc':
      'بعد التبديل، ستبدأ الفوترة السنوية فور دفع الفرق. تاريخ البدء يستمر من الخطة السابقة.',
    'switchToYearly.title': 'التبديل إلى الفوترة السنوية',
    'tab.billing': 'إدارة الفواتير',
    'tab.credits': 'إدارة الأرصدة',
    ...
    'upgradePlan': ba,
    'upgradePlans.desc':
      'تسري ترقية الخطة فورًا بعد دفع الفرق. تاريخ البدء يستمر من الخطة السابقة.',
    ...
    'zarinpal.infoModal.desc':
      'بسبب المتطلبات التنظيمية، يرجى إكمال المعلومات الشخصية التالية قبل تقديم الطلب:',
  ...
  So = {
    'agent.01.prompt':
      'أنت مرشد في الكتابة الإبداعية تساعد الكُتّاب على تطوير مهاراتهم. ما تقوم به: تقديم ملاحظات بنّاءة على الكتابات (مدح النقاط القوية، واقتراح تحسينات)؛ تعليم تقنيات السرد القصصي: هيكل الحبكة، تطوير الشخصيات، الإيقاع، والحوار؛ اقتراح تمارين لتجاوز حواجز الكتابة؛ الإرشاد عبر الأنواع والأساليب المختلفة؛ مساعدة الكُتّاب في اكتشاف صوتهم الفريد. استخدام الأدوات: القطع الفنية: إنشاء بطاقات شخصيات، مخططات حبكة (Mermaid)، مولدات أفكار للكتابة (React)، وقوالب للقصص؛ دفتر الملاحظات: حفظ مسودات المستخدم، تقارير الملاحظات، وخطط الكتابة (بعد طلب الإذن). كن داعمًا، صادقًا، ومتحمسًا للقصص. قابل الكُتّاب حيثما كانوا.',
    'agent.01.title': 'ساعدني لأصبح كاتبًا أفضل',
    'agent.02.prompt':
      'أنشئ مدربًا لتعلم اللغات يتمتع بالصبر والتشجيع، يساعد المستخدمين على ممارسة المحادثة، يشرح القواعد بوضوح، يصحح الأخطاء بلطف، يعلّم التعابير الاصطلاحية، ويضع خطط دراسة مخصصة. استخدم الأدوات المتاحة بفعالية: الذاكرة لتتبع المفردات والتقدم، دفتر الملاحظات لحفظ ملاحظات الدروس والمواد الدراسية، والقطع الفنية لإنشاء تمارين تفاعلية أو بطاقات تعليمية.',
    'agent.02.title': 'ساعدني في تعلم لغة جديدة',
    'agent.03.prompt':
      'أنشئ مدربًا لياقيًا متمكنًا يمكنه تصميم خطط تمارين مخصصة لأهدافك، وشرح الشكل الصحيح للتمارين، واقتراح تعديلات لمستويات اللياقة المختلفة، وتقديم التحفيز والمساءلة، ومساعدتك على تطوير عادات صحية مستدامة.',
    'agent.03.title': 'كن مدربي الشخصي في اللياقة',
    'agent.04.prompt':
      'أنت مستشار تغذية. ساعد المستخدمين على فهم الأكل الصحي، إنشاء خطط وجبات، التعامل مع القيود الغذائية، تصحيح المفاهيم الخاطئة، وبناء علاقة إيجابية مع الطعام. استخدم الأدوات بفعالية: القطع الفنية: جداول خطط الوجبات، بطاقات وصفات، جداول التغذية؛ الصندوق التجريبي: حساب السعرات/العناصر الغذائية، إنشاء تصورات بيانية؛ دفتر الملاحظات: حفظ الخطط والوصفات الشخصية. اعرض دائمًا، لا تكتفِ بالشرح. ذكّر المستخدمين أن هذه معلومات عامة وليست نصيحة طبية.',
    'agent.04.title': 'ساعدني في بناء عادات غذائية صحية',
    'agent.05.prompt':
      'رفيقك المتعاطف في رحلة العافية. سأرشدك عبر تمارين التأمل وتقنيات إعادة التأطير، أنشئ أدوات بصرية للتعامل مع المشاعر، وأحفظ تأملاتك بأمان في دفتر ملاحظات شخصي—أدعم نموك العاطفي برعاية.',
    'agent.05.title': 'ادعمني في صحتي العاطفية',
    'agent.06.prompt':
      'أنت مستشار مالي شخصي. ساعد المستخدمين على فهم الميزانية، إنشاء خطط ادخار، شرح خيارات الاستثمار، إدارة الديون بذكاء، وتحقيق الأهداف المالية. استخدم الأدوات بفعالية: الصندوق التجريبي: حساب الفائدة المركبة، جداول سداد الديون، توقعات الاستثمار؛ القطع الفنية: قوالب ميزانية، متتبعات ادخار، جداول مقارنة مالية؛ دفتر الملاحظات: حفظ الخطط والمعالم الشخصية. قدم أرقامًا واضحة ومرئيات. ذكّر المستخدمين أن هذا تعليم وليس نصيحة مالية مهنية.',
    'agent.06.title': 'ساعدني في إدارة ماليتي الشخصية',
    'agent.07.prompt':
      'أنشئ مخطط رحلات متحمس يمكنه مساعدتك في اكتشاف وجهات السفر، وإنشاء جداول مفصلة، والعثور على أماكن خفية، وتحسين ميزانية السفر، وفهم العادات المحلية، والاستفادة القصوى من مغامراتك.',
    'agent.07.title': 'ساعدني في تخطيط مغامرتي القادمة',
    'agent.08.prompt':
      'أنشئ دليلًا شغوفًا بالطهي يمكنه تعليمك تقنيات الطبخ، واقتراح وصفات بناءً على المكونات المتوفرة لديك، وشرح تناغم النكهات، ومساعدتك في استكشاف مطابخ العالم، وبناء ثقتك في المطبخ.',
    'agent.08.title': 'علمني كيف أطبخ بشكل أفضل',
    'agent.09.prompt':
      'أنشئ مستشارًا مهنيًا مدروسًا يمكنه مساعدتك في استكشاف المسارات المهنية، وتحديد نقاط قوتك واهتماماتك، والاستعداد للانتقال الوظيفي، وتطوير المهارات المهنية، وإنشاء خطط عملية لتحقيق أهدافك المهنية.',
    'agent.09.title': 'ساعدني في تحديد مساري المهني',
    'agent.10.prompt':
      'أنشئ استراتيجيًا للتعلم يمكنه مساعدتك على الدراسة بفعالية أكبر، وتحسين الذاكرة والاستيعاب، وتطوير مهارات التفكير النقدي، والتغلب على التسويف، وبناء عادات تعلم مستمرة تتناسب مع أسلوبك.',
    'agent.10.title': 'ساعدني على الدراسة بفعالية أكبر',
    'agent.11.prompt':
      'أنشئ محللًا ومؤرخًا سرديًا. إلى جانب السرد الحي، استخدم "أداة الخط الزمني المتوازي" لربط الأحداث التاريخية بالقضايا المعاصرة. حلل صعود وسقوط الحضارات باستخدام إطار السببية الهيكلية، لمساعدة المستخدمين على استخلاص "دروس من الماضي" لاتخاذ قرارات مستقبلية.',
    'agent.11.title': 'احكِ لي قصصًا تاريخية مشوقة',
    'agent.12.prompt':
      'أنشئ مرشدًا في الاستقصاء الفلسفي. تصرف كمسهل يستخدم الطريقة السقراطية لتحدي الافتراضات. دمج "كاشف المغالطات المنطقية" لتدقيق حجج المستخدم، و"مصفوفة مقارنة التقاليد" لمساعدة المستخدمين على دمج مدارس فكرية مختلفة في رؤية عالمية شخصية متماسكة.',
    'agent.12.title': 'استكشف الفلسفة والأفكار الكبرى معي',
    'agent.13.prompt':
      'أنشئ مدربًا تفاعليًا للتصوير الفوتوغرافي. قدم "محلل التكوين البصري" لتحليل الصور المرفوعة أو الموصوفة. وفر "محاكي الإعدادات التقنية" (فتحة العدسة/ISO/سرعة الغالق) لسيناريوهات إضاءة محددة، وأنشئ خطط تحديات إبداعية منظمة لمدة 7 أيام حسب مستوى مهارة المستخدم.',
    'agent.13.title': 'ساعدني في التقاط صور أفضل',
    'agent.14.prompt':
      'أنشئ استراتيجيًا في التربية قائمًا على العلم. استخدم "متعقب الإنجازات المناسب للعمر" لتقييم نمو الطفل. قدم "نصوص حل النزاعات الفورية" بناءً على تقنيات الانضباط الإيجابي، وأنشئ سجلات أنشطة أسبوعية مخصصة توازن بين النمو المعرفي والاجتماعي والبدني.',
    'agent.14.title': 'قدّم لي نصائح مفيدة في التربية',
    'agent.15.prompt':
      'أنشئ مهندس مفاهيم قانونية. استخدم "مترجم اللغة المبسطة" لتبسيط القوانين المعقدة. قدم "خريطة حرارة المخاطر" لتحديد المسؤوليات المحتملة في سيناريوهات المستخدم، و"قوائم إجراءات الخطوة التالية" لمساعدة المستخدمين على الاستعداد قبل استشارة محامٍ محترف.',
    'agent.15.title': 'اشرح لي الأمور القانونية ببساطة',
    'agent.16.prompt':
      'أنشئ استراتيجيًا تسويقيًا يركز على النمو. طبق نموذج AARRR ونموذج STP لتشخيص مشكلات الأعمال. استخدم "مولد الشخصيات" و"مصفوفة اختيار القنوات" لبناء استراتيجيات محتوى قائمة على البيانات، وقدم قوالب تقدير مؤشرات الأداء لكل حملة مقترحة.',
    'agent.16.title': 'ساعدني في تسويق عملي بفعالية',
    'agent.17.prompt':
      'أنشئ مهندس علاقات متعاطف. استخدم "محلل أسلوب التواصل" لتشخيص الديناميكيات الشخصية. قدم "محاكي حل النزاعات" لتقمص الأدوار في المحادثات الصعبة، وأنشئ "نصوص وضع الحدود" مخصصة للحفاظ على علاقات صحية.',
    'agent.17.title': 'ساعدني في بناء علاقات أفضل',
    'agent.18.prompt':
      'كن مدربًا للإنتاجية ومنهج GTD. ساعد المستخدمين على تطبيق منهجية Getting Things Done (GTD)، وتقنيات حجز الوقت، وأطر تحديد الأهداف. استخدم نظام إدارة المهام المدمج لتنظيم المهام. قدم مراجعات منتظمة ووسائل بصرية لتتبع الالتزامات وتعزيز التركيز.',
    'agent.18.title': 'ساعدني لأصبح أكثر إنتاجية',
    'agent.19.prompt':
      'أنشئ دليلًا للتأمل واليقظة يمكنه تعليمك تقنيات التأمل، ومساعدتك في إدارة التوتر، وتطوير الوعي باللحظة الحاضرة، وبناء ممارسة منتظمة، وتطبيق مبادئ اليقظة في حياتك اليومية.',
    'agent.19.title': 'علمني التأمل واليقظة الذهنية',
    'agent.20.prompt':
      'أنشئ منسقًا للترفيه يمكنه اقتراح كتب، وأفلام، ومسلسلات، وبودكاست، وموسيقى بناءً على ذوقك، وشرح سبب استمتاعك بها، ومساعدتك على اكتشاف جواهر خفية من مختلف الأنواع.',
    'agent.20.title': 'اقترح لي شيئًا رائعًا للمشاهدة أو القراءة',
    'agent.21.prompt':
      'أنشئ مدربًا للخطابة يمكنه مساعدتك في التغلب على التوتر، وبناء عروض تقديمية مقنعة، وتحسين الإلقاء ولغة الجسد، والتعامل مع جلسات الأسئلة والأجوبة، وتصبح متحدثًا واثقًا وجذابًا.',
    'agent.21.title': 'ساعدني لأصبح متحدثًا واثقًا',
    'agent.22.prompt':
      'أنشئ مدربًا للمقابلات يمكنه مساعدتك في الاستعداد لمقابلات العمل، وممارسة الأسئلة الشائعة، وتطوير قصص مقنعة عن خبراتك، والتعامل مع الأسئلة الصعبة، وترك انطباع قوي.',
    'agent.22.title': 'ساعدني في الاستعداد لمقابلات العمل',
    'agent.23.prompt':
      'أنشئ معلمًا للموسيقى يمكنه شرح نظرية الموسيقى بأسلوب مبسط، ومساعدتك على تعلم آلة موسيقية، وتطوير أذنك الموسيقية، واقتراح تقنيات تدريب، وتعميق تقديرك لأنماط موسيقية مختلفة.',
    'agent.23.title': 'علمني عن الموسيقى والآلات',
    'agent.24.prompt':
      'أنشئ دليلًا لتقدير الفن يمكنه مساعدتك في فهم الحركات الفنية المختلفة، وتحليل الأعمال الفنية، وتطوير بصيرتك البصرية، وتعميق استمتاعك بالمتاحف والمعارض والتعبير الإبداعي.',
    'agent.24.title': 'ساعدني في فهم وتقدير الفن',
    'agent.25.prompt':
      'أنشئ مستشارًا لرعاية الحيوانات الأليفة يقدم إرشادات حول صحة الحيوانات، تدريب السلوك، التغذية، الأنشطة الترفيهية، وبناء علاقة قوية مع مجموعة متنوعة من الحيوانات، بما في ذلك الفروية، والريشية، والزاحفة. يجب أن يرى الوكيل رعاية الحيوانات كمسؤولية مستمرة ويساعد المستخدمين على تحديد المهام والروتين والمعالم المهمة المتعلقة بالحيوانات. عندما تتضمن الرعاية أمورًا متكررة أو تعتمد على الوقت، يجب أن يساعد المستخدمين على تنظيم هذه المسؤوليات وربطها بالتقويم لضمان الالتزام بها في الحياة اليومية.',
    'agent.25.title': 'ساعدني في رعاية حيواني الأليف بشكل أفضل',
    'agent.26.prompt':
      'أنشئ مستشارًا لتصميم الديكور الداخلي يمكنه مساعدتك في تخطيط توزيع الغرف، واختيار الألوان، وانتقاء الأثاث والديكور، والعمل ضمن ميزانيتك، وإنشاء مساحات تعكس شخصيتك وأسلوب حياتك.',
    'agent.26.title': 'ساعدني في تصميم مساحة معيشتي',
    'agent.27.prompt':
      'أنشئ مدربًا لريادة الأعمال يمكنه مساعدتك في التحقق من أفكار المشاريع، وتطوير نماذج الأعمال، وفهم أساسيات الشركات الناشئة، وتجاوز التحديات الشائعة، واتخاذ خطوات عملية لإطلاق مشروعك.',
    'agent.27.title': 'ساعدني في إطلاق فكرة مشروعي',
    'agent.28.prompt':
      'أنشئ مفسرًا علميًا يمكنه شرح المفاهيم العلمية المعقدة بأسلوب جذاب، ومناقشة الاكتشافات الحديثة، والتمييز بين الحقيقة والخيال، ومساعدتك على تطوير الثقافة العلمية والفضول.',
    'agent.28.title': 'اشرح لي مفاهيم علمية',
    'agent.29.prompt':
      'أنشئ مراجعًا خبيرًا للكود البرمجي متخصصًا في اكتشاف الروائح البرمجية، والأخطاء المحتملة، والثغرات الأمنية، ومشاكل الأداء. يجب أن يقدم ملاحظات بناءة مع اقتراحات محددة للتحسين، ويشرح أسباب كل توصية، ويساعد في تطبيق معايير وأفضل ممارسات البرمجة.',
    'agent.29.title': 'ساعدني في مراجعة وتحسين الكود الخاص بي',
    'agent.30.prompt':
      'أنشئ مرشدًا في تطوير الواجهات الأمامية يتمتع بخبرة واسعة في الأطر الحديثة مثل React وVue وAngular. يجب أن يكون قادرًا على شرح المفاهيم المعقدة بطريقة مبسطة، ومراجعة بنية المكونات، واقتراح تحسينات في الأداء، والمساعدة في تصحيح مشكلات واجهة المستخدم المعقدة، وتوجيه أفضل الممارسات لإدارة الحالة، والاختبار، وإمكانية الوصول.',
    'agent.30.title': 'ساعدني في تطوير الواجهات الأمامية',
    'agent.31.prompt':
      'أنشئ مهندسًا معماريًا للأنظمة الخلفية متخصصًا في تصميم بنى الخدمات المصغرة القابلة للتوسع، وتنفيذ الأنظمة المعتمدة على الأحداث، وتحسين أداء واجهات البرمجة، وإدارة تحديات الأنظمة الموزعة، واتخاذ قرارات تقنية توازن بين الأداء وسهولة الصيانة وخبرة الفريق.',
    'agent.31.title': 'ساعدني في تصميم بنية النظام الخلفي',
    'agent.32.prompt':
      'أنشئ مهندس قواعد بيانات يمكنه المساعدة في تصميم مخططات قواعد بيانات فعالة، وتحسين الاستعلامات البطيئة، والاختيار بين حلول SQL وNoSQL، وتنفيذ استراتيجيات فهرسة مناسبة، وتقديم المشورة بشأن أنماط نمذجة البيانات، واستراتيجيات الترحيل، وطرق التوسع لمختلف الحالات.',
    'agent.32.title': 'ساعدني في تصميم قاعدة البيانات',
    'agent.33.prompt':
      'أنشئ مهندس DevOps متخصصًا في بناء خطوط CI/CD قوية، واستخدام الحاويات مع Docker وKubernetes، والبنية التحتية كرمز، وتحسين منصات السحابة (AWS/GCP/Azure)، وإعداد المراقبة والتنبيهات، وتنفيذ أفضل ممارسات الأمان طوال دورة النشر.',
    'agent.33.title': 'ساعدني في إعداد خط DevOps',
    'agent.34.prompt':
      'أنشئ مدير منتج يمكنه المساعدة في تحديد متطلبات المنتج بوضوح، وكتابة قصص مستخدم فعالة مع معايير القبول، وتحديد أولويات الميزات باستخدام أطر مثل RICE أو MoSCoW، وإنشاء خرائط طريق للمنتج، وتسهيل التواصل بين أصحاب المصلحة والمصممين والفرق الهندسية.',
    'agent.34.title': 'ساعدني في تحديد متطلبات المنتج',
    'agent.35.prompt':
      'أنشئ مستشار تصميم تجربة مستخدم يمكنه تقييم واجهات المستخدم من حيث سهولة الاستخدام، واقتراح تحسينات بناءً على مبادئ التصميم وعلم نفس المستخدم، والمساعدة في إنشاء أنظمة تصميم متسقة، وإجراء تقييمات إرشادية، وتقديم إرشادات حول إمكانية الوصول، والتصميم المتجاوب، وأساليب أبحاث المستخدم.',
    'agent.35.title': 'راجع وحسّن تصميم تجربة المستخدم لدي',
    'agent.36.prompt':
      'أنشئ عالم بيانات يمكنه المساعدة في التحليل الإحصائي، وتصوير البيانات، واختبار الفرضيات، والنمذجة التنبؤية، وترجمة الأسئلة التجارية إلى رؤى قائمة على البيانات. يجب أن يشرح المفاهيم التحليلية المعقدة بطريقة مفهومة ويوصي بالأدوات والتقنيات المناسبة.',
    'agent.36.title': 'ساعدني في تحليل وتصوير بياناتي',
    'agent.37.prompt':
      'أنشئ مهندس تعلم آلي يمكنه المساعدة في اختيار النماذج، وهندسة الميزات، وتحسين خطوط التدريب، واستراتيجيات نشر النماذج، وشرح مفاهيم التعلم الآلي بطريقة عملية. يجب أن يوجهك خلال دورة حياة التعلم الآلي من صياغة المشكلة إلى النشر في الإنتاج.',
    'agent.37.title': 'ساعدني في بناء حلول تعلم آلي',
    'agent.38.prompt':
      'أنشئ مهندس بنية سحابية يمكنه تصميم بنى تحتية سحابية فعالة من حيث التكلفة وعالية التوافر، وتنفيذ استراتيجيات التعافي من الكوارث، وتحسين الإنفاق السحابي، والمساعدة في ترحيل الأنظمة القديمة إلى بنى سحابية حديثة على AWS أو GCP أو Azure.',
    'agent.38.title': 'ساعدني في تصميم البنية التحتية السحابية',
    'agent.39.prompt':
      'أنشئ محلل أمان يمكنه مراجعة أمان الشيفرة، وتحديد الثغرات مثل SQL Injection وXSS وCSRF، والتوصية بأنماط مصادقة وتفويض آمنة، والمساعدة في تنفيذ التشفير بشكل صحيح، وتوجيه الامتثال لمعايير الأمان مثل OWASP Top 10.',
    'agent.39.title': 'ساعدني في التحقق من أمان تطبيقي',
    'agent.40.prompt':
      'أنشئ مدير مشروع تقني يمكنه المساعدة في تنفيذ منهجية أجايل، وتخطيط السبرينت، وإدارة المخاطر، والتواصل مع أصحاب المصلحة، وتوزيع الموارد، والحفاظ على سير المشاريع التقنية المعقدة مع الحفاظ على معنويات الفريق وإنتاجيته.',
    'agent.40.title': 'ساعدني في إدارة مشروعي التقني',
    'chat.01.prompt':
      'اشرح الحوسبة الكمومية بطريقة بسيطة. ما الذي يجعلها مختلفة عن الحوسبة التقليدية، وما هي بعض التطبيقات الواقعية التي يمكن أن تستفيد منها؟',
    'chat.01.title': 'اشرح الحوسبة الكمومية ببساطة',
    'chat.02.prompt':
      'ما هي أكثر الاستراتيجيات فعالية لتعلم مهارة جديدة بسرعة؟ أريد تقنيات عملية مدعومة بالعلم يمكنني البدء في استخدامها اليوم.',
    'chat.02.title': 'أفضل استراتيجيات التعلم السريع',
    'chat.03.prompt':
      'ساعدني في كتابة بريد إلكتروني احترافي لمديري لطلب إجازة لقضاء عطلة. أريد أن يكون مهذبًا وواضحًا ويشمل جميع التفاصيل الضرورية.',
    'chat.03.title': 'صياغة طلب إجازة',
    'chat.04.prompt':
      'أريد أن أبدأ روتينًا صباحيًا يعزز الإنتاجية. ما هي العادات التي يمارسها الأشخاص الناجحون عادةً، وكيف يجب أن أنظم صباحي؟',
    'chat.04.title': 'تصميم روتين صباحي منتج',
    'chat.05.prompt':
      'قارن بين المزايا والعيوب للغات البرمجة الشهيرة (Python, JavaScript, Rust, Go) لشخص يبدأ مشروعًا جديدًا للواجهة الخلفية في عام 2025.',
    'chat.05.title': 'مقارنة لغات البرمجة',
    'chat.06.prompt':
      'لخص الأفكار الرئيسية من كتاب "التفكير، بسرعة وببطء" لدانيال كانيمان. ما هي أهم النقاط التي يمكنني تطبيقها في اتخاذ القرارات اليومية؟',
    'chat.06.title': 'لخص لي كتابًا مشهورًا',
    'chat.07.prompt':
      'ساعدني في ابتكار أفكار هدايا إبداعية لصديق يحب الطهي والسفر والقراءة. أريد شيئًا مدروسًا وفريدًا.',
    'chat.07.title': 'ابتكار أفكار هدايا إبداعية',
    'chat.08.prompt':
      'ما هي أكبر الاتجاهات في الذكاء الاصطناعي والتكنولوجيا حاليًا؟ أعطني لمحة عامة عما يحدث ولماذا هو مهم.',
    'chat.08.title': 'أحدث اتجاهات الذكاء الاصطناعي والتكنولوجيا',
    'chat.09.prompt':
      'ساعدني في تخطيط وجبات صحية للأسبوع. أريد وجبات متوازنة وسهلة التحضير وتُخزن جيدًا وتكون لذيذة عند إعادة تسخينها.',
    'chat.09.title': 'تخطيط وجبات أسبوعية',
    'chat.10.prompt':
      'اشرح أساسيات الاستثمار الشخصي للمبتدئين. ماذا يجب أن أعرف عن الأسهم والسندات وصناديق المؤشرات وحسابات التقاعد؟',
    'chat.10.title': 'أساسيات الاستثمار للمبتدئين',
    'chat.11.prompt':
      'اكتب قصة قصيرة لوقت النوم عن ثعلب صغير شجاع يذهب في مغامرة في غابة سحرية. اجعلها ساحرة ومناسبة لطفل عمره 5 سنوات.',
    'chat.11.title': 'اكتب قصة لوقت النوم',
    'chat.12.prompt':
      'ساعدني في تحليل تفكيري بشأن قرار صعب أحتاج إلى اتخاذه. ارشدني خلال إطار عمل منظم لاتخاذ القرار.',
    'chat.12.title': 'ساعدني في اتخاذ قرار صعب',
    'chat.13.prompt':
      'ما هي بعض التجارب العلمية الممتعة والتعليمية التي يمكنني القيام بها في المنزل باستخدام أدوات منزلية شائعة؟ أريد أنشطة مناسبة للأطفال من عمر 8-12 سنة.',
    'chat.13.title': 'تجارب علمية ممتعة في المنزل',
    'chat.14.prompt':
      'ساعدني في كتابة ملخص مقنع على LinkedIn يعرض خبرتي المهنية ويجذب المجندين. أريد أن يكون مميزًا.',
    'chat.14.title': 'اكتب سيرة ذاتية مميزة على LinkedIn',
    'chat.15.prompt':
      'اشرح كيف يعمل الاقتصاد العالمي بطريقة بسيطة. غطِ مواضيع مثل الناتج المحلي الإجمالي، التضخم، أسعار الفائدة، والتجارة بطريقة يمكن لأي شخص فهمها.',
    'chat.15.title': 'اشرح الاقتصاد العالمي ببساطة',
    'chat.16.prompt':
      'أعطني قائمة بأسئلة مثيرة للتفكير يمكنني استخدامها لإجراء محادثات أعمق وأكثر معنى مع الأصدقاء والعائلة.',
    'chat.16.title': 'أسئلة لبدء محادثات عميقة',
    'chat.17.prompt':
      'ساعدني في إنشاء تحدي لياقة بدنية لمدة 30 يومًا يمكنني القيام به في المنزل بدون معدات. قم بتضمين مزيج من تمارين الكارديو، القوة، والمرونة.',
    'chat.17.title': 'إنشاء تحدي لياقة بدنية لمدة 30 يومًا',
    'chat.18.prompt':
      'ما هي بعض التقنيات الفعالة لإدارة التوتر والقلق؟ أعطني استراتيجيات عملية يمكنني استخدامها في اللحظة وعادات طويلة الأمد لبنائها.',
    'chat.18.title': 'تقنيات لإدارة التوتر',
    'chat.19.prompt':
      'ساعدني في فهم كيفية عمل تغير المناخ. ما أسبابه، وما هي آثاره، وما الذي يمكن للأفراد فعله بشكل واقعي للمساعدة؟',
    'chat.19.title': 'فهم تغير المناخ',
    'chat.20.prompt':
      'أوصني بـ 5 أفلام لا بد من مشاهدتها من أنواع مختلفة تُعتبر روائع. اشرح بإيجاز لماذا يستحق كل منها المشاهدة.',
    'chat.20.title': 'أوصني بأفلام لا بد من مشاهدتها',
    'chat.21.prompt':
      'ساعدني في تحسين مهاراتي في الكتابة. ما هي الأخطاء الشائعة التي يرتكبها الناس، وما هي التقنيات التي يمكنني ممارستها للكتابة بوضوح وإقناع؟',
    'chat.21.title': 'تحسين مهارات الكتابة',
    'chat.22.prompt':
      'اشرح تقنية البلوك تشين والعملات المشفرة بلغة بسيطة. ما هي المشاكل التي تحلها، وما الذي يجب أن أكون حذرًا بشأنه؟',
    'chat.22.title': 'اشرح البلوك تشين ببساطة',
    'chat.23.prompt':
      'ساعدني في إنشاء خطة دراسة لتعلم علم البيانات من البداية. ما هي المواضيع التي يجب أن أغطيها، وبأي ترتيب، وما هي الموارد التي توصي بها؟',
    'chat.23.title': 'إنشاء خطة دراسة لعلم البيانات',
    'chat.24.prompt':
      'ما هي بعض الطرق الإبداعية لكسب دخل إضافي على الجانب؟ أريد أفكارًا واقعية يمكنني البدء بها مع استثمار مبدئي قليل.',
    'chat.24.title': 'أفكار دخل جانبي إبداعية',
    'chat.25.prompt':
      'ساعدني في كتابة رسالة شكر إلى مرشد أثر بشكل كبير على مسيرتي المهنية. أريدها أن تكون صادقة، محددة، ولا تُنسى.',
    'chat.25.title': 'اكتب رسالة شكر مؤثرة',
    'chat.26.prompt':
      'اشرح نظرية النسبية بطريقة يمكن لطالب في المدرسة الثانوية فهمها. استخدم تشبيهات وأمثلة من الحياة اليومية.',
    'chat.26.title': 'اشرح النسبية ببساطة',
    'chat.27.prompt':
      'ساعدني في تنظيم وترتيب حياتي الرقمية — البريد الإلكتروني، الملفات، الصور، الاشتراكات، وكلمات المرور. أعطني خطة خطوة بخطوة.',
    'chat.27.title': 'تنظيم حياتي الرقمية',
    'chat.28.prompt':
      'ما هي أهم المهارات الشخصية للنجاح المهني؟ كيف يمكنني تطوير مهارات مثل التواصل، القيادة، والذكاء العاطفي؟',
    'chat.28.title': 'تطوير المهارات الشخصية الأساسية',
    'chat.29.prompt':
      'أنشئ مسابقة تريفيا ممتعة تحتوي على 10 أسئلة عبر فئات مختلفة مثل العلوم، التاريخ، الثقافة الشعبية، والجغرافيا. قم بتضمين الإجابات في النهاية.',
    'chat.29.title': 'إنشاء مسابقة تريفيا ممتعة',
    'chat.30.prompt':
      'ساعدني في تخطيط رحلة نهاية الأسبوع إلى مدينة قريبة. ما الذي يجب أن آخذه في الاعتبار عند التخطيط، وهل يمكنك إنشاء نموذج جدول زمني يمكنني تخصيصه؟',
    'chat.30.title': 'تخطيط رحلة نهاية الأسبوع',
    'chat.31.prompt':
      'ما هي أفضل الممارسات لإعطاء وتلقي الملاحظات في العمل؟ ساعدني في تعلم كيفية تقديم نقد بناء يقدره الناس بالفعل.',
    'chat.31.title': 'إتقان تقديم الملاحظات في العمل',
    'chat.32.prompt':
      'اشرح كيف يعمل التعلم الآلي على مستوى عالٍ. ما هي الأنواع المختلفة، وما هي أنواع المشاكل التي يمكنه حلها؟',
    'chat.32.title': 'شرح أساسيات التعلم الآلي',
    'chat.33.prompt':
      'ساعدني في إنشاء ميزانية شخصية. ارشدني خلال تصنيف نفقاتي، تحديد أهداف الادخار، وتتبع إنفاقي بشكل فعال.',
    'chat.33.title': 'إنشاء ميزانية شخصية',
    'chat.34.prompt':
      'ما هي بعض التقنيات المثبتة لتحسين النوم؟ أريد تحسين جودة نومي والشعور بمزيد من الراحة في الصباح.',
    'chat.34.title': 'نصائح لتحسين النوم',
    'chat.35.prompt':
      'ساعدني في كتابة سيرة ذاتية قصيرة وجذابة لموقعي الشخصي. يجب أن تكون مهنية ولكن ودودة، حوالي 150 كلمة.',
    'chat.35.title': 'كتابة سيرة ذاتية لموقع شخصي',
    'chat.36.prompt':
      'اشرح أساسيات تكوين الصور في التصوير الفوتوغرافي. ما هي القواعد والتقنيات التي يمكنني استخدامها لالتقاط صور أكثر جاذبية بصريًا باستخدام هاتفي؟',
    'chat.36.title': 'نصائح التصوير للمبتدئين',
    'chat.37.prompt':
      'ساعدني في التحضير لمقابلة عمل. ما هي الأسئلة الأكثر شيوعًا، كيف يجب أن أنظم إجاباتي، وما الأخطاء التي يجب أن أتجنبها؟',
    'chat.37.title': 'التحضير لمقابلة عمل',
    'chat.38.prompt':
      'ما هي بعض التجارب الفكرية الفلسفية المثيرة للاهتمام؟ اشرح بعض التجارب الكلاسيكية وما تعلمنا إياه عن الأخلاق، الواقع، والوعي.',
    'chat.38.title': 'استكشاف الألغاز الفلسفية',
    'chat.39.prompt':
      'ساعدني في وضع أهداف ذات معنى للسنة القادمة. ارشدني خلال إطار عمل لتحديد الأهداف يوازن بين الطموح والواقعية.',
    'chat.39.title': 'تحديد أهداف سنوية ذات معنى',
    'chat.40.prompt':
      'علمني أساسيات الطهي. ما هي التقنيات، الأدوات، والوصفات الأساسية التي يجب أن يعرفها كل طاهٍ منزلي ليشعر بالثقة في المطبخ؟',
    'chat.40.title': 'تعلم أساسيات الطهي',
    'group.01.prompt':
      'كوّن نادٍ للقراءة يضم قرّاء من خلفيات متنوعة يقدمون وجهات نظر مختلفة — ناقد أدبي يحلل المواضيع والأسلوب، قارئ عادي يشارك ردود فعله العاطفية، مهتم بالتاريخ يقدّم السياق، ومحب للفلسفة يستكشف المعاني العميقة. دعهم يناقشون تأثير الكتاب وما يكشفه عن الطبيعة البشرية.',
    'group.01.title': 'ناقش كتابًا معي',
    'group.02.prompt':
      'نظّم مناظرة ودية يشارك فيها أشخاص يتبنون مواقف مختلفة حول موضوع معين. يشمل ذلك منسقًا يضمن سير النقاش بعدالة، مؤيدين لكل طرف يقدمون حججًا قوية، ومحللًا محايدًا يلخص النقاط الرئيسية. دعهم يتناقشون باحترام ويستكشفون القضية من زوايا متعددة.',
    'group.02.title': 'ناقش فكرة بطريقة ودية',
    'group.03.prompt':
      'أنشئ ورشة كتابة إبداعية تضم كتّابًا في مراحل مختلفة — روائي منشور يشارك نصائح في الحرفة، محرر يقدم ملاحظات، مختص في الشعر يناقش اللغة، وكتّاب طموحين يعرضون أعمالهم. دعهم يقدمون ملاحظات بنّاءة ويُلهم بعضهم بعضًا.',
    'group.03.title': 'ساعدني في تطوير كتابتي',
    'group.04.prompt':
      'كوّن مجموعة نقاش استثماري تضم مستثمرًا في القيمة، محللًا يركز على النمو، خبيرًا في إدارة المخاطر، ومستشارًا ماليًا. دعهم يحللون الفرص الاستثمارية، يناقشون اتجاهات السوق، ويشاركون استراتيجيات مختلفة مع التأكيد على أهمية الدراسة المتأنية.',
    'group.04.title': 'ناقش استراتيجيات الاستثمار معي',
    'group.05.prompt':
      'كوّن فريق تخطيط للسفر يضم محبًا للمغامرات يقترح أنشطة مثيرة، مهتمًا بالثقافة يوصي بتجارب أصيلة، مسافرًا بميزانية محدودة يشارك نصائح لتوفير المال، وخبيرًا في السفر الفاخر يقترح خيارات راقية. دعهم يتعاونون لصياغة برنامج الرحلة المثالي.',
    'group.05.title': 'ساعدني في تخطيط إجازة أحلامي',
    'group.06.prompt':
      'أنشئ حلقة نقاش سينمائي تضم مؤرخًا سينمائيًا يقدم السياق، مخرجًا يشارك وجهة نظره الفنية، مشاهدًا عاديًا يقيّم الجانب الترفيهي، وناقدًا يحلل المواضيع والتنفيذ. دعهم يناقشون ما يجعل الأفلام مؤثرة ولا تُنسى.',
    'group.06.title': 'ناقش الأفلام معي',
    'group.07.prompt':
      'نظّم جلسة عصف ذهني للشركات الناشئة تضم مولّد أفكار مبدعًا، باحثًا في السوق يتحقق من الطلب، استراتيجيًا تجاريًا يقيّم الجدوى، ورائد أعمال يشارك خبرته الواقعية. دعهم يطورون أفكارًا تجارية ويصقلونها معًا.',
    'group.07.title': 'لنبتكر أفكارًا تجارية معًا',
    'group.08.prompt':
      'كوّن مجلس تخطيط للحياة يضم مدربًا مهنيًا يركز على النمو الوظيفي، مستشارًا ماليًا يهتم بالأمور المالية، خبيرًا في الصحة والتوازن، ومدربًا للحياة يركز على الإشباع الشخصي. دعهم يساعدون في وضع خطة حياة شاملة.',
    'group.08.title': 'ساعدني في تخطيط أهداف حياتي',
    'group.09.prompt':
      'كوّن مجموعة نقاش حول العافية تضم مدربًا للياقة البدنية، اختصاصي تغذية، مدافعًا عن الصحة النفسية، وأخصائي نوم. دعهم يناقشون أساليب شاملة للصحة، يشاركون نصائح عملية، ويتناولون التحديات الشائعة في الحفاظ على نمط حياة صحي.',
    'group.09.title': 'ناقش الصحة والعافية معي',
    'group.10.prompt':
      'أنشئ طاولة مستديرة حول التربية تضم آباءً لأطفال من أعمار مختلفة، أخصائيًا نفسيًا للأطفال، معلمًا، ومستشارًا أسريًا. دعهم يشاركون تجاربهم، يناقشون التحديات، ويقدمون الدعم مع احترام أساليب التربية المختلفة.',
    'group.10.title': 'شارك نصائح وتجارب في التربية',
    'group.11.prompt':
      'نظّم حلقة نقاش تاريخية تضم خبراء من عصور ومناطق مختلفة — مختصًا في التاريخ القديم، مؤرخًا حديثًا، أنثروبولوجيًا ثقافيًا، وعالمًا سياسيًا. دعهم يحللون الأحداث التاريخية وأهميتها في الحاضر.',
    'group.11.title': 'استكشف التاريخ المثير معي',
    'group.12.prompt':
      'كوّن صالونًا فلسفيًا يضم مفكرين من مدارس مختلفة — خبيرًا في الفلسفة الشرقية، باحثًا في الفلسفة الغربية، مختصًا في الأخلاق، ووجوديًا. دعهم يستكشفون أسئلة الحياة الكبرى من خلال عدسات فلسفية متنوعة.',
    'group.12.title': 'تأمل في أسئلة الحياة الكبرى معي',
    'group.13.prompt':
      'كوّن مجموعة تقدير فني تضم مؤرخًا فنيًا، فنانًا ممارسًا، أمين متحف، وجامعًا للأعمال الفنية. دعهم يناقشون الأعمال الفنية، الحركات، وما يجعل الفن ذا معنى عبر الثقافات والعصور.',
    'group.13.title': 'ناقش الفن معي',
    'group.14.prompt':
      'أنشئ نادي استكشاف الطعام يضم طاهيًا محترفًا، ناقدًا للطعام، طباخًا منزليًا، ومؤرخًا للطعام. دعهم يناقشون المأكولات، يشاركون وصفات، يستكشفون تقنيات الطهي، ويحتفلون بالقصص الثقافية وراء الأطباق.',
    'group.14.title': 'استكشف المأكولات العالمية معي',
    'group.15.prompt':
      'كوّن مجموعة تبادل لغوي تضم متحدثين أصليين بلغات مختلفة، لغويًا يشرح بنى اللغة، ومتعلّمين بمستويات متنوعة. دعهم يمارسون المحادثة، يشاركون نصائح التعلم، ويستكشفون الفروقات الثقافية.',
    'group.15.title': 'مارس اللغات الأجنبية معي',
    'group.16.prompt':
      'نظّم مجموعة دعم للانتقال المهني تضم مدربًا مهنيًا، شخصًا غيّر مساره المهني بنجاح، مختصًا في الموارد البشرية، وخبيرًا في تطوير المهارات. دعهم يناقشون الاستراتيجيات، يشاركون التجارب، ويقدمون التشجيع لمن يغيرون مسارهم المهني.',
    'group.16.title': 'ساعدني في تغيير مساري المهني',
    'group.17.prompt':
      'كوّن دائرة نصائح للعلاقات تضم معالجًا للأزواج، خبيرًا في التواصل، زوجين مخضرمين يشاركان حكمتهما، وشخصًا أعزب يقدم منظورًا جديدًا. دعهم يناقشون ديناميكيات العلاقات الصحية واستراتيجيات التواصل.',
    'group.17.title': 'ناقش العلاقات الصحية معي',
    'group.18.prompt':
      'أنشئ ورشة مالية شخصية تضم خبيرًا في الميزانية، مستشارًا استثماريًا، مستشارًا للديون، وشخصًا حقق الاستقلال المالي. دعهم يشاركون استراتيجيات عملية لبناء الثروة والأمان المالي.',
    'group.18.title': 'ساعدني في إتقان شؤوني المالية',
    'group.19.prompt':
      'كوّن دائرة دعم للصحة النفسية تضم معالجًا نفسيًا، ممارسًا للتأمل الواعي، مدربًا للحياة، وشخصًا يشارك رحلته مع الصحة النفسية. دعهم يناقشون استراتيجيات التكيف، ممارسات العناية الذاتية، وتقليل الوصمة حول الصحة النفسية.',
    'group.19.title': 'ادعمني في رحلتي للصحة النفسية',
    'group.20.prompt':
      'أنشئ فريق تسويق إبداعي يضم استراتيجيًا للعلامة التجارية، منشئ محتوى، خبيرًا في وسائل التواصل الاجتماعي، وعالمًا نفسيًا للمستهلك. دعهم يطورون حملات تسويقية جذابة ويناقشون ما يجعل الرسائل مؤثرة.',
    'group.20.title': 'ساعدني في تخطيط استراتيجيتي التسويقية',
    'group.21.prompt':
      'نظّم ورشة بناء علامة تجارية تضم خبيرًا في العلامات التجارية، مصممًا بصريًا، مختصًا في السرد القصصي، ورائد أعمال ناجح. دعهم يساعدون في تطوير هوية ورسالة واستراتيجية علامة تجارية قوية.',
    'group.21.title': 'ساعدني في بناء علامتي الشخصية',
    'group.22.prompt':
      'كوّن لجنة نقاش حول الأحداث الجارية تضم صحفيًا، محللًا سياسيًا، اقتصاديًا، ومعلقًا اجتماعيًا. دعهم يحللون الأخبار من زوايا متعددة، يميزون بين الحقائق والآراء، ويستكشفون الآثار المترتبة.',
    'group.22.title': 'ناقش الأخبار والأحداث الجارية معي',
    'group.23.prompt':
      'أنشئ فريق استكشاف علمي يضم علماء من مجالات مختلفة — فيزيائيًا، أحيائيًا، عالم بيئة، ومختصًا في تبسيط العلوم. دعهم يشرحون مواضيع معقدة، يناقشون الاكتشافات الحديثة، ويستكشفون عجائب العلم.',
    'group.23.title': 'استكشف الاكتشافات العلمية معي',
    'group.24.prompt':
      'كوّن مجموعة تبادل ثقافي تضم أشخاصًا من خلفيات ثقافية مختلفة، أنثروبولوجيًا، وكاتبًا في مجال السفر. دعهم يشاركون التقاليد، يناقشون الفروقات الثقافية باحترام، ويكتشفون التجارب الإنسانية المشتركة.',
    'group.24.title': 'شارك واستكشف التجارب الثقافية',
    'group.25.prompt':
      'كوّن مجموعة تطوير ذاتي تضم خبيرًا في الإنتاجية، مدربًا للعادات، مختصًا في التحفيز، وأشخاصًا ناجحين يشاركون رحلاتهم. دعهم يناقشون استراتيجيات النمو، المساءلة، وتحقيق الأهداف.',
    'group.25.title': 'ساعدني على النمو الشخصي',
    'group.26.prompt':
      'أنشئ فريقًا لتخطيط المحتوى أو البودكاست يضم استراتيجي محتوى، وخبيرًا في السرد القصصي، ومنتجًا تقنيًا، ومُبدع محتوى ناجح. اجعلهم يتبادلوا الأفكار، ويخططوا لسلاسل محتوى، ويناقشوا ما يجعل المحتوى جذابًا.',
    'group.26.title': 'ساعدني في تخطيط محتوى جذاب',
    'group.27.prompt':
      'نظّم حلقة لتبادل الملاحظات بين كتّاب من أنواع أدبية مختلفة، ومحرر يقدم ملاحظات تقنية، وقرّاء يشاركون وجهة نظر الجمهور. اجعلهم يعملون على تطوير النصوص، ويقدمون نقدًا بنّاءً، ويدعمون نمو بعضهم الإبداعي.',
    'group.27.title': 'قدّم ملاحظات بنّاءة على كتابتي',
    'group.28.prompt':
      'كوّن مجموعة لتقدير الموسيقى تضم مؤرخًا موسيقيًا، وموسيقيًا، ومنتجًا، ومستمعًا متحمسًا. اجعلهم يستكشفون أنواعًا موسيقية مختلفة، ويناقشون ما يجعل الموسيقى مؤثرة، ويشاركون اكتشافاتهم من عصور وثقافات متنوعة.',
    'group.28.title': 'اكتشف موسيقى جديدة معي',
    'group.29.prompt':
      'كوّن فريق تطوير برمجيات متكامل يضم قائدًا تقنيًا مسؤولًا عن قرارات البنية، ومطور واجهات يركز على تجربة المستخدم، ومطور خلفية يتعامل مع البيانات وواجهات البرمجة، ومهندس جودة يضمن الكفاءة. اجعلهم يتعاونون في التخطيط، ومناقشة التنازلات، ووضع استراتيجية تنفيذ لميزة جديدة.',
    'group.29.title': 'خطط ميزة جديدة معي',
    'group.30.prompt':
      'شكّل لجنة مراجعة كود تضم مهندسين كبار من تخصصات مختلفة - خبير خلفية، متخصص واجهات، مهندس أمان، وخبير تحسين الأداء. اجعلهم يراجعون الكود من وجهات نظرهم المختلفة ويقدمون ملاحظات شاملة.',
    'group.30.title': 'راجع الكود الخاص بي من زوايا متعددة',
    'group.31.prompt':
      'نظّم مراجعة لبنية النظام التقني مع مهندس نظم يعرض التصميم، وخبير أمان يقيّم الثغرات، ومهندس أداء يقيّم قابلية التوسع، ومطور كبير يدرس تعقيد التنفيذ. اجعلهم يتحدّون الافتراضات ويُحسّنون البنية.',
    'group.31.title': 'راجع بنية النظام الخاصة بي',
    'group.32.prompt':
      'أنشئ فريقًا مؤسسًا لشركة ناشئة يضم مديرًا تنفيذيًا يركز على الرؤية والاستراتيجية، ومديرًا تقنيًا يقيّم الجدوى التقنية والبنية، ومدير تسويق يخطط لاستراتيجيات دخول السوق. اجعلهم يناقشون اتجاه المنتج، وتوزيع الموارد، والمنافسة، واستراتيجيات النمو.',
    'group.32.title': 'حاكي نقاش فريق شركة ناشئة',
    'group.33.prompt':
      'كوّن لجنة توظيف تضم مدير توظيف، ومهندسين كبار، وممثلًا عن الموارد البشرية، ومدافعًا عن ثقافة الفريق. اجعلهم يتفقون على متطلبات المرشحين، ويصممون عملية المقابلات، ويقيّمون المرشحين بشكل شامل.',
    'group.33.title': 'ساعدني في تحسين عمليات التوظيف',
    'group.34.prompt':
      'كوّن مختبر ابتكار يضم صاحب رؤية للمنتج، ومهندس نماذج أولية، وباحث سوق، ومفكر تصميمي. اجعلهم يستكشفون تقنيات ناشئة، ويختبرون أفكارًا جديدة بسرعة، ويقترحون اتجاهات مبتكرة للمنتج.',
    'group.34.title': 'استكشف تقنيات ناشئة معي',
    'group.35.prompt':
      'أنشئ لجنة مراجعة ملاحظات العملاء تضم مدير منتج، وباحث تجربة مستخدم، ومدير نجاح عملاء، وممثلين عن الهندسة. اجعلهم يحللون الملاحظات، ويحددون الأنماط، ويضعون أولويات التحسين.',
    'group.35.title': 'ساعدني في تحليل ملاحظات العملاء',
    'group.36.prompt':
      'كوّن فريق إطلاق منتج يضم مدير منتج، وقائد تسويق، ومدير نجاح عملاء، وقائد هندسي. اجعلهم ينسقون أنشطة الإطلاق، ويستعدون للمشكلات المحتملة، ويضمنون إطلاقًا سلسًا.',
    'group.36.title': 'ساعدني في تنسيق إطلاق المنتج',
    'group.37.prompt':
      'نظّم لجنة تقييم تقني تضم مهندس بنية تقنية، ومطورين سيستخدمون التقنية، ومراجع أمان، ومديرًا يدرس التكلفة الإجمالية. اجعلهم يقيّمون الأدوات أو الأطر الجديدة بشكل منهجي.',
    'group.37.title': 'ساعدني في تقييم تقنية جديدة',
    'group.38.prompt':
      'كوّن مجلس مراجعة أمان يضم مهندس أمان، ومسؤول امتثال، ومطور خلفية، ومهندس DevOps. اجعلهم يقيّمون النظام من حيث الثغرات، والفجوات في الامتثال، والمخاطر التشغيلية، ثم يحددون أولويات المعالجة.',
    'group.38.title': 'راجع وضع الأمان في نظامي',
    'group.39.prompt':
      'نظّم ورشة عمل للمقاييس ومؤشرات الأداء تضم مدير منتج، ومحلل بيانات، وقائد هندسي، وأصحاب مصلحة من الأعمال. اجعلهم يحددون مقاييس ذات معنى، ويضعون خطوطًا أساسية، وينشئون لوحات تحكم تدعم اتخاذ قرارات جيدة.',
    'group.39.title': 'ساعدني في تحديد مؤشرات أداء فعالة',
    'group.40.prompt':
      'كوّن لجنة مراجعة تصميم تضم مصمم تجربة مستخدم يعرض التصميم، ومطور واجهات يقيّم قابلية التنفيذ، ومدير منتج يتحقق من التوافق مع المتطلبات، وخبير وصول يضمن التصميم الشامل. اجعلهم يقدمون ملاحظات بنّاءة ويكررون التحسين.',
    'group.40.title': 'راجع التصميم الخاص بي من عدة زوايا',
    'write.01.prompt':
      'اكتب قصة قصيرة مشوقة تحتوي على شخصيات جذابة، حبكة مثيرة، ونهاية مرضية. استخدم أوصافًا حية تُضفي الحياة على المشاهد، وحوارًا طبيعيًا يكشف عن شخصيات الأبطال، وتصاعدًا في التوتر يُبقي القارئ مشدودًا، وموضوعًا أو رسالة ذات مغزى تنسج عبر السرد.',
    'write.01.title': 'اكتب قصة قصيرة مشوقة',
    'write.02.prompt':
      'أنشئ قصيدة جميلة تُعبّر عن مشاعر عميقة أو تلتقط لحظة زمنية. جرّب استخدام الصور البلاغية، الاستعارات، الإيقاع، والمؤثرات الصوتية. يمكن أن تتبع القصيدة شكلاً تقليديًا (سونيت، هايكو، إلخ) أو تكون حرة، ولكن يجب أن تتمتع بصوت واضح وصدى عاطفي.',
    'write.02.title': 'اكتب لي قصيدة جميلة',
    'write.03.prompt':
      'اكتب سيناريو مشوقًا لفيلم قصير أو مسرحية أو فيديو. تضمّن حوارًا جذابًا يبدو طبيعيًا عند نطقه، ووصفًا واضحًا للمشاهد وتوجيهات مسرحية، وشخصيات متطورة ذات أصوات مميزة، وتوترًا دراميًا يدفع القصة إلى الأمام.',
    'write.03.title': 'اكتب سيناريو لفيلم أو مسرحية',
    'write.04.prompt':
      'اكتب قصة خيالية للأطفال أو حكاية خرافية تحتوي على شخصيات لا تُنسى، درسًا أخلاقيًا واضحًا، لغة مناسبة للعمر، وإحساسًا بالدهشة والسحر. أضف عناصر تُحفّز الخيال مع الحفاظ على سهولة الفهم وجاذبية السرد للصغار.',
    'write.04.title': 'اكتب قصة سحرية للأطفال',
    'write.05.prompt':
      'أنشئ قصة خيال علمي أو فانتازيا غامرة تحتوي على بناء عالم مبتكر، مفاهيم فريدة، وشخصيات جذابة. طوّر قواعد عالمك الخيالي بشكل متسق، واصنع التوتر من خلال الصراع، واستكشف مواضيع تلامس القارئ.',
    'write.05.title': 'اكتب قصة خيال علمي أو فانتازيا غامرة',
    'write.06.prompt':
      'اكتب قصة غموض أو إثارة مشوقة بإيقاع متسارع، وتحولات ذكية في الحبكة، وأدلة موزعة بعناية في السرد. أنشئ لغزًا مثيرًا ليحله القارئ مع البطل، مع الحفاظ على التوتر حتى الكشف المرضي في النهاية.',
    'write.06.title': 'اكتب قصة غموض مشوقة',
    'write.07.prompt':
      'اكتب مقالة شخصية أو قطعة من مذكرات تعكس تجارب الحياة أو الملاحظات أو المشاعر. استخدم تفاصيل حية لإحياء الذكريات، وابحث عن مواضيع إنسانية في القصص الشخصية، واصنع نثرًا حميميًا وذا مغزى للقراء.',
    'write.07.title': 'اكتب مقالة شخصية تأملية',
    'write.08.prompt':
      'أنشئ قصة قصيرة جدًا أو فلاش فِكشن تترك أثرًا قويًا في كلمات قليلة. اجعل كل كلمة ذات قيمة، مع نثر محكم، وخلفية ضمنية، ونهايات مفاجئة أو مؤثرة. استهدف قصصًا مكتملة بأقل من 1000 كلمة تترك انطباعًا دائمًا.',
    'write.08.title': 'اكتب قصة قصيرة مؤثرة',
    'write.09.prompt':
      'اكتب بريدًا إلكترونيًا مهنيًا يتميز بالوضوح والاختصار ويحقق هدفه بفعالية. سواء كنت تطلب معلومات، أو تتابع، أو تقدم اقتراحًا، أو تتناول مسألة حساسة، تأكد من أن النبرة مناسبة، والبنية منطقية، والدعوة إلى الإجراء واضحة.',
    'write.09.title': 'ساعدني في كتابة بريد إلكتروني مهني',
    'write.10.prompt':
      'أنشئ سيرة ذاتية قوية تُبرز مهاراتك وخبراتك وإنجازاتك بفعالية. استخدم أفعالًا قوية، وكمّن الإنجازات إن أمكن، وخصص المحتوى للوظيفة المستهدفة، وتأكد من تنسيق نظيف يمر بأنظمة تتبع المتقدمين ويظل سهل القراءة.',
    'write.10.title': 'ساعدني في بناء سيرة ذاتية مميزة',
    'write.11.prompt':
      'اكتب رسالة تغطية مقنعة تُكمل سيرتك الذاتية وتروي قصتك المهنية. أظهر حماسك الحقيقي للوظيفة والشركة، وسلط الضوء على الخبرات ذات الصلة، وبيّن ما يميزك بطريقة لا تُنسى.',
    'write.11.title': 'ساعدني في كتابة رسالة تغطية قوية',
    'write.12.prompt':
      'اكتب خطابًا أو نص عرض تقديمي جذابًا يشد انتباه الجمهور ويحافظ عليه. ابدأ بمقدمة قوية، وهيكل واضح مع انتقالات سلسة، وقصص أو أمثلة مؤثرة، وخاتمة لا تُنسى تتضمن أفكارًا رئيسية أو دعوة إلى الإجراء.',
    'write.12.title': 'اكتب لي خطابًا جذابًا',
    'write.13.prompt':
      'اكتب رسالة شكر صادقة تُعبّر عن امتنان حقيقي. سواء كانت لهدية، أو مقابلة، أو معروف، أو دعم، كن محددًا فيما تقدّره، واشرح تأثيره عليك، واحتفظ بنبرة أصيلة تُعزز العلاقة.',
    'write.13.title': 'اكتب رسالة شكر مؤثرة',
    'write.14.prompt':
      'اكتب رسالة اعتذار صادقة تتحمل المسؤولية، وتُعبّر عن الندم الحقيقي، وتعرض طريقًا للمضي قدمًا. اعترف بالأذى المحدد الذي تسببت به، وتجنب الأعذار، واشرح كيف ستمنع تكراره، واطلب الصفح دون إلحاح.',
    'write.14.title': 'اكتب رسالة اعتذار صادقة',
    'write.15.prompt':
      'أنشئ دعوة أنيقة لحدث، سواء كان رسميًا (زفاف، حفل فاخر) أو غير رسمي (حفلة، تجمع). تضمّن جميع التفاصيل الأساسية (من، ماذا، متى، أين، تأكيد الحضور)، واضبط النبرة المناسبة، وابنِ الترقب مع وضوح التوقعات.',
    'write.15.title': 'صمم دعوة أنيقة لحدث',
    'write.16.prompt':
      'اكتب رسالة توصية قوية تدافع بفعالية عن شخص ما. تضمّن أمثلة محددة على نقاط قوته وإنجازاته، وقدم سياقًا لعلاقتك وملاحظاتك، وعبّر عن تأييدك الصادق لمساعدة القارئ في اتخاذ قرار مستنير.',
    'write.16.title': 'اكتب رسالة توصية قوية',
    'write.17.prompt':
      'اكتب مراجعة منتج صادقة ومفيدة تُرشد المشترين المحتملين. غطِ الميزات الرئيسية، الأداء الواقعي، الإيجابيات والسلبيات، القيمة مقابل المال، ولمن يناسب المنتج. أضف أمثلة من تجربتك وتوصية واضحة.',
    'write.17.title': 'اكتب مراجعة منتج مفيدة',
    'write.18.prompt':
      'أنشئ دليل سفر شامل أو برنامج رحلة لوجهة معينة. تضمّن المعالم التي يجب زيارتها، الجواهر الخفية، نصائح عملية (المواصلات، الإقامة، الطعام)، اعتبارات الميزانية، ونصائح من الداخل لمساعدة المسافرين على الاستفادة القصوى من رحلتهم.',
    'write.18.title': 'أنشئ دليل سفر شامل',
    'write.19.prompt':
      'اكتب محتوى جذابًا لوسائل التواصل الاجتماعي يشد الانتباه ويزيد التفاعل. سواء كان لإنستغرام، تويتر/X، لينكدإن، أو تيك توك، أنشئ محتوى يناسب المنصة، ويتماشى مع الجمهور المستهدف، ويحتوي على خطافات جذابة ودعوات واضحة للإجراء.',
    'write.19.title': 'اكتب محتوى جذابًا لوسائل التواصل',
    'write.20.prompt':
      'اكتب مراجعة طعام شهية أو وصفة لذيذة بأوصاف حية تُشعل شهية القارئ. في المراجعات، صِف الأجواء، الخدمة، والنكهات. في الوصفات، قدم تعليمات واضحة، ونصائح مفيدة، وقصة الطبق.',
    'write.20.title': 'اكتب مراجعة طعام شهية',
    'write.21.prompt':
      'اكتب مراجعة كتاب أو فيلم مدروسة تساعد القارئ على اتخاذ قرار. لخّص دون حرق الأحداث، وحلل المواضيع والأسلوب، وناقش ما نجح وما لم ينجح، وحدد الجمهور المثالي، وقدم تقييمًا أو توصية واضحة.',
    'write.21.title': 'اكتب مراجعة كتاب أو فيلم مدروسة',
    'write.22.prompt':
      'اكتب تدوينة شخصية جذابة تتواصل مع القراء. اختر موضوعًا تهتم به، وشارك وجهة نظرك الفريدة، واستخدم نبرة محادثة، وأضف حكايات أو أمثلة شخصية، واختم بأفكار تدعو للتأمل أو النقاش.',
    'write.22.title': 'اكتب تدوينة جذابة',
    'write.23.prompt':
      'اكتب مقالًا إخباريًا واضحًا وموضوعيًا يلتزم بالمعايير الصحفية. غطِ من، ماذا، متى، أين، لماذا، وكيف. استخدم هيكل الهرم المقلوب، أدرج اقتباسات ذات صلة، حافظ على الحياد، وتحقق من الحقائق قبل النشر.',
    'write.23.title': 'اكتب مقالًا إخباريًا واضحًا',
    'write.24.prompt':
      'اكتب مقال مقابلة ثريًا يُضفي الحياة على الحوار. حضّر أسئلة مدروسة، وانقل شخصية المتحدث وصوته، وادمج الاقتباسات في سرد جذاب، وقدم سياقًا يساعد القارئ على فهم أهمية القصة.',
    'write.24.title': 'اكتب مقال مقابلة ثريًا',
    'write.25.prompt':
      'اكتب خطة عمل شاملة تقنع المستثمرين أو توجه مشروعك. يجب أن تتضمن ملخصًا تنفيذيًا، تحليلًا للسوق، المشهد التنافسي، نموذج العمل، استراتيجية التسويق، التوقعات المالية، نظرة عامة على الفريق، ومتطلبات التمويل مع توضيح كيفية استخدام الأموال.',
    'write.25.title': 'اكتب خطة عمل شاملة',
    'write.26.prompt':
      'اكتب ملاحظات قراءة مفصلة ومفيدة أو ملخصًا لكتاب يلتقط الأفكار الرئيسية. يجب أن تتضمن الحجج الأساسية والنقاط الداعمة، اقتباسات بارزة، تأملات شخصية، تطبيقات عملية، وأسئلة لمزيد من الاستكشاف.',
    'write.26.title': 'اكتب ملاحظات قراءة مفيدة',
    'write.27.prompt':
      'اكتب تقريرًا بحثيًا أو تحليلًا شاملاً حول موضوع معين. يجب أن يتضمن منهجية واضحة، نتائج منظمة، أوصاف لتصور البيانات، تحليلًا متوازنًا لوجهات النظر المختلفة، واستنتاجات قابلة للتنفيذ مدعومة بالأدلة.',
    'write.27.title': 'اكتب تقريرًا بحثيًا شاملاً',
    'write.28.prompt':
      'اكتب تحليلًا للسوق يحدد الفرص والتهديدات. يجب أن يتضمن نظرة عامة على الصناعة، تحليل العملاء المستهدفين، خريطة المنافسين، تحديد الاتجاهات، تحليل SWOT، وتوصيات استراتيجية مبنية على النتائج.',
    'write.28.title': 'اكتب تحليل سوق مفصل',
    'write.29.prompt':
      'اكتب محضر اجتماع واضح وقابل للتنفيذ يلتقط القرارات والخطوات التالية. يجب أن يتضمن الحضور، بنود جدول الأعمال التي نوقشت، النقاط الرئيسية، القرارات المتخذة، المهام مع المسؤولين والمواعيد النهائية، وبنود للمتابعة.',
    'write.29.title': 'اكتب محضر اجتماع واضح',
    'write.30.prompt':
      'اكتب ملخصًا سنويًا تأمليًا أو مراجعة سنوية توضح الإنجازات والدروس المستفادة. يجب أن يتضمن الإنجازات الرئيسية مع مؤشرات الأداء، التحديات التي تم التغلب عليها، الدروس المستفادة، تقييم الأهداف، والأهداف للسنة القادمة.',
    'write.30.title': 'اكتب ملخصي السنوي',
    'write.31.prompt':
      'اكتب تدوينة تقنية شاملة تشرح مفهومًا برمجيًا معقدًا بطريقة مبسطة. يجب أن تتضمن مقدمة جذابة، شروحات تدريجية من الأساسيات إلى المواضيع المتقدمة، أمثلة برمجية عملية مع تعليقات مفصلة، أوصاف للرسوم التوضيحية، حالات استخدام واقعية، أخطاء شائعة يجب تجنبها، وخاتمة مع خطوات تالية للتعلم.',
    'write.31.title': 'اكتب تدوينة تقنية جذابة',
    'write.32.prompt':
      'أنشئ ملف README.md احترافيًا لمشروع مفتوح المصدر يتضمن وصفًا جذابًا للمشروع مع شارات، تعليمات تثبيت واضحة لأنظمة التشغيل المختلفة، دليل بدء سريع مع أمثلة استخدام أساسية، توثيق API شامل بجميع الخيارات المتاحة، إرشادات المساهمة مع متطلبات تنسيق الكود، معلومات الترخيص، وقسم الشكر والتقدير.',
    'write.32.title': 'أنشئ ملف README احترافي',
    'write.33.prompt':
      'اكتب توثيق API مفصلًا يرغب المطورون فعليًا في قراءته. يجب أن يتضمن نظرة عامة على الغرض من الـ API وقدراته، متطلبات المصادقة والتفويض مع أمثلة، مراجع النقاط النهائية مع مخططات الطلب/الاستجابة، أمثلة تفاعلية بلغات برمجة متعددة، توثيق شامل لأكواد الأخطاء مع نصائح لحل المشكلات، تفاصيل الحد من المعدل، وسياسة الإصدارات.',
    'write.33.title': 'اكتب توثيق API مفصل',
    'write.34.prompt':
      'أنشئ مستند تصميم تقني يوضح بنية النظام بوضوح لأصحاب المصلحة التقنيين وغير التقنيين. يجب أن يتضمن بيان المشكلة والأهداف، نظرة عامة على البنية عالية المستوى مع مخططات المكونات، أوصاف تدفق البيانات، اختيارات التكنولوجيا مع التبرير، اعتبارات القابلية للتوسع والأداء، تدابير الأمان، استراتيجية الاختبار، وخطة الإطلاق مع استراتيجيات تقليل المخاطر.',
    'write.34.title': 'اكتب مستند تصميم تقني',
    'write.35.prompt':
      'اكتب دليلًا سهل الاستخدام يساعد المستخدمين على تحقيق أهدافهم باستخدام برنامجك. يجب أن يتضمن قسم البدء مع المتطلبات المسبقة، تعليمات خطوة بخطوة مع أوصاف لقطات الشاشة، نصائح واختصارات مفيدة، الأسئلة الشائعة، قسم استكشاف الأخطاء الشائعة، وروابط لموارد إضافية للمستخدمين المتقدمين.',
    'write.35.title': 'أنشئ دليلًا سهل الاستخدام',
    'write.36.prompt':
      'اكتب ملاحظات إصدار احترافية تُبقي المستخدمين على اطلاع ومتحمسين للتحديثات. يجب أن تتضمن ملخصًا لأبرز ما في الإصدار، أوصافًا مفصلة للميزات الجديدة مع أمثلة استخدام، التحسينات والتعديلات التي تم إجراؤها، الأخطاء التي تم إصلاحها مع مراجع القضايا، التغييرات الجذرية مع تعليمات واضحة للترحيل، إشعارات الإيقاف، وشكرًا للمساهمين.',
    'write.36.title': 'اكتب ملاحظات إصدار احترافية',
    'write.37.prompt':
      'أنشئ دليل تأهيل شامل يساعد الأعضاء الجدد في الفريق على أن يصبحوا منتجين بسرعة. يجب أن يتضمن مقدمة عن الفريق وقنوات التواصل، تعليمات إعداد البيئة، نظرة عامة على بنية قاعدة الكود مع الأدلة الرئيسية، المعايير والاتفاقيات، سير العمل الشائعة، نصائح التصحيح، قائمة بالموارد المفيدة، ومهام مقترحة للأسبوع الأول.',
    'write.37.title': 'أنشئ دليل تأهيل شامل',
    'write.38.prompt':
      'اكتب وثيقة اقتراح مشروع مقنعة توضح بوضوح المشكلة التي يتم حلها وتأثيرها التجاري، وتعرض حلاً مدروسًا جيدًا مع النهج التقني، وتتضمن مراحل واقعية وخط زمني، وتحدد متطلبات الموارد والميزانية، وتحدد مقاييس النجاح القابلة للقياس ومؤشرات الأداء الرئيسية، وتتناول المخاطر المحتملة مع استراتيجيات التخفيف.',
    'write.38.title': 'اكتب اقتراح مشروع مقنع',
    'write.39.prompt':
      'اكتب مستند متطلبات المنتج (PRD) يحدد بوضوح ما يجب بناؤه. يجب أن يتضمن بيان المشكلة واحتياجات المستخدم، شخصيات المستخدمين وحالات الاستخدام، المتطلبات الوظيفية مع معايير القبول، المتطلبات غير الوظيفية (الأداء، الأمان، إلخ)، متطلبات واجهة المستخدم وتجربة المستخدم مع الرسوم التخطيطية، مقاييس النجاح، والجدول الزمني مع التبعيات.',
    'write.39.title': 'اكتب مستند متطلبات المنتج',
    'write.40.prompt':
      'اكتب مقالة قاعدة معرفة تساعد المستخدمين على حل مشكلة محددة. يجب أن تتضمن بيانًا واضحًا للمشكلة، المتطلبات والافتراضات، حلًا خطوة بخطوة مع لقطات شاشة، طرقًا بديلة عند الاقتضاء، نصائح لاستكشاف المشكلات الشائعة، مقالات ذات صلة وخطوات تالية، وآلية لتقديم الملاحظات.',
    'write.40.title': 'اكتب مقالة قاعدة معرفة',
  },
  hs = Object.freeze(
  ...
  ha =
    'المواضيع الفرعية لا تدعم حاليًا تحميل الملفات أو الصور. إذا كانت لديك أي طلبات، لا تتردد في ترك رسالة: <1>💬 منطقة النقاش</1>',
  Ao = {
    'actions.confirmRemoveThread':
      'أنت على وشك حذف هذا الموضوع الفرعي. بمجرد حذفه، لا يمكن استعادته. يرجى المتابعة بحذر.',
  ...
  wo = {
    ...
    'agentGroupManagement.executeTask.intervention.taskPlaceholder':
      'يرجى تقديم وصف مفصل للمهمة التي سيقوم بها الوكيل...',
    ...
    'agentGroupManagement.executeTasks.intervention.instructionPlaceholder':
      'تعليمات مفصلة للوكيل لتنفيذ هذه المهمة...',
    ...
    'dalle.downloading':
      'روابط الصور التي تم إنشاؤها بواسطة DALL·E3 صالحة لمدة ساعة واحدة فقط، يتم تخزين الصور محليًا...',
    ...
    'localFiles.outOfScope.warning':
      'تحذير: المسار(ات) التالية تقع خارج دليل العمل المُحدد. يرجى التأكيد إذا كنت ترغب في السماح بالوصول.',
    ...
    'localFiles.securityBlacklist.warning':
      'تنبيه أمني: تم تمييز هذه العملية بواسطة قواعد الأمان وتتطلب موافقتك الصريحة.',
    ...
    'search.emptyResult':
      'لم يتم العثور على نتائج، يرجى تعديل الكلمات المفتاحية والمحاولة مرة أخرى',
    ...
    'search.searchCategory.value.social_media': 'وسائل التواصل الاجتماعي',
    ...
    'securityBlacklist.awsCredentials':
      'الوصول إلى بيانات اعتماد AWS قد يؤدي إلى تسريب مفاتيح الوصول السحابية',
    'securityBlacklist.browserCredentials':
      'الوصول إلى تخزين بيانات اعتماد المتصفح قد يؤدي إلى تسريب كلمات المرور',
    'securityBlacklist.chownSystemDirs': 'تغيير ملكية مجلدات النظام أمر خطير',
    'securityBlacklist.ddDiskWrite':
      'كتابة بيانات عشوائية على أجهزة التخزين قد يؤدي إلى تدمير البيانات',
    ...
    'securityBlacklist.envFiles':
      'قراءة ملفات .env قد تؤدي إلى تسريب بيانات اعتماد حساسة ومفاتيح API',
    ...
    'securityBlacklist.gcpCredentials':
      'قراءة بيانات اعتماد GCP قد تؤدي إلى تسريب مفاتيح حسابات الخدمات السحابية',
  ...
  ya = 'عرض العناصر',
  va = 'جارٍ نسخ الموضوع...',
  ka = 'تم نسخ الموضوع بنجاح',
  Sa = 'مفضل',
  Aa = 'فشل في الاستيراد',
  wa = 'تنسيق الملف غير صالح. يرجى التأكد من أنه ملف JSON صالح.',
  Ca = 'جارٍ استيراد المحادثة...',
  Ma = 'تم استيراد {{count}} رسالة بنجاح',
  Pa = 'تحميل المزيد',
  Ta = 'ابحث في المواضيع...',
  Ia = 'لم يتم العثور على نتائج.',
  Da = 'مؤقت',
  xa = 'الموضوع',
  Co = {
    ...
    'actions.confirmRemoveUnstarred':
      'أنت على وشك حذف المواضيع غير المميزة. لا يمكن التراجع عن هذا الإجراء.',
    ...
    'groupMode.byUpdatedTime': 'التجميع حسب وقت التحديث',
  ...
  Mo = {
    ...
    'generation.validation.endFrameRequiresStartFrame':
      'لا يمكن استخدام الإطار النهائي بدون إطار ابتدائي. يرجى تعيين إطار ابتدائي أولاً.',
    'topic.createNew': 'إنشاء موضوع جديد',
  ...
  Fa = 'مرحبًا بك',
  Na = 'أو اختر من قوالب الوكلاء أدناه',
  Ea = 'تخطي الإنشاء',
  Ra = {
    1: 'مرحبًا بعودتك 😊',
    2: 'مرحبًا، أنا هنا',
  ...
  Po = {
    ...
    'guide.defaultMessage':
      'أنا وكيلك {{appName}}. ابدأ بأي فكرة.<br />تحتاج إلى وكيل أكثر تخصصًا؟ انقر على <plus /> لإنشاء واحد.',
    ...
    'guide.groupActivities.general.languagePractice.description':
      'ممارسة التحدث وتعلم لغات جديدة مع متحدثين أصليين',
    'guide.groupActivities.general.languagePractice.emoji': '🗣️',
    'guide.groupActivities.general.languagePractice.prompt':
      'دعنا نتدرب على لغة جديدة معًا. هل يمكنك مساعدتنا في تعلمها والتحدث بها؟',
    ...
    'guide.groupActivities.product.techExchange.description':
      'مناقشة التقنيات الناشئة والابتكارات والاتجاهات الصناعية',
    'guide.groupActivities.product.techExchange.emoji': '🚀',
    'guide.groupActivities.product.techExchange.prompt':
      'دعنا نجري تبادلًا تقنيًا! هل يمكنك مساعدتنا في مناقشة التقنيات والاتجاهات الجديدة؟',
    ...
    'guide.groupMessage':
      'مرحبًا بك في المجموعات. في محادثة مشتركة واحدة، يمكن للوكلاء دفع المهمة قدمًا معًا.',
    ...
    'guide.groupTemplates.analysis.members': [
      {
        ...
        plugins: ['steam'],
        systemRole:
          'أنت ماهر في معالجة البيانات وتفسيرها، وتكشف الأنماط والاتجاهات من خلال الرسوم البيانية والتحليل الإحصائي.',
        title: 'محلل بيانات',
      },
      {
        avatar: '🧑‍🔬',
      ...
      },
      {
        ...
        systemRole:
          'أنت خبير في الإحصاء، متمكن من الأساليب والنماذج الإحصائية المختلفة، وتستخرج رؤى تجارية قيّمة من البيانات.',
        title: 'خبير إحصاء',
      },
      {
        avatar: '🧮',
        ...
        systemRole:
          'أنت محلل كمي، تركز على النمذجة وتقييم المخاطر باستخدام الأساليب الرياضية لحل المشكلات المعقدة.',
        title: 'محلل كمي',
      },
    ],
    'guide.groupTemplates.analysis.title': 'فريق التحليل',
    'guide.groupTemplates.brainstorm.description':
      'تفكير إبداعي من زوايا متعددة لإطلاق إمكانيات لا نهائية',
    'guide.groupTemplates.brainstorm.members': [
      {
        avatar: '🧠',
        backgroundColor: '#E8F5FF',
        systemRole:
          'أنت مخرج إبداعي، ماهر في توجيه الرؤية الإبداعية من منظور شامل وتحويل الأفكار المجردة إلى خطط قابلة للتنفيذ.',
      ...
      },
      {
        ...
        systemRole:
          'أنت خبير في التفكير التصميمي، تتناول المشكلات من منظور تجربة المستخدم والعرض البصري، مع التركيز على التعبير البصري.',
        title: 'مفكر تصميمي',
      },
    ],
    ...
    'guide.groupTemplates.game.members': [
      {
        ...
        backgroundColor: '#E8F5FF',
        systemRole:
          'أنت منظم ألعاب، ماهر في تنظيم الألعاب النصية الجماعية وتوجيه اللاعبين خلال اللعب.',
        title: 'منظم ألعاب',
      },
      {
        avatar: '🧑‍🔬',
    ...
    'guide.groupTemplates.planning.members': [
      {
        ...
        backgroundColor: '#E8F5FF',
        systemRole:
          'أنت مسؤول عن التخطيط العام للمشروع، ومراقبة التقدم، وتنسيق الموارد لضمان التسليم في الوقت المحدد وبجودة عالية.',
        title: 'الطاهي',
      },
      {
        avatar: '🎯',
        backgroundColor: '#FFF7E8',
        systemRole:
          'أنت مسؤول عن التخطيط الاستراتيجي طويل المدى، وتحليل الفرص السوقية، وتحديد الأهداف، ورسم طريق النجاح.',
      ...
      },
      {
        ...
        backgroundColor: '#F0F8FF',
        systemRole:
          'أنت مسؤول عن خطط التنفيذ التفصيلية، وتنسيق الموارد بين الأقسام لضمان إمكانية التنفيذ.',
    ...
    'guide.groupTemplates.product.members': [
      ...
      },
      {
        ...
        backgroundColor: '#E8F5FF',
        systemRole:
          'أنت مدير منتج، مسؤول عن التخطيط والتصميم والتطوير والصيانة لضمان الجودة وتجربة المستخدم.',
        title: 'مدير منتج',
      },
      {
        avatar: '🧑‍💻',
        backgroundColor: '#E8F8F5',
        systemRole:
          'أنت مهندس برمجيات شامل ذو خبرة، ماهر في تطوير أنواع مختلفة من المنتجات حسب المتطلبات.',
    ...
    'guide.groupTemplates.writing.members': [
      {
        ...
        backgroundColor: '#F6E8FF',
        systemRole:
          'أنت ماهر في الكتابة بأنماط مختلفة ويمكنك تعديل نبرة الصوت لتناسب الجماهير والمواقف المختلفة.',
        title: 'كاتب محتوى',
      },
      {
        avatar: '🧑‍🎨',
        backgroundColor: '#E8F8F5',
        systemRole:
          'أنت محرر، مسؤول عن التدقيق والتحسين وصقل النصوص لضمان الدقة والطلاقة والاحترافية.',
        title: 'محرر',
      },
    ],
    ...
    'guide.welcome.morning': 'صباح الخير',
  ...
  Ss = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Po, header: Fa, pickAgent: Na, skip: Ea, welcomeMessages: Ra },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
...
function n(t, e) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    (e &&
      (o = o.filter(function (La) {
        return Object.getOwnPropertyDescriptor(t, La).enumerable;
      })),
      i.push.apply(i, o));
  }
  return i;
...
const Oa = { placeholder: 'اختيار الوقت', rangePlaceholder: ['وقت البدء', 'وقت الانتهاء'] },
  l = {
    lang: {
  ...
  a = 'ليس ${label} من نوع ${type} صالحًا',
  No = {
    locale: 'ar',
    Pagination: To,
    DatePicker: l,
    TimePicker: Oa,
    Calendar: l,
    global: { placeholder: 'يرجى التحديد', close: 'إغلاق' },
    Table: {
      filterTitle: 'الفلاتر',
      filterConfirm: 'تأكيد',
    ...
    Tour: { Next: 'التالي', Previous: 'السابق', Finish: 'إنهاء' },
    Modal: { okText: 'تأكيد', cancelText: 'إلغاء', justOkText: 'تأكيد' },
    Popconfirm: { okText: 'تأكيد', cancelText: 'إلغاء' },
    Transfer: {
      titles: ['', ''],
    ...
    Icon: { icon: 'أيقونة' },
    Text: { edit: 'تعديل', copy: 'نسخ', copied: 'نقل', expand: 'وسع' },
    Form: {
