const e = {
  'azure.azureApiVersion.desc':
    "Version de l'API Azure, au format AAAA-MM-JJ. Consultez la [dernière version](https://learn.microsoft.com/fr-fr/azure/ai-services/openai/reference#chat-completions)",
  ...
  'azure.endpoint.desc':
    "En consultant les ressources sur le portail Azure, vous trouverez cette valeur dans la section 'Clés et points de terminaison'",
  ...
  'azure.token.desc':
    "En consultant les ressources sur le portail Azure, vous trouverez cette valeur dans la section 'Clés et points de terminaison'. Vous pouvez utiliser KEY1 ou KEY2",
  ...
  'azureai.endpoint.desc':
    "Trouvez le point de terminaison d'inférence du modèle Azure AI dans l'aperçu du projet Azure AI",
  ...
  'bedrock.sessionToken.desc':
    'Si vous utilisez AWS SSO/STS, veuillez saisir votre jeton de session AWS',
  ...
  'bedrock.unlock.description':
    "Saisissez votre AccessKeyId / SecretAccessKey AWS pour démarrer la session. L'application ne stockera pas votre configuration d'authentification",
  'bedrock.unlock.imageGenerationDescription':
    "Saisissez votre AccessKeyId / SecretAccessKey AWS pour commencer la génération. L'application ne stockera pas vos identifiants d'authentification.",
  ...
  'cloudflare.baseURLOrAccountID.desc':
    'Saisissez votre identifiant de compte Cloudflare ou une URL API personnalisée',
  ...
  'comfyui.authType.desc':
    "Sélectionnez la méthode d'authentification pour se connecter au serveur ComfyUI",
  ...
  'comfyui.customHeaders.desc':
    "En-têtes de requête requis pour l'authentification personnalisée, au format clé-valeur",
  ...
  'createNewAiProvider.id.desc':
    'Identifiant unique du fournisseur de service, non modifiable après création',
  'createNewAiProvider.id.duplicate': "L'identifiant du fournisseur existe déjà",
  'createNewAiProvider.id.format':
    'Peut contenir uniquement des chiffres, lettres minuscules, tirets (-) et underscores (_)',
  ...
  'github.personalAccessToken.desc':
    'Saisissez votre PAT GitHub. Cliquez [ici](https://github.com/settings/tokens) pour en créer un.',
  'github.personalAccessToken.placeholder': 'ghp_xxxxxx',
  'github.personalAccessToken.title': 'PAT GitHub',
  'huggingface.accessToken.desc':
    'Saisissez votre jeton HuggingFace, cliquez [ici](https://huggingface.co/settings/tokens) pour en créer un',
  ...
  'newapi.apiUrl.desc':
    "Point de terminaison de l'API pour le service New API, inclut généralement /v1",
  ...
  'ollama.customModelName.desc':
    'Ajouter des modèles personnalisés, séparer plusieurs modèles par des virgules',
  ...
  'ollama.download.desc':
    "Ollama télécharge le modèle. Veuillez éviter de fermer cette page. Le téléchargement reprendra là où il s'est arrêté en cas d'interruption.",
  'ollama.download.failed':
    'Échec du téléchargement du modèle. Veuillez vérifier votre connexion réseau ou les paramètres Ollama, puis réessayer.',
  ...
  'ollama.endpoint.desc':
    'Doit inclure http(s):// ; peut être laissé vide si non spécifié localement.',
  ...
  'providerModels.config.aesGcm':
    "Votre clé et l'URL du proxy seront chiffrées à l'aide de l'algorithme <1>AES-GCM</1>",
  'providerModels.config.apiKey.desc': 'Veuillez saisir votre clé API {{name}}',
  'providerModels.config.apiKey.descWithUrl':
    "Veuillez saisir votre clé API {{name}}. <3>Cliquez ici pour l'obtenir</3>",
  ...
  'providerModels.config.checker.desc':
    "Tester si la clé API et l'URL du proxy sont correctement renseignées",
  ...
  'providerModels.config.fetchOnClient.desc':
    'Le mode de requête client initiera les requêtes de session directement depuis le navigateur, ce qui peut améliorer la vitesse de réponse',
  ...
  'providerModels.config.oauth.authorizedDesc':
    'Vous êtes connecté à {{name}}. Cliquez pour vous déconnecter.',
  ...
  'providerModels.config.oauth.connectDesc':
    'Cliquez pour autoriser via le navigateur. Aucune clé API requise.',
  ...
  'providerModels.config.oauth.desc':
    'Autorisez avec votre compte {{name}} pour accéder aux modèles via votre abonnement.',
  'providerModels.config.oauth.disconnect': 'Se déconnecter',
  'providerModels.config.oauth.disconnectConfirm':
    'Êtes-vous sûr de vouloir vous déconnecter ? Vous devrez vous réautoriser pour utiliser ce fournisseur.',
  ...
  'providerModels.config.responsesApi.desc':
    "Utilise le format de requête de nouvelle génération d'OpenAI pour débloquer des fonctionnalités avancées comme le raisonnement en chaîne (pris en charge uniquement par les modèles OpenAI)",
  'providerModels.config.responsesApi.title': 'Utiliser la spécification Responses API',
  'providerModels.config.waitingForMore':
    "D'autres modèles sont actuellement <1>prévus pour intégration</1>, restez à l'écoute",
  ...
  'providerModels.item.customModelCards.confirmDelete':
    'Vous êtes sur le point de supprimer ce modèle personnalisé. Une fois supprimé, il ne pourra pas être récupéré. Veuillez procéder avec prudence.',
  'providerModels.item.delete.confirm':
    'Êtes-vous sûr de vouloir supprimer le modèle {{displayName}} ?',
  ...
  'providerModels.item.modelConfig.azureDeployName.extra':
    'Champ utilisé pour les requêtes réelles dans Azure OpenAI',
  'providerModels.item.modelConfig.azureDeployName.placeholder':
    'Veuillez saisir le nom de déploiement du modèle dans Azure',
  ...
  'providerModels.item.modelConfig.deployName.extra':
    "Ce champ sera utilisé comme identifiant du modèle lors de l'envoi des requêtes",
  'providerModels.item.modelConfig.deployName.placeholder':
    "Veuillez saisir le nom ou l'identifiant réel du modèle",
  ...
  'providerModels.item.modelConfig.displayName.placeholder':
    "Veuillez saisir le nom d'affichage du modèle, par ex. ChatGPT, GPT-4, etc.",
  ...
  'providerModels.item.modelConfig.extendParams.extra':
    'Choisissez les paramètres étendus pris en charge par le modèle. Survolez une option pour prévisualiser les contrôles. Des configurations incorrectes peuvent entraîner des échecs de requête.',
  'providerModels.item.modelConfig.extendParams.options.codexMaxReasoningEffort.hint':
    "Pour les modèles Codex ; contrôle l'intensité du raisonnement.",
  'providerModels.item.modelConfig.extendParams.options.disableContextCaching.hint':
    'Pour les modèles Claude ; peut réduire les coûts et accélérer les réponses.',
  'providerModels.item.modelConfig.extendParams.options.effort.hint':
    "Pour Claude Opus 4.6 ; contrôle le niveau d'effort (faible/moyen/élevé/maximal).",
  'providerModels.item.modelConfig.extendParams.options.enableAdaptiveThinking.hint':
    'Pour Claude Opus 4.6 ; active ou désactive la pensée adaptative.',
  'providerModels.item.modelConfig.extendParams.options.enableReasoning.hint':
    'Pour Claude, DeepSeek et autres modèles de raisonnement ; active une réflexion plus approfondie.',
  'providerModels.item.modelConfig.extendParams.options.gpt5ReasoningEffort.hint':
    'Pour la série GPT-5 ; contrôle l’intensité du raisonnement.',
  'providerModels.item.modelConfig.extendParams.options.gpt5_1ReasoningEffort.hint':
    'Pour la série GPT-5.1 ; contrôle l’intensité du raisonnement.',
  'providerModels.item.modelConfig.extendParams.options.gpt5_2ProReasoningEffort.hint':
    'Pour la série GPT-5.2 Pro ; contrôle l’intensité du raisonnement.',
  'providerModels.item.modelConfig.extendParams.options.gpt5_2ReasoningEffort.hint':
    'Pour la série GPT-5.2 ; contrôle l’intensité du raisonnement.',
  'providerModels.item.modelConfig.extendParams.options.grok4_20ReasoningEffort.hint':
    "Pour la série Grok 4.20 ; contrôle l'intensité du raisonnement. Faible/Moyen utilise 4 agents, Élevé/Très Élevé utilise 16 agents.",
  'providerModels.item.modelConfig.extendParams.options.imageAspectRatio.hint':
    'Pour les modèles de génération d’images Gemini ; contrôle le format d’image généré.',
  'providerModels.item.modelConfig.extendParams.options.imageAspectRatio2.hint':
    "Pour Nano Banana 2 ; contrôle le rapport d'aspect des images générées (prend en charge ultra-large 1:4, 4:1, 1:8, 8:1).",
  'providerModels.item.modelConfig.extendParams.options.imageResolution.hint':
    'Pour les modèles de génération d’images Gemini 3 ; contrôle la résolution des images générées.',
  'providerModels.item.modelConfig.extendParams.options.imageResolution2.hint':
    "Pour les modèles d'images Gemini 3.1 Flash ; contrôle la résolution des images générées (prend en charge 512px).",
  'providerModels.item.modelConfig.extendParams.options.reasoningBudgetToken.hint':
    'Pour Claude, Qwen3 et similaires ; contrôle le budget de jetons pour le raisonnement.',
  'providerModels.item.modelConfig.extendParams.options.reasoningBudgetToken32k.hint':
    'Pour GLM-5 et GLM-4.7 ; contrôle le budget de tokens pour le raisonnement (max 32k).',
  'providerModels.item.modelConfig.extendParams.options.reasoningBudgetToken80k.hint':
    'Pour la série Qwen3 ; contrôle le budget de tokens pour le raisonnement (max 80k).',
  'providerModels.item.modelConfig.extendParams.options.reasoningEffort.hint':
    'Pour OpenAI et autres modèles capables de raisonnement ; contrôle l’effort de raisonnement.',
  'providerModels.item.modelConfig.extendParams.options.textVerbosity.hint':
    'Pour la série GPT-5+ ; contrôle la verbosité de la sortie.',
  'providerModels.item.modelConfig.extendParams.options.thinking.hint':
    'Pour certains modèles Doubao ; permet au modèle de décider s’il doit réfléchir en profondeur.',
  'providerModels.item.modelConfig.extendParams.options.thinkingBudget.hint':
    'Pour la série Gemini ; contrôle le budget de réflexion.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel.hint':
    'Pour les modèles Gemini 3 Flash Preview ; contrôle la profondeur de réflexion.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel2.hint':
    'Pour les modèles Gemini 3 Pro Preview ; contrôle la profondeur de réflexion.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel3.hint':
    'Pour les modèles Gemini 3.1 Pro Preview ; contrôle la profondeur de réflexion avec des niveaux bas/moyen/élevé.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel4.hint':
    'Pour les modèles Gemini 3.1 Flash Image ; active ou désactive la réflexion.',
  'providerModels.item.modelConfig.extendParams.options.thinkingLevel5.hint':
    "Pour l'aperçu Flash-Lite de Gemini 3.1 ; contrôle la profondeur de réflexion avec des niveaux minimal/faible/moyen/élevé.",
  'providerModels.item.modelConfig.extendParams.options.urlContext.hint':
    'Pour la série Gemini ; permet de fournir un contexte via une URL.',
  'providerModels.item.modelConfig.extendParams.placeholder':
    'Sélectionnez les paramètres étendus à activer',
  ...
  'providerModels.item.modelConfig.files.extra':
    "L'implémentation actuelle du téléversement de fichiers est une solution temporaire, limitée à l'expérimentation personnelle. Veuillez attendre les fonctionnalités complètes dans les futures versions.",
  ...
  'providerModels.item.modelConfig.functionCall.extra':
    "Cette configuration activera uniquement la capacité du modèle à utiliser des outils. L'utilisation effective dépend entièrement du modèle lui-même ; veuillez tester sa compatibilité.",
  ...
  'providerModels.item.modelConfig.id.extra':
    'Ne peut pas être modifié après création et sera utilisé comme identifiant du modèle lors des appels IA',
  'providerModels.item.modelConfig.id.placeholder':
    "Veuillez saisir l'identifiant du modèle, par ex. gpt-4o ou claude-3.5-sonnet",
  'providerModels.item.modelConfig.id.title': 'Identifiant du modèle',
  'providerModels.item.modelConfig.imageOutput.extra':
    "Ce paramètre active uniquement la capacité de génération d'images du modèle. Les performances réelles dépendent du modèle. Veuillez tester sa compatibilité.",
  ...
  'providerModels.item.modelConfig.reasoning.extra':
    'Cette configuration activera les capacités de raisonnement approfondi du modèle. Les effets dépendent du modèle. Veuillez tester sa compatibilité.',
  ...
  'providerModels.item.modelConfig.search.extra':
    'Ce paramètre active la capacité de recherche web intégrée du modèle. La prise en charge dépend du modèle. Veuillez tester sa compatibilité.',
  ...
  'providerModels.item.modelConfig.tokens.extra':
    'Définir le nombre maximal de tokens pris en charge par le modèle',
  ...
  'providerModels.item.modelConfig.type.extra':
    "Les différents types de modèles ont des cas d'utilisation et des capacités distincts",
  ...
  'providerModels.item.modelConfig.video.extra':
    "Ce paramètre active la configuration de reconnaissance vidéo dans l'application. La prise en charge dépend du modèle. Veuillez tester sa compatibilité.",
  ...
  'providerModels.item.modelConfig.vision.extra':
    "Cette configuration active uniquement la capacité de téléversement d'images dans l'application. La reconnaissance dépend du modèle. Veuillez tester ses capacités visuelles.",
  ...
  'providerModels.list.empty.desc':
    'Veuillez créer un modèle personnalisé ou en importer un pour commencer.',
  ...
  'providerModels.list.enabledEmpty':
    'Aucun modèle activé disponible. Veuillez activer vos modèles préférés ci-dessous~',
  ...
  'providerModels.list.resetAll.conform':
    'Êtes-vous sûr de vouloir réinitialiser toutes les modifications du modèle actuel ? La liste reviendra à son état par défaut.',
  ...
  'updateAiProvider.confirmDelete':
    'Vous êtes sur le point de supprimer ce fournisseur IA. Une fois supprimé, il ne pourra pas être récupéré. Confirmez-vous la suppression ?',
  ...
  'vertexai.region.desc':
    'Sélectionnez la région pour le service Vertex AI. Certains modèles comme Gemini 2.5 ne sont disponibles que dans certaines régions (ex. : global)',
